...
{
    {0x00000000,   __phys_to_pfn(0x00000000),  (0x20000000),     MEM_TYPE_DEVICE},   
#if defined(CHIP_VER_UIS8910FF)
#if defined(SRAM_SIZE_128MBIT)
    {0x50000000,   __phys_to_pfn(0x50000000),  (0x31000000),     MEM_TYPE_DEVICE},
#else
    {0x50000000,   __phys_to_pfn(0x50000000),  (0x32000000),     MEM_TYPE_DEVICE},
#endif
#else
    {0x50000000,   __phys_to_pfn(0x50000000),  (0x20000000),     MEM_TYPE_DEVICE},
