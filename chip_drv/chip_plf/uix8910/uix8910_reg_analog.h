...
#define ANA_LDO_SD_REG0                           (uint32)(&hwp_rda2720mGlobal->LDO_EMMCCORE_REG0)
#define ANA_LDO_SD_REG1                           (uint32)(&hwp_rda2720mGlobal->LDO_EMMCCORE_REG1)
#define ANA_LDO_SD_REG2                           (uint32)(&hwp_rda2720mGlobal->LDO_EMMCCORE_PD_REG)
...
#define ANA_LDO_VDDR12_PD_REG                (uint32)(&hwp_rda2720mGlobal->LDO_DDR12_PD_REG)
...
#define ANA_LDO_USB_PD_REG                       (uint32)(&hwp_rda2720mGlobal->LDO_USB_PD_REG)
...
#define ANA_LDO_CAMIO_REG0                       (uint32)(&hwp_rda2720mGlobal->LDO_CAMD_REG0)
#define ANA_LDO_CAMIO_REG1                       (uint32)(&hwp_rda2720mGlobal->LDO_CAMD_REG1)
#define ANA_LDO_LCD_REG0                           (uint32)(&hwp_rda2720mGlobal->LDO_LCD_REG0)
#define ANA_LDO_LCD_REG1                           (uint32)(&hwp_rda2720mGlobal->LDO_LCD_REG1)
...
#define ANA_SLP_LDO_PD_CTRL1                       (uint32)(&hwp_rda2720mGlobal->SLP_LDO_PD_CTRL1)
#define ANA_SLP_DCDC_LP_CTRL                     (uint32)(&hwp_rda2720mGlobal->SLP_DCDC_LP_CTRL)
#define ANA_SLP_LDO_LP_CTRL0                     (uint32)(&hwp_rda2720mGlobal->SLP_LDO_LP_CTRL0)
#define ANA_SLP_LDO_LP_CTRL1                     (uint32)(&hwp_rda2720mGlobal->SLP_LDO_LP_CTRL1)
...
#define ANA_DCDC_VLG_SEL                           (uint32)(&hwp_rda2720mGlobal->DCDC_VLG_SEL)
#define ANA_SLP_DCDC_PD_CTRL                   (uint32)(&hwp_rda2720mGlobal->SLP_DCDC_PD_CTRL)
...
#define ANA_FLASH_CTRL                           (uint32)(&hwp_rda2720mGlobal->FLASH_CTRL)
#define ANA_KPLED_CTRL                           (uint32)(&hwp_rda2720mGlobal->KPLED_CTRL0)
#define ANA_VIBR_CTRL                           (uint32)(&hwp_rda2720mGlobal->VIBR_CTRL0)
...
#define ANA_CHGR_DET_FGU_CTRL                (uint32)(&hwp_rda2720mGlobal->CHGR_DET_FGU_CTRL)
 ...
 ** ANA_EFS_SOFT_RST                  : [7] (RW)AUD TX soft reset
 ...
 **************************   Fields Definition *******************************/
#define    ANA_AUDRX_SOFT_RST            (BIT_13)
#define    ANA_AUDTX_SOFT_RST            (BIT_12)
#define    ANA_AUD_IF_SOFT_RST            (BIT_8)
#define    ANA_EFS_SOFT_RST            (BIT_7)
#define    ANA_ADC_SOFT_RST            (BIT_6)
 ...
 **************************   Fields Definition *******************************/
#define    LDO_BTPHY_BYPASS            (BIT_5)
#define    LDO_BTPHY_SHPT_PD        (BIT_1)
#define    LDO_BTPHY_PD                (BIT_0)
 ...
 ** LDO_CAMD_PD                   : [0] (RW)LDO_CAMD  power down,1: power down,0: power on  
 **************************   Fields Definition *******************************/
//#define    LDO_LCD_LP_EN_SW            (BIT_8)
#define    LDO_LCD_SHPT_PD            (BIT_6)
#define    LDO_LCD_PD                 (BIT_0)
 ...
 ** LDO_CAMD_V           : [7:0] (RW)CAMD LDO program bits: 8'b0 as 1.2V output, 10mV/step, 1.8V default
 **************************   Fields Definition *******************************/
#define    LDO_LCD_V_SHIFT                (0)
#define    LDO_LCD_V_MSK                  (0x7FUL << LDO_LCD_V_SHIFT)
 ...
 **************************   Fields Definition *******************************/
#define    LDO_XTL_EN        (BIT_2)
#define    SLP_IO_EN        (BIT_1)
#define    SLP_LDO_PD_EN    (BIT_0)

/*******************************************************************************
 ** Register Name        : ANA_SLP_LDO_PD_CTRL0/1
 ...
 **************************   Fields Definition *******************************/
#define    SLP_LDORF_PD_EN            (BIT_14)
#define    SLP_LDOMMC_PD_EN            (BIT_12)
#define    SLP_LDODCXO_PD_EN        (BIT_11)
#define    SLP_LDOSPIMEM_PD_EN        (BIT_10)
#define    SLP_LDOVDD28_PD_EN        (BIT_9)
#define    SLP_LDOVIO18_PD_EN        (BIT_8)
#define    SLP_LDODDR12_PD_EN        (BIT_7)
#define    SLP_LDOUSB_PD_EN            (BIT_6)
#define    SLP_LDOLCD_PD_EN            (BIT_5)
#define    SLP_LDOCAMD_PD_EN        (BIT_3)
#define    SLP_LDOCAMA_PD_EN        (BIT_2)
#define    SLP_LDOSIM1_PD_EN        (BIT_0)
//#define    SLP_LDOSIM0_PD_EN        (BIT_0)
//#define    SLP_LDOSF_PD_EN            (BIT_14)
//#define    SLP_LDOSD_PD_EN            (BIT_10)
//#define    SLP_LDOBTPA_PD_EN        (BIT_12)

#define    SLP_LDOCP_PD_EN            (BIT_4)
#define    SLP_LDOCON_PD_EN            (BIT_3)
#define    SLP_LDOSIM0_PD_EN        (BIT_2)
#define    SLP_LDOANA_PD_EN            (BIT_1)
#define    SLP_LDOMEM_PD_EN            (BIT_0)

/*******************************************************************************
 ** Register Name        : ANA_SLP_LDO_LP_CTRL0/1
 ...
 **************************   Fields Definition *******************************/
#define    SLP_LDORF_LP_EN            (BIT_14)
#define    SLP_LDOMMC_LP_EN            (BIT_12)
#define    SLP_LDODCXO_LP_EN        (BIT_11)
#define    SLP_LDOSPIMEM_LP_EN        (BIT_10)
#define    SLP_LDOVDD28_LP_EN        (BIT_9)
#define    SLP_LDOVIO18_LP_EN        (BIT_8)
#define    SLP_LDODDR12_LP_EN        (BIT_7)
#define    SLP_LDOUSB_LP_EN            (BIT_6)
#define    SLP_LDOLCD_LP_EN            (BIT_5)
#define    SLP_LDOCAMD_LP_EN        (BIT_3)
#define    SLP_LDOCAMA_LP_EN        (BIT_2)
#define    SLP_LDOSIM1_LP_EN        (BIT_0)
//#define    SLP_LDOSIM0_PD_EN        (BIT_0)
//#define    SLP_LDOSF_PD_EN            (BIT_14)
//#define    SLP_LDOSD_PD_EN            (BIT_10)
//#define    SLP_LDOBTPA_PD_EN        (BIT_12)

#define    SLP_LDOCP_LP_EN            (BIT_4)
#define    SLP_LDOCON_LP_EN            (BIT_3)
#define    SLP_LDOSIM0_LP_EN        (BIT_2)
#define    SLP_LDOANA_LP_EN            (BIT_1)
#define    SLP_LDOMEM_LP_EN            (BIT_0)
...
#define    LDO_CORE_SLP_STEP_VOL_SHIFT            (3)
#define    LDO_CORE_SLP_STEP_VOL_MSK               (0x1FUL << LDO_CORE_SLP_STEP_VOL_SHIFT)
#define    LDO_CORE_SLP_STEP_NUM_SHIFT            (8)
#define    LDO_CORE_SLP_STEP_NUM_MSK               (0xFUL << LDO_CORE_SLP_STEP_NUM_SHIFT)
#define    LDO_CORE_SLP_STEP_DELAY_SHIFT         (12)
#define    LDO_CORE_SLP_STEP_DELAY_MSK            (0x3UL << LDO_CORE_SLP_STEP_DELAY_SHIFT)
...
#define    LDO_CORE_V_DS_MSK                           (0x1FFUL << LDO_CORE_V_DS_SHIFT)
...
#define    LDO_VIBR_V_MSK           (0x7UL << LDO_VIBR_V_SHIFT)

/*******************************************************************************
 ** Register Name        : ANA_BTPHY_CTRL
 ** Register Offset      : 0x0144
 ** Register Description : 
 ** Other Reset      : rst_d1
 ** Protect Register : 
 ...
 ** LDO_VIBR_V                  : [7:0] (RW)VIBR LDO program bits: 8'b0 as 1.2V output, 10mV/step,Default output 3.0V
 **************************   Fields Definition *******************************/
#define    SLP_LDOBTPHY_PD_EN        (BIT_9)
#define    LDO_BTPHY_PD                (BIT_8)
#define    LDO_BTPHY_V_SHIFT         (0)
#define    LDO_BTPHY_V_MSK           (0x3FUL << LDO_VIBR_V_SHIFT)
 ...
 ** Protect Register : 
 ** Register field description:
 ** CHGR_CV_V          : [10:5] (RW)Charger battery sense DAC (CC-CV trans-point control)
 ** CHGR_END_V          : [4:3] (RW)Charger battery charging end voltage
                                00: Vend=4.2V
                                01: Vend=4.3V
                                10: Vend=4.4V
                                11: Vend=4.5V
 ...
 **************************   Fields Definition *******************************/
#define    CHGR_CC_EN                   (BIT_12)
#define    CHGR_SW_POINT_SHIFT          (5)
#define    CHGR_SW_POINT_MSK            (0x3FUL << CHGR_SW_POINT_SHIFT)
#define    CHGR_END_V_SHIFT             (3)
#define    CHGR_END_V_MSK               (0x3UL << CHGR_END_V_SHIFT)
#define    CHGR_ITERM_SHIFT             (1)
 ...
 ** Protect Register : 
 ** Register field description:
 ** CHGR_CC_I          : [13:10] (RW)CC mode charging current
                                0000:300mA        0001 : 350
                                0010: 400mA       0011 : 450
                                0100: 500mA       0101 :550
                                0110: 600mA       0111: 650
                                1000: 700mA       1001: 750
                                1010: 800mA       1011: 900mA
                                1100: 1000mA      1101: 1100mA
                                1110: 1200mA      1111: 1300mA
                                Default 4'b0
 ** VCHG_OVP_V          : [1:0] (RW)control bits of over voltage protection for VCHG. When VCHG is above some level set by these 6 bits, charger power down and CHGR_OVI becomes high.
                                  00: 6.0V(protection voltage)   
                                  01: 6.5V
                                  10: 7.0V                                  
                                  11: 9.7V
                                Default 2'01
 ...
 ** BATDET_OK          : [8] (RO)Battery presence flag to SW and POCV, so need RTC domain,"0" no battery,"1" battery presence
...
#define    BATDET_OK_SHIFT            (8)
#define    BATDET_OK_MASK             (BIT_8)
 ...
 ** WDG_RST_PD_EN                 : [7] (RW)Software reset certain power enable when wdg_rst valid
...
#define    ANA_FLASH_PON                                 (BIT_15)
#define    ANA_FLASH_V_SW_SHIFT                   (0)
#define    ANA_FLASH_V_SW_MSK                      (0x7UL << ANA_FLASH_V_SW_SHIFT)
#define    ANA_FLASH_V_HW_STEP_SHIFT         (4)
#define    ANA_FLASH_V_HW_STEP_MSK            (0x3UL << ANA_FLASH_V_HW_STEP_SHIFT)
#define    ANA_FLASH_HW_EN                            (BIT_6)
