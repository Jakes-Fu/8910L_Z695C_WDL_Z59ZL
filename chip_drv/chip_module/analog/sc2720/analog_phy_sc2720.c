...
LOCAL void _ANA_SetKPDBackLight (uint32 value)
{
    ...
    ANA_REG_OR (ANA_MODULE_EN0, RDA2720M_GLOBAL_BLTC_EN);
...
LOCAL CONST ANA_SW_T s_ana_bln_sw_tab[] =
{
    ...
    {355, 370, 0, 90},      // 3.6V  // 13mA
    {365, 380, 0, 90},      // 3.7V  // 16mA
    {375, 480, 0, 95},      // 3.8V  // 20mA
...
LOCAL ANA_DEV_T s_ana_dev_tab[ANA_DEV_ID_MAX] =
{
    ...
    {ANA_DEV_ID_LCM_BL,                     0x2A,     0,      NULL,                        ANA_SW_INDEX_MAX,      _ANA_SetLCMBackLight},
    {ANA_DEV_ID_LCM_BRIGHTNESS,      0x2A,     0,     NULL,                  ANA_SW_INDEX_MAX,       _ANA_SetLCMBrightness},
#else
    {ANA_DEV_ID_LCM_BL,                     0x2E,     0,      NULL,                        ANA_SW_INDEX_MAX,      _ANA_SetLCMBackLight},
    {ANA_DEV_ID_LCM_BRIGHTNESS,      0x2E,     0,     NULL,                  ANA_SW_INDEX_MAX,       _ANA_SetLCMBrightness}, /*lint !e605*/
#endif
#if defined(POP_MDY_SUPPORT)
