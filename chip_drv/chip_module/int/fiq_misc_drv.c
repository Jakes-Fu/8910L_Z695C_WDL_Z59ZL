...
#if defined(PLATFORM_SC6800H)|| defined(PLATFORM_SC6530) || defined(PLATFORM_SC6531EFM) || defined(PLATFORM_UIX8910)
 ...
 **                         Constant Variables                                *
**---------------------------------------------------------------------------*/
#if (defined(PLATFORM_SC6600L) || defined(PLATFORM_SC6800H) || defined(PLATFORM_SC6530) || defined(PLATFORM_SC6531EFM) || defined(PLATFORM_UIX8910))
