...
#define    ANA_PIN_A2D_SYNC_REG        ANA_REG_ADDR(0x0004)  
#define    ANA_PIN_ADI_D_REG           ANA_REG_ADDR(0x0008)  
#define    ANA_PIN_ADI_SCLK_REG        ANA_REG_ADDR(0x000C)  
#define    ANA_PIN_ADI_SYNC_REG        ANA_REG_ADDR(0x0010)  
#define    ANA_PIN_ANA_INT_REG         ANA_REG_ADDR(0x0014)  
#define    ANA_PIN_APCD_REG            ANA_REG_ADDR(0x0018)  
#define    ANA_PIN_APCSYNC_REG         ANA_REG_ADDR(0x001C)  
#define    ANA_PIN_AUD_ADD0_REG        ANA_REG_ADDR(0x0020)  
#define    ANA_PIN_AUD_ADSYNC_REG      ANA_REG_ADDR(0x0024)  
#define    ANA_PIN_AUD_DAD0_REG        ANA_REG_ADDR(0x0028)  
#define    ANA_PIN_AUD_DAD1_REG        ANA_REG_ADDR(0x002C)  
#define    ANA_PIN_AUD_DASYNC_REG      ANA_REG_ADDR(0x0030)  
#define    ANA_PIN_CHIP_SLEEP_REG      ANA_REG_ADDR(0x0034)  
#define    ANA_PIN_CLK_32K_REG         ANA_REG_ADDR(0x0038)  
#define    ANA_PIN_CLK_ITF_REG         ANA_REG_ADDR(0x003C)  
#define    ANA_PIN_D2A_SYNC_REG        ANA_REG_ADDR(0x0040)  
#define    ANA_PIN_EXT_RST_B_REG       ANA_REG_ADDR(0x0044)  
#define    ANA_PIN_GSMTXD_REG          ANA_REG_ADDR(0x0048)  
#define    ANA_PIN_IF_SPR_REG          ANA_REG_ADDR(0x004C)  
#define    ANA_PIN_PBINT_REG           ANA_REG_ADDR(0x0050)  
#define    ANA_PIN_PTEST_REG           ANA_REG_ADDR(0x0054)  
#define    ANA_PIN_RFSCK_REG           ANA_REG_ADDR(0x0058)  
#define    ANA_PIN_RFSDA_REG           ANA_REG_ADDR(0x005C)  
#define    ANA_PIN_RFSEN_REG           ANA_REG_ADDR(0x0060)  
#define    ANA_PIN_RXID0_REG           ANA_REG_ADDR(0x0064)  
#define    ANA_PIN_RXID1_REG           ANA_REG_ADDR(0x0068)  
#define    ANA_PIN_RXQD0_REG           ANA_REG_ADDR(0x006C)  
#define    ANA_PIN_RXQD1_REG           ANA_REG_ADDR(0x0070)  
#define    ANA_PIN_TESTRSTN_REG        ANA_REG_ADDR(0x0074)  
#define    ANA_PIN_TP_XL_REG           ANA_REG_ADDR(0x0078)  
#define    ANA_PIN_TP_XR_REG           ANA_REG_ADDR(0x007C)  
#define    ANA_PIN_TP_YD_REG           ANA_REG_ADDR(0x0080)  
#define    ANA_PIN_TP_YU_REG           ANA_REG_ADDR(0x0084)  
#define    ANA_PIN_XTL_BUF_EN_REG      ANA_REG_ADDR(0x0088)  
