...
#define AP_IFC_CH_ENABLE_MASK      (0x7F<<0)
#define AP_IFC_CH_ENABLE_SHIFT     (0)
#define AP_IFC_CH_BUSY(n)          (((n)&0x7F)<<16)
#define AP_IFC_CH_BUSY_MASK        (0x7F<<16)
#define AP_IFC_CH_BUSY_SHIFT       (16)

//debug_status
#define AP_IFC_DBG_STATUS          (1<<0)
#define AP_IFC_DBG_STATUS_MASK     (1<<0)
#define AP_IFC_DBG_STATUS_SHIFT    (0)

//control
#define AP_IFC_ENABLE              (1<<0)
#define AP_IFC_ENABLE_MASK         (1<<0)
#define AP_IFC_ENABLE_SHIFT        (0)
#define AP_IFC_DISABLE             (1<<1)
#define AP_IFC_DISABLE_MASK        (1<<1)
#define AP_IFC_DISABLE_SHIFT       (1)
#define AP_IFC_RD_HW_EXCH          (1<<2)
#define AP_IFC_RD_HW_EXCH_MASK     (1<<2)
#define AP_IFC_RD_HW_EXCH_SHIFT    (2)
#define AP_IFC_WR_HW_EXCH          (1<<3)
#define AP_IFC_WR_HW_EXCH_MASK     (1<<3)
#define AP_IFC_WR_HW_EXCH_SHIFT    (3)
#define AP_IFC_AUTODISABLE         (1<<4)
#define AP_IFC_AUTODISABLE_MASK    (1<<4)
#define AP_IFC_AUTODISABLE_SHIFT   (4)
#define AP_IFC_SIZE                (1<<5)
#define AP_IFC_SIZE_MASK           (1<<5)
#define AP_IFC_SIZE_SHIFT          (5)
...
#define AP_IFC_REQ_SRC_AP_APB_DMA_ID_SPI_3_TX (8<<8)
#define AP_IFC_REQ_SRC_AP_APB_DMA_ID_SPI_3_RX (9<<8)
#define AP_IFC_REQ_SRC_AP_APB_DMA_ID_10_RESERVED (10<<8)
#define AP_IFC_REQ_SRC_AP_APB_DMA_ID_11_RESERVED (11<<8)
...
#define AP_IFC_REQ_SRC_V_AP_APB_DMA_ID_SPI_3_TX (8)
#define AP_IFC_REQ_SRC_V_AP_APB_DMA_ID_SPI_3_RX (9)
#define AP_IFC_REQ_SRC_V_AP_APB_DMA_ID_10_RESERVED (10)
#define AP_IFC_REQ_SRC_V_AP_APB_DMA_ID_11_RESERVED (11)
...
#define AP_IFC_FLUSH_MASK          (1<<16)
#define AP_IFC_FLUSH_SHIFT         (16)
...
#define AP_IFC_FIFO_EMPTY_MASK     (1<<4)
#define AP_IFC_FIFO_EMPTY_SHIFT    (4)

//start_addr
#define AP_IFC_START_ADDR(n)       (((n)&0xFFFFFFFF)<<0)
#define AP_IFC_START_ADDR_MASK     (0xFFFFFFFF<<0)
#define AP_IFC_START_ADDR_SHIFT    (0)

//tc
#define AP_IFC_TC(n)               (((n)&0x7FFFFF)<<0)
#define AP_IFC_TC_MASK             (0x7FFFFF<<0)
#define AP_IFC_TC_SHIFT            (0)
...
#define AP_IFC_FIFO_LEVEL_MASK     (31<<8)
#define AP_IFC_FIFO_LEVEL_SHIFT    (8)

//ch_rfspi_start_addr
#define AP_IFC_START_AHB_ADDR(n)   (((n)&0xFFFFFFFF)<<0)
#define AP_IFC_START_AHB_ADDR_MASK (0xFFFFFFFF<<0)
#define AP_IFC_START_AHB_ADDR_SHIFT (0)

//ch_rfspi_end_addr
#define AP_IFC_END_AHB_ADDR(n)     (((n)&0xFFFFFFFF)<<0)
#define AP_IFC_END_AHB_ADDR_MASK   (0xFFFFFFFF<<0)
#define AP_IFC_END_AHB_ADDR_SHIFT  (0)

//ch_rfspi_tc
#define AP_IFC_TC_X1(n)            (((n)&0x3FFF)<<0)
#define AP_IFC_TC_MASK_X1          (0x3FFF<<0)
//#define AP_IFC_TC_SHIFT          (0)
...
#define AUDIO_IFC_ENABLE_MASK      (1<<0)
#define AUDIO_IFC_ENABLE_SHIFT     (0)
#define AUDIO_IFC_DISABLE          (1<<1)
#define AUDIO_IFC_DISABLE_MASK     (1<<1)
#define AUDIO_IFC_DISABLE_SHIFT    (1)
#define AUDIO_IFC_AUTO_DISABLE     (1<<4)
#define AUDIO_IFC_AUTO_DISABLE_MASK (1<<4)
#define AUDIO_IFC_AUTO_DISABLE_SHIFT (4)
...
#define AUDIO_IFC_FIFO_EMPTY_MASK  (1<<4)
#define AUDIO_IFC_FIFO_EMPTY_SHIFT (4)
#define AUDIO_IFC_CAUSE_IEF        (1<<8)
#define AUDIO_IFC_CAUSE_IEF_MASK   (1<<8)
#define AUDIO_IFC_CAUSE_IEF_SHIFT  (8)
#define AUDIO_IFC_CAUSE_IHF        (1<<9)
#define AUDIO_IFC_CAUSE_IHF_MASK   (1<<9)
#define AUDIO_IFC_CAUSE_IHF_SHIFT  (9)
#define AUDIO_IFC_CAUSE_I4F        (1<<10)
#define AUDIO_IFC_CAUSE_I4F_MASK   (1<<10)
#define AUDIO_IFC_CAUSE_I4F_SHIFT  (10)
#define AUDIO_IFC_CAUSE_I3_4F      (1<<11)
#define AUDIO_IFC_CAUSE_I3_4F_MASK (1<<11)
#define AUDIO_IFC_CAUSE_I3_4F_SHIFT (11)
#define AUDIO_IFC_CAUSE_AHB_ERROR  (1<<12)
#define AUDIO_IFC_CAUSE_AHB_ERROR_MASK (1<<12)
#define AUDIO_IFC_CAUSE_AHB_ERROR_SHIFT (12)
#define AUDIO_IFC_IEF              (1<<16)
#define AUDIO_IFC_IEF_MASK         (1<<16)
#define AUDIO_IFC_IEF_SHIFT        (16)
#define AUDIO_IFC_IHF              (1<<17)
#define AUDIO_IFC_IHF_MASK         (1<<17)
#define AUDIO_IFC_IHF_SHIFT        (17)
#define AUDIO_IFC_I4F              (1<<18)
#define AUDIO_IFC_I4F_MASK         (1<<18)
#define AUDIO_IFC_I4F_SHIFT        (18)
#define AUDIO_IFC_I3_4F            (1<<19)
#define AUDIO_IFC_I3_4F_MASK       (1<<19)
#define AUDIO_IFC_I3_4F_SHIFT      (19)
#define AUDIO_IFC_AHB_ERROR        (1<<20)
#define AUDIO_IFC_AHB_ERROR_MASK   (1<<20)
#define AUDIO_IFC_AHB_ERROR_SHIFT  (20)
#define AUDIO_IFC_CH_IDLE          (1<<21)
#define AUDIO_IFC_CH_IDLE_MASK     (1<<21)
#define AUDIO_IFC_CH_IDLE_SHIFT    (21)

//start_addr
#define AUDIO_IFC_START_ADDR(n)    (((n)&0x3FFFFFFF)<<2)
#define AUDIO_IFC_START_ADDR_MASK  (0x3FFFFFFF<<2)
#define AUDIO_IFC_START_ADDR_SHIFT (2)

//Fifo_Size
#define AUDIO_IFC_FIFO_SIZE(n)     (((n)&0xFFFF)<<4)
#define AUDIO_IFC_FIFO_SIZE_MASK   (0xFFFF<<4)
#define AUDIO_IFC_FIFO_SIZE_SHIFT  (4)

//int_mask
#define AUDIO_IFC_END_FIFO         (1<<8)
#define AUDIO_IFC_END_FIFO_MASK    (1<<8)
#define AUDIO_IFC_END_FIFO_SHIFT   (8)
#define AUDIO_IFC_HALF_FIFO        (1<<9)
#define AUDIO_IFC_HALF_FIFO_MASK   (1<<9)
#define AUDIO_IFC_HALF_FIFO_SHIFT  (9)
#define AUDIO_IFC_QUARTER_FIFO     (1<<10)
#define AUDIO_IFC_QUARTER_FIFO_MASK (1<<10)
#define AUDIO_IFC_QUARTER_FIFO_SHIFT (10)
#define AUDIO_IFC_THREE_QUARTER_FIFO (1<<11)
#define AUDIO_IFC_THREE_QUARTER_FIFO_MASK (1<<11)
#define AUDIO_IFC_THREE_QUARTER_FIFO_SHIFT (11)
#define AUDIO_IFC_AHB_ERROR_X1     (1<<12)
#define AUDIO_IFC_AHB_ERROR_MASK_X1 (1<<12)
#define AUDIO_IFC_AHB_ERROR_SHIFT_X1 (12)
...
#define AUDIO_IFC_CUR_AHB_ADDR_MASK (0xFFFFFFFF<<0)
#define AUDIO_IFC_CUR_AHB_ADDR_SHIFT (0)
