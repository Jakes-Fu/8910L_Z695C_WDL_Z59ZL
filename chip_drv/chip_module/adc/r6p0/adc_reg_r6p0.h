...
#define ADC_CTL0                        (ADC_REG_BASE + 0x00B0)
...
// SW & HW SCALE
#define ADC_CH_SCALE_1V2                0
#define ADC_CH_SCALE_2V4                1
#define ADC_CH_SCALE_3V                 2
#define ADC_CH_SCALE_5V                 3
#define ADC_CH_SCALE_SHIFT              9 //[09:10]
#define ADC_CH_SCALE_MASK               (0x3<<ADC_CH_SCALE_SHIFT)
