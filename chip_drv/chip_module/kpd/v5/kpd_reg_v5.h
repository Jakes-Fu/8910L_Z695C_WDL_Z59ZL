...
#define KPD_ROW_EN_SHIFT                18
#define KPD_ROW_EN_MSK                  (0x3F << KPD_ROW_EN_SHIFT)
#define KPD_COL_EN_SHIFT                10
#define KPD_COL_EN_MSK                  (0x3F << KPD_COL_EN_SHIFT)
#elif defined(PLATFORM_SC6531EFM) || defined(PLATFORM_UIX8910)
#define KPD_ROW_EN_SHIFT                16
#define KPD_ROW_EN_MSK                  (0x1F << KPD_ROW_EN_SHIFT)
#define KPD_COL_EN_SHIFT                8
#define KPD_COL_EN_MSK                  (0xFF << KPD_COL_EN_SHIFT)
#endif

#ifdef PLATFORM_SC6530
#define KPD_FIRST_ROW_EN                2
#define KPD_FIRST_COL_EN                2
#endif
