 ...
 ******************************************************************************/
#ifndef _USB_REG_R3P0_H_
#define _USB_REG_R3P0_H_
/*----------------------------------------------------------------------------*
 **                         Dependencies                                      *
 **------------------------------------------------------------------------- */
...
#define USB_CTRL_END                        0x903FFFFF
#else
#define USB_EP0_OUT_FIFO                (USB_REG_BASE + 0x80020)
#define USB_EP2_FIFO                    (USB_REG_BASE + 0x80024)
#define USB_EP4_FIFO                    (USB_REG_BASE + 0x80028)
...
#define USB_INT_STS_MASK						0x1F00
