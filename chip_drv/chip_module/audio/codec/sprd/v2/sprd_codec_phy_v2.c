...
//SC2720_ANA_PMU1
PRIVATE SC2720_ANA_PMU1_T g_SC2720_ANA_PMU1;

PUBLIC void aud_CodecSC2720SetHeadmicBiasV(SC2720_HEADMIC_BIAS_TYPE_T vol)
{
    g_SC2720_ANA_PMU1.reg = ADI_Analogdie_reg_read(SC2720_ANA_PMU1);
    g_SC2720_ANA_PMU1.reg_t.HMIC_BIAS_V = SC2720_RG_AUD_HMIC_BIAS_V(vol);
    ADI_Analogdie_reg_write(SC2720_ANA_PMU1, g_SC2720_ANA_PMU1.reg);
...
PUBLIC  AUD_HEADSET_TYPE_T aud_CodecSC2720HeadsetMicAndButtonDetect(VOID)
{
    ...
    SC2720_HEADSET_TYPE_T type = UNKNOWN_MIC_TYPE;

    type = __sprd_codec_ap_headmic_type_detect();
    if(type == HEADSET_4POLE_NORMAL)
    {
