...
#elif defined (PLATFORM_SC6530) || defined(PLATFORM_SC6531EFM) || defined(PLATFORM_UIX8910) 
...
{
#if defined(PLATFORM_SC8800G) || defined(PLATFORM_UIX8910)
