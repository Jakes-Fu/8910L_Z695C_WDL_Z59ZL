...
#define REG_PWRCTRL_AP_PWR_STAT       0x0000001C
#define REG_PWRCTRL_ZSP_PWR_STAT      0x00000020
#define REG_PWRCTRL_LTE_PWR_STAT      0x00000024
#define REG_PWRCTRL_GGE_PWR_STAT      0x00000028
#define REG_PWRCTRL_RF_PWR_STAT       0x0000002C
#define REG_PWRCTRL_BTFM_PWR_STAT     0x00000030
#define REG_PWRCTRL_STATE_DELAY       0x00000034
#define REG_PWRCTRL_PREPGC_DELAY      0x00000038
#define REG_PWRCTRL_ALLPGC_DELAY      0x0000003C
#define REG_PWRCTRL_DDR_HOLD_CTRL     0x00000040
#define REG_PWRCTRL_ZSP_PD_POLL       0x00000044
#define REG_PWRCTRL_ZSP_PD_POLL_SET    0x00000048
#define REG_PWRCTRL_ZSP_PD_POLL_CLR    0x0000004C
#define REG_PWRCTRL_PD_PLL_SW         0x00000050
#define REG_PWRCTRL_PD_PLL_SW_SET     0x00000054
#define REG_PWRCTRL_PD_PLL_SW_CLR     0x00000058
#define REG_PWRCTRL_PD_PLL_SEL        0x0000005C
#define REG_PWRCTRL_PD_PLL_SEL_SET    0x00000060
#define REG_PWRCTRL_PD_PLL_SEL_CLR    0x00000064
#define REG_PWRCTRL_IDLE_CG_SW        0x00000068
#define REG_PWRCTRL_IDLE_CG_SW_SET    0x0000006C
#define REG_PWRCTRL_IDLE_CG_SW_CLR    0x00000070
#define REG_PWRCTRL_IDLE_CG_SEL       0x00000074
#define REG_PWRCTRL_IDLE_CG_SEL_SET    0x00000078
#define REG_PWRCTRL_IDLE_CG_SEL_CLR    0x0000007C
#define REG_PWRCTRL_RF_IDLE_ENABLE_SW    0x00000080
#define REG_PWRCTRL_RF_IDLE_ENABLE_SEL    0x00000084
#define REG_PWRCTRL_WCN_LPS           0x00000088
#define REG_PWRCTRL_ARM_SLP_REQ_SW    0x0000008C
#define REG_PWRCTRL_ARM_SLP_ACK       0x00000090
#define REG_PWRCTRL_ARM_SLP_REQ_HWEN    0x00000094
#define REG_PWRCTRL_ZSP_SLP_REQ_SW    0x00000098
#define REG_PWRCTRL_ZSP_SLP_ACK       0x0000009C
#define REG_PWRCTRL_ZSP_SLP_REQ_HWEN    0x000000A0
#define REG_PWRCTRL_DDR_SLP_REQ_SW    0x000000A4
#define REG_PWRCTRL_DDR_SLP_ACK       0x000000A8
#define REG_PWRCTRL_DDR_SLP_REQ_HWEN    0x000000AC
#define REG_PWRCTRL_TIMEOUT_FLAG      0x000000B0
#define REG_PWRCTRL_POWER_STATE       0x000000B4
#define REG_PWRCTRL_PWRCTRL_MODE      0x000000B8
#define REG_PWRCTRL_PWRCTRL_SW        0x000000BC
#define REG_PWRCTRL_PWRCTRL_SW_SET    0x000000C0
#define REG_PWRCTRL_PWRCTRL_SW_CLR    0x000000C4
#define REG_PWRCTRL_SLOW_SYS_CLK_SEL_HWEN    0x000000C8
#define REG_PWRCTRL_SLOW_CLK_SEL_HWEN    0x000000CC
