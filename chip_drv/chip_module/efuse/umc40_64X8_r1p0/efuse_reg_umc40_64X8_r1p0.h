...
#ifndef _EFUSE_REG_UMC40_64X8_R1P0_H
#define _EFUSE_REG_UMC40_64X8_R1P0_H
...
#define    EFUSE_READ_INDEX_MSK                     (0xF << EFUSE_READ_INDEX_SHIFT)
#define    EFUSE_PGM_INDEX_SHIFT                    (16)
#define    EFUSE_PGM_INDEX_MSK                      (0xF << EFUSE_PGM_INDEX_SHIFT)
#define    EFUSE_BIST_START_INDEX_SHIFT             (24)
#define    EFUSE_BIST_START_INDEX_MSK               (0xF << EFUSE_BIST_START_INDEX_SHIFT)
#define    EFUSE_BIST_SIZE_SHIFT                    (28)
#define    EFUSE_BIST_SIZE_MSK                      (0xFUL << EFUSE_BIST_SIZE_SHIFT)
...
#endif //_EFUSE_REG_UMC40_64X8_R1P0_H
