...
#elif defined(PLATFORM_SC6800H) || defined(PLATFORM_SC6530) || defined(PLATFORM_SC6531EFM) || defined(PLATFORM_UIX8910)
...
//      Enable CS0 Cache
/*****************************************************************************/
PUBLIC void EMC_EnableCache (void);
...
//      Disable CS0 Cache
/*****************************************************************************/
PUBLIC void EMC_DisableCache (void);
...
//move emc_phy_vxxx.c to emc_drvapi.h because of pclint warning
