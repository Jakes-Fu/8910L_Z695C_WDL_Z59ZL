...
#define BAUD_2000000            0x000D
#endif
#define BAUD_3250000            0x0004
#if defined(PLATFORM_UIX8910)
#define BAUD_8000000            0x0003
#endif
...
PUBLIC void UART_DmaWriteData (uint32 port_num, const uint8 *buffer, uint32 length, uint32 channel);
