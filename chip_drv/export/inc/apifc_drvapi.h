...
#define     APIFC_SDMMC1_TX_CH         (0)
#define     APIFC_SDMMC1_RX_CH         (1)
#define     APIFC_CAMERA_RX_CH         (2)
#define     APIFC_SCI1_TX_CH               (3)
#define     APIFC_SCI1_RX_CH               (4)
#define     APIFC_SCI2_TX_CH               (5)
#define     APIFC_SCI2_RX_CH               (6)

#define     APIFC_REQUESTID_NUM       (0x14)

/// IFC transaction type Id
typedef enum {
/// Sending data to the sdmmc1
    HAL_IFC_SDMMC1_TX = 0,
/// Receiving data from the sdmmc1
    HAL_IFC_SDMMC1_RX,
/// Sending data to the sdmmc2
    HAL_IFC_SDMMC2_TX,
/// Receiving data from the sdmmc2
    HAL_IFC_SDMMC2_RX,
/// Sending data to the SPI1
    HAL_IFC_SPI1_TX,
/// Receiving data from the SPI1
    HAL_IFC_SPI1_RX,
/// Sending data to the SPI2
    HAL_IFC_SPI2_TX,
/// Receiving data from the SPI2
    HAL_IFC_SPI2_RX,
/// Sending data to the SPI3
    HAL_IFC_SPI3_TX,
/// Receiving data from the SPI3
    HAL_IFC_SPI3_RX,
/// Sending data to FREE TX
    HAL_IFC_FREE_TX = 0x12,
