...
#define CS_LANG_PUNJABI         81
#define CS_LANG_GUJARATI        82
#define CS_LANG_ORIYA           83
#define CS_LANG_KANNADA         84
#define CS_LANG_MALAYALAM       85

#define CS_LANG_KHMER           86
#define CS_LANG_LAO             87

#define CS_LANG_AMHARIC         88
#define CS_LANG_ASSAMESE        71
#define CS_LANG_NEPALI          72
#define CS_LANG_TIBETAN         73
...
extern const CS_IME_INFO cs_ldb_croatian;
...
extern const CS_IME_INFO cs_ldb_punjabi;
extern const CS_IME_INFO cs_ldb_gujarati;
extern const CS_IME_INFO cs_ldb_oriya;
extern const CS_IME_INFO cs_ldb_kannada;
extern const CS_IME_INFO cs_ldb_malayalam;
extern const CS_IME_INFO cs_ldb_myanmar;
extern const CS_IME_INFO cs_ldb_khmer;
extern const CS_IME_INFO cs_ldb_lao;
extern const CS_IME_INFO cs_ldb_amharic;
extern const CS_IME_INFO cs_ldb_nepali;
extern const CS_IME_INFO cs_ldb_assamese;
extern const CS_IME_INFO cs_ldb_tibetan;
...
#define CS_PINYIN_MODE_1                0x0000      /* user can edit pinyin, the "star" key is iterator choice */
#define CS_PINYIN_MODE_2                0x0001      /* user can't edit pinyin, user can't step candidates */
#define CS_PINYIN_MODE_3                0x0002      /* user can't edit pinyin, user can step candidates */
#define CS_PINYIN_MODE_4                0x0003      /* user can't edit pinyin, user can step candidates */
#define CS_PINYIN_MODE_5                0x0004      /* bird mode */
...
#define CS_ZHUYIN_SYMBOL_AS_CAND_OFF    0
#define CS_ZHUYIN_SYMBOL_AS_CAND_ON    1
...
typedef struct
{
    ...
    const CS_QWERTY_INFO              *pQwertyInfo;
