...
typedef struct FT_GlyphItemRec
{
	...
	FT_UInt16 update_advance;  ///< update advance if set
...
/// \param[in] crochetWidth ::Specify the added width value if font style is crochet.
...
///////////////////////////////////////////////////////////////
int FT_Text_Layout_Text_Lines( FT_TextLayout text_layout, FT_Shaper shaper, int boldWidth, int crochetWidth, int tabWidth, 
							   int fontheight, int rWidth,  int rHeight, int widthGap, int heightGap, int byWord );
...
int FT_GetLsbZawgyi(FT_Face face, FT_UInt32 index);
FT_Fixed FT_GetAdvanceZawgyi(FT_Face face, FT_UInt32 index);
...
FT_F26Dot6 FT_Text_Layout_Get_Item_Width( FT_TextLayout text_layout, int item );
int FT_Text_Layout_Get_Item_Length( FT_TextLayout text_layout, int item );
...
int FT_Text_Layout_Text_Width( FT_TextLayout text_layout, int boldWidth, int crochetWidth, int tabWidth, int widthGap );
