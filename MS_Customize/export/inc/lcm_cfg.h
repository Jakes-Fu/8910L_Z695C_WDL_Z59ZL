...
#define LCD_DRV_ID_GC9304                      0x009304

#define LCD_DRV_ID_GC9300                     0x009300


#define LCD_DRV_ID_GC9310                     0x9310 // 0x9281f5    
#define LCD_DRV_ID_GC9307                     0x9307 // 0x9281f5    
#define LCD_DRV_ID_JD9851                      0x1c90f5   //0x9290f5
#define LCD_DRV_ID_JD9851_2                    0x9290f5
#define LCD_DRV_ID_JD9851_3                    0x99ffff

#define LCD_DRV_ID_ST7789V2                    0x858552    // FIHNJ
#define LCD_DRV_ID_ILI9340                     0xE30000    // FIHNJ
#define LCD_DRV_ID_ST7789V3                    0x1c81F5    // FIH 0x3e81f5
#define LCD_DRV_ID_ST7789V4                    0x3e80F5    // FIH 0x3e81f5
#define LCD_DRV_ID_ST7789V5                    0x1c80F5    // FIH 0x3e81f5
#define LCD_DRV_ID_ST7789V6                    0x8181b3    // FIH 0x3e81f5
/**---------------------------------------------------------------------------*
...
extern const LCD_SPEC_T g_lcd_GC9310;
extern const LCD_SPEC_T g_lcd_ST7789v2;
extern const LCD_SPEC_T g_lcd_ILI9340;
extern const LCD_SPEC_T g_lcd_JD9851;
extern const LCD_SPEC_T g_lcd_GC9304;
extern const LCD_SPEC_T g_lcd_GC9300;
