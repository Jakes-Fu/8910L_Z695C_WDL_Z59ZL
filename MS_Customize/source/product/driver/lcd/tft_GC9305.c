...
LOCAL ERR_LCD_E GC9305_Init(void)
{
...
#if 0  // use gc9305 spi org init code 
    ...
    LCD_DataWrite_GC9305(0x37);
    LCD_DataWrite_GC9305(0x04);
    LCD_DataWrite_GC9305(0x04);
    LCD_DataWrite_GC9305(0x4b);
    ...
    if(gc9305_farmk == ENABLE_FMARK_LCD)
    {
