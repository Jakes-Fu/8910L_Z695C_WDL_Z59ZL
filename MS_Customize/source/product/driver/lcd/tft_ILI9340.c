...
//hal_GoudaChangeSerialMode(HAL_GOUDA_SPI_LINE_3);
    ...
    LCD_DataWrite_ILI9340((newleft>>8)&0xff); // left high 8 b
    LCD_DataWrite_ILI9340(newleft&0xff); // left low 8 b
    LCD_DataWrite_ILI9340((newright>>8)&0xff); // right high 8 b
...
//---------------------------------------------------------------------------------------------------//
 ...
 //////////////  Ð…Ñ€â„–ÑŠÐÑŽM16 OK
  ...
  /////CTC2.4+ILI9340X///
    ...
    //LCD_CtrlWrite_ILI9340(0xC6);  //2LANE
    //LCD_DataWrite_ILI9340(0x20);



    LCD_CtrlWrite_ILI9340(0xB4);      //  //2 dot inversion
    LCD_DataWrite_ILI9340(0x80);

    LCD_CtrlWrite_ILI9340(0xB7);        //pump ratio 1 
	...
	LCD_CtrlWrite_ILI9340(0xB1); // Frame¿ØÖÆ 
	LCD_DataWrite_ILI9340(0x00); 
	LCD_DataWrite_ILI9340(0x18); //0x17 81hz //0x18 79hz //0x1a 72hz //0x1f 60hz
    LCD_CtrlWrite_ILI9340(0xBA);        //P1=VCOM P2=VRH P3=VDV 
	LCD_DataWrite_ILI9340(0x20); //VCOM ÓÅ»¯Íø¸ñÎÆ£¨fliker£© 15  2D
	LCD_DataWrite_ILI9340(0x15); //VRH£¬ÓÅ»¯¶Ô±È¶È  10	1B  15
    LCD_DataWrite_ILI9340(0x21);

    LCD_CtrlWrite_ILI9340(0xBB);        //P1=VGH&VGL
	LCD_DataWrite_ILI9340(0x74); 
	LCD_DataWrite_ILI9340(0x66); //66
    LCD_DataWrite_ILI9340(0x33);

    LCD_CtrlWrite_ILI9340(0xCD);        //pump ratio 2
	LCD_DataWrite_ILI9340(0x44); 
	LCD_DataWrite_ILI9340(0x44); 
	LCD_DataWrite_ILI9340(0x44); 
    ...
    LCD_CtrlWrite_ILI9340(0xE9);        //
    LCD_DataWrite_ILI9340(0x40);
    LCD_DataWrite_ILI9340(0x84);
    LCD_DataWrite_ILI9340(0x65);
    LCD_DataWrite_ILI9340(0x30);
	LCD_CtrlWrite_ILI9340(0xc0); 
    LCD_DataWrite_ILI9340(0x00);
	LCD_DataWrite_ILI9340(0xff);
    LCD_DataWrite_ILI9340(0x33);
    LCD_DataWrite_ILI9340(0x88);

    LCD_CtrlWrite_ILI9340(0xEA);        //Gate pulse modulation
	LCD_DataWrite_ILI9340(0x02); 
	...
	LCD_CtrlWrite_ILI9340(0xf2); 
    LCD_DataWrite_ILI9340(0x00);
    LCD_DataWrite_ILI9340(0x00);

	LCD_CtrlWrite_ILI9340(0xf5); 
    LCD_DataWrite_ILI9340(0x00);

    LCD_CtrlWrite_ILI9340(0xE4);        //P gamma
    LCD_DataWrite_ILI9340(0x00);
	LCD_DataWrite_ILI9340(0x02); 
    LCD_DataWrite_ILI9340(0x08);
    LCD_DataWrite_ILI9340(0x08);
	LCD_DataWrite_ILI9340(0x16); 
	LCD_DataWrite_ILI9340(0x0B);
    LCD_DataWrite_ILI9340(0x3A);
	LCD_DataWrite_ILI9340(0x57); 
	LCD_DataWrite_ILI9340(0x4A); 
	LCD_DataWrite_ILI9340(0x05); 
	LCD_DataWrite_ILI9340(0x0E); 
	LCD_DataWrite_ILI9340(0x0B); 
	LCD_DataWrite_ILI9340(0x1B); 
	LCD_DataWrite_ILI9340(0x1D); 
	LCD_DataWrite_ILI9340(0x02); 

    LCD_CtrlWrite_ILI9340(0xE5);        //N gamma
    LCD_DataWrite_ILI9340(0x00);
	LCD_DataWrite_ILI9340(0x02); 
	LCD_DataWrite_ILI9340(0x08); 
	LCD_DataWrite_ILI9340(0x06); 
	LCD_DataWrite_ILI9340(0x14); 
	...
	LCD_CtrlWrite_ILI9340(0xBA);
	LCD_DataWrite_ILI9340(0x4C);//VCOMä¼˜åŒ–ç½‘æ ¼çº¹ï¼ˆflikerï¼?6
	LCD_DataWrite_ILI9340(0x15);//VRHï¼Œä¼˜åŒ–å¯¹æ¯”åº¦  10
...
/***********/
////æ³¨æ„ï¼ï¼SPI 3çº?é€šé“æŽ¥å£å±?è¯·æ‰“å¼€C6å¯„å­˜å™? ä¸æ˜¯è¯·å…³æŽ?//	LCD_CtrlWrite_ILI9340(0xC6);//  //2 Lane SPI Mode Selection
	LCD_DataWrite_ILI9340(0x02);//00:1 LANE 02:2 LANE
	/***********/
