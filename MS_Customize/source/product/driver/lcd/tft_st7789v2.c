...
LOCAL void ST7789v2_Init(void)
{
	...
	int j;
#if 0
    SCI_TraceLow_Test("lcd: ST7789v2_Init otp 2 ");
...
LCD_DataWrite_ST7789v2(0x13);    
LCD_CtrlWrite_ST7789v2( 0xC4);     
LCD_DataWrite_ST7789v2( 0x20);   
LCD_CtrlWrite_ST7789v2( 0xC6);     
LCD_DataWrite_ST7789v2( 0x0F);   
...
LCD_DataWrite_ST7789v2( 0x0C);
LCD_DataWrite_ST7789v2( 0x07);
LCD_DataWrite_ST7789v2( 0x37);
LCD_DataWrite_ST7789v2( 0x53);
LCD_DataWrite_ST7789v2( 0x4C);
LCD_DataWrite_ST7789v2( 0x39);
LCD_DataWrite_ST7789v2( 0x15);
LCD_DataWrite_ST7789v2( 0x15);
LCD_DataWrite_ST7789v2( 0x2A);
LCD_DataWrite_ST7789v2( 0x2D);
...
LCD_DataWrite_ST7789v2( 0x08);
LCD_DataWrite_ST7789v2( 0x15);
LCD_DataWrite_ST7789v2( 0x34);
LCD_DataWrite_ST7789v2( 0x34);
LCD_DataWrite_ST7789v2( 0x4A);
LCD_DataWrite_ST7789v2( 0x36);
LCD_DataWrite_ST7789v2( 0x12);
LCD_DataWrite_ST7789v2( 0x13);
LCD_DataWrite_ST7789v2( 0x2B);
LCD_DataWrite_ST7789v2( 0x2F);   
...
LCD_CtrlWrite_ST7789v2(0xbb); 
LCD_DataWrite_ST7789v2(0x35); //2b  //CTC2.4=35   CTC2.8=2b
LCD_CtrlWrite_ST7789v2(0xc0); 
LCD_DataWrite_ST7789v2(0x2c); 
LCD_CtrlWrite_ST7789v2(0xc2); 
LCD_DataWrite_ST7789v2(0x01); 
LCD_CtrlWrite_ST7789v2(0xc3); //vrh
LCD_DataWrite_ST7789v2(0x0D); //17   CTC2.4=0D   CTC2.8=16
LCD_CtrlWrite_ST7789v2(0xc4); //vdv
LCD_DataWrite_ST7789v2(0x21); //20   CTC2.4=21   CTC2.8=24
LCD_CtrlWrite_ST7789v2(0xc6); 
LCD_DataWrite_ST7789v2(0x15); 

LCD_CtrlWrite_ST7789v2(0xca); 
LCD_DataWrite_ST7789v2(0x0f); 
LCD_CtrlWrite_ST7789v2(0xc8); 
LCD_DataWrite_ST7789v2(0x08); 
    ////LCD_CtrlWrite_ST7789v2(0x55); 
    ////LCD_DataWrite_ST7789v2(0x90); 
LCD_CtrlWrite_ST7789v2(0xd0); 
LCD_DataWrite_ST7789v2(0xa4); 
LCD_DataWrite_ST7789v2(0xa1); 
...
LCD_DataWrite_ST7789v2(0x10); 
LCD_DataWrite_ST7789v2(0x12); 
LCD_DataWrite_ST7789v2(0x1b); 
LCD_DataWrite_ST7789v2(0x39); 
LCD_DataWrite_ST7789v2(0x44); 
LCD_DataWrite_ST7789v2(0x47); 
LCD_DataWrite_ST7789v2(0x28); 
LCD_DataWrite_ST7789v2(0x12); 
LCD_DataWrite_ST7789v2(0x10); 
LCD_DataWrite_ST7789v2(0x16); 
LCD_DataWrite_ST7789v2(0x1b); 
LCD_CtrlWrite_ST7789v2(0xe1); 
LCD_DataWrite_ST7789v2(0xf0); 
LCD_DataWrite_ST7789v2(0x00); 
LCD_DataWrite_ST7789v2(0x0a); 
LCD_DataWrite_ST7789v2(0x10); 
LCD_DataWrite_ST7789v2(0x11); 
LCD_DataWrite_ST7789v2(0x1a); 
LCD_DataWrite_ST7789v2(0x3b); 
LCD_DataWrite_ST7789v2(0x34); 
LCD_DataWrite_ST7789v2(0x4e); 
LCD_DataWrite_ST7789v2(0x3a); 
LCD_DataWrite_ST7789v2(0x17); 
LCD_DataWrite_ST7789v2(0x16); 
LCD_DataWrite_ST7789v2(0x21); 

LCD_DataWrite_ST7789v2(0x22); 


#if defined(__SYNC_LCM_SUPPORT__)
		LCD_CtrlWrite_ST7789v2(0x35);
		LCD_DataWrite_ST7789v2(0x00);

		LCD_CtrlWrite_ST7789v2(0x44);
		LCD_DataWrite_ST7789v2(0x00);
		LCD_DataWrite_ST7789v2(0x10);//60
		//com = com+5;
#endif	

/***********/
//// 注意！！SPI 3线2通道接口屏 请打开E7寄存器  不是请关掉

LCD_CtrlWrite_ST7789v2(0xe7); //2 data lane interface enable 
LCD_DataWrite_ST7789v2(0x10);
/***********/
...
LCD_CtrlWrite_ST7789v2(0xB7);     
LCD_DataWrite_ST7789v2(0x75); //VGH=14.97V, VGL=-10.43V  

LCD_CtrlWrite_ST7789v2(0xBB);   //VCOM  
LCD_DataWrite_ST7789v2(0x1D);   
...
LCD_CtrlWrite_ST7789v2(0xC3);   //GVDD  
LCD_DataWrite_ST7789v2(0x13);   
...
LCD_DataWrite_ST7789v2(0x44);
LCD_DataWrite_ST7789v2(0x48);
LCD_DataWrite_ST7789v2(0x0B);
LCD_DataWrite_ST7789v2(0x14);
LCD_DataWrite_ST7789v2(0x11);
LCD_DataWrite_ST7789v2(0x19);
LCD_DataWrite_ST7789v2(0x1C);

LCD_CtrlWrite_ST7789v2(0xE1);
LCD_DataWrite_ST7789v2(0xF0);
LCD_DataWrite_ST7789v2(0x03);
LCD_DataWrite_ST7789v2(0x0B);
LCD_DataWrite_ST7789v2(0x0B);
LCD_DataWrite_ST7789v2(0x0B);
LCD_DataWrite_ST7789v2(0x26);
LCD_DataWrite_ST7789v2(0x38);
LCD_DataWrite_ST7789v2(0x54);
LCD_DataWrite_ST7789v2(0x48);
LCD_DataWrite_ST7789v2(0x3D);
LCD_DataWrite_ST7789v2(0x19);
LCD_DataWrite_ST7789v2(0x19);
LCD_DataWrite_ST7789v2(0x1B);
LCD_DataWrite_ST7789v2(0x1E);
...
//---------------------------------ST7789S Power setting--------------------------------------// 
LCD_CtrlWrite_ST7789v2(0xbb); 
LCD_DataWrite_ST7789v2(0x20); //2b  //CTC2.4=35   CTC2.8=2b
LCD_CtrlWrite_ST7789v2(0xc0); 
LCD_DataWrite_ST7789v2(0x2c); 
LCD_CtrlWrite_ST7789v2(0xc2); 
LCD_DataWrite_ST7789v2(0x01); 
LCD_CtrlWrite_ST7789v2(0xc3); //vrh
LCD_DataWrite_ST7789v2(0x16); //17   CTC2.4=0D   CTC2.8=16
LCD_CtrlWrite_ST7789v2(0xc4); //vdv
LCD_DataWrite_ST7789v2(0x21); //20   CTC2.4=21   CTC2.8=24
LCD_CtrlWrite_ST7789v2(0xc6); 
LCD_DataWrite_ST7789v2(0x15); 
...
LOCAL uint32 ST7789v2_ReadID(uint16 lcd_cs, uint16 lcd_cd, uint16 lcd_id)
{
	...
	mon_Event(idlcd);
	if((idlcd == LCD_DRV_ID_ST7789V2)||(idlcd == LCD_DRV_ID_ST7789V3)||(idlcd == LCD_DRV_ID_ST7789V4)||(LCD_DRV_ID_ST7789V5==idlcd)||(LCD_DRV_ID_ST7789V6==idlcd))
		{
