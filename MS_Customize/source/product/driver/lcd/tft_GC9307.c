...
LOCAL ERR_LCD_E GC9307_SetDirection(LCD_DIRECT_E direct_type)
{
    ...
    SCI_TraceLow_Test("lcd: GC9307_SetDirection = %d",direct_type);
...
LOCAL ERR_LCD_E GC9307_Init(void)
{
    SCI_TraceLow_Test("lcd: GC9307_Init here");
    ...
    LCD_DataWrite_GC9307(0x81);
    LCD_DataWrite_GC9307(0x00);
    LCD_DataWrite_GC9307(0x0D);
    LCD_DataWrite_GC9307(0x0E);
    LCD_DataWrite_GC9307(0x09);
    LCD_DataWrite_GC9307(0x39);

    LCD_CtrlWrite_GC9307(0xF1);
    LCD_DataWrite_GC9307(0x4D);
    LCD_DataWrite_GC9307(0x75);
    LCD_DataWrite_GC9307(0x74);
    LCD_DataWrite_GC9307(0x1F);
    LCD_DataWrite_GC9307(0x22);
    ...
    LCD_DataWrite_GC9307(0x4B);
    LCD_DataWrite_GC9307(0x00);
    LCD_DataWrite_GC9307(0x15);
    LCD_DataWrite_GC9307(0x15);
    LCD_DataWrite_GC9307(0x0C);
    LCD_DataWrite_GC9307(0x46);

    LCD_CtrlWrite_GC9307(0xF3);
    LCD_DataWrite_GC9307(0x56);
    LCD_DataWrite_GC9307(0xB8);
    LCD_DataWrite_GC9307(0xF7);
    LCD_DataWrite_GC9307(0x23);
    LCD_DataWrite_GC9307(0x24);
    ...
    LCD_DataWrite_GC9307(0x08);////spi 2data
#endif
     LCD_CtrlWrite_GC9307(0xfe);
    LCD_CtrlWrite_GC9307(0xfe);
    LCD_CtrlWrite_GC9307(0xef);	
    ...
    LCD_CtrlWrite_GC9307(0x86);	
    LCD_DataWrite_GC9307(0x98);  ///f8

    LCD_CtrlWrite_GC9307(0x89);	
    LCD_DataWrite_GC9307(0x03);//ec  en
    ...
    LCD_CtrlWrite_GC9307(0xc3);	
    LCD_DataWrite_GC9307(0x38);//1////
    LCD_CtrlWrite_GC9307(0xc4);	 
    LCD_DataWrite_GC9307(0x34);//34   20
    LCD_CtrlWrite_GC9307(0xc9);	
    LCD_DataWrite_GC9307(0x2A);//0A
    ...
    LCD_DataWrite_GC9307(0x00);
    LCD_DataWrite_GC9307(0x03);
    LCD_DataWrite_GC9307(0x2E);

    LCD_CtrlWrite_GC9307(0xF1);
    LCD_DataWrite_GC9307(0x46);
    LCD_DataWrite_GC9307(0x9A);
    LCD_DataWrite_GC9307(0x99);
    LCD_DataWrite_GC9307(0x19);
    LCD_DataWrite_GC9307(0x1A);
    LCD_DataWrite_GC9307(0xDF);
    ...
    LCD_CtrlWrite_GC9307(0xF3);
    LCD_DataWrite_GC9307(0x59);
    LCD_DataWrite_GC9307(0xD6);
    LCD_DataWrite_GC9307(0xD4);
    LCD_DataWrite_GC9307(0x28);
    LCD_DataWrite_GC9307(0x2C);
    LCD_DataWrite_GC9307(0xCF);
...
LOCAL void GcCheckDisplayStatus(void)
{
    ...
    if(LCD_DEFAULT_STATUS_09H != lcdstatus)
    {
        ...
        hal_LcdDelay(120);
        GC9307_Init();
        SCI_TraceLow("lcd: GC9307 ReadDisplayStatus: RESET  \n");
    }
    else
    {
#if 0    
        SCI_TraceLow("lcd: GC9307 LCD_DEFAULT_STATUS_09H   \n");
        LCD_CtrlWrite_GC9307(0xfe);
        LCD_CtrlWrite_GC9307(0xef);
...
LOCAL ERR_LCD_E   GC9307_SetContrast(uint16  contrast)
{
    ...
    SCI_TraceLow("lcd: GC9307_SetContrast");
...
uint32 _Read_9307_ID(void)
{
    ...
    hal_LcdDelay(10);
    SCI_TraceLow("lcd: GC9307_ReadID LCM: 0x%0x, 0x%x, 0x%0x (read return : %d)\n", id[2], id[1], id[3], r_err);
...
LOCAL uint32 GC9307_ReadID(uint16 lcd_cs, uint16 lcd_cd, uint16 lcd_id)
{
    uint32 ret_id = LCD_DRV_ID_GC9307;

    GC9307_GetConfig();

    hal_gouda_sim_init(gc9307_line_mode,gc9307_farmk,0x2a000);

    ret_id = _Read_9307_ID();

    hal_gouda_term();

    return ret_id;
    //return LCD_DRV_ID_GC9307;
}
