...
///BOE2.4_ops
	...
	LCD_CtrlWrite_JD9851(0xB7);
	LCD_DataWrite_JD9851(0x0C);//-
	LCD_DataWrite_JD9851(0x73);//-
	LCD_DataWrite_JD9851(0x11);//-
	LCD_DataWrite_JD9851(0x40);//+
	
	LCD_CtrlWrite_JD9851(0xC8);  //G2.0	 //G1.8    //2.5
	LCD_DataWrite_JD9851(0x3F);  //0x3F   //0x3F	   //0x3F
	LCD_DataWrite_JD9851(0x2E);  //0x2F   //0x2F    //0x2B
	LCD_DataWrite_JD9851(0x24);  //0x25   //0x27    //0x25
	LCD_DataWrite_JD9851(0x24);  //0x25   //0x28    //0x22
	LCD_DataWrite_JD9851(0x27);  //0x29   //0x2B    //0x24
	LCD_DataWrite_JD9851(0x2A);  //0x2C   //0x2E    //0x26
	LCD_DataWrite_JD9851(0x25);  //0x28   //0x2A    //0x21
	LCD_DataWrite_JD9851(0x25);  //0x28   //0x2A    //0x22
	LCD_DataWrite_JD9851(0x24);  //0x27   //0x29    //0x20
	LCD_DataWrite_JD9851(0x23);  //0x26   //0x29    //0x1F
	LCD_DataWrite_JD9851(0x21);  //0x24   //0x28    //0x1C
	LCD_DataWrite_JD9851(0x17);  //0x1B   //0x1F    //0x0F
	LCD_DataWrite_JD9851(0x13);  //0x18   //0x1E    //0x0D
	LCD_DataWrite_JD9851(0x0C);  //0x12   //0x19    //0x08
	LCD_DataWrite_JD9851(0x08);  //0x0D   //0x12    //0x03
	LCD_DataWrite_JD9851(0x04);  //0x04   //0x04    //0x04
	LCD_DataWrite_JD9851(0x3F);  //0x3F   //0x3F	   //0x3F
	LCD_DataWrite_JD9851(0x2E);  //0x2F   //0x2F    //0x2B
	LCD_DataWrite_JD9851(0x24);  //0x25   //0x27    //0x25
	LCD_DataWrite_JD9851(0x24);  //0x25   //0x28    //0x22
	...
	LCD_DataWrite_JD9851(0x07);
	LCD_DataWrite_JD9851(0x03);
	
	LCD_CtrlWrite_JD9851(0xD7);
	LCD_DataWrite_JD9851(0x20);    //2 lane SPI
	LCD_DataWrite_JD9851(0x00);
	...
	LCD_CtrlWrite_JD9851(0x3A);
	LCD_DataWrite_JD9851(0x55);   //0x55-RGB565; 0x66-RGB666;
...
//gp+9851
 //defined(LCD_JD9851_BJ_GP24)
	...
	LCD_CtrlWrite_JD9851(0xDE);		
	LCD_DataWrite_JD9851(0x00);	
	LCD_CtrlWrite_JD9851(0x3A);	//ADD
	LCD_DataWrite_JD9851(0x05);
	//VGMP,VGSP,VGMN,VGSN
	LCD_CtrlWrite_JD9851(0xB7);		
	LCD_DataWrite_JD9851(0x1B);//	
	LCD_DataWrite_JD9851(0x72);//
	LCD_DataWrite_JD9851(0x1B);//
	LCD_DataWrite_JD9851(0x26);//
        //======================================		
	
        
        //Set_R_GAMMA2.3
	LCD_CtrlWrite_JD9851(0xC8);//对比度深一点	
	LCD_DataWrite_JD9851(0x3F);		
	LCD_DataWrite_JD9851(0x36); 
	LCD_DataWrite_JD9851(0x2C); 
	LCD_DataWrite_JD9851(0x21); 
	LCD_DataWrite_JD9851(0x24); 
	LCD_DataWrite_JD9851(0x26); 
	LCD_DataWrite_JD9851(0x23); 
	LCD_DataWrite_JD9851(0x24); 
	LCD_DataWrite_JD9851(0x25); 
	LCD_DataWrite_JD9851(0x27); 
	LCD_DataWrite_JD9851(0x28); 
	LCD_DataWrite_JD9851(0x24); 
	LCD_DataWrite_JD9851(0x24); 
	LCD_DataWrite_JD9851(0x25); 
...
//---------------- PAGE0 --------------
 LCD_CtrlWrite_JD9851(0xDE);  	
    ...
    LCD_CtrlWrite_JD9851(0xC8); //G2.5	
    LCD_DataWrite_JD9851(0x3F); //0x3F   	
    LCD_DataWrite_JD9851(0x30); //0x3C
    LCD_DataWrite_JD9851(0x28); //0x34
    LCD_DataWrite_JD9851(0x1F); //0x2D
    LCD_DataWrite_JD9851(0x1F); //0x2D
    LCD_DataWrite_JD9851(0x21); //0x2E
    LCD_DataWrite_JD9851(0x1F); //0x2A
    LCD_DataWrite_JD9851(0x20); //0x2C
    LCD_DataWrite_JD9851(0x22); //0x2C
    LCD_DataWrite_JD9851(0x24); //0x2D
    LCD_DataWrite_JD9851(0x25); //0x2D
    LCD_DataWrite_JD9851(0x23); //0x2A
    LCD_DataWrite_JD9851(0x24); //0x2A
    LCD_DataWrite_JD9851(0x24); //0x2A
    LCD_DataWrite_JD9851(0x24); //0x28
    LCD_DataWrite_JD9851(0x0E); //0x0E
    LCD_DataWrite_JD9851(0x3F); //0x3F   	
    LCD_DataWrite_JD9851(0x30); //0x3C
    LCD_DataWrite_JD9851(0x28); //0x34
    LCD_DataWrite_JD9851(0x1F); //0x2D
...
LCD_DataWrite_JD9851(0x30);  
 LCD_CtrlWrite_JD9851(0xDE);  	
    ...
    LCD_CtrlWrite_JD9851(0xbc);   
    LCD_DataWrite_JD9851(0x3d);
    LCD_DataWrite_JD9851(0x5c);
#endif
...
LOCAL ERR_LCD_E JD9851_Init(void)
{
	SCI_TraceLow_Test("lcd: JD9851_Init otp jj ");
