...
LOCAL ERR_LCD_E GC9306_Init(void)
{
	...
	LCD_DataWrite_GC9306(0x0b);///11 0b
	...
	//LCD_DataWrite_GC9306 (0x08);	//enable two dataline
...
LCD_DataWrite_GC9306(0x0F);
	...
	LCD_CtrlWrite_GC9306(0xAf);//DIG_VREFAD_VRDD[2]
	LCD_DataWrite_GC9306(0x55);

	LCD_CtrlWrite_GC9306(0xa6);
	LCD_DataWrite_GC9306(0x26);// 2a
	LCD_DataWrite_GC9306(0x26);
	LCD_CtrlWrite_GC9306(0xa7);
	LCD_DataWrite_GC9306(0x1b);// 2b
	LCD_DataWrite_GC9306(0x1b);
	LCD_CtrlWrite_GC9306(0xa8);
	LCD_DataWrite_GC9306(0x14);// 18
	LCD_DataWrite_GC9306(0x14);
	LCD_CtrlWrite_GC9306(0xa9);
	LCD_DataWrite_GC9306(0x1a);//2a
	LCD_DataWrite_GC9306(0x1a);
	...
	//------------gamma setting------------------//
	LCD_CtrlWrite_GC9306(0xf0);
	LCD_DataWrite_GC9306(0x02);// 2 
	LCD_DataWrite_GC9306(0x02);// 0
	LCD_DataWrite_GC9306(0x00);// 0
	LCD_DataWrite_GC9306(0x00);// 25
	LCD_DataWrite_GC9306(0x02);// 26
	LCD_DataWrite_GC9306(0x05);// 5
	
	LCD_CtrlWrite_GC9306(0xf1);
	LCD_DataWrite_GC9306(0x01);// 1
	LCD_DataWrite_GC9306(0x01);// 3
	LCD_DataWrite_GC9306(0x00);// 0
	LCD_DataWrite_GC9306(0x00);// 33
	LCD_DataWrite_GC9306(0x07);// 33
	LCD_DataWrite_GC9306(0x12);
	
	LCD_CtrlWrite_GC9306(0xf2);
	LCD_DataWrite_GC9306(0x05);// 5
	LCD_DataWrite_GC9306(0x05);// 3
	LCD_DataWrite_GC9306(0x2d);// 3c
	LCD_DataWrite_GC9306(0x04);// 4
	LCD_DataWrite_GC9306(0x04);// 4
	LCD_DataWrite_GC9306(0x46);// 4c

	LCD_CtrlWrite_GC9306(0xf3);
	LCD_DataWrite_GC9306(0x13);// 9
	LCD_DataWrite_GC9306(0x0b);// 4
	LCD_DataWrite_GC9306(0x3a);// 47
	LCD_DataWrite_GC9306(0x04);// 3
	LCD_DataWrite_GC9306(0x04);// 2
	LCD_DataWrite_GC9306(0x48);// 52

	LCD_CtrlWrite_GC9306(0xf4);
	LCD_DataWrite_GC9306(0x09);// a
	LCD_DataWrite_GC9306(0x14);// 17
	LCD_DataWrite_GC9306(0x12);// 16
	LCD_DataWrite_GC9306(0x23);// 1f
	LCD_DataWrite_GC9306(0x3f);// 21
	LCD_DataWrite_GC9306(0x0F);// f

	LCD_CtrlWrite_GC9306(0xf5);
	LCD_DataWrite_GC9306(0x09);// 7
	LCD_DataWrite_GC9306(0x11);// 12
	LCD_DataWrite_GC9306(0x13);// 12
	LCD_DataWrite_GC9306(0x18);// 1f
	LCD_DataWrite_GC9306(0x3f);// 20
	LCD_DataWrite_GC9306(0x0F);	// f

	//--------end gamma setting--------------//

	LCD_CtrlWrite_GC9306(0xE9); //SPI_2Lane 
	LCD_DataWrite_GC9306(0x08); //08-16BIT   09-18BIT
...
uint32 _Read_9306_ID(void)
{
    ...
    hal_LcdDelay(10);
    SCI_TraceLow("lcd: GC9306_ReadID LCM: 0x%0x, 0x%x, 0x%0x (read return : %d)\n", id[2], id[1], id[3], r_err);
...
LOCAL uint32 GC9306_ReadID(uint16 lcd_cs, uint16 lcd_cd, uint16 lcd_id)
{
    uint32 ret_id = LCD_DRV_ID_GC9306;

    GC9306_GetConfig();

    hal_gouda_sim_init(gc9306_line_mode,gc9306_farmk,0x2a000);

    ret_id = _Read_9306_ID();
