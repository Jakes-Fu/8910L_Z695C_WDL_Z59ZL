...
#if  1  // wuxx add   B246T_8910S_LCD_INI
LCD_CtrlWrite_NV3029(0xfd);	
LCD_DataWrite_NV3029(0x06);
LCD_DataWrite_NV3029(0x07);

LCD_CtrlWrite_NV3029(0x60);       
LCD_DataWrite_NV3029(0x14);   
LCD_DataWrite_NV3029(0x08);

LCD_CtrlWrite_NV3029(0xB1);       
LCD_DataWrite_NV3029(0x61);

LCD_CtrlWrite_NV3029(0x62);       
LCD_DataWrite_NV3029(0x87);  

LCD_CtrlWrite_NV3029(0x63);
LCD_DataWrite_NV3029(0xa9);

LCD_CtrlWrite_NV3029(0x64);
LCD_DataWrite_NV3029(0x19);
LCD_DataWrite_NV3029(0x32);

LCD_CtrlWrite_NV3029(0x65);
LCD_DataWrite_NV3029(0x9b);

LCD_CtrlWrite_NV3029(0x67);       
...
LCD_DataWrite_NV3029(0x00);
LCD_DataWrite_NV3029(0x40);
LCD_DataWrite_NV3029(0x50);

LCD_CtrlWrite_NV3029(0xf3);
LCD_DataWrite_NV3029(0x06); //thrb[5:0]
LCD_DataWrite_NV3029(0x04);//thg[5:0]

LCD_CtrlWrite_NV3029(0xf6);
LCD_DataWrite_NV3029(0x09); 
LCD_DataWrite_NV3029(0x10);
LCD_DataWrite_NV3029(0x80);//80--spi_2wire_mode,00

LCD_CtrlWrite_NV3029(0xf7);     
LCD_DataWrite_NV3029(0x03);

///////////NV3029S2V GAMMA/////////////////
LCD_CtrlWrite_NV3029(0xE0);       
LCD_DataWrite_NV3029(0x13);//PKP0[4:0] 	 v3
LCD_DataWrite_NV3029(0x18);//PKP1[4:0] 	 v4
LCD_DataWrite_NV3029(0x13);//PKP2[4:0]		 v10
LCD_DataWrite_NV3029(0x1B);//PKP3[4:0] 	 v21
LCD_DataWrite_NV3029(0x09);//PKP4[4:0]		 v27
LCD_DataWrite_NV3029(0x14);//PKP5[4:0]		 v28
LCD_DataWrite_NV3029(0x18);//PKP6[4:0] 	 v15
LCD_CtrlWrite_NV3029(0xE3);       
LCD_DataWrite_NV3029(0x0C);//PKN0[4:0] 	 v3
LCD_DataWrite_NV3029(0x17);//PKN1[4:0]		 v4
LCD_DataWrite_NV3029(0x0D);//PKN2[4:0] 	 v10
LCD_DataWrite_NV3029(0x1A);//PKN3[4:0]		 v21
LCD_DataWrite_NV3029(0x06);//PKN4[4:0]		 v27 
LCD_DataWrite_NV3029(0x0f);//PKN5[4:0]		 v28
LCD_DataWrite_NV3029(0x13);//PKN6[4:0] 	 v15

LCD_CtrlWrite_NV3029(0xE1);       
LCD_DataWrite_NV3029(0x10);//PRP0[6:0]		 v5
LCD_DataWrite_NV3029(0x57);//PRP1[6:0]		 v26
LCD_CtrlWrite_NV3029(0xE4);       
LCD_DataWrite_NV3029(0x0C);//PRN0[6:0]		 v5
LCD_DataWrite_NV3029(0x4f);//PRN1[6:0]		 v26

LCD_CtrlWrite_NV3029(0xE2);       
LCD_DataWrite_NV3029(0x06);//VRP0[5:0]
LCD_DataWrite_NV3029(0x19);//VRP1[5:0] 	   v1
LCD_DataWrite_NV3029(0x1C);//VRP2[5:0]		   v2
LCD_DataWrite_NV3029(0x15);//VRP3[5:0]		   v29
LCD_DataWrite_NV3029(0x0C);//VRP4[5:0]		   v30
LCD_DataWrite_NV3029(0x0d);//VRP5[5:0]		  		
LCD_CtrlWrite_NV3029(0xE5);       
LCD_DataWrite_NV3029(0x03);//VRN0[5:0]		 
LCD_DataWrite_NV3029(0x10);//VRN1[5:0] 	   v1
LCD_DataWrite_NV3029(0x09);//VRN2[5:0]		   v2
LCD_DataWrite_NV3029(0x0d);//VRN3[5:0]		   v29
LCD_DataWrite_NV3029(0x07);//VRN4[5:0]		   v30
LCD_DataWrite_NV3029(0x15);//VRN5[5:0]


LCD_CtrlWrite_NV3029(0xEC);     
LCD_DataWrite_NV3029(0xf6);
LCD_CtrlWrite_NV3029(0xED);      
LCD_DataWrite_NV3029(0x02);		
LCD_DataWrite_NV3029(0x94);
...
LCD_CtrlWrite_NV3029(0x3A);       // 16/18 bits
...
uint32 _Read_NV3029_ID(void)
{
    ...
    hal_LcdDelay(10); 
	//Trace_Log_Print("NV3029G_ReadID lcd_id=%d, dev_id=0x%x",lcd_id,lcm_dev_id);
...
LOCAL uint32 NV3029_ReadID(uint16 lcd_cs, uint16 lcd_cd, uint16 lcd_id)
{
    uint32 ret_id = LCD_DRV_ID_NV3029;

    NV3029_GetConfig();

    hal_gouda_sim_init(NV3029_line_mode,NV3029_farmk,0x2a000);

    ret_id = _Read_NV3029_ID();
