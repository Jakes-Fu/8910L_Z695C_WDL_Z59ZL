/******************************************************************************
** File Name:  greneye2_agps_type.h                                                    *
** Author:                                                                    *
** Date:                                                                      *
...
**             authorization.                                                 *
**description:       can not use for sprd agps                                                         *
*******************************************************************************
...
#include "greeneye2_lppe_export.h"
...
typedef struct 
{
    TGe2GpsPosition coordinate;  /* Please ignore altitude information */
...
typedef struct
{
    ...
    unsigned long   count;
    TGe2GpsPosition *pCoordinateList;  /* 3-15 coordinate, Please ignore altitude information */ 
