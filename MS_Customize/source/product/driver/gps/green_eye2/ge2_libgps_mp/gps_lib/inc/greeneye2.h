...
#define GREENEYE2_DEBUG     1
#if  GREENEYE2_DEBUG
#define GREENEYE2_LOGD(_x_) SCI_TraceLow _x_
#define GREENEYE2_LOGE(_x_) SCI_TraceLow _x_
#define GE2GPS_LOGD(fmt, args...) SCI_TraceLow("[GE2]%s " fmt,__FUNCTION__,##args)
#else
#define GREENEYE2_LOGD(_x_)  ((void)0)
#define GREENEYE2_LOGE(_x_)  ((void)0)
#endif
/**---------------------------------------------------------------------------*
 **                         Constant Variables                                *
 **---------------------------------------------------------------------------*/
