...
#ifndef __GREENEYE2_CMD_H
#define __GREENEYE2_CMD_H
...
#define GNSS_MONITOR_INTERVAL_TIME (2) 
...
#define CELLGUIDE  (0x01)
#define GREENEYE2  (0x02)

#define AGPS_REG_LOCATION_TYPE_SIM_MCC      4
#define AGPS_REF_LOCATION_TYPE_LTE_CELLID   5
//========================= agps command begin =========================//
