...
{
	{ LCD_DRV_ID_GC9310, 0, TWO_DATA_LINE_LCD, DISABLE_FMARK_LCD, 0, 0, LCD_CTRL_MODULE_LCM, (LCD_SPEC_T_PTR)&g_lcd_GC9310,  LCD_BACKLIGHT_TYPE_BB_ANALOG, 0, 0, 0, PNULL,"GC9310"},
	...
	{ LCD_DRV_ID_GC9300, 0, TWO_DATA_LINE_LCD, ENABLE_FMARK_LCD, 0, 0, LCD_CTRL_MODULE_LCM, (LCD_SPEC_T_PTR)&g_lcd_GC9300,  LCD_BACKLIGHT_TYPE_BB_ANALOG, 0, 0, 0, PNULL,"GC9300"},	
	//{ LCD_DRV_ID_GC9307, 0, ONE_DATA_LINE_LCD, DISABLE_FMARK_LCD, 0, 0, LCD_CTRL_MODULE_LCM, (LCD_SPEC_T_PTR)&g_lcd_GC9307,  LCD_BACKLIGHT_TYPE_BB_ANALOG, 0, 0, 0, PNULL,"GC9307"},
	{ LCD_DRV_ID_GC9306, 0, TWO_DATA_LINE_LCD, ENABLE_FMARK_LCD, 0, 0, LCD_CTRL_MODULE_LCM, (LCD_SPEC_T_PTR)&g_lcd_GC9306,  LCD_BACKLIGHT_TYPE_BB_ANALOG, 0, 0, 0, PNULL,"GC9306"},
	...
	///{ LCD_DRV_ID_JD9851, 0, TWO_DATA_LINE_LCD, ENABLE_FMARK_LCD, 0, 0, LCD_CTRL_MODULE_LCM, (LCD_SPEC_T_PTR)&g_lcd_JD9851,	LCD_BACKLIGHT_TYPE_BB_ANALOG, 0, 0, 0, PNULL,"JD9851"},
	{ LCD_DRV_ID_ILI9340, 0, TWO_DATA_LINE_LCD, DISABLE_FMARK_LCD, 0, 0, LCD_CTRL_MODULE_LCM, (LCD_SPEC_T_PTR)&g_lcd_ILI9340,	LCD_BACKLIGHT_TYPE_BB_ANALOG, 0, 0, 0, PNULL,"ILI9340"},
#if 0
def ZDT_WDL_Z55ZL_SUPPORT
	{ LCD_DRV_ID_ST7789V2, 0, ONE_DATA_LINE_LCD, DISABLE_FMARK_LCD, 0, 0, LCD_CTRL_MODULE_LCM, (LCD_SPEC_T_PTR)&g_lcd_ST7789v2,	LCD_BACKLIGHT_TYPE_BB_ANALOG, 0, 0, 0, PNULL,"ST7789v2"},
#else
	{ LCD_DRV_ID_ST7789V2, 0, TWO_DATA_LINE_LCD, DISABLE_FMARK_LCD, 0, 0, LCD_CTRL_MODULE_LCM, (LCD_SPEC_T_PTR)&g_lcd_ST7789v2,	LCD_BACKLIGHT_TYPE_BB_ANALOG, 0, 0, 0, PNULL,"ST7789v2"},
#endif
};
/*lint -restore*/
