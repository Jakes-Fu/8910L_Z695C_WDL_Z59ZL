...
#define KEYLOCK_DETECT_SHAKING_TIME     100
#endif
...
/*    ID                                    TYPE                VALID_LEVEL                NUM.            CALLBACK    */
    ...
    {GPIO_PROD_HEADSET_BUTTON_ID,        GPIO_PROD_TYPE_EIC_DBNC, GPIO_PROD_HIGH_LEVEL,     EICA_AUD_HEAD_BUTTON,  PNULL },
       ...
       {GPIO_PROD_HEADSET_DETECT_ID,        GPIO_PROD_TYPE_EIC_DBNC, GPIO_PROD_LOW_LEVEL,EIC_AUD_HEAD_INSERT3,PNULL},
#else
    ...
    {GPIO_PROD_POWER_KEY_ID,            GPIO_PROD_TYPE_EIC_DBNC, GPIO_PROD_LOW_LEVEL,     EICA_PBINT,                PNULL   },    
    ...
    {GPIO_PROD_SPEAKER_PA_EN_ID,        GPIO_PROD_TYPE_BB0, GPIO_PROD_HIGH_LEVEL,     GPIO_PROD_NUM_INVALID,          (GPIO_CB)_GPIO_OpenPA },// GPIO_PROD_NUM_INVALID:do not use Extternal PA, CALLBACK = PNULL: do not use Internal PA
     ...
     {GPIO_PROD_GSENSOR_INT_ID,            GPIO_PROD_TYPE_BB0, GPIO_PROD_LOW_LEVEL,     GPIO_PROD_NUM_INVALID,             (GPIO_CB)MSensor_IntHandler    },    //G-SENSOR INT1
#endif

#ifdef SIM_PLUG_IN_SUPPORT
    {GPIO_PROD_SIM_PLUG_IN_ID,          GPIO_PROD_TYPE_BB0,    GPIO_PROD_HIGH_LEVEL,    49,  PNULL},
#endif
    
    {GPIO_PROD_TORCHLED_ID,            GPIO_PROD_TYPE_BB0, GPIO_PROD_HIGH_LEVEL,    10 ,       PNULL},
...
#ifdef Z695_KEYLOCK_INT_SUPPORT
    {GPIO_PROD_KEYLOCK_INT_ID,      		GPIO_PROD_TYPE_BB0, GPIO_PROD_LOW_LEVEL,    	  8,        PNULL},
#endif
    ...
    //{GPIO_PROD_SDCARD_DETECT_ID,        GPIO_PROD_TYPE_BB0, GPIO_PROD_LOW_LEVEL,     97,             PNULL    },    
     {GPIO_PROD_FMLNA_ID,            GPIO_PROD_TYPE_BB0, GPIO_PROD_HIGH_LEVEL,    11 ,       PNULL}, //jennyxu
...
#ifdef Z695_KEYLOCK_INT_SUPPORT
    GPIO_PROD_RegGpio(
		GPIO_PROD_KEYLOCK_INT_ID,
		SCI_FALSE,
		SCI_FALSE,
		SCI_TRUE,
		KEYLOCK_DETECT_SHAKING_TIME,
		(GPIO_PROD_CALLBACK)GPIO_KeyLockIntHandler
		);
#endif
#if 0
