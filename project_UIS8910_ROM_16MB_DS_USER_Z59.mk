...
ZDT_PRODUCT_FM = TRUE                          ### ZDT_PRODUCT_FM
                                                     # Option1:TRUE
                                                     # Option2:FALSE                                                     
...
ZDT_WDL_Z59_SUPPORT = TRUE                          ### ZDT_WDL_A03ZL_SUPPORT
                                                     # Option1:TRUE
                                                     # Option2:FALSE 
...
HERO_ENGINE_SUPPORT_CLIENT_INFO=TRUE  #支持客户自定义集成商+机型的配置宏
	...
	HERO_ENGINE_CFG_VAR_HANDSETID_SEC   = 69zl
      endif
...
include uis8910_phone_user_base_config_FM.cfg
...
PRODUCT_BASELIB_DIR = UIS8910_ROM_16MB_DS_USER_Z60           ### Dir name for base lib in MS_Code\lib\
                                                     # default: project name 
