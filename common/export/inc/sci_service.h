...
#define BT_DUN_SERVICE        (INTERNAL_USER_SERVICE+13)    // bluetooth DUN Service

#define MN_APP_GPS_SERVICE        (INTERNAL_USER_SERVICE+14)    // GPS Service
...
#define  SCI_NO_SERVER   0x0101
#define  SCI_NO_CLIENT   0x0102 
/*****************************************************************************/
...
//	Global resource dependence: 
//  Author:         Richard.Yang
//	Note:           SCI_SUCCESS: send successfully
//                  SCI_NO_CLIET: no client has registerd on certain server
//                  SCI_NO_SERVER: server is not exist           
/*****************************************************************************/
PUBLIC uint32 SCI_SendEventToClient(
    uint32 server_ID,     // Server ID, EXAMPLE: KEYPAD_SERVICE
    uint32 ui_event_type, // Message ID of the registered event
    void * signal_ptr     // Signal Sent to Client
);
