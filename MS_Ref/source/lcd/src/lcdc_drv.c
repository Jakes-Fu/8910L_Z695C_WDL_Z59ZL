                                                  ...
                                                  uint32 uv_addr)
{
    ...
    switch (layer_id)
    {
        ...
        default:
            ...
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,LCDC_DRV_496_112_2_18_1_45_36_151,(uint8*)"dd", layer_id, y_addr);
            break;
    }
...
PUBLIC uint32 LCDC_DrvSetAlphaBaseAddr (LCD_LAYER_ID_E layer_id, uint32 base_addr)
{
    ...
    switch (layer_id)
    {
        ...
        default:
            ...
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,LCDC_DRV_520_112_2_18_1_45_36_152,(uint8*)"dd", layer_id, base_addr);
            break;
    }
...
PUBLIC uint32 LCDC_DrvSetEndian (LCD_LAYER_ID_E layer_id, LCDC_ENDIAN_SWITCH_E endian_switch,LCDC_ENDIAN_SWITCH_E uv_endian_switch)
{
    ...
    switch (layer_id)
    {
        ...
        default:
            ...
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,LCDC_DRV_575_112_2_18_1_45_36_153,(uint8*)"dd", layer_id, endian_switch);
            break;
    }
                                              ...
                                              LCD_DATA_FORMAT_E data_format)
{
    ...
    case LCD_LAYER_OSD5:            
        ...
        default:
            ...
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,LCDC_DRV_621_112_2_18_1_45_36_154,(uint8*)"dd", layer_id, data_format);
            break;
    }
...
PUBLIC uint32 LCDC_DrvSetLayerBlockEnable (LCD_LAYER_ID_E layer_id, BOOLEAN is_enable)
{
    ...
    case LCD_LAYER_OSD5:            
        ...
        default:
            ...
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,LCDC_DRV_663_112_2_18_1_45_36_155,(uint8*)"dd", layer_id, is_enable);
            break;
    }
...
PUBLIC uint32 LCDC_DrvSetPitch (LCD_LAYER_ID_E layer_id, uint32 pitch)
{
    ...
    switch (layer_id)
    {
        ...
        default:
            ...
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,LCDC_DRV_717_112_2_18_1_45_36_156,(uint8*)"dd", layer_id, pitch);
            break;
    }
...
PUBLIC uint32 LCDC_DrvSetLayerRect (LCD_LAYER_ID_E layer_id, LCDC_RECT_T *disp_rect)
{
    ...
    switch (layer_id)
    {
        ...
        default:
            ...
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,LCDC_DRV_785_112_2_18_1_45_36_157,(uint8*)"ddddd", layer_id,disp_rect->x, disp_rect->y, disp_rect->w, disp_rect->h);
            break;
    }
...
PUBLIC uint32 LCDC_DrvSetAlphaMode (LCD_LAYER_ID_E layer_id, LCD_OSD_ALPHA_E alpha_mode)
{
    ...
    switch (layer_id)
    {
        ...
        default:
            ...
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,LCDC_DRV_831_112_2_18_1_45_37_158,(uint8*)"dd", layer_id, alpha_mode);
            break;
    }
...
PUBLIC uint32 LCDC_DrvSetAlphaValue (LCD_LAYER_ID_E layer_id, uint8 alpha_value)
{
    ...
    switch (layer_id)
    {
        ...
        default:
            ...
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,LCDC_DRV_871_112_2_18_1_45_37_159,(uint8*)"dd", layer_id, alpha_value);
            break;
    }
...
PUBLIC uint32 LCDC_DrvSetGreyRgb (LCD_LAYER_ID_E layer_id, uint32 grey_value)
{
    ...
    switch (layer_id)
    {
        ...
        default:
            ...
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,LCDC_DRV_911_112_2_18_1_45_37_160,(uint8*)"dd", layer_id, grey_value);
            break;
    }
...
PUBLIC uint32 LCDC_DrvSetColorKeyEnable (LCD_LAYER_ID_E layer_id, BOOLEAN is_enable)
{
    ...
    switch (layer_id)
    {
        ...
        default:
            ...
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,LCDC_DRV_955_112_2_18_1_45_37_161,(uint8*)"dd", layer_id, is_enable);
            break;
    }
...
PUBLIC uint32 LCDC_DrvSetColorkey (LCD_LAYER_ID_E layer_id, uint32 color_key)
{
    ...
    switch (layer_id)
    {
        ...
        default:
            ...
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,LCDC_DRV_993_112_2_18_1_45_37_162,(uint8*)"dd", layer_id, color_key);
            break;
    }
...
PUBLIC uint32 LCDC_DrvSetCapDataFormat (LCD_DATA_FORMAT_E data_format)
{
    ...
    switch (data_format)
    {
        ...
        default:
            ...
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,LCDC_DRV_1058_112_2_18_1_45_37_163,(uint8*)"d",data_format);
    }
...
LOCAL uint32 LCDC_DrvDisableLayer (uint32 layer_num)
{
    ...
    switch (layer_num)
    {
        ...
        default:
            ...
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,LCDC_DRV_1205_112_2_18_1_45_37_164,(uint8*)"d",layer_num);
            break;
    }
...
PUBLIC ERR_LCD_E LCDC_DrvSetTiming(LCD_SPEC_INFO_T_PTR lcd_spec_ptr, uint32 ahb_clk, LCD_ID_E lcd_id)
{
    ...
    SCI_ASSERT (0 != ns_per_clk);/*assert verified*/
    ...
    Lcm_para_value.mBits.rcss = MAX(Lcm_para_value.mBits.rcss,0x1);
    adjustment_factor         = (((lcd_spec_ptr->spec_ptr->timing->mcu_mode_timing.rlpw) % ns_per_clk) == 0) ? 0:1;
    Lcm_para_value.mBits.rlpw = MIN ( ( ( (lcd_spec_ptr->spec_ptr->timing->mcu_mode_timing.rlpw) / ns_per_clk) + adjustment_factor), 0xf);
    Lcm_para_value.mBits.rlpw = MAX(Lcm_para_value.mBits.rlpw,0x1);
    adjustment_factor         = (((lcd_spec_ptr->spec_ptr->timing->mcu_mode_timing.rhpw) % ns_per_clk) == 0) ? 0:1;
    Lcm_para_value.mBits.rhpw = MIN ( ( ( (lcd_spec_ptr->spec_ptr->timing->mcu_mode_timing.rhpw) / ns_per_clk) + adjustment_factor), 0xf);
    Lcm_para_value.mBits.rhpw = MAX(Lcm_para_value.mBits.rhpw,0x1);
    ...
    Lcm_para_value.mBits.wcss = MAX(Lcm_para_value.mBits.wcss,0x1);
    adjustment_factor         = (((lcd_spec_ptr->spec_ptr->timing->mcu_mode_timing.wlpw) % ns_per_clk) == 0) ? 0:1;
    Lcm_para_value.mBits.wlpw = MIN ( ( ( (lcd_spec_ptr->spec_ptr->timing->mcu_mode_timing.wlpw) / ns_per_clk) + adjustment_factor), 0xf);
    Lcm_para_value.mBits.wlpw = MAX(Lcm_para_value.mBits.wlpw,0x1);
    adjustment_factor         = (((lcd_spec_ptr->spec_ptr->timing->mcu_mode_timing.whpw) % ns_per_clk) == 0) ? 0:1;
    Lcm_para_value.mBits.whpw = MIN ( ( ( (lcd_spec_ptr->spec_ptr->timing->mcu_mode_timing.whpw) / ns_per_clk) + adjustment_factor), 0xf);
    Lcm_para_value.mBits.whpw = MAX(Lcm_para_value.mBits.whpw,0x1);
...
PUBLIC void LCDC_SetClock(LCDC_CLOCK_E clock_type)
{
    ...
    switch(clock_type)
    {
        ...
        default:
            ...
            SCI_TRACE_ID(TRACE_TOOL_CONVERT,LCDC_DRV_1564_112_2_18_1_45_38_165,(uint8*)"d",clock_type);
            break;
     }         
