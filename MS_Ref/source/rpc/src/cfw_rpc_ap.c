...
#define EV_CFW_NW_GET_AVAIL_OPERATOR_RSP_PTR1_SIZE COUNT_PARAM2_IF_TYPE0(sizeof(CFW_NW_OPERATOR_INFO))
...
#define SS_USSD_IF_TYPE0(s) (EVENT_TYPE == 0 ? (EVENT_PAR1 == 0 ? 0 : (s)) : 0)
