...
typedef enum  _DEVICE_AUTOTEST_ID_E
{
    ...
    DEVICE_AUTOTEST_LCDB2B= 33,//read lcd id
...
#define     PIN_NUM_MAX          95        //max index of pin can be gpio
...
{ 
 //pin_num,pin_sel,gpio_id,reserved,       addr
    {0,          0x0,         0,     0x0,      PIN_GPIO_0_CFG_REG}, 
    {1,          0x0,         1,     0x0,      PIN_GPIO_1_CFG_REG}, 
    {2,          0x0,         2,     0x0,      PIN_GPIO_2_CFG_REG}, 
    {3,          0x0,         3,     0x0,      PIN_GPIO_3_CFG_REG}, 
    {4,          0x0,         4,     0x0,      PIN_GPIO_4_CFG_REG}, 
    {5,          0x0,         5,     0x0,      PIN_GPIO_5_CFG_REG}, 
    {6,          0x0,         6,     0x0,      0xffffffff}, 
    {7,          0x0,         7,     0x0,      PIN_GPIO_7_CFG_REG}, 
    {8,          0x0,         8,     0x0,      PIN_GPIO_8_CFG_REG}, 
    {9,          0x0,         9,     0x0,      PIN_GPIO_9_CFG_REG}, 
    {10,        0x0,        10,     0x0,      PIN_GPIO_10_CFG_REG}, 
    {11,        0x0,        11,     0x0,      PIN_GPIO_11_CFG_REG}, 
    {12,        0x0,        12,     0x0,      PIN_GPIO_12_CFG_REG}, 
    {13,        0x0,        13,     0x0,      PIN_GPIO_13_CFG_REG}, 
    {14,        0x0,        14,     0x0,      PIN_GPIO_14_CFG_REG}, 
    {15,        0x0,        15,     0x0,      PIN_GPIO_15_CFG_REG}, 
    {16,        0x1,        16,     0x0,      PIN_DEBUG_HOST_RX_CFG_REG}, 
    {17,        0x1,        17,     0x0,      PIN_DEBUG_HOST_CLK_CFG_REG}, 
    {18,        0x0,        18,     0x0,      PIN_GPIO_18_CFG_REG}, 
    {19,        0x0,        19,     0x0,      PIN_GPIO_19_CFG_REG}, 
    {20,        0x0,        20,     0x0,      PIN_GPIO_20_CFG_REG}, 
    {21,        0x0,        21,     0x0,      PIN_GPIO_21_CFG_REG}, 
    {22,        0x0,        22,     0x0,      PIN_GPIO_22_CFG_REG}, 
    {23,        0x0,        23,     0x0,      PIN_GPIO_23_CFG_REG}, 
    {24,        0x1,        24,     0x0,      PIN_SDMMC1_CMD_CFG_REG}, 
    {25,        0x1,        25,     0x0,      PIN_SDMMC1_DATA_0_CFG_REG}, 
    {26,        0x1,        26,     0x0,      PIN_SDMMC1_DATA_1_CFG_REG}, 
    {27,        0x1,        27,     0x0,      PIN_SDMMC1_DATA_2_CFG_REG}, 
    {28,        0x1,        28,     0x0,      PIN_SDMMC1_DATA_3_CFG_REG}, 
#if 0      //spiflash pin, can not be set to gpio
    {29,        0x1,        29,     0x0,      PIN_SPI_FLASH_SIO_1_CFG_REG}, 
    {30,        0x1,        30,     0x0,      PIN_SPI_FLASH_SIO_2_CFG_REG}, 
    {31,        0x1,        31,     0x0,      PIN_SPI_FLASH_SIO_3_CFG_REG}, 
#endif
    {32,        0x1,          0,     0x0,      PIN_SPI_LCD_SIO_CFG_REG}, 
    {33,        0x1,          1,     0x0,      PIN_SPI_LCD_SDC_CFG_REG}, 
    {34,        0x1,          2,     0x0,      PIN_SPI_LCD_CLK_CFG_REG}, 
    {35,        0x1,          3,     0x0,      PIN_SPI_LCD_CS_CFG_REG}, 
    {36,        0x1,          4,     0x0,      PIN_SPI_LCD_SELECT_CFG_REG}, 
    {37,        0x1,          5,     0x0,      PIN_LCD_FMARK_CFG_REG}, 
    {38,        0x1,          6,     0x0,      PIN_LCD_RSTB_CFG_REG}, 
    {40,        0x5,          8,     0x0,      PIN_AP_JTAG_TCK_CFG_REG}, 
    {41,        0x5,          9,     0x0,      PIN_AP_JTAG_TRST_CFG_REG}, 
    {42,        0x5,         10,     0x0,      PIN_AP_JTAG_TMS_CFG_REG}, 
    {43,        0x5,         11,     0x0,      PIN_AP_JTAG_TDI_CFG_REG}, 
    {44,        0x5,         12,     0x0,      PIN_AP_JTAG_TDO_CFG_REG}, 
    {48,        0x4,         16,     0x0,      PIN_I2C_M1_SCL_CFG_REG}, 
    {49,        0x4,         17,     0x0,      PIN_I2C_M1_SDA_CFG_REG}, 
    {50,        0x4,         18,     0x0,      PIN_CAMERA_RST_L_CFG_REG}, 
    {51,        0x4,         19,     0x0,      PIN_CAMERA_PWDN_CFG_REG}, 
    {52,        0x4,         20,     0x0,      PIN_CAMERA_REF_CLK_CFG_REG}, 
    {53,        0x4,         21,     0x0,      PIN_SPI_CAMERA_SI_0_CFG_REG}, 
    {54,        0x4,         22,     0x0,      PIN_SPI_CAMERA_SI_1_CFG_REG}, 
    {55,        0x4,         23,     0x0,      PIN_SPI_CAMERA_SCK_CFG_REG}, 
    {59,        0x2,         27,     0x0,      PIN_AUD_DA_SYNC_CFG_REG}, 
    {60,        0x2,         28,     0x0,      PIN_AUD_DA_D1_CFG_REG}, 
    {61,        0x2,         29,     0x0,      PIN_AUD_DA_D0_CFG_REG}, 
    {62,        0x2,         30,     0x0,      PIN_AUD_AD_SYNC_CFG_REG}, 
    {63,        0x2,         31,     0x0,      PIN_AUD_AD_D0_CFG_REG}, 
    {93,        0x2,         29,     0x0,      PIN_SIM_2_CLK_CFG_REG}, 
    {94,        0x2,         30,     0x0,      PIN_SIM_2_DIO_CFG_REG}, 
    {95,        0x2,         31,     0x0,      PIN_SIM_2_RST_CFG_REG}
};
#else
const AUTOTST_PM_PINFUNC_T autodev_pm_func[]=
{
...
PUBLIC void Register_DeviceAutoTest_CmdRoutine (void)
{
    ...
    DIAG_RegisterAutotestCallback( DEVICE_AUTOTEST_LCDB2B, HandleLCDB2BTest);  
...
extern uint32 aud_HeadsetConfig(uint32 isInsert, uint32 isBbat);
...
{
    uint8 result = AUD_HEADSET_TYPE_PLUGOUT;
    uint8 xx = 0;
    uint8 yy = 0;
    uint8* pptr = PNULL;
	...
	pdata = (uint8 *)msg_head+sizeof(MSG_HEAD_T)+2;

    if(MSG_HEAD->cmmand == 0x0a || MSG_HEAD->cmmand == 0x09)
    {
        
        if(GPIO_GetHeadsetDetectFlag())
        {
            result = aud_CodecSC2720HeadsetMicAndButtonDetect();
            if(MSG_HEAD->cmmand == 0x0a && MSG_HEAD->data == 0x01)
            {
                xx = 0;
                yy = 2;
                aud_HeadsetConfig(result,BBAT_MIC_SET_BBAT_MODE);
            }
            else if(MSG_HEAD->cmmand == 0x0a && MSG_HEAD->data == 0x00)
            {
                xx = 1;
                yy = 0;
                aud_HeadsetConfig(result,BBAT_MIC_SET_DEFAULT_NORMAL);
            }
            else if(MSG_HEAD->cmmand == 0x09 && MSG_HEAD->data == 0x01)
            {
                xx = 1;
                yy = 1;
                aud_HeadsetConfig(result,BBAT_MIC_SET_DEFAULT_NORMAL);
            }
            else  if(MSG_HEAD->cmmand == 0x09 && MSG_HEAD->data == 0x00)
            {
                xx = 1;
                yy = 2;
                aud_HeadsetConfig(result,BBAT_MIC_SET_DEFAULT_NORMAL);
            }
            result = AutoTestLoopDirectPcm(xx,yy,SCI_TRUE);
          //  BbatAudioLoopTestSetStatus(result);
            if(SCI_TRUE == result)
            {
                result = FALSE;
            }
	...
	switch(MSG_HEAD->data)
	{
        case 0x01:
        {
            if(MSG_HEAD->cmmand)
            {
                aud_HeadsetConfig(result,BBAT_MIC_SET_BBAT_FORCE_EARMIC);
            }
            else
            {
                aud_HeadsetConfig(result,BBAT_MIC_SET_BBAT_FORCE_MAINMIC);
            }
            Autotest_Mic_Start(MSG_HEAD->cmmand); //0:HANDFREE,1:EARPHONE
            *dest_len_ptr = sizeof(MSG_HEAD_T);
            *dest_ptr = (uint8 *)SCI_ALLOC_APP(*dest_len_ptr);
            SCI_ASSERT(SCI_NULL != *dest_ptr);
...
//            ATCOMMON_GenerateRspMsg(dest_ptr, dest_len_ptr, msg_head);           
	     ...
	     *dest_len_ptr = sizeof(MSG_HEAD_T) + 1;
            *dest_ptr = (uint8 *)SCI_ALLOC_APP(*dest_len_ptr);
            ...
            SCI_MEMCPY(*dest_ptr, msg_head, sizeof(MSG_HEAD_T));
            SCI_MEMCPY(*dest_ptr+sizeof(MSG_HEAD_T), &result, 1);
        ...
        case 0x03:
        {
            buff_ptr = Autotest_GetDataAddr();
            //AMR_REOCED_File((uint8*)buff_ptr,MICBUFFLEN); 
            *dest_len_ptr = sizeof(MSG_HEAD_T) + 400;
            *dest_ptr = (uint8 *)SCI_ALLOC_APP(*dest_len_ptr);

            SCI_ASSERT(SCI_NULL != *dest_ptr);

            SCI_MEMCPY(*dest_ptr, msg_head, sizeof(MSG_HEAD_T));
            SCI_MEMCPY(*dest_ptr+sizeof(MSG_HEAD_T), buff_ptr+(*pdata)*400, 400);
...
//            ATCOMMON_GenerateRspMsg(dest_ptr, dest_len_ptr, msg_head);  
        ...
        case 0x11:
        {
            result = AutoTestLoopDirectPcm(xx,yy,SCI_FALSE);
            if(SCI_TRUE == result)
            {
                result = FALSE;
            }
	     ...
	     *dest_len_ptr = sizeof(MSG_HEAD_T) + 2;
            *dest_ptr = (uint8 *)SCI_ALLOC_APP(*dest_len_ptr);
            ...
            SCI_MEMCPY(*dest_ptr, msg_head, sizeof(MSG_HEAD_T));
            pptr = *dest_ptr+sizeof(MSG_HEAD_T);
            *pptr++ = GPIO_GetHeadsetDetectFlag();
             *pptr = GPIO_GetHeadsetButtonFlag();

            GPIO_SetHeadsetButtonFlag(0);
            ((MSG_HEAD_T  *)(*dest_ptr))->len = *dest_len_ptr;
            ((MSG_HEAD_T  *)(*dest_ptr))->subtype  = SCI_SUCCESS; 	
        }
        break;
 ...
 ) 
{
 ...
 //          SCI_TRACE_LOW("{xx}Handle_SpeakerAutotest: uiHeadSetButton = 0x%x",uiHeadSetButton);

	switch(MSG_HEAD->data)
	{
		case 0x1:			
                    SCI_TRACE_LOW("Autotest_Speaker_Stop pcm_len = %d",pcm_len);
                    Autotest_rpc_Speaker_Stop(MSG_HEAD->cmmand);
			//Autotest_Speaker_Stop();			
			//MMIAPIENVSET_SetTestMode();//silent mode  
			if(0 == Autotest_Speaker_Start_Local(MSG_HEAD->cmmand))//0:speaker 1:reciever 2:earphone
			{
				ret = SCI_FAILURE;
			}			
			*dest_len_ptr = sizeof(MSG_HEAD_T);
		...
		case 0x02:			
			Autotest_rpc_Speaker_Stop(MSG_HEAD->cmmand);
			//MMIAPIENVSET_SetTestMode();//silent mode  
                    SCI_TRACE_LOW("Autotest_rpc_Speaker_Start pcm_len = %d",pcm_len);
			if(0 == Autotest_rpc_Speaker_Start(src_ptr + sizeof(DIAG_MSG_AUDIO_T)+1,pcm_len,MSG_HEAD->cmmand))
			{
				ret = 0x1;
			}
		...
		case 0x03:			
			Autotest_rpc_Speaker_Stop(MSG_HEAD->cmmand);	
			//MMIAPIENVSET_ClearTestMode();//disable silent mode  
			*dest_len_ptr = sizeof(MSG_HEAD_T);
			*dest_ptr = (uint8 *)SCI_ALLOC_APP(*dest_len_ptr);
			SCI_ASSERT(SCI_NULL != *dest_ptr);
		...
		break;	
		case 0x05:			
			ret=AUDIO_SetVolume(MSG_HEAD->cmmand);	
...
LOCAL uint32 HandleLCDB2BTest(
    ...
    uint16 src_len)        // Size of the source buffer in uint8.
{	
    B2BValue_PTR    B2B_ptr;
	MSG_HEAD_T  	*msg_head;
	msg_head    = (MSG_HEAD_T *) src_ptr; 
	
	
    B2B_ptr = (B2BValue_PTR) (src_ptr + sizeof(MSG_HEAD_T));

    msg_head->subtype=1;


	 switch((int8)B2B_ptr->iID)
	{
        case LCD_ID:
		    if(GET_LCD_ID()!=-1 )
				{
				// Malloc a buf for response buf.
				msg_head = (MSG_HEAD_T*)SCI_ALLOC_APP(sizeof(MSG_HEAD_T)); 
	...
	DIAG_MSG_GPIO_T  *MSG_HEAD = (DIAG_MSG_GPIO_T *)src_ptr; 
       ...
       if (((AUTOTEST_GPIO_E)(MSG_HEAD->command) == GPIO_GET_VALUE) || ((AUTOTEST_GPIO_E)(MSG_HEAD->command) == GPIO_SET_VALUE))
       {
        	if(MSG_HEAD->gpio_id > PIN_NUM_MAX)
        	{
              ...
              //need open some power such as MMC LCD SIM
              if ((MSG_HEAD->gpio_id >=24) && (MSG_HEAD->gpio_id <=28))      //sd
              {
                  ANA_REG_SET(ANA_LDO_SD_REG1, 0x0);    //sd 1v8
                  ANA_REG_AND(ANA_LDO_SD_REG2, ~BIT_0);  //sd open
              }
              else if ((MSG_HEAD->gpio_id >=32) && (MSG_HEAD->gpio_id <=38))      //lcd
              {
                  ANA_REG_SET(ANA_LDO_LCD_REG1, 0xF);    //lcd 1v8
                  ANA_REG_AND(ANA_LDO_LCD_REG0, ~BIT_0);  //lcd open
              }
              else if ((MSG_HEAD->gpio_id >=93) && (MSG_HEAD->gpio_id <=95))      //sim2
              {
                  ANA_REG_SET(ANA_LDO_SIM1_REG1, 0xF);    //sim1 1v8
                  ANA_REG_AND(ANA_LDO_SIM1_PD_REG, ~BIT_0);  //sim1 open      
              }
       }
	...
	{  
        ...
        case GPIO_SET_VALUE:   
        {
              if (p_pm_pinfuc->addr != PM_INVALID_VAL)   
              {
                  ...
                  {
                        // pinmap it to force output
                        if (MSG_HEAD->gpio_value)
                        {
                            CHIP_REG_SET(p_pm_pinfuc->addr, PIN_OUT_FRC_HIGH);
                        }
                        else
                        {
                            CHIP_REG_SET(p_pm_pinfuc->addr, PIN_OUT_FRC_LOW);
                        }
                  }
                  else
                  {
 ...
 ) 
{
	...
	switch (cmmand) {
	case 0x01:
		ldo_camret = LDO_SetVoltValue (LDO_LDO_CAMIO, 1800);
		RTN_IF_ERR(ldo_camret);
		ldo_camret = LDO_TurnOnLDO (LDO_LDO_CAMIO);
		RTN_IF_ERR(ldo_camret);
	...
	case 0x03:
		...
		RTN_IF_ERR(ldo_camret);
		ldo_camret = LDO_TurnOffLDO (LDO_LDO_CAMIO);
...
)
{
    ...
    uint32 wifi_index = 0;
    uint8  command = 0;  
    MMIWIFI_PROFILE_T * wifihandle_autotest = PNULL;
    MSG_HEAD_T  *msg_head = (MSG_HEAD_T *)src_ptr;        
    command = *(uint8 *)(msg_head + 1); 
    ...
    switch(command)
    {
        ...
        case WIFI_SCAN:
        {
            ...
            wifi_index = 0;
            SCI_SLEEP(500);
            while (!wifi_index && n < 20) {
                SCI_SLEEP(200); n++;
                wifi_index = MMIWIFI_GetProfileNum();
            }
        ...
        case WIFI_READ:
        {
            ...
            SCI_SLEEP(500);
            wifi_index = MMIWIFI_GetProfileNum();
            *dest_len_ptr = sizeof(MSG_HEAD_T) + (wifi_index)*sizeof(WIFISUPP_BSSID_T);
            *dest_ptr = (uint8 *)SCI_ALLOC_APP(*dest_len_ptr);
            SCI_ASSERT(SCI_NULL != *dest_ptr);
            msg_head->len = *dest_len_ptr;
            msg_head->subtype = SCI_SUCCESS;
            SCI_MEMCPY(*dest_ptr, msg_head, sizeof(MSG_HEAD_T));
            for(i = 0; i < wifi_index; i++)
            {
                wifihandle_autotest = MMIWIFI_GetProfileByIndex(i);
                SCI_MEMCPY(*dest_ptr + sizeof(MSG_HEAD_T)+(i)*sizeof(WIFISUPP_BSSID_T), wifihandle_autotest->config_info.bssid_info.bssid, sizeof(WIFISUPP_BSSID_T));  
            }
            break;
        }
        ...
        case WIFI_RSSI:
        {
            ...
            wifi_index = MMIWIFI_GetProfileNum();
            *dest_len_ptr = sizeof(MSG_HEAD_T) + (wifi_index)*(sizeof(WIFISUPP_BSSID_T) 
                + sizeof(wifihandle_autotest->rssi));
            *dest_ptr = (uint8 *)SCI_ALLOC_APP(*dest_len_ptr);
            SCI_ASSERT(SCI_NULL != *dest_ptr);
            msg_head->len = *dest_len_ptr;
            msg_head->subtype = SCI_SUCCESS;
            ...
            {
                wifihandle_autotest = MMIWIFI_GetProfileByIndex(i);
                SCI_MEMCPY(*dest_ptr + sizeof(MSG_HEAD_T)+(i)*(sizeof(WIFISUPP_BSSID_T) + sizeof(wifihandle_autotest->rssi)),
                    wifihandle_autotest->config_info.bssid_info.bssid, sizeof(WIFISUPP_BSSID_T));
                SCI_MEMCPY(*dest_ptr + sizeof(MSG_HEAD_T)+(i)*(sizeof(WIFISUPP_BSSID_T) + sizeof(wifihandle_autotest->rssi)) + sizeof(WIFISUPP_BSSID_T),
                    &wifihandle_autotest->rssi, sizeof(wifihandle_autotest->rssi));
            }
            break;
        }
        case WIFI_CLOSE:
    ...
    switch(command)
    {
        ...
        case WIFI_SCAN:
        {
            ...
            { 
                SCI_SLEEP(500);                 
                wifi_index = MMIWIFI_GetProfileNum();
                *dest_len_ptr = sizeof(MSG_HEAD_T) + (wifi_index-2)*sizeof(WIFISUPP_BSSID_T);                             
                *dest_ptr = (uint8 *)SCI_ALLOC_APP(*dest_len_ptr);                                                  
                SCI_ASSERT(SCI_NULL != *dest_ptr);    
                msg_head->len = *dest_len_ptr;
                msg_head->subtype = SCI_SUCCESS;
                SCI_MEMCPY(*dest_ptr, msg_head, sizeof(MSG_HEAD_T));                                                       
                for(i = 2; i < wifi_index; i++)
                {
                    wifihandle_autotest = MMIWIFI_GetProfileByIndex(i);
                    SCI_MEMCPY(*dest_ptr + sizeof(MSG_HEAD_T)+(i-2)*sizeof(WIFISUPP_BSSID_T), wifihandle_autotest->config_info.bssid_info.bssid, sizeof(WIFISUPP_BSSID_T));  
                }
            }               
            break;
        }
