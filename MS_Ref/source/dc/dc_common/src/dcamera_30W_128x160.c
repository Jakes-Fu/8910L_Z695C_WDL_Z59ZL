...
PUBLIC DCAMERA_IOCTL_CFG_T  g_dcam_cfg_30W_128x160 =
{
    get_GoudaOffset,
    Gouda_config,
...
static uint32 Preview_init_config(DC_CAMERA_CFG* param)
{
	...
	pCfg->hal_cfg.colRatio   = COL_RATIO_1_4;
	pCfg->hal_cfg.rowRatio   = ROW_RATIO_1_4;
	...
	pCfg->display_width = 160;
	pCfg->display_height =120;
...
/*
 *  30W sensor 640x480. 录像输出YUV 320x240
 */
static uint32 Record_init_config(DC_CAMERA_CFG* param)
{
