...
//extern const DCAMERA_IOCTL_CFG_T  g_dcam_cfg_8W_128x160;
//extern const DCAMERA_IOCTL_CFG_T  g_dcam_cfg_8W_240x320;
extern const DCAMERA_IOCTL_CFG_T  g_dcam_cfg_30W_240x320;
//extern const DCAMERA_IOCTL_CFG_T  g_dcam_cfg_30W_128x160;
...
{
	//return (DCAMERA_IOCTL_CFG_T*) &g_dcam_cfg_8W_128x160;
	//return (DCAMERA_IOCTL_CFG_T*) &g_dcam_cfg_8W_240x320;
	return (DCAMERA_IOCTL_CFG_T*) &g_dcam_cfg_30W_240x320;
	//return (DCAMERA_IOCTL_CFG_T*) &g_dcam_cfg_30W_128x160;
}
...
{
    SCI_TRACE_LOW("hch dcamera_cfg DCamera_get_GoudaOffset");
...
void Dcamera_init_config()
{
	...
	SCI_TRACE_LOW("Dcamera_init_config over!");
