...
BOOLEAN NVITEM_UpdateFixedNvitemAddr(void);
...
NVITEM_ERROR_E EFS_GetRefreshCondition(void);

/********************************************************************/
NVITEM_ERROR_E EFS_NvitemDeleteSync(
    uint16  start_identifier,
    uint16  end_identifier );
/*********************************************************************/
