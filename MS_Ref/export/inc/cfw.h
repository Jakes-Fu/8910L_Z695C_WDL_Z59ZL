...
//uint32_t  CFW_GprsAtt(uint8_t nState, uint16_t nUTI);    // notify: success or fail
...
uint32_t CFW_GprsAct(
    uint8_t nState,
    uint8_t nCid,
    uint16_t nUTI,
    CFW_SIM_ID nSimID); // [in] nCid  // notify: success or fail
