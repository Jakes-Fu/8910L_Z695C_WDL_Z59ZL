...
#define UCOM_CREATE_COM_DEBUGDATA_MODEM (0x04) /*data + debug + cp trace + modem */
#define UCOM_CREATE_COM_DEBUGDATA_UMS   ( 0x05 )  /*data for at, diag and udisk */  
#define UCOM_CREATE_MAX_TYPE       ( 0x06 )
/**----------------------------------------------------------------------------*
**                             Data Prototype                                 **
**----------------------------------------------------------------------------*/
