...
typedef enum
{
	MNPHONE_CDMA_IMSI_NOT_INIT,
	MNPHONE_CDMA_IMSI_NOT_EXIST,
	MNPHONE_CDMA_IMSI_OK,
}MNPHONE_CDMA_IMSI_STATUS;
extern uint32 MNPHONE_GetCdmaImsi(uint8 pIMSI[10],MN_DUAL_SYS_E dual_sys);
