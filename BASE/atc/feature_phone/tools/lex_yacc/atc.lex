...
"+AUNTZ"     { yylval.cmd_index = AT_CMD_AUNTZ; BEGIN(AT_CMD); return AT_EXTENSION_CMD; }
"+CFUQ"     { yylval.cmd_index = AT_CMD_CFUQ; BEGIN(AT_CMD); return AT_EXTENSION_CMD; }
"+FAPDP"     { yylval.cmd_index = AT_CMD_FAPDP; BEGIN(AT_CMD); return AT_EXTENSION_CMD; }
"+GLBAND"     { yylval.cmd_index = AT_CMD_GLBAND; BEGIN(AT_CMD); return AT_EXTENSION_CMD; }
"+GLFREQ"     { yylval.cmd_index = AT_CMD_GLFREQ; BEGIN(AT_CMD); return AT_EXTENSION_CMD; }
"+TLFREQ"     { yylval.cmd_index = AT_CMD_TLFREQ; BEGIN(AT_CMD); return AT_EXTENSION_CMD; }
"+TLBAND"     { yylval.cmd_index = AT_CMD_TLBAND; BEGIN(AT_CMD); return AT_EXTENSION_CMD; }
"+SPUPLMN"     { yylval.cmd_index = AT_CMD_SPUPLMN; BEGIN(AT_CMD); return AT_EXTENSION_CMD; }
"+CDMAIMSI"     { yylval.cmd_index = AT_CMD_CDMAIMSI; BEGIN(AT_CMD); return AT_EXTENSION_CMD; }
