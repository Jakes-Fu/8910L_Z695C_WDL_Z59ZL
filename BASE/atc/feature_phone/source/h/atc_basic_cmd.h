...
extern void ATC_InitUplmnCfgInfo(MN_DUAL_SYS_E  dual_sys);
extern void  ATC_InitBandFreq(MN_DUAL_SYS_E  dual_sys);

extern ATC_STATUS ATC_ProcessAUNTZ( // return the handle result
                ATC_CONFIG_T   * atc_config_ptr, // point to the ATC_CONFIG_T struct.
                ATC_CUR_INFO_LIST_T *cur_cmd_info // point to the atc cmd info
                            );
extern ATC_STATUS ATC_ProcessCFUQ( // return the handle result
                ATC_CONFIG_T   * atc_config_ptr, // point to the ATC_CONFIG_T struct.
                ATC_CUR_INFO_LIST_T *cur_cmd_info // point to the atc cmd info
                            );
extern ATC_STATUS ATC_ProcessFAPDP( // return the handle result
                ATC_CONFIG_T   * atc_config_ptr, // point to the ATC_CONFIG_T struct.
                ATC_CUR_INFO_LIST_T *cur_cmd_info // point to the atc cmd info
                            );
extern ATC_STATUS ATC_ProcessGLBAND(
                ATC_CONFIG_T   * atc_config_ptr, // point to the ATC_CONFIG_T struct.
                ATC_CUR_INFO_LIST_T *cur_cmd_info // point to the atc cmd info
                );
extern ATC_STATUS ATC_ProcessTLBAND(
               ATC_CONFIG_T *atc_config_ptr,
               ATC_CUR_INFO_LIST_T *cur_cmd_info
                );
extern ATC_STATUS ATC_ProcessGLFREQ(
               ATC_CONFIG_T *atc_config_ptr,
               ATC_CUR_INFO_LIST_T *cur_cmd_info
               );
extern ATC_STATUS ATC_ProcessTLFREQ(
               ATC_CONFIG_T *atc_config_ptr,
               ATC_CUR_INFO_LIST_T *cur_cmd_info
               );
extern ATC_STATUS ATC_ProcessSPUPLMN(
                ATC_CONFIG_T   * atc_config_ptr, // point to the ATC_CONFIG_T struct.
                ATC_CUR_INFO_LIST_T *cur_cmd_info // point to the atc cmd info
                );

extern ATC_STATUS ATC_ProcessCDMAIMSI(
                ATC_CONFIG_T        *atc_config_ptr, // point to the ATC_CONFIG_T struct.
                ATC_CUR_INFO_LIST_T *cur_cmd_info // point to the atc cmd info
                );
/**---------------------------------------------------------------------------*
