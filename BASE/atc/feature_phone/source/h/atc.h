...
#define ATC_SIO_DEFAULT_PORT  COM_DATA
#define ATC_SIO_PPP_PORT  COM_DATA2
...
#if defined(AUDIO_PARAM_ARM) || defined(DUALSIM_SIMLOCK_SUPPORT)
...
#define ATC_SIND_DEFAULT_VAL       2047
...
#if defined(AUDIO_PARAM_ARM) || defined(DUALSIM_SIMLOCK_SUPPORT)
#define ATC_MAX_CMD_LINE_LENGTH       5120//4096
#else
...
#if (!defined(_MUX_ENABLE_) || defined(_MUX_REDUCED_MODE_)) &&!defined(_ATC_UIX8910_ENABLE_)
...
{
    ATC_PLAIN_CONNECT = 0,
    ATC_CONNECT_WITH_BAUD
}ATC_CONNECT_RESULT_MODE_ENUM;
...
/*----------------------------------------------------------------------------*/
    ...
    uint8       aoc_mode;         /* 0: Query CCM value.
                                         ...
                                         */
    uint32      ccm_val;
    //uint8       cicb_val;         /* AT+CICB=<mode> 0:data call 1: fax call 2: speech call*/
    ...
    BOOLEAN     audio_flag;    
    BOOLEAN     call_ready_flag[MN_DUAL_SYS_MAX];
    ...
    */
    ...
    ATC_CONNECT_RESULT_MODE_ENUM connect_result_code_mode;// identify connect mode, ATXn
    uint8                           cfun_status[MN_SYS_NUMBER];
    BOOLEAN           is_sim_init[MN_SYS_NUMBER];
}ATC_CONFIG_T;
...
/*----------------------------------------------------------------------------*/
    ...
    BOOLEAN     audio_flag;    
    BOOLEAN     call_ready_flag[MN_SYS_NUMBER];
    ...
    */
    ...
    ATC_CONNECT_RESULT_MODE_ENUM connect_result_code_mode;
    uint8                           cfun_status[MN_SYS_NUMBER];
    BOOLEAN           is_sim_init[MN_SYS_NUMBER];
    uint8                 current_link_id;
    ATC_EXP_LINK_INFO_T   atc_exp_link_info;
