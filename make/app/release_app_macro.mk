...
ifeq ($(strip $(MMI_22_INDIAN_SUPPORT)),TRUE)

     MCFLAG_OPT  += -DIM_KANNADA_SUPPORT
     MCFLAG_OPT  += -DIM_TELUGU_SUPPORT
     MCFLAG_OPT  += -DIM_BENGALI_SUPPORT
     
     MCFLAG_OPT  += -DIM_MALAYALAM_SUPPORT
     MCFLAG_OPT  += -DIM_MARATHI_SUPPORT
     MCFLAG_OPT  += -DIM_URDU_SUPPORT
     
     MCFLAG_OPT  += -DIM_ORIYA_SUPPORT
     MCFLAG_OPT  += -DIM_TAMIL_SUPPORT
     MCFLAG_OPT  += -DIM_HINDI_SUPPORT
     
     MCFLAG_OPT  += -DIM_PUNJABI_SUPPORT
     MCFLAG_OPT  += -DIM_GUJARATI_SUPPORT
     MCFLAG_OPT  += -DIM_ASSAMESE_SUPPORT
     
endif


#2016 standard
#MCFLAG_OPT += -DMMI_VCARD_BACKUP_BY_GROUP_SUPPORT
MCFLAG_OPT += -DMMIPB_DELETE_CONTACTS_BY_GROUP_SUPPORT
#MCFLAG_OPT += -DMMI_CLEAR_CODE_SUPPORT # clear code
#MCFLAG_OPT += -DMMI_22_INDIAN_SUPPORT #IM_HINDI_SUPPORT ON
MCFLAG_OPT += -DMMI_BLACKLIST_SUPPORT
#MCFLAG_OPT += -DACCOUNT_AUTO_ADAPT_BY_SPN_PNN #部分特殊运营商，通过spn，pnn进行匹配
#MCFLAG_OPT += -DMMI_EUALERT_SUPPORT
MCFLAG_OPT += -DMMIPB_TIPS_OPEN
#MCFLAG_OPT += -DCALL_REC_FILE_SEPERATE #calling record by contacts' name
#MCFLAG_OPT += -DDATA_CONNECT_DUAL #dual sim data connection
ifeq ($(strip $(TCARD_PB_SUPPORT)), TRUE)
	MCFLAG_OPT += -DPB_ADD_TO_TCARD
	MCFLAG_OPT += -DPB_DELETE_FROM_TCARD
	MCFLAG_OPT += -DPB_COPY_TO_TCARD
	MCFLAG_OPT += -DPB_MOVE_SUPPORT
	MCFLAG_OPT += -DPB_MOVE_TO_TCARD
endif

ifeq ($(strip $(IM_SIMP_CHINESE_SUPPORT)),TRUE)
     #32x32 ch version ram limit needed
     MCFLAG_OPT  += -DMMI_MMS_MAX_ONE_MMS_SIZE_MINI
endif     
...
ifeq ($(findstring $(strip $(LOW_MEMORY_SUPPORT)),32X32 128X128),)
...
#MCFLAG_OPT += -DMMIPB_DELETE_CONTACTS_BY_GROUP_SUPPORT
#MCFLAG_OPT += -DVIRTUAL_VIBRATE_FUNC
#MCFLAG_OPT += -DMMI_BLACKLIST_SUPPORT
#MCFLAG_OPT += -DACCOUNT_AUTO_ADAPT_BY_SPN_PNN
...
#MCFLAG_OPT += -DMMI_DEVICE_STORAGE  # phone storage support