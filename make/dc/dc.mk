...
ifeq ($(strip $(PLATFORM)), UIX8910)
SOURCES				= dcamera_app.c	jpeg.c dcamera_mem.c dcamera_misc.c dcamera_cfg.c dcamera_30W_128x160.c dcamera_30W_240x320.c dcamera_8W_128x160.c dcamera_8W_240x320.c
endif
