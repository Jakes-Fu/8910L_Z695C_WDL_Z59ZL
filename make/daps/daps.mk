...
SOURCES      += ssl_alert.c ssl_algo.c ssl_algoprocess.c ssl_api.c ssl_cert.c \
		...
		corelib.c psmalloc.c osdep.c hmacsha_api.c
# sslEncode.c sslDecode.c psk.c cipherSuite.c tls.c prf.c matrixsslApi.c sslv3.c
endif
#----------------------------------------------------------------------------#
#                                   WTLS                                     #
#----------------------------------------------------------------------------#
...
SOURCES      += conn_interface_manager.c  content_handler_manager.c omadl_serialize.c\
                ...
                http_interface.c  wsp_interface.c odm.c  omadl_util.c
endif          
