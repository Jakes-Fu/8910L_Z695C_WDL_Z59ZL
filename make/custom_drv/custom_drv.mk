...
ifneq ($(findstring $(strip $(PLATFORM)),UIX8910 SC6531EFM),)
ifneq ($(strip $(SRAM_SIZE)), 16MBIT)
MCFLAG_OPT   += -DFLOWRATE_LEVEL_2
else
MCFLAG_OPT   += -DFLOWRATE_LEVEL_1
...
MINCPATH +=   chip_drv/chip_module/lcdc/uix8910 
endif
...
ifneq ($(strip $(WIFI_SUPPORT)),NONE) 
  ...
  MSRCPATH    += $(DRIVERPATH)/wifi/uni8910
  SOURCES     += uni8910_wifi.c uni8910_wifi_wcn.c wifisupp_adap_unisoc.c 
  endif 
