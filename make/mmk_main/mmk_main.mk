...
$(MMI_DIR)/source/mmi_ctrl/include $(MMI_DIR)/source/mmi_gui/include Third-party/ImageDecoder/Include \
...
SOURCES			= mmk_kbd.c  mmk_msg.c mmk_timer.c mmk_tp.c ui_layer.c mmk_gsensor.c  mmk_opsensor.c
