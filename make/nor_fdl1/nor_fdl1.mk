...
SCATFILENAME 	= fdl_bootloader/nor_fdl1/nor_fdl1_uix8910.scf
endif
...
ifeq ($(strip $(PLATFORM)), UIX8910)
ifeq ($(strip $(COMPILER)),	RVCT)
	@$(LINK) --info totals --entry 0x800100 --scatter $(SCATFILENAME) --map --symbols --list fdl_nor1.map  --info sizes --xref \
	$(addprefix $(BUILD_DIR)/obj/nor_fdl1/, $(OBJECTS)) --Output $(BUILD_DIR)/fdl_bootloader/nor_fdl1.axf
	@$(FROMELF) -c --bin $(BUILD_DIR)/fdl_bootloader/nor_fdl1.axf --output $(BUILD_DIR)/fdl_bootloader/nor_fdl1.bin
else
	@$(LINK) -info totals -entry 0x800100 -scatter $(SCATFILENAME) -map -symbols -list fdl_nor1.map -first init.o -info sizes -xref \
    $(addprefix $(BUILD_DIR)/obj/nor_fdl1/, $(OBJECTS)) -Output $(BUILD_DIR)/fdl_bootloader/nor_fdl1.axf
	@$(FROMELF) -c -bin $(BUILD_DIR)/fdl_bootloader/nor_fdl1.axf -output $(BUILD_DIR)/fdl_bootloader/nor_fdl1.bin
endif	
endif
