...
SOURCES	       = app_tasks.c block_mem.c mmi_atc.c mmi_atc_wintab.c mmi_filetask.c mmi_modu_main.c mmi_osbridge.c mmi_port.c mmi_res_outside.c\
                ...
                mmipb_id.c mmisms_id.c mmistk_id.c tp_id.c mmialarm_id.c mmiebook_id.c \
                ...
                mmi_autotest.c mmiptscr_main.c mmiptscr_save.c \
                ...
                mmiidle_func.c mmiidle_statusbar.c mmiidle_cstyle.c mmiidle_mstyle.c mmiidle_display.c mmitakescrphoto_main.c \
...
SOURCES	+= aac_stream_demo.c amr_stream_demo.c amr_record_demo.c audio_express_demo.c mp3_stream_demo.c \
           wav_stream_demo.c pcm_record_demo.c
...
SOURCES	 +=     mmipim_export.c mmiocr_export.c \
                 mmiengtd_export.c mmifm_export.c mmidcd_export.c mmimms_export.c mmipb_export.c mmipic_edit_export.c \
...
ifeq ($(strip $(IM_ENGINE)), T9)
	...
	ifeq (SOGOU, $(findstring SOGOU, $(strip $(IM_ENGINE))))
		...
		#                mmiim_sp_tp_py26key.c mmiim_sp_tp_stroke.c mmiim_sp_tp_en9key.c mmiim_sp_tp_abc9key.c
	    	...
	    	SOURCES +=     mmiim_tp_iekie.c mmiim_tp_iekie_keyboard_cfg.c
			else
...
SOURCES	 +=     mmiim_touch_draw.c mmiim_touch_common.c mmiim_touch_ime_common.c mmiim_touch_set.c
  ifeq (SOGOU, $(findstring SOGOU, $(strip $(IM_ENGINE))))
      ...
      ifeq ($(strip $(IM_ENGINE)), CSTAR)
        ...
        ifeq ($(strip $(IM_ENGINE)), IEKIE)
		        SOURCES	 +=     mmiim_touch_ime_iekie.c mmiim_touch_ime_hw.c mmiim_touch_app_iekie.c
				else
...
ifeq ($(strip $(HERO_ENGINE_TTS_SUPPORT)), TRUE)
	ifeq ($(strip $(HERO_ENGINE_TTS_AKEY_TIME)), KEY_7_TIME)
		MCFLAG_OPT += -DHERO_ENGINE_TTS_KEY_7_TIME
	endif
	ifeq ($(strip $(HERO_ENGINE_TTS_AKEY_TIME)), KEY_8_TIME)
		MCFLAG_OPT += -DHERO_ENGINE_TTS_KEY_8_TIME
	endif
	ifeq ($(strip $(HERO_ENGINE_TTS_AKEY_TIME)), KEY_9_TIME)
		MCFLAG_OPT += -DHERO_ENGINE_TTS_KEY_9_TIME
	endif
	ifeq ($(strip $(HERO_ENGINE_TTS_AKEY_TIME)), KEY_0_TIME)
		MCFLAG_OPT += -DHERO_ENGINE_TTS_KEY_0_TIME
	endif
	ifeq ($(strip $(HERO_ENGINE_TTS_AKEY_TIME)), STAR_TIME)
	MCFLAG_OPT += -DHERO_ENGINE_TTS_KEY_STAR_TIME
	endif
	SOURCES	 +=     TTS_api.c hero_tts_api.c hero_tts_ui.c hero_tts_app.c
endif
...
ifeq ($(strip $(TTS_SUPPORT)), YOUNGTONE)
SOURCES	 +=     TTS_api.c tts_nv.c tts_youngtong_api.c tts_youngtong_audio.c youngtone_tts_interface.c  
endif

ifeq ($(strip $(TTS_SUPPORT)), YOUNGTONE_ROM)
SOURCES	 +=     TTS_api.c tts_nv.c tts_youngtong_api.c tts_youngtong_audio.c youngtone_tts_interface.c  yt_tts_16k_cn_man_data.c
endif
...
SOURCES	 += mmimms_attalistoptwin.c
endif
else
ifeq ($(strip $(MMS_SMS_IN_1_SUPPORT)), TRUE)
SOURCES	 += mmimms_control_main.c mmimms_edit.c mmimms_editwin.c mmimms_menutable_new.c mmimms_id.c mmimms_main_new.c mmimms_setting.c mmimms_settingwin.c
endif
endif
...
SOURCES	   +=  heroEngineFunc.c heroEngineWintab.c heroEngineApp.c heroEngineMotion.c heroEnginePhonebook.c heroEngineCamera.c heroEngineSimulatorApi.c heroEngineFm.c heroEngineHostName.c
...
ifneq ($(strip $(HERO_ENGINE_HMGS_SUPPORT)), NONE)
	ifeq ($(strip $(HERO_ENGINE_HMGS_SUPPORT)), FULL_ROM)
		MCFLAG_OPT += -DFIRM_HMGS_FULL_ROM
	endif
	ifeq ($(strip $(HERO_ENGINE_HMGS_SUPPORT)), MIN_ROM)
		MCFLAG_OPT += -DFIRM_HMGS_MIN_ROM
	endif
	ifeq ($(strip $(HERO_ENGINE_HMGS_SUPPORT)), TCARD)
		MCFLAG_OPT += -DFIRM_HMGS_TCARD
	endif
	MINCPATH   +=  $(MMI_DIR)/source/mmi_app/app/heroengine/call/h
	MSRCPATH   +=  $(MMI_DIR)/source/mmi_app/app/heroengine/call/c
	SOURCES    +=  HcCallIn.c HcFileAdapter.c
endif
endif
endif
...
ifeq ($(strip $(MMI_SUPPORT_CONTROLPANEL)), TRUE)
...
MINCPATH 	+= $(MMI_DIR)/source/mmi_app/app/ping/h
MSRCPATH 	+= $(MMI_DIR)/source/mmi_app/app/ping/c
SOURCES	    += mmi_ping.c mmiping_wintab.c
endif
ifeq ($(strip $(LEBAO_MUSIC_SUPPORT)), TRUE)
MINCPATH += $(MMI_DIR)/source/mmi_app/app/lebao/applib/base/inc
MSRCPATH += $(MMI_DIR)/source/mmi_app/app/lebao/applib/base/src
MINCPATH += $(MMI_DIR)/source/mmi_app/app/lebao/applib/base/src/simulator
MSRCPATH += $(MMI_DIR)/source/mmi_app/app/lebao/applib/base/src/simulator
MINCPATH += $(MMI_DIR)/source/mmi_app/app/lebao/applib/v2/inc
MSRCPATH += $(MMI_DIR)/source/mmi_app/app/lebao/applib/v2/src
...
MSRCPATH += $(MMI_DIR)/source/mmi_app/app/lebao/music/ctrl
MINCPATH += $(MMI_DIR)/source/mmi_app/app/lebao/music/view
MSRCPATH += $(MMI_DIR)/source/mmi_app/app/lebao/music/view
# 如果使用 mbedtls V206/V224, 请在项目mk文件中显示定义包含 MBEDTLS_VERSION=V2xx
# 或者修改此处以匹配对应的 mbedtls 版本
ifeq ($(strip $(MBEDTLS_VERSION)), )
MINCPATH += DAPS/export/inc/mbedtls
endif
ifeq ($(strip $(MBEDTLS_VERSION)), V206)
MINCPATH += Third-party/mbedtls/V206/include Third-party/mbedtls/V206/include/mbedtls
SOURCES += ctr_drbg.c
endif
ifeq ($(strip $(MBEDTLS_VERSION)), V224)
MINCPATH += Third-party/mbedtls/V224/include Third-party/mbedtls/V224/include/mbedtls
SOURCES += ctr_drbg-new.c
endif

SOURCES += lebao_wintable.c lebao_app.c lebao_win_base.c http_socket.c
ifeq ($(strip $(LEBAO_MUSIC_DEVELOP_MODE)), TRUE)
SOURCES += helper_b64.c helper_file.c helper_mp3.c helper_stamp.c helper_thread.c helper_mem.c http_client.c link_list.c sds.c \
				   datetime_port.c file_port.c http_socket_port.c thread.c \
				   lebao_api.c lebao_config.c lebao_event.c lebao_playlist.c lebao_srv.c \
				   bmp_file.c lebao_audio.c lebao_ctrl.c  helper_qrcode.c qrcodegen.c \
				   lebao_win_splash.c lebao_win_menu.c lebao_win_booklist.c lebao_win_history.c \
				   lebao_win_chart.c lebao_win_musiclist.c lebao_win_player.c lebao_win_volume.c lebao_win_search.c lebao_win_order.c lebao_win_local.c lebao_win_waiting.c lebao_win_confirm.c \
				   rsa_decrypt.c lib_bignum.c lib_rsa.c lebao_win_history.c lebao_aes.c
endif
endif
...
MINCPATH		+= Third-party/zmt_pinyin/api/h
...
MINCPATH		+= Third-party/zmt_yinbiao/api/h
...
MINCPATH		+= Third-party/zmt_poetry/api/h
