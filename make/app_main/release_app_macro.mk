...
#    MCFLAG_OPT		+=  -DMMI_SAM_THEME
    ...
    MCFLAG_OPT		+=  -DENG_BAND_FREQ_SUPPORT
    MCFLAG_OPT		+=  -DENG_NETWORK_SET
...
MCFLAG_OPT	+=  -DMMI_DYNA_ALLOC_WALLPAPER_BUF
 ...
 ifeq (SOGOU, $(findstring SOGOU, $(strip $(IM_ENGINE))))
  ...
  ifeq ($(strip $(RECORD_SUPPORT)), TRUE)
    ...
    MCFLAG_OPT	+=	-DMMI_CCRECORD_SUPPORT
	  MCFLAG_OPT	+=	-DMMI_AUTO_RECORD_SUPPORT
	endif

  MCFLAG_OPT		+=  -DMMI_AUDIOPLAYER_ALBUM_SUPPORT  #ID3 information
  #MCFLAG_OPT		+=  -DMMI_AUDIOPLAYER_ALBUM_ARTIST_LIST_SUPPORT
  #MCFLAG_OPT		+=  -DMMI_AUDIOPLAYER_ALBUM_IMAGE_SUPPORT
...
MCFLAG_OPT		+=  -DMMI_BT_PBAP_SUPPORT
endif
...
MCFLAG_OPT += -DVOLUME_MAX_LEVEL_9
...
ifeq ($(strip $(MMI_MSTYLE_SUPPORT)), TRUE)
MCFLAG_OPT		+=  -DMMI_BOCA_IDLE_EMERGENCY_CALL_SUPPORT
endif
...
#SECONDEDAC
#  MCFLAG_OPT += -DENG_SECONDEDAC_SUPPORT
...
#bt headset
  MCFLAG_OPT += -DMMIBT_HEADSET_AUTHORIZE
  MCFLAG_OPT += -DMMI_DUALSYS_PREFER_SIM

#share via multimedia
  MCFLAG_OPT += -DMMI_GALLERY_SHARE_VIA_MULTIMEDIA_DISABLE
  MCFLAG_OPT += -DMMI_GALLERY_WITHOUT_VIDEO
  MCFLAG_OPT += -DMMISET_GALLERY_WALLPAPER_NO_SUPPORT
  MCFLAG_OPT += -DMMI_VIDEO_PREVIEW_WITH_DEFAULT_PIC
  MCFLAG_OPT += -DMMI_VIDEOPLAYER_SET_RENAME_NOT_SUPPORT

  MCFLAG_OPT += -DMMIPB_RMVITEM_SUPPORT
  MCFLAG_OPT += -DMMIPB_SIMCONTACT_SUPPORT
