...
typedef struct
{
    ...
    //Microsoft project add++
    BOOLEAN             is_clear_anim_bg;    /*!<当解码完成，是否需要擦除anim默认背景*/
    GUI_COLOR_T         fill_color;          /*!<anim默认背景的填充颜色*/
    //Microsoft project add--
    
    MMI_IMAGE_ID_T      spinner_img_id;     //default display image icon id
    GUI_BG_T            spinner_bg;         //default bg
