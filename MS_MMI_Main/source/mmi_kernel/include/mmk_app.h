...
// 关于起始的tp move的宏定义
#define MMK_TPMOVE_POINT_MIN_NUM  (10)     // 超过该像素值算move
...
//  Note: 
/*****************************************************************************/
PUBLIC BOOLEAN MMK_ReturnMainmenuWin(void);
