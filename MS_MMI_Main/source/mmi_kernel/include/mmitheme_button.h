...
#define  MMI_DEFAULT_BUTTON_BIG_FONT   SONG_FONT_16     //boda
...
#define  MMI_DEFAULT_BUTTON_FONT   SONG_FONT_16     
#define  MMI_DEFAULT_BUTTON_BIG_FONT   SONG_FONT_20     
...
typedef struct
{
    ...
    MMI_IMAGE_ID_T      icon_id;        //MS button icon id 
} MMITHEME_BUTTON_T;
