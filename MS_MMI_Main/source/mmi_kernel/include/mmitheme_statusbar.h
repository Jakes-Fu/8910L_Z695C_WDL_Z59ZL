...
#else
#define MMISTATUSBAR_ICONANIM_TIMEOUT                500 // 动画启动时的时间间隔
#endif
#define MMISTATUSBAR_SCROLLMSG_TIMEOUT               200 // 滚动的时间间隔
#define MMISTATUSBAR_SCROLLMSG_PAUSE_TIMEOUT         1000// 滚动最后一帧停留的时间间隔

#define MMISTATUSBAR_ITEM_WIDTH                      20  // item的最大宽度
#define MMISTATUSBAR_ITEM_HEIGHT                     16//20  // item的最大高度
#define MMISTATUSBAR_ITEM_SPACE                      2   // item之间的具体

#define MMISTATUSBAR_ITEM_ICON_FRAME                6///    10   // 动画图标的最大数
#define MMISTATUSBAR_ITEM_TEXT_LEN                   25  // 文本的长度
