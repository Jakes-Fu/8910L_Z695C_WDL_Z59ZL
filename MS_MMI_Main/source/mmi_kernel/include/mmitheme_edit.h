...
typedef struct
{
    ...
    GUI_COLOR_T                 theme_color;// line color for [MS]
    GUI_COLOR_T                 non_focused_color;// line color for [MS]
    GUI_COLOR_T                 themeline_focused_color;// line color for [MS]
    GUI_COLOR_T                 themeline_unfocused_color;// line color for [MS]
...
/*****************************************************************************/
//  Description : get MS date edit theme
//  Global resource dependence : 
//  Author: Jassmine
//  Note:
/*****************************************************************************/
...
/*****************************************************************************/
//  Description : get MS time edit theme
//  Global resource dependence : 
//  Author: Jassmine
//  Note:
/*****************************************************************************/
