...
#define MMIMENU_ITEM_BG_ALPHA                    77 //30% opacity
#define MMIMENU_ITEM_BG_ALPHA_MOVE               128//50% opacity
#define MMIMENU_ITEM_UNAVAILABLE_WEAKLAYERALPHA  178
#define MMIMENU_BG_ALPHA                         102//40% opacity
#ifdef UI_MULTILAYER_SUPPORT
#define MMIMENU_SK_BG_ALPHA                      230//90% opacity
#else
#define MMIMENU_SK_BG_ALPHA                      255//100% opacity
#endif
...
#define MMITHEME_MAINMENU_CUR_ITEM_INDEX        0
...
//boda , 128x160
#define MMITHEME_MENUMAIN_TOTAL_ITEM_MAX_NUM              100//菜单项位置信息要写入NV，所以要限制个数
...
#define MMITHEME_TITLE_ICONMENU_BOTTOM_MARGIN_V           2
...
#define MMITHEME_TITLE_ICONMENU_ITEM_HEIGHT_V            40 
#define MMITHEME_TITLE_ICONMENU_ITEM_MARGIN_V             6
#define MMITHEME_TITLE_ICONMENU_ITEM_WIDTH_V              MENUTEXT_WIDTH

#define MMITHEME_TITLE_ICONMENU_LEFT_MARGIN_MOVE          6
#define MMITHEME_TITLE_ICONMENU_RIGHT_MARGIN_MOVE         6
#define MMITHEME_TITLE_ICONMENU_ITEM_MARGIN_MOVE          5
#define MMITHEME_TITLE_ICONMENU_ITEM_HEIGHT_MOVE          37
#define MMITHEME_TITLE_ICONMENU_ITEM_WIDTH_MOVE           37
...
// 主菜单图标的宽度和高度，与make file中的SPECIAL_EFFECT_ICON_SIZE_40X36一定相同
// 否则无法做主菜单icon3D特效
#define MENUICON_WIDTH      76
#define MENUICON_HEIGHT     76
#ifdef MMI_RES_SLIM_SUPPORT
...
#define MENUTEXT_HEIGHT     0
#else
#define MENUICON_FOCUSITEM_W   76
#define MENUICON_FOCUSITEM_H   76 
...
#define MENUICON_WIDTH         48
#define MENUICON_HEIGHT        48
#define MENUICON_WIDTH_NATIVE  40
#define MENUICON_NUMBER_SPACE  1
#define MENUICON_FOCUSITEM_W   48
#define MENUICON_FOCUSITEM_H   48
#define MENUTEXT_WIDTH      76
...
#define MMITHEME_ICONMENU_LEFT_MARGIN_V             0
#define MMITHEME_ICONMENU_RIGHT_MARGIN_V            0
#define MMITHEME_ICONMENU_TOP_MARGIN_V              6

#define MMITHEME_ICONMENU_ICON_TEXT_MARGIN_V        2
#define MMITHEME_ICONMENU_ITEM_HEIGHT_V             86   // 宫格菜单的item高度
#define MMITHEME_ICONMENU_ICON_TOP_SPACE_V          0    // icon与menu item区域顶部之间的的距离
...
#define MMITHEME_TITLE_ICONMENU_TOP_MARGIN_V              6//0
#define MMITHEME_TITLE_ICONMENU_ITEM_MARGIN_V             6
#define MMITHEME_TITLE_ICONMENU_ITEM_HEIGHT_V             76//75   // 带title的宫格菜单的item高度
#define MMITHEME_TITLE_ICONMENU_ITEM_WIDTH_V              76

#define MMITHEME_TITLE_ICONMENU_LEFT_MARGIN_MOVE          6
#define MMITHEME_TITLE_ICONMENU_RIGHT_MARGIN_MOVE         6
#define MMITHEME_TITLE_ICONMENU_ITEM_MARGIN_MOVE          5
#define MMITHEME_TITLE_ICONMENU_ITEM_HEIGHT_MOVE          74
#define MMITHEME_TITLE_ICONMENU_ITEM_WIDTH_MOVE           74
...
// 240*320 非PDA 宫格主菜单位置信息
#define MMITHEME_ICONMENU_BOTTOM_MARGIN_H           2 //28
#define MMITHEME_ICONMENU_LEFT_MARGIN_H             5
#define MMITHEME_ICONMENU_RIGHT_MARGIN_H            5
#define MMITHEME_ICONMENU_TOP_MARGIN_H              8 // 2

#define MMITHEME_ICONMENU_ICON_TEXT_MARGIN_H        0
#ifdef MAIN_MENU_48X48
#define MMITHEME_ICONMENU_ITEM_HEIGHT_H             86 //65   // 宫格菜单的item高度
#else
...
#endif
    MMIMENU_LANGUAGE_BELARUS,
    MMIMENU_LANGUAGE_LINGALA,
    MMIMENU_LANGUAGE_MALAGASY,
    MMIMENU_LANGUAGE_PASHTO,
    MMIMENU_LANGUAGE_UZBEK,    
...
typedef struct
{
    ...
    uint16          item_margin;       //menu item的间距
...
#define MMITHEME_MENU_ITEM_WIDTH        MMITHEME_TITLE_ICONMENU_ITEM_WIDTH_V//MENUTEXT_WIDTH
#define MMITHEME_MENU_ITEM_HEIGHT       MMITHEME_TITLE_ICONMENU_ITEM_HEIGHT_V//(MENUICON_HEIGHT + MENUTEXT_HEIGHT + MMITHEME_ICONMENU_ICON_TEXT_MARGIN)
#define MMITHEME_MENU_ITEM_WIDTH_MOVE   MMITHEME_TITLE_ICONMENU_ITEM_WIDTH_MOVE
#define MMITHEME_MENU_ITEM_HEIGHT_MOVE   MMITHEME_TITLE_ICONMENU_ITEM_HEIGHT_MOVE

#define MMITHEME_MENU_ITEM_DELTA_H      (MMITHEME_TITLE_ICONMENU_ITEM_WIDTH_V - MMITHEME_TITLE_ICONMENU_ITEM_WIDTH_MOVE)/2
#define MMITHEME_MENU_ITEM_DELTA_V      (MMITHEME_TITLE_ICONMENU_ITEM_HEIGHT_V - MMITHEME_TITLE_ICONMENU_ITEM_HEIGHT_MOVE)/2
...
PUBLIC GUI_LCD_DEV_INFO MMITHEME_DrawMainmenuItem(
                                                  ...
                                                  BOOLEAN is_install_item
                                                  );

/*****************************************************************************/
//  Description : get menu item focus icon
//  Global resource dependence : 
//  Author: Cheney.Wu
//  Note: main menu icon customization according the theme id
/*****************************************************************************/
PUBLIC MMI_IMAGE_ID_T MMITHEME_GetMainmenuFocusIcon(MMITHEME_ACCENT_COLOR_E accent_id);
