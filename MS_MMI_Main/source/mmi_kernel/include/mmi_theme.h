...
#define MMITHEME_PHONE_IMG_WIDTH  56 //46//50
#define MMITHEME_PHONE_IMG_HEIGHT  88 //66//100
#endif
#define MMITHEME_TEXT_SCROLL_STEP_MIN   (3) //表示字符串最小滚动步数
...
#define MMI_IDLE_NTF_LIST_BG_ALPHA (255*0.8)
#else
#define MMI_IDLE_NTF_LIST_BG_ALPHA 255
#endif
...
/*****************************************************************************/
// 	Description : Get Accent Color By accent_id
//	Global resource dependence : 
//  Author: 
//	Note:
/*****************************************************************************/
