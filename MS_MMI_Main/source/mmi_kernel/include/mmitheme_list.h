...
#define GUIILIST_MASK_BG_ALPHA  (255*0.35)
...
#define MMI_LIST_ITEM_SELECT_ICON_LEFT_MARGIN  2
#define MMI_LIST_ITEM_SELECT_ICON_TOP_MARGIN   6
#define MMI_LIST_ITEM_SELECT_ICON_RECT_WIDTH   16
#define MMI_LIST_ITEM_SELECT_ICON_RECT_HEIGHT  16
#define MMI_LIST_ITEM_SPECIAL_SELECT_ICON_RECT_WIDTH   24
#define MMI_LIST_ITEM_SPECIAL_SELECT_ICON_RECT_HEIGHT  24
#else
#define MMI_LIST_ITEM_SELECT_ICON_LEFT_MARGIN  6
#define MMI_LIST_ITEM_SELECT_ICON_TOP_MARGIN   12
#define MMI_LIST_ITEM_SELECT_ICON_RECT_WIDTH   18
#define MMI_LIST_ITEM_SELECT_ICON_RECT_HEIGHT  18
#define MMI_LIST_ITEM_SPECIAL_SELECT_ICON_RECT_WIDTH   42
#define MMI_LIST_ITEM_SPECIAL_SELECT_ICON_RECT_HEIGHT  42
#endif
...
//xiyuan edit
    ...
    GUIITEM_LAYOUT_TWO_LINE_ANIM_TWO_TEXT_AND_TEXT_3_SCROLL,
#endif
...
//zmt add end
    ...
    //|        text               |
    //|---------------------------|
    //Two label list item with size stamp--multi choice picker
    GUIITEM_STYLE_MULTI_CHOICE_PICKER_TWO_LINE_TEXT_AND_TEXT_2,
...
//    GUIITEM_STYLE_ONE_TWO_LINE_SETTING_TEXT_AND_ICON_TEXT,
    ...
    //| ┗┛   text               |
    //|---------------------------|
    GUIITEM_STYLE_TWO_LINE_ANIM_TWO_TEXT_AND_TEXT_3_SCROLL,
    #if defined(ZDT_PHILIPS_DIAL_SEARCH_STYLE) //   A20210129
    GUIITEM_STYLE_TWO_LINE_ANIM_TWO_TEXT_AND_TEXT_3_SCROLL_NEW,
    #endif
#endif

    //add for pb_avatar_text_item_quick_action
    //Custom_UI_spec_Contacts_0.95.pdf --- P45
    //one line --- (quick action icon) + (left triangle icon) + avatar + (avatar mask) + text
    GUIITEM_STYLE_PB_ONE_LINE_AVATAR_TEXT_LEFT_FOCUS_MS,
...
//end
    ...
    GUIITEM_STYLE_TWO_LINE_2BIGICON_TEXT_AND_TEXT_MS,
    ...
    //The different from GUIITEM_STYLE_2TEXT_AND_TEXT_WITH_LEFT_FOCUS_MS is
    //that it's corresponded with text_and_2text item style.
	...
	//|---------------------------|
    //Two label list item with icon--Quick Action list item
    GUIITEM_STYLE_TWO_LINE_BIGICON_TEXT_AND_TEXT_WITH_2_MASK_MS,
	//|---------------------------|
	//|  ┏┓   text              | 
	//|  ┗┛   text              |      
	//|---------------------------|
	//Two label list item with avatar –Initials (no photo available)
    GUIITEM_STYLE_TWO_LINE_INITIALTEXT_TEXT_AND_TEXT_WITH_2_MASK_MS,
	//|-----------------------------|
	//| [@] text      [rightQuick]  |
	//|     text      [rightQuick]  |
	//|-----------------------------|
    //Two label list item with icon--Quick Action list item
	GUIITEM_STYLE_TWO_LINE_BIGICON_TEXT_AND_TEXT_WITH_2_MASK_RIGHT_FOCUS_MS,
	//|-----------------------------|
	//| [leftQuick]   [@]text       |
	//| [leftQuick]      text       |
	//|-----------------------------|
	//Two label list item with icon--Quick Action list item
	GUIITEM_STYLE_TWO_LINE_BIGICON_TEXT_AND_TEXT_WITH_2_MASK_LEFT_FOCUS_MS,
    //|---------------------------|
    //| [leftQuick] [@ ]   text   | 
    //|                    text   |      
    //|---------------------------|
    //Two label list item with avatar –Initials (no photo available) -- Quick Action list item
    GUIITEM_STYLE_TWO_LINE_INITIALTEXT_TEXT_AND_TEXT_WITH_2_MASK_LEFT_FOCUS_MS,
    ...
    //|---------------------------|
    //Two label list item with avatar –Initials (no photo available) -- Quick Action list item
    // GUIITEM_STYLE_TWO_LINE_INITIALTEXT_TEXT_AND_WITH_MASK_AND_TEXT_WITH_RIGHT_FOCUS_MS,
	GUIITEM_STYLE_TWO_LINE_INITIALTEXT_TEXT_AND_TEXT_WITH_2_MASK_RIGHT_FOCUS_MS,
	//|---------------------------|
	//|         text         ┏┓ |
	//|         text         ┗┛ |
	//|---------------------------|
...
/***Microsoft project need to support different color for content+++****/
//自定义content的字体颜色、透明度
typedef struct
{
    GUI_COLOR_T     font_color;//normal font color
    uint8           alpha;		//normal font color alpha value
    GUI_COLOR_T     font_color_focus;//focus font color
	uint8           alpha_focus;     //focus font color alpha value
} THEMELIST_CONTENT_COLOR_STYLE_T;
/***Microsoft project need to support different color for content---****/
...
typedef struct
{
    ...
    MMI_IMAGE_ID_T  avatar_marked_image_id;     // 标记图片id	
    ...
    MMI_IMAGE_ID_T  avatar_checkbox_selected_image_id;    // 多选选中图标
    MMI_IMAGE_ID_T  avatar_checkbox_unselected_image_id;  // 多选未选中图标
	MMI_IMAGE_ID_T  avatar_checkbox_unselected_avatar_image_1_id;
	MMI_IMAGE_ID_T  avatar_checkbox_unselected_avatar_image_2_id;
    MMI_IMAGE_ID_T  toggle_on_image_id; //开启图标
    MMI_IMAGE_ID_T  toggle_off_image_id;//关闭图标
    ...
    BOOLEAN         is_custom_right_sk; //是否需要单独设置右软键显示图标或文本
    ...
    GUI_COLOR_T     split_item_text_font_color; //分隔符item文本的字体颜色
    uint32          split_item_text_alpha;  //分隔符item文本的字体透明度
	uint16			split_line_hight;		//分隔符线条高度
    GUI_COLOR_T	split_line_color_with_label; //带有label的分隔符线条颜色
    ...
    /*microsoft project need to support+++*/
    //每个content的color style
    THEMELIST_CONTENT_COLOR_STYLE_T      content_color_style[GUIITEM_CONTENT_MAX_NUM];    
    int16           custom_content_item;    //自定义font color的content_item索引号 
    GUI_BORDER_T    content_border;         // content边框
    //focus状态下显示的三角图片
    uint16          triangle_width;         //三角图片的宽度
    MMI_IMAGE_ID_T  left_triangle_icon_id;  //左三角图片的image id
    uint16          left_triangle_left_space;//左三角图片的左边距
    MMI_IMAGE_ID_T  right_triangle_icon_id; //右三角图片的image id
    uint16          right_triangle_right_space;//右三角图片的右边距
    //Quick Action图片
    uint16          quick_icon_bg_width;//quick图片背景区域宽度
    uint16          quick_icon_margin; //quick图片的边距
    uint16          quick_icon_width;       //Quick图片的宽度
    MMI_IMAGE_ID_T  left_quick_icon_image;    //Qucik图片的image id
    MMI_IMAGE_ID_T  right_quick_icon_image;    //Qucik图片的image id
    uint16          quick_and_triangel_space;  //Quick图片与三角图片之间的间隔
