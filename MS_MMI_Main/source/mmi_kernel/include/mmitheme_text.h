...
#define MMITHEME_TEXT_MARGIN_SPACE      3
#define MMITHEME_TEXT_CHAR_SPACE        1
#define MMITHEME_TEXT_LINE_SPACE       2	//该间距下，PUBWIN纯文本可显示4行

#define MMITHEME_TEXT_MARGIN_HEIGHT_SPACE     2
#define MMITHEME_TEXT_MARGIN_WIDTH_SPACE      2
 #else
#define MMITHEME_TEXT_MARGIN_SPACE      5
#define MMITHEME_TEXT_CHAR_SPACE        1
#define MMITHEME_TEXT_LINE_SPACE       5	//该间距下，PUBWIN纯文本可显示4行

#define MMITHEME_TEXT_MARGIN_HEIGHT_SPACE      12
#define MMITHEME_TEXT_MARGIN_WIDTH_SPACE      6
#endif
/**--------------------------------------------------------------------------*
 **                         TYPE AND STRUCT                                  *
 **--------------------------------------------------------------------------*/
