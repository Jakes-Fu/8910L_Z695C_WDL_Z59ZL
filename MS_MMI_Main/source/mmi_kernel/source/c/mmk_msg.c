...
//         break;
    ...
    default:
	 if((MSG_TYPE_NONE==mmi_msg_ptr->msg_type) && (mmi_msg_ptr->msg_id !=0))
	 {
        SCI_TRACE_LOW("mmk_msg.c Line 396, MSG_TYPE_NONE,msd_id=%x",mmi_msg_ptr->msg_id);
	 }
	 else
	 {
                          ...
                          )
{
    ...
    if(s_mmk_msg_queue.msg[ s_mmk_msg_queue.writepos ].param_ptr != PNULL)
    {
    	SCI_FREE(s_mmk_msg_queue.msg[ s_mmk_msg_queue.writepos ].param_ptr);
	s_mmk_msg_queue.msg[ s_mmk_msg_queue.writepos ].param_ptr = PNULL;
    }
    ...
    //queue full
    if(  s_mmk_msg_queue.writepos +1 % s_mmk_msg_queue.len == s_mmk_msg_queue.readpos )
    {
...
//============== MET MEX  end ===================
    default:
        ...
        SCI_TRACE_ID(TRACE_TOOL_CONVERT,MMK_MSG_579_112_2_18_3_22_42_10,(uint8*)"u", (*signal_ptr)->Sender );
        DispatchSysSig((*signal_ptr));
        break;
    }
