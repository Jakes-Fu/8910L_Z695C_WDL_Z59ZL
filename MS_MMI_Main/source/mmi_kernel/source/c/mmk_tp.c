                       ...
                       )
{
    ...
    case MMI_TP_DOWN:        
        ...
        MMK_AddVelocityItemExt( tppress_ptr->x, tppress_ptr->y, MMI_TP_DOWN ); // 增加速度的点
    ...
    case MMI_TP_UP:
        MMK_AddVelocityItemExt( tppress_ptr->x, tppress_ptr->y, MMI_TP_UP ); // 增加速度的点
        ReduceHandleTPNum();
    ...
    case MMI_TP_MOVE:
        MMK_AddVelocityItemExt( tppress_ptr->x, tppress_ptr->y, MMI_TP_MOVE ); // 增加速度的点
                       ...
                       )
{
    ...
    if (s_is_tp_move
        || abs(tppress_ptr->x - s_tp_point_x) > move_spacing
        || abs(tppress_ptr->y - s_tp_point_y) > move_spacing)
    {
        is_tp_move = TRUE;
        s_is_delay_tp_move = FALSE;
    }
