...
typedef enum
{
    ...
    GUIFORM_CHILD_HEIGHT_MAX_TO_BOTTOM, /*设置高度为从该child开始位置到该form的bottom的高度*/
...
typedef enum
{
    ...
    GUIFORM_CHILD_DISP_FROM_HEAD, /*!<从头开始显示>*/
...
typedef enum
{
    ...
    GUIFORM_CHILD_DOCK_FLOAT,   /*!<浮动，不占空间*/
