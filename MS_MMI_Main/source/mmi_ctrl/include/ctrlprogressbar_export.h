...
typedef enum
{
    ...
    GUIPRGBOX_STYLE_HORIZONTAL_PROCESS,     /*!< 横向进度条 */
    GUIPRGBOX_STYLE_VOLUME_BAR,             /*!< 音量调节条 */
    GUIPRGBOX_STYLE_BRIGHTNESS_BAR,         /*!< 亮度调节条 */
    GUIPRGBOX_STYLE_NPS_SCORE_BAR,          /*!< NPS SCORE  */
    GUIPRGBOX_STYLE_KEYPAD_VOLUME_BAR,      /*!< keypad音量调节条 */
...
#endif
    GUIPRGBOX_STYLE_RECT_WAITING_INDICATOR_PROCESS,
