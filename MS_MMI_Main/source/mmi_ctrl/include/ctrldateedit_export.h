...
typedef enum
{
	GUIEDIT_DATE_DEFAUL_DISPLAYTYPE,
    GUIEDIT_DATE_NORMAL_DISPLAYTYPE,
    GUIEDIT_DATE_DIALOG_DISPLAYTYPE,    
	GUIEDIT_DATE_COMBINE_TIME_DISPLAYTYPE,    
    GUIEDIT_DATE_MAX_DISPLAYTYPE
}GUIEDIT_DATE_DISPLAY_TYPE_E;
