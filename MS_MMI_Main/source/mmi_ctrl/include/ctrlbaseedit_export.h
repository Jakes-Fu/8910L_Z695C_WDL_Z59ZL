...
typedef enum
{
    ...
    GUIEDIT_STYLE_MULTI_DYN_DOWN, // [MS] 多行
...
typedef enum
{
    	GUILABEL_DATA_TEXT_ID,     /*!< 显示文本 */ 
	GUILABEL_DATA_TEXT_BUFFER  /*!< 显示文本 */  
}GUIEDITLABEL_TEXT_DATA_E;

typedef enum
{
    	GUIHINTTEXT_DATA_TEXT_ID,     /*!< 显示文本 */ 
	GUIHINTTEXT_DATA_TEXT_BUFFER  /*!< 显示文本 */  
