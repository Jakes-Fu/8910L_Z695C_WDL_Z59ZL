...
#define TEXT_DIALOG_TITLE_FONT SONG_FONT_12
#define TEXT_DIALOG_TITLE_TOP_OFFSET             6
#define TEXT_DIALOG_RECT_OFFSET_WITH_TITLE       6
#define TEXT_DIALOG_RECT_OFFSET_WITHOUT_TITLE    2
#else
#define TEXT_DIALOG_TITLE_FONT SONG_FONT_24
#define TEXT_DIALOG_TITLE_TOP_OFFSET             6
#define TEXT_DIALOG_RECT_OFFSET_WITH_TITLE       6
#define TEXT_DIALOG_RECT_OFFSET_WITHOUT_TITLE    2
#endif
...
typedef struct _text_obj_tag
{
    ...
    BOOLEAN                 is_font_height_changed;         //is font height chage
    uint16                      font_height;     //font height
    ...
    uint16                      cur_top_line_index;     //displaying top line index
    uint16                      cur_bottom_line_index;  //displaying the bottom line index
    ...
    BOOLEAN                     is_text_dialog;     //text dialog flag
    MMI_STRING_T                dialog_title_str;    
} CTRLTEXT_OBJ_T;
