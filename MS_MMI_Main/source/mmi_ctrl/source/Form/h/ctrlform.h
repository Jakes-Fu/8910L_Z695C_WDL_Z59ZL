...
typedef struct _ctrlform_obj_tag
{
    ...
    BOOLEAN                     is_reset_top_down;    //is need form to set child's select postion
    ...
    uint16                      cur_top;
    uint16                      cur_bottom;
    BOOLEAN                     cur_dock_postion_valid;
...
PUBLIC GUIFORM_CHILD_DOCK_E CTRLFORM_GetDockChildType(
                                    CTRLFORM_CHILD_T    *child_ptr
                                    );
...
//  Note:
/*****************************************************************************/
PUBLIC CTRLFORM_CHILD_T* CTRLFORM_GetDockChildPtrByDockType(
                                                  GUIFORM_CHILD_DOCK_E  dock_type,  //in:
                                                  CTRLFORM_OBJ_T    *form_ctrl_ptr  //in:
                                                  );
