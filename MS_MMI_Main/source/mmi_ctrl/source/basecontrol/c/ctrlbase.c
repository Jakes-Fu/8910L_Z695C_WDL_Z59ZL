...
//	Note:
/*****************************************************************************/
PUBLIC BOOLEAN CTRLBASE_SetDisplayRect (
    MMI_HANDLE_T            ctrl_handle,
    const GUI_RECT_T        *rect_ptr,
    BOOLEAN           is_update
)
{
    ...
    if (PNULL != rect_ptr && PNULL != base_ctrl_ptr)
    {
        result = VTLBASE_SetDisplayRect (base_ctrl_ptr, rect_ptr, is_update);
    }
    return result;
}
...
//	Note:
/*****************************************************************************/
PUBLIC BOOLEAN CTRLBASE_SetActiveEx(
    MMI_HANDLE_T	ctrl_handle,
    BOOLEAN         is_active,    
    BOOLEAN         is_update
    )
{
    ...
    if (PNULL != base_ctrl_ptr)
    {
        result = VTLBASE_SetActive (base_ctrl_ptr, is_active);
