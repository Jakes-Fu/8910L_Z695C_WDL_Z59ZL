                               ...
                               )
{
    ...
    width = (uint16)(MMITHEME_GetScrollBarWidthByState(menu_ctrl_ptr->common_theme.is_used_slide) + 2);
                          ...
                          )
{
    ...
    //set bg
    GUIWIN_SetTitleBackground(menu_ctrl_ptr->win_handle,menu_ctrl_ptr->sec_theme.title_icon_id,GUI_RGB2RGB565(0xff,0xff,0xff));
                                      ...
                                      )
{
    ...
    if (MMITHEME_GetIsScrollAsPixel())
    {
        ...
        menu_ctrl_ptr->item_str_index = GUI_CalculateStringScrollStartPos(text_pixel_len,text_rect_width,
                                    menu_ctrl_ptr->sec_theme.pixel_scroll_step,
                                    menu_ctrl_ptr->item_str_index);
    }
    else
    {
