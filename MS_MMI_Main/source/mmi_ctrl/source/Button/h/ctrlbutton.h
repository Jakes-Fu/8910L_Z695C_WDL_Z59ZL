...
#define RECT_BUTTON_WIDTH	            (240)
#define RECT_BUTTON_HEIGHT              (46)
#define RECT_BUTTON_BORDER              (6)
#define TEXT_LABEL_WIDTH 		        (228)
#define TEXT_LABEL_HEIGHT 		        (26)
#define TEXT_LABEL_LEFT_MARGIN	        (6)
#define TEXT_LABEL_TOP_MARGIN	        (4)
#define ICON_LABEL_TOP_MARGIN	        (2)
#define ICON_LABEL_HEIGHT	            (30)
#define ICON_LABEL_TEXT_ICON_SPACE	    (6)
#define ICON_LABEL_IMAG_TOP_MARGIN	    (9)
#define ICON_LABEL_IMAG_HEIGHT		    (16)
...
typedef struct _button_obj_tag
{
    ...
    BOOLEAN                     is_rect_button;
    GUI_LCD_DEV_INFO            transparent_layer_info;
    GUI_COLOR_T                 label_bg_color;
    BOOLEAN                     is_focused;
} CTRLBUTTON_OBJ_T;
