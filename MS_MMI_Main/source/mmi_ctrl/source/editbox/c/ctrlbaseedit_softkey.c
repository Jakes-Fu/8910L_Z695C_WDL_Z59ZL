...
)
{
	...
	MMI_IMAGE_ID_T	left_softkey_img_id = 0;
	MMI_IMAGE_ID_T	mid_softkey_img_id = 0;
	MMI_IMAGE_ID_T	right_softkey_img_id = 0;
	uint16 i=0;
    CTRLBASE_OBJ_T  *base_ctrl_ptr = (CTRLBASE_OBJ_T*) baseedit_ctrl_ptr;
...
//         right_softkey_id = baseedit_ctrl_ptr->common_theme.softkey.button[2].text_1;
		...
		left_softkey_img_id  = baseedit_ctrl_ptr->common_theme.softkey.button[0].image_id;
		mid_softkey_img_id   = baseedit_ctrl_ptr->common_theme.softkey.button[1].image_id;
		right_softkey_img_id = baseedit_ctrl_ptr->common_theme.softkey.button[2].image_id;
        ...
        {
			if (baseedit_ctrl_ptr->common_theme.softkey.button[0].button_type == EDIT_BUTTON_TEXT_ID)
			{
            left_softkey_id = baseedit_ctrl_ptr->common_theme.softkey.button[0].text_2;
        }
			else
			{
				left_softkey_img_id = baseedit_ctrl_ptr->common_theme.softkey.button[0].image_id_2;
			}
        }
        ...
        {
			if (baseedit_ctrl_ptr->common_theme.softkey.button[1].button_type == EDIT_BUTTON_TEXT_ID)
			{
            mid_softkey_id = baseedit_ctrl_ptr->common_theme.softkey.button[1].text_2;
        }
			else
			{
				mid_softkey_img_id = baseedit_ctrl_ptr->common_theme.softkey.button[1].image_id_2;
			}
        }
        ...
        {
			if (baseedit_ctrl_ptr->common_theme.softkey.button[2].button_type == EDIT_BUTTON_TEXT_ID)
			{
            right_softkey_id = baseedit_ctrl_ptr->common_theme.softkey.button[2].text_2;
        }
			else
			{
				right_softkey_img_id = baseedit_ctrl_ptr->common_theme.softkey.button[2].image_id_2;
			}
        }
