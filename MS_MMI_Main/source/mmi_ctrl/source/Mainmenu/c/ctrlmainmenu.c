                                   ...
                                   )
{
    ...
    if (PNULL != mainmenu_ctrl_ptr->call_back.Handle)
    {
        mainmenu_ctrl_ptr->call_back.Handle(
            mainmenu_ctrl_ptr->pm_data_ptr,
            MSG_CTRLMAINMENU_SET_COLOR_THEME_MODE, (DPARAM)&is_color_theme_mode);
        result = TRUE;
    }
                                   ...
                                   )
{
    ...
    if (PNULL != mainmenu_ctrl_ptr->call_back.Handle)
    {
        mainmenu_ctrl_ptr->call_back.Handle(
            mainmenu_ctrl_ptr->pm_data_ptr,
            MSG_CTRLMAINMENU_IS_COLOR_THEME_MODE, (DPARAM)&result);
    }
                                   ...
                                   )
{
    ...
    if (PNULL != mainmenu_ctrl_ptr->call_back.Handle)
    {
        mainmenu_ctrl_ptr->call_back.Handle(
            mainmenu_ctrl_ptr->pm_data_ptr,
            MSG_CTRLMAINMENU_IS_MOVE_MODE, (DPARAM)&result);
    }
                                   ...
                                   )
{
    ...
    if (PNULL != mainmenu_ctrl_ptr->call_back.Handle)
    {
        mainmenu_ctrl_ptr->call_back.Handle(
            mainmenu_ctrl_ptr->pm_data_ptr,
            MSG_CTRLMAINMENU_IS_UNINSTALLABLE, (DPARAM)&result);
    }
                                   ...
                                   )
{
    ...
    if (PNULL != mainmenu_ctrl_ptr->call_back.Handle)
    {
        mainmenu_ctrl_ptr->call_back.Handle(
            mainmenu_ctrl_ptr->pm_data_ptr,
            MSG_CTRLMAINMENU_SET_MOVE_MODE, (DPARAM)&is_move_mode);
                                   ...
                                   )
{
    ...
    if (PNULL != mainmenu_ctrl_ptr->call_back.Handle)
    {
        mainmenu_ctrl_ptr->call_back.Handle(
            mainmenu_ctrl_ptr->pm_data_ptr,
            MSG_CTRLMAINMENU_REDRAW, (DPARAM)&result);
                                   ...
                                   )
{
    ...
    if (PNULL != mainmenu_ctrl_ptr->call_back.Handle)
    {
        mainmenu_ctrl_ptr->call_back.Handle(
            mainmenu_ctrl_ptr->pm_data_ptr,
            MSG_CTRLMAINMENU_LOSE_FOCUS_REDRAW, (DPARAM)&result);
