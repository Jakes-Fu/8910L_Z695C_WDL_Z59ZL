                                                    ...
                                                    )
{
    ...
    if(PNULL == travel_ptr)
    {
        SCI_TRACE_LOW("MMI_CreateTreeTravelInfo: travel_ptr is PNULL, malloc size is %d", sizeof(MMITREE_TRAVEL_INFO_T));    
    ...
    {
        SCI_TRACE_LOW("MMI_CreateTreeTravelInfo: travel_ptr->data_ptr is PNULL, malloc size is %d", travel_ptr->max_num * sizeof(uint32));    
                                   ...
                                   )
{
    ...
    if(PNULL == node_ptr)
    {
        SCI_TRACE_LOW("TreeNodeNew: node_ptr is PNULL, malloc size is %d", sizeof(MMI_TREENODE_T));
