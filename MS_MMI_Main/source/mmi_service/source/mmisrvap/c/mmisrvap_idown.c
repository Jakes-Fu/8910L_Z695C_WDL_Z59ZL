...
)
{
    ...
    case MMISRVAUD_REPORT_END:
        ...
        if(report_ptr->data1 == MMISRVAUD_REPORT_RESULT_NOT_SUPPORT)
        	error_code = MMISRVAP_ERROR_FILE_FORMAT_NOT_SUPPORT;
        else if(report_ptr->data1 == MMISRVAUD_REPORT_RESULT_ERROR)
