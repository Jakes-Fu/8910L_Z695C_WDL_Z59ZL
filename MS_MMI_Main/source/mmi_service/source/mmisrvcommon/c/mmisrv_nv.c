...
PUBLIC MN_RETURN_RESULT_E MMISRV_ReadNVItem(uint32 item_id, void * buffer_ptr)
{
    ...
    reslut = MNNV_ReadItem(true_item_id, s_mmisrv_nv_len[module_id][nv_offset], buffer_ptr); /*read NV*/
...
PUBLIC void MMISRV_WriteNVItem(uint32 item_id, void * buffer_ptr)
{
    ...
    MNNV_WriteItem(true_item_id, s_mmisrv_nv_len[module_id][nv_offset], buffer_ptr);/*write nv*/
}
