...
PUBLIC uint32 MMIAPICOM_UTF8toUnicode(const uint8 *utf8, uint16 utf8_length, uint16 *unicode, uint16 unicode_length)
{
    // 20100528: will.jiang: cr181804: pclint(20100601): e574: Signed-unsigned mix 
    int32 i = 0;
    int32 j = 0;
