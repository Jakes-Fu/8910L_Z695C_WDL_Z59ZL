...
#define MMIPB_NAME_MAX_LEN   (40) //(PHONEBOOK_MAX_DN_ALPHA_IDENTIFY_LEN) 20150922 wang.qinggang modify
#else
...
#define MMIPB_SIM_NAME_ASCII_MAX_LEN   (14)    
#define MMIPB_SIM_NAME_UNICODE_MAX_LEN   (6)        
// 最大、最少组个数
...
#else
#define MMIPB_USER_GROUP_NUM        (uint8)(11)//允许用户新增11个分组
#endif
#endif
#ifdef SNS_SUPPORT
...
#define MMIPB_MAX_NUM_TYPE              2//5//only surpport 2 numbers
/**--------------------------------------------------------------------------*
 **                         TYPE AND CONSTANT                                *
 **--------------------------------------------------------------------------*/
//主要的PB的所有错误类型
...
// 手机中电话簿记录的最大数
#ifndef WIN32
#if defined(PB_SUPPORT_LOW_MEMORY)
    #define MMIPB_NV_MAX_RECORD_NUM    300// 200 //500 
#else
...
#ifndef WIN32
#define MMIPB_MAX_CONTACT_COUNT       1000
#else
