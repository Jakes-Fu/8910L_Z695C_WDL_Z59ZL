...
#define MMI_DEFAULT_EXTRA_BIG_FONT	        SONG_FONT_16
#define MMI_DEFAULT_EXTRA_BIG_FONT_SIZE       16
...
//fixed by hongjun.jia for bugzilla 2461-2464
#define MMI_DEFAULT_BIG_FONT	        SONG_FONT_16//SONG_FONT_18
#define MMI_DEFAULT_BIG_FONT_SIZE       16//18

#define MMI_DEFAULT_NORMAL_FONT	        SONG_FONT_14//SONG_FONT_16
#define MMI_DEFAULT_NORMAL_FONT_SIZE	14//16

#define MMI_DEFAULT_SMALL_FONT          SONG_FONT_12
#define MMI_DEFAULT_SMALL_FONT_SIZE     12

//added by lxf for dphone
#elif defined(MAINLCD_SIZE_128X64) 
#define MMI_DEFAULT_BIG_FONT	        SONG_FONT_14
#define MMI_DEFAULT_BIG_FONT_SIZE       14

#define MMI_DEFAULT_NORMAL_FONT	        SONG_FONT_14
#define MMI_DEFAULT_NORMAL_FONT_SIZE	14

#define MMI_DEFAULT_SMALL_FONT          MMI_DEFAULT_NORMAL_FONT
#define MMI_DEFAULT_SMALL_FONT_SIZE     MMI_DEFAULT_NORMAL_FONT_SIZE
//

#elif defined(MAINLCD_SIZE_240X400)
#define MMI_DEFAULT_BIG_FONT	        SONG_FONT_20
#define MMI_DEFAULT_BIG_FONT_SIZE       20

#define MMI_DEFAULT_NORMAL_FONT	        SONG_FONT_18
#define MMI_DEFAULT_NORMAL_FONT_SIZE	18

#define MMI_DEFAULT_SMALL_FONT          SONG_FONT_14
#define MMI_DEFAULT_SMALL_FONT_SIZE     14

#elif defined(MAINLCD_SIZE_240X320)

#define MMI_DEFAULT_EXTRA_BIG_FONT	        SONG_FONT_38
#define MMI_DEFAULT_EXTRA_BIG_FONT_SIZE       38

#define MMI_DEFAULT_BIG_FONT	        SONG_FONT_38
#define MMI_DEFAULT_BIG_FONT_SIZE       38

#define MMI_DEFAULT_NORMAL_FONT	        SONG_FONT_38
#define MMI_DEFAULT_NORMAL_FONT_SIZE	38

#define MMI_DEFAULT_SMALL_FONT          SONG_FONT_26
#define MMI_DEFAULT_SMALL_FONT_SIZE     26

#elif defined(MAINLCD_SIZE_320X480)
#define MMI_DEFAULT_BIG_FONT	        SONG_FONT_24
#define MMI_DEFAULT_BIG_FONT_SIZE       24

#define MMI_DEFAULT_NORMAL_FONT	        SONG_FONT_20
#define MMI_DEFAULT_NORMAL_FONT_SIZE	20

#define MMI_DEFAULT_SMALL_FONT          SONG_FONT_16
#define MMI_DEFAULT_SMALL_FONT_SIZE     16
#else
#error
#endif
...
//默认菜单风格：见MMIMAINMENU_MATRIX_E结构
	...
	#define MMISET_DEFAULT_MENU_STYLE_E	        MMIMAINMENU_MATRIX_E//for defualt style
		...
		#define MMISET_DEFAULT_MENU_STYLE_E	        MMIMAINMENU_GO_SLIDE_E //for defualt style
    #else
		#define MMISET_DEFAULT_MENU_STYLE_E	        MMIMAINMENU_MATRIX_E//MMIMAINMENU_MATRIX_E  //for defualt style
	#endif
#endif 
#endif
...
#endif
#else
    #define MMISET_EDEFAULT_LANGUAGE             MMISET_LANGUAGE_SIMP_CHINESE  //英文/Auto
#endif
...
#define MMISET_EDEFAULT_CONTRAST            7   //MMISET_CONTRAST_FIVE

//默认按键灯时间（单位：毫秒）
#define MMISET_EDEFAULT_KEYBOARD_LIGHT_TIME 10000   //MMISET_KEYBOARD_LIGHT_TIME_10

//默认按键灯类型：见MMISET_KEYBOARD_LIGHT_OPEN结构
#define MMISET_EDEFAULT_KEYBOARD_LIGHT_TYPE MMISET_KEYBOARD_LIGHT_AUTO //MMISET_KEYBOARD_LIGHT_OPEN
...
#elif defined MMIPB_SYNC_WITH_O365	
    #define MMIPB_MAX_NV_PHONE_NUM     (uint8)(3) 
#else
    #define MMIPB_MAX_NV_PHONE_NUM     (uint8)(3) //wang.qinggang 5->3
#endif
//电话号码的最大位数（范围：1 ~ 40）
...
#define MMIPB_SYNC_O365_ID_LEN 256 //Office365 分配的联系人id 最大长度
#endif
...
//常用语最大长度
#define MMISMS_FREQUENT_WORD_LEN    60
...
#else
#define MMISMS_SPLIT_MAX_NUM          6   //modify from 4 to 6 for bug 1060693
#endif
...
//安全信箱默认密码(1-8位)
#define MMISMS_SECURITYBOX_DEFAULT_PWD "0000" ///"1234"

/*-------------------------------mms segment-------------------------------------------*/
#ifdef NANDBOOT_SUPPORT
//各个信箱的彩信总的条数（包括彩信通知,范围:1~200）
#define    MMIMMS_MAX_MMS_NUM                  20  
...
#define MMIMMS_MAX_RECEIVER_NUM                100
#define MMIMMS_MAX_RECEIVER_ONE_NUM            1   
#else
...
#else
    #define MMICL_RECORD_MAX_NUM    50//modify for queen requirement 50 max
#endif
//@MS00216980 cheney 
