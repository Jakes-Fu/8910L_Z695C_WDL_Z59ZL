...
//zhuyongjing add for PIC dir according to ms require 20150811
#ifdef MMI_SHOW_MSA
#define MMIMULTIM_DIR_PIC_ONEDRIVE_DOWNLOAD             (g_mmimultim_gallary_onedrive_download_dir_wstr)
#define MMIMULTIM_DIR_PIC_ONEDRIVE_DOWNLOAD_LEN         15
#define MMIMULTIM_DIR_PIC_CAMERA_ROLL             (g_mmimultim_gallary_camera_roll)
#define MMIMULTIM_DIR_PIC_CAMERA_ROLL_LEN         18
#define MMIMULTIM_DIR_PIC_ONEDRIVE_THUMBNAILS             (g_mmimultim_gallary_onedrive_thumbnail_dir_wstr)
#define MMIMULTIM_DIR_PIC_ONEDRIVE_THUMBNAILS_LEN        26
#endif
#define MMIMULTIM_DIR_PIC_MMS_BROWSER_SAVE_PICS             (g_mmimultim_mms_browser_save_pics_dir_wstr)
#define MMIMULTIM_DIR_PIC_MMS_BROWSER_SAVE_PICS_LEN        21
#define MMIMULTIM_DIR_PIC_CAMERA (g_mmimultim_gallary_camera)
#define MMIMULTIM_DIR_PIC_CAMERA_LEN  6
//add end

#define MMIMULTIM_DIR_BACKUP               (g_mmimultim_backup_dir_wstr)
#define MMIMULTIM_DIR_BACKUP_LEN           7

#define MMIMULTIM_DIR_RECORDING            (g_mmimultim_recording_dir_wstr)
#define MMIMULTIM_DIR_RECORDING_LEN        27

#define MMIMULTIM_DIR_RECEIVED_RECORDING      (g_mmimultim_received_recording_dir_wstr)
#define MMIMULTIM_DIR_RECEIVED_RECORDING_LEN  30

#define MMIMULTIM_DIR_RADIO_RECORDING            (g_mmimultim_radio_recording_dir_wstr)
#define MMIMULTIM_DIR_RADIO_RECORDING_LEN        27

#define MMIMULTIM_DIR_RECEIVED             (g_mmimultim_received_dir_wstr)
#define MMIMULTIM_DIR_RECEIVED_LEN         14

#define MMIMULTIM_DIR_MUSIC_FILE             (g_mmimultim_music_file_dir_wstr)
#define MMIMULTIM_DIR_MUSIC_FILE_LEN         11
//End
...
#define MMIMULTIM_AUDIO_DIR_NUM                   5
#ifdef ZDT_MUSIC_KING_SUPPORT
extern wchar g_mmimultim_music_king_01_dir_wstr[];
extern wchar g_mmimultim_music_king_02_dir_wstr[];
extern wchar g_mmimultim_music_king_03_dir_wstr[];
extern wchar g_mmimultim_music_king_04_dir_wstr[];
extern wchar g_mmimultim_music_king_05_dir_wstr[];
#define MMIMULTIM_DIR_MUSIC_KING_01           (g_mmimultim_music_king_01_dir_wstr)
#define MMIMULTIM_DIR_MUSIC_KING_01_LEN        4

#define MMIMULTIM_DIR_MUSIC_KING_02           (g_mmimultim_music_king_02_dir_wstr)
#define MMIMULTIM_DIR_MUSIC_KING_02_LEN        4
#define MMIMULTIM_DIR_MUSIC_KING_03           (g_mmimultim_music_king_03_dir_wstr)
#define MMIMULTIM_DIR_MUSIC_KING_03_LEN        4
#define MMIMULTIM_DIR_MUSIC_KING_04           (g_mmimultim_music_king_04_dir_wstr)
#define MMIMULTIM_DIR_MUSIC_KING_04_LEN        4
#define MMIMULTIM_DIR_MUSIC_KING_05           (g_mmimultim_music_king_05_dir_wstr)
#define MMIMULTIM_DIR_MUSIC_KING_05_LEN        4
#endif
#if defined(ZDT_VIDEO_KING_SUPPORT)
extern wchar g_mmimultim_video_king_01_dir_wstr[];
extern wchar g_mmimultim_video_king_02_dir_wstr[];
extern wchar g_mmimultim_video_king_03_dir_wstr[];
extern wchar g_mmimultim_video_king_04_dir_wstr[];
extern wchar g_mmimultim_video_king_05_dir_wstr[];
extern wchar g_mmimultim_video_king_06_dir_wstr[];
extern wchar g_mmimultim_video_king_07_dir_wstr[];
extern wchar g_mmimultim_video_king_08_dir_wstr[];
extern wchar g_mmimultim_video_king_09_dir_wstr[];
extern wchar g_mmimultim_video_king_10_dir_wstr[];
#define MMIMULTIM_DIR_VIDEO_KING_01           (g_mmimultim_video_king_01_dir_wstr)
#define MMIMULTIM_DIR_VIDEO_KING_01_LEN        4
#define MMIMULTIM_DIR_VIDEO_KING_02           (g_mmimultim_video_king_02_dir_wstr)
#define MMIMULTIM_DIR_VIDEO_KING_02_LEN        4
#define MMIMULTIM_DIR_VIDEO_KING_03           (g_mmimultim_video_king_03_dir_wstr)
#define MMIMULTIM_DIR_VIDEO_KING_03_LEN        3
#define MMIMULTIM_DIR_VIDEO_KING_04           (g_mmimultim_video_king_04_dir_wstr)
#define MMIMULTIM_DIR_VIDEO_KING_04_LEN        3
#define MMIMULTIM_DIR_VIDEO_KING_05           (g_mmimultim_video_king_05_dir_wstr)
#define MMIMULTIM_DIR_VIDEO_KING_05_LEN        4
#define MMIMULTIM_DIR_VIDEO_KING_06           (g_mmimultim_video_king_06_dir_wstr)
#define MMIMULTIM_DIR_VIDEO_KING_06_LEN        4
#define MMIMULTIM_DIR_VIDEO_KING_07           (g_mmimultim_video_king_07_dir_wstr)
#define MMIMULTIM_DIR_VIDEO_KING_07_LEN        4
#define MMIMULTIM_DIR_VIDEO_KING_08           (g_mmimultim_video_king_08_dir_wstr)
#define MMIMULTIM_DIR_VIDEO_KING_08_LEN        4
#define MMIMULTIM_DIR_VIDEO_KING_09           (g_mmimultim_video_king_09_dir_wstr)
#define MMIMULTIM_DIR_VIDEO_KING_09_LEN        4
#define MMIMULTIM_DIR_VIDEO_KING_10           (g_mmimultim_video_king_10_dir_wstr)
#define MMIMULTIM_DIR_VIDEO_KING_10_LEN        4
#endif
//"Movie"
...
#define MMIMULTIM_DIR_REVFILE                 (g_mmimultim_RevFile_dir_wstr)
#define MMIMULTIM_DIR_REVFILE_LEN             14
#define MMIMULTIM_DIR_RECORDINGS                 (g_mmimultim_Recordings_dir_wstr)
#define MMIMULTIM_DIR_RECORDINGS_LEN       10
#define MMIMULTIM_VIDEO_DIR_NUM                   3

#define MMIMULTIM_PIC_DIR_NUM       3
...
//zhuyongjing change for ms require 20150811
#ifdef MMI_SHOW_MSA
extern wchar g_mmimultim_gallary_onedrive_download_dir_wstr[];
extern wchar g_mmimultim_gallary_onedrive_thumbnail_dir_wstr[];
extern wchar g_mmimultim_gallary_camera_roll[];
#endif
extern wchar g_mmimultim_mms_browser_save_pics_dir_wstr[];
extern wchar g_mmimultim_gallary_camera[];
//add end

extern wchar g_mmimultim_backup_dir_wstr[];
extern wchar g_mmimultim_recording_dir_wstr[];
extern wchar g_mmimultim_received_dir_wstr[];
extern wchar g_mmimultim_music_file_dir_wstr[];
extern wchar g_mmimultim_received_recording_dir_wstr[];
extern wchar g_mmimultim_radio_recording_dir_wstr[];

extern wchar g_mmimultim_music_dir_wstr[];
extern wchar g_mmimultim_movie_dir_wstr[];
extern wchar g_mmimultim_RevFile_dir_wstr[] ;
extern wchar g_mmimultim_Recordings_dir_wstr[];
#ifdef MMI_KING_MOVIE_SUPPORT
...
typedef enum
{
    ...
    MMIFMM_FILE_TYPE_DAT,   // data file
...
#define MMIFMM_DAT          ((MMIFMM_FILE_TYPE_DAT * MMIFMM_FILE_TYPE_BASE) + (MMIFMM_SUFFIX_BASE))
...
/*****************************************************************************/
//  Description : handle copy process
//  Global resource dependence : 
//  Author:
//  Note: 
/*****************************************************************************/
...
/*****************************************************************************/
//  Description : Update deleted files count
//  Global resource dependence :
//  Author:
//  Note:
/*****************************************************************************/
...
#define MMIFMM_CopyProgressCallBack                  MMIAPIFMM_CopyProgressCBK
