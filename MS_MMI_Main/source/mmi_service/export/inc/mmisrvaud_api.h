...
#ifdef AMR_WB_SUPPORT
    MMISRVAUD_RING_FMT_AMR_WB,    
#endif
...
typedef enum
{  
    MMISRVAUD_EQ_REGULAR,      //≥£πÊ
    MMISRVAUD_EQ_CLASSIC,      //π≈µ‰
    MMISRVAUD_EQ_ODEUM,        //“Ù¿÷Ã¸
    MMISRVAUD_EQ_JAZZ,         //æÙ ø
    MMISRVAUD_EQ_ROCK,         //“°πˆ
    MMISRVAUD_EQ_SOFT_ROCK,    //»Ì“°πˆ
...
#define MMISRVAUD_VOLUME_LEVEL_MAX   15
...
typedef enum
{
    MMISRVAUD_RECORD_WB_FRAME_LEN_DEFAULT = 0,
    MMISRVAUD_RECORD_WB_FRAME_LEN_61 = 0,
    MMISRVAUD_RECORD_WB_FRAME_LEN_59,
    MMISRVAUD_RECORD_WB_FRAME_LEN_51,
    MMISRVAUD_RECORD_WB_FRAME_LEN_47,
    MMISRVAUD_RECORD_WB_FRAME_LEN_41,
    MMISRVAUD_RECORD_WB_FRAME_LEN_37,
    MMISRVAUD_RECORD_WB_FRAME_LEN_33,
    MMISRVAUD_RECORD_WB_FRAME_LEN_24,
    MMISRVAUD_RECORD_WB_FRAME_LEN_18,
    MMISRVAUD_RECORD_WB_FRAME_LEN_MAX
}MMISRVAUD_RECORD_WB_FRAME_LEN_E;
...
/*****************************************************************************/
//  Description : get current playing handle
//  Global resource dependence : 
//  Author
//  Note:
/*****************************************************************************/
PUBLIC MMISRV_HANDLE_T MMISRVAUD_GetCurrentHandle(void);
...
PUBLIC void MMISRVAUD_PlayToneExVolume(
                uint16 pri,
                MMISRVAUD_TYPE_E tone_type,
                uint32 tone_id,
                uint32 duration,
...
/*****************************************************************************/
//  Description :Get Audio Priority Info
//  Global resource dependence : 
//  Author:
//  Note: 
/*****************************************************************************/
PUBLIC uint16 MMISRVAUD_GetAudPriorityInfo(MMISRV_HANDLE_T audio_handle);
...
/*MMI_UNISOC_MANUALLY_CIT_SUPPORT*/
/*******************************************************************/
//  Interface:		MMISRVAUD_HandleEarphoneEvent
//  Description : 	MMISRVAUD_HandleEarphoneEvent
//  Global resource dependence : 
