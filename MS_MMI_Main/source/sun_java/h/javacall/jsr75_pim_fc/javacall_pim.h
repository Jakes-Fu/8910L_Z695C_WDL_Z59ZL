 ...
 *
 * See JSR-75 PIM specification for details.
 *
...
#ifdef  PIM_DEBUG
#define PIM_LOG_0(log) javacall_print("[PIM]"log"\n")
#define PIM_LOG_1(log, var1) javacall_printf("[PIM]"log"\n", var1)
#define PIM_LOG_2(log, var1, var2) javacall_printf("[PIM]"log"\n", var1, var2)
#define PIM_LOG_3(log, var1, var2, var3) javacall_printf("[PIM]"log"\n", var1, var2, var3)
#define PIM_LOG_4(log, var1, var2, var3, var4) javacall_printf("[PIM]"log"\n", var1, var2, var3, var4)
#define PIM_LOG_5(log, var1, var2, var3, var4, var5) javacall_printf("[PIM]"log"\n", var1, var2, var3, var4, var5)

#else
#define PIM_LOG_0(log) 
#define PIM_LOG_1(log, var1) 
#define PIM_LOG_2(log, var1, var2)
#define PIM_LOG_3(log, var1, var2, var3)
#define PIM_LOG_4(log, var1, var2, var3, var4)
#define PIM_LOG_5(log, var1, var2, var3, var4, var5)
#endif
/**
 * @enum javacall_pim_type
 * @brief Indicates which personal information the user would like to manage
 *        (Contact, Event, Todo)
 */
typedef enum {
...
typedef struct {
    ...
    javacall_utf16 code[JAVACALL_PIM_MAX_LABEL_SIZE];
...
typedef struct {
    ...
    javacall_pim_field_array_element
        arrayElements[JAVACALL_PIM_MAX_ARRAY_ELEMENTS];
} javacall_pim_field;
...
javacall_result javacall_pim_list_open(javacall_pim_type listType,
    javacall_utf16* pimListName, javacall_pim_open_mode mode,
