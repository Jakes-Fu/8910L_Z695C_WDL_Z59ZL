...
int javacall_lcd_get_flushStartLine(void);
...
javacall_bool javacall_lcd_get_background_allowed(void);
void javacall_lcd_display_set_cmcc_keep_background(javacall_bool keepBackground);
javacall_bool javacall_lcd_get_cmcc_keep_background(void);
