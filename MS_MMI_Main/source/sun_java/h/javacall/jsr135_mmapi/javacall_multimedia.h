...
#define JAVACALL_MEDIA_FORMAT_MPEG1_LAYER2      "MPEG1_layer_2"  //mp2
/** MPEG-1 layer 3, audio/mpeg */
#define JAVACALL_MEDIA_FORMAT_MPEG1_LAYER3      "MPEG1_layer_3"  //mp3
/** MP3pro, audio/mpeg */
#define JAVACALL_MEDIA_FORMAT_MPEG1_LAYER3_PRO  "MPEG1_layer_3_pro" //.mp3
/** MPEG-2 Advanced_Audio_Coding, audio/mpeg */
#define JAVACALL_MEDIA_FORMAT_MPEG2_AAC         "MPEG2_AAC"       //.aac
...
#define JAVACALL_MEDIA_FORMAT_M4A               "M4A"    //m4a

    
/** 3GPP Adaptive Multi Rate audio/amr */
#define JAVACALL_MEDIA_FORMAT_AMR               "AMR"  //amr
 ...
 * audio/qcelp */
#define JAVACALL_MEDIA_FORMAT_QCELP             "QCELP"    //.qcp
/** MIDI Manufacturers Association, audio/midi */
#define JAVACALL_MEDIA_FORMAT_MIDI              "MIDI"   ///midi
/** MIDI Manufacturers Association, audio/spmidi */
#define JAVACALL_MEDIA_FORMAT_SP_MIDI           "SP_MIDI" //midi
/** Microsoft, linear Pulse Coded Modulation, audio/x-wav */
#define JAVACALL_MEDIA_FORMAT_MS_PCM            "MS_PCM"   //wav
...
#define JAVACALL_MEDIA_FORMAT_TONE              "TONE"  //duo yin

/** Video formats section */
/** Default MJPEG, video/mjpeg */
#define JAVACALL_MEDIA_FORMAT_MJPEG_DEFAULT     "MJPEG_DEFAULT"//rm
/** ITU H.263, video/h263 */
#define JAVACALL_MEDIA_FORMAT_H263              "H263" //3gp
/** ITU H.264, video/h264 */
#define JAVACALL_MEDIA_FORMAT_H264              "H264"
/** MPEG-1, video/mpeg */
#define JAVACALL_MEDIA_FORMAT_MPEG_1            "MPEG_1" //vcd
/** MPEG-2, video/mpeg */
#define JAVACALL_MEDIA_FORMAT_MPEG_2            "MPEG_2"  //vcd
/** MPEG-4 Simple Visual Profile, video/mpeg */
#define JAVACALL_MEDIA_FORMAT_MPEG_4_SVP        "MPEG_4_SVP"  //mp4
/** MPEG-4 Advanced Video Codec (ITU H.264), video/mpeg */
#define JAVACALL_MEDIA_FORMAT_MPEG_4_AVC        "MPEG_4_AVC"  //mp4
/** RealVideo ver 8, video/vnd.rn-realvideo */
#define JAVACALL_MEDIA_FORMAT_REALVIDEO_8       "REALVIDEO_8"  //rm
...
#define JAVACALL_MEDIA_FORMAT_AVI               "AVI"  //avi
...
#define JAVACALL_MEDIA_FORMAT_DEVICE_TONE       "DEVICE_TONE"  //tone
