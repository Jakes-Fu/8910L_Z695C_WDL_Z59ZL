#if defined(BIG5_SUPPORT) || defined(MULTI_VARIANT_SUPPORT)
/*****************************************************************************
** File Name:      gui_big5.c                                                *
** Author:                                                                   *
** Date:           02/12/2010                                                *
** Copyright:      2010 Spreatrum, Incoporated. All Rights Reserved.         *
** Description:    This file is used to describe conversion function         *
**                 from UCS2 string to Big5 string                           *
******************************************************************************
**                         Important Edit History                            *
** --------------------------------------------------------------------------*
** DATE           NAME             DESCRIPTION                               *
** 02/12/2010    James.Zhang         Create                                  *
******************************************************************************/
...
LOCAL const uint16 s_big5_2uni_pagea1[6121] = 
{
  /* 0xa1 */
...
LOCAL const uint16 s_big5_2uni_pagec9[7652] = {
  /* 0xc9 */
...
LOCAL const uint16 s_big5_2charset[13703] = {
...
LOCAL const BIG5_SUMMARY_T s_big5_uni2indx_page00[16] = {
  /* 0x0000 */
...
LOCAL const BIG5_SUMMARY_T s_big5_uni2indx_page02[38] = {
  /* 0x0200 */
...
LOCAL const BIG5_SUMMARY_T s_big5_uni2indx_page20[44] = {
  /* 0x2000 */
...
LOCAL const BIG5_SUMMARY_T s_big5_uni2indx_page24[37] = {
  /* 0x2400 */
...
LOCAL const BIG5_SUMMARY_T s_big5_uni2indx_page30[62] = {
  /* 0x3000 */
...
LOCAL const BIG5_SUMMARY_T s_big5_uni2indx_page4e[1307] = {
  /* 0x4e00 */
...
LOCAL const BIG5_SUMMARY_T s_big5_uni2indx_pagefa[1] = {
  /* 0xfa00 */
  { 13563, 0x3000 },
};
LOCAL const BIG5_SUMMARY_T s_big5_uni2indx_pagefe[23] = {
  /* 0xfe00 */
...
/*---------------------------------------------------------------------------*/
/*****************************************************************************/
// 	Description : big5 to wstr, with returning the end position of src postion. 
...
{
    return GUI_Big5ToWstrWithEndPos(wstr_ptr, big5_ptr, str_len, PNULL);
} 
                             ...
                             )
{
    ...
    if ( PNULL == big5_ptr || PNULL == wstr_ptr || 0 == str_len )
    {
        return 0;
    }
    ...
    while(len > 0)
    {
            ...
            || ( ch1 >= 0xc9 && ch1 <= 0xf9 ) ) 
        {
            ...
            if ( ( ch2 >= 0x40 && ch2 < 0x7f ) 
                || ( ch2 >= 0xa1 && ch2 < 0xff ) ) 
            {
                i = 157 * (ch1 - 0xa1) + (ch2 - (ch2 >= 0xa1 ? 0x62 : 0x40));
                unicode = 0xfffd;
                ...
                else 
                {
                    if (i < 13932)
                    {
                        unicode = s_big5_2uni_pagec9[i-6280];
                    }
                }
    ...
    {
        *src_end_pos = (uint32)(big5_ptr);
    }
    return count;
} 

/*****************************************************************************/
// 	Description : wstr to big5
//	Global resource dependence : none
//  Author: James.Zhang
//	Note: 
/*****************************************************************************/
...
{
    uint16   unicode = 0;
    uint32   big5_length = 0;
    uint32   i = 0;
  	
    if ( PNULL == big5_ptr || PNULL == wstr_ptr || 0 == wstr_len )
    {
        return 0;
    }
    ...
    for ( ; i < wstr_len; i++ )
    {
        ...
        if ( unicode < 0x80 )
        {
            *big5_ptr++ = (uint8)unicode;
            big5_length++;
        }
        else
        {
            const BIG5_SUMMARY_T *summary = PNULL;

            if (unicode < 0x0100)
            {
                summary = &s_big5_uni2indx_page00[(unicode>>4)];
            }
            else if (unicode >= 0x0200 && unicode < 0x0460)
            {
                summary = &s_big5_uni2indx_page02[(unicode>>4)-0x020];
            }
            else if (unicode >= 0x2000 && unicode < 0x22c0)
            {
                summary = &s_big5_uni2indx_page20[(unicode>>4)-0x200];
            }
            else if (unicode >= 0x2400 && unicode < 0x2650)
            {
                summary = &s_big5_uni2indx_page24[(unicode>>4)-0x240];
            }
            else if (unicode >= 0x3000 && unicode < 0x33e0)
            {
                summary = &s_big5_uni2indx_page30[(unicode>>4)-0x300];
            }
            else if (unicode >= 0x4e00 && unicode < 0x9fb0)
            {
                summary = &s_big5_uni2indx_page4e[(unicode>>4)-0x4e0];
            }
            else if (unicode >= 0xfa00 && unicode < 0xfa10)
            {
                summary = &s_big5_uni2indx_pagefa[(unicode>>4)-0xfa0];
            }
            else if (unicode >= 0xfe00 && unicode < 0xff70)
            {
                summary = &s_big5_uni2indx_pagefe[(unicode>>4)-0xfe0];
            }
            ...
            if (summary) 
            {
                ...
                if (used & ((uint16) 1 << index)) 
                {
                    ...
                    *big5_ptr++ = s_big5_2charset[summary->indx + used] >> 8;
                    *big5_ptr++ = s_big5_2charset[summary->indx + used] & 0xff;
                    big5_length += 2;
