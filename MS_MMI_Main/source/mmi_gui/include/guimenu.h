...
@brief 动态主菜单字符串长度最大值
*/
#define GUIMENU_DYMAINMENU_STR_MAX_NUM     40
...
#define GUIMENU_SetMenuText             CTRLMENU_SetText
#define GUIMENU_SetMenuTextEx           CTRLMENU_SetTextEx
...
#define GUIMENU_SetPopMenuSoftkeyType   CTRLMENU_SetPopMenuSoftkeyType
#define GUIMENU_SetPopMenuCentered      CTRLMENU_SetPopMenuCentered
...
#define GUIMENU_SetItemStateEx          CTRLMENU_SetItemStateEx
...
#define GUIMAINMENU_IsMoveMode          CTRLMAINMENU_IsMoveMode
#define GUIMAINMENU_SetMoveMode         CTRLMAINMENU_SetMoveMode
#define GUIMAINMENU_CancelMoveIcon      CTRLMAINMENU_CancelMoveIcon
#define GUIMAINMENU_GetStyle            CTRLMAINMENU_GetStyle
#define GUIMAINMENU_SetColorThemeMode   CTRLMAINMENU_SetColorThemeMode
#define GUIMAINMENU_IsColorThemeMode	CTRLMAINMENU_IsColorThemeMode
#define GUIMAINMENU_Redraw              CTRLMAINMENU_Redraw
#define GUIMAINMENU_LoseFocusRedraw     CTRLMAINMENU_LoseFocusRedraw
#define GUIMAINMENU_IsUninstallable     CTRLMAINMENU_IsUninstallable
/*---------------------------------------------------------------------------*
 **                         Compiler Flag                                    *
 **--------------------------------------------------------------------------*/
#ifdef   __cplusplus
