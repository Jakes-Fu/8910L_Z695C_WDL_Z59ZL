...
@note 
*******************************************************************************/
#define GUIICONLIST_GetDisplayTimeStampFlag CTRLICONLIST_GetDisplayTimeStampFlag
...
@note 
*******************************************************************************/
#define GUIICONLIST_SetDisplayTimeStampFlag CTRLICONLIST_SetDisplayTimeStampFlag
...
@note 
*******************************************************************************/
#define GUIICONLIST_SetTimeStr CTRLICONLIST_SetTimeStr
...
@author 
@param ctrl_id     [in] 控件id
@param iis_iconlist_maskable [in] 是否有mask
@return 操作是否成功
@note 
*******************************************************************************/
#define GUIICONLIST_SetIconMaskable      CTRLICONLIST_SetIconMaskable

/***************************************************************************//*!
@brief 设置宫格列表是否处于标记状态
@author 
@param ctrl_id     [in] 控件id
@param image_id [in] mask 图片
@return 操作是否成功
@note 
*******************************************************************************/
#define GUIICONLIST_SetIconMaskThemeImg  CTRLICONLIST_SetIconMaskThemeImg
...
@note 
*******************************************************************************/
#define GUIICONLIST_SetMarkThemeImg  CTRLICONLIST_SetMarkThemeImg
...
//  Note:
/*****************************************************************************/
#define GUIICONLIST_SetIndicateIcon	CTRLICONLIST_SetIndicateIcon
