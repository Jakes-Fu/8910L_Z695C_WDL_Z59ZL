...
#define GUIFORM_SetPadding                  CTRLFORM_SetPadding
...
#define GUIFORM_SetFormChildTheme			CTRLFORM_SetFormChildTheme
#define GUIFORM_SetFormActiveChildTheme		CTRLFORM_SetFormActiveChildTheme
...
#define GUIFORM_IsAtvFormChild              CTRLFORM_IsAtvFormChild
#define GUIFORM_SetUseFormBg            CTRLFORM_SetUseFormBg
#define GUIFORM_SetChildUpDownPostion CTRLFORM_SetChildUpDownPostion
//zmt add start
