...
@brief 设置字体和颜色
@param       win_handle [in]   窗口句柄
@param       button_num  [in]  button序号
@param       font_ptr   [in]   字体类型
@retval TRUE     设置成功
@retval FALSE    设置失败
@return 是否设置成功
@note   此函数封装了GUISOFTKEY_SetButtonFont，可以设置softkey button上的文本字体
*******************************************************************************/
...
@brief 设置背景透明色
@param       win_handle [in]   窗口句柄
@param       bg_alpha  [in]    透明值
@retval TRUE     设置成功
@retval FALSE    设置失败
@return 是否设置成功
@note   此函数封装了GUISOFTKEY_SetBgAlpha，可以设置softkey的背景颜色的透明值
*******************************************************************************/
