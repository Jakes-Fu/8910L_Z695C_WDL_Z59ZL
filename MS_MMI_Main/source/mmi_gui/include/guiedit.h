...
typedef void (*EDTEVENTFUNC)(MMI_CTRL_ID_T, MMI_MESSAGE_ID_E);
typedef void (*IEDTRETFUNC)(MMI_CTRL_ID_T,  uint16, BOOLEAN);
typedef struct _IEDT_HANDLE_T {
    EDTEVENTFUNC	func;
    BOOLEAN is_used;			
} IEDT_HANDLE_T;

#define MAX_IDET_HANDLE 1
...
#define GUIEDIT_SetDisplayRect           CTRLBASE_SetDisplayRect
...
#define GUIEDIT_GetImSymbol                 CTRLBASEEDIT_GetImSymbol
...
#define GUIEDIT_SetThemeColor             CTRLBASEFLEX_SetThemeColor
#define GUIEDIT_SetThemeLine            CTRLBASEFLEX_SetThemeLine
...
/*****************************************************************************/
//  Description : set inline edit visibility
//  Global resource dependence : 
//  Author: Jassmine
//  Note:
/*****************************************************************************/
PUBLIC void GUIEDIT_SetVisible(
    MMI_CTRL_ID_T    ctrl_id,
    BOOLEAN          is_visible,
    BOOLEAN          is_update
                                 );
...
//  Note:
/*****************************************************************************/
PUBLIC uint16 GUIEDIT_GetLineHeight( 
	MMI_CTRL_ID_T    ctrl_id 
);


/*****************************************************************************/
//  Description : is active inline editor
//  Global resource dependence : 
//  Author: maryxiao
//  Note:
/*****************************************************************************/
PUBLIC uint16 GUIEDIT_IsActive( 
	MMI_CTRL_ID_T    ctrl_id 
);
/**--------------------------------------------------------------------------*
 **                         Compiler Flag                                    *
