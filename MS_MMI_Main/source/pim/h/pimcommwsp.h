...
/******************************************************************************
  ...
  *****************************************************************************/
  /*加入此FEATURE防止头文件重复包含*/
  #ifndef   HEADER_FILE_COMM_WSP
  #define HEADER_FILE_COMM_WSP
  ...
  ** 版本: ver 1.0
  *******************************************************************/
  short  HS_WSP_SendData(short id,char* sendcache, uint32 sendlength, void*information);
  ...
  ** 版本: ver 1.0
  *******************************************************************/
  short  HS_WSP_RecData(short id,char* receivecache, uint32 recevielength, void*information);
