...
//#ifdef BLUETOOTH_SUPPORT
    ...
    {
    case 1:
        MMIPUB_OpenAlertTextWinByTextId( &time,TXT_CONNECTION_DATA_ROAMING_QUERY,PNULL,PNULL,MMIPUB_SOFTKEY_CUSTOMER,PNULL);
        MMIPUB_SetWinSoftkeyEx( MMIPUB_ALERT_TEXT_WIN_ID, TXT_COMMON_OK, STXT_EXIT, STXT_CANCEL, FALSE );
        break;
    case 2:
        MMIPUB_OpenQueryTextWinByTextId( TXT_CONNECTION_DATA_ROAMING_QUERY,PNULL,PNULL );
        break;
    case 3:
    ...
    case 4:
        ...
        MMIPUB_SetWinTitleTextId( MMIPUB_QUERY_WIN_ID, TXT_CONNECTION_DATA_ROAMING_QUERY, FALSE );
        break;
        
    case 5:
        MMIPUB_OpenProgressWinByTextId( TXT_CONNECTION_DATA_ROAMING_QUERY, PNULL, PNULL, 0, HandlePrgWinMsg );
    ...
    case 10:
        {
            if ( s_is_pubwin )
            {
                ...
                MMIPUB_OpenDialogInputFieldWinByTextPtr(&s_prompt_str_array[3], PNULL, PNULL, MMIPUB_SOFTKEY_DIALOG_CLOSE_OK_RETURN_VMAIL, PNULL);
            }
            else
            {
    ...
    case 11:
	{
		MMIPUB_OpenAlarmDialogWin(2, &(s_prompt_str_array[3]), &(s_prompt_str_array[3]), PNULL, MMIPUB_ALARM_WIN_ID, IMAGE_IDLE_SCREEN_ALARM, IMAGE_NULL, WIN_ONE_LEVEL, PNULL, PNULL);
    	}
	break;
    case 12:
	{
    		MMI_WIN_ID_T linkMenu_dialog_id = MMIPUB_INPUTFIELD_WIN_ID;
   	       MMIPUB_OpenDialogPasswordWinByTextPtr(&(s_prompt_str_array[3]),&linkMenu_dialog_id,PNULL,MMIPUB_SOFTKEY_DIALOG_CLOSE_OK_RETURN ,PNULL);
    	}
	break;		
#endif
    default:
