...
//Dialog type
#define    MMIPUBWIN_CONFIRM_DIALOG           (MMIPUBWIN_NONE+10)
#define    MMIPUBWIN_TEXT_DIALOG              (MMIPUBWIN_NONE+11)
#define    MMIPUBWIN_ALARM_DIALOG             (MMIPUBWIN_NONE+12)
#define    MMIPUBWIN_PROGRESSBAR_DIALOG       (MMIPUBWIN_NONE+13)
#define    MMIPUBWIN_INPUTFIELD_DIALOG        (MMIPUBWIN_NONE+14)
#define    MMIPUBWIN_PASSWORD_DIALOG          (MMIPUBWIN_NONE+15)
#define    MMIPUBWIN_DATE_EDITOR_DIALOG       (MMIPUBWIN_NONE+16)
