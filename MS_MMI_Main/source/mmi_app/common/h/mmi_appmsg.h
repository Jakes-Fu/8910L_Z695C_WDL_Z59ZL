...
#define MSG_MMS_OPEN_ATTA_LIST_VIEW 0x0213  //open list view window for conversation view
#define MSG_MMS_SET_EDIT_FOCUS      0x0214
...
#define MSG_MMI_WEBKIT_START_ID             0x03A0  //=== 浏览器管理消息号起始值 ===

#define MSG_MMI_WEBKIT_ENTER_URL                    (MSG_MMI_WEBKIT_START_ID+36)
#define MSG_MMI_WEBKIT_SHOW_SMS                 (MSG_MMI_WEBKIT_START_ID+37)
...
#define MSG_CC_STOP_APPLET (MSG_MMICC_START_ID+7)
...
#define MMI_PB_KEY_LEFT_FOCUS			0x0534
#define MMI_PB_KEY_RIGHT_FOCUS			0x0535
#define MMI_PB_LOAD_SIM_CONTACT_CNF			0x0536 //MMI_PB_DYNAMIC_LOAD_SIM_CONTACT_SUPPORT
#define MMI_PB_RELEASE_SIM_CONTACT_CNF			0x0537 //MMI_PB_DYNAMIC_LOAD_SIM_CONTACT_SUPPORT
#define MMI_PB_SYNC_UPDATE			0x0538
#define MMI_PB_ADDEDIT_CLEAR_DATE			0x0539
#ifdef MMIPB_SYNC_WITH_O365
#define MMI_PB_SYNC_UPDATE_BROADCAST    0x0540
#endif
#ifdef MMI_BT_PBAP_SUPPORT
#define MMI_PB_PBAP_CONTACT_READ_CNF      0x0541  
#define MMI_PB_PBAP_CALLLOG_READ_CNF      0x0542 
#endif
...
#define MMI_PB_ERROR_PERMISSION_OPEN_WIN   0x0614 //PBSYNC error windows opening for permission deny
#define MMI_PB_ERROR_NETWORK_OPEN_WIN      0x0615 //PBSYNC error windows opening for network error
#define MMIPB_CloseSyncResultwin        0x0616 //PBSYNC close window when user forget
...
#define MSG_UMS_VALIDATE_PRIVACY_SUCCESS    0x0716
#endif
#ifdef SLIDESHOW_WALLPAPER_SUPPORT
#define MSG_SET_SLIDESHOW_FIND_PHOTO   0x0716
#endif
#ifdef MMI_INDIAN_SOS_SUPPORT
#define MSG_SET_SOS_NUMBER_LIST_UPDATE   0x0718
#define MSG_SET_SOS_SETTINGS_TYPE_LIST_UPDATE   	0x0719
#endif
#if defined(MMI_WHITELIST_SUPPORT)
#define MSG_SET_WHITELIST_LIST_UPDATE   	0x0720  
#endif
...
#define MSG_START_PHONE_RING 				0x089C
#endif
//附件的范围：    0x0900~~~0x09ff
...
#define     MSG_SCH_LIST_DEL_ALL_BEFORE_ONEDAY            0x0b0c
...
#define     MSG_IDLE_UPDATE_NOTIFICATION_LIST     0x0c17
...
#define  MSG_AUDIO_EU_ALERT_NOTIFY          0x0e24
...
//Banner
#define MSG_COMMON_BANNER_CLOSE 0x1001
//NPS
#define MSG_NPS_PDP_ACTIVE_CNF        0x10e0
#define MSG_NPS_PDP_ACTIVE_FAILED_CNF 0x10e1
#define MSG_NPS_CONN_FAILED_CNF       0x10e2
#define MSG_NPS_PARSE_START_IND       0x10e3
#define MSG_NPS_PARSE_SUCCESS_CNF     0x10e4
#define MSG_NPS_PARSE_FAILED_CNF      0x10e5
#define MSG_NPS_HTTP_CLOSE_CNF        0x10e6

//GPS
#define MSG_GPS_READ_EXCEPTION  0x10f1  // gps 异常
#define MSG_GPS_COPY_RES_IND    0x10f2
...
#define MSG_PICVIEWER_LOAD_VIDEO_CONTINUE (MSG_PICVIEWER_START+8)
#define MSG_PICVIEWER_MUTIL_UPLOAD_FINISH (MSG_PICVIEWER_START+9) //close task waiting win
#define MSG_PICVIEWER_DISCONNECT_DELETE_FINISH (MSG_PICVIEWER_START+10) //close task waiting win
#define MSG_PICVIEWER_MARKABLE_DELETE_FINISH (MSG_PICVIEWER_START+11) //close task waiting win
#define MSG_PICVIEWER_GOTO_SUBFOLDER_FINISH (MSG_PICVIEWER_START+12) //close task waiting win
#define MSG_PICVIEWER_GET_THUMBNAILS_FINISH (MSG_PICVIEWER_START+13) //close task waiting win
#define MSG_PICVIEWER_SERVER_DELETE_FINISH (MSG_PICVIEWER_START+14) //close task waiting win
...
#ifdef MMI_DAC_SUPPORT
#define     MSG_DAC_START                         0x1450
#define     MSG_DAC_PDP_ACTIVE_CNF                (MSG_DAC_START + 1)
#define     MMIDAC_MSG_HTTPS_TIMER_EXPIRED_CNF    (MSG_DAC_START + 2)
#define     MMIDAC_MSG_SMS_TIMER_EXPIRED_CNF      (MSG_DAC_START + 3)
#define     MMIDAC_MSG_SMS_SEND_CNF               (MSG_DAC_START + 4)
#define     MMIDAC_MSG_CALL_MADE_CNF              (MSG_DAC_START + 5)
#define     MMIDAC_MSG_HTTPS_DONE_CNF             (MSG_DAC_START + 6)
#define     MSG_DAC_HTTP_HEAD_REQUEST_CNF         (MSG_DAC_START + 7)
#define     MMIDAC_MSG_SMS_SEND_SUCCESS_CNF       (MSG_DAC_START + 8)
#define     MMIDAC_MSG_SMS_SEND_FAIL_CNF          (MSG_DAC_START + 9)

#define     MSG_DAC_END                           (MSG_DAC_START + 30)
#endif
...
#define       MSG_PUB_PROGRESS_UPDATE_TIME_PERIOD 0x3004
...
#define MSG_VP_SEARCH_INTERRUPTED 0x4118
...
#define MSG_VP_NEED_UPDATE_LOCALLIST_BEGIN     0x4600
#define MSG_VP_NEED_UPDATE_LOCALLIST_END     0x4700
#define MSG_VP_DELETE_CNF 0x4800
#endif
...
#ifdef MMIPB_SYNC_WITH_O365
//PbSync
#define MSG_PBSYNC_START                            0xC300
#define MSG_PBSYNC_PDP_ACTIVE_CNF                   (MSG_PBSYNC_START + 1)
#define MSG_PBSYNC_PDP_ACTIVE_FAILED_CNF        (MSG_PBSYNC_START + 2)
#define MSG_PBSYNC_PDP_DEACTIVE_CNF                     (MSG_PBSYNC_START + 3)
#define MSG_PBSYNC_HTTP_INIT_CNF                        (MSG_PBSYNC_START + 4)
#define MSG_PBSYNC_CONN_FAILED_CNF              (MSG_PBSYNC_START + 5)
#define MSG_PBSYNC_CONN_SUCCESS_CNF                     (MSG_PBSYNC_START + 6)
#define MSG_PBSYNC_LOGIN_CNF                        (MSG_PBSYNC_START + 7)
#define MSG_PBSYNC_LOGOUT_CNF                   (MSG_PBSYNC_START + 8)
#define MSG_PBSYNC_EXIT_CNF                     (MSG_PBSYNC_START + 9)
#define MSG_PBSYNC_PARSE_START_IND              (MSG_PBSYNC_START + 8)
#define MSG_PBSYNC_PARSE_SUCCESS_CNF            (MSG_PBSYNC_START + 9)
#define MSG_PBSYNC_PARSE_FAILED_CNF                 (MSG_PBSYNC_START + 10)
#define MSG_PBSYNC_HTTP_CLOSE_CNF               (MSG_PBSYNC_START + 11)

//app use
#define MSG_PBSYNC_APP_START                            (MSG_PBSYNC_START + 30)
#define MSG_PBSYNC_ALL_CONTACT_CNF              (MSG_PBSYNC_START + 31)
#define MSG_PBSYNC_CONTACT_DETAIL_CNF           (MSG_PBSYNC_START + 32)
#define MSG_PBSYNC_ALL_MODITIEM_CNF             (MSG_PBSYNC_START + 33)
#define MSG_PBSYNC_ADD_CONTACT_CNF              (MSG_PBSYNC_START + 34)
#define MSG_PBSYNC_DELELE_CONTACT_CNF           (MSG_PBSYNC_START + 35)
#define MSG_PBSYNC_MODIFY_CONTACT_CNF           (MSG_PBSYNC_START + 36)

#define MSG_PBSYNC_ERROR_START                          (MSG_PBSYNC_APP_START + 20)
/* error type */
#define MSG_PBSYNC_DATA_ERROR                           (MSG_PBSYNC_ERROR_START)
#define MSG_PBSYNC_TOKEN_INVALID_ERROR              (MSG_PBSYNC_ERROR_START+1)
#define MSG_PBSYNC_INPUT_PARAM_ERROR                (MSG_PBSYNC_ERROR_START+2)
#define MSG_PBSYNC_NOMEMORY                             (MSG_PBSYNC_ERROR_START+3)
#define MSG_PBSYNC_FILE_ERROR                           (MSG_PBSYNC_ERROR_START+4)
#define MSG_PBSYNC_NET_ERROR                            (MSG_PBSYNC_ERROR_START+5)
#define MSG_PBSYNC_TIMEOUT_ERROR                        (MSG_PBSYNC_ERROR_START+6)
#define MSG_PBSYNC_TASKBUSY_ERROR                   (MSG_PBSYNC_ERROR_START+7)
#define MSG_PBSYNC_NODATA                                   (MSG_PBSYNC_ERROR_START+8)
#define MSG_PBSYNC_UNKNOWN_ERROR                    (MSG_PBSYNC_ERROR_START+9)
#define MSG_PBSYNC_OPERATE_ERROR                        (MSG_PBSYNC_ERROR_START+10)


#define MSG_PBSYNC_END                           0xC3FF

#endif


//WNS messages range: 0xc100 -- 0xc1ff
#ifdef MMIWNS_SUPPORT
enum {
            /*All WNS response message*/
            MSG_WNS_RESPONSE = 0xc100,
            /*Push notification*/
            MSG_WNS_PUSH_NOTIFICATION,
            /*WNS Error*/
            MSG_WNS_CONNECTION_CLOSED,
            ...
            MSG_WNS_COMMON_ERROR,

            MSG_PNS_NET_CONN_FAILED_CNF,  //socket连接失败
            MSG_PNS_PDP_ACTIVE_CNF,  //PDP激活成功
            MSG_PNS_PDP_ACTIVE_FAILED_CNF, //PDP激活失败
            MSG_PNS_CREATE_CHANNEL_REQ,
            MSG_PNS_CLOSE_CHANNEL_REQ,
            MSG_PNS_APP_IS_REMOVED,
            MSG_PNS_CLEAR_NOTIFICATION,
            MSG_PNS_START_WNS,
            MSG_PNS_STOP_WNS,
            MSG_WNS_END
};
...
#define MSG_CAMERA_ROLL_START (0xd000)
#define MSG_CAMERA_ROLL_UPLOAD_PHOTO_NOTIFY  (0xd001)
#define MSG_CAMERA_ROLL_UPLOAD_PHOTO_CNF  (0xd002)
#define MSG_CAMERA_ROLL_DOWNLOAD_THUMBNAIL_NOTIFY  (0xd003)
#define MSG_CAMERA_ROLL_DOWNLOAD_THUMBNAIL_CNF  (0xd004)
#define MSG_CAMERA_ROLL_DOWNLOAD_PHOTO_NOTIFY (0xd005)
#define MSG_CAMERA_ROLL_DOWNLOAD_PHOTO_CNF (0xd006)
#define MSG_CAMERA_ROLL_INIT_CNF (0xd007)
#define MSG_CAMERA_ROLL_ERROR_NOTIFY (0xd008)
#define MSG_CAMERA_ROLL_CANCEL_CNF (0xd009)
#define MSG_CAMERA_ROLL_DELETE_PHOTO_NOTIFY (0xd00a)
#define MSG_CAMERA_ROLL_SHARE_LINK_CNF (0xd00b)
#define MSG_CAMERA_ROLL_EMAIL_INVITE_CNF (0xd00c)
#define MSG_CAMERA_ROLL_SIGNOFF_CNF (0xd00d)
#define MSG_CAMERA_ROLL_END (0xd00e)
#endif

#if defined (MSA_SUPPORT)
#define MSG_MS_ACCOUNT_START (0xd010)
#define MSG_MS_ACCOUNT_REFRESH_TOKEN_REQ (0xd011)
#define MSG_MS_ACCOUNT_REFRESH_TOKEN_CNF (0xd012)
#define MSG_MS_ACCOUNT_SIGNOFF_CNF (0xd013)
#define MSG_MS_ACCOUNT_END (0xd014)
#endif

#define MSG_AUTOCIT_LCD_UPDATE (0xd020)
#define MSG_AUTOCIT_LCD_CLOSE (0xd021)

#define MSG_MAINMENU_SHOW_BANNER   (0xd100)
//for inlineedit
#define MSG_IEDT_SET_BG  (0xe000)
#define MSG_IEDT_SET_RECT (0xe001)
#define MSG_IEDT_SET_MAXLEN (0xe002)
#define MSG_IEDT_SET_BORDER (0xe003)
#define MSG_IEDT_SET_CURSOR (0xe004)
#define MSG_IEDT_SET_FOCUS (0xe005)
#define MSG_IEDT_SET_FONT (0xe006)
#define MSG_IEDT_SET_FONTCOLOR (0xe007)
#define MSG_IEDT_SET_IM (0xe008)
#define MSG_IEDT_SET_VISIBLE (0xe009)
#define MSG_IEDT_SET_STYLE (0xe00a)
#define MSG_IEDT_SET_STRING (0xe00b)
#define MSG_IEDT_SET_HANDLEREDKEY (0xe00c)
#define MSG_IEDT_SET_DISPLAYRECT (0xe00d)
#define MSG_IEDT_SET_PSWSTYLE (0xe00f)
#define MSG_IEDT_SET_DEFSTR (0xe010)
#define MSG_IEDT_SET_CONFIGDISCHAR (0xe011)
#define MSG_IEDT_SET_ENABLE (0xe012)
#define MSG_IEDT_SET_DISPLEFTNUM (0xe013)
#define MSG_IEDT_SET_ALIGN (0xe014)
#define MSG_IEDT_SET_MARGIN (0xe015)
#define MSG_IEDT_SET_CURSORHIDE (0xe016)
#define MSG_IEDT_SET_PERMITBORDER (0xe017)
#define MSG_IEDT_SET_BGTRANSPARENT (0xe018)
#define MSG_IEDT_SET_DIVIDINGLINE (0xe019)
#define MSG_IEDT_SET_THEMELINE (0xe01a)
#define MSG_IEDT_CLEARSTR (0xe01b)
//Add by baiyu for camera recorder
#define MSG_PLAY_RING_END (0xe01c)
//End Add by baiyu for camera recorder
/**-------------------------------------------------------------------------*
 **                         Compile Flag                                   *
 **------------------------------------------------------------------------*/
#ifdef __cplusplus
