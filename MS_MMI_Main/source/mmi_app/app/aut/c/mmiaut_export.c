...
LOCAL BOOLEAN   s_sntp_first_query_flag                = TRUE;    
/**--------------------------------------------------------------------------*
**                         GLOBAL DEFINITION                                *
**--------------------------------------------------------------------------*/
...
PUBLIC void MMIAPIAUT_SetIsFirstQuerySNTPFlag(BOOLEAN is_sntp_first_query_flag)
{
    SCI_TRACE_LOW("MMIAPIAUT_SetIsFirstQuerySNTPFlag:: is_sntp_first_query_flag = %d", is_sntp_first_query_flag);
    s_sntp_first_query_flag = is_sntp_first_query_flag;
}

PUBLIC BOOLEAN MMIAPIAUT_GetIsFirstQuerySNTPFlag(void)
{
    SCI_TRACE_LOW("MMIAPIAUT_GetIsFirstQuerySNTPFlag:: is_sntp_first_query_flag = %d", s_sntp_first_query_flag);
    return s_sntp_first_query_flag;
}
/*****************************************************************************/
