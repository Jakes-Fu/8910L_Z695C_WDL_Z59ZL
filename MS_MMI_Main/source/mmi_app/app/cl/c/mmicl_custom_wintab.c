                                            ...
                                            )
{
    ...
    //需要响应MSG_KEYLONG_HASH、MSG_KEYLONG_STAR，所以此处不能响应KEYDOWN消息
                              ...
                              )
{
    ...
    else
    {
        ...
        if (p_call_bcdinfo->is_num_present)//电话号码存在
        {
            //get number
                            ...
                            )
{
    ...
    record_index = s_group_list_info[group_index].position[0];
    if (arraycall_info->call_bcdinfo[record_index].is_num_present)//电话号码存在
    {
        //get number
