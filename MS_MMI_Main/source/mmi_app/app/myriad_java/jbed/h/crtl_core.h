...
/**
 * @file
 * Jbed Porting Layer: Core C runtime library abstraction (VM-independent)
 *
 * <b>Important:</b> Since CRTL is a macro-remapping layer, it can only be used
 * in full source distributions of Jbed.
 *
...
/*
 * PUBLICSYMBOL is required by some prototypes below. (Files using crtl.h do
 * not always include insignia.h/base_def.h)
 */
