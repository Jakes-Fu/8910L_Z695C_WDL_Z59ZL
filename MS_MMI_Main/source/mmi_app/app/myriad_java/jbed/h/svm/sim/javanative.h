...
void JBNI_EXPORT OPL_trace_printf3(STRING_INSTANCE, jint, jint, jint);
void JBNI_EXPORT OPL_trace_registerDebugSymbol(STRING_INSTANCE, jint);
void JBNI_EXPORT OPL_trace_traceClassInit(struct INSTANCE_java_lang_Class_s * , jboolean);
void JBNI_EXPORT OPL_trace_traceCollector(jint, jint, jint);
void JBNI_EXPORT OPL_trace_traceCompactor(jint, jint, jint);
void JBNI_EXPORT OPL_trace_traceInit(void);
void JBNI_EXPORT OPL_trace_traceThrow(struct INSTANCE_java_lang_Throwable_s * , jint, jint);
void JBNI_EXPORT OPL_trace_traceUncaught(struct INSTANCE_java_lang_Throwable_s * );
