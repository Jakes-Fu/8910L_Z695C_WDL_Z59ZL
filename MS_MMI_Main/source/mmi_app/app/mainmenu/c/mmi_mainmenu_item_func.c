...
#if 0 // no used in Mocor20b
PUBLIC void MMIMAINMENU_StartBrowser (uint32 param1, uint32 param2)
{
    ...
    {
#ifdef BROWSER_SUPPORT_DORADO
        MMIMAINMENU_StartDoradoBrowser(param1, param2);
#endif
    }
    else
    {
#ifdef OPERA_MINI_SUPPORT
    	  MMIMAINMENU_StartOperaMinBrowser(param1, param2);
#endif
    }
}
#endif
...
#ifdef MMI_JEWISH_CALENDAR
PUBLIC void MMIMAINMENU_StartJewishCalendar (uint32 param1, uint32 param2)
{
    MMIAPICALENDAR_OpenJewishCalMainWin();    
    return;
}
#endif
...
#ifdef GPS_SUPPORT
PUBLIC void MMIMAINMENU_StartGPS (uint32 param1, uint32 param2)
{
...
PUBLIC void MMIMAINMENU_StartTorch (uint32 param1, uint32 param2)
{
    if(MMIIDLE_GetTorchStatus())
    {
...
PUBLIC void MMIMAINMENU_StartPhoneSetting (uint32 param1, uint32 param2)
{
    ...
    }else{//exit settings first
		MMK_CloseMiddleWin(SET_WIN_ID_START + 1, SET_MAX_WIN_ID -1);
		MMIAPISET_EnterPhoneSettingWin();
	}
    return;
}

#ifdef HERO_APP_SMART_IN_MAINMENU
#ifdef HERO_APP_SMART_OPEN
PUBLIC void MMIMAINMENU_StartSmart (uint32 param1, uint32 param2)
{
...
//added by du.yuxuan
PUBLIC void MMIMAINMENU_OpenExtrasMainWin(uint32 param1, uint32 param2)
{
    MMIAPIEXTRAS_OpenMainWin();
}
//end

//#ifndef DATA_COUNTER_SUPPORT
PUBLIC void MMIMANMENU_DataCounter_MainWin(uint32 param1, uint32 param2)
{
...
PUBLIC void MMIMANMENU_EnterServer(uint32 param1, uint32 param2)
{
    MMISET_ServerInfoWin();
}

#ifdef ZDT_VIDEO_KING_SUPPORT
PUBLIC void MMIMAINMENU_StartVideoKing (uint32 param1, uint32 param2)
{
    MMIAPIMENU_EnterVideoKing();
    return;
}
#endif
#ifdef ZDT_MUSIC_KING_SUPPORT
PUBLIC void MMIMAINMENU_StartMusicKing (uint32 param1, uint32 param2)
{
