...
static const MMI_MAINMENU_ITEM_T s_mainmenu_item_data[] =
{
    ...
    {ID_MAINMENU_CMCC_MONERNET, TXT_MAINMENU_CMCC_PORTAL, IMAGE_MAINMENU_ICON_PT, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_EnterMonternetWin, 0},
#endif
    // 拨号盘	通讯录	通话记录	话机设置
    ...
    // 浏览器   信息服务 相机 情景模式
#ifdef BROWSER_SUPPORT
    {ID_COMMUNICATION_BROWSER, STR_ILIST_INTERNET_EXT01, IMAGE_MAINMENU_ICON_BROWSER, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartCommunicationBrowser, 0},
#endif
    ...
    {ID_GOMENU_CHANGE_STYLE, TXT_SET_MAINMENU_GO, IMAGE_MAINMENU_ICON_MAINMENU_SET, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_GoMenuChangeStyle, 0},
#endif
...
#endif
#ifdef DL_SUPPORT
    //{ID_DOWNLOAD_MANAGER, TXT_DL_DOWNLOAD_MANAGER, IMAGE_MAINMENU_ICON_DL, IMAGE_MAINMENU_ICON_SELECT, MMIMANMENU_DownloadManager, 0},
#endif
...
#endif
    {ID_ENTERTAIMENT_FAVORITE, TXT_MAINMENU_FAVORITE, IMAGE_MAINMENU_ICON_FAVORITE, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartFavorite, 0},
...
#endif
#ifdef PIC_VIEWER_SUPPORT
    //zhuyongjing change gallery string 20150722
	{ID_PIC_VIEWER, STR_GAL_HDR_GALLERY_EXT01/*TXT_COMMON_PIC*/, IMAGE_MAINMENU_ICON_PIC, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartPicViewer, 0},
    //{ID_PIC_VIEWER, TXT_COMMON_PIC, IMAGE_MAINMENU_ICON_PIC, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartPicViewer, 0},
#endif
#ifdef FM_SUPPORT
    {ID_ENTERTAIMENT_FM, TXT_FM, IMAGE_MAINMENU_ICON_FM, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartFM, 0},
...
static const wchar* s_mainmenu_item_name[] =
{
    L"Messaging",
    L"Contacts",
    L"Call log",
...
/*static const MMI_TEXT_ID_T s_mainmenu_item_name[] =
{
    STXT_MAIN_PB,
    STXT_MAIN_CL,
    STXT_MAIN_SETTING,
    STR_ILIST_INTERNET_EXT01,
...
static const MMI_MAINMENU_ITEM_T s_mainmenu_item_data[] =
{
	...
	{ID_MAINMENU_MUSIC_KING, TXT_MEDIA_MUSIC_KING, IMAGE_MAIN_MENU_Z903_MUSIC, IMAGE_MAIN_MENU_Z903_MUSIC, MMIMAINMENU_StartMusicKing, 0},
#endif
#ifdef ZDT_VIDEO_KING_SUPPORT	
	{ID_MAINMENU_VIDEO_KING, TXT_MEDIA_VIDEO_KING, IMAGE_MAIN_MENU_Z903_VIDEO, IMAGE_MAIN_MENU_Z903_VIDEO, MMIMAINMENU_StartVideoKing, 0},
#endif
	{ID_COMMUNICATION_PB, STXT_MAIN_PB, IMAGE_MAIN_MENU_Z903_1, IMAGE_MAIN_MENU_Z903_1, MMIMAINMENU_StartPB, 0},
	{ID_COMMUNICATION_MESSAGE, STXT_MAIN_MESSAGE, IMAGE_MAIN_MENU_Z903_2, IMAGE_MAIN_MENU_Z903_2, MMIMAINMENU_StartMessage, 0},
	
	//{ID_COMMUNICATION_CL, STXT_MAIN_CL, IMAGE_MAIN_MENU_Z903_3, IMAGE_MAIN_MENU_Z903_3, MMIMAINMENU_StartCL, 0},

	{ID_MAINMENU_ZDT_PLAYER, STXT_MAIN_MULTIMEDIA, IMAGE_MAIN_MENU_Z903_3, IMAGE_MAIN_MENU_Z903_3, MMIMANMENU_EnterPlayer, 0}, 
	{ID_MAINMENU_ZDT_TOOLS, STXT_MAIN_TOOLS, IMAGE_MAIN_MENU_Z903_4, IMAGE_MAIN_MENU_Z903_4, MMIMANMENU_EnterTools, 0},
	{ID_SETTINGS_PHONE, STXT_MAIN_SETTING, IMAGE_MAIN_MENU_Z903_5, IMAGE_MAIN_MENU_Z903_5, MMIMANMENU_EnterSetting, 0},   

	///{ID_SETTINGS_SERVER,	 STXT_MAIN_SERVER,IMAGE_MAIN_MENU_Z903_7,  IMAGE_MAIN_MENU_Z903_7,MMIMANMENU_EnterServer,0},	
#if defined(LEBAO_MUSIC_SUPPORT)
    {ID_ENTERTAIMENT_LEBAO, TEXT_LEBAO_MAIN_TITLE, IMAGE_MAIN_MENU_Z903_7, IMAGE_MAIN_MENU_Z903_7, MMIMAINMENU_StartLebao, 0},
#endif
#ifdef ZDT_PRODUCT_FM
#ifdef FM_SUPPORT
    {ID_ENTERTAIMENT_FM, STR_RADIO_HDR_FMRADIO, IMAGE_MAIN_MENU_Z903_8, IMAGE_MAIN_MENU_Z903_8, MMIMAINMENU_StartFM, 0},
#endif
#endif
//zmt add start
    {ID_ENTERTAIMENT_STUDY, TXT_STUDY_APP_TITLE, IMAGE_MAIN_MENU_Z903_STUDY, IMAGE_MAIN_MENU_Z903_STUDY, MMIAPIMENU_EnterStudyApp, 0},
//zmt add end
#if 0
#ifdef MMI_JEWISH_CALENDAR
    {ID_JEWISH_CALENDAR, STXT_JEWISH_CALENDAR, IMAGE_JEWISH_CALENDAR, IMAGE_MAINMENU_ICON_SELECT, MMIAPICALENDAR_OpenJewishCalMainWin, 0},
#endif
    
    {ID_COMMUNICATION_CL, STR_MENU_HDR_LOG_EXT02, IMAGE_PHONE, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartCL, 0},
    {ID_COMMUNICATION_PB, STXT_HEADER_PHONEBOOK, IMAGE_CONTACTS, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartPB, 0},
#ifdef PIC_VIEWER_SUPPORT
    {ID_PIC_VIEWER, STR_GAL_HDR_GALLERY_EXT01, IMAGE_PHOTOS, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartPicViewer, 0},
#endif

#ifdef BROWSER_SUPPORT
    {ID_COMMUNICATION_BROWSER, STR_OPERA_BROWSER_EXT01, IMAGE_OPERA_BROWSER, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartCommunicationBrowser, 0},
#endif
    {ID_COMMUNICATION_MESSAGE, STXT_HEADER_MESSAGES, IMAGE_MESSAGING, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartMessage, 0},
#ifdef  CAMERA_SUPPORT
    {ID_ENTERTAIMENT_CAMERA, STR_MENU_CAMERA, IMAGE_CAMERA, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartDCPhoto, 0},
#endif

#ifdef BROWSER_SUPPORT
#ifdef JAVA_SUPPORT
    {ID_MAINMENU_OPERA_STORE, STR_OPERA_STORE_EXT01, IMAGE_OPERA_STORE, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartBrowerURL, BROWSER_URL_TYPE_STORE},
#endif
#endif

#ifdef BROWSER_SUPPORT
#ifdef JAVA_SUPPORT
    {ID_MAINMENU_GAMEAPP, STR_HDR_APPS_GAMES, IMAGE_APPGAME, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartJava, BROWSER_URL_TYPE_FACEBOOK},
#endif
#endif

#ifdef BROWSER_SUPPORT
//    {ID_MAINMENU_FACEBOOK, STR_HDR_FACEBOOK, IMAGE_FB, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartBrowerURL, BROWSER_URL_TYPE_FACEBOOK},
//    {ID_MAINMENU_TWITTER, STR_HDR_TWITTER, IMAGE_TWITTER, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartBrowerURL, BROWSER_URL_TYPE_TWITTER},
#endif
    {ID_SETTINGS_PHONE, STXT_HEADER_SETTINGS, IMAGE_SETTINGS, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartPhoneSetting, 0},
    
#ifdef MMI_AUDIO_PLAYER_SUPPORT
    {ID_ENTERTAIMENT_MP3, STR_HDR_MUSIC, IMAGE_MUSIC, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartMp3, 0},
#endif
#ifdef VIDEO_PLAYER_SUPPORT
    {ID_ENTERTAIMENT_VIDEO, STR_MAINMENU_VIDEOS, IMAGE_VIDEOS, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartIVP, 0},
#endif
#ifdef CALENDAR_SUPPORT
    {ID_TOOLS_CALENDAR, STXT_CALENDAR, IMAGE_CALENDAR, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartCalendar, 0},
#endif

#ifdef CALCULATOR_SUPPORT 
    {ID_TOOLS_CALCULATOR, STR_CALC_HDR_CALCULATOR_EXT02, IMAGE_CALCULATOR, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartPicalc, 0},
#endif
#if (!defined MMI_ALARM_MINI_SUPPORT) && (!defined MMI_WORLDCLOCK_MINI_SUPPORT) && (!defined MMI_COUNTEDTIME_MINI_SUPPORT)
    {ID_CLOCK, STXT_HEADER_ALARM_CLOCK, IMAGE_ALARM_CLOCK, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartTimer, ID_CLOCK},
#endif
    {ID_MAINMENU_EXTRAS, STR_HDR_APPS_EXTRAS, IMAGE_EXTRAS, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_OpenExtrasMainWin, 0},

    {ID_ENTERTAIMENT_FAVORITE, STR_MAINMENU_FILES, IMAGE_FILE_EXPLORER, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartFavorite, 0},
#ifdef RECORD_SUPPORT
    {ID_TOOLS_RECORD, STXT_HEADER_VOICE_REC, IMAGE_RECORDER, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartRecord, 0},
#endif
#ifdef FM_SUPPORT
    {ID_ENTERTAIMENT_FM, STR_RADIO_HDR_FMRADIO, IMAGE_FM_RADIO, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartFM, 0},
#endif
    //modify for data counter
    //#ifdef DATA_COUNTER_SUPPORT
    //{ID_MAINMENU_COUNTERS, STR_HDR_COUNTERS, IMAGE_COUNTERS, IMAGE_MAINMENU_ICON_SELECT, PNULL, 0},
    {ID_MAINMENU_DATA_COUNTERS, STR_HDR_COUNTERS, IMAGE_COUNTERS, IMAGE_MAINMENU_ICON_SELECT, MMIMANMENU_DataCounter_MainWin, 0},
    //#endif

    {ID_MAINMENU_TORCH, STR_FLASHL_HDR_TORCH, IMAGE_TORCH, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartTorch, 0},
#ifdef EBOOK_SUPPORT
    {ID_EBOOK, TXT_COMM_EBOOK, IMAGE_MAINMENU_ICON_EBOOK, IMAGE_MAINMENU_ICON_SELECT, MMIMAINMENU_StartEBOOK, 0},
#endif    
...
#ifdef JAVA_SUPPORT
    //显示java安装进度的菜单项，必须放在数组最后。如新增菜单项，务必放在该项前面。
    {ID_MAINMENU_INSTALL, STR_HDR_INSTALLING_EXT01, IMAGE_MY_APPLICATION, IMAGE_MAINMENU_ICON_SELECT, PNULL, 0},
#endif
#endif
};
#endif
