                                        ...
                                        )
{
    ...
    {
    case CTRL_ICON_ID:
		                    SCI_TRACE_LOW("MAIN MENU :: MMIMAINMENU_DrawItemIcon -- image  = %d", item_ptr->icon.data.icon_id);
    ...
    case CTRL_ICON_BUFFER:
        {
            ...
            SCI_TRACE_LOW("MAIN MENU :: MMIMAINMENU_DrawItemIcon -- buff  = %x", item_ptr->icon.data.buffer.data);
