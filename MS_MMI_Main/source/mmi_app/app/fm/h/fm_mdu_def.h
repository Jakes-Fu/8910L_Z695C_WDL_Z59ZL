...
*/
RES_ADD_STRING(TXT_UDISK_FULL_TO_SD,"Not enough space, save to MemoryCard")   

RES_ADD_STRING(TXT_SD_FULL_TO_UDISK,"Insufficient space in MemoryCard, will save to phone.")  
...
#if defined(FM_RDS_SUPPORT)&& defined(MMI_FM_MINI_SUPPORT)
RES_ADD_IMG(IMAGE_FM_ADJ_BUT_RDS,"\\MMI_RES_##\\IMAG\\IMAGE_FM_ADJ_BUT_RDS.png",IMG_CMP_PNG_ARGB_RLE,0)
#endif
...
RES_ADD_STRING(TXT_FM_FREQUENCY_ALREADY_EXIST,"Channel already existed, failed to save")
...
RES_ADD_STRING(TXT_FM_FULL_AUTO_SEARCH,"Auto search and save")
RES_ADD_STRING(TXT_FM_BACKGROUND_PLAY,"Background play")
RES_ADD_STRING(TXT_FM_HEADSET_MODE,"Headset mode")
RES_ADD_STRING(TXT_FM_SPEAKER_MODE,"Open speaker")
...
RES_ADD_STRING(TXT_FM_RECORD_TIMER,"Timing record")
