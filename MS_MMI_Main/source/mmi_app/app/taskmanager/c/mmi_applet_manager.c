...
#endif
    WIN_SOFTKEY(STR_POC_ILIST_OFF,TXT_ACTIVE,STXT_RETURN),
    END_WIN
};
...
#else
        GUIWIN_SetSoftkeyTextId(MMIAPPLET_MANAGER_LIST_WIN_ID, STR_POC_ILIST_OFF, TXT_ACTIVE, STXT_RETURN, FALSE);
#endif
    }
    else
    {
