...
{
	{ID_DYNA_OPT_DETAIL, TIP_NULL, {STXT_SOFTKEY_SELECT_MK, TXT_NULL, STXT_RETURN}, STXT_DETAIL,  0, 0, 0, NULL},//detail
	{ID_DYNA_OPT_DELAPP, TIP_NULL, {STXT_SOFTKEY_SELECT_MK, TXT_NULL, STXT_RETURN}, TXT_DYNA_DEL_APP, 0, 0, 0, NULL},//del
