...
{
    {ID_OTA_CONFIG_SET_DELETE,TIP_NULL,{IMAGE_NULL,TXT_NULL,IMAGE_NULL},
        TXT_DELETE,0,0,0,MENU_NULL},        //删除
    {ID_OTA_CONFIG_SET_SAVE,TIP_NULL,{IMAGE_NULL,TXT_NULL,IMAGE_NULL},
    STXT_SOFTKEY_SAVE_MK,0,0,0,MENU_NULL},          //保存
    {ID_OTA_CONFIG_SET_DETAIL,TIP_NULL,{IMAGE_NULL,TXT_NULL,IMAGE_NULL},
...
//     {ID_OTA_CONFIG_SET_EXISTNUM,TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN}, 
//     TXT_ADDTOPB_EXIST, 0, 0, 0, MENU_NULL},//加至已有联系人
#ifndef MMISMS_CHATMODE_ONLY_SUPPORT 
#if defined (MMI_SMS_SECURITYBOX_SUPPORT)
    {ID_PUSH_MENU_MOVE_ITEM,  TIP_NULL, {IMAGE_NULL, TXT_NULL, IMAGE_NULL},
...
const GUIMENU_ITEM_T menu_cmsbrw_pushmsg[] =
{
    ...
    {ID_CMSBRW_PUSHMSG_FORWD,      TIP_NULL, {PNULL, STXT_SOFTKEY_SELECT_MK, TXT_COMMON_COMMON_BACK},STXT_SMS_OPTION_FORWARD,           0, 0, 0, MENU_NULL},
    {ID_CMSBRW_PUSHMSG_DELETE,      TIP_NULL, {PNULL, STXT_SOFTKEY_SELECT_MK, TXT_COMMON_COMMON_BACK},TXT_DELETE, 0, 0, 0, MENU_NULL},
#ifndef MMISMS_CHATMODE_ONLY_SUPPORT 
#if defined (MMI_SMS_SECURITYBOX_SUPPORT)
    {ID_PUSH_MENU_MOVE_ITEM,  TIP_NULL, {TXT_NULL, TXT_NULL, TXT_NULL}, TXT_MOVE,  0, 0, 0, MENU_PUSH_SECURITY_SELECT},
#endif
#endif
    //  {ID_CMSBRW_PUSHMSG_DELETEALL,   TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_CMSBRW_DELETEALL, 0, 0, 0, MENU_NULL},
};
