...
///    CHILD_BUTTON_CTRL(FALSE, IMAGE_COMMON_BTN_LIST, MMIMP3_LIST_BTN_CTRL_ID,   MMIMP3_BTN_FORM_CTRL1_ID),
   ...
   // CHILD_LABEL_CTRL(GUILABEL_ALIGN_MIDDLE, FALSE, MMIMP3_ARTIST_LABLE_CTRL_ID, MMIMP3_TITLE_FORM_CTRL_ID),
    CHILD_LABEL_CTRL(GUILABEL_ALIGN_MIDDLE, FALSE, MMIMP3_TITLE_LABLE_CTRL_ID,  MMIMP3_TITLE_FORM_CTRL_ID),
       ...
       // CHILD_BUTTON_CTRL(FALSE, IMAGE_COMMON_BTN_LIST, MMIMP3_LIST_BTN_CTRL_ID,   MMIMP3_BTN_FORM_CTRL1_ID),
        CHILD_FORM_CTRL(FALSE, GUIFORM_LAYOUT_ORDER, MMIMP3_TITLE_FORM_CTRL_ID, MMIMP3_BTN_FORM_CTRL1_ID),
#ifndef MMI_DEFAULT_FONT_20_SUPPORT
            CHILD_LABEL_CTRL(GUILABEL_ALIGN_MIDDLE,FALSE,MMIMP3_ARTIST_LABLE_CTRL_ID, MMIMP3_TITLE_FORM_CTRL_ID),
#endif
            CHILD_LABEL_CTRL(GUILABEL_ALIGN_MIDDLE,FALSE,MMIMP3_TITLE_LABLE_CTRL_ID,  MMIMP3_TITLE_FORM_CTRL_ID),
#ifndef MMI_DEFAULT_FONT_20_SUPPORT
...
#endif
	#endif
     //   CHILD_BUTTON_CTRL(FALSE, IMAGE_VOL_0, MMIMP3_VOLUME_BTN_CTRL_ID, MMIMP3_BTN_FORM_CTRL1_ID),
...
PUBLIC BOOLEAN MMIAP_IsMp3Tittle(MMI_CTRL_ID_T ctrl_id)
{
	return MMIMP3_TITLE_LABLE_CTRL_ID == ctrl_id;
}
/*****************************************************************************/
...
LOCAL void SetMp3BtnParam(void)
{
...
#endif
    gray_bg.img_id  = IMAGE_COMMON_PLAYER_BTN_VOL;//IMAGE_COMMON_PLAYER_BTN_VOL_GREY;//change by James li
    GUIBUTTON_SetGrayed(MMIMP3_VOLUME_BTN_CTRL_ID,  FALSE, &gray_bg, FALSE);
    gray_bg.img_id  = IMAGE_COMMON_BTN_PREV;//IMAGE_COMMON_BTN_PREV_GREY;//change by James li
    GUIBUTTON_SetGrayed(MMIMP3_PREV_BTN_CTRL_ID,    FALSE, &gray_bg, FALSE);
    gray_bg.img_id  = IMAGE_COMMON_BTN_PLAY;//IMAGE_COMMON_BTN_PLAY_GREY;////change by James li
    GUIBUTTON_SetGrayed(MMIMP3_PLAY_BTN_CTRL_ID,    FALSE, &gray_bg, FALSE);
    gray_bg.img_id  = IMAGE_COMMON_BTN_NEXT;//IMAGE_COMMON_BTN_NEXT_GREY;////change by James li
    ...
    gray_bg.img_id  = IMAGE_COMMON_BTN_LIST;//IMAGE_COMMON_BTN_LIST_GREY;////change by James li
...
)
{
    ...
    gui_bg.color = MMI_WHITE_COLOR;//MMI_BLACK_COLOR//change by James li
    //设置starusbar的背景
    ...
    else
    {
        ...
        //add by James li
        gui_bg.bg_type = GUI_BG_COLOR;
        gui_bg.color = MMI_WHITE_COLOR;
        //add by James li end
        GUIFORM_SetBg(MMIMP3_BTN_FORM_CTRL1_ID, &gui_bg);
        GUIFORM_SetAlign(MMIMP3_BTN_FORM_CTRL1_ID, GUIFORM_CHILD_ALIGN_HMIDDLE);//GUIFORM_CHILD_ALIGN_NONE);
     ...
     //   GUIFORM_SetChildHeight(MMIMP3_TITLE_FORM_CTRL_ID, MMIMP3_ARTIST_LABLE_CTRL_ID, &pda_title_sub_height);
       ...
       // GUIFORM_SetChildHeight(MMIMP3_TITLE_FORM_CTRL_ID, MMIMP3_ALBUM_LABLE_CTRL_ID,  &pda_title_sub_height);
        ...
        gui_bg.bg_type = GUI_BG_IMG;
        gui_bg.img_id  = IMAGE_COMMON_BG;//IMAGE_COMMON_BTN_BG;
        ...
        gui_bg.bg_type = GUI_BG_IMG;
#ifndef MMI_RES_LOW_COST
        gui_bg.img_id  = IMAGE_COMMON_BG;//IMAGE_MP3_OSD_BG_UP;
#endif
        //add by James li begin
        gui_bg.bg_type = GUI_BG_COLOR;
        gui_bg.color = MMI_WHITE_COLOR;
    ...
    GUILABEL_SetFont(MMIMP3_TITLE_LABLE_CTRL_ID,  SONG_FONT_30, MMI_BLACK_COLOR);//yangyu modify
   // GUILABEL_SetFont(MMIMP3_ARTIST_LABLE_CTRL_ID, MMIMP3_SUB_TEXT_FONT,  MMI_BLACK_COLOR);
  //  GUILABEL_SetFont(MMIMP3_ALBUM_LABLE_CTRL_ID,  MMIMP3_SUB_TEXT_FONT,  MMI_BLACK_COLOR);
