...
RES_ADD_STRING(TXT_MP3_SET_RING,"Set as ringtone")
...
RES_ADD_STRING(TXT_MP3_SET_ALARM_RING,"Set as alarm ringtone")
...
RES_ADD_STRING(TXT_MP3_ADD_TO_SAVED_LIST,"To saved play list")

RES_ADD_STRING(TXT_MP3_ADD_TO_NEW_LIST,"To new play list")
#ifdef MMIAP_MUSICMARK_SUPPORT
...
#ifdef MMI_AUDIO_PLAYER_SUPPORT
RES_ADD_STRING(TXT_MP3_REVIEW_OPEN,"Open review")
RES_ADD_STRING(TXT_MP3_REVIEW_CLOSE,"Close review")
#endif
...
RES_ADD_STRING(TXT_MP3_DEL_REAL_MUSIC,"Permanently deleted")  //永久删除

RES_ADD_STRING(TXT_MP3_DEL_REAL_MUSIC_QUERY,"Data can't be restored if deleted permanently, continue?") //永久删除将无法恢复，确认继续?
...
RES_ADD_STRING(TXT_MP3_ALBUM,"Album image")   //专辑
#endif
RES_ADD_STRING(STR_WAIT_UPDATING,"Update …")
#endif
...
#endif
RES_ADD_STRING(STR_NOTE_MUSIC_SET_RINGTONE,"Ringtone set")
RES_ADD_STRING(STR_NOTE_MUSIC_RINGTONE_FAIL,"Can't use this as a ringtone")
