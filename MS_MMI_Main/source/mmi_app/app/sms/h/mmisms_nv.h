...
typedef BOOLEAN MMINV_SMSCB_50_CHANNEL_T;
...
//CB item
#ifdef MMI_ETWS_SUPPORT
    MMINV_SMSCB_MESSAGE_LIST_FIRST,
    MMINV_SMSCB_MESSAGE_LIST_LAST = MMINV_SMSCB_MESSAGE_LIST_FIRST +MMINV_MAX_SMSCB_RECORDS -1,
#endif
