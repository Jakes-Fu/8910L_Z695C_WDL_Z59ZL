...
typedef enum
{
    ...
    MMISMS_CHATBOX_BLOCK_OPT_MENU_CTRL_ID,
#endif    
...
//    MMISMS_SMSBOX_LISTBOX_CTRL_ID,          // the listbox for SMS box
    ...
    MMISMS_CB_50_CHANNEL_LISTBOX_CTRL_ID,                 //50频段小区广播启动单选列表控件
    ...
    MMISMS_SMS_EDIT_ELEMENT_AREA_FORM_ID,
    MMISMS_SMS_EDIT_CONTAINER_FORM_ID,
    MMISMS_SMS_EDIT_SIM_AREA_FORM_ID,
    MMISMS_SMS_EDIT_SIM_OWNDRAW_CTL_ID,
    MMISMS_SMS_EDIT_BODY_FORM_ID,
    MMISMS_SMS_EDIT_TEXT_FORM_ID,
    MMISMS_SMS_EDIT_SHORTCUT_INDICATOR_CTL_ID,
    MMISMS_SMS_ATTACH_ALL_DEL_CTL_ID,//Tong Yongli added
    MMISMS_SHOW_CHAT_SMS_EDITCTRL_ID,
    MMISMS_SMS_EDIT_UNDER_BACKGROUND_LABEL_CTL_ID,
    ...
    MMISMS_SHOW_CHAT_SMS_LABEL_ITEM_CTRL_ID,
    MMISMS_MAX_SHOW_CHAT_SMS_ITEM_LABEL_CTRL_ID = MMISMS_SHOW_CHAT_SMS_LABEL_ITEM_CTRL_ID + MMISMS_CHAT_MAX_ITEM,    

    MMISMS_SHOW_CHAT_SMS_OWNDRAW_ITEM_FORM_CTRL_ID,
    MMISMS_MAX_SHOW_CHAT_SMS_ITEM_OWNDRAW_FORM_CTRL_ID = MMISMS_SHOW_CHAT_SMS_OWNDRAW_ITEM_FORM_CTRL_ID + MMISMS_CHAT_MAX_ITEM,    
    
    MMISMS_SHOW_CHAT_SMS_OWNDRAW_ITEM_LABEL_CTRL_ID,
    MMISMS_MAX_SHOW_CHAT_SMS_ITEM_OWNDRAW_LABEL_CTRL_ID = MMISMS_SHOW_CHAT_SMS_OWNDRAW_ITEM_LABEL_CTRL_ID + MMISMS_CHAT_MAX_ITEM,   
    ...
    MMISMS_SHOW_CHAT_SMS_RICHTEXT_ITEM_FORM_CTRL_ID,
    MMISMS_MAX_SHOW_CHAT_SMS_RICHTEXT_ITEM_FORM_CTRL_ID = MMISMS_SHOW_CHAT_SMS_RICHTEXT_ITEM_FORM_CTRL_ID + MMISMS_CHAT_MAX_ITEM,  

    MMISMS_SHOW_CHAT_SMS_UNDERBG_ITEM_FORM_CTRL_ID,
    MMISMS_MAX_SHOW_CHAT_SMS_UNDERBG_ITEM_FORM_CTRL_ID = MMISMS_SHOW_CHAT_SMS_UNDERBG_ITEM_FORM_CTRL_ID + MMISMS_CHAT_MAX_ITEM,  

    //MMS body and bg container only for send fail type
    MMISMS_SHOW_CHAT_SMS_TEXT_CONTAINER_ITEM_FORM_CTRL_ID,
    MMISMS_MAX_SHOW_CHAT_TEXT_CONTAINER_ITEM_FORM_CTRL_ID = MMISMS_SHOW_CHAT_SMS_TEXT_CONTAINER_ITEM_FORM_CTRL_ID + MMISMS_CHAT_MAX_ITEM,   

    //MMS title
    MMISMS_SHOW_CHAT_SMS_TITLE_ITEM_FORM_CTRL_ID,
    MMISMS_MAX_SHOW_CHAT_TITLE_ITEM_FORM_CTRL_ID = MMISMS_SHOW_CHAT_SMS_TITLE_ITEM_FORM_CTRL_ID + MMISMS_CHAT_MAX_ITEM,    

    //MMS size
    MMISMS_SHOW_CHAT_SMS_SIZE_ITEM_FORM_CTRL_ID,
    MMISMS_MAX_SHOW_CHAT_SIZE_ITEM_FORM_CTRL_ID = MMISMS_SHOW_CHAT_SMS_SIZE_ITEM_FORM_CTRL_ID + MMISMS_CHAT_MAX_ITEM,    

    //MMS More Attachments tip label(actually we can share the 'MMS size' ID for the two are conflictual)
    MMISMS_SHOW_CHAT_SMS_MORE_ATTA_TIP_ITEM_FORM_CTRL_ID,
    MMISMS_MAX_SHOW_CHAT_SMS_MORE_ATTA_TIP_ITEM_FORM_CTRL_ID = MMISMS_SHOW_CHAT_SMS_MORE_ATTA_TIP_ITEM_FORM_CTRL_ID + MMISMS_CHAT_MAX_ITEM,    
    ...
    MMISMS_CHAT_EDIT_DICTIONARY_CTRL_ID,
    #ifdef MMI_PDA_SUPPORT
    ...
    #endif
	MMISMS_SHOW_BLOCKNUMBER_TEXT_CTRL_ID,
#endif    
    ...
    MMISMS_CHATBOX_CHILD_BUTTON_FORM_CTRL_ID,
    MMISMS_CHATBOX_CHILD_LIST_FORM_CTRL_ID,
    MMISMS_CHATBOX_NEWMSG_BUTTON_CTRL_ID,
    MMISMS_CHATBOX_NEWMSG_BTEXT_CTRL_ID,
    MMISMS_CHATBOX_NEWMSG_STEXT_CTRL_ID,
    MMISMS_SMS_MESSAGE_SETTING_CTRL_ID,
    MMISMS_MMS_ATTACHMENT_LIST_CTRL_ID,
    MMISMS_PICTURE_PREVIEW_CTRL_ID,
#ifdef HERO_ENGINE_SUPPORT
	MMISMS_SET_SPAM_MSG_CLEAN_CTRL_ID,
	MMISMS_SET_SPAM_MSG_CLEAN_SET_LIST_CTRL_ID,
	MMISMS_SET_SPAM_MSG_CLEAN_SET_CLOSE_ACK_CTRL_ID,
	MMISMS_SET_SPAM_MSG_CLEAN_HELP_CTRL_ID,
#endif
    MMISMS_MAX_CTRL_ID
}MMISMS_CONTROL_ID_E;
