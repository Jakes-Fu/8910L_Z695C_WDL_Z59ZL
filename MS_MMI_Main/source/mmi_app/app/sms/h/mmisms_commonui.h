...
{    
    ...
    uint16 all_deleted_msg_num;     //已经删除的个数
    uint16 total_msg_num;     //总的会话个数

    BOOLEAN mms_is_sendrecv;  //MMS是否发送中
    BOOLEAN is_mms_del;      //是否删除了MMS
    BOOLEAN is_delete_chatlist;      //是否删除会话列表
    void*  user_data;    
...
/*****************************************************************************/
//     Description : to open the message of delete progress window    
//    Global resource dependence : 
//  Author:
//    Note: 
/*****************************************************************************/
