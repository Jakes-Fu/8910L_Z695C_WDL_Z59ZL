...
LOCAL void  InitPdaSmsMainListCtrl(BOOLEAN is_replace)
{
    ...
    AppendPdaSmsMainListItem2Line(ctrl_id, TXT_COMMON_WRITE_MESSAGE, text_str, IMAGE_NUMBER_1, MMISMS_MAIN_MENU_NODE_WRITE_NEW_MSG, is_replace, item_index, GUIITEM_STYLE_ONE_LINE_ICON_TEXT_WITHOUT_EFFECT_STR);
    item_index++;
    ...
    AppendPdaSmsMainListItem2Line(ctrl_id, TXT_INBOX, text_str, IMAGE_NUMBER_2, MMISMS_MAIN_MENU_NODE_INBOX, is_replace, item_index, GUIITEM_STYLE_ONE_LINE_ICON_TEXT_AND_TEXT);
    item_index++;
    ...
    AppendPdaSmsMainListItem2Line(ctrl_id, TXT_COMM_OUTBOX, text_str, IMAGE_NUMBER_3, MMISMS_MAIN_MENU_NODE_OUTBOX, is_replace, item_index, GUIITEM_STYLE_ONE_LINE_ICON_TEXT_AND_TEXT);
    item_index++;
    ...
    AppendPdaSmsMainListItem2Line(ctrl_id, TXT_COMM_DRAFT, text_str, IMAGE_NUMBER_4, MMISMS_MAIN_MENU_NODE_DRAFTBOX, is_replace, item_index, GUIITEM_STYLE_ONE_LINE_ICON_TEXT_AND_TEXT);
    item_index++;
    ...
    AppendPdaSmsMainListItem2Line(ctrl_id, TXT_SMS_SENTBOX, text_str, IMAGE_NUMBER_5, MMISMS_MAIN_MENU_NODE_SENTBOX, is_replace, item_index, GUIITEM_STYLE_ONE_LINE_ICON_TEXT_AND_TEXT);
    item_index++;
...
#endif
    SCI_MEMSET(&text_str, 0x00, sizeof(MMI_STRING_T));
    AppendPdaSmsMainListItem2Line(ctrl_id, TXT_SMS_FREQWORD, text_str, IMAGE_NUMBER_6, MMISMS_MAIN_MENU_NODE_FREQWORD, is_replace, item_index, GUIITEM_STYLE_ONE_LINE_ICON_TEXT_WITHOUT_EFFECT_STR);
    item_index++;
