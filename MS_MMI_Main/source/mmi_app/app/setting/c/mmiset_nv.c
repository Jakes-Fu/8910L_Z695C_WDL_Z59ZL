...
const uint16 set_nv_len[] =
{
        ...
        sizeof(BOOLEAN),///1,									// MMINV_SET_CONNECT_PROMPT_STATUS
        ...
        sizeof(BOOLEAN),//1//1,//MMINV_SET_IS_RED_KEYLOCK
      ...
      //  1,                                  // MMINV_SET_IS_MENU_ANIMATION_OPEN
        ...
        sizeof(MN_CALL_CLIR_E),				// MMINV_SET_CLIR_TYPE    
...
//#endif
    ...
    sizeof(BOOLEAN),//whitelist audio call
    sizeof(BOOLEAN),//whitelist vedio call
    sizeof(BOOLEAN),//whitelist message
    sizeof(MMISET_WHITELIST_T),
#endif
    ...
    sizeof(BOOLEAN),//MMINV_SET_SMARTDIVERT_ACTION
		...
		sizeof(BOOLEAN), ////handfree
	//  sizeof(BOOLEAN),
#endif

    sizeof(MMISET_LANG_FORECD_NV_BYTE_T),
    sizeof(GUI_FONT_T),
#ifdef UNISOC_TEST_ENTRY_FOR_TESTER
    sizeof(MMISET_SECURITY_CODE_T),
    sizeof(BOOLEAN),
#endif
    ...
    //dong.chunguang add for welcome NV
		sizeof(wchar)*(MMISET_WELCOME_MAX_LEN+1),
		sizeof(BOOLEAN),//Message
		sizeof(BOOLEAN),//CALL
		sizeof(BOOLEAN),//ALARM
		sizeof(BOOLEAN),//CALENDAR
		sizeof(BOOLEAN),//MAIL
		sizeof(BOOLEAN),//OUTLOOCK
		sizeof(BOOLEAN),//OPERATOR
		sizeof(BOOLEAN),//RADIO
		sizeof(BOOLEAN),//MUSIC
		sizeof(BOOLEAN),//OTHERS
		sizeof(uint8),//Notificaton show type
		sizeof(BOOLEAN),//Notificaton
    //end
    sizeof(BOOLEAN), //nhl add nv
    sizeof(uint8),//	ljg add MMINV_SET_CALL_FORWARD_CONDITIONS
    sizeof(uint8),//	ljg add  MMINV_SET_CALL_FORWARD_SIMCARDS
    sizeof(BOOLEAN),//ljg add  MMINV_SET_CALL_SENDCALLID
    sizeof(MMISET_VM_NUMBER_INFO_T),//ljg add MMINV_SET_CALL_VOICEMAIL_SIMONE
    sizeof(MMISET_VM_NUMBER_INFO_T),//ljg add MMINV_SET_CALL_VOICEMAIL_SIMTWO
    sizeof(MMISET_LOCKSCREEN_SECURITY_CODE_T),
    sizeof(MN_CALL_CLIR_E),//ljg add MMINV_SET_CLIR_TYPE_SIM2
	...
	sizeof(uint8),
#endif
	sizeof(BOOLEAN), //MMINV_SET_BT_LOG_ENABLE
#ifdef GCF_TA_SUPPORT	
	 sizeof(BOOLEAN),//	zhouqin  add MMINV_SET_CALL_WAIT_STATUS
	 sizeof(BOOLEAN),
#endif
#ifdef PHONE_NUMBER_VOICE
	sizeof(MMISET_TTS_CODE_INFO_T),
	sizeof(MMI_POINTTIME_INFO_T),
#endif
#ifdef SOS_KEYLONGWEB
	sizeof(MMISET_SOS_T),
#endif
sizeof(MMISET_IMSI_T),
