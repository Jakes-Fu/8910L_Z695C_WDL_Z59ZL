...
PUBLIC void MMIAPISET_OpenAboutResetPwdWin(BOOLEAN      is_clean_all_data)
{
   ...
   if(MMIDEVICELOCKSCREEN_ReadPwd(&device_lock_pwd))
   {
       ...
       {
           MMIPUB_OpenConfirmationDialogWinByTextIdEx(MMK_GetFirstAppletHandle(),PNULL,STR_QUERY_RESET_SETTINGS_EXT01,PNULL,PNULL,&dialog_win_id,PNULL,MMIPUB_SOFTKEY_DIALOG_OK,handleConfirmationDialog,(uint32)tmp);
       }
   }
   else
   {
