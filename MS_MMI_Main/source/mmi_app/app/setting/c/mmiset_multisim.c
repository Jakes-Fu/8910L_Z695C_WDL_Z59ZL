...
//     uint8                       ready_times = 0;
    ...
    func_array[MMISET_MAJOR_SIM_SEL_FUNC_WAP] = MMISET_MAJOR_SIM_SEL_SIM1;//special for MMISET_MAJOR_SIM_SEL_FUNC_WAP
...
PUBLIC MMISET_MAJOR_SIM_SEL_TYPE_E MMISET_GetMajorSimSelType(MMISET_MAJOR_SIM_SEL_FUNC_TYPE_E e_func_type)
{
    ...
    {
        SCI_TRACE_LOW("MMISET_GetMajorSimSelType  error e_func_type");
...
//    SCI_ASSERT(e_func_type < MMISET_MAJOR_SIM_SEL_FUNC_MAX);/* assert to do */
    ...
    if (MN_RETURN_SUCCESS != return_value)
    {
        ...
        func_array[MMISET_MAJOR_SIM_SEL_FUNC_WAP] = MMISET_MAJOR_SIM_SEL_SIM1;
...
PUBLIC MMISET_MAJOR_SIM_SEL_TYPE_E MMIAPISET_GetMajorSim(MMISET_MAJOR_SIM_SEL_FUNC_TYPE_E e_func_type)
{
    ...
    else if (e_func_type == MMISET_MAJOR_SIM_SEL_FUNC_WAP)
    {
