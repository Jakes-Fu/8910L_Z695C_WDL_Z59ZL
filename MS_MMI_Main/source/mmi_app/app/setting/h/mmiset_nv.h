...
typedef enum
{
    ...
    //  MMINV_SET_IS_MENU_ANIMATION_OPEN,
       ...
       // MMIENVSET_SETTING,               // 保存环境设置值
        ...
        MMINV_SET_BT_STATUS_BEFORE_FLY_MODE,
...
//#endif
    ...
    MMINV_SET_WHITELIST_AUDIOCALL,
    MMINV_SET_WHITELIST_VEDIOCALL,
    MMINV_SET_WHITELIST_MESSAGE,
    MMINV_SET_WHITELIST,
#endif
	...
	MMINV_SET_AUTO_HANDFREE,
	//MMINV_SET_CALL_ANSWER_TIME,
#endif


        MMINV_FORECD_LANG_FIRST_POWER,
		MMINV_SET_FONT_SIZE,
#ifdef UNISOC_TEST_ENTRY_FOR_TESTER
        MMINV_SET_SECURITY_CODE,
        MMINV_SET_PRIVACY_MODE,
#endif
#if defined(OMA_CP_SEC_SUPPORT)
    MMINV_SET_OTA_SECURITY_ENABLE,
#endif

        //dong.chunguang add for welcome NV
        MMINV_SET_WELCOME_NOTE,
        MMINV_SET_NOTIFICATION_MESSAGES,
        MMINV_SET_NOTIFICATION_CALLS,
        MMINV_SET_NOTIFICATION_ALARMS,
        MMINV_SET_NOTIFICATION_CALENDAR,
        MMINV_SET_NOTIFICATION_MAILS,
        MMINV_SET_NOTIFICATION_OUTLOOK,
        MMINV_SET_NOTIFICATION_OPERATOR,
        MMINV_SET_NOTIFICATION_RADIO,
        MMINV_SET_NOTIFICATION_MUSIC, 
        MMINV_SET_NOTIFICATION_OTHERS,
        MMINV_SET_NOTIFICATION_TYPE,
        MMINV_SET_NOTIFICATION_ALERT,
        //end

        MMINV_KEYGUARD_SETTING_SWITCH,	//nhl add nv keyguard

        MMINV_SET_CALL_FORWARD_CONDITIONS,
        MMINV_SET_CALL_FORWARD_SIMCARDS,
        MMINV_SET_CALL_SENDCALLID,
        MMINV_SET_CALL_VOICEMAIL_SIMONE,
        MMINV_SET_CALL_VOICEMAIL_SIMTWO,
        MMINV_DEVICELOCKSCREEN_PWD,
        MMINV_SET_CLIR_TYPE_SIM2,
	...
	MMINV_SET_2G_4G_NETWORK_SIM1,
	MMINV_SET_2G_4G_NETWORK_SIM2,
#endif
	MMINV_SET_BT_LOG_ENABLE,
#ifdef GCF_TA_SUPPORT
    MMINV_SET_CALL_WAIT_STATUS_SIM1,
    MMINV_SET_CALL_WAIT_STATUS_SIM2,    
#endif
#ifdef PHONE_NUMBER_VOICE
	MMINV_SET_TTS_STYLE,
	MMINV_SET_POINTTIME_STYLE,
#endif
#ifdef SOS_KEYLONGWEB
	 MMINV_SET_SOS_CALL_TYPE,
#endif
	MMINV_SET_IMSI_TYPE,
