...
#define MMISET_MAX_VM_NUMBER_LEN  20
...
typedef enum
{
     MMISET_VMN_OPER_TYPE_CALL_DIVERT,       //setting中查询呼叫转移     MMISMS_VMN_OPER_TYPE_CALL_DIVERT,       //setting中查询呼叫转移
     MMISET_VMN_OPER_TYPE_CALL_SETTING,    //setting 中VMN设置
     MMISET_VMN_OPER_TYPE_IDLE_DIAL,         //idle下快捷拨号
     MMISET_VMN_OPER_TYPE_MAX
}MMISET_VMN_OPER_TYPE_E;
