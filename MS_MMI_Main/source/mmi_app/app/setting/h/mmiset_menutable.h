...
typedef enum
{
	...
	ID_ZDT_MENU_SWITCH,
	ID_ZDT_TIME_SWITCH,
	ID_ZDT_ONEKEY_TIME_SWITCH,
	ID_ZDT_CC_SWITCH,
	ID_ZDT_PB_SWITCH,
	ID_ZDT_NEWSMS_SWITCH,
	ID_ZDT_SMS_SWITCH,
	ID_ZDT_VOL_SWITCH,
	ID_ZDT_CHARGE_SWITCH,	
	ID_ZDT_KL_SWITCH,		
	ID_ZDT_START_TIME,
	ID_ZDT_END_TIME,
	ID_ZDT_POINT_TIME,
	ID_ZDT_POINT_DIRECTION,
	ID_ZDT_ONEKEY_TIME,
	ID_ZDT_ONEKEY_DIRECTION,
#endif
...
//	ID_SET_MENU_ANIMATION,
	...
	ID_FDN_NUM,
	/*FDN end*/
    ID_SET_BLACKLIST_ENTER,
    ID_SET_COST_SETTINGS,
    ID_SET_VOICE_MAIL,
    ID_SET_FIXED_DIALING,
    ...
    ID_SET_WHITELIST_ENTER,
    ID_SET_WHITELIST_LIST,   
    ID_SET_WHITELIST_SETTING,
    ID_SET_WHITELIST_NEW,
    ID_SET_WHITELIST_EDIT,
    ID_SET_WHITELIST_DEL,
    ID_SET_WHITELIST_CONTACT,
    ID_SET_WHITELIST_CL,
    ID_SET_WHITELIST_DELALL,
#endif
...
//add for dual sys
	...
	ID_SET_MSA_REMOVE_ACCOUNT,
	ID_SET_MSA_EDIT_ACCOUNT,
	//dong.chunguang add
	ID_SET_NOTIFICATION_DETAILS,
	ID_SET_NOTIFICATION_ICON_ONLY,
	//end
...
#endif
#ifdef PHONE_NUMBER_VOICE
		ID_SET_PONTTIME_CODE_SETTING,
		ID_SET_PONTTIME_TIME_SETTING,
#endif
    SET_ID_MENU_MAX
}SET_ID_MENU_E;
...
typedef enum
{
  ID_SET_MSA_INDEX_ACCOUNT = 0,
  ID_SET_MSA_INDEX_ONEDRIVE_PHOTO,
  ID_SET_MSA_INDEX_CONTACTS_SYNC,
  ID_SET_MSA_INDEX_MAX
}MMISET_MSA_INDEX_E;
