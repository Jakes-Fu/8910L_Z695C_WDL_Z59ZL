...
#define MMISET_EnterGprsSettingWin 		 	 MMIAPISET_EnterGprsSettingWin
...
#undef MMISET_WALLPAPER_USER_MAX_NUM 
...
#define MMISET_RING_FIXED_DEFAUT_NUM_EX     MMISET_RING_USER_MAX_NUM_EX //固定铃声个数

#define MMISET_ORTHODOX_RING_FIXED_DEFAUT_NUM        15 //固定铃声个数

#define MMISET_MSG_FIXED_RING_MAX_ITEM      MMISET_ALERT_RING_MAX_NUM//dong.chunguang modify MMISET_MSGRING_USER_MAX_NUM
#define MMISET_MSG_FIXED_RING_MAX_ITEM_EX   MMISET_ALERT_RING_MAX_NUM_EX//dong.chunguang modify MMISET_MSGRING_USER_MAX_NUM
//[alarm ring tone UI and function]
#define MMIALM_RING_FIXED_DEFAULT_NUM        MMIALM_CLOCK_RING_MAX_NUM//alarm ring tone num
#define MMIALM_RING_FIXED_DEFAULT_NUM_MAT    MMIALM_CLOCK_RING_MAX_NUM_MAT//alarm ring tone num multi countries' language
//[end]

#define MMISET_WALLPAPER_FIXED_PIC_MAX_NUM  (MMISET_WALLPAPER_USER_MAX_NUM + 1)

#ifdef PHONE_NUMBER_VOICE
#define MMISET_MAX_RING_ID                  (MMISET_RING_FIXED_DEFAUT_NUM + MMISET_ORTHODOX_RING_FIXED_DEFAUT_NUM+ 10 + 10)  //更多铃声id
#else
#define MMISET_MAX_RING_ID                  (MMISET_RING_FIXED_DEFAUT_NUM + MMISET_ORTHODOX_RING_FIXED_DEFAUT_NUM + 10)  //更多铃声id
#endif
...
#define MMISET_VOL_HENDSET_MAX              5
#define MMISET_VOL_DEFAULT_MULTIM         8///  5

#define MMISET_WALLPAPER_DEFAULT_ID         1//默认墙纸id
#define MMISET_ORTHODOX_WALLPAPER_DEFAULT_ID         0//默认墙纸id
...
#define MMISET_WHITELIST_MAX_NUM        30
#endif
...
// CALL Ring
#define MMI_CALL_RING_START_ID R_CALL_1  //铃声的开始id

#define MMI_OPER_RING_START_ID R_OPER_CALL_1  //midi铃声的开始id
#ifdef MMI_COMPILE_E//8910UIX
// MMS Ring
#define MMI_MMS_RING_START_ID  R_ALERT_1//dongchunguang add for same as Call//R_MMS_1 //彩信铃声的开始id

//WNS Ring
#define MMI_WNS_RING_START_ID  R_WNS_1//dongchunguang add for WNS ring
#endif

// Clock Ring
#define MMI_CLOCK_RING_START_ID  R_CLOCK_1
// SMS Ring
#define MMI_SMS_RING_START_ID  R_SMS_1 //短信铃声的开始id
...
#else
#define MMI_POWER_RING_START_ID R_CALL_1 //R_POWER_1 //开关机铃声的开始id
#endif
#if defined(MMI_MP3_FIXED_MUSIC)

#define MMI_MP3_FIXED_MUSIC_RING_START_ID   R_FIXED_MP3_1 // R_CALL_1///   R_CALL_MP3_1

#define MMI_MP3_FIXED_MUSIC_RING_NUMBER   1
#endif

#ifdef SOS_KEYLONGWEB
#define MMI_SOS_ALARM_START_ID R_SOS_ALARM
#endif
...
#define MMI_DC_RING_FINAL_COUNT_ID R_DC_COUNT
#define MMI_DC_REC_STOP_ID R_RECORD_OFF
#define MMI_DC_REC_START_ID R_RECORD_ON
...
//key lock ring
#define MMI_KEY_LOCK_RING_START_ID R_TP_KEYLOCK //key lock ring start id
...
#ifdef PHONE_NUMBER_VOICE
#define MMI_PHONENUM_RING_START_ID R_NUM_0
#define MMI_PHONENUM_RING_NUMBER   16
#define MMISET_PHONENUM_RING1_ID             1
#define MMISET_PHONENUM_RING_DEFAULT_VOL    MMISET_VOL_SIX
#endif
#define MMISET_RING_DEFAULT_ID_EX              1
#define MMISET_MSG_DEFAULT_ID_EX              1//message 1
#define MMISET_RING_DEFAULT_ID              1
#define MMISET_MSG_DEFAULT_ID              1//message 1
#define MMISET_POWER_DEFAULT_ID              1//

#define MMISET_DC_DEFAULT_RING_ID       1 //相机默认铃声id
#define MMISET_DC_DEFAULT_VOL           MMISET_VOL_EIGHT        //相机默认铃声音量
...
#define MMISET_POWER_OFF_BACKLIGHT_TIME      60000//待机屏幕背关默认时间
...
#define MMISET_SECURITY_CODE_LEN_MAX 8

#if 1//def _SW_ZDT_PRODUCT_
#define RING_NAMES L"Ring1", L"Ring2", L"Ring3", L"Ring4"
#else
#define RING_NAMES L"Bicycle", L"Brikabrak", L"Brook", \
        L"Coconut", L"Destiny", L"Elves", \
        L"Nocturnal", L"Tune", L"Nostalgia", \
        L"Rococo", L"Seahorse", L"Urgent", \
        L"Trace", L"Tumbler"
...
#define ALERT_NAMES_EX L"Calendar 1", L"Message 1"
#if 1//def _SW_ZDT_PRODUCT_
#define RING_NAMES_EX L"Bicycle", L"Brikabrak"

#else
#define RING_NAMES_EX L"Bicycle", L"Brikabrak", L"Brook", \
        L"Coconut", L"Destiny", L"Elves", \
        L"Nocturnal", L"Tune", L"Nostalgia", \
        L"Rococo", L"Seahorse", L"Urgent"
...
#define TXT_ORTH_RING_1 {0x05D0, 0X05D7, 0X05D9, 0X05E0, 0X05D5, 0}
#define TXT_ORTH_RING_2 {0X05D0, 0X05E0, 0X05D0, 0X0020, 0X05D4, 0}
#define TXT_ORTH_RING_3 {0X05D0, 0X05E0, 0X05D9, 0X0020, 0X05DE, 0X05D0, 0X05DE, 0X05D9, 0X05DF, 0}
#define TXT_ORTH_RING_4 {0X05D5, 0X05D4, 0X05D1, 0X05D9, 0X05D0, 0X05D5, 0X05EA, 0X05D9, 0X05DD, 0}
#define TXT_ORTH_RING_5 {0X05D5, 0X05D4, 0X05D9, 0X05D4, 0X0020, 0X05D1, 0X05D9, 0X05D5, 0X05DD, 0X0020, 0X05D4, 0X05D4, 0X05D5, 0X05D0, 0}
#define TXT_ORTH_RING_6 {0X05D5, 0X05D4, 0X05D9, 0X05D5, 0X0020, 0X05DC, 0X05DE, 0X05E9, 0X05D9, 0X05E1, 0X05D4, 0}
#define TXT_ORTH_RING_7 {0X05D5, 0X05D6, 0X05DB, 0X05E0, 0X05D5, 0X0020, 0X05DC, 0X05E7, 0X05D1, 0X05DC, 0}
#define TXT_ORTH_RING_8 {0X05D5, 0X05E0, 0X05E7, 0X05D9, 0X05EA, 0X05D9, 0}
#define TXT_ORTH_RING_9 {0X05D5, 0X05E2, 0X05EA, 0X05D4, 0X0020, 0X05DB, 0X05EA, 0X05D1, 0X05D5,0X0020, 0X05DC, 0X05DB, 0X05DD, 0}
#define TXT_ORTH_RING_10 {0X05D9, 0X05E2, 0X05DC, 0X05D4, 0X0020, 0X05D5, 0X05D9, 0X05D1, 0X05D0, 0}
#define TXT_ORTH_RING_11 {0X05DC, 0X05DE, 0X05E2, 0X05DF, 0X0020, 0X05D0, 0X05D7, 0X05D9, 0X0020, 0X05D5, 0X05E8, 0X05E2, 0X05D9, 0X05D9, 0}
#define TXT_ORTH_RING_12 {0X05DE, 0X05DE, 0X05E7, 0X05D5, 0X05DE, 0X05DA, 0}
#define TXT_ORTH_RING_13 {0X05DE, 0X05E0, 0X05D5, 0X05E8, 0X05D4, 0}
#define TXT_ORTH_RING_14 {0X05E4, 0X05E0, 0X05D4, 0X0020, 0X05DC, 0X05E2, 0X05DC, 0X05D1, 0X05D5, 0}
#define TXT_ORTH_RING_15 {0X05E4, 0X05E8, 0X05D5, 0X05E7, 0X0020, 0X05D9, 0X05EA, 0X0020, 0X05E2, 0X05E0, 0X05DA, 0}

typedef struct
{
    wchar title_id[30];
} MMISET_RING_TITLE_INFO_T;

#define ORTHODOX_RING_NAMES \
{TXT_ORTH_RING_1}, {TXT_ORTH_RING_2}, {TXT_ORTH_RING_3}, {TXT_ORTH_RING_4}, {TXT_ORTH_RING_5}, {TXT_ORTH_RING_6}, {TXT_ORTH_RING_7}, {TXT_ORTH_RING_8}, \
{TXT_ORTH_RING_9}, {TXT_ORTH_RING_10}, {TXT_ORTH_RING_11},{TXT_ORTH_RING_12}, {TXT_ORTH_RING_13}, {TXT_ORTH_RING_14}, {TXT_ORTH_RING_15}


#define ALERT_NAMES L"Message 1", L"Message 2"
//end

#define CLOCK_NAMES L"Clock1", L"Clock 2"

#define CLOCK_NAMES_MAT L"Clock1"
//[end]
...
typedef struct
{
    ...
    uint8       code[MMISET_SECURITY_CODE_LEN_MAX];
    uint8       code_len;                            //密码长度
}MMISET_SECURITY_CODE_T;
...
#endif
#if 0
def TORCH_SUPPORT //Bug 1248959
    MMISET_SHORTCUT_TORCH,
#endif
  //  MMISET_SHORTCUT_SETTINGS,
  //  MMISET_SHORTCUT_EXTRAS,
///	MMISET_SHORTCUT_COUNTERS,
    MMISET_SHORTCUT_MAX
...
typedef enum
{
    ...
    MMISET_SHORTCUT_ACTION_LEFT =  MMISET_SHORTCUT_ACTION_FUNCKEY_END,
...
typedef enum
{
    ...
    MMISET_RING_TYPE_HANDHOLD,
     ...
     MMISET_RING_TYPE_GAMELOFT,
#endif
#ifdef PHONE_NUMBER_VOICE
		MMISET_RING_TYPE_PHONENUM,
#endif
    #if defined(MMI_MP3_FIXED_MUSIC)
		MMISET_RING_TYPE_FIXED_MUSIC,
#endif
#ifdef SOS_KEYLONGWEB
		MMISET_RING_TYPE_SOSALARM,
#endif
...
typedef enum
{
    ...
    MMISET_IDLE_MSTYLE,         //microsoft style
...
#endif
    MMISET_KEYLOCK_10_SEC = 10000,   //10s
    MMISET_KEYLOCK_15_SEC = 15000,   //15s
    MMISET_KEYLOCK_20_SEC = 20000,   //20s
    MMISET_KEYLOCK_30_SEC = 30000,    //30s
    MMISET_KEYLOCK_40_SEC = 40000,   //40s
    MMISET_KEYLOCK_1_MIN = 60000,   //1min
    MMISET_KEYLOCK_120_SEC = 120000,   //120s
...
//2015-7-9 tangting add
typedef enum
{
  MMISET_FONT_SIZE_CONTACTS,
  MMISET_FONT_SIZE_MENU,
  MMISET_FONT_SIZE_MESSAGING
}MMISET_FONT_SIZE_TYPE_E;

typedef struct
{
   uint16                font_size_index;
}MMISET_FONT_SIZE_T;
//end
...
typedef struct
{
    ...
    uint16  num_len;
    wchar  num[MMISET_PHONE_NUM_MAX_LEN];
}MMISET_WHITELIST_ITEM_T;

typedef struct
{
    uint16 num;
    MMISET_WHITELIST_ITEM_T whitelist[MMISET_WHITELIST_MAX_NUM]; 
}MMISET_WHITELIST_T;
#endif
...
typedef enum
{
    MMISET_WHITELIST_ERROR_NONE,
    MMISET_WHITELIST_ERROR_BEYOND_MAX_NUM,
    MMISET_WHITELIST_ERROR_NUM_EMPTY,
    MMISET_WHITELIST_ERROR_SAME_NUM,
    MMISET_WHITELIST_ERROR_PARAM_NULL,
    MMISET_WHITELIST_ERROR_MAX
} MMISET_WHITELIST_ERROR_TYPE_E;
#endif
...
typedef struct
{
    MMIPB_BCD_NUMBER_T    pb_bcd;
    MMI_STRING_T          mmi_pb_name;
}MMISET_WHITELIST_NAME_NUM_ITEM_T;
#endif
...
typedef enum
{
    MMISET_NOTIFICATION_MESSAGES = 0,
    MMISET_NOTIFICATION_CALLS,
    MMISET_NOTIFICATION_ALARMS,
    MMISET_NOTIFICATION_CALENDAR,
    MMISET_NOTIFICATION_MAILS,
    MMISET_NOTIFICATION_OUTLOOK,
    MMISET_NOTIFICATION_OPERATOR,
    MMISET_NOTIFICATION_RADIO,
    MMISET_NOTIFICATION_MUSIC,
    MMISET_NOTIFICATION_OTHERS,
    MMISET_NOTIFICATION_MAX
} MMISET_NOTIFICATION_TYPE_E;

#define  MMISET_WELCOME_MAX_LEN            127
...
typedef struct 
{
	uint8  cur_auto_time_read_status;	
	uint8  cur_auto_time_quantum_mode;	
	uint8  cur_auto_time_start_time;
	uint8  cur_auto_time_end_time;
}MMI_POINTTIME_INFO_T;
typedef struct 
{
	uint8 tts_switch;
	uint8 dial_switch;
	...
	uint8 charge_switch;
	uint8  kl_switch;
}MMISET_TTS_CODE_INFO_T;
#endif

#ifdef SOS_KEYLONGWEB
#define MMISET_SOS_MAX_LEN         15
#define MMISET_SOS_SMS_MAX_LEN         50

//the information about power on password
typedef struct
{
    uint16     is_enable;                          //紧急呼叫是否开启
    uint8       sos[3][MMISET_SOS_MAX_LEN];   //紧急呼叫号码
    uint16       sos_len;                            //号码长度
    wchar		w_sms[50+1];
}MMISET_SOS_T;
#endif
...
//  Note:
/*****************************************************************************/
PUBLIC BOOLEAN MMIAPISET_FormatDateStrByDateAndMonStrEx(
                                                        uint16 year, //in
                                                        uint8 month, //in
                                                        uint8 date, //in
                                                        char symbol, //in
...
/*****************************************************************************/
//  Description : get date string for sms
//  Global resource dependence : none
//  Author:
//  Note:
/*****************************************************************************/
PUBLIC BOOLEAN MMIAPISET_FormatDateStrForSMS(
                                            uint16 year, //in
                                            uint8 month, //in
                                            uint8 date, //in
                                            char symbol, //in
...
/*****************************************************************************/
//  Description : Get alert tone name.
//  Global resource dependence :
//  Author: sunhongzhe
//  Note:
/*****************************************************************************/
...
//  Note: 
/*****************************************************************************/
PUBLIC MMISET_WHITELIST_ERROR_TYPE_E MMIAPISET_AddWhitelistFromExt(
                                                                            MMI_STRING_T * whitelist_name_ptr,
                                                                            MMIPB_BCD_NUMBER_T *pb_num_ptr      
                                                                            );
...
//  Note: 
/*****************************************************************************/
PUBLIC void MMIAPISET_AddWhitelist(
                                MMI_STRING_T mmi_pb_name,
                                MMIPB_BCD_NUMBER_T pb_bcd      
                                );
#endif                               
...
/*****************************************************************************/
//  Description : open the FDN handle window
//  Global resource dependence : 
//  Author:zhenxing
/*****************************************************************************/
...
/*****************************************************************************/
//  Description : set date display type by language
//  Global resource dependence : none
//  Author:
//  Note:
/*****************************************************************************/
...
/*****************************************************************************/
//  Description : Reset volume to low when earphone plug in
//  Global resource dependence :
//  Author: baokun.yin
//  Note:
/*****************************************************************************/
PUBLIC void MMIAPIENVSET_ReSetAllVolmue(uint32 volume);
...
/*****************************************************************************/
//  Description : IsPowerOnSecruityCodeEnable
//  Global resource dependence :
//  Author: dong.chunguang
//  Note:
/*****************************************************************************/
...
/*****************************************************************************/
//  Description : MMIAPISET_IsOpenMsgRingWin
//  Global resource dependence :
//  Author:dong.chunguang
//  Note:
/*****************************************************************************/
PUBLIC BOOLEAN MMIAPISET_IsOpenMsgRingWin(void);
PUBLIC uint8 MMIAPISET_GetCurrentFontSize(void);

typedef struct
{
    BOOLEAN is_vodafone_sim;
    BOOLEAN is_new_sim;
    BOOLEAN is_configured;
    BOOLEAN reserved;
    uint16	 setting_value;
}MMISET_VODAFONE_SETTING_SIM_T;

typedef struct
{
    MMISET_VODAFONE_SETTING_SIM_T  vodafone_sim[MN_DUAL_SYS_MAX];
    uint16 cur_sim_index;
    BOOLEAN should_auto_popup;
    BOOLEAN  new_sim_checked;
}MMISET_VODAFONE_SETTINGS_T;
//niuhuiling add lockscreen code
#define MMI_DEVICELOCKSCREEN_PWD_MIN_LEN         4
#define MMI_DEVICELOCKSCREEN_PWD_MAX_LEN         8
#define MMI_DEVICELOCKSCREEN_INIT_PWD		"0000"//	"1234"

typedef struct
{
    BOOLEAN     is_enable;                          //密码是否开启
    uint8       pwd[MMI_DEVICELOCKSCREEN_PWD_MAX_LEN];
    uint8       pwd_len;                            //密码长度
}MMISET_LOCKSCREEN_SECURITY_CODE_T;
...
/*****************************************************************************/
// 	Description : get font size for UI DIsplay
//	Global resource dependence :
//  Author:
//	Note:
/*****************************************************************************/
PUBLIC uint16 MMIAPISET_GetFontSize(void);
...
//	Note:
/*****************************************************************************/
PUBLIC void MMIAPISET_SetFontSize(GUI_FONT_T font_size);
