...
#define     MMISET_PRIVACY_PROTECT_INIT_PWD			"0000"
#define     MMISET_PRIVACY_PROTECT_BH_PWD			"1122"
/**--------------------------------------------------------------------------*
**                         TYPE AND CONSTANT                                *
**--------------------------------------------------------------------------*/
...
extern MN_DUAL_SYS_E s_cur_dual_sys;
...
PUBLIC void OpenBarSettingsWindow(void);
...
PUBLIC BOOLEAN GetStartupLockStatus(void);
#endif
#if defined(MMI_WHITELIST_SUPPORT)
