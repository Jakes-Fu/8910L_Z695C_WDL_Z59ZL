                                         ...
                                         )
{
    ...
    {
    case MMIMTV_OPEN_SCENE:
        MMIMTV_OpenCommonQueryScene(STR_CB_DELETE_CHANNEL);
        break;
                                       ...
                                       )
{
    ...
    {
    case MMIMTV_OPEN_SCENE:
        MMIMTV_OpenCommonWaitScene(STR_SIM_SEARCHING_NETWORK);
        break;
...
{
    MTV_MMI_TEXT_ID_E value = STR_LANGUAGE_CHINESE_CN;
    ...
    case MMIMTV_CHINESE_CODE:
        value = STR_LANGUAGE_CHINESE_CN;
        break;
        
    case MMIMTV_ENGLISH_CODE:
        value = STR_LANGUAGE_ENGLISH;
        break;
