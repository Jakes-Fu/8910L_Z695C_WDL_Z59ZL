...
const GUIMENU_ITEM_T menu_asp_msg_opt[] =
{
    ...
    {MMIASP_MENU_CALL_ITEM_ID,    TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_CALL,     0, 0, 0, MENU_ASP_CALL_OPT},    
#else
    {MMIASP_MENU_CALL_AUDIO_ITEM_ID,    TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_CALL,     0, 0, 0, MENU_NULL},    
#endif
    {MMIASP_MENU_MSG_ITEM_ID,     TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_REPLY,  0, 0, 0, MENU_ASP_SEND_MSG_OPT},
    {MMIASP_MENU_DELETE_ITEM_ID,  TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_DELETE,        0, 0, 0, MENU_NULL},    
    {MMIASP_MENU_MARK_ITEM_ID,    TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},STXT_SOFTKEY_MARK_MK,      0, 0, 0, MENU_ASP_MARK_OPT},    
    {MMIASP_MENU_SEND_ITEM_ID,    TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_SEND,          0, 0, 0, MENU_ASP_SEND_OPT},
    {MMIASP_MENU_SETTING_ITEM_ID, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},STXT_MAIN_SETTING,       0, 0, 0, MENU_NULL},
    {MMIASP_MENU_HELP_ITEM_ID, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_HELP,       0, 0, 0, MENU_NULL}
};
...
{
    {MMIASP_MENU_MARK_SINGLE_ITEM_ID,    TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},STXT_SOFTKEY_MARK_MK,           0, 0, 0, MENU_NULL},    
    {MMIASP_MENU_UNMARK_SINGLE_ITEM_ID,  TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_CANCEL_MARK,    0, 0, 0, MENU_NULL},
    {MMIASP_MENU_MARK_ALL_ITEM_ID,       TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_MARK_ALL,        0, 0, 0, MENU_NULL},    
    {MMIASP_MENU_UNMARK_ALL_ITEM_ID,     TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_CANCEL_MARK_ALL, 0, 0, 0, MENU_NULL}
};
...
{					 
	...
	{MMIASP_MENU_DELETE_ITEM_ID,  TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},TXT_DELETE, 0, 0, 0, MENU_NULL}, 
	//{MMIASP_MENU_RENAME_ITEM_ID, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_DELETE, 0, 0, 0, MENU_NULL	},
	{MMIASP_MENU_SEND_MMS_ITEM_ID,       TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},/*TXT_MMS*/TXT_COMM_MMS_SEND,           0, 0, 0, MENU_NULL},    
#if defined(BLUETOOTH_SUPPORT)
    {MMIASP_MENU_SEND_BLUETOOTH_ITEM_ID, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_BLUETOOTH,     0, 0, 0, MENU_NULL},
#endif        
	//{MMIASP_MENU_SEND_EMAIL_ITEM_ID, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_DELETE, 0, 0, 0, MENU_NULL	}
};
...
const GUIMENU_ITEM_T menu_asp_msg_opt[] =
{
    ...
    //{MMIASP_MENU_MSG_ITEM_ID,     TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_REPLY,  0, 0, 0, MENU_ASP_SEND_MSG_OPT},
    //{MMIASP_MENU_DELETE_ITEM_ID,  TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_DELETE,        0, 0, 0, MENU_NULL},    
    {MMIASP_MENU_MARK_ITEM_ID,    TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},STXT_SOFTKEY_MARK_MK,      IMAGE_COMMON_OPTMENU_MARK, 0, 0, MENU_ASP_MARK_OPT},    
    //{MMIASP_MENU_SEND_ITEM_ID,    TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_SEND,          0, 0, 0, MENU_ASP_SEND_OPT},
