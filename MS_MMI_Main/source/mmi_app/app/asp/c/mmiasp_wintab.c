...
#endif
	MMI_TEXT_ID_T      flag_text[ASP_SWITCH_FLAG_TYPE_NUM] = {TXT_OPEN, STR_POC_ILIST_OFF};
    uint32             i                                   = 0;
    uint32             j                                   = 0;
    uint16             cur_index                           = 0;
...
LOCAL void AppendSettingAllDropDownListData( MMIFILE_DEVICE_E *device_arrary_ptr)
{
    ...
    MMI_TEXT_ID_T  speaker_flag_text[ASP_SPEAKER_FLAG_TYPE_NUM]= {TXT_OPEN, STR_POC_ILIST_OFF};
