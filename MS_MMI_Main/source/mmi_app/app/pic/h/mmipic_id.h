...
typedef enum
{
	...
	//lijinghua add it
	MMIPIC_EDIT_MAINMENU_LABEL_CTRL_ID,
    MMIPIC_EDIT_MAINMENU_BRIGHTNESS_ID,
    MMIPIC_EDIT_MAINMENU_CONTRAST_ID,
	//lijinghua end it
    MMIPIC_EDIT_MAINMENU_RAOTATE_ID,
    //MMIPIC_EDIT_MAINMENU_ADJUST_ID,      //lijinghua delete it
    MMIPIC_EDIT_MAINMENU_EFFECT_ID,
    MMIPIC_EDIT_MAINMENU_CROP_ID,          //lijinghua add it
...
#endif
    //lijinghua add 
	MMIPIC_ADD_BUTTON_ID,
	MMIPIC_BRI_BRI_BUTTON_ID,
	MMIPIC_REMOVE_BUTTON_ID,
	MMIPIC_CONTRAST_CONTRAST_BUTTON_ID,
	MMIPIC_ROTATE_ROTATE_ID,
	MMIPIC_ROTATE_MIRROR_HORIZONTAL_ID,
	MMIPIC_ROTATE_MIRROR_VERTICAL_ID,
	MMIPIC_EDIT_EFFECT_LABEL_CTRL_ID,
    MMIPIC_EDIT_CROP_OPT_MENU_CTRL_ID,	
    //lijinghua end
