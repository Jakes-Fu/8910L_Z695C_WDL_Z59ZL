...
uint16				pic_index = 0;	  //lijinghua add for pic edit effect
LOCAL uint16  s_icon_current_index=0;  //lijinghua add for pic edit rotate
...
LOCAL BOOLEAN s_is_grayed = TRUE;      //lijinghua add for pic edit
LOCAL BOOLEAN s_is_squre_crop = FALSE;  //lijinghua add for pic crop
LOCAL BOOLEAN s_is_landsquare_crop = FALSE;//lijinghua add for pic crop
LOCAL BOOLEAN s_is_crop = FALSE;//lijinghua add for pic crop
LOCAL BOOLEAN s_is_rotate = FALSE;//lijinghua add for pic rotate
...
LOCAL BOOLEAN s_is_saved_complete = FALSE;  //lijinghua add for pic edit
...
//lijinghua add for edit  UI
#define MMIPIC_EDIT_NONE_CTRL_ID    0XFFFF
#define MMIPIC_EDIT_ROTATE_NONE_CTRL_ID    0XFFFF

LOCAL GUI_RECT_T lab_rect = {0};
LOCAL GUI_RECT_T brightness_button_rect = {0};
LOCAL GUI_RECT_T contrast_button_rect = {0};
LOCAL GUI_RECT_T rotate_button_rect = {0};
LOCAL GUI_RECT_T effect_button_rect = {0};
LOCAL GUI_RECT_T crop_button_rect = {0};

LOCAL GUI_RECT_T rotate_rotate_button_rect = {0};
LOCAL GUI_RECT_T rotate_mirror_horizontal_button_rect = {0};
LOCAL GUI_RECT_T rotate_mirror_vertical_button_rect = {0};
LOCAL GUI_RECT_T edit_lab_rect = {0};
LOCAL GUI_RECT_T effect_left_arrow_rect = {0};
LOCAL GUI_RECT_T effect_right_arrow_rect = {0};

LOCAL GUI_RECT_T plus_rect = {0};
LOCAL GUI_RECT_T img_rect = {0};
LOCAL GUI_RECT_T minus_rect = {0};

LOCAL MMI_CTRL_ID_T current_button_ctrl_id = MMIPIC_EDIT_NONE_CTRL_ID;
LOCAL MMI_CTRL_ID_T rotate_current_button_ctrl_id = MMIPIC_EDIT_ROTATE_NONE_CTRL_ID;
LOCAL const MMI_IMAGE_ID_T THEME_BRIGHTNESS_FOCUS_ON_ICON [MMITHEME_ACCENT_COLOR_MAX] =
{
	IMAG_PS_ICON_BRIGHTNESS_VIOLET,
	IMAG_PS_ICON_BRIGHTNESS_RED,
	IMAG_PS_ICON_BRIGHTNESS_YELLOW,
	IMAG_PS_ICON_BRIGHTNESS_GREEN,
	IMAG_PS_ICON_BRIGHTNESS_COPPER,
	IMAG_PS_ICON_BRIGHTNESS_BLUE	
	
};
LOCAL const MMI_IMAGE_ID_T THEME_BRIGHTNESS_DEFOCUS_ON_ICON [MMITHEME_ACCENT_COLOR_MAX] =
{
	IMAG_PS_ICON_BRIGHTNESS,
	IMAG_PS_ICON_BRIGHTNESS,
	IMAG_PS_ICON_BRIGHTNESS,
	IMAG_PS_ICON_BRIGHTNESS,
	IMAG_PS_ICON_BRIGHTNESS,
...
LOCAL const MMI_IMAGE_ID_T THEME_CONTEAST_FOCUS_ON_ICON [MMITHEME_ACCENT_COLOR_MAX] =
{
	IMAG_PS_ICON_CONTRAST_VIOLET,
	IMAG_PS_ICON_CONTRAST_RED,
	IMAG_PS_ICON_CONTRAST_YELLOW,
	IMAG_PS_ICON_CONTRAST_GREEN,
	IMAG_PS_ICON_CONTRAST_COPPER,
	IMAG_PS_ICON_CONTRAST_BLUE
	
};
LOCAL const MMI_IMAGE_ID_T THEME_CONTRAST_DEFOCUS_ON_ICON [MMITHEME_ACCENT_COLOR_MAX] =
{
	IMAG_PS_ICON_CONTRAST,
	IMAG_PS_ICON_CONTRAST,
	IMAG_PS_ICON_CONTRAST,
	IMAG_PS_ICON_CONTRAST,
	IMAG_PS_ICON_CONTRAST,
...
LOCAL const MMI_IMAGE_ID_T THEME_ROTATE_FOCUS_ON_ICON [MMITHEME_ACCENT_COLOR_MAX] =
{
	IMAG_PS_ICON_ROTATE_VIOLET,
	IMAG_PS_ICON_ROTATE_RED,
	IMAG_PS_ICON_ROTATE_YELLOW,
	IMAG_PS_ICON_ROTATE_GREEN,
	IMAG_PS_ICON_ROTATE_COPPER,
	IMAG_PS_ICON_ROTATE_BLUE	
};
LOCAL const MMI_IMAGE_ID_T THEME_ROTATE_DEFOCUS_ON_ICON [MMITHEME_ACCENT_COLOR_MAX] =
{
	IMAG_PS_ICON_ROTATE,
	IMAG_PS_ICON_ROTATE,
	IMAG_PS_ICON_ROTATE,
...
LOCAL const MMI_IMAGE_ID_T THEME_EFFECT_FOCUS_ON_ICON [MMITHEME_ACCENT_COLOR_MAX] =
{
	IMAG_PS_ICON_EFFECT_VIOLET,
	IMAG_PS_ICON_EFFECT_RED,
	IMAG_PS_ICON_EFFECT_YELLOW,
	IMAG_PS_ICON_EFFECT_GREEN,
	IMAG_PS_ICON_EFFECT_COPPER,
	IMAG_PS_ICON_EFFECT_BLUE	
};
LOCAL const MMI_IMAGE_ID_T THEME_EFFECT_DEFOCUS_ON_ICON [MMITHEME_ACCENT_COLOR_MAX] =
{
	IMAG_PS_ICON_EFFECT,
	IMAG_PS_ICON_EFFECT,
	IMAG_PS_ICON_EFFECT,
...
LOCAL const MMI_IMAGE_ID_T THEME_CROP_FOCUS_ON_ICON [MMITHEME_ACCENT_COLOR_MAX] =
{
	IMAG_PS_ICON_CROP_VIOLET,
	IMAG_PS_ICON_CROP_RED,
	IMAG_PS_ICON_CROP_YELLOW,
	IMAG_PS_ICON_CROP_GREEN,
	IMAG_PS_ICON_CROP_COPPER,
	IMAG_PS_ICON_CROP_BLUE	
	
};
LOCAL const MMI_IMAGE_ID_T THEME_CROP_DEFOCUS_ON_ICON [MMITHEME_ACCENT_COLOR_MAX] =
{
	IMAG_PS_ICON_CROP,
	IMAG_PS_ICON_CROP,
	IMAG_PS_ICON_CROP,
...
LOCAL const MMI_IMAGE_ID_T THEME_MIRROR_HORIZONTAL_FOCUS_ON_ICON [MMITHEME_ACCENT_COLOR_MAX] =
{
	IMAG_PS_ICON_ROTATE_MIRROR_HORIZONTAL_VIOLET,
	IMAG_PS_ICON_ROTATE_MIRROR_HORIZONTAL_RED,
	IMAG_PS_ICON_ROTATE_MIRROR_HORIZONTAL_YELLOW,
	IMAG_PS_ICON_ROTATE_MIRROR_HORIZONTAL_GREEN,
	IMAG_PS_ICON_ROTATE_MIRROR_HORIZONTAL_COPPER,
	IMAG_PS_ICON_ROTATE_MIRROR_HORIZONTAL_BLUE	
	
};
LOCAL const MMI_IMAGE_ID_T THEME_MIRROR_HORIZONTAL_DEFOCUS_ON_ICON [MMITHEME_ACCENT_COLOR_MAX] =
{
	IMAG_PS_ICON_ROTATE_MIRROR_HORIZONTAL,
	IMAG_PS_ICON_ROTATE_MIRROR_HORIZONTAL,
	IMAG_PS_ICON_ROTATE_MIRROR_HORIZONTAL,
	IMAG_PS_ICON_ROTATE_MIRROR_HORIZONTAL,
	IMAG_PS_ICON_ROTATE_MIRROR_HORIZONTAL,
...
LOCAL const MMI_IMAGE_ID_T THEME_MIRROR_VERTICAL_FOCUS_ON_ICON [MMITHEME_ACCENT_COLOR_MAX] =
{
	IMAG_PS_ICON_ROTATE_MIRROR_VERTICAL_VIOLET,
	IMAG_PS_ICON_ROTATE_MIRROR_VERTICAL_RED,
	IMAG_PS_ICON_ROTATE_MIRROR_VERTICAL_YELLOW,
	IMAG_PS_ICON_ROTATE_MIRROR_VERTICAL_GREEN,
	IMAG_PS_ICON_ROTATE_MIRROR_VERTICAL_COPPER,
	IMAG_PS_ICON_ROTATE_MIRROR_VERTICAL_BLUE	
	
};
LOCAL const MMI_IMAGE_ID_T THEME_MIRROR_VERTICAL_DEFOCUS_ON_ICON [MMITHEME_ACCENT_COLOR_MAX] =
{
	IMAG_PS_ICON_ROTATE_MIRROR_VERTICAL,
	IMAG_PS_ICON_ROTATE_MIRROR_VERTICAL,
	IMAG_PS_ICON_ROTATE_MIRROR_VERTICAL,
	IMAG_PS_ICON_ROTATE_MIRROR_VERTICAL,
	IMAG_PS_ICON_ROTATE_MIRROR_VERTICAL,
...
//lijinghua add
LOCAL MMI_RESULT_E  HandleBrightNessWinMsg (
                                           MMI_WIN_ID_T      win_id,
                                           MMI_MESSAGE_ID_E  msg_id, 
                                           DPARAM            param
                                           );
LOCAL MMI_RESULT_E  HandleContrastWinMsg (
                                      MMI_WIN_ID_T      win_id,
                                      MMI_MESSAGE_ID_E  msg_id, 
                                      DPARAM            param
                                      );
...
//lijinghua add for pic edit crop menu opt
LOCAL MMI_RESULT_E  HandleCropWinMsg (
                                        MMI_WIN_ID_T        win_id,
                                        MMI_MESSAGE_ID_E    msg_id, 
                                        DPARAM          param
                                        );
...
/*****************************************************************************/
// 	Description : set param of of edit main menu
//	Global resource dependence :
//  Author:lijinghua
//	Note: 
/*****************************************************************************/
LOCAL void SetMainWinParam(MMI_WIN_ID_T win_id);
...
//lijinghua add
LOCAL void InitBriAndConParam(MMI_WIN_ID_T win_id, uint8 grade,MMI_CTRL_ID_T ctrl_id);
LOCAL void InitRotateWinParam(MMI_WIN_ID_T win_id);
LOCAL void SetEffectWinParam(MMI_WIN_ID_T win_id,uint16 pic_index);
...
LOCAL void SaveCropImgFile(MMI_WIN_ID_T win_id);       //lijinghua add it for pic crop
...
//lijinghua add
LOCAL void MMIPIC_EDIT_DrawButtonCtrl(GUIOWNDRAW_INFO_T *owner_draw_ptr);
LOCAL void MMIPIC_EDIT_HandleButtons(MMI_WIN_ID_T win_id,MMI_MESSAGE_ID_E msg_id);
LOCAL void PIC_EDIT_UpdateButtonState(MMI_WIN_ID_T win_id);
LOCAL void PIC_EDIT_UpdateButtonBrightness(MMI_WIN_ID_T win_id,BOOLEAN high_light);
LOCAL void PIC_EDIT_UpdateButtonContrast(MMI_WIN_ID_T win_id,BOOLEAN high_light);
LOCAL void PIC_EDIT_UpdateButtonRotate(MMI_WIN_ID_T win_id,BOOLEAN high_light);
LOCAL void PIC_EDIT_UpdateButtonEffect(MMI_WIN_ID_T win_id,BOOLEAN high_light);
LOCAL void PIC_EDIT_UpdateButtonCrop(MMI_WIN_ID_T win_id,BOOLEAN high_light);
LOCAL void PIC_EDIT_CleanButtonState();
LOCAL void MMIPIC_EDIT_Rotate_DrawButtonCtrl(GUIOWNDRAW_INFO_T *owner_draw_ptr);
LOCAL void PIC_EDIT_Rotate_UpdateButtonState(MMI_WIN_ID_T win_id);
LOCAL void MMIPIC_EDIT_Rotate_HandleButtons(MMI_WIN_ID_T win_id,MMI_MESSAGE_ID_E msg_id);
LOCAL void PIC_EDIT_Rotate_UpdateButtonRotate(MMI_WIN_ID_T win_id,BOOLEAN high_light);
LOCAL void PIC_EDIT_Rotate_UpdateButtonMirrorVertical(MMI_WIN_ID_T win_id,BOOLEAN high_light);
LOCAL void PIC_EDIT_Rotate_UpdateButtonMirrorHorizontal(MMI_WIN_ID_T win_id,BOOLEAN high_light);
LOCAL void PIC_EDIT_Rotate_CleanButtonState();
//lijinghua end
/*---------------------------------------------------------------------------*/
/*                          CONSTANT VARIABLES                               */
/*---------------------------------------------------------------------------*/
...
WINDOW_TABLE(MMIPIC_EDITOR_MAIN_WIN_TAB) = 
{
    //CLEAR_LCD,
       ...
       WIN_SOFTKEY(TXT_NULL, STXT_SOFTKEY_SELECT_MK, TXT_COMMON_COMMON_BACK),
	    ...
	    CREATE_LABEL_CTRL(GUILABEL_ALIGN_MIDDLE,MMIPIC_EDIT_MAINMENU_LABEL_CTRL_ID),
	    ...
	    CREATE_OWNDRAW_CTRL(MMIPIC_EDIT_MAINMENU_BRIGHTNESS_ID,(uint32)MMIPIC_EDIT_DrawButtonCtrl),
	    CREATE_OWNDRAW_CTRL(MMIPIC_EDIT_MAINMENU_CONTRAST_ID,(uint32)MMIPIC_EDIT_DrawButtonCtrl),
        CREATE_OWNDRAW_CTRL(MMIPIC_EDIT_MAINMENU_RAOTATE_ID,(uint32)MMIPIC_EDIT_DrawButtonCtrl),
		CREATE_OWNDRAW_CTRL(MMIPIC_EDIT_MAINMENU_EFFECT_ID,(uint32)MMIPIC_EDIT_DrawButtonCtrl),
	    CREATE_OWNDRAW_CTRL(MMIPIC_EDIT_MAINMENU_CROP_ID,(uint32)MMIPIC_EDIT_DrawButtonCtrl),
...
WINDOW_TABLE(MMIPIC_ROTATE_WIN_TAB) = 
{
        ...
        WIN_SUPPORT_ANGLE(WIN_SUPPORT_ANGLE_CUR),
#ifndef PIC_EDIT_U200_SUPPORT
        WIN_SOFTKEY(STXT_SOFTKEY_OK_MK, TXT_NULL, TXT_PIC_UNDO),
#else
        CREATE_BUTTON_CTRL(PNULL, MMIPIC_CANCEL_CTRL_ID),
        CREATE_BUTTON_CTRL(PNULL, MMIPIC_OK_CTRL_ID),
#endif
//lijing add for edit rotate
	    CREATE_OWNDRAW_CTRL(MMIPIC_ROTATE_ROTATE_ID,(uint32)MMIPIC_EDIT_Rotate_DrawButtonCtrl),
	    CREATE_OWNDRAW_CTRL(MMIPIC_ROTATE_MIRROR_HORIZONTAL_ID,(uint32)MMIPIC_EDIT_Rotate_DrawButtonCtrl),
        CREATE_OWNDRAW_CTRL(MMIPIC_ROTATE_MIRROR_VERTICAL_ID,(uint32)MMIPIC_EDIT_Rotate_DrawButtonCtrl),
//lijinghua end
        END_WIN
};
...
//lijinghua add for pic edit 
WINDOW_TABLE(MMIPIC_EDIT_BRI_WIN_TAB) = 
{
        WIN_FUNC( (uint32)HandleBrightNessWinMsg),    
        WIN_ID( MMIPIC_EDIT_BRI_WIN_ID),
        WIN_HIDE_STATUS,
        WIN_SUPPORT_ANGLE(WIN_SUPPORT_ANGLE_CUR),
#ifndef PIC_EDIT_U200_SUPPORT
        WIN_SOFTKEY(TXT_COMMON_OK, TXT_NULL, TXT_PIC_UNDO),
        ...
        CREATE_BUTTON_CTRL(PNULL, MMIPIC_OK_CTRL_ID),
#endif
         CREATE_BUTTON_CTRL(IMAG_PS_ICON_SLIDER_MINUS,  MMIPIC_ADD_BUTTON_ID),
	     CREATE_BUTTON_CTRL(IMAG_PS_ICON_BRIGHTNESS , MMIPIC_BRI_BRI_BUTTON_ID),
         CREATE_BUTTON_CTRL(IMAG_PS_ICON_SLIDER_PLUS , MMIPIC_REMOVE_BUTTON_ID),

        END_WIN
};

WINDOW_TABLE(MMIPIC_EDIT_CONTRAST_WIN_TAB) = 
{
        WIN_FUNC( (uint32)HandleContrastWinMsg),    
        WIN_ID(MMIPIC_EDIT_CONTRAST_WIN_ID),
        WIN_HIDE_STATUS,
        WIN_SUPPORT_ANGLE(WIN_SUPPORT_ANGLE_CUR),
#ifndef PIC_EDIT_U200_SUPPORT
        WIN_SOFTKEY(TXT_COMMON_OK, TXT_NULL, TXT_PIC_UNDO),
...
#endif
        CREATE_BUTTON_CTRL(IMAG_PS_ICON_SLIDER_MINUS,  MMIPIC_ADD_BUTTON_ID),
	    CREATE_BUTTON_CTRL(IMAG_PS_ICON_CONTRAST , MMIPIC_CONTRAST_CONTRAST_BUTTON_ID),
        CREATE_BUTTON_CTRL(IMAG_PS_ICON_SLIDER_PLUS , MMIPIC_REMOVE_BUTTON_ID),
...
WINDOW_TABLE(MMIPIC_EFFECT_WIN_TAB) = 
{
        ...
        CREATE_BUTTON_CTRL(PNULL, MMIPIC_OK_CTRL_ID),
#endif
		CREATE_LABEL_CTRL(GUILABEL_ALIGN_MIDDLE,MMIPIC_EDIT_EFFECT_LABEL_CTRL_ID),
        //CREATE_ICONLIST_CTRL(MMIPIC_EDIT_EFFECT_ICONLIST_CTRL_ID),
        END_WIN
};

//lijinghua add it 
// the window for  pic editor crop window
WINDOW_TABLE(MMIPIC_CROP_WIN_TAB) = 
{
        WIN_FUNC( (uint32)HandleCropWinMsg),    
        WIN_ID(MMIPIC_EDIT_CROP_WIN_ID),
        WIN_HIDE_STATUS,
        WIN_SUPPORT_ANGLE(WIN_SUPPORT_ANGLE_CUR),
		CREATE_POPMENU_CTRL(MENU_PIC_EDIT_CROP_OPT,MMIPIC_EDIT_CROP_OPT_MENU_CTRL_ID),
		WIN_STYLE( WS_HAS_TRANSPARENT|WS_DISABLE_COMMON_BG),
		WIN_SOFTKEY(TXT_NULL,STXT_SOFTKEY_SELECT_MK,TXT_COMMON_COMMON_BACK),
        END_WIN
};
...
WINDOW_TABLE(MMIPIC_SAVE_TAB) = 
{
    ...
    WIN_TITLE(STXT_SOFTKEY_SAVE_MK),
                                            ...
                                            )
{
   ...
   //lijinghua add for pic edit
    ...
    case MSG_OPEN_WINDOW:
      ...
      // MMIPUB_OpenAlertWinByTextId(PNULL,TXT_COMMON_WAITING,TXT_NULL,IMAGE_PUBWIN_WAIT,&alert_win_id,PNULL,MMIPUB_SOFTKEY_NONE,PNULL);
            ...
            else
            {
...
#ifndef PIC_EDIT_U200_SUPPORT
                //zhuyongjing changed 
                    //GUIWIN_SetSoftkeyTextId(win_id,  STXT_SOFTKEY_SAVE_MK, TXT_NULL, STXT_RETURN, FALSE);
                    ...
                    GUIWIN_SetSoftkeyBgAlpha(win_id,65);
                ...
                //MMK_SetAtvCtrl(win_id, MMIPIC_EDIT_MAINMENU_FORM_ID);     //lijinghua modify it
				//SetMainFormGrayed(TRUE);                   //lijinghua modify it
            }
        break;
    ...
    case MSG_FULL_PAINT:
        ...
        {
            MMIPIC_DisplayImage();    
			SetMainWinParam(win_id);                 //lijinghua add it
#ifdef PIC_EDIT_U200_SUPPORT
            SetPicEditTitle(win_id, &title_txt, IMAG_PS_MAIN_TITLE_BG);
#endif
        }
    ...
    case MSG_END_FULL_PAINT:
        GUIWIN_UpdateSoftkey(win_id);//zhuyongjing add 
        break;
    ...
    case MSG_PIC_DISPLAY_IND:
        ...
        //zhuyongjing changed  
           //  MMIPIC_DisplayImage();
            ...
            //add end
			//SetMainFormGrayed(FALSE);               //lijinghua modify it
                if(!s_is_changed)
                {
...
//lijinghua add it
            ...
            if(s_is_rotate)
			{
                GUIWIN_SeSoftkeytButtonTextId(win_id, STXT_SOFTKEY_SAVE_MK, LEFT_BUTTON, FALSE);
                GUIWIN_SeSoftkeytButtonTextId(win_id, IMAGE_NULL, MIDDLE_BUTTON, FALSE);
            }else{
            ...
            //GUIWIN_SetSoftkeyTextId(win_id,  STXT_SOFTKEY_SAVE_MK, TXT_NULL, TXT_PIC_UNDO, FALSE);
//lijinghua end	
#else
...
//lijinghua modify it
        if(s_is_changed && !s_is_crop)
        {
            ...
            //SaveEditImg();
        }else if(s_is_changed && s_is_crop){
			SaveCropImgFile(win_id);
		}
//lijinghua end
        break;
#endif
    ...
    case MSG_CTL_MIDSK:
        ...
        {
		//lijinghua add it
        case MMIPIC_EDIT_MAINMENU_BRIGHTNESS_ID:
            MMK_CreateWin((uint32*)MMIPIC_EDIT_BRI_WIN_TAB, PNULL);
			break;

		case MMIPIC_EDIT_MAINMENU_CONTRAST_ID:
            MMK_CreateWin((uint32*)MMIPIC_EDIT_CONTRAST_WIN_TAB, PNULL);
			break;
//lijinghua end it
  ...
  //lijinghua change it       
     ...
     //lijinghua end it                   
        case MMIPIC_EDIT_MAINMENU_EFFECT_ID:
            ...
            break;
		case MMIPIC_EDIT_MAINMENU_CROP_ID:
            MMK_CreateWin((uint32*)MMIPIC_CROP_WIN_TAB, (ADD_DATA)s_file_info_ptr);
			break;
#ifdef PIC_EDIT_FRAME_SUPPORT    
    ...
    case MSG_CTL_CANCEL:   
        if(s_is_changed)
        {
            ...
            MMIPIC_UndoFileInfo();
            s_is_changed=FALSE;
            s_is_grayed = TRUE;                 //lijinghua add it 
            s_is_crop=FALSE;                    //lijinghua add it for pic crop
            s_is_rotate=FALSE;                   //lijinghua add it for pic rotate
#ifndef PIC_EDIT_U200_SUPPORT
//lijinghua add it
            GUIWIN_SeSoftkeytButtonTextId(win_id, TXT_COMMON_COMMON_BACK, RIGHT_BUTTON, FALSE);
            GUIWIN_SeSoftkeytButtonTextId(win_id, TXT_NULL, LEFT_BUTTON, FALSE);
...
//lijinghua end it
		...
		PIC_EDIT_CleanButtonState();        //lijinghua add it
        break;
...
//         MMK_SendMsg(win_id, msg_id, PNULL);
        break;
     //lijinghua add for edit main menu
	 case MSG_KEYUP_LEFT:
	 case MSG_KEYUP_RIGHT:
		 MMIPIC_EDIT_HandleButtons(win_id, msg_id);
         GUIWIN_UpdateSoftkey(win_id);//zhuyongjing add 
		 break;
     //lijinghua end
#ifdef TOUCH_PANEL_SUPPORT //IGNORE9527
...
//         }
        ...
        if( s_is_saved )
        {
            ...
            if(MMK_IsOpenWin(MMIPICVIEW_LIST_WIN_ID))
            {
               ...
               // MMIAPIPICVIEW_ReloadFile(); //zhuyongjing change for search quickly
                ...
                if(s_is_crop)
				{
					MMIPICCROP_GetFileInfo(&param_to_save_as_win);
                }else{
...
//                     if(MMIAPIPICVIEW_IsPicArrayFromArrayLib())
                    {
                    //lijinghua modify for pic edit complete 
                        GUIANIM_FILE_INFO_T     icon_file = {0};
                        uint16 cur_index = MMIPICVIEW_GetCurIndex(MMIPICVIEW_LIST_CTRL_ID);
                        s_is_saved_complete = TRUE; 		 //lijinghua add it
                        MMIAPIPICVIEW_ReloadFile(); 
                        MMIPICVIEW_InsertPicArray(param_to_save_as_win.full_path_wstr_ptr);
                        GUIICONLIST_SetTotalIcon(MMIPICVIEW_LIST_CTRL_ID, MMIPICVIEW_GetAllPicNum());
                        icon_file.full_path_wstr_ptr = param_to_save_as_win.full_path_wstr_ptr;
                        icon_file.full_path_wstr_len = param_to_save_as_win.full_path_wstr_len;
                        GUIICONLIST_AppendIcon(MMIPICVIEW_GetAllPicNum()-1, MMIPICVIEW_LIST_CTRL_ID, PNULL, &icon_file);
                        GUIICONLIST_SetCurIconIndex(cur_index,  MMIPICVIEW_LIST_CTRL_ID);
                    }
//                     else
//                     {
...
//                     }
		...
		MMIPICCROP_Exit();               //lijinghua add it
        ...
        s_operation_times = 0;
		PIC_EDIT_CleanButtonState();           //lijinghua end it
...
//      s_device_len         s_dir_len        not_suffix_name_len       s_ucs2_suffix_len_without_dot
        ...
        {
            MMIPUB_OpenAlertWarningWin(STR_FILE_PATH_MAXIMUM);                   
            MMK_CloseWin(win_id);
	     return result;
        }
            ...
            if (s_new_path_len <= MMIFILE_FULL_PATH_MAX_LEN)
            {
               ...
               // SCI_TRACE_LOW("HandlePicSaveAsWinMsg, disk_result=%d,free_low_word=%d",disk_result,free_low_word);
                ...
                if(disk_result)
                {
                    ...
                    {
                        MMIPUB_OpenQueryWinByTextId(STR_FILE_EXIST_QUERY,IMAGE_PUBWIN_QUERY,PNULL,PNULL);
                    }
                }
                else
                {
                                        ...
                                        )
{
    ...
    case MSG_OPEN_WINDOW:
        ...
        GUIWIN_SeSoftkeytButtonTextId(win_id, TXT_NULL, LEFT_BUTTON, FALSE);
        GUIWIN_SeSoftkeytButtonTextId(win_id, STXT_SOFTKEY_APPLY_MK, MIDDLE_BUTTON, FALSE);
        GUIWIN_SetSoftkeyBgAlpha(win_id,65);
        GUIWIN_SetSoftkeyStyle(win_id,MMITHEME_GetCurThemeFontColor(MMI_THEME_SOFTKEY_FONT),GUI_SOFTKEY_BG_COLOR_ONLY,MMI_BLACK_COLOR,0);
        ...
        s_icon_index=0;
#endif
		InitRotateWinParam(win_id);           //lijinghua add it
        s_is_grayed = TRUE;//zhuyongjing add for Bug 487889 
        break;
    ...
    case MSG_LOSE_FOCUS:
        switch(MMK_GetActiveCtrlId(win_id))
        {
        case MMIPIC_ROTATE_ROTATE_ID:
            if(s_icon_index == MMI_ROTATION_DEGREE_90)
            {
            ...
            break;
        case MMIPIC_ROTATE_MIRROR_HORIZONTAL_ID:
            if(s_icon_index!=MMI_ROTATION_DEGREE_MIRROR)
            {
                s_icon_index = MMI_ROTATION_DEGREE_MIRROR;
            }
            else
            ...
            break;
        case MMIPIC_ROTATE_MIRROR_VERTICAL_ID:
            if(s_icon_index!=MMI_ROTATION_DEGREE_VERTICAL_MIRROR)
            {
                s_icon_index = MMI_ROTATION_DEGREE_VERTICAL_MIRROR;
            }
            else
            {
                s_icon_index = MMI_ROTATION_DEGREE_90;
...
#endif //TOUCH_PANEL_SUPPORT //IGNORE9527
#endif
//lijinghua modify for pic rotate
    case MSG_APP_OK:
    case MSG_CTL_OK:
    //case MSG_APP_WEB:
		if(!s_is_grayed)
		{
			...
			if(s_icon_current_index<MMI_ROTATION_DEGREE_VERTICAL_MIRROR)
			{
				if(!MMIPIC_GetRotatedImageData(s_icon_current_index))
				{
			...
			{
				if(!MMIPIC_GetVerticaledMirrorImageData(s_icon_current_index))
				{
					MMIPUB_OpenAlertWinByTextId(PNULL,TXT_ERROR_OCCUR,TXT_NULL,IMAGE_PUBWIN_WARNING,&error_alert_id,PNULL,MMIPUB_SOFTKEY_ONE,PNULL);				
					MMIPIC_ExitFromPicEditor(); 
					return (result);
	...
	case MSG_KEYUP_WEB:
		...
		{
        	case MMIPIC_ROTATE_ROTATE_ID:
				if(s_icon_index<=MMI_ROTATION_DEGREE_270)
				{
					if( !MMIPIC_AppendRotatePreviewImageData(s_icon_index) )
					{
					...
					s_icon_current_index = s_icon_index;
					s_icon_index++;
			...
			case MMIPIC_ROTATE_MIRROR_VERTICAL_ID:
				...
				{
					s_icon_index = MMI_ROTATION_DEGREE_VERTICAL_MIRROR;
					if( !MMIPIC_AppendVerticalMirrorPreviewImageData(s_icon_index) )
					{
						MMIPIC_FreeRotatedPreviewImage();
						MMIPUB_OpenAlertWinByTextId(PNULL,TXT_ERROR_OCCUR,TXT_NULL,IMAGE_PUBWIN_WARNING,&error_alert_id,PNULL,MMIPUB_SOFTKEY_ONE,PNULL);				
						MMIPIC_ExitFromPicEditor(); 
    ...
    case MSG_CTL_CANCEL:
        MMK_CloseWin(win_id);
		PIC_EDIT_Rotate_CleanButtonState();             //lijinghua add it
		s_is_grayed = TRUE;
        break;
   //lijinghua modift end  
   //lijinghua delete it   
    /*case MSG_APP_UP:
...
//lijinghua end
    ...
    case MSG_TP_PRESS_DOWN:
        ...
        break;
#endif //TOUCH_PANEL_SUPPORT //IGNORE9527
	//lijinghua add for edit rotate menu
	case MSG_KEYUP_LEFT:
	case MSG_KEYUP_RIGHT:
		MMIPIC_EDIT_Rotate_HandleButtons(win_id, msg_id);
		break;
	//lijinghua end
    case MSG_CLOSE_WINDOW:
        MMIPIC_FreeRotatedPreviewImage();
                                          ...
                                          )
{
    ...
    case MSG_CTL_ICONLIST_APPEND_TEXT:
        ...
        icon_list.softkey_id[0] = STXT_SOFTKEY_SELECT_MK;
...
{   
    ...
    case MSG_OPEN_WINDOW:
        ...
        s_bright_bar.total = 1;
	    s_bright_bar.focus_item = 0;
        s_bright_bar.win_id = win_id;
        s_bright_bar.group[0].grade = 4;
        s_bright_bar.group[0].total_level = 8;
        InitBriAndConParam(win_id,s_bright_bar.group[0].grade,MMIPIC_BRI_BRI_BUTTON_ID);
        break;
...
{   
    ...
    case MSG_OPEN_WINDOW:
        ...
        s_bright_bar.group[1].grade = 4;
        s_bright_bar.group[1].total_level = 8;
        InitBriAndConParam(win_id,s_bright_bar.group[1].grade,MMIPIC_CONTRAST_CONTRAST_BUTTON_ID);
        break;
                                        ...
                                        )
{
    ...
    {
        STR_PHOTO_EFFECT_GRAYSCALE,
        STR_PHOTO_EFFECT_SEPIA,
        STR_PHOTO_EFFECT_SHARPEN_EXT01,
        STR_PHOTO_EFFECT_SMOOTH_EXT01,
        STR_PHOTO_EFFECT_DILATION_EXT01,
        STR_PHOTO_EFFECT_EMBOSSMENT_EXT01,
        STR_PHOTO_EFFECT_EXPOSURE_EXT01,
        STR_PHOTO_EFFECT_NEGATIVE_EXT01,
        STR_PHOTO_EFFECT_MEDIAN_EXT01
    };
    ...
    //uint16              pic_index = 0;       //lijinghua delete it
    GUIANIM_DATA_INFO_T data_info = {0};
    GUIICONLIST_DISP_T  icon_text = {0};
    MMI_STRING_T        title_txt = {0};
	...
	//lijinghua add 
		GUIWIN_SetSoftkeyBtnGray(win_id,1,TRUE);
		SetEffectWinParam(win_id,pic_index);
	//lijinghua end
        MMIPIC_CopyOrgImgDataToOutputImgData();
#ifndef PIC_EDIT_U200_SUPPORT
        //GUIICONLIST_SetDispCustomerSoftkey(iconctrl_id, TRUE);    //lijinghua delete it
#else
        ...
        //MMK_SetAtvCtrl(win_id, iconctrl_id);    //lijinghua delete it
        //GUIICONLIST_SetCurIconIndex(pic_index, iconctrl_id);   //lijinghua delete it
        break;
        
    case MSG_FULL_PAINT:
        MMIPIC_DisplayOutputImage(win_id, msg_id);
		SetEffectWinParam(win_id,pic_index);   //lijignhua add it
#ifdef PIC_EDIT_U200_SUPPORT
        MMI_GetLabelTextByLang(TXT_PIC_EFFECT_TITLE, &title_txt);
        SetPicEditTitle(win_id, &title_txt, IMAG_PS_EFFECT_BG);
#endif
...
//lijinghua add and modify it
    ...
    case MSG_KEYDOWN_LEFT:
	    ...
	    GUIRES_DisplayImg(PNULL,
							&effect_left_arrow_rect,
							PNULL,
							win_id,
							IMAGE_EFFECT_LEFTDOWNARROW,
							(const GUI_LCD_DEV_INFO *)MMITHEME_GetDefaultLcdDev());
		break;
	case MSG_KEYDOWN_RIGHT:
		
	    GUIRES_DisplayImg(PNULL,
							&effect_right_arrow_rect,
							PNULL,
							win_id,
							IMAGE_EFFECT_RIGHTDOWNARROW,
							(const GUI_LCD_DEV_INFO *)MMITHEME_GetDefaultLcdDev());
		break;
    //case MSG_APP_WEB:
    //case MSG_CTL_MIDSK:
    ...
    case MSG_KEYUP_LEFT:
	    GUIRES_DisplayImg(PNULL,
							...
							PNULL,
							win_id,
							IMAGE_EFFECT_LEFTUPARROW,
							(const GUI_LCD_DEV_INFO *)MMITHEME_GetDefaultLcdDev());
        if(0 == pic_index)
        {
             pic_index=MMI_PIC_EFFECT_DENOISE;
        	 if(!MMIPIC_GetEffectImage((MMI_PIC_EFFECT_E)pic_index))
        	 {
            	 MMIPUB_OpenAlertWinByTextId(PNULL,TXT_ERROR_OCCUR,TXT_NULL,IMAGE_PUBWIN_WARNING,&error_alert_id,PNULL,MMIPUB_SOFTKEY_ONE,PNULL);                
            	 MMIPIC_ExitFromPicEditor(); 
...
//         break;
    ...
    case MSG_CLOSE_WINDOW:
		//s_is_grayed = FALSE;           //lijinghua add it
		pic_index = 0;
        break;
...
PUBLIC void MMIPIC_ExitFromPicEditor(void)
{
    ...
    if(MMK_IsOpenWin(MMIPIC_EDIT_SAVE_WIN_ID))
    {
        MMK_CloseWin(MMIPIC_EDIT_SAVE_WIN_ID);
    }
	...
	if(MMK_IsOpenWin(MMIPIC_EDIT_BRI_WIN_ID))
    {
        MMK_CloseWin(MMIPIC_EDIT_BRI_WIN_ID);
    }
	if(MMK_IsOpenWin(MMIPIC_EDIT_CONTRAST_WIN_ID))
    {
        MMK_CloseWin(MMIPIC_EDIT_CONTRAST_WIN_ID);
    } 
	if(MMK_IsOpenWin(MMIPIC_EDIT_CROP_WIN_ID))
    {
        MMK_CloseWin(MMIPIC_EDIT_CROP_WIN_ID);
    } 	
...
//lijinghua add for pic edit crop menu opt
PUBLIC  MMI_RESULT_E HandleCropWinMsg(
                                       MMI_WIN_ID_T        win_id,   //in
                                       MMI_MESSAGE_ID_E    msg_id,  //in  
                                       DPARAM              param    //in
                                       )
{
		...
		MMI_RESULT_E		result = MMI_RESULT_TRUE;
		MMI_CTRL_ID_T		ctrl_id = MMIPIC_EDIT_CROP_OPT_MENU_CTRL_ID;
		MMI_MENU_ID_T		menu_id = 0;
		MMI_MENU_GROUP_ID_T group_id = 0;
		...
		uint16	lcd_width = 0;
		uint16	lcd_height = 0;
	        static PIC_EDIT_FILE_INFO_T * s_crop_file_info_ptr=PNULL;
                MMI_PIC_ERROR_TYPE_E picresult = MMI_PIC_SUCCESS;
                wchar crop_file[MMIFILE_FILE_NAME_MAX_LEN+1] = L"D:/photos/PICCROP/temp_crop_file.jpg";
                s_crop_file_info_ptr = (PIC_EDIT_FILE_INFO_T*)MMK_GetWinAddDataPtr(win_id);
		switch (msg_id)
		{
		case MSG_OPEN_WINDOW:
			//s_is_crop=TRUE;                                 //lijinghua add it for pic crop
			GUIMENU_SetPopMenuCentered(ctrl_id, TRUE);
			MMK_SetAtvCtrl(win_id,ctrl_id);
                        if(MMIPIC_IsPictureChanged()){
                            if(MMIAPIFMM_IsFileExist(crop_file,MMIAPICOM_Wstrlen(crop_file)))
                            {
                                MMIAPIFMM_DeleteFileSyn(crop_file,MMIAPICOM_Wstrlen(crop_file));        
                            }
                            picresult = MMIPIC_SaveAsForCrop(crop_file, MMIAPICOM_Wstrlen(crop_file));
                            if(MMI_PIC_SUCCESS != picresult){
                                SCI_TRACE_LOW("HandleCropWinMsg : result = %d",picresult);
                                MMIPIC_ShowMsg(picresult);
                                MMK_CloseWin(win_id);
                            }
                        }
			break;
		...
		switch (menu_id)
		{
		 case ID_PIC_EDIT_PORTRAIT:
			 if(s_crop_file_info_ptr)
			 {
                            s_is_crop=TRUE;  
			    crop_src.crop_type=MMIPIC_CROP_DEFAULT_SAVE;
                            if(MMIPIC_IsPictureChanged()){
				crop_src.full_path_ptr = crop_file;
				crop_src.full_path_len = MMIAPICOM_Wstrlen(crop_file);
                            }else{
				crop_src.full_path_ptr = (wchar*)s_crop_file_info_ptr->full_path_wstr_ptr;
				crop_src.full_path_len = s_crop_file_info_ptr->full_path_wstr_len;
                            }
		   ...
		   break;
		 case ID_PIC_EDIT_SQUARE:
			 s_is_squre_crop = TRUE;
			 if(s_crop_file_info_ptr)
			 {
                            s_is_crop=TRUE;  
			    crop_src.crop_type=MMIPIC_CROP_DEFAULT_SAVE;
		 	...
		 	break;
			case ID_PIC_EDIT_LANDSCAPE:
				s_is_landsquare_crop = TRUE;
				if(s_crop_file_info_ptr)
				{
                            s_is_crop=TRUE;  
				   crop_src.crop_type=MMIPIC_CROP_DEFAULT_SAVE;
...
PUBLIC void MMIPICCROP_RecordChangedTimes(void)
{
    if(!s_is_changed)
    {
        s_is_changed=TRUE;
...
LOCAL void SetMainWinParam(MMI_WIN_ID_T win_id)
{
	...
	box.bottom = box.top + 52;
	LCD_FillArgbRect(MMITHEME_GetDefaultLcdDev(),box,MMI_BLACK_COLOR,255 * 35 / 100);

	lab_rect.left = rect.left + 6;
	lab_rect.top = rect.top + 3;
	lab_rect.right = rect.right -6;
	lab_rect.bottom = lab_rect.top + 20;
	
	GUILABEL_SetFont(MMIPIC_EDIT_MAINMENU_LABEL_CTRL_ID,MMI_DEFAULT_SMALL_FONT,MMI_WHITE_COLOR);
	GUILABEL_SetRect(MMIPIC_EDIT_MAINMENU_LABEL_CTRL_ID, &lab_rect, FALSE);
	GUILABEL_SetTextById(MMIPIC_EDIT_MAINMENU_LABEL_CTRL_ID, STR_PHOTO_EDIT_BRIGHTNESS_EXT01,FALSE);
	
	brightness_button_rect.left = rect.left + 56;
	brightness_button_rect.top = lab_rect.bottom + 3;
	brightness_button_rect.right = brightness_button_rect.left + 24;
	brightness_button_rect.bottom = brightness_button_rect.top + 24;
	
	contrast_button_rect.left = brightness_button_rect.right + 4;
	contrast_button_rect.top = brightness_button_rect.top;
	contrast_button_rect.right = contrast_button_rect.left + 24;
	contrast_button_rect.bottom = brightness_button_rect.bottom;
	
	rotate_button_rect.left = contrast_button_rect.right + 4;
	rotate_button_rect.top = brightness_button_rect.top;
	rotate_button_rect.right = rotate_button_rect.left + 24;
	rotate_button_rect.bottom = brightness_button_rect.bottom;
	
	effect_button_rect.left = rotate_button_rect.right + 4;
	effect_button_rect.top = brightness_button_rect.top;
	effect_button_rect.right = effect_button_rect.left + 24;
	effect_button_rect.bottom = brightness_button_rect.bottom;
	
	crop_button_rect.left = effect_button_rect.right + 4;
	crop_button_rect.top = brightness_button_rect.top;
	crop_button_rect.right = crop_button_rect.left + 24;
	crop_button_rect.bottom = brightness_button_rect.bottom;
...
LOCAL void InitRotateWinParam(MMI_WIN_ID_T win_id)
{
	...
	box.top =  rect.top;
	box.right = rect.right;
	box.bottom = box.top + 28;
	LCD_FillArgbRect(MMITHEME_GetDefaultLcdDev(),box,MMI_BLACK_COLOR,255 * 35 / 100);

	rotate_rotate_button_rect.left = rect.left + 80;
	rotate_rotate_button_rect.top = rect.top + 2;
	rotate_rotate_button_rect.right = rotate_rotate_button_rect.left + 24;
	rotate_rotate_button_rect.bottom = rotate_rotate_button_rect.top + 24;
	
	rotate_mirror_horizontal_button_rect.left = rotate_rotate_button_rect.right + 4;
	rotate_mirror_horizontal_button_rect.top = rotate_rotate_button_rect.top;
	rotate_mirror_horizontal_button_rect.right = rotate_mirror_horizontal_button_rect.left + 24;
	rotate_mirror_horizontal_button_rect.bottom = rotate_rotate_button_rect.bottom;
	
	rotate_mirror_vertical_button_rect.left = rotate_mirror_horizontal_button_rect.right + 4;
	rotate_mirror_vertical_button_rect.top = rotate_rotate_button_rect.top;
	rotate_mirror_vertical_button_rect.right = rotate_mirror_vertical_button_rect.left + 24;
	rotate_mirror_vertical_button_rect.bottom = rotate_rotate_button_rect.bottom;
}

LOCAL void InitBriAndConParam(MMI_WIN_ID_T win_id,uint8 grade,MMI_CTRL_ID_T ctrl_id)
{
    GUI_RECT_T      form_rect   = MMITHEME_GetFullScreenRectEx(win_id);
    GUI_BG_T            bg          = {0};
    GUI_BG_DISPLAY_T bg_display = {0};
	GUI_RECT_T box = {0};
	GUI_RECT_T box1 = {0};
	
	box.left = form_rect.left;
	box.top =  form_rect.top;
	box.right = form_rect.left + 30 * grade;
	box.bottom = form_rect.top + 28;
	...
	box1.left = box.right;
	box1.top =  form_rect.top;
	box1.right = form_rect.right;
	box1.bottom = form_rect.top + 28;
	LCD_FillArgbRect(MMITHEME_GetDefaultLcdDev(),box1,MMI_BLACK_COLOR,255 * 50 / 100);
	
	plus_rect.left = form_rect.left;
	plus_rect.right = plus_rect.left + 28;
	plus_rect.top = form_rect.top;
	plus_rect.bottom = plus_rect.top + 28;
	GUIBUTTON_SetRect(MMIPIC_ADD_BUTTON_ID,&plus_rect);
	
	img_rect.left = form_rect.left + 108;
	img_rect.right = img_rect.left + 24;
	img_rect.top = form_rect.top + 2;
	img_rect.bottom = img_rect.top + 24;
	GUIBUTTON_SetRect(ctrl_id,&img_rect);
	
	
	minus_rect.left = form_rect.right + 1 - 28;
	minus_rect.right = form_rect.right;
	minus_rect.top = form_rect.top;
	minus_rect.bottom = minus_rect.top + 28;
	GUIBUTTON_SetRect(MMIPIC_REMOVE_BUTTON_ID,&minus_rect);
}
LOCAL void SetEffectWinParam(MMI_WIN_ID_T win_id,uint16 pic_index)
{
	GUI_RECT_T		rect   = MMITHEME_GetFullScreenRectEx(win_id);
	...
	uint16 left_icon_height = 0;
	uint16 right_icon_width = 0;
	uint16 right_icon_height = 0;
    MMI_TEXT_ID_T       txt_id[MMI_PIC_EFFECT_MAX]= 
    {   
        STR_PHOTO_EFFECT_GRAYSCALE,
        STR_PHOTO_EFFECT_SEPIA,
	...
	box.top =  rect.top;
	box.right = rect.right;
	box.bottom = box.top + 24;
	LCD_FillArgbRect(MMITHEME_GetDefaultLcdDev(),box,MMI_BLACK_COLOR,255 * 35 / 100);

	edit_lab_rect.left = rect.left;
	edit_lab_rect.top = rect.top + 4;
	edit_lab_rect.right = rect.right;
	edit_lab_rect.bottom = box.bottom;
	
	GUILABEL_SetFont(MMIPIC_EDIT_EFFECT_LABEL_CTRL_ID,MMI_DEFAULT_SMALL_FONT,MMI_WHITE_COLOR);
	GUILABEL_SetRect(MMIPIC_EDIT_EFFECT_LABEL_CTRL_ID, &edit_lab_rect, FALSE);
	GUILABEL_SetTextById(MMIPIC_EDIT_EFFECT_LABEL_CTRL_ID, txt_id[pic_index],FALSE);
	
	GUIRES_GetImgWidthHeight(&left_icon_width,&left_icon_height, IMAGE_EFFECT_LEFTUPARROW, win_id);
	GUIRES_GetImgWidthHeight(&right_icon_width,&right_icon_height, IMAGE_EFFECT_RIGHTUPARROW, win_id);
	
	effect_left_arrow_rect.left = rect.left +6;
	effect_left_arrow_rect.right = effect_left_arrow_rect.left + left_icon_width;
	effect_left_arrow_rect.top = rect.top + 5;
	effect_left_arrow_rect.bottom = effect_left_arrow_rect.top + 14;

	effect_right_arrow_rect.right = rect.right + 1 - 6;
	effect_right_arrow_rect.left = effect_right_arrow_rect.right - right_icon_width;
	effect_right_arrow_rect.top = effect_left_arrow_rect.top;
	effect_right_arrow_rect.bottom = effect_left_arrow_rect.bottom;
...
LOCAL void SetCancelOkButtonParam(MMI_WIN_ID_T win_id, MMI_CTRL_ID_T ctr1_id, MMI_CTRL_ID_T ctr2_id, BOOLEAN is_main_win)
{
    ...
    { 
        ...
        MMI_GetLabelTextByLang(STXT_SOFTKEY_SAVE_MK, &str_data);
    ...
    if(ctr1_id > 0)
    {
        ...
        if(is_main_win)
        {
            ...
            GUIBUTTON_SetTextId(ctr1_id, STXT_SOFTKEY_SAVE_MK);
        }
        else
        {
                                        ...
                                        DPARAM param )
{
    ...
    case MSG_OPEN_WINDOW:
       ...
       //添加list选项
       MMIAPISET_AppendListItemByTextId(TXT_COMM_FONT_BIG, STXT_SOFTKEY_OK_MK, ctrl_id, GUIITEM_STYLE_ONE_LINE_RADIO );
...
LOCAL void SaveImgFile(MMI_WIN_ID_T win_id, BOOLEAN is_overwrite)
{
    ...
    case MMI_PIC_SUCCESS:
        ...
        s_is_saved = TRUE;
        MMK_CloseWin(win_id);
        //MMK_CloseWin(MMIPIC_EDIT_MAIN_WIN_ID);//保存就直接退出        //lijinghua delete it
        //MMIPIC_ShowMsg(pic_result);
        break;
...
LOCAL void SaveCropImgFile(MMI_WIN_ID_T win_id)
{

	MMI_PICCROP_ERROR_TYPE_E err_type = MMI_PICCROP_ERR_EXIT;
	MMIPICCROP_INFO_T* crop_info_ptr = PNULL;

     //zhuyongjing add for back from crop,then goto others such as effect, bright...
    MMIPICCROP_CopyOutputImgDataToCropData();
    //add end
    crop_info_ptr = MMIPICCROP_GetCropInfoPtr();
...
LOCAL void MMIPIC_EDIT_DrawButtonCtrl(GUIOWNDRAW_INFO_T *owner_draw_ptr)
{
    PIC_EDIT_UpdateButtonState(owner_draw_ptr->win_handle);
}
...
LOCAL void MMIPIC_EDIT_HandleButtons(MMI_WIN_ID_T win_id,MMI_MESSAGE_ID_E msg_id)
{
    ...
    {
        case MSG_KEYUP_LEFT:
            if(current_button_ctrl_id == MMIPIC_EDIT_MAINMENU_CROP_ID)
            {
                current_button_ctrl_id = MMIPIC_EDIT_MAINMENU_EFFECT_ID;
            }
            else if(current_button_ctrl_id == MMIPIC_EDIT_MAINMENU_EFFECT_ID)
            {
                current_button_ctrl_id = MMIPIC_EDIT_MAINMENU_RAOTATE_ID;
            }
			else if(current_button_ctrl_id == MMIPIC_EDIT_MAINMENU_RAOTATE_ID)
            {
                current_button_ctrl_id = MMIPIC_EDIT_MAINMENU_CONTRAST_ID;
            }
			else if(current_button_ctrl_id == MMIPIC_EDIT_MAINMENU_CONTRAST_ID)
            {
                current_button_ctrl_id = MMIPIC_EDIT_MAINMENU_BRIGHTNESS_ID;
            }
            break;
        case MSG_KEYUP_RIGHT:
            if(current_button_ctrl_id == MMIPIC_EDIT_MAINMENU_BRIGHTNESS_ID)
            {
                current_button_ctrl_id = MMIPIC_EDIT_MAINMENU_CONTRAST_ID;
            }
            else if(current_button_ctrl_id == MMIPIC_EDIT_MAINMENU_CONTRAST_ID)
            ...
            {
                current_button_ctrl_id = MMIPIC_EDIT_MAINMENU_CROP_ID;
            }
            break;
        default:
            break;
    }
    MMK_SetAtvCtrl(win_id,current_button_ctrl_id);
    PIC_EDIT_UpdateButtonState(win_id);
}

LOCAL void PIC_EDIT_UpdateButtonState(MMI_WIN_ID_T win_id)
{
        if(current_button_ctrl_id == MMIPIC_EDIT_NONE_CTRL_ID)
        {
            current_button_ctrl_id = MMIPIC_EDIT_MAINMENU_BRIGHTNESS_ID;
            MMK_SetAtvCtrl(win_id,current_button_ctrl_id);
        }
        MMIPIC_DisplayImage();    
        SetMainWinParam(win_id); 
        PIC_EDIT_UpdateButtonBrightness(win_id,current_button_ctrl_id==MMIPIC_EDIT_MAINMENU_BRIGHTNESS_ID);
        PIC_EDIT_UpdateButtonContrast(win_id,current_button_ctrl_id==MMIPIC_EDIT_MAINMENU_CONTRAST_ID);
        PIC_EDIT_UpdateButtonRotate(win_id,current_button_ctrl_id==MMIPIC_EDIT_MAINMENU_RAOTATE_ID);
        PIC_EDIT_UpdateButtonEffect(win_id,current_button_ctrl_id==MMIPIC_EDIT_MAINMENU_EFFECT_ID);
        PIC_EDIT_UpdateButtonCrop(win_id,current_button_ctrl_id==MMIPIC_EDIT_MAINMENU_CROP_ID);
}
...
LOCAL void PIC_EDIT_UpdateButtonBrightness(MMI_WIN_ID_T win_id,BOOLEAN high_light)
{
    ...
    bg_display.display_rect = brightness_button_rect;
    bg_display.rect = brightness_button_rect;
    bg_display.win_handle = MMK_ConvertIdToHandle(win_id);

    if(high_light)
    {
        img_id = THEME_BRIGHTNESS_FOCUS_ON_ICON[theme_index];
	    GUILABEL_SetTextById(MMIPIC_EDIT_MAINMENU_LABEL_CTRL_ID, STR_PHOTO_EDIT_BRIGHTNESS_EXT01,TRUE);
	    GUIRES_DisplayImg(PNULL,
							&brightness_button_rect,
							PNULL,
							win_id,
							img_id,
							(const GUI_LCD_DEV_INFO *)MMITHEME_GetDefaultLcdDev());
    ...
    {
	    img_id = THEME_BRIGHTNESS_DEFOCUS_ON_ICON[theme_index];
	    GUIRES_DisplayImg(PNULL,
							&brightness_button_rect,
							PNULL,
							win_id,
...
LOCAL void PIC_EDIT_UpdateButtonContrast(MMI_WIN_ID_T win_id,BOOLEAN high_light)
{
    ...
    bg_ptr.bg_type = GUI_BG_COLOR;
    bg_display.display_rect = contrast_button_rect;
    bg_display.rect = contrast_button_rect;
    bg_display.win_handle = MMK_ConvertIdToHandle(win_id);

    if(high_light)
    {
	    img_id = THEME_CONTEAST_FOCUS_ON_ICON[theme_index];
	    GUILABEL_SetTextById(MMIPIC_EDIT_MAINMENU_LABEL_CTRL_ID, STR_PHOTO_EDIT_CONTRAST_EXT01,TRUE);
	    GUIRES_DisplayImg(PNULL,
							&contrast_button_rect,
							PNULL,
							win_id,
							img_id,
							(const GUI_LCD_DEV_INFO *)MMITHEME_GetDefaultLcdDev());
    ...
    {
	    img_id = THEME_CONTRAST_DEFOCUS_ON_ICON[theme_index];
	    GUIRES_DisplayImg(PNULL,
							&contrast_button_rect,
							PNULL,
							win_id,
...
LOCAL void PIC_EDIT_UpdateButtonRotate(MMI_WIN_ID_T win_id,BOOLEAN high_light)
{
    ...
    bg_ptr.bg_type = GUI_BG_COLOR;
    bg_display.display_rect = rotate_button_rect;
    bg_display.rect = rotate_button_rect;
    bg_display.win_handle = MMK_ConvertIdToHandle(win_id);

    if(high_light)
    {
	    img_id = THEME_ROTATE_FOCUS_ON_ICON[theme_index];
	    GUILABEL_SetTextById(MMIPIC_EDIT_MAINMENU_LABEL_CTRL_ID, STR_PHOTO_EDIT_ROTATE_EXT01,TRUE);
	    GUIRES_DisplayImg(PNULL,
							&rotate_button_rect,
							PNULL,
							win_id,
    ...
    {
	    img_id = THEME_ROTATE_DEFOCUS_ON_ICON[theme_index];
	    GUIRES_DisplayImg(PNULL,
							&rotate_button_rect,
							PNULL,
							win_id,
...
LOCAL void PIC_EDIT_UpdateButtonEffect(MMI_WIN_ID_T win_id,BOOLEAN high_light)
{
    ...
    bg_ptr.bg_type = GUI_BG_COLOR;
    bg_display.display_rect = effect_button_rect;
    bg_display.rect = effect_button_rect;
    bg_display.win_handle = MMK_ConvertIdToHandle(win_id);

    if(high_light)
    {
	    img_id = THEME_EFFECT_FOCUS_ON_ICON[theme_index];
	    GUILABEL_SetTextById(MMIPIC_EDIT_MAINMENU_LABEL_CTRL_ID, STR_PHOTO_EDIT_EFFECT_EXT01,TRUE);
	    GUIRES_DisplayImg(PNULL,
							&effect_button_rect,
							PNULL,
							win_id,
    ...
    {
	    img_id = THEME_EFFECT_DEFOCUS_ON_ICON[theme_index];
	    GUIRES_DisplayImg(PNULL,
							&effect_button_rect,
							PNULL,
							win_id,
...
LOCAL void PIC_EDIT_UpdateButtonCrop(MMI_WIN_ID_T win_id,BOOLEAN high_light)
{
    ...
    bg_ptr.bg_type = GUI_BG_COLOR;
    bg_display.display_rect = crop_button_rect;
    bg_display.rect = crop_button_rect;
    bg_display.win_handle = MMK_ConvertIdToHandle(win_id);

    if(high_light)
    {
	    img_id = THEME_CROP_FOCUS_ON_ICON[theme_index];
	    GUILABEL_SetTextById(MMIPIC_EDIT_MAINMENU_LABEL_CTRL_ID, STR_PHOTO_EDIT_CROP_EXT01,TRUE);
	    GUIRES_DisplayImg(PNULL,
							&crop_button_rect,
							PNULL,
							win_id,
    ...
    {
	    img_id = THEME_CROP_DEFOCUS_ON_ICON[theme_index];
	    GUIRES_DisplayImg(PNULL,
							&crop_button_rect,
							PNULL,
							win_id,
...
LOCAL void PIC_EDIT_CleanButtonState()
{
	current_button_ctrl_id = MMIPIC_EDIT_NONE_CTRL_ID;

}

LOCAL void MMIPIC_EDIT_Rotate_DrawButtonCtrl(GUIOWNDRAW_INFO_T *owner_draw_ptr)
{
    PIC_EDIT_Rotate_UpdateButtonState(owner_draw_ptr->win_handle);
}
...
LOCAL void MMIPIC_EDIT_Rotate_HandleButtons(MMI_WIN_ID_T win_id,MMI_MESSAGE_ID_E msg_id)
{
    ...
    {
        case MSG_KEYUP_LEFT:
            if(rotate_current_button_ctrl_id == MMIPIC_ROTATE_MIRROR_VERTICAL_ID)
            {
                rotate_current_button_ctrl_id = MMIPIC_ROTATE_MIRROR_HORIZONTAL_ID;
            }
            else if(rotate_current_button_ctrl_id == MMIPIC_ROTATE_MIRROR_HORIZONTAL_ID)
            {
                rotate_current_button_ctrl_id = MMIPIC_ROTATE_ROTATE_ID;
            }
            break;
        case MSG_KEYUP_RIGHT:
            if(rotate_current_button_ctrl_id == MMIPIC_ROTATE_ROTATE_ID)
            {
                rotate_current_button_ctrl_id = MMIPIC_ROTATE_MIRROR_HORIZONTAL_ID;
            }
            else if(rotate_current_button_ctrl_id == MMIPIC_ROTATE_MIRROR_HORIZONTAL_ID)
            {
                rotate_current_button_ctrl_id = MMIPIC_ROTATE_MIRROR_VERTICAL_ID;
            }
            break;
        default:
            break;
    }
    MMK_SetAtvCtrl(win_id,rotate_current_button_ctrl_id);
    PIC_EDIT_Rotate_UpdateButtonState(win_id);
}

LOCAL void PIC_EDIT_Rotate_UpdateButtonState(MMI_WIN_ID_T win_id)
{
        if(rotate_current_button_ctrl_id == MMIPIC_EDIT_ROTATE_NONE_CTRL_ID)
        {
            rotate_current_button_ctrl_id = MMIPIC_ROTATE_ROTATE_ID;
            MMK_SetAtvCtrl(win_id,rotate_current_button_ctrl_id);
        }

        PIC_EDIT_Rotate_UpdateButtonRotate(win_id,rotate_current_button_ctrl_id==MMIPIC_ROTATE_ROTATE_ID);
        PIC_EDIT_Rotate_UpdateButtonMirrorHorizontal(win_id,rotate_current_button_ctrl_id==MMIPIC_ROTATE_MIRROR_HORIZONTAL_ID);
        PIC_EDIT_Rotate_UpdateButtonMirrorVertical(win_id,rotate_current_button_ctrl_id==MMIPIC_ROTATE_MIRROR_VERTICAL_ID);
}
...
LOCAL void PIC_EDIT_Rotate_UpdateButtonRotate(MMI_WIN_ID_T win_id,BOOLEAN high_light)
{
    ...
    bg_ptr.bg_type = GUI_BG_COLOR;
    bg_display.display_rect = rotate_rotate_button_rect;
    bg_display.rect = rotate_rotate_button_rect;
    bg_display.win_handle = MMK_ConvertIdToHandle(win_id);
...
LOCAL void PIC_EDIT_Rotate_UpdateButtonMirrorVertical(MMI_WIN_ID_T win_id,BOOLEAN high_light)
{
    ...
    bg_ptr.bg_type = GUI_BG_COLOR;
    bg_display.display_rect = rotate_mirror_vertical_button_rect;
    bg_display.rect = rotate_mirror_vertical_button_rect;
    bg_display.win_handle = MMK_ConvertIdToHandle(win_id);

    if(high_light)
    {
	    img_id = THEME_MIRROR_VERTICAL_FOCUS_ON_ICON[theme_index];
	    GUIRES_DisplayImg(PNULL,
							&rotate_mirror_vertical_button_rect,
							PNULL,
							win_id,
							img_id,
							(const GUI_LCD_DEV_INFO *)MMITHEME_GetDefaultLcdDev());
    ...
    {
	    img_id = THEME_MIRROR_VERTICAL_DEFOCUS_ON_ICON[theme_index];
	    GUIRES_DisplayImg(PNULL,
							&rotate_mirror_vertical_button_rect,
							PNULL,
							win_id,
...
LOCAL void PIC_EDIT_Rotate_UpdateButtonMirrorHorizontal(MMI_WIN_ID_T win_id,BOOLEAN high_light)
{
    ...
    bg_ptr.bg_type = GUI_BG_COLOR;
    bg_display.display_rect = rotate_mirror_horizontal_button_rect;
    bg_display.rect = rotate_mirror_horizontal_button_rect;
    bg_display.win_handle = MMK_ConvertIdToHandle(win_id);

    if(high_light)
    {
	    img_id = THEME_MIRROR_HORIZONTAL_FOCUS_ON_ICON[theme_index];
	    GUIRES_DisplayImg(PNULL,
							&rotate_mirror_horizontal_button_rect,
							PNULL,
							win_id,
							img_id,
							(const GUI_LCD_DEV_INFO *)MMITHEME_GetDefaultLcdDev());
    ...
    {
	    img_id = THEME_MIRROR_HORIZONTAL_DEFOCUS_ON_ICON[theme_index];
	    GUIRES_DisplayImg(PNULL,
							&rotate_mirror_horizontal_button_rect,
							PNULL,
							win_id,
...
LOCAL void PIC_EDIT_Rotate_CleanButtonState()
{
	rotate_current_button_ctrl_id = MMIPIC_EDIT_ROTATE_NONE_CTRL_ID;

}
PUBLIC BOOLEAN PIC_CROP_GetSquareCropStatus()
{
	return s_is_squre_crop;
}

PUBLIC void PIC_CROP_SetSquareCropStatus(BOOLEAN param)
{
	s_is_squre_crop = param;
}

PUBLIC BOOLEAN PIC_CROP_GetLandscapeCropStatus()
{
	return s_is_landsquare_crop;
}
PUBLIC void PIC_CROP_SetLandscapeCropStatus(BOOLEAN param)
{
	s_is_landsquare_crop = param;
}
PUBLIC BOOLEAN PIC_GetIsCrop()
{
	return s_is_crop;
}
PUBLIC void PIC_SetIsCrop(BOOLEAN param)
{
	s_is_crop = param;
}
//lijinghua end it

PUBLIC BOOLEAN PIC_EDIT_SetSavedCompletestatus(BOOLEAN param)
{
    s_is_saved_complete = param;
	return s_is_saved_complete;
}

PUBLIC BOOLEAN PIC_EDIT_GetSavedCompletestatus()
{
	return s_is_saved_complete;
}
