...
{
    {ID_PIC_EDIT_SAVE, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},STXT_SOFTKEY_SAVE_MK, 0, 0, 0, NULL},
    {ID_PIC_EDIT_SAVEAS, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN}, TXT_COMMON_SAVE_AS, 0, 0, 0, NULL},  
    {ID_PIC_EDIT_UNDO, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_PIC_UNDO, 0, 0, 0, NULL},
//       {ID_PIC_EDIT_ZOOM, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_PIC_ZOOM, 0, 0, 0, NULL},  
    {ID_PIC_EDIT_ROTATE, TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},TXT_PIC_ROTATE, 0, 0, 0, NULL},
    {ID_PIC_EDIT_INSERT, TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},STXT_SOFTKEY_ADD_MK, 0, 0, 0, MENU_PIC_EDIT_INSERT_OPT},
    ...
    {ID_PIC_EDIT_CROP, TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},TXT_EFFECT, 0, 0, 0, MENU_PIC_EDIT_CROP_OPT},
};
...
const GUIMENU_ITEM_T menu_pic_edit_adjust_opt[] =
{
    ...
    {ID_PIC_EDIT_CONSTRACT, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_COMM_CONTRAST, 0, 0, 0, NULL},
    {ID_PIC_EDIT_SATURATION, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN}, TXT_PIC_SATURATION, 0, 0, 0, NULL},  
    {ID_PIC_EDIT_HUE, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_PIC_HUE, 0, 0, 0, NULL},
};
...
const GUIMENU_ITEM_T menu_pic_edit_crop_opt[] =
{
	{ID_PIC_EDIT_PORTRAIT,TIP_NULL,{TXT_NULL,STXT_SOFTKEY_SELECT_MK,TXT_COMMON_COMMON_BACK},STR_PHOTO_PORTRAIT_EXT01,0,0,0,NULL},
	{ID_PIC_EDIT_SQUARE,TIP_NULL,{TXT_NULL,STXT_SOFTKEY_SELECT_MK,TXT_COMMON_COMMON_BACK},STR_PHOTO_SQUARE_EXT01,0,0,0,NULL},
	{ID_PIC_EDIT_LANDSCAPE,TIP_NULL,{TXT_NULL,STXT_SOFTKEY_SELECT_MK,TXT_COMMON_COMMON_BACK},STR_PHOTO_LANDSCAPE_EXT01,0,0,0,NULL},
};
//lijinghua end
...
const GUIMENU_ITEM_T menu_pic_edit_adjust_opt[] =
{
    {ID_PIC_EDIT_SIZE, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_COMMON_SIZE, 0, 0, 0, NULL},
    {ID_PIC_EDIT_COLOR, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN}, TXT_COLOR, 0, 0, 0, NULL},  
    {ID_PIC_EDIT_BRIGHTNESS, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_COMMON_COMMON_BRIGHTNESS, 0, 0, 0, NULL},
    {ID_PIC_EDIT_CONSTRACT, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_COMM_CONTRAST, 0, 0, 0, NULL},
    {ID_PIC_EDIT_SATURATION, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN}, TXT_PIC_SATURATION, 0, 0, 0, NULL},  
    {ID_PIC_EDIT_HUE, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_PIC_HUE, 0, 0, 0, NULL},
};
