...
typedef enum
{
    ...
    MMICONNECTION_GPRS_DATA_ROAMING_CTRL_ID,
#endif
    MMISET_SET_GPRS_CR_CTRL_ID,
    MMICONNECTION_NETWORK_TYPE_CTRL_ID,
    MMICONNECTION_VODAFONE_SETTINGS_CTRL_ID,
    MMICONNECTION_NETWORK_SETTING_CTRL_ID,
	MMICONNECTION_VODAFONE_CTRL_ID,
	MMICONNECTION_LIST_SETTINGACCOUNTTYPE_CTRL_ID,
