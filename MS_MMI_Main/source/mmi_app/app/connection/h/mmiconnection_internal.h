...
typedef enum
{
    ...
    MMI_CONNECTION_MENU_LIST_GPRS_SIM,
#endif
...
#endif
    MMI_CONNECTION_MENU_LIST_NETWORK_TYPE,
    MMI_CONNECTION_MENU_LIST_VODAFONE,
    ...
    MMI_CONNECTION_MENU_LIST_FLIGHT_MODE,

    MMI_CONNECTION_MENU_LIST_DUAL_SIM,

    MMI_CONNECTION_MENU_LIST_ACCESS_POINTS,
    MMI_CONNECTION_MENU_LIST_ACCESS_NETWORK_TYPE,

    MMI_CONNECTION_SET_VODAFONE_PAY,
