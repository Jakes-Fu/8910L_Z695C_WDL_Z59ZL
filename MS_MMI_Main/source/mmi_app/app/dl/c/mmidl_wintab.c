...
#ifdef MMI_PDA_SUPPORT
    WIN_STYLE(WS_HAS_BUTTON_SOFTKEY),
    WIN_SOFTKEY(STXT_SOFTKEY_SAVE_MK, TXT_NULL, TXT_COMMON_COMMON_BACK),
#else
    WIN_SOFTKEY(STXT_SOFTKEY_SAVE_MK, TXT_EDIT, TXT_COMMON_COMMON_BACK),
#endif /* MMI_PDA_SUPPORT */
...
//    WIN_STATUSBAR,
    ...
    WIN_STYLE(WS_HAS_BUTTON_SOFTKEY),
    #endif /* MMI_PDA_SUPPORT */
    WIN_SOFTKEY(STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_CANCEL),
...
WINDOW_TABLE(MMIDL_DOWNLOAD_SELECT_DEVICE_WIN_TAB) = 
{
    ...
    WIN_ID(MMIDL_DOWNLOAD_SELECT_DEVICE_WIN_ID),
        //    WIN_STATUSBAR,
    WIN_TITLE(STR_SETT_LIST_STORAGE_EXT01),
    WIN_SOFTKEY(STXT_SOFTKEY_OK_MK, TXT_NULL, TXT_COMMON_COMMON_BACK),
...
WINDOW_TABLE(MMIDL_DOWNLOAD_SETTINGS_WIN_TAB) = 
{
    ...
    CHILD_FORM_CTRL(TRUE,GUIFORM_LAYOUT_ORDER,MMIDL_DOWNLOAD_SAVE_PICTURE_FORM_CTRL_ID,MMIDL_DOWNLOAD_SETTINGS_FORM_CTRL_ID),
        ...
        CHILD_LABEL_CTRL(GUILABEL_ALIGN_LEFT,TRUE,MMIDL_DOWNLOAD_SAVE_PICTURE_VALUE_CTRL_ID,MMIDL_DOWNLOAD_SAVE_PICTURE_FORM_CTRL_ID),
    ...
    CHILD_FORM_CTRL(TRUE,GUIFORM_LAYOUT_ORDER,MMIDL_DOWNLOAD_SAVE_MUSIC_FORM_CTRL_ID,MMIDL_DOWNLOAD_SETTINGS_FORM_CTRL_ID),
        ...
        CHILD_LABEL_CTRL(GUILABEL_ALIGN_LEFT,TRUE,MMIDL_DOWNLOAD_SAVE_MUSIC_VALUE_CTRL_ID,MMIDL_DOWNLOAD_SAVE_MUSIC_FORM_CTRL_ID),
    ...
    CHILD_FORM_CTRL(TRUE,GUIFORM_LAYOUT_ORDER,MMIDL_DOWNLOAD_SAVE_VIDEO_FORM_CTRL_ID,MMIDL_DOWNLOAD_SETTINGS_FORM_CTRL_ID),
        ...
        CHILD_LABEL_CTRL(GUILABEL_ALIGN_LEFT,TRUE,MMIDL_DOWNLOAD_SAVE_VIDEO_VALUE_CTRL_ID,MMIDL_DOWNLOAD_SAVE_VIDEO_FORM_CTRL_ID),
    ...
    CHILD_FORM_CTRL(TRUE,GUIFORM_LAYOUT_ORDER,MMIDL_DOWNLOAD_SAVE_OTHERS_FORM_CTRL_ID,MMIDL_DOWNLOAD_SETTINGS_FORM_CTRL_ID),
        ...
        CHILD_LABEL_CTRL(GUILABEL_ALIGN_LEFT,TRUE,MMIDL_DOWNLOAD_SAVE_OTHERS_VALUE_CTRL_ID,MMIDL_DOWNLOAD_SAVE_OTHERS_FORM_CTRL_ID),
...
LOCAL MMI_RESULT_E HandleDownloadAuthWinMsg(MMI_WIN_ID_T win_id, MMI_MESSAGE_ID_E msg_id, DPARAM param)
{
    ...
    case MSG_OPEN_WINDOW:
        ...
        GUIWIN_SetSoftkeyTextId(win_id,  STXT_SOFTKEY_OK_MK, TXT_EDIT, TXT_COMMON_COMMON_BACK, FALSE);
...
LOCAL MMI_RESULT_E HandleDownloadAuthInputWinMsg(MMI_WIN_ID_T win_id, MMI_MESSAGE_ID_E msg_id, DPARAM param)
{
    ...
    case MSG_OPEN_WINDOW:
        ...
        GUIEDIT_SetStyle(ctrl_handle,GUIEDIT_STYLE_MULTI_UP);
        GUIEDIT_SetSoftkey(
                                        ctrl_handle,
                                        0,
                                        0,
...
LOCAL MMI_RESULT_E HandleDownloadSaveWinMsg(MMI_WIN_ID_T win_id, MMI_MESSAGE_ID_E msg_id, DPARAM param)
{
    ...
    case MSG_OPEN_WINDOW:     
        ...
        GUILABEL_SetTextById(file_name_handle, TXT_FILENAME, FALSE);
    ...
    case MSG_FULL_PAINT:
        ...
        {
            GUIWIN_SetSoftkeyTextId(win_id,  STXT_SOFTKEY_OK_MK, STXT_SOFTKEY_CHANGE, TXT_COMMON_COMMON_BACK, FALSE);
        }
        break;
                ...
                if (!MMIAPIFMM_IsFileExist(full_name, full_name_len))
                {
                    ...
                    if( SFS_INVALID_HANDLE != file_handle )
                    {
                        ...
                        else
                        {
                            ...
                            MMIPUB_OpenAlertWarningWin(STXT_MESSAGE_MEMORY_FULL);
...
LOCAL MMI_RESULT_E HandleDownloadSelectDeviceWinMsg(MMI_WIN_ID_T win_id, MMI_MESSAGE_ID_E msg_id, DPARAM param)
{
    ...
    case MSG_OPEN_WINDOW:
        ...
        MMIAPISET_AppendListItemByTextId(TXT_COMMON_UDISK, STXT_SOFTKEY_OK_MK, ctrl_id, GUIITEM_STYLE_ONE_LINE_RADIO );
#ifndef DUAL_TCARD_SUPPORT
        MMIAPISET_AppendListItemByTextId(TXT_COMMON_SD_CARD, STXT_SOFTKEY_OK_MK, ctrl_id, GUIITEM_STYLE_ONE_LINE_RADIO );
#else
        MMIAPISET_AppendListItemByTextId(TXT_COMMON_SD_CARD0, STXT_SOFTKEY_OK_MK, ctrl_id, GUIITEM_STYLE_ONE_LINE_RADIO );
        MMIAPISET_AppendListItemByTextId(TXT_COMMON_SD_CARD1, STXT_SOFTKEY_OK_MK, ctrl_id, GUIITEM_STYLE_ONE_LINE_RADIO );
#endif
                                                                                                          ...
                                                                                                          DPARAM param)
{
    ...
    case MSG_CTL_MIDSK:  
        ...
        case ID_DL_MANAGER_OPT_REDOWNLOAD:
            ...
            MMIBROWSER_OpenQueryWinByTextId(TXT_DL_QURERY_RE_DOWNLOAD, IMAGE_PUBWIN_QUERY,PNULL,PNULL);
#else
...
#ifdef BROWSER_SUPPORT_DORADO
            MMIBROWSER_OpenQueryWinByTextId(TXT_DELETE_QUERY, IMAGE_PUBWIN_QUERY,PNULL,PNULL);
#else
...
#ifdef BROWSER_SUPPORT_DORADO
            MMIBROWSER_OpenQueryWinByTextId(TXT_DELETE_ALL_QUERY, IMAGE_PUBWIN_QUERY,PNULL,PNULL);
#else
			MMIPUB_OpenQueryWinByTextId(TXT_DELETE_ALL_QUERY, IMAGE_PUBWIN_QUERY, PNULL, PNULL);
#endif
            break;
                                                                                                          ...
                                                                                                          DPARAM param)
{
	...
	{
		task_index  = pubwin_info_ptr->user_data;
	}
	...
	SCI_TRACE_LOW("[BRW] func[%s] line[%d] task_index[%d] msg_id[%d]",__FUNCTION__,__LINE__,task_index,msg_id);
    switch(msg_id)
    {
#if 0
    case MSG_OPEN_WINDOW:
...
{   
    ...
    MMI_CTRL_ID_T          current_ctrl_id = MMIDL_DOWNLOAD_SETTINGS_FORM_CTRL_ID;
    GUI_BG_T               bg_info = {0};
    ...
    case MSG_NOTIFY_GET_ACTIVE:
        {
            ...
            GUIWIN_SetSoftkeyTextId(win_id,  STXT_SOFTKEY_OK_MK, STXT_SOFTKEY_SELECT_MK, TXT_COMMON_COMMON_BACK, TRUE);
#else
            ...
            GUIWIN_SetSoftkeyTextId(win_id,  STXT_SOFTKEY_SAVE_MK, STXT_SOFTKEY_SELECT_MK, TXT_COMMON_COMMON_BACK, TRUE);
#endif
        }
        break;
...
LOCAL void SetDownloadPath(MMI_WIN_ID_T win_id)
{
    ...
    GUILABEL_SetTextById(video_name_ctrl, STR_MAINMENU_VIDEOS, FALSE);
    GUILABEL_SetTextById(others_name_ctrl, TXT_TOOLS_OTHERS, FALSE);

    CTRLFORM_SetPaddingEx(MMIDL_DOWNLOAD_SAVE_PICTURE_FORM_CTRL_ID, 6);
    CTRLFORM_SetPaddingEx(MMIDL_DOWNLOAD_SAVE_MUSIC_FORM_CTRL_ID, 6);
    CTRLFORM_SetPaddingEx(MMIDL_DOWNLOAD_SAVE_VIDEO_FORM_CTRL_ID, 6);
    CTRLFORM_SetPaddingEx(MMIDL_DOWNLOAD_SAVE_OTHERS_FORM_CTRL_ID, 6);
...
#ifndef MMI_GUI_STYLE_TYPICAL
    GUIWIN_SetSoftkeyTextId(win_id,  STXT_SOFTKEY_OK_MK, STXT_SOFTKEY_SELECT_MK, TXT_COMMON_COMMON_BACK	, FALSE);
#else
    GUIWIN_SetSoftkeyTextId(win_id,  STXT_SOFTKEY_SAVE_MK, STXT_SOFTKEY_SELECT_MK, TXT_COMMON_COMMON_BACK	, FALSE);
#endif
}
...
LOCAL void SetDownloadSettings(MMI_WIN_ID_T win_id)
{
    ...
    MMI_HANDLE_T path_list_ctrl = MMK_GetCtrlHandleByWin(win_id, MMIDL_DOWNLOAD_SETTINGS_PATH_LIST_CTRL_ID);
#endif
    uint16 cur_index = GUILIST_GetCurItemIndex(MMIDL_DOWNLOAD_SETTINGS_LIST_CTRL_ID);
    MMI_TEXT_ID_T method_text[MMIDL_DOWNLOAD_METHOD_TYPE_MAX] = {TXT_DL_SETTINGS_METHOD_APPOSITE, TXT_DL_SETTINGS_METHOD_QUEUE};
    MMI_TEXT_ID_T path_text[MMIDL_DOWNLOAD_PATH_TYPE_MAX] = {TXT_DL_SETTINGS_PATH_DEFAULT, STR_BROWSER_TYPE_CUSTOMIZED};
    ...
    CTRLLIST_SetCurItemIndex(MMIDL_DOWNLOAD_SETTINGS_LIST_CTRL_ID, cur_index);
#else
    //set method name
...
LOCAL void dlHandleMethodSet(void)
{
    MMK_CreateWin((uint32 *)MMIDL_METHOD_SET_WIN_TAB, PNULL);
}
...
LOCAL void dlHandlePathSet(void)
{
    MMK_CreateWin((uint32 *)MMIDL_PATH_SET_WIN_TAB, PNULL);
}
...
LOCAL void DlCreatePathSetMenu(MMI_WIN_ID_T win_id, MMI_CTRL_ID_T ctrl_id)
{
    MMI_TEXT_ID_T       path_text[] = {TXT_DL_SETTINGS_PATH_DEFAULT, STR_BROWSER_TYPE_CUSTOMIZED};
