 ...
 **                         MACRO DEFINITION                                 *
 **--------------------------------------------------------------------------*/
#define BLOCK_MEM_POOL_SIZE_NEST (900 * 1024)   // Set a  MEM POOL for different livewallpaper respectively;
...
LOCAL BOOLEAN NEST_Construct(MMI_WIN_ID_T win_id)
{
    ...
    s_petal_info.Petal[0] = s_pRes_springnest[35];
    s_petal_info.Petal[1] = s_pRes_springnest[37];
    s_petal_info.Petal[2] = s_pRes_springnest[36];
