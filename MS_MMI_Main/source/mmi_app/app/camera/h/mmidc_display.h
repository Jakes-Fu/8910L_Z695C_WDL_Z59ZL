...
#else
    #define ICON_SIZE_FONT  SONG_FONT_10 //bugid:1241660  补充--设成12的话也会和边框有重叠
...
#define MMIDC_TEXT_FONT         SONG_FONT_14//MMI_DEFAULT_NORMAL_FONT
#define MMIDC_TEXT_FONT_SIZE    14          //MMI_DEFAULT_NORMAL_FONT_SIZE
#elif defined MAINLCD_SIZE_128X160
#define MMIDC_TEXT_FONT         SONG_FONT_12//MMI_DEFAULT_NORMAL_FONT
#define MMIDC_TEXT_FONT_SIZE    12          //MMI_DEFAULT_NORMAL_FONT_SIZE
#elif (defined MAINLCD_SIZE_240X320)
#define MMIDC_TEXT_FONT         SONG_FONT_24//SONG_FONT_18//MMI_DEFAULT_NORMAL_FONT
#define MMIDC_TEXT_FONT_SIZE    24 //18          //MMI_DEFAULT_NORMAL_FONT_SIZE
#else
#define MMIDC_TEXT_FONT         SONG_FONT_20 //MMI_DEFAULT_BIG_FONT
#define MMIDC_TEXT_FONT_SIZE    20          //MMI_DEFAULT_BIG_FONT_SIZE
#endif
...
#define MMIDC_TRANSPARENT_COLOR     MMI_BLACK_COLOR
    ...
    #define MMIDC_ITEM_TEXT_HEIGHT      (MMIDC_TEXT_FONT_SIZE+8)
