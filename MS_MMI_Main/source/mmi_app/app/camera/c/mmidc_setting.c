...
LOCAL MMIDC_SIZE_ATTRIBUTE_T   s_photo_size_val_array[]=
{
    ...
    {1200, 1600},//PHOTO_SIZE_1200X1600,
...
{    
	// Mocor20B原生video摄像分辨率仅限于VIDEO_SIZE_320X240
	// 因此修改此处代码作为暂时规避方案
#if 0   
...
#else
	dc_setting_info->video_size = VIDEO_SIZE_320X240;
	//SCI_TRACE_LOW:"[MMIDC] CheckVideoSize video_size = %d"
	SCI_TRACE_ID(TRACE_TOOL_CONVERT,MMIDC_SETTING_462_112_2_18_2_9_45_596,(uint8*)"d", dc_setting_info->video_size);
#endif
}
...
PUBLIC BOOLEAN MMIDC_Setting_GetNVDefaultValue(void)
{
	...
	// Mocor20B原生picture拍照分辨率仅限于PHOTO_SIZE_640X480
...
PUBLIC void MMIAPIDC_Setting_SetFactoryValue(void)
{
    ...
    dc_setting_info.video_shutter_voice = SHUTTER_VOICE_1;	//快门音（无，快门音一，快
	...
	dc_setting_info.photo_quality = PHOTO_QUALITY_ADVANCED;
...
// Mocor20B原生video摄像格式仅支持 VIDEO_FILE_TYPE_3GP
#if 0 // def AVI_ENC_SUPPORT
...
PUBLIC void MMIDC_SetFlashLamp(DCAMERA_FLASH_MODE_E flash)
{
    ...
    {    
        ...
        SCI_TRACE_LOW("[MMIDC] MMIDC_SetFlashLamp ret = %d,flash:%d", ret,flash);
...
/*****************************************************************************/
// 	Description : get video shutter voice enum
//	Global resource dependence : none
//  Author: luo.junxian
//	Note:
/*****************************************************************************/
PUBLIC SHUTTER_VOICE_E MMIDC_GetVideoShutterVoice(void)
{
	return MMIDC_SETTING_DATA_PTR->dc_setting_info.video_shutter_voice;
}
...
PUBLIC int16 GetDCameraSizeToPhotoSizeArray(MMIDC_SIZE_T* size_ptr, int16 size_len)
{
    MMIDC_SIZE_T size_array[]=
    {
        ...
        {DCAMERA_PHOTO_SIZE_1200X1600,PHOTO_SIZE_1200X1600},
...
PUBLIC DCAMERA_PARAM_PHOTO_SIZE_E MMIDC_ConvertPhotoSizeToDCameraSize(MMIDC_PHOTO_SIZE_E photo_size)
{
    MMIDC_SIZE_T size_array[]=
    {
        ...
        {PHOTO_SIZE_1200X1600, DCAMERA_PHOTO_SIZE_1200X1600},
...
#else
	MMIDC_PHOTO_SIZE_E max_photo_size = PHOTO_SIZE_640X480;
#endif
...
PUBLIC MMIDC_PHOTO_SIZE_E MMIDC_GetMaxPhotoSizeToBurst(MULTI_SHOOT_E shoot_number)
{
    ...
    {
        max_photo_number = MMIDC_GetBurstNumberByPhotoSize(photo_size);
        if ((max_photo_number >= shoot_number) || (photo_size == 0))
        {
            break;
        }
        photo_size--;
