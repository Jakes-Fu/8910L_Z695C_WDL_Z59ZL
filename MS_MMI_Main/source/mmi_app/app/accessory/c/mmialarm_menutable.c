 ...
 **                         MACRO DEFINITION                                 *
 **--------------------------------------------------------------------------*/
#define TXT_COMMON_CHOOSE STXT_SOFTKEY_SELECT_MK
/**--------------------------------------------------------------------------*
 **                         STATIC DEFINITION                                *
 **--------------------------------------------------------------------------*/
...
{   
    ...
    {ID_ALM_CLOSE,    TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   STR_POC_ILIST_OFF,         0, 0, 0, MENU_NULL},
...
const GUIMENU_ITEM_T  menu_sch[] =
{
    ...
    {ID_SCH_EDIT,  		TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_EDIT,  IMG_PB_MENU_EDIT_ICON, IMG_PB_MENU_EDIT_ICON, IMG_PB_MENU_EDIT_ICON, MENU_NULL},
    {ID_SCH_DEL,        TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_DELETE,  IMAGE_COMMON_OPTMENU_DELETE, IMAGE_COMMON_OPTMENU_DELETE, IMAGE_COMMON_OPTMENU_DELETE, MENU_NULL},
#ifdef MMI_VCALENDAR_SUPPORT
    {ID_SCH_LIST_SEND,	TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_SEND,  IMAGE_COMMON_OPTMENU_SEND, IMAGE_COMMON_OPTMENU_SEND, IMAGE_COMMON_OPTMENU_SEND, MENU_SCH_SEND},
    {ID_SCH_VCALENDAR_EXPORT,    TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_COMM_EXPORT, IMG_CALENDAR_MENU_EXPORT_ICON, IMG_CALENDAR_MENU_EXPORT_ICON, IMG_CALENDAR_MENU_EXPORT_ICON, MENU_NULL},
#endif
#else
    {ID_SCH_EDIT,  		TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_EDIT,  0, 0, 0, MENU_NULL},
    {ID_SCH_DEL,        TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_DELETE,  0, 0, 0, MENU_NULL},
#endif
};
const GUIMENU_ITEM_T  menu_sch_opt[] =
{
...
#ifdef MMI_VCALENDAR_SUPPORT
    {ID_SCH_LIST_MARK,	TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   STXT_MARK,  IMAGE_COMMON_OPTMENU_MARK, IMAGE_COMMON_OPTMENU_MARK, IMAGE_COMMON_OPTMENU_MARK, MENU_SCH_MARK},
    {ID_SCH_VCALENDAR_IMPORT,      TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_COMMON_IMPORT,  IMG_PB_MENU_IMPORT_ICON, IMG_PB_MENU_IMPORT_ICON, IMG_PB_MENU_IMPORT_ICON, MENU_NULL},
#else
    ...
    {ID_SCH_LIST_VIEW,	TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_VIEW,  0, 0, 0, MENU_NULL},
    {ID_SCH_LIST_EDIT, 	TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_EDIT,  0, 0, 0, MENU_NULL},
    {ID_SCH_LIST_NEW,   TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_CALENDAR_NEW,  0, 0, 0, MENU_NULL},
#ifdef MMI_VCALENDAR_SUPPORT
    {ID_SCH_LIST_DEL_MARK, 	TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_DELETE,  0, 0, 0, MENU_NULL},
    {ID_SCH_LIST_SEND,	TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_SEND,  0, 0, 0, MENU_SCH_SEND},
    {ID_SCH_LIST_MARK,	TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   STXT_MARK,  0, 0, 0, MENU_SCH_MARK},
    {ID_SCH_VCALENDAR,  TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_IDLE_CALENDAR,  0, 0, 0, MENU_SCH_VCALENDAR},   
#else
...
const GUIMENU_ITEM_T  menu_sch_all_opt[] =
{
    ...
    {ID_SCH_TO_DATE,	TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_CALENDAR_TO_DATE,  IMG_CALENDAR_MENU_CLEAN_GOTO_DATE_ICON, IMG_CALENDAR_MENU_CLEAN_GOTO_DATE_ICON, IMG_CALENDAR_MENU_CLEAN_GOTO_DATE_ICON, MENU_NULL},
#else//MMI_PDA_SUPPORT
    {ID_SCH_ALL_LIST_VIEW,	TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_VIEW,  0, 0, 0, MENU_NULL},
    {ID_SCH_ALL_LIST_EDIT, 	TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_EDIT,  0, 0, 0, MENU_NULL},   
    {ID_SCH_ALL_LIST_NEW,  	TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_CALENDAR_NEW,  0, 0, 0, MENU_NULL},
#ifdef MMI_VCALENDAR_SUPPORT
    {ID_SCH_LIST_DEL_MARK, 	TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_DELETE,  0, 0, 0, MENU_NULL},
    {ID_SCH_LIST_MARK,	TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   STXT_MARK,  0, 0, 0, MENU_SCH_MARK},
    {ID_SCH_LIST_SEND,	TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_SEND,  0, 0, 0, MENU_SCH_SEND},
...
{   
    {ID_SCH_LIST_SUB_MARK,      TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   STXT_MARK,  0, 0, 0, MENU_NULL},
    {ID_SCH_LIST_SUB_CANCEL_MARK,    TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_CANCEL_MARK, 0, 0, 0, MENU_NULL},
    {ID_SCH_LIST_SUB_MARK_ALL,         TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_MARK_ALL,     0, 0, 0, MENU_NULL},
    {ID_SCH_LIST_SUB_CANCEL_MARK_ALL,      TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_CANCEL_MARK_ALL,   0, 0, 0, MENU_NULL},
};

const GUIMENU_ITEM_T menu_sch_vcalendar[] =
{   
    {ID_SCH_VCALENDAR_IMPORT,      TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_COMMON_IMPORT,  0, 0, 0, MENU_NULL},
    {ID_SCH_VCALENDAR_EXPORT,    TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_COMM_EXPORT, 0, 0, 0, MENU_NULL},
};

const GUIMENU_ITEM_T menu_sch_send[] =
{   
    {ID_SCH_LIST_SEND_SMS,      TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_SMS,  0, 0, 0, MENU_NULL},
#ifdef MMS_SUPPORT
    {ID_SCH_LIST_SEND_MMS,    TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_MMS, 0, 0, 0, MENU_NULL},
#endif
...
{   
    {ID_ALM_OPT_ADD,      TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},   TXT_ADD,  0, 0, 0, MENU_NULL},
    {ID_ALM_OPT_EDIT,    TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},   TXT_EDIT, 0, 0, 0, MENU_NULL},
    {ID_ALM_OPT_DEL,         TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},   TXT_DELETE,     0, 0, 0, MENU_NULL},
};
#endif

//[alarm edit option menu]
const GUIMENU_ITEM_T menu_alarm_edit_opt[] =
{
    {ID_ALM_OPT_SAVE,  TIP_NULL, {IMAGE_NULL, STXT_SOFTKEY_SELECT_MK, TXT_COMMON_COMMON_BACK},   STR_LIST_SAVE_EXT01,  0, 0, 0, MENU_NULL},
};

const GUIMENU_ITEM_T menu_alarm_main_opt[] =
{
    {ID_ALM_OPT_EDIT,    TIP_NULL, {IMAGE_NULL, STXT_SOFTKEY_SELECT_MK, TXT_COMMON_COMMON_BACK},   STR_ALARM_LIST_EDIT_EXT01, 0, 0, 0, MENU_NULL},
    {ID_ALM_OPT_DEL,     TIP_NULL, {IMAGE_NULL, STXT_SOFTKEY_SELECT_MK, TXT_COMMON_COMMON_BACK},   TXT_DELETE,     0, 0, 0, MENU_NULL},
    {ID_ALM_OPT_DEL_ALL, TIP_NULL, {IMAGE_NULL, STXT_SOFTKEY_SELECT_MK, TXT_COMMON_COMMON_BACK},   STR_ALARM_LIST_DELETE_ALL_EXT01, 0, 0, 0, MENU_NULL},
};
//[end]
