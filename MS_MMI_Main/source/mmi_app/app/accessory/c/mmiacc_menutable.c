...
//    {ID_UDISK_PCC_SETTINGS, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_UDISK_PCC_SETTING, 0, 0, 0, MENU_UPCC_SETTINGS},
};

const GUIMENU_ITEM_T menu_upcc_settings[] =
{
    {ID_UDISK_PCC_BRIGHTNESS, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_COMMON_COMMON_BRIGHTNESS, 0, 0, 0, MENU_NULL},
    {ID_UDISK_PCC_CONTRAST, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_COMM_CONTRAST, 0, 0, 0, MENU_NULL},
    {ID_UDISK_PCC_EFFECT, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_EFFECT, 0, 0, 0, MENU_NULL},
...
{
    {MMI_PHONESEARCH_POP_QUERY_MENU_ID, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_INQUIRE, 0, 0, 0, MENU_NULL},

#if defined(BROWSER_SUPPORT) && defined(HOME_LOCATION_INQUIRE_SUPPORT_TCARD)
    {MMI_PHONESEARCH_POP_DOWNLOAD_MENU_ID, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_SEARCHPHONE_DOWNLOAD_PHONENUM_FILE, 0, 0, 0, MENU_NULL},
#endif
};
/*---------------------------------------------------------------------------*/
/*                          TYPE AND CONSTANT                                */
