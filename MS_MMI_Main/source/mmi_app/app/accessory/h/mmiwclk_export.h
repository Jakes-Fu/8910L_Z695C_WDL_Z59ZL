...
**                         MACRO DEFINITION                                 *
**--------------------------------------------------------------------------*/
#define WT_TIME_ZONE_NUM_TOTAL		 37  // 时区总数
...
typedef enum
{
    ...
    MMI_ACC_9_P_TOKYO,
    MMI_ACC_9_P_SEOUL,
    MMI_ACC_10P5_P_ADELAIDE,
    MMI_ACC_9P5_P_DARWIN,
    MMI_ACC_7_N_PHOENIX,
    ...
    MMI_ACC_5_N_NEWYORK,
    MMI_ACC_4_N_CARACAS,
    MMI_ACC_11_P_NORFOLD_ISLAND,
    MMI_ACC_1_N_PRAIA,
    MMI_ACC_1_P_GENEVA,
    MMI_ACC_3_N_SANTIAGO,
    MMI_ACC_5_N_BOGOTA,
    ...
    MMI_ACC_2_P_ATHENS,
    MMI_ACC_2_P_HELSINKI,
    MMI_ACC_2_P_JERUSALEM,
    MMI_ACC_2_P_PRETORIA,
    MMI_ACC_7_P_JAKARTA,
    MMI_ACC_6P5_P_YANGON,
    MMI_ACC_5_P_ISLAMABAD,
    MMI_ACC_3_P_ISTANBUL,
    MMI_ACC_2_P_JOHANNESBURG,
    MMI_ACC_6_N_CHICAGO,
    MMI_ACC_7_P_PHNOMPENH,
    MMI_ACC_3_P_DOHA,
    MMI_ACC_3_P_KAMPALA,
    MMI_ACC_2_P_AMMAN,
    MMI_ACC_2_P_KYIV,
    ...
    MMI_ACC_3_P_SANA,
    MMI_ACC_0_ACCRA,
    MMI_ACC_7_P_NOVOSIBIRSK,
    MMI_ACC_11_P_LDH,
    MMI_ACC_12_P_ANADYR,
    MMI_ACC_11_P_MAGADAN,
    MMI_ACC_12_N_IDL_WEST,
    MMI_ACC_11_N_MIDWAY,
    MMI_ACC_8_N_SEATTLE,
    MMI_ACC_5_N_WASHINGTON,
    MMI_ACC_3P5_N_SAINIT_JOHN,
    MMI_ACC_1_N_AZORES,
...
typedef struct _WT_NEW_TIME_CITY_ZONE
{
	MMI_TEXT_ID_T	city_index;//city
	MMI_TEXT_ID_T	zone_index;//zone
	MMI_TEXT_ID_T	zone_city_index;
	uint16	         mcc;    //mobile country code
    WT_CITY_INDEX_E  city_order; //the order and index of city
}WT_NEW_TIME_CITY_ZONE;
...
typedef struct _WT_NDT_CODE_ZONE
{
	uint8 ndt_code[12];
	MMI_TEXT_ID_T ndt_zone_index;
}_WT_NDT_CODE_ZONE;
