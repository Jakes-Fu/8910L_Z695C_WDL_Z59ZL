...
MMI_TIMER_PARENT_TAB_ID,
    ...
    //added by du.yuxuan
    MMICT_CUSTOM_EDIT_FORM_CTRL_ID,
    MMICT_CUSTOM_TIME_EDIT_FORM_CTRL_ID,
    MMICT_CUSTOM_TIME_LABEL_CTRL_ID,
    MMICT_CUSTOM_TIMEEDIT_CTRL_ID,
    MMICT_CUSTOM_TEXTEDIT_CTRL_ID,
    MMICT_CUSTOM_SEL_MENU_CTRL_ID,
    //end
    //tvout
    ...
    //new worldtime ctrl id
        ...
        MMIWT_CITY_1_FORM_CTRL_ID,
            ...
            //added by du.yuxuan
            MMIEXTRAS_MAIN_MENU_LIST_CTRL_ID,
            //end
        #if 0    
    ...
    MMIUNITCONV_MAIN_WIN_MENU_LIST_CTRL_ID,
    MMIUNITCONV_SUBSET_WIN_MENU_LIST_CTRL_ID,
    MMIUNITCONV_CONVERTER_WIN_FORM_CTRL_ID,
    MMIUNITCONV_CONVERTER_WIN_EDIT_1_CTRL_ID,
    MMIUNITCONV_CONVERTER_WIN_EDIT_2_CTRL_ID,
    MMIUNITCONV_CONVERTER_WIN_EDIT_3_CTRL_ID,
    MMIUNITCONV_CONVERTER_WIN_EDIT_4_CTRL_ID,
    MMIUNITCONV_CONVERTER_OPT_LIST_CTRL_ID,
#else
...
#endif
        MMIWT_SET_TIME_ZONE_LIST_CTRL_ID,//tangting add
    MMIACC_MAX_CTRL_ID
}MMIACC_CONTROL_ID_E;
