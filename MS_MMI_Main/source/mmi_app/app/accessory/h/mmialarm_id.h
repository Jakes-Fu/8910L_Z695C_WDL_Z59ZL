...
//	MMIALM_EDIT_MODE_LIST3_CTRL_ID,
    ...
    MMISCH_REMIND_VALUE_LABEL_CTRL_ID,
    ...
    MMISCH_VIEW_DETAIL_FORM_CTRL_ID,
    MMISCH_VIEW_DETAIL_LABEL_DATE_CTRL_ID,
    MMISCH_VIEW_DETAIL_CHILD_FORM_CTRL_ID,
    MMISCH_VIEW_DETAIL_LABEL_TIME_CTRL_ID,
    MMISCH_VIEW_DETAIL_IMAGE_REPEAT_CTRL_ID,
    MMISCH_VIEW_DETAIL_IMAGE_REMINDER_CTRL_ID,
    MMISCH_VIEW_DETAIL_LABEL_SUBJECT_CTRL_ID,
    MMISCH_VIEW_DETAIL_TEXT_BODY_CTRL_ID,
    ...
    MMISCH_FREQ_VALUE_LABEL_CTRL_ID,
    ...
    MMISCH_PLACE_FORM_CTRL_ID,
    MMISCH_PLACE_TITLE_LABEL_CTRL_ID,
    MMISCH_PLACE_EDIT_CTRL_ID,
    MMISCH_EDIT_OPTION_MENU_CTRL_ID,
    MMISCH_EDIT_REMINDER_LIST_CTRL_ID,
    
    MMISCH_EDIT_LIST_CTRL_ID,
    MMISCH_CONTENT_LABEL_CTRL_ID,
    MMISCH_OPTION_MENU_CTRL_ID,
    MMISCH_OPTION_DYNAMIC_MENU_CTRL_ID,
...
#endif
    MMISCH_VIEW_FORM_CTRL_ID,
    MMISCH_VIEW_LABEL_CTRL_ID,
    MMISCH_VIEW_BTN_CTRL_ID,
    MMISCH_VIEW_EMPTY_TEXT_CTRL_ID,
    //[add new alarm list UI]
    MMIALM_MAINWIN_FORM_CTRL_ID,
    MMIALM_NEW_ALARM_CTRL_ID,
    MMIALM_TEXT_NO_ALARMS_CTRL_ID,
    MMIALM_EDIT_REPEAT_LIST_CTRL_ID,
    MMIALM_REPEAT_LIST_CTRL_ID,
    MMIALM_EDIT_SNOOZE_TIME_CTRL_ID,
    MMIALM_SNOOZETIMELIST_CTRL_ID,
    MMIALM_EDIT_MENU_CTRL_ID,
    MMIALM_POWERONOFF_EDIT_CTRL_ID,
    //[end]
#ifdef MMI_JEWISH_CALENDAR
    MMIJEWISHCAL_LOCATION_TITLE_CTRL_ID,
    MMIJEWISHCAL_DATE_TITLE_CTRL_ID,
    MMIJEWISHCAL_DAY_DETAIL_TEXT_CTRL_ID,
    MMIJEWISHCAL_DAY_DETAIL_FROM_ID,
    MMIJEWISHCAL_DETAIL_TITLE_FORM_ID,
    MMIJEWISHCAL_DETAIL_LOCATION_LABEL_CTRL_ID,
    MMIJEWISHCAL_DETAIL_DLS_BTN_CTRL_ID,
    MMIJEWISHCAL_DETAIL_DATE_LABEL_CTRL_ID,
    MMIJEWISHCAL_OPT_MENU_CTRL_ID,
    MMIJEWISHCAL_LOCATION_LIST_CTRL_ID,
    MMIJEWISHCAL_SEL_DATE_BTN_CTRL_ID,
    MMIJEWISHCAL_DLS_LABEL_CTRL_ID,
    MMIJEWISHCAL_ABOUT_TEXT_CTRL_ID,
    MMIJEWISHCAL_HELP_TEXT_CTRL_ID,
#endif
    ALARM_MAX_CTRL_ID
}ALARM_CONTROL_ID_E;
