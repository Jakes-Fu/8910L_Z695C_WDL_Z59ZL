 ...
 **--------------------------------------------------------------------------*/
...
#else
#if defined MAINLCD_SIZE_128X160
    #define MMICALC_TEXT_FONT           SONG_FONT_12        
    #define MMICALC_TEXT_FONT_H           SONG_FONT_12  
#else
...
#if defined (MAINLCD_SIZE_128X160)
    #define CALC_LINE_RIGHT_BORDER      2 //4     
    #define CALC_LINE_RIGHT_BORDER_H    3 
#else
	...
	#define ST_BUTTON_MARGIN  8
        #define ST_TIME_HOUR_WIDTH 38
        #define ST_TIME_MIN_SEC_WIDTH 64
        #define ST_TIME_MSEC_WIDTH 54
        #define ST_TIME_MARGIN 7
        #define ST_TIME_SPACE 2
	...
	#define CALENDAR_DAILY_DATE_FONT                    SONG_FONT_12 // Bug 1339920, 按日检视缩小字型较能对齐显示
	...
	#define CALENDAR_DAILY_DATE_FONT                    SONG_FONT_14 // Bug 1339920, 按日检视缩小字型较能对齐显示
...
#define ACC_CALC_BL_DISP_RECT	    {CALC_LINE_START_X, CALC_LINE_START_Y, CALC_LINE_END_X,CALC_LINE_END_Y}
	...
	#define ST_TIMER1_HEIGHT_V 15
	#define ST_TIMER1_HEIGHT_H 14
	#define ST_TIMER2_HEIGHT_V 65
	#define ST_TIMER2_HEIGHT_H 31
	#define ST_BUTTON_HEIGHT_V  40
	#define ST_BUTTON_HEIGHT_H  32
	#define ST_BUTTON_OFFSET_X_V  6
	#define ST_BUTTON_OFFSET_X_H  18
	#define ST_TIMER1_STR_OFFSET_X_V  (ST_BUTTON_OFFSET_X_V + 6)
	#define ST_TIMER1_STR_OFFSET_X_H  (ST_BUTTON_OFFSET_X_H + 6)
	#define ST_BUTTON_MARGIN  8
    ...
    #define CALENDAR_WEEKLY_SELECT_HEIGHT_V             31
...
#define CALENDAR_YEAR_TITLE_RECT_V 						{45, 4, 239, 28} //{45, 25, 239, 43}
    #define CALENDAR_MONTH_TITLE_RECT_V 	            {5, 10, 41, 52} //{5, 25, 41, 61}
    #define CALENDAR_MONTH_LINE0_TOP_V                  87
    #define CALENDAR_MONTH_ITEM0_LEFT_V                 1
    #define CALENDAR_SCH_TEXT_OFFSET_V                  5
    #define CALENDAR_POINT_Y_V                          305
    #define CALENDAR_LUNAR_TITLE_RECT_V 	            {45, 28, 239, 52}//{45, 43, 239, 61}
    ...
    #define CALENDAR_MONTH_WEEKLY_Y_V    				55 //70
	...
	#define CALENDAR_DAILY_DATE_FONT                    (SONG_FONT_14-CALENDAR_ETRUMP_ADJUST_SIZE) // Bug 1339920, 按日检视缩小字型较能对齐显示
    ...
    #define CALENDAR_YEAR_FONT                          SONG_FONT_24 //SONG_FONT_16
    #define CALENDAR_DATE_FONT                          SONG_FONT_30 //SONG_FONT_16
    #define CALENDAR_DAILY_DATE_FONT                    SONG_FONT_14 // Bug 1339920, 按日检视缩小字型较能对齐显示
...
#define CALENDAR_WEEK_TEXT_FONT   SONG_FONT_16
	...
	#define CALENDAR_DAILY_DATE_FONT                    (SONG_FONT_24-CALENDAR_ETRUMP_ADJUST_SIZE) // Bug 1339920, 按日检视缩小字型较能对齐显示
	...
	#define CALENDAR_DAILY_DATE_FONT                    SONG_FONT_22 // Bug 1339920, 按日检视缩小字型较能对齐显示
