...
#define MMIENVSET_CALL_RING_VOL_STANDARD_MODE  MMISET_VOL_SEVEN
#else    
#define MMIENVSET_CALL_RING_VOL_STANDARD_MODE  MMISET_VOL_EIGHT
#endif 
    // 安静环境
...
//#define MMIENVSET_CALL_RING_VOL_FLY_MODE       MMISET_VOL_FIVE
    ...
    // 普通环境
#ifdef MONOCHROME_LCD_SUPPORT 
#define MMIENVSET_MSG_RING_VOL_STANDARD_MODE   MMISET_VOL_SEVEN
#else    
#define MMIENVSET_MSG_RING_VOL_STANDARD_MODE   MMISET_VOL_EIGHT
#endif
    // 安静环境
...
#else    
#define MMIENVSET_COMM_VOL_STANDARD_MODE    MMISET_VOL_SEVEN//   MMISET_VOL_EIGHT
#endif 
    // 安静环境
...
#define MMIENVSET_TKEY_RING_VOL_BLUETOOTH_MODE      MMISET_VOL_SIX
    // --------------------------------------------------开关机音量-------------------------------------------------------------
    // 普通环境
#define MMIENVSET_POWER_RING_VOL_STANDARD_MODE      MMISET_VOL_MAX
    // 安静环境 
...
//#define MMIENVSET_POWER_RING_VOL_FLY_MODE           MMISET_VOL_THREE
    ...
    // ----------------------------------------------来电提示类型----------------------------------------------------------------
    // 普通环境
#define MMIENVSET_CALL_RING_TYPE_STANDARD_MODE      MMISET_CALL_RING
    // 安静环境
...
//#define MMIENVSET_CALL_RING_TYPE_FLY_MODE      MMISET_CALL_RING
    ...
    // ------------------------------------------------短信提示方式----------------------------------------------------------------
    // 普通环境
#define MMIENVSET_MSG_RING_TYPE_STANDARD_MODE  MMISET_MSG_RING
    // 安静环境
...
// -------------------------------------------- 按键音 类型 ------------------------------------------------------------------
// 普通环境
#define MMIENVSET_KEY_RING_TYPE_STANDARD_MODE         MMISET_OTHER_SILENT
// 安静环境
...
// 车内环境
#define MMIENVSET_KEY_RING_TYPE_INSIDE_MODE           MMISET_OTHER_SILENT
// 户外环境
#define MMIENVSET_KEY_RING_TYPE_NOISY_MODE            MMISET_OTHER_SILENT
    //耳机模式
#define MMIENVSET_KEY_RING_TYPE_EARPHONE_MODE         MMISET_OTHER_SILENT
    //蓝牙模式
#define MMIENVSET_KEY_RING_TYPE_BLUETOOTH_MODE        MMISET_OTHER_SILENT
// 飞行环境
...
// 普通环境
#define MMIENVSET_VOLTAGE_WARN_SWITCH_STANDARD_MODE          MMIENVSET_VOLTAGE_WARN_SWITCH_OPEN
// 安静环境
...
// 车内环境
#define MMIENVSET_VOLTAGE_WARN_SWITCH_INSIDE_MODE            MMIENVSET_VOLTAGE_WARN_SWITCH_OPEN
// 户外环境
...
// -----------------------------------------闹钟铃声音量-------------------------------------------------------------------------
// 普通环境
#define MMIENVSET_ALARM_RING_VOL_STANDARD_MODE       MMISET_VOL_SIX
// 安静环境
...
// -----------------------------------------闹钟提示方式-------------------------------------------------------------------------
// 普通环境
#define MMIENVSET_ALARM_RING_TYPE_STANDARD_MODE      MMISET_MSG_RING
// 安静环境
#define MMIENVSET_ALARM_RING_TYPE_SILENT_MODE	   MMISET_MSG_RING //  MMISET_MSG_SILENT
#ifdef ZDT_PRODUCT_VIBRATE
// 会议环境
#define MMIENVSET_ALARM_RING_TYPE_MEETING_MODE     MMISET_MSG_VIBRA_AND_RING//  MMISET_MSG_VIBRA
// 车内环境
