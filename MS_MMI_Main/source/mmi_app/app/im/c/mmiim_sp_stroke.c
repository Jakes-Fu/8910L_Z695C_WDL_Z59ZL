...
LOCAL void* Initialize(GUIIM_INIT_KERNEL_T *param_ptr)
{
    ...
    data_ptr->bar_cand.rect.top = data_ptr->bar_cand.rect.bottom - (GUI_GetFontHeight(SONG_FONT_20, UNICODE_HANZI) + 2) + 1;
    ...
    data_ptr->bar_edit.rect.top = data_ptr->bar_edit.rect.bottom - (GUI_GetFontHeight(SONG_FONT_20, UNICODE_HANZI) + 2) + 1;
