...
LOCAL __inline BOOLEAN IsVietnameseVowel(wchar wc)
{
    return (wc == 0x0041 || wc == 0x00C2 || wc == 0x0102 || wc == 0x0045
            || wc == 0x00CA || wc == 0x0049 || wc == 0x004F || wc == 0x00D4
            || wc == 0x01A0 || wc == 0x0055 || wc == 0x01AF || wc == 0x0059
            || wc == 0x0061 || wc == 0x00E2 || wc == 0x0103 || wc == 0x0065
            || wc == 0x00EA || wc == 0x0069 || wc == 0x006F || wc == 0x00F4
            || wc == 0x01A1 || wc == 0x0075 || wc == 0x01B0 || wc == 0x0079);
}


// add for yoruba basic vowel ( unicode 0x0301 0x0300)
LOCAL __inline BOOLEAN IsYorubaBasicChar(wchar wc)
{
    return ( wc ==0x0041|| wc == 0x0045|| wc == 0x0049|| wc ==  0x004F|| wc == 0x0055
        || wc == 0x0061|| wc == 0x0065|| wc == 0x0069|| wc == 0x006F|| wc == 0x0075
        || wc == 0x1EB8|| wc == 0x1EB9|| wc == 0x1ECC|| wc == 0x1ECD) ;
}


#define MMIIM_SP_KEYMAP_SPACE 0x0020/*0xF700*/
#define MMIIM_SP_KEYMAP_LINE_BREAK 0x000A/*0xF706*/
/*----------------------------------------------------------------------------*/
/*                          TYPE AND STRUCT                                   */
/*----------------------------------------------------------------------------*/
...
typedef wchar MMIIM_SP_KEYMAP_TABLE_T[MMIIM_SP_KEYMAP_COMBINE_MAX][5];
typedef MMIIM_SP_KEYMAP_TABLE_T const MMIIM_SP_KEYMAP_TABLE_DEF_T;
//多个unicode的组合
static MMIIM_SP_KEYMAP_TABLE_T keymap_combine_all = 
{
//TELUGU
/*Kye 1*/{0x0C15,0x0C4D, 0x0C37},/*E100*/
//Tamil
/*Kye 9*/{0x0B95, 0x0BCD, 0x0BB7},///1
/*Kye 9*/{0x0BB8, 0x0BCD, 0x0BB0, 0x0BC0},///2
//Sinhala
/*Kye 1*/{0x0DCA, 0x200D, 0x0DBB},///3
/*Kye 1*/{0x0DCA, 0x200D, 0x0DBA},///4
/*Kye 9*/{0x0DC5, 0x0DD4},///5
/*Kye 9*/{0x0DC5, 0x0DD6},///6
//Oriya
/*Kye 0*/{0x0B15, 0x0B4D, 0x0B37},///7
/*Kye 1*/{0x0B30, 0x0B4D},///8
/*Kye 1*/{0x0B4D, 0x0B5F},///9
//Myanmar
/*Kye 1*/{0x1004, 0x103A, 0x1039},///10
//Marathi
/*Kye 1*/{0x0930, 0x094D},///11
/*Kye 3*/{0x0905, 0x0945},///12
/*Kye 9*/{0x0915,0x094D,0x0937},///13
/*Kye 9*/{0x091C,0x094D,0x091E},///14
//Malayalam
/*Kye 0*/{0x0D33, 0x0D4D, 0x200D},///15
/*Kye 6*/{0x0D23, 0x0D4D, 0x200D},///16
/*Kye 7*/{0x0D28, 0x0D4D, 0x200D},///17
/*Kye 9*/{0x0D30, 0x0D4D, 0x200D},///18
/*Kye 9*/{0x0D32, 0x0D4D, 0x200D},///19
//Malagasy (not support)
///*Kye 6L*/{},
///*Kye 6U*/{},
//Khmer
/*Kye 1*/{0x17BB,0x17C6},///20
/*Kye 1*/{0x17BB,0x17C7},///21
/*Kye 3*/{0x17B6,0x17C6},///22
/*Kye 3*/{0x17C1,0x17C7},///23
/*Kye 3*/{0x17C4,0x17C7},///24
//Kannada
/*Kye 1*/{0x0CB0,0x0CCD},///25
//Hindi
/*Kye 1*/{0x0930,0x094D},///26
/*Kye 1*/{0x094D,0x0930},///27
//Gujarati
/*Kye 1*/{0x0AB0, 0x0ACD},///28
//Bengali-IN (not support)
///*Kye 1*/{},
//Assamese
/*Kye 0*/{0x0995, 0x09CD, 0x09B7},///29
/*Kye 1*/{0x09F0, 0x09CD},///30
/*Kye 1*/{0x09CD, 0x09AF},///31
/*Kye 1*/{0x09CD, 0x09F0},///32
/*Kye 1*/{0x09A4, 0x09CD, 0x200D},///33

//Marathi
/*Kye 9*/{0x0931,0x094D,0x200D},///34

//Sinhala-1
/*Kye 1*/{0x0DCA,0x200D},//35 
//Hindi
/*Kye ?*/{0x0936,0x094D,0x0930},///36
//Bengali-BD
/*Kye 1*/{0x09cd,0x09b0},//37
//Bengali-BD
/*Kye 1*/{0x09cd,0x09af},//38
//Bengali-BD
/*Kye 1*/{0x09b0,0x09cd},//39
};
/*---------------------------------------------------------------------------*/
/*                          CONSTANT ARRAY                                   */
/*---------------------------------------------------------------------------*/
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_abc_lower =
{
    ...
    /*8*/{4, 't', 'u', 'v', '8'},
    /*9*/{5, 'w', 'x', 'y', 'z', '9'},
    /*0*/{3, ' ', '0', MMIIM_SP_KEYMAP_LINE_BREAK},
    /***/{0},
    /*#*/{0}
};
...
#elif defined MMIIM_T9_MULTITAP
//English-GB
//注意!!!更新s_key_table_abc_lower和s_key_table_abc_upper时，需要同步更新abc_enable_char_value@ctrlbaseedit_im.c
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_abc_lower =
{
    /*1*/{14, 0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{12, 0x0061, 0x0062, 0x0063, 0x0032, 0x00E4, 0x00E6, 0x00E5, 0x00E0, 0x00E1, 0x00E2, 0x00E3, 0x00E7},
    /*3*/{9, 0x0064, 0x0065, 0x0066, 0x0033, 0x00E8, 0x00E9, 0x00EA, 0x00EB, 0x00F0},
    /*4*/{8, 0x0067, 0x0068, 0x0069, 0x0034, 0x00EC, 0x00ED, 0x00EE, 0x00EF},
    /*5*/{5, 0x006A, 0x006B, 0x006C, 0x0035, 0x00A3},
    /*6*/{11, 0x006D, 0x006E, 0x006F, 0x0036, 0x00F6, 0x00F8, 0x00F2, 0x00F3, 0x00F4, 0x00F5, 0x00F1},
    /*7*/{7, 0x0070, 0x0071, 0x0072, 0x0073, 0x0037, 0x00DF, 0x0024},
    /*8*/{8, 0x0074, 0x0075, 0x0076, 0x0038, 0x00F9, 0x00FA, 0x00FB, 0x00FC},
    /*9*/{7, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039, 0x00FD, 0x00FE},  
    /*0*/{3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK}, 
};
...
{
    /*1*/{14, 0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{12, 0x0041, 0x0042, 0x0043, 0x0032, 0x00C4, 0x00C6, 0x00C5, 0x00C0, 0x00C1, 0x00C2, 0x00C3, 0x00C7},
    /*3*/{9, 0x0044, 0x0045, 0x0046, 0x0033, 0x00C8, 0x00C9, 0x00CA, 0x00CB, 0x00D0},
    /*4*/{8, 0x0047, 0x0048, 0x0049, 0x0034, 0x00CC, 0x00CD, 0x00CE, 0x00CF},
    /*5*/{5, 0x004A, 0x004B, 0x004C, 0x0035, 0x00A3},
    /*6*/{11, 0x004D, 0x004E, 0x004F, 0x0036, 0x00D6, 0x00D8, 0x00D2, 0x00D3, 0x00D4, 0x00D5, 0x00D1},
    /*7*/{6, 0x0050, 0x0051, 0x0052, 0x0053, 0x0037, 0x0024},
    /*8*/{8, 0x0054, 0x0055, 0x0056, 0x0038, 0x00D9, 0x00DA, 0x00DB, 0x00DC},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_swahili_lower =
{
    /*1*/{14, 0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{12, 0x0061, 0x0062, 0x0063, 0x0032, 0x00E4, 0x00E6, 0x00E5, 0x00E0, 0x00E1, 0x00E2, 0x00E3, 0x00E7},
    /*3*/{9, 0x0064, 0x0065, 0x0066, 0x0033, 0x00E8, 0x00E9, 0x00EA, 0x00EB, 0x00F0},
...
//大写字母与数字
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_swahili_upper =
{
    /*1*/{14, 0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{12, 0x0041, 0x0042, 0x0043, 0x0032, 0x00C4, 0x00C6, 0x00C5, 0x00C0, 0x00C1, 0x00C2, 0x00C3, 0x00C7},
    /*3*/{9, 0x0044, 0x0045, 0x0046, 0x0033, 0x00C8, 0x00C9, 0x00CA, 0x00CB, 0x00D0},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_malay_lower =
{
    /*1*/{14, 0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{12, 0x0061, 0x0062, 0x0063, 0x0032, 0x00E4, 0x00E6, 0x00E5, 0x00E0, 0x00E1, 0x00E2, 0x00E3, 0x00E7},
    /*3*/{9, 0x0064, 0x0065, 0x0066, 0x0033, 0x00E8, 0x00E9, 0x00EA, 0x00EB, 0x00F0},
...
//大写字母与数字
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_malay_upper =
{
    /*1*/{14, 0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{12, 0x0041, 0x0042, 0x0043, 0x0032, 0x00C4, 0x00C6, 0x00C5, 0x00C0, 0x00C1, 0x00C2, 0x00C3, 0x00C7},
    /*3*/{9, 0x0044, 0x0045, 0x0046, 0x0033, 0x00C8, 0x00C9, 0x00CA, 0x00CB, 0x00D0},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_xhosa_upper =
{
    /*1*/{14, 0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{12, 0x0041, 0x0042, 0x0043, 0x0032, 0x00C4, 0x00C6, 0x00C5, 0x00C0, 0x00C1, 0x00C2, 0x00C3, 0x00C7},
    /*3*/{9, 0x0044, 0x0045, 0x0046, 0x0033, 0x00C8, 0x00C9, 0x00CA, 0x00CB, 0x00D0},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_xhosa_lower =
{
    /*1*/{14, 0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{12, 0x0061, 0x0062, 0x0063, 0x0032, 0x00E4, 0x00E6, 0x00E5, 0x00E0, 0x00E1, 0x00E2, 0x00E3, 0x00E7},
    /*3*/{9, 0x0064, 0x0065, 0x0066, 0x0033, 0x00E8, 0x00E9, 0x00EA, 0x00EB, 0x00F0},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_zulu_upper =
{
    /*1*/{14, 0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{12, 0x0041, 0x0042, 0x0043, 0x0032, 0x00C4, 0x00C6, 0x00C5, 0x00C0, 0x00C1, 0x00C2, 0x00C3, 0x00C7},
    /*3*/{9, 0x0044, 0x0045, 0x0046, 0x0033, 0x00C8, 0x00C9, 0x00CA, 0x00CB, 0x00D0},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_zulu_lower =
{
    /*1*/{14, 0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{12, 0x0061, 0x0062, 0x0063, 0x0032, 0x00E4, 0x00E6, 0x00E5, 0x00E0, 0x00E1, 0x00E2, 0x00E3, 0x00E7},
    /*3*/{9, 0x0064, 0x0065, 0x0066, 0x0033, 0x00E8, 0x00E9, 0x00EA, 0x00EB, 0x00F0},
...
{
    /*1*/{ 7, 0x002E, 0x060C, 0x061B, 0x061F, 0x0021, 0x0031, 0x003A, 0x0661},
    /*2*/{ 7, 0x0628, 0x062A, 0x0629, 0x062B, 0x0640, 0x0032, 0x0662},
    /*3*/{ 10, 0x0627, 0x0623, 0x0625, 0x0622, 0x0649, 0x0624, 0x0626, 0x0621, 0x0033, 0x0663},
    /*4*/{ 6, 0x0633, 0x0634, 0x0635, 0x0636, 0x0034, 0x0664},
    /*5*/{ 6, 0x062F, 0x0630, 0x0631, 0x0632, 0x0035, 0x0665},
    /*6*/{ 5, 0x062C, 0x062D, 0x062E, 0x0036, 0x0666},
    /*7*/{ 6, 0x0646, 0x0647, 0x0648, 0x064A, 0x0037, 0x0667},
    /*8*/{ 7, 0x0641, 0x0642, 0x0643, 0x0644, 0x0645, 0x0038, 0x0668},
    /*9*/{ 6, 0x0637, 0x0638, 0x0639, 0x063A, 0x0039, 0x0669},
    /*0*/{ 4, ' ', '0', 0x0660, MMIIM_SP_KEYMAP_LINE_BREAK},
    /***/{0},
    /*#*/{0}
};
#elif defined MMIIM_SOGOU_MULTITAP
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_arabic =
{
    /*1*/{ 7, 0x002E, 0x061F, 0x003A, 0x060C, 0x0021, 0x0031, 0x0661},
    /*2*/{ 6, 0x0628, 0x062A, 0x0629, 0x062B, 0x0032, 0x0662},
    /*3*/{10, 0x0627, 0x0623, 0x0625, 0x0622, 0x0649, 0x0624, 0x0626, 0x0621, 0x0033, 0x0663},
    /*4*/{ 6, 0x0633, 0x0634, 0x0635, 0x0636, 0x0034, 0x0664},
    /*5*/{ 6, 0x062F, 0x0630, 0x0631, 0x0632, 0x0035, 0x0665},
    /*6*/{ 5, 0x062C, 0x062D, 0x062E, 0x0036, 0x0666},
    ...
    /*8*/{ 7, 0x0641, 0x0642, 0x0643, 0x0644, 0x0645, 0x0038, 0x0668},
    /*9*/{ 6, 0x0637, 0x0638, 0x0639, 0x063A, 0x0039, 0x0669},
    /*0*/{ 4, 0x0020, 0x0030, 0x0660, MMIIM_SP_KEYMAP_LINE_BREAK},
};
#else
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_arabic =
{
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_french_upper =
{
    /*1*/  {14,0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  {12,0x0041, 0x0042, 0x0043, 0x0032, 0x00C0, 0x00C2, 0x00C6, 0x00C7, 0x00C4, 0x00C1, 0x00C3},
    /*3*/  {8, 0x0044, 0x0045, 0x0046, 0x0033, 0x00C9, 0x00C8, 0x00CA, 0x00CB},
    /*4*/  {10,0x0047, 0x0048, 0x0049, 0x0034, 0x00CF, 0x00CE, 0x00CC, 0x00CD, 0x011E, 0x0130},
    /*5*/  {4, 0x004A, 0x004B, 0x004C, 0x0035},
    /*6*/  {11,0x004D, 0x004E, 0x004F, 0x0036, 0x00D4, 0x0152, 0x00D6, 0x00D1, 0x00D2, 0x00D3, 0x00D8},
    /*7*/  {6, 0x0050, 0x0051, 0x0052, 0x0053, 0x0037, 0x0024},
    /*8*/  {8, 0x0054, 0x0055, 0x0056, 0x0038, 0x00DB, 0x00D9, 0x00DC, 0x00DA},
    /*9*/  {6, 0x0057, 0x0058, 0x0059, 0x005A, 0x0039, 0x0178},
    /*0*/  {3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_french_lower =
{
    /*1*/  {14,0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  {11,0x0061, 0x0062, 0x0063, 0x0032, 0x00E0, 0x00E2, 0x00E6, 0x00E7, 0x00E4, 0x00E1, 0x00E3},
    /*3*/  {8, 0x0064, 0x0065, 0x0066, 0x0033, 0x00E9, 0x00E8, 0x00EA, 0x00EB},
    /*4*/  {10,0x0067, 0x0068, 0x0069, 0x0034, 0x00EF, 0x00EE, 0x00EC, 0x00ED, 0x011F, 0x0131},
    /*5*/  {4, 0x006A, 0x006B, 0x006C, 0x0035},
    /*6*/  {11,0x006D, 0x006E, 0x006F, 0x0036, 0x00F4, 0x0153, 0x00F6, 0x00F1, 0x00F2, 0x00F3, 0x00F8},
    /*7*/  {7, 0x0070, 0x0071, 0x0072, 0x0073, 0x0037, 0x0024, 0x00DF},
    /*8*/  {8, 0x0074, 0x0075, 0x0076, 0x0038, 0x00FB, 0x00F9, 0x00FC, 0x00FA},
    /*9*/  {6, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039, 0x00FF},
    /*0*/  {3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
#else
...
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{12, 0x0041, 0x0042, 0x0043, 0x0032, 0x00C4, 0x00C0, 0x00C1, 0x00C3, 0x00C2, 0x00C5, 0x00C6, 0x00C7},
    /*3*/{ 9, 0x0044, 0x0045, 0x0046, 0x0033, 0x00C8, 0x00C9, 0x00CB, 0x00CA, 0x00D0},
    /*4*/{ 8, 0x0047, 0x0048, 0x0049, 0x0034, 0x00CC, 0x00CD, 0x00CE, 0x00CF},
    /*5*/{ 5, 0x004A, 0x004B, 0x004C, 0x0035, 0x00A3},
    /*6*/{11, 0x004D, 0x004E, 0x004F, 0x0036, 0x00D6, 0x00D2, 0x00D3, 0x00D4, 0x00D5, 0x00D8, 0x00D1},
    /*7*/{ 6, 0x0050, 0x0051, 0x0052, 0x0053, 0x0037, 0x0024},
    /*8*/{ 8, 0x0054, 0x0055, 0x0056, 0x0038, 0x00DC, 0x00D9, 0x00DA, 0x00DB},
    /*9*/{ 7, 0x0057, 0x0058, 0x0059, 0x005A, 0x0039, 0x00DD, 0x00DE},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_german_lower =
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{12, 0x0061, 0x0062, 0x0063, 0x0032, 0x00E4, 0x00E0, 0x00E1, 0x00E3, 0x00E2, 0x00E5, 0x00E6, 0x00E7},
    /*3*/{ 9, 0x0064, 0x0065, 0x0066, 0x0033, 0x00E8, 0x00E9, 0x00EB, 0x00EA, 0x00F0},
    /*4*/{ 8, 0x0067, 0x0068, 0x0069, 0x0034, 0x00EC, 0x00ED, 0x00EE, 0x00EF},
    /*5*/{ 5, 0x006A, 0x006B, 0x006C, 0x0035, 0x00A3},
    /*6*/{11, 0x006D, 0x006E, 0x006F, 0x0036, 0x00F6, 0x00F2, 0x00F3, 0x00F4, 0x00F5, 0x00F8, 0x00F1},
    /*7*/{ 7, 0x0070, 0x0071, 0x0072, 0x0073, 0x0037, 0x00DF, 0x0024},
    /*8*/{ 8, 0x0074, 0x0075, 0x0076, 0x0038, 0x00FC, 0x00F9, 0x00FA, 0x00FB},
    /*9*/{ 7, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039, 0x00FD, 0x00FE},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
#else
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_greek_upper =
{
    /*1*/{15, 0x002E, 0x002C, 0x0021, 0x003B, 0x003F, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{ 8, 0x0391, 0x0392, 0x0393, 0x0032, 0x0386, 0x0041, 0x0042, 0x0043},
    /*3*/{ 8, 0x0394, 0x0395, 0x0396, 0x0033, 0x0388, 0x0044, 0x0045, 0x0046},
    /*4*/{10, 0x0397, 0x0398, 0x0399, 0x0034, 0x0389, 0x038A, 0x03AA, 0x0047, 0x0048, 0x0049},
    /*5*/{ 7, 0x039A, 0x039B, 0x039C, 0x0035, 0x004A, 0x004B, 0x004C},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_hindi = 
{
    /*1*/ {18, 0x0901, 0x0902, 0x0903, MMIIM_SP_KEYMAP_COMBINE_START+26, MMIIM_SP_KEYMAP_COMBINE_START+27, 0x094D, 0x0970, 0x0950, 0x0964, 0x0965, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x002D, 0x0031, 0x0967},
    /*2*/ {15, 0x093E, 0x093F, 0x0940, 0x0941, 0x0942, 0x0943, 0x0905, 0x0906, 0x0907, 0x0908, 0x0909, 0x090A, 0x090B, 0x0032, 0x0968},
    /*3*/ {14, 0x0947, 0x0948, 0x0945, 0x094B, 0x094C, 0x0949, 0x090F, 0x0910, 0x090D, 0x0913, 0x0914, 0x0911, 0x0033, 0x0969},
    /*4*/ {12, 0x0915, 0x0916, 0x0917, 0x0918, 0x0919, 0x0958, 0x0959, 0x095A, 0x090C, 0x0944, 0x0034, 0x096A},
    /*5*/ {8, 0x091A, 0x091B, 0x091C, 0x091D, 0x091E, 0x095B, 0x0035, 0x096B},
    /*6*/ {9, 0x091F, 0x0920, 0x0921, 0x0922, 0x0923, 0x095C, 0x095D, 0x0036, 0x096C},
    /*7*/ {12, 0x0924, 0x0925, 0x0926, 0x0927, 0x0928, 0x0929, 0x0960, 0x0961, 0x0962, 0x0963, 0x0037, 0x096D},
    /*8*/ {10, 0x092A, 0x092B, 0x092C, 0x092D, 0x092E, 0x095E, MMIIM_SP_KEYMAP_COMBINE_START+36, 0x200C, 0x0038, 0x096E},
    /*9*/ {14, 0x092F, 0x0930, 0x0932, 0x0935, 0x0936, 0x0937, 0x0938, 0x0939, 0x0933, 0x0931, 0x0934, 0x095F, 0x0039, 0x096F},
    /*0*/{ 4, ' ', '0', 0x0966, MMIIM_SP_KEYMAP_LINE_BREAK},
    /***/{0},
    /*#*/{0}
};
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_hindi =
{
    /*1*/{13, 0x0901, 0x0902, 0x0903, MMIIM_SP_KEYMAP_COMBINE_START+26, MMIIM_SP_KEYMAP_COMBINE_START+27, 0x094D, 0x0031, 0x0964, 0x002E, 0x002C, 0x003F, 0x0021, 0x0967},
    /*2*/{15, 0x0905, 0x0906, 0x0907, 0x0908, 0x0909, 0x090A, 0x090B, 0x093E, 0x093F, 0x0940, 0x0941, 0x0942, 0x0943, 0x0032, 0x0968},
    /*3*/{14, 0x090F, 0x0910, 0x090D, 0x0913, 0x0914, 0x0911, 0x0947, 0x0948, 0x0945, 0x094B, 0x094C, 0x0949, 0x0033, 0x0969},
    /*4*/{ 10, 0x0915, 0x0916, 0x0917, 0x0918, 0x0919, 0x0034, 0x0958, 0x0959, 0x095A, 0x096A},
    /*5*/{ 8, 0x091A, 0x091B, 0x091C, 0x091D, 0x091E, 0x0035, 0x095B, 0x096B},
    /*6*/{ 9, 0x091F, 0x0920, 0x0921, 0x0922, 0x0923, 0x0036, 0x095C, 0x095D, 0x096C},
    /*7*/{ 8, 0x0924, 0x0925, 0x0926, 0x0927, 0x0928, 0x0037, 0x0929, 0x096D},
    /*8*/{ 8, 0x092A, 0x092B, 0x092C, 0x092D, 0x092E, 0x0038, 0x095E, 0x096E},
    /*9*/{14, 0x092F, 0x0930, 0x0932, 0x0933, 0x0935, 0x0936, 0x0937, 0x0938, 0x0939, 0x0039, 0x0931, 0x0934, 0x095F, 0x096F},
    /*0*/{ 4, 0x0020, 0x0030, 0x0966, MMIIM_SP_KEYMAP_LINE_BREAK},
};
...
#if defined(SPECIAL_NEPALI)  //special   908
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_nepali = 
{
    /*1*/ {4, 0x0901, 0x0902, 0x0903,0x094D},
    /*2*/ {13,0x0905, 0x0906, 0x0907, 0x0908, 0x0909, 0x090A, 0x090B,0x093E, 0x093F, 0x0940,0x0941, 0x0942, 0x0943},
    /*3*/ {12,0x090D, 0x090F, 0x0910, 0x0911, 0x0913, 0x0914,0x0945, 0x0947, 0x0948, 0x0949, 0x094B,0x094C},
    /*4*/ {8, 0x0915, 0x0916, 0x0917, 0x0918, 0x0919, 0x0958, 0x0959, 0x095A},
    /*5*/ {6, 0x091A, 0x091B, 0x091C, 0x091D, 0x091E, 0x095B},
    /*6*/ {7, 0x091F, 0x0920, 0x0921, 0x0922, 0x0923, 0x095C, 0x095D},
    /*7*/ {6, 0x0924, 0x0925, 0x0926, 0x0927, 0x0928, 0x0929},
    /*8*/ {6, 0x092A, 0x092B, 0x092C, 0x092D, 0x092E, 0x095E},
    /*9*/ {12,0x092F, 0x0930, 0x0931, 0x0932, 0x0933, 0x0934,0x0935, 0x0936, 0x0937, 0x0938, 0x0939,0x095F},
    /*0*/ {2, 0x0020, 0x0030},
    /***/ {0},
    /*#*/ {0}
};
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_nepalimatra =
{
    /*1*/ {4, 0x0901, 0x0902, 0x0903,0x094D},
    /*2*/ {13,0x0905, 0x0906, 0x0907, 0x0908, 0x0909, 0x090A, 0x090B,0x093E, 0x093F, 0x0940,0x0941, 0x0942, 0x0943},
    /*3*/ {12,0x090D, 0x090F, 0x0910, 0x0911, 0x0913, 0x0914,0x0945, 0x0947, 0x0948, 0x0949, 0x094B,0x094C},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_nepalimatra1 =
{
    /*1*/ {4, 0x0901, 0x0902, 0x0903,0x094D},
    /*2*/ {13,0x0905, 0x0906, 0x0907, 0x0908, 0x0909, 0x090A, 0x090B,0x093E, 0x093F, 0x0940,0x0941, 0x0942, 0x0943},
    /*3*/ {12,0x090D, 0x090F, 0x0910, 0x0911, 0x0913, 0x0914,0x0945, 0x0947, 0x0948, 0x0949, 0x094B,0x094C},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_nepalimatra2 =
{
    /*1*/ {4, 0x0901, 0x0902, 0x0903,0x094D},
    /*2*/ {13,0x0905, 0x0906, 0x0907, 0x0908, 0x0909, 0x090A, 0x090B,0x093E, 0x093F, 0x0940,0x0941, 0x0942, 0x0943},
    /*3*/ {12,0x090D, 0x090F, 0x0910, 0x0911, 0x0913, 0x0914,0x0945, 0x0947, 0x0948, 0x0949, 0x094B,0x094C},
...
#endif
#endif/*IM_NEPALI_SUPPORT*/

#ifdef IM_SINHALESE_SUPPORT//ZHMCH
#if defined(MMIIM_IEKIE_MULTITAP)

//mini版
#if defined(INPUT_METHOD_IEKIE_COMMON_MINI)

#if defined(SPECIAL_SINHALA)  //special   908
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_sinhala = 
{
	/*1*/  {5, '1','.',',','?','!'},
	/*2*/  {9, 0x0D85, 0x0D86, 0x0D87, 0x0D88, 0x0D89, 0x0D8A, 0x0D8B, 0x0D8C, 0x0032},    
	/*3*/  {8, 0x0D91, 0x0D92, 0x0D94, 0x0D95, 0x0033, 0x0D93, 0x0D96, 0x0D8D},    
	/*4*/  {7, 0x0D9A, 0x0D9C, 0x0D9F, 0x0034, 0x0D9B, 0x0D9D, 0x0D9E},    
	/*5*/  {7, 0x0DA0, 0x0DA2, 0x0DA4, 0x0035, 0x0DA5, 0x0DA1, 0x0DA3},    
	/*6*/  {6, 0x0DA7, 0x0DA9, 0x0DAC, 0x0036, 0x0DA8, 0x0DAA},    
	/*7*/  {8, 0x0DAD, 0x0DAF, 0x0DB1, 0x0037, 0x0DAB, 0x0DB3, 0x0DAE, 0x0DB0},    
	/*8*/  {7, 0x0DB4, 0x0DB6, 0x0DB8, 0x0038, 0x0DB9, 0x0DB5, 0x0DB7},    
	/*9*/  {5, 0x0DBA, 0x0DBB, 0x0DBD, 0x0039, 0x0DC5},    
	/*0*/  {9, ' ',0x0DC0,0x0DC3,0x0DC4,0x0030, MMIIM_SP_KEYMAP_LINE_BREAK, 0x0DC1,0x0DC2,0x0DC6},
    /***/  {0},
    /*#*/  {0}
};
#else   //907
...
#endif      //INPUT_METHOD_IEKIE_COMMON_MINI

#else       //非INPUT_METHOD_IEKIE_COMMON_MINI mini版

#if defined(SPECIAL_SINHALA)  //special   906, 与908相同
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_sinhala = 
{
	/*1*/  {5, '1','.',',','?','!'},
	/*2*/  {9, 0x0D85, 0x0D86, 0x0D87, 0x0D88, 0x0D89, 0x0D8A, 0x0D8B, 0x0D8C, 0x0032},    
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_sinhala = 
{
	/*1*/  {10, '1','.',',','?','!', 0x0DCA, MMIIM_SP_KEYMAP_COMBINE_START+3, MMIIM_SP_KEYMAP_COMBINE_START+4, 0x0D82, 0x0D83},
	/*2*/  {16, 0x0D85, 0x0D86, 0x0D87, 0x0D88, 0x0D89, 0x0D8A, 0x0D8B, 0x0D8C, 0x0DCF, 0x0DD0, 0x0DD1, 0x0DD2, 0x0DD3, 0x0DD4, 0x0DD6, 0x0032},    
	/*3*/  {16, 0x0D91, 0x0D92, 0x0D94, 0x0D95, 0x0DD9, 0x0DDA, 0x0DDC, 0x0DDD, 0x0033, 0x0D93, 0x0D96, 0x0D8D, 0x0DDB, 0x0DDE, 0x0DD8, 0x0DF2},    
	/*4*/  {7, 0x0D9A, 0x0D9C, 0x0D9F, 0x0034, 0x0D9B, 0x0D9D, 0x0D9E},    
	/*5*/  {7, 0x0DA0, 0x0DA2, 0x0DA4, 0x0035, 0x0DA5, 0x0DA1, 0x0DA3},    
	/*6*/  {6, 0x0DA7, 0x0DA9, 0x0DAC, 0x0036, 0x0DA8, 0x0DAA},    
	/*7*/  {8, 0x0DAD, 0x0DAF, 0x0DB1, 0x0037, 0x0DAB, 0x0DB3, 0x0DAE, 0x0DB0},    
	/*8*/  {7, 0x0DB4, 0x0DB6, 0x0DB8, 0x0038, 0x0DB9, 0x0DB5, 0x0DB7},    
	/*9*/  {7, 0x0DBA, 0x0DBB, 0x0DBD, 0x0039, 0x0DC5, MMIIM_SP_KEYMAP_COMBINE_START+5, MMIIM_SP_KEYMAP_COMBINE_START+6},    
	/*0*/  {9, ' ',0x0DC0,0x0DC3,0x0DC4,0x0030, MMIIM_SP_KEYMAP_LINE_BREAK, 0x0DC1,0x0DC2,0x0DC6},
    /***/  {0},
    /*#*/  {0}
};
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_sinhala =
{
	...
	/*8*/  {7, 0x0DB4, 0x0DB6, 0x0DB8, 0x0038, 0x0DB9, 0x0DB5, 0x0DB7},    
	/*9*/  {5, 0x0DBA, 0x0DBB, 0x0DBD, 0x0039, 0x0DC5},    
	/*0*/  {8, ' ',    0x0DC0, 0x0DC3, 0x0DC4, 0x0030, 0x0DC1, 0x0DC2, 0x0DC6},
    /***/  {0},
    /*#*/  {0}

};

static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_sinhalamatra =
{
	/*1*/  {5, '1','.',',','?','!'},
	/*2*/  {9, 0x0D85, 0x0D86, 0x0D87, 0x0D88, 0x0D89, 0x0D8A, 0x0D8B, 0x0D8C, 0x0032},    
	/*3*/  {8, 0x0D91, 0x0D92, 0x0D94, 0x0D95, 0x0033, 0x0D93, 0x0D96, 0x0D8D},    
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_sinhalamatra1 =
{
	/*1*/  {5, '1','.',',','?','!'},
	/*2*/  {9, 0x0D85, 0x0D86, 0x0D87, 0x0D88, 0x0D89, 0x0D8A, 0x0D8B, 0x0D8C, 0x0032},    
	/*3*/  {8, 0x0D91, 0x0D92, 0x0D94, 0x0D95, 0x0033, 0x0D93, 0x0D96, 0x0D8D},    
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_sinhalamatra2 =
{
	/*1*/  {5, '1','.',',','?','!'},
	/*2*/  {9, 0x0D85, 0x0D86, 0x0D87, 0x0D88, 0x0D89, 0x0D8A, 0x0D8B, 0x0D8C, 0x0032},    
	/*3*/  {8, 0x0D91, 0x0D92, 0x0D94, 0x0D95, 0x0033, 0x0D93, 0x0D96, 0x0D8D},    
...
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{11, 0x0041, 0x00C1, 0x0042, 0x0043, 0x0032, 0x00C2, 0x00C4, 0x0102, 0x0104, 0x0106, 0x010C},
    /*3*/{ 9, 0x0044, 0x0045, 0x00C9, 0x0046, 0x0033, 0x010E, 0x0110, 0x0118, 0x011A},
    /*4*/{ 6, 0x0047, 0x0048, 0x0049, 0x00CD, 0x0034, 0x00CE},
    /*5*/{ 5, 0x004A, 0x004B, 0x004C, 0x0035, 0x00A3},
    /*6*/{10, 0x004D, 0x004E, 0x004F, 0x00D3, 0x00D6, 0x0150, 0x0036, 0x0143, 0x0147, 0x00D4},
    /*7*/{11, 0x0050, 0x0051, 0x0052, 0x0053, 0x0037, 0x0154, 0x0158, 0x015A, 0x015E, 0x0160, 0x0024},
    /*8*/{10, 0x0054, 0x0055, 0x00DA, 0x00DC, 0x0170, 0x0056, 0x0038, 0x0162, 0x0164, 0x016E},
    /*9*/{ 9, 0x0057, 0x0058, 0x0059, 0x005A, 0x0039, 0x00DD, 0x0179, 0x017B, 0x017D},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
...
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{11, 0x0061, 0x00E1, 0x0062, 0x0063, 0x0032, 0x00E2, 0x00E4, 0x0103, 0x0105, 0x0107, 0x010D},
    /*3*/{ 9, 0x0064, 0x0065, 0x00E9, 0x0066, 0x0033, 0x010F, 0x0111, 0x0119, 0x011B},
    /*4*/{ 6, 0x0067, 0x0068, 0x0069, 0x00ED, 0x0034, 0x00EE},
    /*5*/{ 5, 0x006A, 0x006B, 0x006C, 0x0035, 0x00A3},
    /*6*/{10, 0x006D, 0x006E, 0x006F, 0x00F3, 0x00F6, 0x0151, 0x0036, 0x0144, 0x0148, 0x00F4},
    /*7*/{12, 0x0070, 0x0071, 0x0072, 0x0073, 0x0037, 0x0155, 0x0159, 0x015B, 0x015F, 0x0161, 0x00DF, 0x0024},
    /*8*/{10, 0x0074, 0x0075, 0x00FA, 0x00FC, 0x0171, 0x0076, 0x0038, 0x0163, 0x0165, 0x016F},
    /*9*/{ 9, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039, 0x00FD, 0x017A, 0x017C, 0x017E},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
#else
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_hungarian_upper =
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_indonesian_lower =
{
    ...
    /*5*/{ 5, 0x006A, 0x006B, 0x006C, 0x0035, 0x00A3},
    /*6*/{ 4, 0x006D, 0x006E, 0x006F, 0x0036},
    /*7*/{ 6, 0x0070, 0x0071, 0x0072, 0x0073, 0x0037, 0x0024},
    /*8*/{ 4, 0x0074, 0x0075, 0x0076, 0x0038},
    /*9*/{ 5, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
...
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{12, 0x0041, 0x0042, 0x0043, 0x0032, 0x00C0, 0x00C1, 0x00C4, 0x00C2, 0x00C3, 0x00C5, 0x00C6, 0x00C7},
    /*3*/{ 9, 0x0044, 0x0045, 0x0046, 0x0033, 0x00C8, 0x00C9, 0x00CB, 0x00CA, 0x00D0},
    /*4*/{ 8, 0x0047, 0x0048, 0x0049, 0x0034, 0x00CC, 0x00CD, 0x00CF, 0x00CE},
    /*5*/{ 5, 0x004A, 0x004B, 0x004C, 0x0035, 0x00A3},
    /*6*/{12, 0x004D, 0x004E, 0x004F, 0x0036, 0x00D2, 0x00BA, 0x00D3, 0x00D6, 0x00D4, 0x00D5, 0x00D8, 0x00D1},
    /*7*/{ 6, 0x0050, 0x0051, 0x0052, 0x0053, 0x0037, 0x0024},
    /*8*/{ 8, 0x0054, 0x0055, 0x0056, 0x0038, 0x00D9, 0x00DA, 0x00DC, 0x00DB},
    /*9*/{ 7, 0x0057, 0x0058, 0x0059, 0x005A, 0x0039, 0x00DD, 0x00DE},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_italian_lower =
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{12, 0x0061, 0x0062, 0x0063, 0x0032, 0x00E0, 0x00E1, 0x00E4, 0x00E2, 0x00E3, 0x00E5, 0x00E6, 0x00E7},
    /*3*/{ 9, 0x0064, 0x0065, 0x0066, 0x0033, 0x00E8, 0x00E9, 0x00EB, 0x00EA, 0x00F0},
    /*4*/{ 8, 0x0067, 0x0068, 0x0069, 0x0034, 0x00EC, 0x00ED, 0x00EF, 0x00EE},
    /*5*/{ 5, 0x006A, 0x006B, 0x006C, 0x0035, 0x00A3},
    /*6*/{12, 0x006D, 0x006E, 0x006F, 0x0036, 0x00F2, 0x00BA, 0x00F3, 0x00F6, 0x00F4, 0x00F5, 0x00F8, 0x00F1},
    /*7*/{ 7, 0x0070, 0x0071, 0x0072, 0x0073, 0x0037, 0x00DF, 0x0024},
    /*8*/{ 8, 0x0074, 0x0075, 0x0076, 0x0038, 0x00F9, 0x00FA, 0x00FC, 0x00FB},
    /*9*/{ 7, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039, 0x00FD, 0x00FE},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
#else
...
#if (defined(MMIIM_CSTAR_MULTITAP) || defined(MMIIM_IEKIE_MULTITAP))
#if (defined(INPUT_METHOD_CSTAR_COMMON_MINI) || defined(INPUT_METHOD_IEKIE_COMMON_MINI))     //mini版本，使用469 or 467
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_persian =
{
    /*1*/  {6, 0x002E, 0x061F, 0x003A, 0x060C, 0x0021, 0x0031},
    /*2*/  {6, 0x0628, 0x067E, 0x062A, 0x0629, 0x062B, 0x0032},
    /*3*/  {8, 0x0627, 0x0623, 0x0625, 0x0622, 0x0624, 0x0626, 0x0621, 0x0033},
    /*4*/  {5, 0x0633, 0x0634, 0x0635, 0x0636, 0x0034},
    /*5*/  {6, 0x062F, 0x0630, 0x0631, 0x0632, 0x0698, 0x0035},
    /*6*/  {5, 0x062C, 0x0686, 0x062D, 0x062E, 0x0036},
    /*7*/  {5, 0x0646, 0x0648, 0x0647, 0x06CC, 0x0037},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_persian =
{
    /*1*/{16, 0x002E, 0x061F, 0x060C, 0x0021, 0x061B, 0x0022, 0x0040, 0x003A, 0x0031, 0x003B, 0x0028, 0x0029, 0x002A, 0x002D, 0x002F, 0x06F1},
    /*2*/{ 6, 0x062C, 0x062D, 0x062E, 0x0686, 0x0032, 0x06F2},
    /*3*/{10, 0x0627, 0x0623, 0x0625, 0x0622, 0x0628, 0x062A, 0x062B, 0x067E, 0x0033, 0x06F3},
    /*4*/{ 6, 0x0637, 0x0638, 0x0639, 0x063A, 0x0034, 0x06F4},
    /*5*/{ 6, 0x0633, 0x0634, 0x0635, 0x0636, 0x0035, 0x06F5},
    /*6*/{ 7, 0x062F, 0x0630, 0x0631, 0x0632, 0x0698, 0x0036, 0x06F6},
    /*7*/{ 9, 0x0648, 0x0624, 0x0649, 0x064A, 0x0626, 0x0621, 0x06CC, 0x0037, 0x06F7},
    /*8*/{ 6, 0x0645, 0x0646, 0x0647, 0x0629, 0x0038,0x06F8},
    /*9*/{ 8, 0x0641, 0x0642, 0x0643, 0x0644, 0x06A9, 0x06AF, 0x0039, 0x06F9},
    /*0*/{ 4, ' ', '0', 0x06F0, MMIIM_SP_KEYMAP_LINE_BREAK},
    /***/{0},
    /*#*/{0}
};
#endif
...
{
    /*1*/  {14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  {13, 0x0041, 0x0042, 0x0043, 0x0032, 0x00C3, 0x00C1, 0x00C0, 0x00C2, 0x00C7, 0x00AA, 0x00C4, 0x00C5, 0x00C6},
    /*3*/  {9, 0x0044, 0x0045, 0x0046, 0x0033, 0x00C9, 0x00CA, 0x00C8, 0x00CB, 0x00D0},
    /*4*/  {8, 0x0047, 0x0048, 0x0049, 0x0034, 0x00CD, 0x00CC, 0x00CE, 0x00CF},
    /*5*/  {5, 0x004A, 0x004B, 0x004C, 0x0035, 0x00A3},
    /*6*/  {12, 0x004D, 0x004E, 0x004F, 0x0036, 0x00D5, 0x00D3, 0x00D4, 0x00BA, 0x00D2, 0x00D6, 0x00D8, 0x00D1},
    /*7*/  {6, 0x0050, 0x0051, 0x0052, 0x0053, 0x0037, 0x0024},
    /*8*/  {8, 0x0054, 0x0055, 0x0056, 0x0038, 0x00DA, 0x00DC, 0x00D9, 0x00DB},
    /*9*/  {7, 0x0057, 0x0058, 0x0059, 0x005A, 0x0039, 0x00DD, 0x00DE},
    /*0*/  {3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_portuguese_lower =
{
    /*1*/  {14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  {13, 0x0061, 0x0062, 0x0063, 0x0032, 0x00E3, 0x00E1, 0x00E0, 0x00E2, 0x00E7, 0x00AA, 0x00E4, 0x00E5, 0x00E6},
    /*3*/  {9, 0x0064, 0x0065, 0x0066, 0x0033, 0x00E9, 0x00EA, 0x00E8, 0x00EB, 0x00F0},
    /*4*/  {8, 0x0067, 0x0068, 0x0069, 0x0034, 0x00ED, 0x00EC, 0x00EE, 0x00EF},
    /*5*/  {5, 0x006A, 0x006B, 0x006C, 0x0035, 0x00A3},
    /*6*/  {12, 0x006D, 0x006E, 0x006F, 0x0036, 0x00F5, 0x00F3, 0x00F4, 0x00BA, 0x00F2, 0x00F6, 0x00F8, 0x00F1},
    /*7*/  {7, 0x0070, 0x0071, 0x0072, 0x0073, 0x0037, 0x00DF, 0x0024},
    /*8*/  {8, 0x0074, 0x0075, 0x0076, 0x0038, 0x00FA, 0x00FC, 0x00F9, 0x00FB},
    /*9*/  {7, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039, 0x00FD, 0x00FE},
    /*0*/  {3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_portuguese_br_upper =
{
    /*1*/  {14,0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  {9, 0x0041, 0x0042, 0x0043, 0x0032, 0x00C1, 0x00C3, 0x00C2, 0x00C0, 0x00C7},
    /*3*/  {6, 0x0044, 0x0045, 0x0046, 0x0033, 0x00C9, 0x00CA},
    /*4*/  {5, 0x0047, 0x0048, 0x0049, 0x0034, 0x00CD},
    /*5*/  {4, 0x004A, 0x004B, 0x004C, 0x0035},
    /*6*/  {7, 0x004D, 0x004E, 0x004F, 0x0036, 0x00D3, 0x00D5, 0x00D4},
    /*7*/  {5, 0x0050, 0x0051, 0x0052, 0x0053, 0x0037},
    /*8*/  {6, 0x0054, 0x0055, 0x0056, 0x0038, 0x00DA, 0x00DC},
    /*9*/  {5, 0x0057, 0x0058, 0x0059, 0x005A, 0x0039},
    /*0*/  {3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_portuguese_br_lower =
{
    /*1*/  {14,0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  {9, 0x0061, 0x0062, 0x0063, 0x0032, 0x00E1, 0x00E3, 0x00E2, 0x00E0, 0x00E7},
    /*3*/  {6, 0x0064, 0x0065, 0x0066, 0x0033, 0x00E9, 0x00EA},
    /*4*/  {5, 0x0067, 0x0068, 0x0069, 0x0034, 0x00ED},
    /*5*/  {4, 0x006A, 0x006B, 0x006C, 0x0035},
    /*6*/  {7, 0x006D, 0x006E, 0x006F, 0x0036, 0x00F3, 0x00F5, 0x00F4},
    /*7*/  {5, 0x0070, 0x0071, 0x0072, 0x0073, 0x0037},
    /*8*/  {6, 0x0074, 0x0075, 0x0076, 0x0038, 0x00FA, 0x00FC},
    /*9*/  {5, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039},
    /*0*/  {3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_spanish_upper =
{
    /*1*/  {16, 0x002E, 0x002C, 0x00BF, 0x003F, 0x00A1, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  {13, 0x0041, 0x0042, 0x0043, 0x0032, 0x00C1, 0x00AA, 0x00C0, 0x00C2, 0x00C3, 0x00C4, 0x00C5, 0x00C6, 0x00C7},
    /*3*/  {9, 0x0044, 0x0045, 0x0046, 0x0033, 0x00C9, 0x00C8, 0x00CB, 0x00CA, 0x00D0},
    /*4*/  {8, 0x0047, 0x0048, 0x0049, 0x0034, 0x00CD, 0x00CE, 0x00CF, 0x00CC},
    /*5*/  {5, 0x004A, 0x004B, 0x004C, 0x0035, 0x00A3},
    /*6*/  {12, 0x004D, 0x004E, 0x004F, 0x0036, 0x00D1, 0x00D3, 0x00BA, 0x00D6, 0x00D4, 0x00D2, 0x00D5, 0x00D8},
    /*7*/  {6, 0x0050, 0x0051, 0x0052, 0x0053, 0x0037, 0x0024},
    /*8*/  {8, 0x0054, 0x0055, 0x0056, 0x0038, 0x00DA, 0x00DC, 0x00D9, 0x00DB},
    /*9*/  {7, 0x0057, 0x0058, 0x0059, 0x005A, 0x0039, 0x00DD, 0x00DE},
    /*0*/  {3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
...
{
    /*1*/  {16, 0x002E, 0x002C, 0x00BF, 0x003F, 0x00A1, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  {13, 0x0061, 0x0062, 0x0063, 0x0032, 0x00E1, 0x00AA, 0x00E0, 0x00E2, 0x00E3, 0x00E4, 0x00E5, 0x00E6, 0x00E7},
    /*3*/  {9, 0x0064, 0x0065, 0x0066, 0x0033, 0x00E9, 0x00E8, 0x00EB, 0x00EA, 0x00F0},
    /*4*/  {8,0x0067, 0x0068, 0x0069, 0x0034, 0x00ED, 0x00EE, 0x00EF, 0x00EC},
    /*5*/  {5, 0x006A, 0x006B, 0x006C, 0x0035, 0x00A3},
    /*6*/  {12, 0x006D, 0x006E, 0x006F, 0x0036, 0x00F1, 0x00F3, 0x00BA, 0x00F6, 0x00F4, 0x00F2, 0x00F5, 0x00F8},
    /*7*/  {7, 0x0070, 0x0071, 0x0072, 0x0073, 0x0037, 0x00DF, 0x0024},
    /*8*/  {8, 0x0074, 0x0075, 0x0076, 0x0038, 0x00FA, 0x00FC, 0x00F9, 0x00FB},
    /*9*/  {7, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039, 0x00FD, 0x00FE},
    /*0*/  {3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
...
//Spanish-US
//IM_SPANISH_AM_SUPPORT
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_spanish_us_upper =
{
    /*1*/  {16, 0x002E, 0x002C, 0x00BF, 0x003F, 0x00A1, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  {5, 0x0041, 0x0042, 0x0043, 0x0032, 0x00C1},
    /*3*/  {5, 0x0044, 0x0045, 0x0046, 0x0033, 0x00C9},
    /*4*/  {5, 0x0047, 0x0048, 0x0049, 0x0034, 0x00CD},
    /*5*/  {4, 0x004A, 0x004B, 0x004C, 0x0035},
    /*6*/  {6, 0x004D, 0x004E, 0x004F, 0x0036, 0x00D1, 0x00D3},
    /*7*/  {5, 0x0050, 0x0051, 0x0052, 0x0053, 0x0037},
    /*8*/  {6, 0x0054, 0x0055, 0x0056, 0x0038, 0x00DA, 0x00DC},
    /*9*/  {5, 0x0057, 0x0058, 0x0059, 0x005A, 0x0039},
    /*0*/  {3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_spanish_us_lower =
{
    /*1*/  {16, 0x002E, 0x002C, 0x00BF, 0x003F, 0x00A1, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  {5, 0x0061, 0x0062, 0x0063, 0x0032, 0x00E1},
    /*3*/  {5, 0x0064, 0x0065, 0x0066, 0x0033, 0x00E9},
    /*4*/  {5, 0x0067, 0x0068, 0x0069, 0x0034, 0x00ED},
    /*5*/  {4, 0x006A, 0x006B, 0x006C, 0x0035},
    /*6*/  {6, 0x006D, 0x006E, 0x006F, 0x0036, 0x00F1, 0x00F3},
    /*7*/  {5, 0x0070, 0x0071, 0x0072, 0x0073, 0x0037},
    /*8*/  {6, 0x0074, 0x0075, 0x0076, 0x0038, 0x00FA, 0x00FC},
    /*9*/  {5, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039},
    /*0*/  {3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
...
#ifdef IM_LATIN_SERBIAN_SUPPORT
//follow serbian key mapping
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_latin_serbian_upper =
{
    /*1*/{13, '.', ',', '-', '?', '!', '\'', '@', ':', '#', '$', '/', '_', '1'},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_latin_serbian_lower =
{
    /*1*/{13, '.', ',', '-', '?', '!', '\'', '@', ':', '#', '$', '/', '_', '1'},
...
#ifdef IM_BRAZILIAN_PORTUGUESE_SUPPORT
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_brazilian_portuguese_upper =
{
    /*1*/  {14, 0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  { 9, 0x0041, 0x0042, 0x0043, 0x0032, 0x00C1, 0x00C3, 0x00C2, 0x00C0, 0x00C7},
    /*3*/  { 6, 0x0044, 0x0045, 0x0046, 0x0033, 0x00C9, 0x00CA},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_brazilian_portuguese_lower =
{
    /*1*/  {14,0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  { 9, 0x0061, 0x0062, 0x0063, 0x0032, 0x00E1, 0x00E3, 0x00E2, 0x00E0, 0x00E7},
    /*3*/  { 6, 0x0064, 0x0065, 0x0066, 0x0033, 0x00E9, 0x00EA},
...
#elif defined(MMIIM_CSTAR_MULTITAP) || defined(MMIIM_IEKIE_MULTITAP)
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_tagalog =
{
    /*1*/  { 9, '.', ',', '-', '?', '!', '\'', '@', ':', '1'},
    /*2*/  { 7, 0x0061, 0x0062, 0x0063, 0x00E0, 0x00E1, 0x00E2, 0x0032},
    /*3*/  { 5, 0x0064, 0x0065, 0x0066, 0x00E9, 0x0033},
    /*4*/  { 7, 0x0067, 0x0068, 0x0069, 0x00EC, 0x00ED, 0x00EE, 0x0034},
    /*5*/  { 4, 0x006A, 0x006B, 0x006C, 0x0035},
    /*6*/  { 7, 0x006D, 0x006E, 0x006F, 0x00F2, 0x00F3, 0x00F1, 0x0036},
    /*7*/  { 5, 0x0070, 0x0071, 0x0072, 0x0073, 0x0037},
    /*8*/  { 4, 0x0074, 0x0075, 0x0076, 0x0038},
    /*9*/  { 5, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039},
    /*0*/  { 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_tagalog_upper =
{
    /*1*/  {14, 0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  {12, 0x0041, 0x0042, 0x0043, 0x0032, 0x00C4, 0x00C6, 0x00C5, 0x00C0, 0x00C1, 0x00C2, 0x00C3, 0x00C7},
    /*3*/  { 9, 0x0044, 0x0045, 0x0046, 0x0033, 0x00C8, 0x00C9, 0x00CA, 0x00CB, 0x00D0},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_tagalog_lower =
{
    /*1*/  {14, 0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  {12, 0x0061, 0x0062, 0x0063, 0x0032, 0x00E4, 0x00E6, 0x00E5, 0x00E0, 0x00E1, 0x00E2, 0x00E3, 0x00E7},
    /*3*/  { 9, 0x0064, 0x0065, 0x0066, 0x0033, 0x00E8, 0x00E9, 0x00EA, 0x00EB, 0x00F0},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_thai = 
{
    /*1*/ {9, 0x0E01, 0x0E02, 0x0E04, 0x0E30, 0x0E32, 0x0E33, 0x0E03, 0x0E05, 0x0031},
    /*2*/ {7, 0x0E06, 0x0E07, 0x0E08, 0x0E09, 0x0E40, 0x0E41, 0x0032},
    /*3*/ {8, 0x0E0A, 0x0E0B, 0x0E0C, 0x0E0D, 0x0E42, 0x0E43, 0x0E44, 0x0033},
    /*4*/ {8, 0x0E0E, 0x0E0F, 0x0E10, 0x0E11, 0x0E12, 0x0E13, 0x0E31, 0x0034},
    /*5*/ {8, 0x0E14, 0x0E15, 0x0E16, 0x0E17, 0x0E18, 0x0E34, 0x0E35, 0x0035},
    /*6*/ {8, 0x0E19, 0x0E1A, 0x0E1B, 0x0E1C, 0x0E1D, 0x0E36, 0x0E37, 0x0036},
    /*7*/ {8, 0x0E1E, 0x0E1F, 0x0E20, 0x0E21, 0x0E22, 0x0E38, 0x0E39, 0x0037},
    /*8*/ {9, 0x0E23, 0x0E24, 0x0E25, 0x0E26, 0x0E27, 0x0E28, 0x0E29, 0x0E47, 0x0038},
    /*9*/ {8, 0x0E2A, 0x0E2B, 0x0E2C, 0x0E2D, 0x0E2E, 0x0E2F, 0x0E46, 0x0039},
    /*0*/ {8, 0x0E48, 0x0E49, 0x0E4A, 0x0E4B, 0x0E4C, 0x0030, MMIIM_SP_KEYMAP_SPACE, MMIIM_SP_KEYMAP_LINE_BREAK},
    /***/{0},
    /*#*/{0}
};
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_thai =
{
    /*key 1*/  { 6, 0x0E01, 0x0E02, 0x0E03, 0x0E04, 0x0E05, 0x0031}, 
    /*key 2*/  { 5, 0x0E06, 0x0E07, 0x0E08, 0x0E09, 0x0032}, 
    /*key 3*/  { 5, 0x0E0A, 0x0E0B, 0x0E0C, 0x0E0D, 0x0033}, 
    /*key 4*/  { 7, 0x0E0E, 0x0E0F, 0x0E10, 0x0E11, 0x0E12, 0x0E13, 0x0034}, 
    /*key 5*/  { 6, 0x0E14, 0x0E15, 0x0E16, 0x0E17, 0x0E18, 0x0035}, 
    /*key 6*/  { 6, 0x0E19, 0x0E1A, 0x0E1B, 0x0E1C, 0x0E1D, 0x0036}, 
    /*key 7*/  { 6, 0x0E1E, 0x0E1F, 0x0E20, 0x0E21, 0x0E22, 0x0037}, 
    /*key 8*/  { 8, 0x0E23, 0x0E24, 0x0E25, 0x0E26, 0x0E27, 0x0E28, 0x0E29, 0x0038}, 
    /*key 9*/  { 6, 0x0E2A, 0x0E2B, 0x0E2C, 0x0E2D, 0x0E2E, 0x0039}, 
    /*key 0*/  {12, 0x0E40, 0x0E41, 0x0E42, 0x0E43, 0x0E44, 0x0E30, 0x0E32, 0x0E33, 0x0E45, 0x0030, MMIIM_SP_KEYMAP_SPACE, MMIIM_SP_KEYMAP_LINE_BREAK}, 
};
#else
//thai,5 tables
//<--thai begin
...
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{11, 0x0041, 0x0042, 0x0043, 0x00C7, 0x0032, 0x00C2, 0x00C4, 0x00C0, 0x00C1, 0x00C3, 0x00C6},
    /*3*/{ 8, 0x0044, 0x0045, 0x0046, 0x0033, 0x00C8, 0x00C9, 0x00CB, 0x00CA},
    /*4*/{10, 0x0047, 0x011E, 0x0048, 0x0049, 0x0130, 0x0034, 0x00CE, 0x00CF, 0x00CC, 0x00CD},
    /*5*/{ 5, 0x004A, 0x004B, 0x004C, 0x0035, 0x00A3},
    /*6*/{10, 0x004D, 0x004E, 0x004F, 0x0036, 0x00D6, 0x00D4, 0x00D2, 0x00D3, 0x00D8, 0x00D1},
    /*7*/{ 7, 0x0050, 0x0051, 0x0052, 0x0053, 0x015E, 0x0037, 0x0024},
    /*8*/{ 8, 0x0054, 0x0055, 0x0056, 0x0038, 0x00DC, 0x00D9, 0x00DB, 0x00DA},
    /*9*/{ 5, 0x0057, 0x0058, 0x0059, 0x005A, 0x0039},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_turkish_lower =
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{11, 0x0061, 0x0062, 0x0063, 0x00E7, 0x0032, 0x00E2, 0x00E4, 0x00E0, 0x00E1, 0x00E3, 0x00E6},
    /*3*/{ 8, 0x0064, 0x0065, 0x0066, 0x0033, 0x00E8, 0x00E9, 0x00EB, 0x00EA},
    /*4*/{10, 0x0067, 0x011F, 0x0068, 0x0131, 0x0069, 0x0034, 0x00EE, 0x00EF, 0x00EC, 0x00ED},
    /*5*/{ 5, 0x006A, 0x006B, 0x006C, 0x0035, 0x00A3},
    /*6*/{10, 0x006D, 0x006E, 0x006F, 0x0036, 0x00F6, 0x00F4, 0x00F2, 0x00F3, 0x00F8, 0x00F1},
    /*7*/{ 8, 0x0070, 0x0071, 0x0072, 0x0073, 0x015F, 0x0037, 0x00DF, 0x0024},
    /*8*/{ 8, 0x0074, 0x0075, 0x0076, 0x0038, 0x00FC, 0x00F9, 0x00FB, 0x00FA},
    /*9*/{ 5, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
#else
...
#if (defined(MMIIM_CSTAR_MULTITAP) || defined(MMIIM_IEKIE_MULTITAP))
#if (defined(INPUT_METHOD_CSTAR_COMMON_MINI) || defined(INPUT_METHOD_IEKIE_COMMON_MINI))    //mini版本，使用957
...
#if (defined(MMIIM_CSTAR_MULTITAP) || defined(MMIIM_IEKIE_MULTITAP))
#if (defined(INPUT_METHOD_CSTAR_COMMON_MINI) || defined(INPUT_METHOD_IEKIE_COMMON_MINI))    //mini版本，使用317
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_vietnamese_upper =
{
    ...
    /*8*/{ 5, 0x0054, 0x0055, 0x01AF, 0x0056, 0x0038},
    /*9*/{ 5, 0x0057, 0x0058, 0x0059, 0x005A, 0x0039},
    /*0*/{ 2, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
    /***/{0},
    /*#*/{0}
};
...
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{ 6, 0x0041, 0x0102, 0x00C2, 0x0042, 0x0043, 0x0032},
    /*3*/{ 6, 0x0044, 0x0110, 0x0045, 0x00CA, 0x0046, 0x0033},
    /*4*/{ 4, 0x0047, 0x0048, 0x0049, 0x0034},
    /*5*/{ 4, 0x004A, 0x004B, 0x004C, 0x0035},
    /*6*/{ 6, 0x004D, 0x004E, 0x004F, 0x00D4, 0x01A0, 0x0036},
    /*7*/{ 5, 0x0050, 0x0051, 0x0052, 0x0053, 0x0037},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_vietnamese_upper_full =
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{ 6, 0x0041, 0x0102, 0x00C2, 0x0042, 0x0043, 0x0032},
    /*3*/{ 6, 0x0044, 0x0110, 0x0045, 0x00CA, 0x0046, 0x0033},
    ...
    /*9*/{ 5, 0x0057, 0x0058, 0x0059, 0x005A, 0x0039},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
    /***/{ 5, 0x0301, 0x0300, 0x0309,0x0303,0x0323}
};
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_vietnamese_lower =
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{ 6, 0x0061, 0x0103, 0x00E2, 0x0062, 0x0063, 0x0032},
    /*3*/{ 6, 0x0064, 0x0111, 0x0065, 0x00EA, 0x0066, 0x0033},
    /*4*/{ 4, 0x0067, 0x0068, 0x0069, 0x0034},
    /*5*/{ 4, 0x006A, 0x006B, 0x006C, 0x0035},
    /*6*/{ 6, 0x006D, 0x006E, 0x006F, 0x00F4, 0x01A1, 0x0036},
    /*7*/{ 5, 0x0070, 0x0071, 0x0072, 0x0073, 0x0037},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_vietnamese_lower_full =
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{ 6, 0x0061, 0x0103, 0x00E2, 0x0062, 0x0063, 0x0032},
    /*3*/{ 6, 0x0064, 0x0111, 0x0065, 0x00EA, 0x0066, 0x0033},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_hebrew =
{
    /*1*/{ 5, 0x002E, 0x002C, 0x003F, 0x0021, 0x0031},
    /*2*/{ 4, 0x05D3, 0x05D4, 0x05D5, 0x0032},
    /*3*/{ 4, 0x05D0, 0x05D1, 0x05D2, 0x0033},
    /*4*/{ 5, 0x05DE, 0x05DD, 0x05E0, 0x05DF, 0x0034},
    /*5*/{ 5, 0x05D9, 0x05DB, 0x05DA, 0x05DC, 0x0035},
...
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{11, 0x0041, 0x0042, 0x0043, 0x0032, 0x00C1, 0x010C, 0x00C2, 0x00C4, 0x0102, 0x0104, 0x0106},
    /*3*/{ 9, 0x0044, 0x0045, 0x0046, 0x0033, 0x010E, 0x00C9, 0x011A, 0x0110, 0x0118},
    /*4*/{ 6, 0x0047, 0x0048, 0x0049, 0x0034, 0x00CD, 0x00CE},
    /*5*/{ 8, 0x004A, 0x004B, 0x004C, 0x0035, 0x013D, 0x0139, 0x0141, 0x00A3},
    /*6*/{10, 0x004D, 0x004E, 0x004F, 0x0036, 0x0147, 0x00D3, 0x0143, 0x00D4, 0x00D6, 0x0150},
    /*7*/{11, 0x0050, 0x0051, 0x0052, 0x0053, 0x0037, 0x0158, 0x0160, 0x0154, 0x015A, 0x015E, 0x0024},
    /*8*/{10, 0x0054, 0x0055, 0x0056, 0x0038, 0x0164, 0x00DA, 0x016E, 0x0162, 0x00DC, 0x0170},
    /*9*/{ 9, 0x0057, 0x0058, 0x0059, 0x005A, 0x0039, 0x017D, 0x00DD, 0x0179, 0x017B},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_czech_lower =
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{11, 0x0061, 0x0062, 0x0063, 0x0032, 0x00E1, 0x010D, 0x00E2, 0x00E4, 0x0103, 0x0105, 0x0107},
    /*3*/{ 9, 0x0064, 0x0065, 0x0066, 0x0033, 0x010F, 0x00E9, 0x011B, 0x0111, 0x0119},
    /*4*/{ 6, 0x0067, 0x0068, 0x0069, 0x0034, 0x00ED, 0x00EE},
    /*5*/{ 8, 0x006A, 0x006B, 0x006C, 0x0035, 0x013E, 0x013A, 0x0142, 0x00A3},
    /*6*/{10, 0x006D, 0x006E, 0x006F, 0x0036, 0x0148, 0x00F3, 0x0144, 0x00F4, 0x00F6, 0x0151},
    /*7*/{12, 0x0070, 0x0071, 0x0072, 0x0073, 0x0037, 0x0159, 0x0161, 0x0155, 0x015B, 0x015F, 0x00DF, 0x0024},
    /*8*/{10, 0x0074, 0x0075, 0x0076, 0x0038, 0x0165, 0x00FA, 0x016F, 0x0163, 0x00FC, 0x0171},
    /*9*/{ 9, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039, 0x017E, 0x00FD, 0x017A, 0x017C},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
#else
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_czech_lower =
...
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{11, 0x0061, 0x00E2, 0x0103, 0x0062, 0x0063, 0x0032, 0x00E1, 0x00E4, 0x0105, 0x0107, 0x010D},
    /*3*/{ 9, 0x0064, 0x0065, 0x0066, 0x0033, 0x010F, 0x0111, 0x00E9, 0x0119, 0x011B},
    /*4*/{ 6, 0x0067, 0x0068, 0x0069, 0x00EE, 0x0034, 0x00ED},
    /*5*/{ 8, 0x006A, 0x006B, 0x006C, 0x0035, 0x013E, 0x013A, 0x0142, 0x00A3},
    /*6*/{10, 0x006D, 0x006E, 0x006F, 0x0036, 0x0144, 0x0148, 0x00F3, 0x00F4, 0x00F6, 0x0151},
    /*7*/{13, 0x0070, 0x0071, 0x0072, 0x0073, 0x0219, 0x015F, 0x0037, 0x0155, 0x0159, 0x015B, 0x0161, 0x00DF, 0x0024},
    /*8*/{11, 0x0074, 0x021B, 0x0163, 0x0075, 0x0076, 0x0038, 0x0165, 0x00FA, 0x00FC, 0x016F, 0x0171},
    /*9*/{ 9, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039, 0x00FD, 0x017A, 0x017C, 0x017E},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
...
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{11, 0x0041, 0x00C2, 0x0102, 0x0042, 0x0043, 0x0032, 0x00C1, 0x00C4, 0x0104, 0x0106, 0x010C},
    /*3*/{ 9, 0x0044, 0x0045, 0x0046, 0x0033, 0x010E, 0x0110, 0x00C9, 0x0118, 0x011A},
    /*4*/{ 6, 0x0047, 0x0048, 0x0049, 0x00CE, 0x0034, 0x00CD},
    /*5*/{ 8, 0x004A, 0x004B, 0x004C, 0x0035, 0x013D, 0x0139, 0x0141, 0x00A3},
    /*6*/{10, 0x004D, 0x004E, 0x004F, 0x0036, 0x0143, 0x0147, 0x00D3, 0x00D4, 0x00D6, 0x0150},
    /*7*/{12, 0x0050, 0x0051, 0x0052, 0x0053, 0x0218, 0x015E, 0x0037, 0x0154, 0x0158, 0x015A, 0x0160, 0x0024},
    /*8*/{11, 0x0054, 0x021A, 0x0162, 0x0055, 0x0056, 0x0038, 0x0164, 0x00DA, 0x00DC, 0x016E, 0x0170},
    /*9*/{ 9, 0x0057, 0x0058, 0x0059, 0x005A, 0x0039, 0x00DD, 0x0179, 0x017B, 0x017D},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
#else
...
#if (defined(MMIIM_CSTAR_MULTITAP) || defined(MMIIM_IEKIE_MULTITAP))	//CSTAR按孟加拉电信规范第一版来处理，1键上的自定义字符unicode码与sogou使用不同0x09FC, 0x09FD, 0x09FE
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_bengali =
{
    /*1*/  {10, MMIIM_SP_KEYMAP_COMBINE_START+37, MMIIM_SP_KEYMAP_COMBINE_START+38, MMIIM_SP_KEYMAP_COMBINE_START+39, 0x0982, 0x0983, 0x0981, 0x09E7, 0x09CD, 0x09BC, 0x0031},	//0x09FC = 0x09cd + 0x09b0, 0x09FD = 0x09cd + 0x09af, 0x09FE = 0x09b0 + 0x09cd三个字符为组合字符，是自造字
    /*2*/  {15, 0x0985, 0x0986, 0x0987, 0x0988, 0x0989, 0x098A, 0x098B, 0x09BE, 0x09BF, 0x09C0, 0x09C1, 0x09C2, 0x09C3, 0x0032, 0x09E8},
    /*3*/  {10, 0x098F, 0x0990, 0x0993, 0x0994, 0x09C7, 0x09C8, 0x09CB, 0x09CC, 0x0033, 0x09E9},
    /*4*/  {7, 0x0995, 0x0996, 0x0997, 0x0998, 0x0999, 0x0034, 0x09EA},

    /*9*/{ 9, 0x0057, 0x0058, 0x0059, 0x005A, 0x017D, 0x0039, 0x00DD, 0x0179, 0x017B},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_slovenian_lower =
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{11, 0x0061, 0x0062, 0x0063, 0x010D, 0x0032, 0x00E1, 0x00E2, 0x00E4, 0x0103, 0x0105, 0x0107},
    /*3*/{ 9, 0x0064, 0x0065, 0x0066, 0x0033, 0x010F, 0x0111, 0x00E9, 0x0119, 0x011B},
    /*4*/{ 6, 0x0067, 0x0068, 0x0069, 0x0034, 0x00ED, 0x00EE},
    /*5*/{ 8, 0x006A, 0x006B, 0x006C, 0x0035, 0x013E, 0x013A, 0x0142, 0x00A3},
    /*6*/{10, 0x006D, 0x006E, 0x006F, 0x0036, 0x0144, 0x0148, 0x00F3, 0x00F4, 0x00F6, 0x0151},
    /*7*/{12, 0x0070, 0x0071, 0x0072, 0x0073, 0x0161, 0x0037, 0x0155, 0x0159, 0x015B, 0x015F, 0x00DF, 0x0024},
    /*8*/{10, 0x0074, 0x0075, 0x0076, 0x0038, 0x0163, 0x0165, 0x00FA, 0x00FC, 0x016F, 0x0171},
    /*9*/{ 9, 0x0077, 0x0078, 0x0079, 0x007A, 0x017E, 0x0039, 0x00FD, 0x017A, 0x017C},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
#else
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_slovenian_lower =
...
{
    /*1*/ {10, 0x0031, 0x0C4D, 0x0C02, 0x0C03, 0x0C01, 0x002E, 0x002C, 0x003F, 0x0021, 0x0C67},
    /*2*/ {7, 0x0C15, 0x0C16, 0x0C05, 0x0C06, 0x0032, 0x0C3E, 0x0C68},
    /*3*/ {9, 0x0C17, 0x0C18, 0x0C19, 0x0C07, 0x0C08, 0x0033, 0x0C3F, 0x0C40, 0x0C69},
    /*4*/ {11, 0x0C1A, 0x0C1B, 0x0C1C, 0x0C1D, 0x0C1E, 0x0C09, 0x0C0A, 0x0034, 0x0C41, 0x0C42, 0x0C6A},
    /*5*/ {9, 0x0C1F, 0x0C20, 0x0C21, 0x0C22, 0x0C23, 0x0C0B, 0x0035, 0x0C43, 0x0C6B},
    /*6*/ {10, 0x0C24, 0x0C25, 0x0C26, 0x0c27, 0x0C0E, 0x0C0F, 0x0036, 0x0C46, 0x0C47, 0x0C6C},
    /*7*/ {10, 0x0C28, 0x0C2A, 0x0C2B, 0x0C2C, 0x0C2D, 0x0C10, 0x0037, 0x0C48, 0x0C27, 0x0C6D},
    /*8*/ {9, 0x0C2E, 0x0C2F, 0x0C30, 0x0C12, 0x0C13, 0x0038, 0x0C4A, 0x0C4B, 0x0C6E},
    /*9*/ {11, 0x0C32, 0x0C35, 0x0C36, 0x0C37, 0x0C38, 0x0C39, 0x0C33, 0x0C14, 0x0039, 0x0C4C, 0x0C6F},
    /*0*/ {6, ' ', '0', MMIIM_SP_KEYMAP_COMBINE_START, 0x0C31, 0x0C66, MMIIM_SP_KEYMAP_LINE_BREAK},
    /***/{0},
    /*#*/{0}
};
#elif defined MMIIM_SOGOU_MULTITAP
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_telugu =
{
    /*1*/{10, 0x0C01, 0x0C02, 0x0C03, 0x0C4D, 0x0031, 0x002E, 0x002C, 0x003F, 0x0021, 0x0C67},
    /*2*/{15, 0x0C05, 0x0C06, 0x0C07, 0x0C08, 0x0C09, 0x0C0A, 0x0C0B, 0x0C3E, 0x0C3F, 0x0C40, 0x0C41, 0x0C42, 0x0C43, 0x0032, 0x0C68},
    /*3*/{14, 0x0C0E, 0x0C0F, 0x0C10, 0x0C12, 0x0C13, 0x0C14, 0x0C46, 0x0C47, 0x0C48, 0x0C4A, 0x0C4B, 0x0C4C, 0x0033, 0x0C69},
    /*4*/{ 7, 0x0C15, 0x0C16, 0x0C17, 0x0C18, 0x0C19, 0x0034, 0x0C6A},
    /*5*/{ 7, 0x0C1A, 0x0C1B, 0x0C1C, 0x0C1D, 0x0C1E, 0x0035, 0x0C6B},
    /*6*/{ 7, 0x0C1F, 0x0C20, 0x0C21, 0x0C22, 0x0C23, 0x0036, 0x0C6C},
    /*7*/{ 7, 0x0C24, 0x0C25, 0x0C26, 0x0C27, 0x0C28, 0x0037, 0x0C6D},
    /*8*/{ 7, 0x0C2A, 0x0C2B, 0x0C2C, 0x0C2D, 0x0C2E, 0x0038, 0x0C6E},
    /*9*/{ 7, 0x0C2F, 0x0C30, 0x0C32, 0x0C35, 0x0C36, 0x0039, 0x0C6F},
    /*0*/{ 10, 0x0020, 0x0C37, 0x0C38, 0x0C39, 0x0C33, MMIIM_SP_KEYMAP_COMBINE_START, 0x0C31, 0x0030, 0x0C66, MMIIM_SP_KEYMAP_LINE_BREAK},
};
#else
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_telugu =
{
...
{
    /*1*/ {14, 0x0031, 0x0967, 0x0964, 0x0950, 0x094D, 0x093C, 0x0902, 0x0903, 0x0901, MMIIM_SP_KEYMAP_COMBINE_START+11, 0x002E, 0x002C, 0x003F, 0x0021},
    /*2*/ {5, 0x0905, 0x0906, 0x0032, 0x0968, 0x093E},
    /*3*/ {13, 0x0915, 0x0916, 0x0917, 0x0918, 0x0919, 0x0907, 0x0958, 0x0959, 0x095A, 0x0033, 0x0969, 0x093F, MMIIM_SP_KEYMAP_COMBINE_START+12},
    ...
    /*9*/ {12, 0x0935, 0x0936, 0x0937, 0x0938, 0x0939, 0x0914, 0x0039, 0x096F, 0x094C, MMIIM_SP_KEYMAP_COMBINE_START+13, MMIIM_SP_KEYMAP_COMBINE_START+14, MMIIM_SP_KEYMAP_COMBINE_START+34},
    /*0*/ {4, 0x0966, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
    /***/{0},
    /*#*/{0}
};
#elif defined MMIIM_SOGOU_MULTITAP
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_marathi =
{
    /*1*/{13, 0x0901, 0x0902, 0x0903, MMIIM_SP_KEYMAP_COMBINE_START+11, 0x093C, 0x094D, 0x0031, 0x0967, 0x0964, 0x002E, 0x002C, 0x003F, 0x0021},
    /*2*/{15, 0x0905, 0x0906, 0x0907, 0x0908, 0x0909, 0x090A, 0x090B, 0x093E, 0x093F, 0x0940, 0x0941, 0x0942, 0x0943, 0x0032, 0x0968},
    /*3*/{14, 0x090F, 0x0910, MMIIM_SP_KEYMAP_COMBINE_START+12, 0x0913, 0x0914, 0x0911, 0x0947, 0x0948, 0x0945, 0x094B, 0x094C, 0x0949, 0x0033, 0x0969},
    /*4*/{ 7, 0x0915, 0x0916, 0x0917, 0x0918, 0x0919, 0x0034, 0x096A},
    /*5*/{ 7, 0x091A, 0x091B, 0x091C, 0x091D, 0x091E, 0x0035, 0x096B},
    /*6*/{ 7, 0x091F, 0x0920, 0x0921, 0x0922, 0x0923, 0x0036, 0x096C},
    /*7*/{ 7, 0x0924, 0x0925, 0x0926, 0x0927, 0x0928, 0x0037, 0x096D},
    /*8*/{ 7, 0x092A, 0x092B, 0x092C, 0x092D, 0x092E, 0x0038, 0x096E},
    /*9*/{13, 0x092F, 0x0930, 0x0932, 0x0935, 0x0936, 0x0937, 0x0938, 0x0939, 0x0933, MMIIM_SP_KEYMAP_COMBINE_START+13, MMIIM_SP_KEYMAP_COMBINE_START+14, 0x0039, 0x096F, MMIIM_SP_KEYMAP_COMBINE_START+34},
    /*0*/{ 4, 0x0020, 0x0030, 0x0966, MMIIM_SP_KEYMAP_LINE_BREAK},
};
#else
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_marathi =
...
{
    /*1*/ {8, 0x0031, 0x0B83, 0x0BCD, 0x002E, 0x002C, 0x003F, 0x0021, 0x0BE7},
    /*2*/ {13, 0x0B85, 0x0B86, 0x0B87, 0x0B88, 0x0B89, 0x0B8A, 0x0032, 0x0BBE, 0x0BBF, 0x0BC0, 0x0BC1, 0x0BC2, 0x0BE8},
    /*3*/ {14, 0x0B8E, 0x0B8F, 0x0B90, 0x0B92, 0x0B93, 0x0B94, 0x0033, 0x0BC6, 0x0BC7, 0x0BC8, 0x0BCA, 0x0BCB, 0x0BCC, 0x0BE9},
    /*4*/ {6, 0x0B95, 0x0B99, 0x0B9A, 0x0B9E, 0x0034, 0x0BEA},
    /*5*/ {6, 0x0B9F, 0x0BA3, 0x0BA4, 0x0BA8, 0x0035, 0x0BEB},
    /*6*/ {5, 0x0BAA, 0x0BAE, 0x0BAF, 0x0036, 0x0BEC},
    /*7*/ {5, 0x0BB0, 0x0BB2, 0x0BB5, 0x0037, 0x0BED},
    /*8*/ {6, 0x0BB4, 0x0BB3, 0x0BB1, 0x0BA9, 0x0038, 0x0BEE},
    /*9*/ {8, 0x0B9C, 0x0BB7, 0x0BB8, 0x0BB9, MMIIM_SP_KEYMAP_COMBINE_START+1, MMIIM_SP_KEYMAP_COMBINE_START+2, 0x0039, 0x0BEF},
    /*0*/ {3, ' ', '0', MMIIM_SP_KEYMAP_LINE_BREAK},
    /***/{0},
    /*#*/{0}
};
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_tamil =
{
    /*1*/{ 8, 0x0BCD, 0x0B83, 0x0031, 0x002E, 0x002C, 0x003F, 0x0021, 0x0BE7},
    /*2*/{13, 0x0B85, 0x0B86, 0x0B87, 0x0B88, 0x0B89, 0x0B8A, 0x0BBE, 0x0BBF, 0x0BC0, 0x0BC1, 0x0BC2, 0x0032, 0x0BE8},
    /*3*/{14, 0x0B8E, 0x0B8F, 0x0B90, 0x0B92, 0x0B93, 0x0B94, 0x0BC6, 0x0BC7, 0x0BC8, 0x0BCA, 0x0BCB, 0x0BCC, 0x0033, 0x0BE9},
    /*4*/{ 6, 0x0B95, 0x0B99, 0x0B9A, 0x0B9E, 0x0034, 0x0BEA},
    /*5*/{ 6, 0x0B9F, 0x0BA3, 0x0BA4, 0x0BA8, 0x0035, 0x0BEB},
    /*6*/{ 5, 0x0BAA, 0x0BAE, 0x0BAF, 0x0036, 0x0BEC},
    /*7*/{ 5, 0x0BB0, 0x0BB2, 0x0BB5, 0x0037, 0x0BED},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_gujarati =
{
    /*1*/{ 11, 0x0A95, 0x0A96, 0x0A97, 0x0A98, 0x0A99, 0x0AE7, 0x0031, MMIIM_SP_KEYMAP_COMBINE_START+28, 0x002C, 0x003F, 0x0021},
    ...
    /*0*/{14, 0x0020, 0x002E, 0x0AD0, 0x0AF1, 0x0AE6, 0x0964, 0x0965, 0x0030, 0x0ACD, 0x0A81, 0x0A82, 0x0A83, 0x0ABC, MMIIM_SP_KEYMAP_LINE_BREAK},
    /***/{0},
    /*#*/{0}
};
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_gujaratimatra =
{
    ...
    /*0*/{13, ' ', GUJARATI_S_HALANT, GUJARATI_S_CHANDRA_BINDU, GUJARATI_S_BINDU, GUJARATI_S_VISARGA, GUJARATI_S_OM, GUJARATI_D_CS, '.', GUJARATI_D_ZERO, GUJARATI_DEVANAGARI_S_DANDA, GUJARATI_DEVANAGARI_S_DDANDA, '0', MMIIM_SP_KEYMAP_LINE_BREAK},
    /***/{0},
    /*#*/{0}
};
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_gujaratimatra1 =
{
    ...
    /*8*/{16, GUJARATI_IV_A, GUJARATI_IV_AA, GUJARATI_IV_I, GUJARATI_IV_II, GUJARATI_IV_U, GUJARATI_IV_UU, GUJARATI_IV_VR, GUJARATI_IV_VL, GUJARATI_IV_CE, GUJARATI_IV_E, GUJARATI_IV_AI, GUJARATI_IV_CO, GUJARATI_IV_O, GUJARATI_IV_AU, GUJARATI_D_EIGHT, '8'},
    /*9*/{ 2, GUJARATI_D_NINE, '9'},
    /*0*/{12, ' ', GUJARATI_S_CHANDRA_BINDU, GUJARATI_S_BINDU, GUJARATI_S_VISARGA, GUJARATI_S_OM, GUJARATI_D_CS, '.', GUJARATI_D_ZERO, GUJARATI_DEVANAGARI_S_DANDA, GUJARATI_DEVANAGARI_S_DDANDA, '0', MMIIM_SP_KEYMAP_LINE_BREAK},
    /***/{0},
    /*#*/{0}
};
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_gujaratimatra2 =
{
    ...
    /*8*/{16, GUJARATI_IV_A, GUJARATI_IV_AA, GUJARATI_IV_I, GUJARATI_IV_II, GUJARATI_IV_U, GUJARATI_IV_UU, GUJARATI_IV_VR, GUJARATI_IV_VL, GUJARATI_IV_CE, GUJARATI_IV_E, GUJARATI_IV_AI, GUJARATI_IV_CO, GUJARATI_IV_O, GUJARATI_IV_AU, GUJARATI_D_EIGHT, '8'},
    /*9*/{ 2, GUJARATI_D_NINE, '9'},
    /*0*/{11, ' ', GUJARATI_S_BINDU, GUJARATI_S_VISARGA, GUJARATI_S_OM, GUJARATI_D_CS, '.', GUJARATI_D_ZERO, GUJARATI_DEVANAGARI_S_DANDA, GUJARATI_DEVANAGARI_S_DDANDA, '0', MMIIM_SP_KEYMAP_LINE_BREAK},
    /***/{0},
    /*#*/{0}
};
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_gujaratimatra3 =
{
    ...
    /*8*/{16, GUJARATI_IV_A, GUJARATI_IV_AA, GUJARATI_IV_I, GUJARATI_IV_II, GUJARATI_IV_U, GUJARATI_IV_UU, GUJARATI_IV_VR, GUJARATI_IV_VL, GUJARATI_IV_CE, GUJARATI_IV_E, GUJARATI_IV_AI, GUJARATI_IV_CO, GUJARATI_IV_O, GUJARATI_IV_AU, GUJARATI_D_EIGHT, '8'},
    /*9*/{15, GUJARATI_DV_AA, GUJARATI_DV_I, GUJARATI_DV_II, GUJARATI_DV_U, GUJARATI_DV_UU, GUJARATI_DV_VR, GUJARATI_DV_VRR, GUJARATI_DV_CE, GUJARATI_DV_E, GUJARATI_DV_AI, GUJARATI_DV_CO, GUJARATI_DV_O, GUJARATI_DV_AU, GUJARATI_D_NINE, '9'},
    /*0*/{14, ' ', GUJARATI_S_HALANT, GUJARATI_S_CHANDRA_BINDU, GUJARATI_S_BINDU, GUJARATI_S_NUKTA, GUJARATI_S_VISARGA, GUJARATI_S_OM, GUJARATI_D_CS, '.', GUJARATI_D_ZERO, GUJARATI_DEVANAGARI_S_DANDA, GUJARATI_DEVANAGARI_S_DDANDA, '0', MMIIM_SP_KEYMAP_LINE_BREAK},
    /***/{0},
    /*#*/{0}
};
#elif defined MMIIM_SOGOU_MULTITAP
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_gujarati =
{
    /*1*/{10, 0x0A82, 0x0A83, MMIIM_SP_KEYMAP_COMBINE_START+28, 0x0ACD, 0x0031, 0x0AE7, 0x002E, 0x002C, 0x003F, 0x0021},
    /*2*/
    /*7*/ {16, 0x0D05, 0x0D06, 0x0D07, 0x0D08, 0x0D09, 0x0D0A, 0x0D0B, 0x0D0E, 0x0D0F, 0x0D10, 0x0D12, 0x0D13, 0x0D14, 0x0D6D, 0x0037, MMIIM_SP_KEYMAP_COMBINE_START+17},
    /*8*/ {15, 0x0D6E, 0x0038, 0x0D3E, 0x0D3F, 0x0D40, 0x0D41, 0x0D42, 0x0D43, 0x0D44, 0x0D46, 0x0D47, 0x0D48, 0x0D4A, 0x0D4B, 0x0D4C},
    /*9*/ {7, 0x0D6F, 0x0039, 0x0D02, 0x0D03, 0x0D4D, MMIIM_SP_KEYMAP_COMBINE_START+18, MMIIM_SP_KEYMAP_COMBINE_START+19},
    /*0*/ {7, 0x0020, 0x0D66, 0x0964, 0x0965, 0x0030, MMIIM_SP_KEYMAP_COMBINE_START+15, MMIIM_SP_KEYMAP_LINE_BREAK},
    /***/{0},
    /*#*/{0}
};
#elif defined MMIIM_T9_MULTITAP
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_malayalam =
{
    /*1*/{ 9, 0x0D02, 0x0D03, 0x0D4D, 0x0031, 0x002E, 0x002C, 0x003F, 0x0021, 0x0D67},
    /*2*/{15, 0x0D05, 0x0D06, 0x0D07, 0x0D08, 0x0D09, 0x0D0A, 0x0D0B, 0x0D3E, 0x0D3F, 0x0D40, 0x0D41, 0x0D42, 0x0D43, 0x0032, 0x0D68},
    /*3*/{14, 0x0D0E, 0x0D0F, 0x0D10, 0x0D12, 0x0D13, 0x0D14, 0x0D46, 0x0D47, 0x0D48, 0x0D4A, 0x0D4B, 0x0D4C, 0x0033, 0x0D69},
    /*4*/{ 7, 0x0D15, 0x0D16, 0x0D17, 0x0D18, 0x0D19, 0x0034, 0x0D6A},
    /*5*/{ 7, 0x0D1A, 0x0D1B, 0x0D1C, 0x0D1D, 0x0D1E, 0x0035, 0x0D6B},
    /*6*/{ 8, 0x0D1F, 0x0D20, 0x0D21, 0x0D22, 0x0D23, MMIIM_SP_KEYMAP_COMBINE_START+16, 0x0036, 0x0D6C},
    /*7*/{ 8, 0x0D24, 0x0D25, 0x0D26, 0x0D27, 0x0D28, MMIIM_SP_KEYMAP_COMBINE_START+17, 0x0037, 0x0D6D},
    /*8*/{ 7, 0x0D2A, 0x0D2B, 0x0D2C, 0x0D2D, 0x0D2E, 0x0038, 0x0D6E},
    /*9*/{ 10, 0x0D2F, 0x0D30, MMIIM_SP_KEYMAP_COMBINE_START+18, 0x0D32, MMIIM_SP_KEYMAP_COMBINE_START+19, 0x0D35, 0x0D36, 0x0D37, 0x0039, 0x0D6F},
    /*0*/{ 10, 0x0020, 0x0D38, 0x0D39, 0x0D33, MMIIM_SP_KEYMAP_COMBINE_START+15, 0x0D34, 0x0D31, 0x0030, 0x0D66, MMIIM_SP_KEYMAP_LINE_BREAK},
};
#else
...
{
    /*1*/  {18, 0x1031, 0x102C, 0x102D, 0x102E, 0x102B, 0x103A, 0x1036, 0x1032, 0x1039, 0x104A, 0x104B, 0x1085, 0x1041, 0x0031, 0x002E, 0x002C, 0x0021, 0x003F},
    /*2*/  {7, 0x1000, 0x1001, 0x1004, 0x1002, 0x1003, 0x1042, 0x0032},
    /*3*/  {8, 0x1005, 0x1006, 0x100A, 0x1008, 0x1007, 0x1009, 0x1043, 0x0033},
    /*4*/  {11, 0x100F, 0x100C, 0x100B, 0x100D, 0x100E, 0x1044, 0x0034, 0x1060, 0x1061, 0x1062, 0x1063},
    /*5*/  {11, 0x1014, 0x1010, 0x1011, 0x1012, 0x1013, 0x1045, 0x0035, 0x1065, 0x1066, 0x1068, 0x1069},
    /*6*/  {10, 0x1019, 0x1015, 0x1016, 0x1017, 0x1018, 0x1046, 0x0036, 0x106C, 0x106D, 0x1070},
    /*7*/  {14, 0x101C, 0x101A, 0x101B, 0x101D, 0x104C, 0x104D, 0x104F, 0x1047, 0x0037, 0x1071, 0x1073, 0x1075, 0x1076, 0x1077},
    /*8*/  {19, 0x101E, 0x101F, 0x1021, 0x1025, 0x1020, 0x103F, 0x1023, 0x1024, 0x1026, 0x1027, 0x1029, 0x102A, 0x1048, 0x0038, 0x1078, 0x1079, 0x107A, 0x107B, 0x107C},
    /*9*/  {10, 0x103E, 0x102F, 0x1030, 0x103B, 0x103C, 0x103D, 0x1037, 0x1038, 0x1049, 0x0039},
    /*0*/  {4, 0x1040, 0x0030, 0x0020, MMIIM_SP_KEYMAP_LINE_BREAK},
};
#elif defined MMIIM_SOGOU_MULTITAP
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_myanmar =
{
    /*1*/  {14, 0x1036, 0x1037, 0x1038, 0x103A, MMIIM_SP_KEYMAP_COMBINE_START+10, 0xF6FC, 0x0031, 0x1041, 0x104A, 0x104B, 0x002E, 0x002C, 0x0021, 0x003F},
    /*2*/  {12, 0x102C, 0x102B, 0x102D, 0x102E, 0x102F, 0x1030, 0x1023, 0x1024, 0x1025, 0x1026, 0x0032, 0x1042},
    /*3*/  { 7, 0x1031, 0x1032, 0x1027, 0x1029, 0x102A, 0x0033, 0x1043},
    /*4*/  { 7, 0x1000, 0x1001, 0x1002, 0x1003, 0x1004, 0x0034, 0x1044},
    /*5*/  { 8, 0x1005, 0x1006, 0x1007, 0x1008, 0x100A, 0x1009, 0x0035, 0x1045},
    /*6*/  { 7, 0x100B, 0x100C, 0x100D, 0x100E, 0x100F, 0x0036, 0x1046},
    /*7*/  { 7, 0x1010, 0x1011, 0x1012, 0x1013, 0x1014, 0x0037, 0x1047},
    /*8*/  { 7, 0x1015, 0x1016, 0x1017, 0x1018, 0x1019, 0x0038, 0x1048},
    /*9*/  {10, 0x101A, 0x101B, 0x101C, 0x101D, 0x101E, 0x101F, 0x1020, 0x1021, 0x0039, 0x1049},
    /*0*/  { 8, 0x0020, 0x103B, 0x103C, 0x103D, 0x103E, 0x0030, 0x1040, MMIIM_SP_KEYMAP_LINE_BREAK},
};
#else	
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_myanmar = 
{
...
{
    /*1*/ {13, 0x0b15, 0x0b16, 0x0b17, 0x0b18, 0x0b19, 0x0b67, 0x0031, MMIIM_SP_KEYMAP_COMBINE_START+8, MMIIM_SP_KEYMAP_COMBINE_START+9, 0x002C, 0x003F, 0x0021},
    /*2*/ {8, 0x0b1a, 0x0b1b, 0x0b1c, 0x0b1d, 0x0b1e, 0x0b68, 0x0032, 0x0B60},
    ...
    /*0*/ {13, 0x0020, 0x002e, 0x0b66, 0x0964, 0x0965, 0x0030, 0x0b4d, 0x0b01, 0x0b02, 0x0b03, 0x0b3d, MMIIM_SP_KEYMAP_COMBINE_START+7, MMIIM_SP_KEYMAP_LINE_BREAK},
    /***/{0},
    /*#*/{0}
};
#elif defined MMIIM_T9_MULTITAP
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table
, 0x0039},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
#else
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_hausa_upper =
...
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{11, 0x0041, 0x0042, 0x0043, 0x0032, 0x00C1, 0x00C6, 0x00C5, 0x00C4, 0x00C0, 0x00C2, 0x00C7},
    /*3*/{ 9, 0x0044, 0x0045, 0x0046, 0x0033, 0x00D0, 0x00C9, 0x00C8, 0x00CB, 0x00CA},
    /*4*/{ 8, 0x0047, 0x0048, 0x0049, 0x0034, 0x00CD, 0x00CE, 0x00CF, 0x00CC},
    /*5*/{ 4, 0x004A, 0x004B, 0x004C, 0x0035},
    /*6*/{10, 0x004D, 0x004E, 0x004F, 0x0036, 0x00D3, 0x00D6, 0x00D8, 0x00D4, 0x00D2, 0x00D1},
    /*7*/{ 5, 0x0050, 0x0051, 0x0052, 0x0053, 0x0037},
    /*8*/{ 8, 0x0054, 0x0055, 0x0056, 0x0038, 0x00DA, 0x00DC, 0x00D9, 0x00DB},
    /*9*/{ 7, 0x0057, 0x0058, 0x0059, 0x005A, 0x0039, 0x00DD, 0x00DE},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
...
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{11, 0x0061, 0x0062, 0x0063, 0x0032, 0x00E1, 0x00E6, 0x00E5, 0x00E4, 0x00E0, 0x00E2, 0x00E7},
    /*3*/{ 9, 0x0064, 0x0065, 0x0066, 0x0033, 0x00F0, 0x00E9, 0x00E8, 0x00EB, 0x00EA},
    /*4*/{ 8, 0x0067, 0x0068, 0x0069, 0x0034, 0x00ED, 0x00EE, 0x00EF, 0x00EC},
    /*5*/{ 4, 0x006A, 0x006B, 0x006C, 0x0035},
    /*6*/{10, 0x006D, 0x006E, 0x006F, 0x0036, 0x00F3, 0x00F6, 0x00F8, 0x00F4, 0x00F2, 0x00F1},
    /*7*/{ 5, 0x0070, 0x0071, 0x0072, 0x0073, 0x0037},
    /*8*/{ 8, 0x0074, 0x0075, 0x0076, 0x0038, 0x00FA, 0x00FC, 0x00F9, 0x00FB},
    /*9*/{ 7, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039, 0x00FD, 0x00FE},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_igbo_upper =
{
    ...
    /*2*/{ 4, 0x0041, 0x0042, 0x0043, 0x0032},
    /*3*/{ 4, 0x0044, 0x0045, 0x0046, 0x0033},
    /*4*/{ 5, 0x0047, 0x0048, 0x0049, 0x1ECA, 0x0034},
    /*5*/{ 4, 0x004A, 0x004B, 0x004C, 0x0035},
    /*6*/{ 6, 0x004D, 0x004E, 0x00D1, 0x004F, 0x1ECC, 0x0036},
    /*7*/{ 5, 0x0050, 0x0051, 0x0052, 0x0053, 0x0037},
    /*8*/{ 5, 0x0054, 0x0055, 0x1EE4, 0x0056, 0x0038},
    /*9*/{ 5, 0x0057, 0x0058, 0x0059, 0x005A, 0x0039},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_igbo_lower =
{
    ...
    /*2*/{ 4, 0x0061, 0x0062, 0x0063, 0x0032},
    /*3*/{ 4, 0x0064, 0x0065, 0x0066, 0x0033},
    /*4*/{ 5, 0x0067, 0x0068, 0x0069, 0x1ECB, 0x0034},
    /*5*/{ 4, 0x006A, 0x006B, 0x006C, 0x0035},
    /*6*/{ 6, 0x006D, 0x006E, 0x00F1, 0x006F, 0x1ECD, 0x0036},
    /*7*/{ 5, 0x0070, 0x0071, 0x0072, 0x0073, 0x0037},
    /*8*/{ 5, 0x0074, 0x0075, 0x1EE5, 0x0076, 0x0038},
    /*9*/{ 5, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
#else
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_kazakh_upper =
{
    ...
    /*9*/{ 6, 0x042B, 0x042C, 0x042D, 0x042E, 0x042F, '9'},
    /*0*/{ 3, 0x0020, '0', MMIIM_SP_KEYMAP_LINE_BREAK},
    /***/{0},
    /*#*/{0}
};
...
{
    /*1*/{15, 0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x003B, 0x005F, 0x0031},
    /*2*/{10, 0x0410, 0x04D8, 0x0411, 0x0412, 0x0413, 0x0492, 0x0032, 0x0041, 0x0042, 0x0043},
    /*3*/{ 9, 0x0414, 0x0415, 0x0401, 0x0416, 0x0417, 0x0033, 0x0044, 0x0045, 0x0046},
    /*4*/{ 9, 0x0418, 0x0419, 0x041A, 0x049A, 0x041B, 0x0034, 0x0047, 0x0048, 0x0049},
    /*5*/{10, 0x041C, 0x041D, 0x04A2, 0x041E, 0x04E8, 0x041F, 0x0035, 0x004A, 0x004B, 0x004C},
    /*6*/{10, 0x0420, 0x0421, 0x0422, 0x0423, 0x04B0, 0x04AE, 0x0036, 0x004D, 0x004E, 0x004F},
    /*7*/{10, 0x0424, 0x0425, 0x04BA, 0x0426, 0x0427, 0x0037, 0x0050, 0x0051, 0x0052, 0x0053},
    /*8*/{ 9, 0x0428, 0x0429, 0x042A, 0x042B, 0x0406, 0x0038, 0x0054, 0x0055, 0x0056},
    /*9*/{ 9, 0x042C, 0x042D, 0x042E, 0x042F, 0x0039, 0x0057, 0x0058, 0x0059, 0x005A},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
...
{
    /*1*/{15, 0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0

    /*3*/{ 9, 0x0044, 0x0045, 0x0046, 0x0033, 0x010E, 0x00C9, 0x0110, 0x011A, 0x0118},
    /*4*/{ 6, 0x0047, 0x0048, 0x0049, 0x0034, 0x00CD, 0x00CE},
    /*5*/{ 8, 0x004A, 0x004B, 0x004C, 0x0035, 0x013D, 0x0139, 0x0141, 0x00A3},
    /*6*/{10, 0x004D, 0x004E, 0x004F, 0x0036, 0x0147, 0x00D3, 0x00D4, 0x0143, 0x00D6, 0x0150},
    /*7*/{11, 0x0050, 0x0051, 0x0052, 0x0053, 0x0037, 0x0154, 0x0160, 0x0158, 0x015A, 0x015E, 0x0024},
    /*8*/{10, 0x0054, 0x0055, 0x0056, 0x0038, 0x0164, 0x00DA, 0x0162, 0x016E, 0x00DC, 0x0170},
    /*9*/{ 9, 0x0057, 0x0058, 0x0059, 0x005A, 0x0039, 0x00DD, 0x017D, 0x0179, 0x017B},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
...
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{11, 0x0061, 0x0062, 0x0063, 0x0032, 0x00E1, 0x00E4, 0x010D, 0x00E2, 0x0103, 0x0105, 0x0107},
    /*3*/{ 9, 0x0064, 0x0065, 0x0066, 0x0033, 0x010F, 0x00E9, 0x0111, 0x011B, 0x0119},
    /*4*/{ 6, 0x0067, 0x0068, 0x0069, 0x0034, 0x00ED, 0x00EE},
    /*5*/{ 8, 0x006A, 0x006B, 0x006C, 0x0035, 0x013E, 0x013A, 0x0142, 0x00A3},
    /*6*/{10, 0x006D, 0x006E, 0x006F, 0x0036, 0x0148, 0x00F3, 0x00F4, 0x0144, 0x00F6, 0x0151},
    /*7*/{12, 0x0070, 0x0071, 0x0072, 0x0073, 0x0037, 0x0155, 0x0161, 0x0159, 0x015B, 0x015F, 0x00DF, 0x0024},
    /*8*/{10, 0x0074, 0x0075, 0x0076, 0x0038, 0x0165, 0x00FA, 0x0163, 0x016F, 0x00FC, 0x0171},
    /*9*/{ 9, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039, 0x00FD, 0x017E, 0x017A, 0x017C},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
#else
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_slovak_upper =
...
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{12, 0x0041, 0x0042, 0x0043, 0x0032, 0x00C5, 0x00C4, 0x00C6, 0x00C0, 0x00C1, 0x00C2, 0x00C7, 0x00C3},
    /*3*/{ 9, 0x0044, 0x0045, 0x0046, 0x0033, 0x00C9, 0x00D0, 0x00C8, 0x00CB, 0x00CA},
    /*4*/{ 8, 0x0047, 0x0048, 0x0049, 0x0034, 0x00CE, 0x00CF, 0x00CC, 0x00CD},
    /*5*/{ 4, 0x004A, 0x004B, 0x004C, 0x0035},
    /*6*/{11, 0x004D, 0x004E, 0x004F, 0x0036, 0x00D6, 0x00D8, 0x00D4, 0x00D2, 0x00D3, 0x00D5, 0x00D1},
    /*7*/{ 6, 0x0050, 0x0051, 0x0052, 0x0053, 0x0037, 0x0024},
    /*8*/{ 8, 0x0054, 0x0055, 0x0056, 0x0038, 0x00DC, 0x00D9, 0x00DB, 0x00DA},
    /*9*/{ 7, 0x0057, 0x0058, 0x0059, 0x005A, 0x0039, 0x00DD, 0x00DE},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
...
{
    /*1*/{14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{12, 0x0061, 0x0062, 0x0063, 0x0032, 0x00E5, 0x00E4, 0x00E6, 0x00E0, 0x00E1, 0x00E2, 0x00E7, 0x00E3},
    /*3*/{ 9, 0x0064, 0x0065, 0x0066, 0x0033, 0x00E9, 0x00F0, 0x00E8, 0x00EB, 0x00EA},
    /*4*/{ 8, 0x0067, 0x0068, 0x0069, 0x0034, 0x00EE, 0x00EF, 0x00EC, 0x00ED},
    /*5*/{ 4, 0x006A, 0x006B, 0x006C, 0x0035},
    /*6*/{11, 0x006D, 0x006E, 0x006F, 0x0036, 0x00F6, 0x00F8, 0x00F4, 0x00F2, 0x00F3, 0x00F5, 0x00F1},
    /*7*/{ 7, 0x0070, 0x0071, 0x0072, 0x0073, 0x0037, 0x00DF, 0x0024},
    /*8*/{ 8, 0x0074, 0x0075, 0x0076, 0x0038, 0x00FC, 0x00F9, 0x00FB, 0x00FA},
    /*9*/{ 7, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039, 0x00FD, 0x00FE},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_yoruba_upper =
{
    /*1*/{14, 0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{ 4,  0x0041, 0x0042, 0x0043, 0x0032},
    /*3*/{ 5,  0x0044, 0x0045, 0x1EB8, 0x0046, 0x0033},
    /*4*/{ 4, 0x0047, 0x0048, 0x0049, 0x0034},
    /*5*/{ 4, 0x004A, 0x004B, 0x004C, 0x0035},
    /*6*/{ 5, 0x004D, 0x004E, 0x004F, 0x1ECC, 0x0036},
    /*7*/{ 6, 0x0050, 0x0051, 0x0052, 0x0053, 0x1E62, 0x0037},
    /*8*/{ 4, 0x0054, 0x0055, 0x0056, 0x0038},
    /*9*/{ 5, 0x0057, 0x0058, 0x0059, 0x005A, 0x0039},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_yoruba_upper_full =
{
    /*1*/{14, 0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{ 5, 0x0300, 0x0041, 0x0042, 0x0043, 0x0032},
    /*3*/{ 6, 0x0301, 0x0044, 0x0045, 0x1EB8, 0x0046, 0x0033},
    /*4*/{ 4, 0x0047, 0x0048, 0x0049, 0x0034},
    /*5*/{ 4, 0x004A, 0x004B, 0x004C, 0x0035},
    /*6*/{ 5, 0x004D, 0x004E, 0x004F, 0x1ECC, 0x0036},
    /*7*/{ 6, 0x0050, 0x0051, 0x0052, 0x0053, 0x1E62, 0x0037},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_yoruba_lower =
{
    /*1*/{14, 0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{ 4, 0x0061, 0x0062, 0x0063, 0x0032},
    /*3*/{ 5, 0x0064, 0x0065, 0x1EB9, 0x0066, 0x0033},
    /*4*/{ 4, 0x0067, 0x0068, 0x0069, 0x0034},
    /*5*/{ 4, 0x006A, 0x006B, 0x006C, 0x0035},
    /*6*/{ 5, 0x006D, 0x006E, 0x006F, 0x1ECD, 0x0036},
    /*7*/{ 6, 0x0070, 0x0071, 0x0072, 0x0073, 0x1E63, 0x0037},
    /*8*/{ 4, 0x0074, 0x0075, 0x0076, 0x0038},
    /*9*/{ 5, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039},
    /*0*/{ 3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};

static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_yoruba_lower_full =
{
    /*1*/{14, 0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/{ 5, 0x0300, 0x0061, 0x0062, 0x0063, 0x0032},
    /*3*/{ 6, 0x0301, 0x0064, 0x0065, 0x1EB9, 0x0066, 0x0033},
    /*4*/{ 4, 0x0067, 0x0068, 0x0069, 0x0034},
    /*5*/{ 4, 0x006A, 0x006B, 0x006C, 0x0035},
    /*6*/{ 5, 0x006D, 0x006E, 0x006F, 0x1ECD, 0x0036},
    /*7*/{ 6, 0x0070, 0x0071, 0x0072, 0x0073, 0x1E63, 0x0037},
...
{
    /*1*/{8, 0x1362, 0x1363, 0x1364, 0x1366, 0x1365, 0x003F, 0x0021, 0x0031}, 
    /*2*/{6, 0x1200, 0x1208, 0x1298, 0x1218, 0x1210, 0x0032},
    /*3*/{6, 0x1230, 0x1228, 0x1238, 0x1220, 0x1338, 0x0033},
    /*4*/{7, 0x1260, 0x1270, 0x1240, 0x1280, 0x1248, 0x1250, 0x0034},
    /*5*/{5, 0x12A0, 0x1278, 0x1290, 0x1288, 0x0035}, 
    /*6*/{6, 0x12A8, 0x12C8, 0x12E0, 0x12B8, 0x12B0, 0x0036},
    /*7*/{6, 0x12D8, 0x12E8, 0x12F0, 0x1300, 0x12D0, 0x0037},
    /*8*/{6, 0x1308, 0x1320, 0x1330, 0x1328, 0x1310, 0x0038},
    /*9*/{5, 0x1348, 0x1340, 0x1268, 0x1350, 0x0039},
    /*0*/{3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_abc_khmer = 
{
    ...
    /*0*/{4, 0x17C9, 0x17CB, 0x17C8, MMIIM_SP_KEYMAP_LINE_BREAK},
    /***/{0},
    /*#*/{0}
};    
#elif defined MMIIM_SOGOU_MULTITAP
...
#elif defined MMIIM_T9_MULTITAP
// Ver_1S2S3S
// (BC||BV||CS||RO||DV||VM) == FALSE
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_abc_khmer = 
{
    /*1*/{7, 0x17D4, 0x002E, 0x002C, 0x003F, 0x0021, 0x0031, 0x17E1},
    /*2*/{2, 0x0032, 0x17E2},
    /*3*/{2, 0x0033, 0x17E3},
    /*4*/{ 7, 0x1780, 0x1781, 0x1782, 0x1783, 0x1784, 0x0034, 0x17E4},
    /*5*/{ 7, 0x1785, 0x1786, 0x1787, 0x1788, 0x1789, 0x0035, 0x17E5},
    /*6*/{ 7, 0x178A, 0x178B, 0x178C, 0x178D, 0x178E, 0x0036, 0x17E6},
    /*7*/{ 7, 0x178F, 0x1790, 0x1791, 0x1792, 0x1793, 0x0037, 0x17E7},
    /*8*/{ 7, 0x1794, 0x1795, 0x1796, 0x1797, 0x1798, 0x0038, 0x17E8},
    /*9*/{10, 0x1799, 0x179A, 0x179B, 0x179C, 0x179F, 0x17A0, 0x17A1, 0x17A2, 0x0039, 0x17E9},
    /*0*/{18, 0x0020, 0x17A5, 0x17A6, 0x17A7, 0x17A9, 0x17AA, 0x17AB, 0x17AC, 0x17AD, 0x17AE, 0x17AF, 0x17B0, 0x17B1, 0x17B2, 0x17B3, 0x0030, 0x17E0, MMIIM_SP_KEYMAP_LINE_BREAK},
};
// Ver_1F2F3F
// (BC||BV||CS) == TRUE
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_abc_khmer_full = 
{
    /*1*/{13, 0x17D2, 0x17BB, 0x17BC, 0x17BD, MMIIM_SP_KEYMAP_COMBINE_START+20, MMIIM_SP_KEYMAP_COMBINE_START+21, 0x17D4, 0x002E, 0x002C, 0x003F, 0x0021, 0x0031, 0x17E1},
    /*2*/{15, 0x17CB, 0x17B7, 0x17B8, 0x17B9, 0x17BA, 0x17C6, 0x17CF, 0x17C9, 0x17CA, 0x17D0, 0x17CD, 0x17CE, 0x17CC, 0x0032, 0x17E2},
    /*3*/{16, 0x17B6, 0x17BE, 0x17BF, 0x17C0, 0x17C1, 0x17C2, 0x17C3, 0x17C4, 0x17C5, MMIIM_SP_KEYMAP_COMBINE_START+22, 0x17C7, MMIIM_SP_KEYMAP_COMBINE_START+23, MMIIM_SP_KEYMAP_COMBINE_START+24, 0x17C8, 0x0033, 0x17E3},
    /*4*/{ 7, 0x1780, 0x1781, 0x1782, 0x1783, 0x1784, 0x0034, 0x17E4},
    /*5*/{ 7, 0x1785, 0x1786, 0x1787, 0x1788, 0x1789, 0x0035, 0x17E5},
    /*6*/{ 7, 0x178A, 0x178B, 0x178C, 0x178D, 0x178E, 0x0036, 0x17E6},
    /*7*/{ 7, 0x178F, 0x1790, 0x1791, 0x1792, 0x1793, 0x0037, 0x17E7},
...
// Ver_1S2F3S
// !(BC||BV||CS) && !DV && (RO||VM)
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_abc_khmer_sfs = 
{
    /*1*/{7, 0x17D4, 0x002E, 0x002C, 0x003F, 0x0021, 0x0031, 0x17E1},
    /*2*/{15, 0x17CB, 0x17B7, 0x17B8, 0x17B9, 0x17BA, 0x17C6, 0x17CF, 0x17C9, 0x17CA, 0x17D0, 0x17CD, 0x17CE, 0x17CC, 0x0032, 0x17E2},
    /*3*/{2, 0x0033, 0x17E3},
...
// Ver_1S2F3M
// !(BC||BV||CS) && DV
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_abc_khmer_sfm = 
{
    /*1*/{7, 0x17D4, 0x002E, 0x002C, 0x003F, 0x0021, 0x0031, 0x17E1},
    /*2*/{15, 0x17CB, 0x17B7, 0x17B8, 0x17B9, 0x17BA, 0x17C6, 0x17CF, 0x17C9, 0x17CA, 0x17D0, 0x17CD, 0x17CE, 0x17CC, 0x0032, 0x17E2},
    /*3*/{4, 0x17C7,0x17C8,0x0033, 0x17E3},
    /*4*/{ 7, 0x1780, 0x1781, 0x1782, 0x1783, 0x1784, 0x0034, 0x17E4},
    /*5*/{ 7, 0x1785, 0x1786, 0x1787, 0x1788, 0x1789, 0x0035, 0x17E5},
    /*6*/{ 7, 0x178A, 0x178B, 0x178C, 0x178D, 0x178E, 0x0036, 0x17E6},
    /*7*/{ 7, 0x178F, 0x1790, 0x1791, 0x1792, 0x1793, 0x0037, 0x17E7},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_abc_lao =
{
    ...
    /*0*/  {18, 0x0020, 0x0030, 0x0EAF, 0x0EB1, 0x0EB4, 0x0EB5, 0x0EB6, 0x0EB7, 0x0EB8, 0x0EB9, 0x0EC6, 0x0EC8, 0x0EC9, 0x0ECA, 0x0ECB, 0x0ECC, 0x0ECD, MMIIM_SP_KEYMAP_LINE_BREAK},
};
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_abc_tibetan =
{
    ...
    /*0*/  {3, 0x0F20,0x0020, MMIIM_SP_KEYMAP_LINE_BREAK},
};
#else
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_abc_tibetan =
{
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_abc_sinhalese =
{
    /*1*/  {10, 0x0DCA, MMIIM_SP_KEYMAP_COMBINE_START+3, MMIIM_SP_KEYMAP_COMBINE_START+4, 0x0D82, 0x0D83, 0x0031, 0x002E, 0x002C, 0x003F, 0x0021},
    /*2*/  {16, 0x0D85, 0x0D86, 0x0D87, 0x0D88, 0x0D89, 0x0D8A, 0x0D8B, 0x0D8C, 0x0DCF, 0x0DD0, 0x0DD1, 0x0DD2, 0x0DD3, 0x0DD4, 0x0DD6, 0x0032},
    /*3*/  {16, 0x0D91, 0x0D92, 0x0D94, 0x0D95, 0x0DD9, 0x0DDA, 0x0DDC, 0x0DDD, 0x0033, 0x0D93, 0x0D96, 0x0D8D, 0x0DDB, 0x0DDE, 0x0DD8, 0x0DF2},
    /*4*/  { 7, 0x0D9A, 0x0D9C, 0x0D9F, 0x0034, 0x0D9B, 0x0D9D, 0x0D9E},
    /*5*/  { 7, 0x0DA0, 0x0DA2, 0x0DA4, 0x0035, 0x0DA5, 0x0DA1, 0x0DA3},
    ...
    /*8*/  { 7, 0x0DB4, 0x0DB6, 0x0DB8, 0x0038, 0x0DB9, 0x0DB5, 0x0DB7},
    /*9*/  { 7, 0x0DBA, 0x0DBB, 0x0DBD, 0x0039, 0x0DC5, MMIIM_SP_KEYMAP_COMBINE_START+5, MMIIM_SP_KEYMAP_COMBINE_START+6},
    /*0*/  { 9, 0x0020, 0x0DC0, 0x0DC3, 0x0DC4, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK, 0x0DC1, 0x0DC2, 0x0DC6},
};
#else	//sogou版本代替
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_abc_sinhalese =
{
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_bosnian_upper =
{
    /*1*/  {14,0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  {11,0x0041, 0x0042, 0x0043, 0x010C, 0x0106, 0x0032, 0x00C1, 0x00C2, 0x00C4, 0x0102, 0x0104},
    /*3*/  {9, 0x0044, 0x0110, 0x0045, 0x0046, 0x0033, 0x010E, 0x00C9, 0x0118, 0x011A},
    ...
    /*5*/  {4, 0x004A, 0x004B, 0x004C, 0x0035},
    /*6*/  {10,0x004D, 0x004E, 0x004F, 0x0036, 0x0143, 0x0147, 0x00D3, 0x00D4, 0x00D6, 0x0150},
    /*7*/  {10,0x0050, 0x0051, 0x0052, 0x0053, 0x0160, 0x0037, 0x0154, 0x0158, 0x015A, 0x015E},
    /*8*/  {10,0x0054, 0x0055, 0x0056, 0x0038, 0x0162, 0x0164, 0x00DA, 0x00DC, 0x016E, 0x0170},
    /*9*/  {9, 0x0057, 0x0058, 0x0059, 0x005A, 0x017D, 0x0039, 0x00DD, 0x0179, 0x017B},
    /*0*/  {3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};

static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_bosnian_lower =
{
    /*1*/  {14,0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  {11,0x0061, 0x0062, 0x0063, 0x010D, 0x0107, 0x0032, 0x00E1, 0x00E2, 0x00E4, 0x0103, 0x0105},
    /*3*/  {9, 0x0064, 0x0111, 0x0065, 0x0066, 0x0033, 0x010F, 0x00E9, 0x0119, 0x011B},
    ...
    /*5*/  {4, 0x006A, 0x006B, 0x006C, 0x0035},
    /*6*/  {10,0x006D, 0x006E, 0x006F, 0x0036, 0x0144, 0x0148, 0x00F3, 0x00F4, 0x00F6, 0x0151},
    /*7*/  {11,0x0070, 0x0071, 0x0072, 0x0073, 0x0161, 0x0037, 0x0155, 0x0159, 0x015B, 0x015F, 0x00DF},
    /*8*/  {10,0x0074, 0x0075, 0x0076, 0x0038, 0x0163, 0x0165, 0x00FA, 0x00FC, 0x016F, 0x0171},
    /*9*/  {9, 0x0077, 0x0078, 0x0079, 0x007A, 0x017E, 0x0039, 0x00FD, 0x017A, 0x017C},
    /*0*/  {3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
};

static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_american_upper =
{
    /*1*/  {14,0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  {4, 0x0041, 0x0042, 0x0043, 0x0032},
    /*3*/  {4, 0x0044, 0x0045, 0x0046, 0x0033},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_american_lower =
{
    /*1*/  {14,0x002E, 0x002C, 0x0027, 0x003F, 0x0021, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  {4, 0x0061, 0x0062, 0x0063, 0x0032},
    /*3*/  {4, 0x0064, 0x0065, 0x0066, 0x0033},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_turkmen_latin_upper =
{
    /*1*/  {14,0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  {6, 0x0041, 0x0042, 0x0043, 0x0032, 0x00C4, 0x00C7},
    /*3*/  {4, 0x0044, 0x0045, 0x0046, 0x0033},
    /*4*/  {4, 0x0047, 0x0048, 0x0049, 0x0034},
    /*5*/  {4, 0x004A, 0x004B, 0x004C, 0x0035},
    /*6*/  {6, 0x004D, 0x004E, 0x004F, 0x0036, 0x0147, 0x00D6},
    /*7*/  {6, 0x0050, 0x0051, 0x0052, 0x0053, 0x0037, 0x015E},
    /*8*/  {5, 0x0054, 0x0055, 0x0056, 0x0038, 0x00DC},
    /*9*/  {7, 0x0057, 0x0058, 0x0059, 0x005A, 0x0039, 0x00DD, 0x017D},
    /*0*/  {3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
...
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_turkmen_latin_lower =
{
    /*1*/  {14,0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  {6, 0x0061, 0x0062, 0x0063, 0x0032, 0x00E4, 0x00E7},
    /*3*/  {4, 0x0064, 0x0065, 0x0066, 0x0033},
    /*4*/  {4, 0x0067, 0x0068, 0x0069, 0x0034},
    /*5*/  {4, 0x006A, 0x006B, 0x006C, 0x0035},
    /*6*/  {6, 0x006D, 0x006E, 0x006F, 0x0036, 0x0148, 0x00F6},
    /*7*/  {6, 0x0070, 0x0071, 0x0072, 0x0073, 0x0037, 0x015F},
    /*8*/  {5, 0x0074, 0x0075, 0x0076, 0x0038, 0x00FC},
    /*9*/  {7, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039, 0x00FD, 0x017E},
    /*0*/  {3, 0x0020, 0x0030, MMIIM_SP_KEYMAP_LINE_BREAK},
...
//Belarus
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_belarus_upper =
{
    /*1*/  {10, 0x002E, 0x002C, 0x002D, 0x003F, 0x0021, 0x0027, 0x0040, 0x003A, 0x002F, 0x0031},
    /*2*/  { 5, 0x0410, 0x0411, 0x0412, 0x0413, 0x0032},
    /*3*/  { 6, 0x0414, 0x0415, 0x0401, 0x0416, 0x0417, 0x0033},
    /*4*/  { 5, 0x0406, 0x0419, 0x041A, 0x041B, 0x0034},
    /*5*/  { 5, 0x041C, 0x041D, 0x041E, 0x041F, 0x0035},
    /*6*/  { 6, 0x0420, 0x0421, 0x0422, 0x0423, 0x040E, 0x0036},
    /*7*/  { 5,0x0424, 0x0425, 0x0426, 0x0427, 0x0037},
    /*8*/  { 3, 0x0428, 0x042B, 0x0038},
    /*9*/  { 5, 0x042C, 0x042D, 0x042E, 0x042F, 0x0039},
    /*0*/  { 1, 0x0030},
};
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_belarus_lower =
{
    /*1*/  {10, 0x002E, 0x002C, 0x002D, 0x003F, 0x0021, 0x0027, 0x0040, 0x003A, 0x002F, 0x0031},
    /*2*/  { 5, 0x0430, 0x0431, 0x0432, 0x0433, 0x0032},
    /*3*/  { 6, 0x0434, 0x0435, 0x0451, 0x0436, 0x0437, 0x0033},
    /*4*/  { 5, 0x0456, 0x0439, 0x043A, 0x043B, 0x0034},
    /*5*/  { 4, 0x043C, 0x043D, 0x043E, 0x0035},
    /*6*/  { 4, 0x043F, 0x0440, 0x0441, 0x0036},
    /*7*/  { 6, 0x0442, 0x0443, 0x045E, 0x0444, 0x0045, 0x0037},
    /*8*/  { 4, 0x0446, 0x0447, 0x0448, 0x0038},
    /*9*/  { 6, 0x044B, 0x044C, 0x044D, 0x044E, 0x044F, 0x0039},
    /*0*/  { 1, 0x0030},
};

static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_lingala_upper =
{
    /*1*/  {9, 0x002E, 0x002C, 0x002D, 0x003F, 0x0021, 0x0027, 0x0040, 0x003A, 0x0031},
    /*2*/  {6, 0x0410, 0x0411, 0x0412, 0x0413, 0x0492, 0x0032},
    /*3*/  {6, 0x0414, 0x0415, 0x0401, 0x0416, 0x0417, 0x0033},
    /*4*/  {6, 0x0418, 0x0419, 0x041A, 0x049A, 0x041B, 0x0034},
    /*5*/  {5, 0x041C, 0x041D, 0x041E, 0x041F, 0x0035},
    /*6*/  {6, 0x0420, 0x0421, 0x0422, 0x0423, 0x040E, 0x0036},
    /*7*/  {6, 0x0424, 0x0425, 0x04B2, 0x0426, 0x0427, 0x0037},
    /*8*/  { 3, 0x0428, 0x042B, 0x0038},
    /*9*/  { 5, 0x042C, 0x042D, 0x042E, 0x042F, 0x0039},
    /*0*/  { 1, 0x0030},
};

static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_lingala_lower =
{
    /*1*/  {9, 0x002E, 0x002C, 0x002D, 0x003F, 0x0021, 0x0027, 0x0040, 0x003A, 0x0031},
    /*2*/  {6, 0x0430, 0x0431, 0x0432, 0x0433, 0x0493, 0x0032},
    /*3*/  {6, 0x0434, 0x0435, 0x0451, 0x0436, 0x0437, 0x0033},
    /*4*/  {4, 0x0438, 0x0439, 0x043A, 0x049B, 0x043B, 0x0034},
    /*5*/  {4, 0x043C, 0x043D, 0x043E, 0x0035},
    /*6*/  {4, 0x043F, 0x0440, 0x0441, 0x0036},
    /*7*/  {7, 0x0442, 0x0443, 0x045E, 0x0444, 0x0045, 0x04B3, 0x0037},
    /*8*/  {5, 0x0446, 0x0447, 0x0448, 0x044A, 0x0038},
    /*9*/  {5, 0x044C, 0x044D, 0x044E, 0x044F, 0x0039},
    /*0*/  {1, 0x0030},
};

static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_malagasy_upper =
{
    /*1*/  {14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  { 9, 0x0041, 0x0042, 0x0043, 0x0032, 0x00C0, 0x00C1, 0x00C2, 0x00C6, 0x00C7},
    /*3*/  { 8, 0x0044, 0x0045, 0x0046, 0x0033, 0x00C8, 0x00C9, 0x00CA, 0x00CB},
    /*4*/  { 8, 0x0047, 0x0048, 0x0049, 0x0034, 0x00CC, 0x00CD, 0x00CE, 0x00CF},
    /*5*/  { 4, 0x004A, 0x004B, 0x004C, 0x0035},
    /*6*/  {10, 0x004D, 0x004E, 0x004F, 0x0036, 0x00D2, 0x00D3, 0x00D4, 0x0308, 0x00D1, 0x0152}, //0x004E+0x0308
    /*7*/  { 5, 0x0050, 0x0051, 0x0052, 0x0053, 0x0037},
    /*8*/  { 7, 0x0054, 0x0055, 0x0056, 0x0038, 0x00D9, 0x00DA, 0x00DB},
    /*9*/  { 7, 0x0057, 0x0058, 0x0059, 0x005A, 0x0039, 0x1EF2, 0x00DD},
    /*0*/  { 3, 0x0020, 0x0030, 0x21B5},
};

static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_malagasy_lower =
{
    /*1*/  {14, 0x002E, 0x002C, 0x003F, 0x0021, 0x0027, 0x0022, 0x0031, 0x002D, 0x0028, 0x0029, 0x0040, 0x002F, 0x003A, 0x005F},
    /*2*/  { 9, 0x0061, 0x0062, 0x0063, 0x0032, 0x00E0, 0x00E1, 0x00E2, 0x00E6, 0x00E7},
    /*3*/  { 8, 0x0064, 0x0065, 0x0066, 0x0033, 0x00E8, 0x00E9, 0x00EA, 0x00EB},
    /*4*/  { 8, 0x0067, 0x0068, 0x0069, 0x0034, 0x00EC, 0x00ED, 0x00EE, 0x00EF},
    /*5*/  { 4, 0x006A, 0x006B, 0x006C, 0x0035},
    /*6*/  {10, 0x006D, 0x006E, 0x006F, 0x0036, 0x00F2, 0x00F3, 0x00F4, 0x0308, 0x00F1, 0x0153}, //0x006E+0x0308
    /*7*/  { 5, 0x0070, 0x0071, 0x0072, 0x0073, 0x0037},
    /*8*/  { 7, 0x0074, 0x0075, 0x0076, 0x0038, 0x00FA, 0x00F9, 0x00FB},
    /*9*/  { 7, 0x0077, 0x0078, 0x0079, 0x007A, 0x0039, 0x1EF3, 0x00FD},
    /*0*/  { 3, 0x0020, 0x0030, 0x21B5},
};

static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_pashto =
{
    /*1*/{ 6, 0x002E, 0x061F, 0x003A, 0x060C, 0x0021, 0x0031},
    /*2*/{ 7, 0x0628, 0x067E, 0x062A, 0x0629, 0x067C, 0x062B, 0x0032},
    /*3*/{ 7, 0x0627, 0x0622, 0x0623, 0x0624, 0x0626, 0x0621, 0x0033},
    /*4*/{ 6, 0x0633, 0x0634, 0x069A, 0x0635, 0x0636, 0x0034},
    /*5*/{ 9, 0x062F, 0x0689, 0x0630, 0x0631, 0x0693, 0x0632, 0x0698, 0x0696, 0x0035},
    /*6*/{ 7, 0x062C, 0x0681, 0x0686, 0x0685, 0x062D, 0x062E, 0x0036},
    /*7*/{ 8, 0x0646, 0x06BC, 0x0648, 0x0647, 0x06CC, 0x06D0, 0x06CD, 0x0037},
    /*8*/{ 8, 0x0641, 0x0642, 0x06A9, 0x0643, 0x06AB, 0x0644, 0x0645, 0x0038},
    /*9*/{ 5, 0x0637, 0x0638, 0x0639, 0x063A, 0x0039},
    /*0*/{ 1, 0x0030},
};

static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_uzbek_upper =
{
    /*1*/  {9, 0x002E, 0x002C, 0x002D, 0x003F, 0x0021, 0x0027, 0x0040, 0x003A,  0x0031},
    /*2*/  {6, 0x0410, 0x0411, 0x0412, 0x0413, 0x0492, 0x0032},
    /*3*/  {6, 0x0414, 0x0415, 0x0401, 0x0416, 0x0417, 0x0033},
    ...
    /*6*/  {6, 0x0420, 0x0421, 0x0422, 0x0423, 0x040E, 0x0036},
    /*7*/  {6, 0x0424, 0x0425, 0x04B2, 0x0426, 0x0427, 0x0037},
    /*8*/  {3, 0x0428, 0x042A, 0x0038},
    /*9*/  {5, 0x042C, 0x042D, 0x042E, 0x042F, 0x0039},
    /*0*/  {1, 0x0030},
};
static MMIIM_SP_9KEY_TABLE_DEF_T s_key_table_uzbek_lower =
{
    /*1*/  {9, 0x002E, 0x002C, 0x002D, 0x003F, 0x0021, 0x0027, 0x0040, 0x003A,  0x0031},
    /*2*/  {6, 0x0430, 0x0431, 0x0432, 0x0433, 0x0493, 0x0032},
    /*3*/  {6, 0x0434, 0x0435, 0x0451, 0x0436, 0x0437, 0x0033},
    /*4*/  {6, 0x0438, 0x0439, 0x043A, 0x049B, 0x043B, 0x0034},
    /*5*/  {5, 0x043C, 0x043D, 0x043E, 0x043F, 0x0035},
    /*6*/  {6, 0x0440, 0x0441, 0x0442, 0x0443, 0x045E, 0x0036},
    /*7*/  {6, 0x0444, 0x0445, 0x04B3, 0x0446, 0x0447, 0x0037},
    /*8*/  {3, 0x0448, 0x044A, 0x0038},
    /*9*/  {5, 0x044C, 0x044D, 0x044E, 0x044F, 0x0039},
    /*0*/  {1, 0x0030},
};
// 输入法信息
...
#ifdef IM_NEPALI_SUPPORT
    {GUIIM_M_NEPALI_ABC, &s_key_table_nepali},
    {GUIIM_M_TP_NEPALI_ABC, &s_key_table_nepali},
#endif

#ifdef IM_LATIN_SPANISH_SUPPORT
    {GUIIM_M_LATIN_SPANISH_ABC_LEAD_UPPER, &s_key_table_latin_spanish_upper},
    {GUIIM_M_LATIN_SPANISH_ABC_LOWER,      &s_key_table_latin_spanish_lower},
    {GUIIM_M_LATIN_SPANISH_ABC_UPPER,      &s_key_table_latin_spanish_upper},
#endif

#ifdef IM_LATIN_SERBIAN_SUPPORT
    {GUIIM_M_LATIN_SERBIAN_ABC_LEAD_UPPER, &s_key_table_latin_serbian_upper},
    {GUIIM_M_LATIN_SERBIAN_ABC_LOWER,      &s_key_table_latin_serbian_lower},
    {GUIIM_M_LATIN_SERBIAN_ABC_UPPER,      &s_key_table_latin_serbian_upper},
#endif

#ifdef IM_BRAZILIAN_PORTUGUESE_SUPPORT
    {GUIIM_M_BRAZILIAN_PORTUGUESE_ABC_LEAD_UPPER, &s_key_table_brazilian_portuguese_upper},
    {GUIIM_M_BRAZILIAN_PORTUGUESE_ABC_LOWER,      &s_key_table_brazilian_portuguese_lower},
    {GUIIM_M_BRAZILIAN_PORTUGUESE_ABC_UPPER,      &s_key_table_brazilian_portuguese_upper},
#endif
...
// 马来语
#ifdef IM_MALAY_SUPPORT
#if (defined(MMIIM_CSTAR_MULTITAP) || defined(MMIIM_T9_MULTITAP) || defined(MMIIM_IEKIE_MULTITAP))
    {GUIIM_M_MALAY_ABC_LEAD_UPPER, &s_key_table_malay_upper},
    {GUIIM_M_MALAY_ABC_LOWER,      &s_key_table_malay_lower},
    {GUIIM_M_MALAY_ABC_UPPER,      &s_key_table_malay_upper},

    {GUIIM_M_TP_MALAY_ABC_LEAD_UPPER, &s_key_table_malay_upper},
    {GUIIM_M_TP_MALAY_ABC_LOWER,      &s_key_table_malay_lower},
    {GUIIM_M_TP_MALAY_ABC_UPPER,      &s_key_table_malay_upper},
#else
...
#ifdef MMIIM_T9_MULTITAP
    {GUIIM_M_PORTUGUESE_BR_ABC_LEAD_UPPER, &s_key_table_portuguese_br_upper},
    {GUIIM_M_PORTUGUESE_BR_ABC_LOWER, &s_key_table_portuguese_br_lower}, 
    {GUIIM_M_PORTUGUESE_BR_ABC_UPPER, &s_key_table_portuguese_br_upper},
#else
    {GUIIM_M_PORTUGUESE_BR_ABC_LEAD_UPPER, &s_key_table_portuguese_upper},
    {GUIIM_M_PORTUGUESE_BR_ABC_LOWER, &s_key_table_portuguese_lower}, 
    {GUIIM_M_PORTUGUESE_BR_ABC_UPPER, &s_key_table_portuguese_upper},
 #endif
#endif
...
#ifdef MMIIM_T9_MULTITAP
    {GUIIM_M_SPANISH_AM_ABC_LEAD_UPPER, &s_key_table_spanish_us_upper},
    {GUIIM_M_SPANISH_AM_ABC_LOWER,      &s_key_table_spanish_us_lower},
    {GUIIM_M_SPANISH_AM_ABC_UPPER,      &s_key_table_spanish_us_upper},
#else
    {GUIIM_M_SPANISH_AM_ABC_LEAD_UPPER, &s_key_table_spanish_upper},
    {GUIIM_M_SPANISH_AM_ABC_LOWER,      &s_key_table_spanish_lower},
    {GUIIM_M_SPANISH_AM_ABC_UPPER,      &s_key_table_spanish_upper},
...
// 斯瓦西里语
#ifdef IM_SWAHILI_SUPPORT       
#if (defined(MMIIM_CSTAR_MULTITAP) || defined(MMIIM_IEKIE_MULTITAP) || defined(MMIIM_T9_MULTITAP))
    {GUIIM_M_SWAHILI_ABC_LEAD_UPPER, &s_key_table_swahili_upper},
    {GUIIM_M_SWAHILI_ABC_LOWER,      &s_key_table_swahili_lower},
    {GUIIM_M_SWAHILI_ABC_UPPER,      &s_key_table_swahili_upper},

    {GUIIM_M_TP_SWAHILI_ABC_LEAD_UPPER, &s_key_table_swahili_upper},
    {GUIIM_M_TP_SWAHILI_ABC_LOWER,      &s_key_table_swahili_lower},
    {GUIIM_M_TP_SWAHILI_ABC_UPPER,      &s_key_table_swahili_upper},
#else
...
#if !defined MMIIM_SOGOU_MULTITAP && defined MMIIM_T9_MULTITAP
    {GUIIM_M_TAGALOG_ABC_LEAD_UPPER, &s_key_table_tagalog_upper},
    {GUIIM_M_TAGALOG_ABC_LOWER, &s_key_table_tagalog_lower},
    {GUIIM_M_TAGALOG_ABC_UPPER, &s_key_table_tagalog_upper},
    //{GUIIM_M_TP_TAGALOG_ABC, &s_key_table_tagalog},
    {GUIIM_M_TP_TAGALOG_ABC, &s_key_table_tagalog_lower},
#endif
#endif
...
#ifdef IM_XHOSA_SUPPORT
#if (defined(MMIIM_CSTAR_MULTITAP) || defined(MMIIM_T9_MULTITAP) || defined(MMIIM_IEKIE_MULTITAP))
    {GUIIM_M_XHOSA_ABC_LEAD_UPPER, &s_key_table_xhosa_upper},
    {GUIIM_M_XHOSA_ABC_LOWER,      &s_key_table_xhosa_lower},
    {GUIIM_M_XHOSA_ABC_UPPER,      &s_key_table_xhosa_upper},

    {GUIIM_M_TP_XHOSA_ABC_LEAD_UPPER, &s_key_table_xhosa_upper},
    {GUIIM_M_TP_XHOSA_ABC_LOWER,      &s_key_table_xhosa_lower},
    {GUIIM_M_TP_XHOSA_ABC_UPPER,      &s_key_table_xhosa_upper},
#else
...
#ifdef IM_ZULU_SUPPORT
#if (defined(MMIIM_CSTAR_MULTITAP) || defined(MMIIM_T9_MULTITAP) || defined(MMIIM_IEKIE_MULTITAP))
    {GUIIM_M_ZULU_ABC_LEAD_UPPER, &s_key_table_zulu_upper},
    {GUIIM_M_ZULU_ABC_LOWER,      &s_key_table_zulu_lower},
    {GUIIM_M_ZULU_ABC_UPPER,      &s_key_table_zulu_upper},

    {GUIIM_M_TP_ZULU_ABC_LEAD_UPPER, &s_key_table_zulu_upper},
    {GUIIM_M_TP_ZULU_ABC_LOWER,      &s_key_table_zulu_lower},
    {GUIIM_M_TP_ZULU_ABC_UPPER,      &s_key_table_zulu_upper},
#else
...
//老挝
...
#ifdef IM_SINHALESE_SUPPORT
#ifdef MMIIM_CORE_USE_IEKIE
    {GUIIM_M_SINHALESE_ABC, &s_key_table_sinhala},
    {GUIIM_M_TP_SINHALESE_ABC, &s_key_table_sinhala},
#else
    ...
    {GUIIM_M_BOSNIAN_ABC_LEAD_UPPER, &s_key_table_bosnian_upper},
    {GUIIM_M_BOSNIAN_ABC_LOWER, &s_key_table_bosnian_lower},
    {GUIIM_M_BOSNIAN_ABC_UPPER, &s_key_table_bosnian_upper},

    {GUIIM_M_TP_BOSNIAN_ABC, &s_key_table_bosnian_lower},
#endif

#ifdef IM_AMERICAN_SUPPORT
    {GUIIM_M_AMERICAN_ABC_LEAD_UPPER, &s_key_table_american_upper},
    {GUIIM_M_AMERICAN_ABC_LOWER, &s_key_table_american_lower},
    {GUIIM_M_AMERICAN_ABC_UPPER, &s_key_table_american_upper},

    {GUIIM_M_TP_AMERICAN_ABC, &s_key_table_american_lower},
#endif

#ifdef IM_TURKMEN_LATIN_SUPPORT
    {GUIIM_M_TURKMEN_LATIN_ABC_LEAD_UPPER, &s_key_table_turkmen_latin_upper},
    {GUIIM_M_TURKMEN_LATIN_ABC_LOWER, &s_key_table_turkmen_latin_lower},
    {GUIIM_M_TURKMEN_LATIN_ABC_UPPER, &s_key_table_turkmen_latin_upper},

    {GUIIM_M_TP_TURKMEN_LATIN_ABC, &s_key_table_turkmen_latin_lower},
#endif

#ifdef IM_BELARUS_SUPPORT
    {GUIIM_M_BELARUS_ABC_LEAD_UPPER, &s_key_table_belarus_lower},
    {GUIIM_M_BELARUS_ABC_LOWER, &s_key_table_belarus_lower},
    {GUIIM_M_BELARUS_ABC_UPPER, &s_key_table_belarus_upper},
    
    {GUIIM_M_TP_BELARUS_ABC, &s_key_table_belarus_lower},
#endif

#ifdef IM_LINGALA_SUPPORT
    {GUIIM_M_LINGALA_ABC_LEAD_UPPER, &s_key_table_lingala_lower},
    {GUIIM_M_LINGALA_ABC_LOWER, &s_key_table_lingala_lower},
    {GUIIM_M_LINGALA_ABC_UPPER, &s_key_table_lingala_upper},
    
    {GUIIM_M_TP_LINGALA_ABC, &s_key_table_lingala_lower},
#endif

#ifdef IM_MALAGASY_SUPPORT
    {GUIIM_M_MALAGASY_ABC_LEAD_UPPER, &s_key_table_malagasy_lower},
    {GUIIM_M_MALAGASY_ABC_LOWER, &s_key_table_malagasy_lower},
    {GUIIM_M_MALAGASY_ABC_UPPER, &s_key_table_malagasy_upper},
    
    {GUIIM_M_TP_MALAGASY_ABC, &s_key_table_malagasy_lower},
#endif

#ifdef IM_PASHTO_SUPPORT    
    {GUIIM_M_PASHTO_ABC, &s_key_table_pashto},
    
    {GUIIM_M_TP_PASHTO_ABC, &s_key_table_pashto},
#endif

#ifdef IM_UZBEK_SUPPORT
    {GUIIM_M_UZBEK_ABC_LEAD_UPPER, &s_key_table_uzbek_lower},
    {GUIIM_M_UZBEK_ABC_LOWER, &s_key_table_uzbek_lower},
    {GUIIM_M_UZBEK_ABC_UPPER, &s_key_table_uzbek_upper},

    {GUIIM_M_TP_UZBEK_ABC, &s_key_table_uzbek_lower},
#endif
};
...
#ifdef IM_NEPALI_SUPPORT
    {GUIIM_M_NEPALI, &s_key_table_nepali},
    {GUIIM_M_TP_NEPALI, &s_key_table_nepali},
#endif
...
#ifdef IM_MALAY_SUPPORT
#if (defined(MMIIM_CSTAR_MULTITAP) || defined(MMIIM_T9_MULTITAP) || defined(MMIIM_IEKIE_MULTITAP))
    {GUIIM_M_MALAY_LEAD_UPPER, &s_key_table_malay_upper},
    {GUIIM_M_MALAY_LOWER,      &s_key_table_malay_lower},
    {GUIIM_M_MALAY_UPPER,      &s_key_table_malay_upper},

    {GUIIM_M_TP_MALAY_LEAD_UPPER, &s_key_table_malay_upper},
    {GUIIM_M_TP_MALAY_LOWER,      &s_key_table_malay_lower},
    {GUIIM_M_TP_MALAY_UPPER,      &s_key_table_malay_upper},
#else
...
#ifdef IM_PORTUGUESE_BR_SUPPORT
#ifdef MMIIM_T9_MULTITAP
    {GUIIM_M_PORTUGUESE_BR_LEAD_UPPER, &s_key_table_portuguese_br_upper},
    {GUIIM_M_PORTUGUESE_BR_LOWER,      &s_key_table_portuguese_br_lower},
    {GUIIM_M_PORTUGUESE_BR_UPPER,      &s_key_table_portuguese_br_upper},
#else
    {GUIIM_M_PORTUGUESE_BR_LEAD_UPPER, &s_key_table_portuguese_upper},
    {GUIIM_M_PORTUGUESE_BR_LOWER,      &s_key_table_portuguese_lower},
    {GUIIM_M_PORTUGUESE_BR_UPPER,      &s_key_table_portuguese_upper},
#endif
#endif
...
#ifdef IM_SPANISH_AM_SUPPORT
#ifdef MMIIM_T9_MULTITAP
    {GUIIM_M_SPANISH_AM_LEAD_UPPER, &s_key_table_spanish_us_upper},
    {GUIIM_M_SPANISH_AM_LOWER,      &s_key_table_spanish_us_lower},
    {GUIIM_M_SPANISH_AM_UPPER,      &s_key_table_spanish_us_upper},
#else
    {GUIIM_M_SPANISH_AM_LEAD_UPPER, &s_key_table_spanish_upper},
    {GUIIM_M_SPANISH_AM_LOWER,      &s_key_table_spanish_lower},
    {GUIIM_M_SPANISH_AM_UPPER,      &s_key_table_spanish_upper},
#endif
#endif
...
// 他加禄语
    ...
    {GUIIM_M_TAGALOG_LEAD_UPPER, &s_key_table_tagalog_upper},
    {GUIIM_M_TAGALOG_LOWER, &s_key_table_tagalog_lower},
    {GUIIM_M_TAGALOG_UPPER, &s_key_table_tagalog_upper},

    //{GUIIM_M_TP_TAGALOG, &s_key_table_tagalog},
    {GUIIM_M_TP_TAGALOG, &s_key_table_tagalog_lower},
#endif
#endif
...
#ifdef IM_ZULU_SUPPORT
#if (defined(MMIIM_CSTAR_MULTITAP) || defined(MMIIM_T9_MULTITAP) || defined(MMIIM_IEKIE_MULTITAP))
    {GUIIM_M_ZULU_LEAD_UPPER, &s_key_table_zulu_upper},
    {GUIIM_M_ZULU_LOWER,      &s_key_table_zulu_lower},
    {GUIIM_M_ZULU_UPPER,      &s_key_table_zulu_upper},

    {GUIIM_M_TP_ZULU_LEAD_UPPER, &s_key_table_zulu_upper},
    {GUIIM_M_TP_ZULU_LOWER,      &s_key_table_zulu_lower},
    {GUIIM_M_TP_ZULU_UPPER,      &s_key_table_zulu_upper},
#else
...
#ifdef IM_SINHALESE_SUPPORT
#ifdef MMIIM_CORE_USE_IEKIE
    {GUIIM_M_SINHALESE, &s_key_table_sinhala},
    {GUIIM_M_TP_SINHALESE, &s_key_table_sinhala},
#else
...
#ifdef IM_BOSNIAN_SUPPORT
    {GUIIM_M_BOSNIAN_LEAD_UPPER, &s_key_table_bosnian_upper},
    {GUIIM_M_BOSNIAN_LOWER, &s_key_table_bosnian_lower},
    {GUIIM_M_BOSNIAN_UPPER, &s_key_table_bosnian_upper},

    {GUIIM_M_TP_BOSNIAN, &s_key_table_bosnian_lower},
#endif

#ifdef IM_AMERICA_SUPPORT
    {GUIIM_M_AMERICAN_LEAD_UPPER, &s_key_table_american_upper},
    {GUIIM_M_AMERICAN_LOWER, &s_key_table_american_lower},
    {GUIIM_M_AMERICAN_UPPER, &s_key_table_american_upper},

    {GUIIM_M_TP_AMERICAN, &s_key_table_american_lower},
#endif

#ifdef IM_TURKMEN_LATINR_SUPPORT
    {GUIIM_M_TURKMEN_LATIN_LEAD_UPPER, &s_key_table_turkmen_latin_upper},
    {GUIIM_M_TURKMEN_LATIN_LOWER, &s_key_table_turkmen_latin_lower},
    {GUIIM_M_TURKMEN_LATIN_UPPER, &s_key_table_turkmen_latin_upper},

    {GUIIM_M_TP_TURKMEN_LATIN, &s_key_table_turkmen_latin_lower},
#endif
...
/*==============================================================================
Description: Adjust the keymap based on the previous input character according to Khmer type rule
Author: arvin
Global resource dependence: NONE
Note:
==============================================================================*/
LOCAL MMIIM_SP_9KEY_TABLE_DEF_T* GetKhmerKeyTable(
    wchar previous_char   // [in] prev char
);

/*==============================================================================
Description: Adjust the keymap based on the previous input character according to Vietnamese type rule
Author: arvin
Global resource dependence: NONE
Note:
==============================================================================*/
LOCAL MMIIM_SP_9KEY_TABLE_DEF_T* GetVietnameseKeyTable(
    wchar previous_char   // [in] prev char
);
...
Note:
==============================================================================*/
LOCAL MMIIM_SP_9KEY_TABLE_DEF_T* GetVietnameseUpperKeyTable(
    wchar previous_char   // [in] prev char
);
...
LOCAL MMIIM_SP_9KEY_TABLE_DEF_T* GetNepaliKeyTable(
    wchar previous_char   // [in] prev char
)
{
#ifdef IM_NEPALI_SUPPORT
#if (defined MMIIM_IEKIE_MULTITAP)
    return &s_key_table_nepali;
#else
    MMIIM_SP_9KEY_TABLE_DEF_T *key_table = PNULL;
    switch (previous_char)
    {
    ...
    case(DEVA_LV_R):
    case(DEVA_L_E):
        key_table = &s_key_table_nepalimatra1;//ZHMCH	s_key_table_hindimatra1
        break;
    case(DEVA_VS_I):
    case(DEVA_VS_II):
    case(DEVA_VSC_E):
    ...
    case(DEVA_L_O):
    case(DEVA_L_AU):
        key_table = &s_key_table_nepalimatra2;//ZHMCH	s_key_table_hindimatra2
        break;
    default:
        if ((previous_char >= DEVA_L_KA && previous_char <= DEVA_L_HA) ||
                (previous_char >= DEVA_L_QA && previous_char <= DEVA_L_YYA))
        {
            key_table = &s_key_table_nepalimatra;//ZHMCH
        }
        else
        {
            key_table = &s_key_table_nepali;//ZHMCH
        }
        break;
    }
    return key_table;
...
LOCAL MMIIM_SP_9KEY_TABLE_DEF_T* GetSinhalaKeyTable(
    wchar previous_char   // [in] prev char
)
{
#ifdef IM_SINHALESE_SUPPORT//ZHMCH
#if (defined MMIIM_IEKIE_MULTITAP)
        return &s_key_table_sinhala;//ZHMCH
#else
    MMIIM_SP_9KEY_TABLE_DEF_T *key_table = PNULL;
    switch (previous_char)
    {
    ...
    case(DEVA_LV_R):
    case(DEVA_L_E):
        key_table = &s_key_table_sinhalamatra1;
        break;
    case(DEVA_VS_I):
    case(DEVA_VS_II):
    case(DEVA_VSC_E):
    ...
    case(DEVA_L_O):
    case(DEVA_L_AU):
        key_table = &s_key_table_sinhalamatra2;
        break;
    default:
        if ((previous_char >= DEVA_L_KA && previous_char <= DEVA_L_HA) ||
                (previous_char >= DEVA_L_QA && previous_char <= DEVA_L_YYA))
        {
            key_table = &s_key_table_sinhalamatra;
        }
        else
        {
            key_table = &s_key_table_sinhala;
        }
        break;
    }
    return key_table;
...
{
#ifdef IM_TELUGU_SUPPORT
#if (defined(MMIIM_CSTAR_MULTITAP) || defined (MMIIM_SOGOU_MULTITAP) || defined(MMIIM_IEKIE_MULTITAP))
...
)
{
    ...
    return &s_key_table_abc_khmer;
#else
	MMIIM_SP_9KEY_TABLE_DEF_T *key_table = &s_key_table_abc_khmer;
	...
	if(previous_char)
	{
		...
		{
			key_table = &s_key_table_abc_khmer_full;
		}
		else
		{
			//DV [17B4,17C5]
...
{
	MMIIM_SP_9KEY_TABLE_DEF_T *key_table = &s_key_table_vietnamese_lower;
#ifdef MMIIM_T9_MULTITAP
	if(previous_char && IsVietnameseVowel(previous_char))
	{
		key_table = &s_key_table_vietnamese_lower_full;
	}
#endif
...
{
	MMIIM_SP_9KEY_TABLE_DEF_T *key_table = &s_key_table_vietnamese_upper;
#ifdef MMIIM_T9_MULTITAP
	if(previous_char && IsVietnameseVowel(previous_char))
	{
		key_table = &s_key_table_vietnamese_upper_full;
	}
#endif
...
#ifdef IM_YORUBA_SUPPORT
/*==============================================================================
Description: Adjust the keymap based on the previous input character according to Yoruba type rule
Author: 
Global resource dependence: NONE
Note:
==============================================================================*/
LOCAL MMIIM_SP_9KEY_TABLE_DEF_T* GetYorubaKeyTable(
    wchar previous_char   // [in] prev char
)
{
	MMIIM_SP_9KEY_TABLE_DEF_T *key_table = &s_key_table_yoruba_lower;
#ifdef MMIIM_T9_MULTITAP
	if(previous_char && IsYorubaBasicChar(previous_char))
	{
        key_table = &s_key_table_yoruba_lower_full;
	}
...
Note:
==============================================================================*/
LOCAL MMIIM_SP_9KEY_TABLE_DEF_T* GetYorubaUpperKeyTable(
    wchar previous_char   // [in] prev char
)
{
	MMIIM_SP_9KEY_TABLE_DEF_T *key_table = &s_key_table_yoruba_upper;
#ifdef MMIIM_T9_MULTITAP
	if(previous_char && IsYorubaBasicChar(previous_char))
	{
        key_table = &s_key_table_yoruba_upper_full;
	}
#endif
...
#ifdef IM_NEPALI_SUPPORT
    if (GUIIM_M_NEPALI_ABC == method)
    {
        checking_func_ptr = GetNepaliKeyTable;
    }
#endif
#ifdef IM_SINHALESE_SUPPORT
    if (GUIIM_M_SINHALESE_ABC == method)
    {
        checking_func_ptr = GetSinhalaKeyTable;
    }
#endif
...
#ifdef IM_KHMER_SUPPORT
    if (GUIIM_M_KHMER_ABC == method)
    {
        checking_func_ptr = GetKhmerKeyTable;
    }
#endif

#ifdef IM_VIETNAMESE_SUPPORT
    if (GUIIM_M_VIETNAMESE_ABC_LOWER == method)
    {
        checking_func_ptr = GetVietnameseKeyTable;
    }

    if (GUIIM_M_VIETNAMESE_ABC_LEAD_UPPER == method || GUIIM_M_VIETNAMESE_ABC_UPPER == method)
    {
        checking_func_ptr = GetVietnameseUpperKeyTable;
    }
#endif

#ifdef IM_YORUBA_SUPPORT
    if (GUIIM_M_YORUBA_ABC_LOWER == method)
    {
        checking_func_ptr = GetYorubaKeyTable;
    }

    if (GUIIM_M_YORUBA_ABC_LEAD_UPPER == method || GUIIM_M_YORUBA_ABC_UPPER == method)
    {
        checking_func_ptr = GetYorubaUpperKeyTable;
    }    
#endif
...
#ifdef MMIIM_MULTITAP_CANDIDATE_SUPPORT //zhaokai@2017.02.14 印度22国语言非智能输入法增加候选框
/*==============================================================================
Description: 获取指定键值表
Global resource dependence: NONE
Author: arvin.zhang
Note: char_index从1开始计数!!!
==============================================================================*/
PUBLIC wchar* MMIIM_SP_ML9KEY_GetCandTable(void const * table_ptr, uint16 key_idx)
{
    MMIIM_SP_9KEY_TABLE_DEF_T *key_table_ptr = (MMIIM_SP_9KEY_TABLE_DEF_T *)table_ptr;
	
    if (PNULL == key_table_ptr || key_idx >= MMIIM_SP_9KEY_INDEX_MAX)
    {
        return 0;
    }
	
    return ((wchar*)(&((*key_table_ptr)[key_idx][1])));
}
#endif
...
{
    wchar const *keymap_str_ptr = NULL;
    keymap_str_ptr = keymap_combine_all[wc - MMIIM_SP_KEYMAP_COMBINE_START];
    return keymap_str_ptr;
}
                                    ...
                                    )
{
    uint32 i = 0;
    uint32 j = 0;
    for (i = 0; i < MMIIM_SP_KEYMAP_COMBINE_MAX; i++)
    {
        for(j = 0; j < 5; j++)
        {
            if(keymap_combine_all[i][j]
                && wc == keymap_combine_all[i][j])
            {
                return MMIIM_SP_KEYMAP_COMBINE_START + i;
            }
        }
    }
    return wc;
