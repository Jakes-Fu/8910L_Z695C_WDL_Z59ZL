...
typedef enum
{
    ...
    MMIIM_SP_SYMB_HOT_FISRT_ROW,
    MMIIM_SP_SYMB_HOT_LAST_ROW,
...
LOCAL void InitData(MMIIM_SP_SYMB_WIN_DATA_T *win_data_ptr)
{
    ...
    win_data_ptr->title_rect.bottom = MMITHEME_GetStatusBarHeight() - 1;
#if 0//MS_MMI_Delete
    win_data_ptr->win_rect.top = 0;
#endif
    win_data_ptr->rect_symb = win_data_ptr->win_rect;
    win_data_ptr->rect_symb.top = MMITHEME_GetStatusBarHeight();
    ...
    win_data_ptr->rect_symb.right -= MMIIM_SP_SYMB_MARGIN_H;
#endif
    win_data_ptr->row = MMIIM_SP_SYMB_PANEL_ROW;//每页的行数
    win_data_ptr->col = MMIIM_SP_SYMB_PANEL_COL;//每页的列数
    //每页字符的最大个数
    win_data_ptr->per_max_cnt = MMIIM_SP_SYMB_PANEL_ROW*MMIIM_SP_SYMB_PANEL_COL;
    
    win_data_ptr->color_bg = GUI_RGB2RGB565(0,0,0);//MMIIM_SP_SYMB_COLOR_BG;
    win_data_ptr->color_border = GUI_RGB2RGB565(0,0,0);//MMIIM_SP_SYMB_COLOR_BORDER;
    win_data_ptr->color_font = GUI_RGB2RGB565(255,255,255);//MMIIM_SP_SYMB_COLOR_FONT;
    win_data_ptr->color_hot = MMITHEME_GetAccentColorByOffset(MMITHEME_OFFSET_COLOR_DEFAULT);//MMIIM_SP_SYMB_COLOR_HOT;
    ...
    win_data_ptr->page = win_data_ptr->symb_cnt/42;//总共的页数
    win_data_ptr->page += (win_data_ptr->symb_cnt%42==0)?0 :1;
#if 0//MS_MMI_Delete
    //空出地方来放按钮
...
LOCAL void LoadSymbData(MMIIM_SP_SYMB_WIN_DATA_T *win_data_ptr)
{
    ...
    SCI_TRACE_LOW("LoadSymbData symb_type=%d",win_data_ptr->symb_type);
    switch (win_data_ptr->symb_type)
    {
    //根据符号表类型添加符号,以arabic为例
    case MMIIM_SP_SYMB_TYPE_ARABIC:
        //1arabic符号
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_ARABIC, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
    case MMIIM_SP_SYMB_TYPE_NORWEGIAN:
        //1NORWEGIAN符号
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_NORWEGIAN, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
    case MMIIM_SP_SYMB_TYPE_CHS:
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_CHS, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
    case MMIIM_SP_SYMB_TYPE_THAI:
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_THAI, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
        //1Thai的键0符号
    case MMIIM_SP_SYMB_TYPE_THAI_ZERO:
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_THAI_ZERO, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
    case MMIIM_SP_SYMB_TYPE_SPANISH:
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_SPANISH, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
    case MMIIM_SP_SYMB_TYPE_AMHARIC:
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_AMHARIC, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
    case MMIIM_SP_SYMB_TYPE_ENGLISH:
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_ENGLISH, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
    
    case MMIIM_SP_SYMB_TYPE_YORUBA:
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_YORUBA, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
    
    case MMIIM_SP_SYMB_TYPE_ASSAMESE:
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_ASSAMESE, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
    
    case MMIIM_SP_SYMB_TYPE_GUJARATI:
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_GUJARATI, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
    
    case MMIIM_SP_SYMB_TYPE_KANNADA:
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_KANNADA, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
    
    case MMIIM_SP_SYMB_TYPE_MALAYALAM:
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_MALAYALAM, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
    
    case MMIIM_SP_SYMB_TYPE_ORIYA:
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_ORIYA, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
    
    case MMIIM_SP_SYMB_TYPE_PUNJABI:
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_PUNJABI, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
    
    case MMIIM_SP_SYMB_TYPE_TAMIL:
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_TAMIL, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
    
    case MMIIM_SP_SYMB_TYPE_TELUGU:
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_TELUGU, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
    
    case MMIIM_SP_SYMB_TYPE_HAUSA:
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_HAUSA, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
    ...
    case MMIIM_SP_SYMB_TYPE_IGBO:
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_IGBO, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
    
    case MMIIM_SP_SYMB_TYPE_KHMER:
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_KHMER, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
    
    case MMIIM_SP_SYMB_TYPE_MARATHI:
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_MARATHI, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
    case MMIIM_SP_SYMB_TYPE_HEBREW:
        
        symb_cnt = MMIIM_SP_SYMB_CNT_LIMIT - win_data_ptr->symb_cnt;
        MMIIM_SP_SYMB_GetSymbols(MMIIM_SP_SYMBOL_TYPE_HEBREW, &symb_cnt,
                             win_data_ptr->symb_list + win_data_ptr->symb_cnt);
        win_data_ptr->symb_cnt += symb_cnt;
        break;
...
)
{
    ...
    case MSG_LCD_SWITCH:
        ...
        break;
/*
//Forbid the left soft key for no softkey icon shown
    case MSG_CTL_OK:
    case MSG_APP_OK:
*/
    case MSG_APP_WEB:
    ...
    case MSG_APP_LEFT:
        ...
        else
        {
            ...
            GetHotPos(win_data_ptr, &hot_row, &hot_col);
            while(last_page < hot_row/win_data_ptr->row)
            {
               //根据页数执行翻页的过程
               PageDown(win_data_ptr, MMIIM_SP_SYMB_HOT_END);
               last_page++;
            }  
    ...
    case MSG_APP_RIGHT:
        ...
        else
        {
            ...
            //判断当前页数，根据页数执行到第一页翻页的次数
            while(cur_page)
            {
                PageUp(win_data_ptr, MMIIM_SP_SYMB_HOT_BEGIN);
                cur_page--;
            }
    ...
    case MSG_APP_UP:
        ...
        else
        {
            //焦点在第一行的执行up后的处理
            int16   last_page = 0;
            win_data_ptr->hot_idx += (win_data_ptr->per_max_cnt * win_data_ptr->page) - win_data_ptr->col;
            
            while(win_data_ptr->hot_idx >= win_data_ptr->symb_cnt)
            {
                win_data_ptr->hot_idx -= win_data_ptr->col;
            }
            GetHotPos(win_data_ptr, &hot_row, &hot_col);
            ...
            while(last_page < hot_row/win_data_ptr->row)
            {
               PageDown(win_data_ptr, MMIIM_SP_SYMB_HOT_LAST_ROW); 
               last_page++;
            }     
            DrawWin(win_data_ptr);
        }
    ...
    case MSG_APP_DOWN:
        ...
        else
        {
            ...
            int16   cur_page = 0;
            GetHotPos(win_data_ptr, &hot_row, &hot_col);
            win_data_ptr->hot_idx = hot_col;
            
            cur_page = win_data_ptr->first_row / win_data_ptr->row;
            while(cur_page)
            {
                PageUp(win_data_ptr, MMIIM_SP_SYMB_HOT_FISRT_ROW);
                cur_page--;
...
LOCAL void DrawWin(MMIIM_SP_SYMB_WIN_DATA_T *win_data_ptr)
{
    ...
    //draw title
    MMI_GetLabelTextByLang(STR_MSG_HDR_SYM_EXT02, &title_str);
    ...
    //泰语键0对应的符号不需要title
    if(MMIIM_SP_SYMB_TYPE_THAI_ZERO!=win_data_ptr->symb_type)
    {
    ...
    for (symb_idx = 0; symb_idx < symb_per_page; symb_idx++)
    {
        ...
        else if(MMIIM_SP_SYMB_COMBINE_START <= cur_symb && cur_symb< MMIIM_SP_SYMB_COMBINE_END )//组合符号
        {
            symb_info.wstr_ptr = MMIIM_SP_SYMB_GetSymbStrPtr(cur_symb);
            symb_info.wstr_len = MMIAPICOM_Wstrlen(symb_info.wstr_ptr);
            symb_style.font = win_data_ptr->font;
               //string
            GUISTR_DrawTextToLCDInRect(&win_data_ptr->lcd_dev_info,
...
LOCAL void CommitSymb(MMIIM_SP_SYMB_WIN_DATA_T *win_data_ptr, uint32 idx)
{
    ...
    else if (MMIIM_SP_SYMB_COMBINE_START <= cur_symb && cur_symb< MMIIM_SP_SYMB_COMBINE_END)
    {
        symb_str = MMIIM_SP_SYMB_GetSymbStrPtr(cur_symb);
        notify_pack.data.commit_data.commit_len = MMIAPICOM_Wstrlen(symb_str);
    ...
    else if( MMIIM_SP_SYMB_LINE_BREAK == cur_symb || MMIIM_SP_SYMB_SPACE_CHAR == cur_symb)
    {
        symb_str = MMIIM_SP_SYMB_GetSymbStrPtr(cur_symb);
        notify_pack.data.commit_data.commit[0] = *symb_str;
        notify_pack.data.commit_data.commit_len = 1;
    ...
    //符号提交完成后，也要重新适配keymap
    MMK_SendMsg(win_data_ptr->im_handle, MSG_NOTIFY_EDITBOX_IMSYNC_CURSOR, 0);
    return;
}
...
)
{
    ...
    case MMIIM_SP_SYMB_HOT_HOLD_COL:
        ...
        win_data_ptr->hot_idx += win_data_ptr->first_row * win_data_ptr->col;
        break;
    case MMIIM_SP_SYMB_HOT_LAST_ROW:
        break;
...
)
{
    ...
    case MMIIM_SP_SYMB_HOT_FISRT_ROW:
        win_data_ptr->hot_idx %= win_data_ptr->col;
        break;
    case MMIIM_SP_SYMB_HOT_END:
    default:
...
PUBLIC MMI_HANDLE_T MMIIM_SP_SymbCreateWinEx(MMI_HANDLE_T im_handle, MMIIM_SP_SYMB_TYPE_T type)
{
    return SymbCreateWin(im_handle, type);
}
/*==============================================================================
...
{
    return SymbCreateWin(im_handle, MMIIM_GetSymbTypeByLang(lang));
}
/*==============================================================================
Description: 根据输入语言选择获取符号表
Global resource dependence: NONE
Author: 
Note:
==============================================================================*/
PUBLIC MMIIM_SP_SYMB_TYPE_T MMIIM_GetSymbTypeByLang(GUIIM_LANGUAGE_T lang)
{
    ...
    case GUIIM_LANG_TRAD_CHINESE_HK:
     //以上为新增
        type = MMIIM_SP_SYMB_TYPE_CHS;
        break;
    case GUIIM_LANG_THAI:
        type = MMIIM_SP_SYMB_TYPE_THAI;
        break;
    case GUIIM_LANG_SPANISH:
    case GUIIM_LANG_SPANISH_AM:
        type = MMIIM_SP_SYMB_TYPE_SPANISH;
        break;
    case GUIIM_LANG_AMHARIC:
        type = MMIIM_SP_SYMB_TYPE_AMHARIC;
        break;
    case GUIIM_LANG_BENGALI:
    case GUIIM_LANG_BENGALI_BD:
        type = MMIIM_SP_SYMB_TYPE_BENGALI;
        break;
     //新增语言
    ...
    case GUIIM_LANG_ENGLISH:
        type = MMIIM_SP_SYMB_TYPE_ENGLISH;
        break;
    case GUIIM_LANG_YORUBA:
        type = MMIIM_SP_SYMB_TYPE_YORUBA;
        break;
    case GUIIM_LANG_ASSAMESE:
        type = MMIIM_SP_SYMB_TYPE_ASSAMESE;
        break;
    case GUIIM_LANG_GUJARATI:
        type = MMIIM_SP_SYMB_TYPE_GUJARATI;
        break;
    case GUIIM_LANG_KANNADA:
        type = MMIIM_SP_SYMB_TYPE_KANNADA;
        break;
    case GUIIM_LANG_MALAYALAM:
        type = MMIIM_SP_SYMB_TYPE_MALAYALAM;
        break;
    case GUIIM_LANG_ORIYA:
        type = MMIIM_SP_SYMB_TYPE_ORIYA;
        break;
    case GUIIM_LANG_PUNJABI:
        type = MMIIM_SP_SYMB_TYPE_PUNJABI;
        break;
    case GUIIM_LANG_TAMIL:
        type = MMIIM_SP_SYMB_TYPE_TAMIL;
        break;
    case GUIIM_LANG_TELUGU:
        type = MMIIM_SP_SYMB_TYPE_TELUGU;
        break;
    case GUIIM_LANG_HAUSA:
        type = MMIIM_SP_SYMB_TYPE_HAUSA;
        break;
    case GUIIM_LANG_HINDI:
        type = MMIIM_SP_SYMB_TYPE_HINDI;
        break;
    case GUIIM_LANG_IGBO:
        type = MMIIM_SP_SYMB_TYPE_IGBO;
        break;
    case GUIIM_LANG_KHMER:
        type = MMIIM_SP_SYMB_TYPE_KHMER;
        break;
    case GUIIM_LANG_MARATHI:
        type = MMIIM_SP_SYMB_TYPE_MARATHI;
        break;
    //新增symbolspicker
    case GUIIM_LANG_HEBREW:
        type = MMIIM_SP_SYMB_TYPE_HEBREW;
        break;
