...
#if (defined MMIIM_VKB_SUPPORT)
	//{
	//	GUIIM_LANG_TIBETAN, GUIIM_TYPE_SMART, GUIIM_INPUT_TYPE_NONE, STXT_IM_SHORT_TIBETAN,
	//},
	{
...
#if (defined MMIIM_VKB_SUPPORT)
    {GUIIM_LANG_ENGLISH, GUIIM_TYPE_SMART, GUIIM_INPUT_TYPE_NONE, STXT_IM_SHORT_ENGLISH_LOWER},
    {GUIIM_LANG_ENGLISH, GUIIM_TYPE_MULTITAP, GUIIM_INPUT_TYPE_NONE, STXT_IM_SHORT_ABC_LOWER},
#endif
#if defined(IM_HANDWRITING_HANWANG)
    {
