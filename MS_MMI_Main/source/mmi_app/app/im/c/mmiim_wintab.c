...
WINDOW_TABLE( MMIIM_SET_PINYIN_FUZZY_WIN_TAB ) = 
{
    ...
    WIN_TITLE(STXT_INPUT_PY_FUZZY_SET),
...
WINDOW_TABLE( MMIIM_SET_HW_SPEED_WIN_TAB ) = 
{
    ...
    WIN_TITLE( STXT_INPUT_HANDWRITING_SPEED_SET ),
...
WINDOW_TABLE( MMIIM_SET_HW_THICKNESS_WIN_TAB ) = 
{
    ...
    WIN_TITLE( STXT_INPUT_HANDWRITING_THICKNESS_SET ),
...
WINDOW_TABLE( MMIIM_SET_HW_COLOR_WIN_TAB ) = 
{
    ...
    WIN_TITLE( STXT_INPUT_HANDWRITING_COLOR_SET ),
                               ...
                               )
{
    ...
    //append item
    MMIAPISET_AppendListItemByTextId(STXT_INPUT_PY_FUZZY_Z_ZH,TXT_COMMON_OK,ctrl_id,GUIITEM_STYLE_ONE_LINE_CHECK);
    MMIAPISET_AppendListItemByTextId(STXT_INPUT_PY_FUZZY_C_CH,TXT_COMMON_OK,ctrl_id,GUIITEM_STYLE_ONE_LINE_CHECK);
    MMIAPISET_AppendListItemByTextId(STXT_INPUT_PY_FUZZY_S_SH,TXT_COMMON_OK,ctrl_id,GUIITEM_STYLE_ONE_LINE_CHECK);
    MMIAPISET_AppendListItemByTextId(STXT_INPUT_PY_FUZZY_H_F,TXT_COMMON_OK,ctrl_id,GUIITEM_STYLE_ONE_LINE_CHECK);
    MMIAPISET_AppendListItemByTextId(STXT_INPUT_PY_FUZZY_L_H,TXT_COMMON_OK,ctrl_id,GUIITEM_STYLE_ONE_LINE_CHECK);
    MMIAPISET_AppendListItemByTextId(STXT_INPUT_PY_FUZZY_IN_ING,TXT_COMMON_OK,ctrl_id,GUIITEM_STYLE_ONE_LINE_CHECK);
    MMIAPISET_AppendListItemByTextId(STXT_INPUT_PY_FUZZY_EN_ENG,TXT_COMMON_OK,ctrl_id,GUIITEM_STYLE_ONE_LINE_CHECK);
    MMIAPISET_AppendListItemByTextId(STXT_INPUT_PY_FUZZY_AN_ANG,TXT_COMMON_OK,ctrl_id,GUIITEM_STYLE_ONE_LINE_CHECK);
    MMIAPISET_AppendListItemByTextId(STXT_INPUT_PY_FUZZY_IAN_IANG,TXT_COMMON_OK,ctrl_id,GUIITEM_STYLE_ONE_LINE_CHECK);
    MMIAPISET_AppendListItemByTextId(STXT_INPUT_PY_FUZZY_UAN_UANG,TXT_COMMON_OK,ctrl_id,GUIITEM_STYLE_ONE_LINE_CHECK);
                               ...
                               )
{
    ...
    MMIAPISET_AppendListItemByTextId(TXT_COMMON_FAST,STXT_SOFTKEY_OK_MK,ctrl_id,GUIITEM_STYLE_ONE_LINE_RADIO);
    MMIAPISET_AppendListItemByTextId(TXT_NORMAL,TXT_COMMON_OK,ctrl_id,GUIITEM_STYLE_ONE_LINE_RADIO);
    MMIAPISET_AppendListItemByTextId(TXT_COMMON_SLOW,STXT_SOFTKEY_OK_MK,ctrl_id,GUIITEM_STYLE_ONE_LINE_RADIO);
                                   ...
                                   )
{
    ...
    MMIAPISET_AppendListItemByTextId(STXT_HANDWRITING_THICK,TXT_COMMON_OK,ctrl_id,GUIITEM_STYLE_ONE_LINE_RADIO);
    MMIAPISET_AppendListItemByTextId(TXT_COMMON_COMMON_NORMAL,STXT_SOFTKEY_OK_MK,ctrl_id,GUIITEM_STYLE_ONE_LINE_RADIO);
    MMIAPISET_AppendListItemByTextId(STXT_HANDWRITING_THIN,TXT_COMMON_OK,ctrl_id,GUIITEM_STYLE_ONE_LINE_RADIO);
...
LOCAL void SetPYFuzzyParam(void)
{
    ...
    MMI_GetLabelTextByLang(STXT_INPUT_PY_FUZZY_SET, &title);
...
LOCAL void SetHandwriteSpeedParam(void)
{
    ...
    MMI_GetLabelTextByLang(STXT_INPUT_HANDWRITING_SPEED, &title);
    ...
    GUISETLIST_SetTitleTextId(MMIIM_SET_HANDWRITE_SPEED_SETLIST_CTRL_ID,STXT_INPUT_HANDWRITING_SPEED_SET);	
}
/*****************************************************************************/
//  Description : set handwritting thick param 
//  Global resource dependence : 
...
LOCAL void SetHandwriteThickParam(void )
{
    ...
    {
        STXT_HANDWRITING_THICK,
        TXT_COMMON_COMMON_NORMAL,
        STXT_HANDWRITING_THIN
    };
...
#endif
    MMI_GetLabelTextByLang(STXT_INPUT_HANDWRITING_THICKNESS, &title);
    ...
    GUISETLIST_SetTitleTextId(MMIIM_SET_HANDWRITE_THICK_SETLIST_CTRL_ID,STXT_INPUT_HANDWRITING_THICKNESS_SET);	
}
/*****************************************************************************/
//  Description : set handwritting color param 
//  Global resource dependence : 
...
LOCAL void SetHandwriteColorParam(void)
{
    ...
    MMI_GetLabelTextByLang(STXT_INPUT_HANDWRITING_COLOR, &title1);
    GUILABEL_SetText(MMIIM_SET_HANDWRITE_COLOR_LABEL_CTRL_ID, &title1, FALSE);
    MMI_GetLabelTextByLang(STXT_INPUT_HANDWRITING_COLOR_SET, &title2);
...
LOCAL void SetKeyboardSizeParam(void)
{
    ...
    MMI_GetLabelTextByLang(STXT_KEYBOARD_SIZE_SET, &title);
    ...
    GUISETLIST_SetTitleTextId(MMIIM_SET_KEYBOARD_SIZE_SETLIST_CTRL_ID,STXT_KEYBOARD_SIZE_SET);
