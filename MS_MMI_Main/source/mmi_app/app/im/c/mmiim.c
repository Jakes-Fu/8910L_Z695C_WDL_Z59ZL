...
#include "csk2api.h"
#elif defined(MMIIM_CORE_USE_IEKIE)
#include "iimek2api.h"
...
LOCAL S_LANG_CODE_STRING s_lang_code_table [] = 
{
    ...
    {GUIIM_LANG_BENGALI, L"Be-IN" },    
    {GUIIM_LANG_BENGALI_BD, L"Be-BD" },    
    ...
    {GUIIM_LANG_BOSNIAN, L"Bos"},       //有待验证
    {GUIIM_LANG_AMERICAN, L"Ame"},      //有待验证
    {GUIIM_LANG_TURKMEN_LATIN, L"Tul"}, //有待验证

    {GUIIM_LANG_BELARUS, L"By"},        //有待验证
    {GUIIM_LANG_LINGALA, L"Lin"},       //有待验证
    {GUIIM_LANG_MALAGASY, L"Mg"},       //有待验证
    {GUIIM_LANG_PASHTO, L"Ps"},         //有待验证
    {GUIIM_LANG_UZBEK, L"Uz"},          //有待验证
};
...
static MMIIM_CSTAR_METHOD_RELATION_T const g_cstar_method_relation_list[] =
{
    ...
    {GUIIM_M_ARMENIAN_LEAD_UPPER,              IM_ARMENIAN_LEAD_UPPER},
    {GUIIM_M_ARMENIAN_LOWER,                   IM_ARMENIAN_LOWER},
    {GUIIM_M_ARMENIAN_UPPER,                   IM_ARMENIAN_UPPER},
...
static MMIIM_CSTAR_METHOD_RELATION_T const g_method_relation_list[] =
{
#ifdef DPHONE_SUPPORT 
    #ifndef KEYBOARD_SUPPORT_LOW_MEMORY
    {GUIIM_M_PINYIN,                        IM_PINYIN},
    ...
    {GUIIM_M_URDU,                          IM_URDU},
    {GUIIM_M_HEBREW,                        IM_HEBREW},
    {GUIIM_M_BENGALI_ABC,                       IM_BENGALI_MT},  // zhongjie.liu 2012 1127  Bengali BTRC Support
    {GUIIM_M_VIETNAMESE_LEAD_UPPER,         IM_VIETNAMESE_LEAD_UPPER},
    {GUIIM_M_VIETNAMESE_LOWER,              IM_VIETNAMESE_LOWER},
    {GUIIM_M_VIETNAMESE_UPPER,              IM_VIETNAMESE_UPPER},
    {GUIIM_M_CZECH_LEAD_UPPER,              IM_CZECH_LEAD_UPPER},
    ...
    {GUIIM_M_FINNISH_UPPER,                 IM_FINNISH_UPPER},
    {GUIIM_M_UYGHUR,                        IM_UYGHUR},
    //{GUIIM_M_AMHARIC,                        IM_AMHARIC_MT},   // zhongjie.liu 2013 0118 amharic support
    {GUIIM_M_AMHARIC_ABC,                   IM_AMHARIC},    
    {GUIIM_M_SINHALESE,                     IM_SINHALA},//IM_SINHALESE_SUPPORT
    {GUIIM_M_NEPALI,                        IM_NEPALI},//IM_NEPALI_SUPPORT
    {GUIIM_M_ARMENIAN_LEAD_UPPER,              IM_ARMENIAN_LEAD_UPPER},
    {GUIIM_M_ARMENIAN_LOWER,                   IM_ARMENIAN_LOWER},
    {GUIIM_M_ARMENIAN_UPPER,                   IM_ARMENIAN_UPPER},
#ifdef DPHONE_SUPPORT 
    ...
    {GUIIM_M_Q_FINNISH_UPPER,               IM_FULLKEY_BASE + IM_FINNISH_UPPER},
    {GUIIM_M_Q_UYGHUR,                      IM_FULLKEY_BASE + IM_UYGHUR},
    {GUIIM_M_Q_SINHALESE,                   IM_FULLKEY_BASE + IM_SINHALA},//IM_SINHALESE_SUPPORT
    {GUIIM_M_Q_NEPALI,                      IM_FULLKEY_BASE + IM_NEPALI},//IM_NEPALI_SUPPORT
};
#endif
 ...
 **                         GLOBAL DEFINITION                                *
 **--------------------------------------------------------------------------*/
#define T9_MAX_LDB_DEFAULT_BUF_SIZE       142 * 1024 
LOCAL uint32 s_t9_ldb_max_size=T9_MAX_LDB_DEFAULT_BUF_SIZE;
...
//     language_type = (MMISET_LANGUAGE_TYPE_E)MMISET_GetLanguageType();
    //取得GUI语言序
...
/*****************************************************************************/
//  Description : 获取当前Dictionary输入语言的默认设置
//  Global resource dependence : 
//  Author: haiwu.chen
//  Note:
/*****************************************************************************/
PUBLIC GUIIM_LANGUAGE_T MMIAPIIM_GetDictionaryLanguage(void)
{
    GUIIM_LANGUAGE_T lang = GUIIM_LANG_NONE;
    MN_RETURN_RESULT_E return_value = MN_RETURN_FAILURE;
	...
	SCI_TRACE_LOW("MMIAPIIM_GetDictionaryLanguage lang:%d",lang);
    return (lang);
}
/*****************************************************************************/
//  Description : 设置当前Dictionary输入语言的默认设置
//  Global resource dependence : 
//  Author: haiwu.chen
//  Note: 
/*****************************************************************************/
PUBLIC void MMIAPIIM_SetDictionaryLanguage(GUIIM_LANGUAGE_T lang)
{
	SCI_TRACE_LOW("MMIAPIIM_SetDictionaryLanguage lang:%d",lang);
    MMINV_WRITE(MMINV_IM_LANGUAGE, &lang);
...
/*
flag[32]  MALAYALAM  185K 
flag[27] Telugu 185K
flag[29] Tamil  185K
flag[77]  Sinhala  240K
flag[3], flag[79] traditional chinese 254K
other set	142K
*/
extern BOOLEAN s_lang_status_info[MMISET_MAX_LANGUAGE + 1][2];
LOCAL void initT9MaxLdbSizeFromLangInfo(void)
{
	if(s_lang_status_info[MMISET_LANGUAGE_MALAYALAM][1] || s_lang_status_info[MMISET_LANGUAGE_TAMIL][1] || s_lang_status_info[MMISET_LANGUAGE_TELUGU][1])
	{
		s_t9_ldb_max_size = 185*1024;
	}
	else if(s_lang_status_info[MMISET_LANGUAGE_SINHALESE][1])
	{
		s_t9_ldb_max_size = 240*1024;
	}
	else if( s_lang_status_info[MMISET_LANGUAGE_TRAD_CHINESE][1] || s_lang_status_info[MMISET_LANGUAGE_TRAD_CHINESE_HK][1])
	{
		s_t9_ldb_max_size = 254*1024;
	}
	else
	{
		s_t9_ldb_max_size = T9_MAX_LDB_DEFAULT_BUF_SIZE;
	}	
}

PUBLIC uint32 MMIIM_T9GetMaxLdbSize(void)
{
	return s_t9_ldb_max_size;
}
                                   ...
                                   )
{
...
#endif        
	{
		...
		{
			if(pcur_key == PNULL /*|| pcur_key[0] == MMIIM_SP_9KEY_INDEX_MAX*/)//wang.qinggang modify
			{
				//SCI_TRACE_LOW:"MMIAPIIM_GetKeyIndexByKeytable"
			...
			for (iloop2 = 1; iloop2 <= pcur_key[0]; iloop2 ++)	//第一个字符表示数据个数
			{
				...
				{
					if(iloop1 <= MMIIM_SP_9KEY_INDEX_9)
					{
					    return (iloop1 - MMIIM_SP_9KEY_INDEX_1 + '1');
					}
					else if(iloop1 == MMIIM_SP_9KEY_INDEX_0)
					{
					    return '0';
					}
					else if(iloop1 == MMIIM_SP_9KEY_INDEX_STAR)
					{
					    return '*';
					}
					else if(iloop1 == MMIIM_SP_9KEY_INDEX_HASH)
					{
					    return '#';
					}
				}
...
// Note: 
/******************************************************************************/
PUBLIC IIME_UINT MMIIM_ConvertMethod(GUIIM_METHOD_T method)
{
    uint16 i = 0;
    uint16 im_cnt = ARR_SIZE(g_method_relation_list);
    IIME_UINT iime_im = IM_NONE;
    ...
    for(i = 0; i < im_cnt; i++)
    {
        if(g_method_relation_list[i].guiim_method == method)
        {
            iime_im = g_method_relation_list[i].cstar_method;
            break;
        }
    }
