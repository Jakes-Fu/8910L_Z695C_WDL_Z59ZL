...
/*                         MACRO DEFINITION                                   */
/*----------------------------------------------------------------------------*/
#define MMIIM_SP_KEYMAP_COMBINE_START  (0xE100)
#define MMIIM_SP_KEYMAP_COMBINE_END    (0xE135)
#define MMIIM_SP_KEYMAP_COMBINE_MAX    ((MMIIM_SP_KEYMAP_COMBINE_END) - (MMIIM_SP_KEYMAP_COMBINE_START))
/*----------------------------------------------------------------------------*/
/*                          TYPE AND STRUCT                                   */
/*----------------------------------------------------------------------------*/
// 按键索引
...
/*==============================================================================
Description: MMIIM_SP_ML9KEY_GetCombindata
Global resource dependence: NONE
Author: 
Note:根据PUA得到组合字符的数组
==============================================================================*/
PUBLIC wchar const * MMIIM_SP_ML9KEY_GetCombindata(
                                    wchar wc
                                    );
/*==============================================================================
Description: MMIIM_SP_ML9KEY_GetPUAChar
Global resource dependence: NONE
Author: 
Note:查询是否组合字符数组中的unicode，如果是则返回PUA的值
==============================================================================*/
PUBLIC wchar MMIIM_SP_ML9KEY_GetPUAChar(
                                    wchar wc
                                    );
