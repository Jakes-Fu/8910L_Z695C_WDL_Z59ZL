...
#else
    MMIIM_SP_SYMB_PANEL_ROW = 6,//7,
    MMIIM_SP_SYMB_PANEL_COL = 7,//5,
#endif
...
#else
    MMIIM_SP_SYMB_MARGIN_V = 50,
	MMIIM_SP_SYMB_MARGIN_H = 1,
#endif
...
#else
	MMIIM_SP_SYMB_FONT = SONG_FONT_20,
    MMIIM_SP_SYMB_FONT_STR = SONG_FONT_16,
    MMIIM_SP_SYMB_FONT_LABEL = SONG_FONT_9,
...
#endif
    //根据符号表添加新增的类型,以arabic为例，
    MMIIM_SP_SYMB_TYPE_ARABIC,
    MMIIM_SP_SYMB_TYPE_NORWEGIAN,
    MMIIM_SP_SYMB_TYPE_CHS,
    MMIIM_SP_SYMB_TYPE_THAI,
    MMIIM_SP_SYMB_TYPE_SPANISH,
    MMIIM_SP_SYMB_TYPE_AMHARIC,
    MMIIM_SP_SYMB_TYPE_BENGALI,
    MMIIM_SP_SYMB_TYPE_ENGLISH,
    MMIIM_SP_SYMB_TYPE_YORUBA,
    MMIIM_SP_SYMB_TYPE_ASSAMESE,
    MMIIM_SP_SYMB_TYPE_GUJARATI,
    MMIIM_SP_SYMB_TYPE_KANNADA,
    MMIIM_SP_SYMB_TYPE_MALAYALAM,
    MMIIM_SP_SYMB_TYPE_ORIYA,
    MMIIM_SP_SYMB_TYPE_PUNJABI,
    MMIIM_SP_SYMB_TYPE_TAMIL,
    MMIIM_SP_SYMB_TYPE_TELUGU,
    MMIIM_SP_SYMB_TYPE_HAUSA,
    MMIIM_SP_SYMB_TYPE_HINDI,
    MMIIM_SP_SYMB_TYPE_IGBO,
    MMIIM_SP_SYMB_TYPE_KHMER,
    MMIIM_SP_SYMB_TYPE_MARATHI,
    //新增
    MMIIM_SP_SYMB_TYPE_HEBREW,
    //新增thai按键0的符号表
    MMIIM_SP_SYMB_TYPE_THAI_ZERO,
