...
#define MMIIM_SP_SYMB_COMBINE_START  (0xE100)
#define MMIIM_SP_SYMB_COMBINE_END    (0xE170)
#define MMIIM_SP_SYMB_COMBINE_MAX    ((MMIIM_SP_SYMB_COMBINE_END) - (MMIIM_SP_SYMB_COMBINE_START))
#define MMIIM_SP_SYMB_SIGN_START (MMIIM_SP_SYMB_DEF_STR_START)
#define MMIIM_SP_SYMB_SPACE_CHAR (0x2423)//空格
#define MMIIM_SP_SYMB_LINE_BREAK (0x21B5)//换行
typedef wchar MMIIM_SP_SYMBOL_TABLE_T[MMIIM_SP_SYMB_COMBINE_MAX][10];
typedef MMIIM_SP_SYMBOL_TABLE_T const MMIIM_SP_SYMBOL_TABLE_DEF_T;
...
typedef enum
{
    ...
    //注意顺序，以arabic为例
    MMIIM_SP_SYMBOL_TYPE_ARABIC,
    MMIIM_SP_SYMBOL_TYPE_NORWEGIAN,
    MMIIM_SP_SYMBOL_TYPE_CHS,
    MMIIM_SP_SYMBOL_TYPE_THAI,
    MMIIM_SP_SYMBOL_TYPE_SPANISH,
    MMIIM_SP_SYMBOL_TYPE_AMHARIC,
    MMIIM_SP_SYMBOL_TYPE_BENGALI,
    MMIIM_SP_SYMBOL_TYPE_ENGLISH,
    MMIIM_SP_SYMBOL_TYPE_YORUBA,
    MMIIM_SP_SYMBOL_TYPE_ASSAMESE,
    MMIIM_SP_SYMBOL_TYPE_GUJARATI,
    MMIIM_SP_SYMBOL_TYPE_KANNADA,
    MMIIM_SP_SYMBOL_TYPE_MALAYALAM,
    MMIIM_SP_SYMBOL_TYPE_ORIYA,
    MMIIM_SP_SYMBOL_TYPE_PUNJABI,
    MMIIM_SP_SYMBOL_TYPE_TAMIL,
    MMIIM_SP_SYMBOL_TYPE_TELUGU,
    MMIIM_SP_SYMBOL_TYPE_HAUSA,
    MMIIM_SP_SYMBOL_TYPE_HINDI,
    MMIIM_SP_SYMBOL_TYPE_IGBO,
    MMIIM_SP_SYMBOL_TYPE_KHMER,
    MMIIM_SP_SYMBOL_TYPE_MARATHI,
    MMIIM_SP_SYMBOL_TYPE_HEBREW,
    MMIIM_SP_SYMBOL_TYPE_THAI_ZERO,
#if MMIIM_SP_SYMBOL_SUPPORT_FULL
