...
#if defined(IM_TRAD_CHINESE_SUPPORT) || defined(IM_SIMP_CHINESE_SUPPORT)
#undef MMIIM_CORE_USE_SPIM
#define MMIIM_CORE_USE_SPIM
#endif
...
#if defined(MMIIM_CORE_USE_IEKIE)
    #define MMIIM_USE_IEKIE

    #define MMIIM_USE_KB_IEKIE

    #if defined(MMIIM_USE_TOUCH_PANEL)
        #define MMIIM_USE_TP_IEKIE
        #define MMIIM_USE_ASSO_IEKIE
    #endif
#endif
...
#if (defined(MMIIM_CORE_USE_CSTAR) || defined(MMIIM_CORE_USE_IEKIE))
enum
{
    //indicator size
    MMIIM_IDC_WIDTH = 4,
...
enum
{
    ...
    MMIIM_WIN_BUFFER_LEN = 2*MMIIM_ASSO_WORD_MAX_LEN,
    //cand
    MMIIM_CAND_COUNT_MAX = 40,//consider khmer
...
typedef struct
{
    ...
    wchar buffer[MMIIM_CAND_COUNT_MAX][MMIIM_WIN_BUFFER_LEN];
    int32 count;
	int32 cur_sel;
    MMIIM_IDC_FLAG_T idc_flag; // 0 - none, 1 - right, 2 - left, 3 - all
