...
WINDOW_TABLE( MMI_TEST_TEXT_EDITBOX_WIN_TAB ) = 
{
    ...
    WIN_TITLE(TXT_HELLO_TEST_STXT_EDITBOX),
                                               ...
                                               )
{
    ...
    case MSG_OPEN_WINDOW:
        ...
        AppendEditBoxMainListItem( ctrl_id, TXT_HELLO_TEST_STXT_EDITBOX, GUIEDIT_TYPE_TEXT );
                                               ...
                                               )
{
    ...
    case MSG_OPEN_WINDOW:
        ...
        MMI_GetLabelTextByLang( TXT_HELLO_TEST_STXT_EDITBOX, &string );
