...
/** \brief VM state: Indicate VM is in BACKGROUND state */
#define AJSC_VMSTATE_BACKGROUND   (9)
/** \brief VM state: Indicate VM is in FOREGROUND state */
#define AJSC_VMSTATE_FOREGROUND      (10)
...
/** \brief VM callback event: Indicate the VM IN BACKGROUND event. */
#define AJMS_VMEVENT_VM_BACKGROUND                  (11)
/** \brief VM callback event: Indicate the VM IN FOREGROUND event. */
#define AJMS_VMEVENT_VM_FOREGROUND                  (12)
/** @} */
...
/** \brief VM callback event: Indicate the VM stop normally normally with the exception OUT_OF_MEMORY  */
#define AJMS_VMEXIT_EXCEPTION_OUT_OF_MEMORY                   (300)
/** \brief VM callback event: Indicate the VM stop normally normally with the exception NULL_POINT  */
#define AJMS_VMEXIT_EXCEPTION_NULL_POINT                      (301)
/** \brief VM callback event: Indicate the VM stop normally normally with the exception ARITHMETIC  */
#define AJMS_VMEXIT_EXCEPTION_ARITHMETIC                      (302)
/** \brief VM callback event: Indicate the VM stop normally normally with the exception ARRRYINDEX_OUTOFBOUND  */
#define AJMS_VMEXIT_EXCEPTION_ARRRYINDEX_OUTOFBOUNDS          (303)
/** \brief VM callback event: Indicate the VM stop normally normally with the exception NO_CLASS_DEF_FOUND */
#define AJMS_VMEXIT_EXCEPTION_NO_CLASS_DEF_FOUND              (304)
...
AJ_S32 ajms_arc_backgroundApp(void);

AJ_S32 ajms_arc_foregroundApp(void);
