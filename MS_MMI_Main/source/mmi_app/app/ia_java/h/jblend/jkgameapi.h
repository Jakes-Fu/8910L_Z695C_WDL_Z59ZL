 ...
 *  If values specified in MIDP2.0 are to be designated, set these values internally.
 *
 */
 ...
 *
 * @param g              The handle of the graphics context that can be used 
 *                       as a work buffer.
 * @param hScreen        The handle of the source offscreen.
 * @param rect           The position and size of the rectangle region to be transferred.
 * 
 * Transfer the region designated in <i>rect</i> of the source offscreen 
 * designated in <i>hScreen</i> to the same region in the real screen.
 *
