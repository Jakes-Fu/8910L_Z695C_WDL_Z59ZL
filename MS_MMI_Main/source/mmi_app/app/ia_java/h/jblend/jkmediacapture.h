...
/**
 * Error occured in recording.\ A value to be returned by JKT_Media_RecordControl structure <i>getState()</i>.
 */
...
typedef struct {
     ...
     * <i>pType</i> paramameter a pointer to the string that represents 
     ...
     *
     * If the input device has not been opened yet when this funciton is called,
     ...
     *
     * If the input device has been already opened when this funciton is called, 
...
typedef struct {
    ...
    /**
     * Sets an encoder and encoding paramters to the player
     * @param id
     *  The player ID.
     * @param pParam
     *  A pointer to the buffer holding the encoding paramters.
     ...
     *
     *  JBlend analyses encoding parameters based on the MMAPI specification
     ...
     *  after this function returns; therfore, 
     ...
     *   accroding to the encoding parameters that were designated by setEncodeParam()().
     */
     ...
     * @param id
     *  The player ID.
     *   JBlend calles this function, after image data acquisition by 
...
typedef struct {
     ...
     *  The player ID.
     * @return
     *  Return the size of buffer (in bytes) which microjBlend adds in Java heap.
     *
    ...
    /**
     * Sets a size limit of recording data.
     * @param id
     *  The player ID.
     * @param size
    ...
    /**
     * Gets the addres and size of a buffer holding recorded data.
     * @param id
     *  The player ID.
     * @param count
     ...
     *   if it fails, return #JKMEDIA_RESULT_ERROR.
     *
     *  JBlend calls this function when recroding is completed.
