 ...
 *         Designate an address value conforming to the memory alignment of the CPU
 *         used.
 *  @param errorCode
 ...
 *
 *  The notation in the JAD file must be in a format conforming to the MIDP 2.0
 *  specification.<br>
 ...
 *
 *  The notation in the manifest file must be in a format conforming to the MIDP 2.0
 *  specification.<br>
 ...
 *         Designate an address value conforming to the memory alignment of the CPU used. <br>
...
/**
 *  Verifies conformity of a JAD file to the MIDP 2.0 specification.
 *  @param hEnv
 *         The application information analysis functions environment handle obtained by
 *         #AamsEnvInitialize()
 *  @param hJad
 ...
 *  @return
 *         - #JK_AMS_OK: Conforms to MIDP 2.0 specification<br>
 *         - #JK_AMS_ILLEGAL_ARGUMENT_ERROR:  Either of the following cases<br>
 ...
 *         .
 *
 *  This function checks the JAD file designated by hJad for conformity to the MIDP 2.0
...
/**
 *  Verifies conformity of a manifest file to the MIDP 2.0 specification.
 *  @param hEnv
 *         The application information analysis functions environment handle obtained by
 *         #AamsEnvInitialize()
 *  @param hManifest
 ...
 *  MIDP 2.0 specification. The following conditions are checked.<br>
 ...
 *  the hJad and hManifest parameters conform to the MIDP 2.0 specification.<br>
 ...
 *  MIDP 2.0 or in creating an application original to the native system. 
 *  The use of this function is not necessary if the device manufacturer implements only the
 *  AMS specified in MIDP 2.0.
 ...
 *
 * See the MIDP 2.0 specification for details of version information given in the
 ...
 *  Since the MIDlet attribute values as specified by MIDP 2.0 are not enclosed
