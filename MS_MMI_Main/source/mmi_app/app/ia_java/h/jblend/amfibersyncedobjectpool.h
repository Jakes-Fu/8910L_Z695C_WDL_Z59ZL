...
/**
 * @name Fiber Synchronization Object Pool Capacity Macros
 * @{
 */

/**
 *  A macro used to set the Synchronized Object Pool capacity.
 *
 *  @param fibers
 *   The maximum number of Fiber objects supported by the pool.
 *  @param objects
 *   The maximum number of Synchronized Objects supported by the pool.
 * 
 *  @return
 *   A bit-wise combination of the <i>fibers</i> and <i>objects</i> 
 *   provided to the macro for use with the 
 *   #AmFiberSyncedObjectPoolCreate() function.
 * 
 *  @see
 *  fsop_getFibers, fsop_setCapacity
 * 
 */

#define fsop_setCapacity(fibers,objects)            (((0x0000FFFF & (fibers  )) << 16) | ((0x0000FFFF & (objects)) <<  0))

/**
 *  A macro used to get the Fiber object capacity from a Synchronized 
 *  Object Pool capacity value.
 *
 *  @param capacity
 *   The bit-wise combination of the Fiber and Synchronized Objects 
 *   combined to specify the @ref 
 *   Fiber_Synced_Object_Pool_JBI "Synchronized Object Pool" capacity.
 * 
 *  @return
 *   The Fiber object portion of the @ref 
...
#define fsop_getFibers(capacity)                     ((0xFFFF0000 & (capacity)) >> 16)

/**
 *  A macro used to get the Synchronized Object capacity from a 
 *  Synchronized Object Pool capacity value.
 *
 *  @param capacity
 *   The bit-wise combination of the Fiber and Synchronized Objects 
 *   combined to specify the @ref 
 ...
 * 
 *  @return
 *   The Synchronized Object portion of the @ref
 *   Fiber_Synced_Object_Pool_JBI "Synchronized Object Pool" 
 *   <i>capacity</i>.
 * 
 *  @see
...
#define fsop_getObjects(capacity)                    ((0x0000FFFF & (capacity)) >>  0)
 ...
 *  Object Pool.
 */
#define JK_FIBER_SOP_OBJECTS_MAX        (1024) /* 1024 objects */
 ...
 *  @param cshObjectCapacity
 *   A combination value indicating the number of Fiber objects supported 
 *   by the Synchronized Object Pool and the maximum number of Synchronized 
 *   Objects which may be built with it. See #fsop_setCapacity for more 
 *   details regarding how to create this value.
 *  @param pvObjectHeap
...
long AmFiberSyncedObjectPoolCreate( unsigned long ulSpecifications, unsigned long cshObjectCapacity, void *pvObjectHeap, unsigned long *pulObjectHeapSize, JKFiberSyncedObjectPoolHandle *phFiberSyncedObjectPool );
 ...
 *  #JK_FIBER_SO_SPECIFICATION_EVENT and #JK_FIBER_SO_SPECIFICATION_SECTION. 
 *  The <i>ulSpecification</i> parameter is used as an ordinal value instead 
 *  of a bit-field (as seen in the #AmFiberSyncedObjectPoolCreate() 
 *  function).
 * 
 ...
 *  created with a formal type of #JKFiberSyncedEventHandle. Likewise, a 
 *  Synchronized Section object with a formal 
 *  type of #JKFiberSyncedSectionHandle will be created when 
 *  #JK_FIBER_SO_SPECIFICATION_SECTION is used. Both objects are 
 *  subclasses of the ubiquitous Synchronized Object. As such, the handle 
 *  used to manage these objects can be cast to the 
 *  #JKFiberSyncedObjectHandle type when needed.
 * 
 *  Usage of the <i>ulFlags</i> parameter varies based on the value 
 ...
 *  flags with the <i>ulFlags</i> parameter. In consideration of the 
 ...
 *  does not make use of any flags in the <i>ulFlags</i> parameter. In 
 *  this case, the value of the <i>ulFlags</i> parameter should be 
 ...
 *  #AmFiberEventWait() and #AmFiberSectionEnter() for more details.
 * 
 ...
 * 
 *  @see
 *  AmFiberEventWait, AmFiberSectionEnter, 
 *  AmFiberSyncedObjectRelease, AmFiberSyncedObjectPoolDestroy
 *
 */

long AmFiberSyncedObjectCreate( JKFiberSyncedObjectPoolHandle hFiberSyncedObjectPool, unsigned long ulSpecification, unsigned long ulFlags, JKFiberSyncedObjectHandle *phFiberSyncedObject );
