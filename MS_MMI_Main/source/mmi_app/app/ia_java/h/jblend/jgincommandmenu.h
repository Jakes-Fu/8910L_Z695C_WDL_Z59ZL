 ...
 *   distinguish a list item for cancelation from the other items. 
 */
 ...
 *   
 *   This is functional only when the JBlend option "Pointing Device Support"
 *   is enabled. Otherwise, this function does not perform any action.
 * 
 */
