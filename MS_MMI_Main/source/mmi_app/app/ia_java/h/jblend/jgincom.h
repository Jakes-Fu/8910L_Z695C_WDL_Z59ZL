 ...
 *   
 *   @if DOJA_OE
 *    This event is issued only when the event handler which handles #JG_COM_EVT_GET_PREF_HEIGHT 
 *    returns a height greater or equal to the display size. 
 *   @endif
 *   @if MIDP
 ...
 *   
 *   @if DOJA_OE
 *    This event is issued only when the event handler which handles #JG_COM_EVT_GET_PREF_WIDTH 
 *    returns a width greater or equal to the display size. 
 *   @endif
 *   @if MIDP
 *    This event is issued when the event handler which handles 
 ...
 *   
 *   The inset values must be in the range of 0 to 127.
 *
 *   In the following cases @ref page_gui_trouble_shooting "Error" results.
 *   <ul>
 *    <li>When component is an illegal handle.</li>
