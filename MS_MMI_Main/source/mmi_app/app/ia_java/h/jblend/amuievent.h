 ...
 *  @endif
 *  @if DOJA_OE
 *  When this event is passed to JBlend, if an object of 
 *  the <code>com.nttdocomo.ui.Canvas</code> class's subclass is set 
 *  as the current <code>Frame</code>, the <code>processEvent</code> 
 *  method is called designating <code>com.nttdocomo.ui.Display.KEY_PRESSED_EVENT</code> 
 *  in the parameter.
 *  @endif
 */
 ...
 *  @if DOJA_OE
 *  When this event is passed to JBlend, if an object of 
 *  the <code>com.nttdocomo.ui.Canvas</code> class's subclass is set as the current 
 *  <code>Frame</code>, the <code>processEvent</code> method is called designating 
 *  <code>com.nttdocomo.ui.Display.KEY_RELEASED_EVENT</code> in the parameter.
 *  @endif
 */
 ...
 *  @if DOJA_OE
 *  When this event is passed to JBlend, if an object of 
 *  the <code>com.nttdocomo.ui.Panel</code> class or its subclass is set 
 *  as the current <code>Frame</code>, scrolling of the screen and 
 *  the actions of GUI components on the screen are performed.
 *  @endif
 */
 ...
 *  @if DOJA_OE
 * JVM events #JK_DVMEVENT_VMPAINTREADY and #JK_DVMEVENT_APPSTARTED to the native system.
 * Thus if the native system calls this function before the #JK_DVMEVENT_APPSTARTED 
 *  @else
