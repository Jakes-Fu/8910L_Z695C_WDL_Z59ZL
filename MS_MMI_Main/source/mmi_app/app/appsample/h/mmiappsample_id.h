...
#undef WIN_ID_DEF
    ...
    typedef enum
    {
        ...
        MMIAPPSAMPLE_ROOT_FORM_CTRL_ID,
		MMIAPPSAMPLE_FORM_SUB1_CTRL_ID,
		MMIAPPSAMPLE_FORM_SUB11_CTRL_ID,
		MMIAPPSAMPLE_FORM_SUB12_CTRL_ID,
		MMIAPPSAMPLE_FORM_SUB13_CTRL_ID,
		MMIAPPSAMPLE_FORM_SUB2_CTRL_ID,
		MMIAPPSAMPLE_FORM_SUB21_CTRL_ID,
		MMIAPPSAMPLE_FORM_SUB22_CTRL_ID,
        MMIAPPSAMPLE_FORM_SUB23_CTRL_ID,
		MMIAPPSAMPLE_FORM_SUB3_CTRL_ID,
		MMIAPPSAMPLE_FORM_SUB31_CTRL_ID,
		MMIAPPSAMPLE_FORM_SUB32_CTRL_ID,
		MMIAPPSAMPLE_FORM_SUB33_CTRL_ID,
