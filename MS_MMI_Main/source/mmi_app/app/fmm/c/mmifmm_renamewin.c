...
#endif
#include "guitext.h"
//#define MMI_FMM_RENAME_DIALOG_SUPPORT
//End
/**--------------------------------------------------------------------------*
**                         MACRO DEFINITION                                 *
**--------------------------------------------------------------------------*/
...
)
{
    ...
    MMI_WIN_ID_T rename_dialog_id = MMIFMM_RENAME_WIN_ID;
    ...
    if (PNULL != param_to_rename_win_ptr)
    {
...
#ifndef MMI_FMM_RENAME_DIALOG_SUPPORT
        ...
        MMIPUB_OpenDialogInputFieldWinByTextPtr(
            ...
            HandleFmmRenameWinMsg
            );
        MMK_SetWinUserData (rename_dialog_id, (void *) param_to_rename_win_ptr);
#endif
...
#else
#ifdef ZDT_PRODUCT_BH
		GUIEDIT_SetFontColor(ctrl_handle, 0xef9d); 
#endif

        GUIEDIT_SetString (ctrl_handle, file_buf_ptr, string_len);
#endif
        break;
...
case MSG_NOTIFY_OK:	
    ...
    case MSG_APP_CANCEL:
    case MSG_CTL_CANCEL:
#ifdef MMI_FMM_RENAME_DIALOG_SUPPORT
    case MSG_KEYUP_OK:
#endif
      //  GUIEDIT_GetString(ctrl_handle,&name_str);
      //  if (0 == name_str.wstr_len)
...
#else
    MMIFMM_RENAME_WIN_PARAM_T *detail_data = (MMIFMM_RENAME_WIN_PARAM_T*) MMK_GetWinUserData (win_id);
#endif
