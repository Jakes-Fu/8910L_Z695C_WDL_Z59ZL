...
#ifdef MMI_SHOW_MSA
wchar g_mmimultim_gallary_onedrive_thumbnail_dir_wstr[] = { 'P', 'h','o','t','o','s', '\\','O','n','e', 'D', 'r', 'i', 'v','e', '\\','T','h','u','m','b','n','a','i','l','s',0};
wchar g_mmimultim_gallary_onedrive_download_dir_wstr[] = {'P', 'h','o','t','o','s', '\\','O','n','e', 'D', 'r', 'i', 'v','e',0 };
wchar g_mmimultim_gallary_camera_roll[] = { 'P', 'h','o','t','o','s', '\\', 'C', 'a', 'm','e','r','a',' ','R','o','l','l',0 };
#endif
wchar g_mmimultim_mms_browser_save_pics_dir_wstr[] = { 'P', 'h','o','t','o','s', '\\','S','a','v', 'e', 'd', ' ', 'P','i', 'c','t','u','r','e','s',0};
wchar g_mmimultim_gallary_camera[] = { 'P', 'h','o','t','o','s', 0};
//add end

wchar g_mmimultim_backup_dir_wstr[] = { 'B', 'a', 'c', 'k', 'u', 'p','s', 0 };
wchar g_mmimultim_recording_dir_wstr[] = { 'R', 'e', 'c', 'o', 'r', 'd', 'i', 'n', 'g', 's', '\\', 'V', 'o', 'i', 'c', 'e', ' ', 'r', 'e', 'c', 'o', 'r', 'd', 'i', 'n', 'g', 's',0};
wchar g_mmimultim_received_recording_dir_wstr[] = { 'R', 'e', 'c', 'o', 'r', 'd', 'i', 'n', 'g', 's', '\\', 'R', 'e', 'c', 'e', 'i', 'v', 'e', 'd', ' ', 'r', 'e', 'c', 'o', 'r', 'd', 'i', 'n', 'g', 's',0};
wchar g_mmimultim_radio_recording_dir_wstr[] = { 'R', 'e', 'c', 'o', 'r', 'd', 'i', 'n', 'g', 's', '\\', 'R', 'a', 'd', 'i', 'o', ' ', 'r', 'e', 'c', 'o', 'r', 'd', 'i', 'n', 'g', 's',0};
wchar g_mmimultim_received_dir_wstr[] = { 'R', 'e', 'c', 'e', 'i', 'v', 'e', 'd', ' ', 'f', 'i', 'l', 'e', 's',0};
wchar g_mmimultim_music_file_dir_wstr[] = { 'M', 'u', 's', 'i', 'c', ' ','f', 'i', 'l', 'e', 's',0};
#ifdef ZDT_PRODUCT_BH
wchar g_mmimultim_music_dir_wstr[]   =  {'M', 'u', 's', 'i', 'c', 0} ;//  { 'A', 'u', 'd', 'i', 'o', 0 }/*lint !e785*/;  Music
#else
wchar g_mmimultim_music_dir_wstr[]   = { 'A', 'u', 'd', 'i', 'o', 0 }/*lint !e785*/;
#endif
wchar g_mmimultim_movie_dir_wstr[]   = { 'V', 'i', 'd', 'e', 'o' , 0 }/*lint !e785*/;
wchar g_mmimultim_RevFile_dir_wstr[]   = { 'R', 'e', 'c', 'e', 'i' , 'v' , 'e' , 'd' , ' ' , 'f' , 'i' , 'l' , 'e' , 's' ,0 };
wchar g_mmimultim_Recordings_dir_wstr[]   = { 'R', 'e', 'c', 'o', 'r' , 'd' , 'i' , 'n' , 'g' , 's' , 0 };

#if defined(ZDT_MUSIC_KING_SUPPORT)
wchar g_mmimultim_music_king_01_dir_wstr[] = {0x6D41, 0x884C, 0x6B4C, 0x66F2, 0}; //流行歌曲6D41 884C 6B4C 66F2
wchar g_mmimultim_music_king_02_dir_wstr[] = {0x7EA2, 0x6B4C, 0x7ECF, 0x5178, 0}; //红歌经典7EA2 6B4C 7ECF 5178
wchar g_mmimultim_music_king_03_dir_wstr[] = {0x5E7F, 0x573A, 0x821E, 0x66F2, 0}; //广场舞曲 5E7F 573A 821E 66F2 
wchar g_mmimultim_music_king_04_dir_wstr[] = {0x66F2, 0x827A, 0x6742, 0x8C08, 0 }; //曲艺杂谈 66F2 827A 6742 8C08
wchar g_mmimultim_music_king_05_dir_wstr[] =  {0x513F, 0x6B4C, 0x7ECF, 0x5178, 0}; //儿歌经典513F 6B4C 7ECF 5178
#endif
#if defined(ZDT_VIDEO_KING_SUPPORT)
wchar g_mmimultim_video_king_01_dir_wstr[] ={0x5F71, 0x89C6, 0x6B4C, 0x66F2, 0};///影视歌曲5F71  89C6  6B4C  66F2 
wchar g_mmimultim_video_king_02_dir_wstr[] = {0x5C0F, 0x54C1, 0x5FEB, 0x677F, 0 }; //小品快板 5C0F 54C1 5FEB 677F 
wchar g_mmimultim_video_king_03_dir_wstr[] = {0x513F, 0x6B4C, 0x6545, 0x4E8B, 0}; //儿歌故事 513F 6B4C 6545 4E8B
wchar g_mmimultim_video_king_04_dir_wstr[] = {0x5E7F, 0x573A, 0x821E, 0}; //广场舞 5E7F 573A 821E  
wchar g_mmimultim_video_king_05_dir_wstr[] = {0x5065, 0x8EAB, 0x64CD, 0}; //健身操 5065 8EAB 64CD
wchar g_mmimultim_video_king_06_dir_wstr[] = {0x5730, 0x65B9, 0x620F, 0x66F2, 0 }; //地方戏曲 5730 65B9 620F 66F2   
wchar g_mmimultim_video_king_07_dir_wstr[] = {0x514D, 0x8D39, 0x7535, 0x5F71, 0 }; //免费电影514D 8D39 7535 5F71 
wchar g_mmimultim_video_king_08_dir_wstr[] = {0x66F2, 0x827A, 0x6742, 0x8C08, 0 }; //曲艺杂谈66F2 827A 6742 8C08 
wchar g_mmimultim_video_king_09_dir_wstr[] = {0x76F8, 0x58F0, 0x5C0F, 0x54C1, 0 }; //相声小品76F8 58F0 5C0F 54C1 
wchar g_mmimultim_video_king_10_dir_wstr[] = {0x5F71, 0x89C6, 0x6B4C, 0x66F2, 0 }; //影视歌曲5F71 89C6 6B4C 66F2 
#endif
...
#ifdef DRM_SUPPORT
	if(s_select_win_param_ptr == PNULL)
	{
		return FALSE;
	}
    if (((0 != s_select_win_param_ptr->drm_limit.cons_mode_limit)
                                        ...
                                        )
{
    ...
    case MSG_OPEN_WINDOW:
        if ( !MMIAPIMMS_IsBlockConflict(BLOCK_MEM_POOL_MP4ENC) )
        {
			...
			MMIAPIFMM_SetOpenFileWinSoftkey(STXT_SOFTKEY_SELECT_MK, IMAGE_COMMON_SOFTKEY_START_ICON, STXT_RETURN);
#else
			MMIAPIFMM_SetOpenFileWinSoftkey(STXT_SOFTKEY_SELECT_MK, STXT_PREVIEW, STXT_RETURN);
#endif
        }
        else
        {
#ifdef MID_SOFTKEY_USE_IMG_SUPPORT 
            MMIAPIFMM_SetOpenFileWinSoftkey(STXT_SOFTKEY_SELECT_MK, IMAGE_NULL, STXT_RETURN);
#else
			MMIAPIFMM_SetOpenFileWinSoftkey(STXT_SOFTKEY_SELECT_MK, TXT_NULL, STXT_RETURN);
#endif
        }
        #ifdef MMI_PDA_SUPPORT
                                ...
                                )
{
    ...
    if(s_select_win_param_ptr == NULL)
        return FALSE;
#ifdef DRM_SUPPORT
    if ((0 != s_select_win_param_ptr->drm_limit.cons_mode_limit)
        || (0 != s_select_win_param_ptr->drm_limit.method_level_limit))
...
PUBLIC void MMIFMM_DrawTickedOnFile(uint16 tick_file_index)
{
    ...
    if (MMIAPIFMM_SplitFileName(s_select_win_param_ptr->ticked_file, s_select_win_param_ptr->ticked_file_len, PNULL, PNULL, suffix_wstr, &suffix_len))
    {
		...
		else if(0 < s_select_win_param_ptr->ticked_file_len)
		{
            ...
            item_data.softkey_id[0] = STXT_SOFTKEY_SELECT_MK;
...
PUBLIC void MMIAPIFMM_CloseSelectFileWin(void)
{
    ...
    {
        MMK_CloseParentWin(MMIFMM_OPEN_FILE_BYLAYER_WIN_ID);
    }
