...
//#endif
    ...
    MMIFMM_RECORD_LIST_CTRL_ID,
    MMIFMM_RECORD_OPT_MENU_CTRL_ID,
    MMIFMM_RECORD_SHARE_OPT_MENU_CTRL_ID,
    MMIFMM_MAX_CTRL_ID,

#if defined(ZDT_VIDEO_KING_SUPPORT)
        MMIFMM_MEDIA_LIST_CTRL_ID,
#endif
    MMIFMM_FOLDER_OPT_MENU_CTRL_ID,
    MMIFMM_FILES_OPT_MENU_CTRL_ID,
    MMIFMM_VCARD_FILES_OPT_MENU_CTRL_ID,
    MMIFMM_VCALENDAR_FILES_OPT_MENU_CTRL_ID,
    MMIFMM_MULTI_SELECT_OPT_MENU_CTRL_ID,
    MMIFMM_WAIT_SPINNER_CTRL_ID
}MMIFMM_CONTROL_ID_E;
