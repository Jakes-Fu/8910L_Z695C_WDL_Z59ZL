...
const GUIMENU_ITEM_T menu_email_view_locate_number_option[] =
{
    ...
    STR_LOG_LIST_SAVE,  0, 0, 0, MENU_EMAIL_VIEW_ADDTOPB_OPT},
};
...
const GUIMENU_ITEM_T menu_email_view_attach_option[] =
{
    ...
    STXT_SOFTKEY_SAVE_MK,  0, 0, 0, MENU_NULL},
};
...
const GUIMENU_ITEM_T menu_email_save_attachment_option[] =
{
    ...
    STXT_SOFTKEY_SAVE_MK,  IMAGE_EMAIL_OPTMENU_SAVE_TO, 0, 0, MENU_NULL},
};
#endif
#ifdef MMI_IP_CALL_SUPPORT
/**************************************************************************************/
...
{ 
    ...
    STXT_SOFTKEY_MARK_MK, IMAGE_COMMON_OPTMENU_MARK, 0, 0, MENU_NULL},
...
#else
{
    ...
    STXT_SOFTKEY_MARK_MK, 0, 0, 0, MENU_EMAIL_BOX_MARK_OPT},
...
#else
{
    ...
    STXT_SOFTKEY_MARK_MK, 0, 0, 0, MENU_NULL},
...
#if defined(MMI_PDA_SUPPORT)//@tao.xue
{
    {EMAIL_MAINMENU_OPT_RECEIVE_SEND_ITEM_ID, TIP_NULL, {STXT_SOFTKEY_SELECT_MK, TXT_NULL, STXT_RETURN},
    ...
    {EMAIL_MAINMENU_OPT_ACCOUNT_SETTING_ITEM_ID, TIP_NULL, {STXT_SOFTKEY_SELECT_MK, TXT_NULL, STXT_RETURN},
    TXT_ACCOUNT_SETTING,  IMAGE_EMAIL_OPTMENU_ACC_SETTING, 0, 0, MENU_NULL},
    {EMAIL_MAINMENU_OPT_SYS_SETTING_ITEM_ID,  TIP_NULL, {STXT_SOFTKEY_SELECT_MK, TXT_NULL, STXT_RETURN},
...
#if defined(MMI_PDA_SUPPORT)//@tao.xue
{
    //     {EMAIL_SETTING_OPT_SEND_RECEIVE_MAIL_ID,    TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},
    //         TXT_COMMON_RECV_EMAIL,        0, 0, 0, MENU_NULL},
