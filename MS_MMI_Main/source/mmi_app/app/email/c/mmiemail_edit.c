...
//             else
...
#ifdef MMI_PDA_SUPPORT
         if (s_email_edit_p->focus_index < MMIEMAIL_RICHTEXT_ITEM_NUM_MAX && MMIEMAIL_EDIT_RICHTEXT_ADDFILE == s_email_edit_richtext_type[s_email_edit_p->focus_index])
         {
         ...
         else if (s_email_edit_p->focus_index < MMIEMAIL_RICHTEXT_ITEM_NUM_MAX && MMIEMAIL_EDIT_RICHTEXT_TO == s_email_edit_richtext_type[s_email_edit_p->focus_index])
         {
         ...
         else if (s_email_edit_p->focus_index < MMIEMAIL_RICHTEXT_ITEM_NUM_MAX && MMIEMAIL_EDIT_RICHTEXT_CC == s_email_edit_richtext_type[s_email_edit_p->focus_index])
         {
         ...
         else if (s_email_edit_p->focus_index < MMIEMAIL_RICHTEXT_ITEM_NUM_MAX && MMIEMAIL_EDIT_RICHTEXT_BCC == s_email_edit_richtext_type[s_email_edit_p->focus_index])
         {
                                           ...
                                           )
{
    ...
    case MSG_OPEN_WINDOW:
        ...
        //set softkey
        //GUIEDIT_SetSoftkey(ctrl_id,0,1,STXT_MAIN_PB,STXT_SOFTKEY_OK_MK,PNULL);
