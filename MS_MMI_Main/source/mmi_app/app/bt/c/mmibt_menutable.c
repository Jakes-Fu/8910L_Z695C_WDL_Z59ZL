...
{
    { ID_BT_HANDFREE, TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, STR_BT_DEVICE_HANDFREE, 0, 0, 0, MENU_NULL },
...
const GUIMENU_ITEM_T menu_my_bt_setting[] =
{
    ...
    { ID_MY_BT_VISIBILITY, TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, STR_BT_SETT_PHONE_DETECTABILITY, 0, 0, 0, MENU_NULL },
    { ID_MY_BT_DEVICE_NAME, TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, STR_BT_SETT_RENAME_PHONE, 0, 0, 0, MENU_NULL },
...
{
 { ID_BT_DEVICE_CONNECT, TIP_NULL, {NULL, STXT_SOFTKEY_SELECT_MK, STXT_RETURN}, STR_SOFTKEY_BT_CONNECT_MK, 0, 0, 0, MENU_NULL },
 { ID_BT_DEVICE_RENAME, TIP_NULL, {NULL, STXT_SOFTKEY_SELECT_MK, STXT_RETURN}, STR_BT_SETT_RENAME_PHONE, 0, 0, 0, MENU_NULL },
 { ID_BT_DEVICE_DELETE, TIP_NULL, {NULL, STXT_SOFTKEY_SELECT_MK, STXT_RETURN}, STR_BT_FULL_DISSOLVE, 0, 0, 0, MENU_NULL },
#ifndef MMI_PDA_SUPPORT
 { ID_BT_DEVICE_DELETE_ALL, TIP_NULL, {NULL, STXT_SOFTKEY_SELECT_MK, STXT_RETURN}, TXT_DELALL, 0, 0, 0, MENU_NULL },
#endif
 { ID_BT_DEVICE_DETAIL, TIP_NULL, {NULL, STXT_SOFTKEY_SELECT_MK, STXT_RETURN}, TXT_BT_DEVICE_DETAILS, 0, 0, 0, MENU_NULL },
#ifdef MMIBT_HEADSET_AUTHORIZE
 { ID_BT_AUTO_CONNECT_TOGGLE, TIP_NULL, {NULL, STXT_SOFTKEY_SELECT_MK, STXT_RETURN}, STR_BT_SETT_CONN_TYPE, 0, 0, 0, MENU_NULL},
 { ID_BT_ACCREDIT_SETTINGS, TIP_NULL, {NULL, STXT_SOFTKEY_SELECT_MK, STXT_RETURN}, TXT_BT_ACCREDIT_SETTINGS, 0, 0, 0, MENU_BT_ACCREDIT_SETTINGS_OPT},
#endif
};
//device option menu of headset connect
const GUIMENU_ITEM_T menu_bt_deactive_device_details[] =
{
 { ID_BT_DEVICE_DISCONNECT, TIP_NULL, {NULL, STXT_SOFTKEY_SELECT_MK, STXT_RETURN}, STR_SOFTKEY_BT_DISCONNECT_MK, 0, 0, 0, MENU_NULL },
 { ID_BT_DEVICE_RENAME, TIP_NULL, {NULL, STXT_SOFTKEY_SELECT_MK, STXT_RETURN}, TXT_BT_DEVICE_RENAME, 0, 0, 0, MENU_NULL },
 { ID_BT_DEVICE_DELETE, TIP_NULL, {NULL, STXT_SOFTKEY_SELECT_MK, STXT_RETURN}, STR_BT_FULL_DISSOLVE, 0, 0, 0, MENU_NULL },
#ifndef MMI_PDA_SUPPORT
 { ID_BT_DEVICE_DELETE_ALL, TIP_NULL, {NULL, STXT_SOFTKEY_SELECT_MK, STXT_RETURN}, TXT_DELALL, 0, 0, 0, MENU_NULL },
#endif
...
const GUIMENU_ITEM_T menu_other_bt_device_details[] =
{
 { ID_BT_DEVICE_CONNECT, TIP_NULL, {NULL, STXT_SOFTKEY_SELECT_MK, STXT_RETURN}, STR_SOFTKEY_BT_CONNECT_MK, 0, 0, 0, MENU_NULL },
 { ID_BT_DEVICE_DISCONNECT, TIP_NULL, {NULL, STXT_SOFTKEY_SELECT_MK, STXT_RETURN}, STR_SOFTKEY_BT_DISCONNECT_MK, 0, 0, 0, MENU_NULL },
 { ID_BT_SEATCH_DEVICE, TIP_NULL, {NULL, STXT_SOFTKEY_SELECT_MK, STXT_RETURN}, STXT_SEARCH, 0, 0, 0, MENU_NULL},
  { ID_BT_DEVICE_DELETE, TIP_NULL, {NULL, STXT_SOFTKEY_SELECT_MK, STXT_RETURN}, STR_BT_FULL_DISSOLVE, 0, 0, 0, MENU_NULL },
  { ID_BT_AUTO_CONNECT_TOGGLE, TIP_NULL, {NULL, STXT_SOFTKEY_SELECT_MK, STXT_RETURN}, STR_BT_SETT_CONN_TYPE, 0, 0, 0, MENU_NULL},
 { ID_BT_ACCREDIT_SETTINGS, TIP_NULL, {NULL, STXT_SOFTKEY_SELECT_MK, STXT_RETURN}, TXT_BT_ACCREDIT_SETTINGS, 0, 0, 0, MENU_BT_ACCREDIT_SETTINGS_OPT},
 { ID_BT_DEVICE_RENAME, TIP_NULL, {NULL, STXT_SOFTKEY_SELECT_MK, STXT_RETURN}, TXT_BT_DEVICE_RENAME, 0, 0, 0, MENU_NULL },
...
const GUIMENU_ITEM_T menu_bt_accredit_settings_opt[] =
{
    ...
    {ID_BT_AUTO_CONNECT,   TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},STR_BT_SETT_CONN_TYPE,0, 0, 0, NULL},
};
