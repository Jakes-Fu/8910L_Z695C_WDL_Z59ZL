...
{
    {ID_SEARCH_MARKED,   TIP_NULL, {STXT_SOFTKEY_OK_MK,TXT_NULL,STXT_RETURN},STXT_SOFTKEY_MARK_MK,   IMAGE_COMMON_OPTMENU_MARK, 0, 0, MENU_SEARCH_MARK},
    {ID_SEARCH_SORT,     TIP_NULL, {STXT_SOFTKEY_OK_MK,TXT_NULL,STXT_RETURN},TXT_COMMON_SORT,   IMAGE_COMMON_OPTMENU_SORT, 0, 0, MENU_SEARCH_SORT_OPT}
};

const GUIMENU_ITEM_T menu_search_file_list_opt[] =
{
    {ID_SEARCH_OPEN,     TIP_NULL, {STXT_SOFTKEY_OK_MK,TXT_NULL,STXT_RETURN},TXT_VIEW,    0, 0, 0, MENU_NULL},
    {ID_SEARCH_DELETE,   TIP_NULL, {STXT_SOFTKEY_OK_MK,TXT_NULL,STXT_RETURN},TXT_DELETE, 0, 0, 0, MENU_NULL},
    {ID_SEARCH_SEND,     TIP_NULL, {STXT_SOFTKEY_OK_MK,TXT_NULL,STXT_RETURN},TXT_SEND,    0, 0, 0, MENU_SEARCH_SEND},
    {ID_SEARCH_DETAIL,   TIP_NULL, {STXT_SOFTKEY_OK_MK,TXT_NULL,STXT_RETURN},STXT_DETAIL, 0, 0, 0, MENU_NULL},
...
const GUIMENU_ITEM_T menu_search_file_list_opt[] =
{
    ...
    {ID_SEARCH_MARKED,   TIP_NULL, {STXT_SOFTKEY_OK_MK,TXT_NULL,STXT_RETURN},STXT_SOFTKEY_MARK_MK,   0, 0, 0, MENU_SEARCH_MARK},
    {ID_SEARCH_SORT,     TIP_NULL, {STXT_SOFTKEY_OK_MK,TXT_NULL,STXT_RETURN},TXT_COMMON_SORT,   0, 0, 0, MENU_SEARCH_SORT_OPT}
};
#endif
...
{
    {ID_SEARCH_SEND_MMS,    TIP_NULL, {STXT_SOFTKEY_OK_MK,TXT_NULL,STXT_RETURN},TXT_MMS,       0, 0, 0, MENU_NULL},
#ifdef BLUETOOTH_SUPPORT
    {ID_SEARCH_SEND_BT,     TIP_NULL, {STXT_SOFTKEY_OK_MK,TXT_NULL,STXT_RETURN},TXT_BLUETOOTH,        0, 0, 0, MENU_NULL}
#endif
};
...
{
    {ID_SEARCH_MARKED,         TIP_NULL, {STXT_SOFTKEY_OK_MK,TXT_NULL,STXT_RETURN},STXT_SOFTKEY_MARK_MK,              0, 0, 0, MENU_NULL},
    {ID_SEARCH_UNMARKED,       TIP_NULL, {STXT_SOFTKEY_OK_MK,TXT_NULL,STXT_RETURN},TXT_CANCEL_MARK,       0, 0, 0, MENU_NULL},
    {ID_SEARCH_MARKED_ALL,     TIP_NULL, {STXT_SOFTKEY_OK_MK,TXT_NULL,STXT_RETURN},TXT_MARK_ALL,          0, 0, 0, MENU_NULL},
    {ID_SEARCH_UNMARKED_ALL,   TIP_NULL, {STXT_SOFTKEY_OK_MK,TXT_NULL,STXT_RETURN},TXT_CANCEL_MARK_ALL,   0, 0, 0, MENU_NULL}
};
...
{
    {ID_SEARCH_TYPE_ALL,   TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_COMMON_ALL,0, 0, 0, NULL},
