...
#define MMITHEME_BUTTON_MARGIN_SPACE    1
#else
#define MMITHEME_BUTTON_MARGIN_SPACE    2
#endif
#define MMITHEME_BUTTON_CHAR_SPACE      0   //edit by hongjun.jia for NEWMS00177100
#define MMITHEME_BUTTON_IMAGE_TEXT_SPACE    3
#define MMITHEME_BUTTON_IMAGE_SPACE    6
