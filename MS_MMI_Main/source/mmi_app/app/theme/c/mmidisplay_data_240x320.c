...
#define MMI_IDLE_COMON_ITEM_FONT_H          36 //16
#define MMI_IDLE_COMMO_ITEM_FONT            MMI_DEFAULT_NORMAL_FONT //SONG_FONT_16
#define MMI_IDLE_TIME_X                     4
#define MMI_IDLE_TIME_Y                     27
#define MMI_IDLE_DATE_Y                     102 //26
#define MMI_IDLE_WEEK_Y                     98 //42
/**--------------------------------------------------------------------------*
 **                         STATIC DEFINITION                                *
 **--------------------------------------------------------------------------*/
...
{   
	//待机MAIN LCD运营商文字 	
	{MMI_IDLE_COMON_MAIN_LCD_X, 200,IDLE_ALIGN_X_CENTER, MMI_IDLE_COMMO_ITEM_FONT},

#ifndef MMI_MULTI_SIM_SYS_SINGLE
	//待机MAIN LCD SIM2 Service Providor Name 
	{MMI_IDLE_COMON_MAIN_LCD_X,200+MMI_IDLE_COMON_ITEM_FONT_H+MMI_IDLE_COMON_INTREVAL,
    IDLE_ALIGN_X_CENTER,MMI_IDLE_COMMO_ITEM_FONT},
...
//待机MAIN LCD MP3背景播放mp3 name
	...
	//待机MAIN LCD日期
	{0,MMI_IDLE_DATE_Y,IDLE_ALIGN_X_CENTER,MMI_IDLE_COMMO_ITEM_FONT},
	
    //待机MAIN LCD星期 
	{MMI_MAINSCREEN_RIGHT_MAX_PIXEL- 6,MMI_IDLE_WEEK_Y,IDLE_ALIGN_RIGHT,MMI_IDLE_COMMO_ITEM_FONT},
