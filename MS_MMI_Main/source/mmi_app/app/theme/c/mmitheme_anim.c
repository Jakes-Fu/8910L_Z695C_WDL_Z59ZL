...
#define MMITHEME_ANIM_ZOOM_MAX_WIDTH            240
#define MMITHEME_ANIM_ZOOM_MAX_HEIGHT           320
#else
                           ...
                           )
{
    ...
    //set zoom ratio
    theme_ptr->zoom_in_ratio.num1  = 5;
    theme_ptr->zoom_in_ratio.num2  = 4;
    theme_ptr->zoom_out_ratio.num1 = 4;
    theme_ptr->zoom_out_ratio.num2 = 5;
    ...
    theme_ptr->error_bg.bg_type = GUI_BG_NONE;//GUI_BG_IMG;
    theme_ptr->error_bg.img_id  = 0;//IMAGE_COMMON_PIC_ERROR;

    //set is clear anim control bg
    theme_ptr->is_clear_anim_bg = FALSE;
    
    theme_ptr->spinner_img_id     = ANIM_PUBWIN_WAIT;
    theme_ptr->spinner_bg.bg_type = GUI_BG_COLOR;
    theme_ptr->spinner_bg.color   = 0x02D4; // MAKE_BREW_RGB(0x02,0x59,0xA2);
