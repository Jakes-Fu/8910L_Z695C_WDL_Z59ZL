...
#define MMIPUB_WIN_MARGIN               10      // PUBWIN窗口离屏幕左边的距离，即背景图片左边的空白大小
#define MMIPUB_TITLE_START              6       // TITLE的起始位置，相对于有效的窗口区域
#define MMIPUB_TITLE_IMAGE_TEXT_SPACE   5       // TITLE中图片与文字的间距
#define MMIPUB_TITLE_V_MARGIN_TOP       12      // TITLE的垂直边距(离顶部)
#define MMIPUB_TITLE_V_MARGIN_BOTTOM    6       // TITLE的垂直边距(离底部)
#define MMIPUB_CLIENT_H_MARGIN          0       // 客户区的离PUBWIN窗口的距离
#define MMIPUB_CLIENT_V_MARGIN          8       // 客户区的垂直边距
#ifdef MAINLCD_SIZE_240X400
#define MMIPUB_H_ADD_MARGIN             ((400-240)/2)      // 横屏时左右留白
#else
#define MMIPUB_H_ADD_MARGIN             ((320-240)/2)      // 横屏时左右留白
#endif
#define MMIPUB_BUTTON_MARGIN            6       // BUTTON离客户区的边距
#define MMIPUB_BUTTON_BOTTOM_MARGIN     4      // BUTTON下边距
#define MMIPUB_BUTTON_SPACE             6       // BUTTON间距
#define MMIPUB_LINE_SPACE               4   // 文字行间距
...
#define MMIPUB_TITLE_START              5       // TITLE的起始位置，相对于有效的窗口区域
#define MMIPUB_TITLE_IMAGE_TEXT_SPACE   5       // TITLE中图片与文字的间距
#define MMIPUB_TITLE_V_MARGIN_TOP       3//10      // TITLE的垂直边距(离顶部)
#define MMIPUB_TITLE_V_MARGIN_BOTTOM    2       // TITLE的垂直边距(离底部)
#define MMIPUB_CLIENT_H_MARGIN          0       // 客户区的离PUBWIN窗口的距离
#define MMIPUB_CLIENT_V_MARGIN          1       // 客户区的垂直边距
#define MMIPUB_H_ADD_MARGIN             10      // 横屏时左右留白
#define MMIPUB_BUTTON_MARGIN            2// BUTTON离客户区的边距
#define MMIPUB_BUTTON_BOTTOM_MARGIN     5//10      // BUTTON下边距
#define MMIPUB_BUTTON_SPACE             5       // BUTTON间距
#define MMIPUB_LINE_SPACE               1//0       // 文字行间距
#else
                          ...
                          )
{
	...
	theme_ptr->extra_big_font       = MMI_PUBWIN_EXTRA_BIG_FONT;
	...
	if (MMIPUBWIN_WAITING == type)
	{
		theme_ptr->font_color          = MMI_BLACK_COLOR;
	}
	else
	{
    ...
    theme_ptr->dialog_bg_color = MMITHEME_GetAccentColorByOffset(MMITHEME_OFFSET_COLOR_NEG_1);
#else
    theme_ptr->dialog_bg_color = MMI_WHITE_COLOR;
#endif
}
                                ...
                                )
{
    ...
    layout_theme_ptr->button_big_font.color   = MMI_BLACK_COLOR;
    layout_theme_ptr->button_big_font.font    = MMI_DEFAULT_BUTTON_BIG_FONT;
