...
#define MMITHEME_FORM_HOR_SPACE     1
#define MMITHEME_FORM_VER_SPACE     1
                           ...
                           )
{
    ...
    theme_ptr->unit_font.color  = MMI_BLACK_COLOR;//MMITHEME_GetCurThemeFontColor(MMI_THEME_LIST_ITEM_SMALL_FONT);
    ...
    theme_ptr->form_active_child.bg.shape    = GUI_SHAPE_RECT;
