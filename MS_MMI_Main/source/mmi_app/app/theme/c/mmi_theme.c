...
{
    {GUI_RGB2RGB565(0xde, 0x94, 0xe0), GUI_RGB2RGB565(0xcc, 0x76, 0xca), GUI_RGB2RGB565(0xc2, 0x39, 0xb3), GUI_RGB2RGB565(0xb4, 0x00, 0x9e), GUI_RGB2RGB565(0x9a, 0x00, 0x89), GUI_RGB2RGB565(0x80, 0x00, 0x74), GUI_RGB2RGB565(0x5c, 0x00, 0x5c)},
    {GUI_RGB2RGB565(0xf5, 0xc1, 0xb2), GUI_RGB2RGB565(0xee, 0x99, 0x80), GUI_RGB2RGB565(0xe6, 0x68, 0x44), GUI_RGB2RGB565(0xe0, 0x42, 0x15), GUI_RGB2RGB565(0xbf, 0x38, 0x12), GUI_RGB2RGB565(0xa2, 0x30, 0x0f), GUI_RGB2RGB565(0x6e, 0x20, 0x0a)},
    {GUI_RGB2RGB565(0xff, 0xda, 0xbb), GUI_RGB2RGB565(0xff, 0xc9, 0x88), GUI_RGB2RGB565(0xff, 0xaa, 0x44), GUI_RGB2RGB565(0xff, 0x8c, 0x00), GUI_RGB2RGB565(0xd4, 0x73, 0x00), GUI_RGB2RGB565(0xb0, 0x5e, 0x0d), GUI_RGB2RGB565(0x7f, 0x42, 0x00)},
    {GUI_RGB2RGB565(0x93, 0xd7, 0x93), GUI_RGB2RGB565(0x68, 0xc8, 0x68), GUI_RGB2RGB565(0x36, 0xb4, 0x36), GUI_RGB2RGB565(0x0a, 0xa5, 0x0a), GUI_RGB2RGB565(0x0a, 0x7c, 0x07), GUI_RGB2RGB565(0x04, 0x57, 0x04), GUI_RGB2RGB565(0x00, 0x43, 0x04)},
    {GUI_RGB2RGB565(0xb5, 0xc5, 0xc2), GUI_RGB2RGB565(0x97, 0xaf, 0xa9), GUI_RGB2RGB565(0x74, 0x94, 0x8c), GUI_RGB2RGB565(0x56, 0x7c, 0x73), GUI_RGB2RGB565(0x40, 0x5d, 0x56), GUI_RGB2RGB565(0x2e, 0x42, 0x3c), GUI_RGB2RGB565(0x23, 0x32, 0x2f)},
    {GUI_RGB2RGB565(0x8f, 0xc6, 0xf1), GUI_RGB2RGB565(0x60, 0xb0, 0xf1), GUI_RGB2RGB565(0x2b, 0x90, 0xe2), GUI_RGB2RGB565(0x00, 0x00, 0xff), GUI_RGB2RGB565(0x02, 0x59, 0xa2), GUI_RGB2RGB565(0x00, 0x3d, 0x6f), GUI_RGB2RGB565(0x00, 0x2f, 0x56)},
};
 ...
 **--------------------------------------------------------------------------*/
/*****************************************************************************/
// 	Description : Init Accent Id
//	Global resource dependence : 
//  Author: 
//	Note:
/*****************************************************************************/
PUBLIC void MMITHEME_InitAccentId(void)
{
#if MMI_COMPILE_E
    MN_RETURN_RESULT_E  return_value = MN_RETURN_FAILURE;
#ifndef WIN32
    uint8 predefined_theme_accent_id = MMITHEME_ACCENT_COLOR_DEFAULT;
#endif
   
    MMINV_READ(MMI_NV_THEME_ACCENT_ID, &s_theme_accent_id, return_value);
	
    if(MN_RETURN_SUCCESS !=return_value)
    {
#ifndef WIN32
        EFS_NvitemRead(APP_NV_DEFAULT_THEME_COLOR, sizeof(uint8), &predefined_theme_accent_id);
        s_theme_accent_id = predefined_theme_accent_id;
#else
        s_theme_accent_id = MMITHEME_ACCENT_COLOR_DEFAULT;
#endif
        MMINV_WRITE(MMI_NV_THEME_ACCENT_ID, &s_theme_accent_id);
    }
#else
    s_theme_accent_id = MMITHEME_ACCENT_COLOR_DEFAULT;
#endif
...
/*****************************************************************************/
// 	Description : Set Accent Id
//	Global resource dependence : 
//  Author: 
//	Note:
/*****************************************************************************/
PUBLIC BOOLEAN MMITHEME_SetAccentId(
                                    MMITHEME_ACCENT_COLOR_E accent_id
                                    )
{
    BOOLEAN result = FALSE;
	
    if(accent_id < MMITHEME_ACCENT_COLOR_MAX)
    {
        s_theme_accent_id = accent_id;
		MMINV_WRITE(MMI_NV_THEME_ACCENT_ID, &s_theme_accent_id);
		result = TRUE;
    }
...
/*****************************************************************************/
// 	Description : Get Accent Id
//	Global resource dependence : 
//  Author: 
//	Note:
/*****************************************************************************/
PUBLIC MMITHEME_ACCENT_COLOR_E MMITHEME_GetAccentId(void)
{
    return s_theme_accent_id;
}
/*****************************************************************************/
// 	Description : Get Accent Color By Offset
//	Global resource dependence : 
//  Author: 
//	Note:
/*****************************************************************************/
PUBLIC GUI_COLOR_T MMITHEME_GetAccentColor(
                                                   MMITHEME_ACCENT_COLOR_E accent_id,
...
{
    MMITHEME_ACCENT_COLOR_E accent_id = MMITHEME_ACCENT_COLOR_BLUE;//s_theme_accent_id;
...
/*****************************************************************************/
// 	Description : Set Accent Color By Offset
//	Global resource dependence : 
//  Author: 
//	Note:
/*****************************************************************************/
PUBLIC void MMITHEME_SetAccentColorByOffset(
                                            MMITHEME_OFFSET_COLOR_E offset_id,
                                            GUI_COLOR_T color
                                            )
{
    MMITHEME_ACCENT_COLOR_E accent_id = s_theme_accent_id;
    s_theme_accent_color_array[accent_id][offset_id] = color;
}

/*****************************************************************************/
// 	Description : Get Blue Color
//	Global resource dependence :
//	Author: wen.dong
//	Note:
/*****************************************************************************/
PUBLIC GUI_COLOR_T MMITHEME_GetBlueColor(void)
{
    return s_theme_accent_color_array[MMITHEME_ACCENT_COLOR_BLUE][MMITHEME_OFFSET_COLOR_DEFAULT];
}
...
#endif
        //deal with Greek language
        if(MMISMS_IsGSMByteChar(ch) && (MMISMS_ALPHABET_MANAGEMENT_GSM_ALPHABET == MMISMS_GetAlphabetManagement()))
        {
            result = FALSE;
        }
    }
...
//	Global resource dependence : 
//  Author:
//	Note: Microsoft project need to support
/*****************************************************************************/
PUBLIC GUI_BG_T MMITHEME_GetCommonBgExt(void)
{
    GUI_BG_T    bg_info = {0};
