...
//@for light function modify
    ...
    theme_ptr->mark_text_id   = STXT_SOFTKEY_MARK_MK;
    theme_ptr->cancel_text_id = STXT_CANCEL;

    //set image id
    theme_ptr->mark_img_id = IMAGE_CHECK_SELECTED_ICON;
//	theme_ptr->iconlist_mask_img_id = IMAGE_GRID_MULTISELECTOR_BLUE;
	theme_ptr->iconlist_mask_img_id = IMAGE_PRMIO_GRID_MULTISELECTOR;
