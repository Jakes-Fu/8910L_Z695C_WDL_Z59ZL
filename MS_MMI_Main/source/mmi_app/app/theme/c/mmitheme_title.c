...
//#endif
    ...
    title_style_ptr->bg_color     = MMI_WHITE_COLOR;//GUI_RGB2RGB565(0x19,0x19,0x19); //MMI_BLACK_COLOR;
...
//fixed by hongjun.jia.176X220ºÍ128X160ÕâÁ½ÖÖ·Ö±æÂÊÏÂ£¬title¿¿×óÏÔÊ¾
    ...
    title_style_ptr->align_type = ALIGN_HVMIDDLE;
#else
	title_style_ptr->align_type = ALIGN_HMIDDLE;
#endif
    title_style_ptr->title_text_margin = MMI_TITLE_TEXT_L_MARGIN;
#ifdef MAINLCD_SIZE_240X320
    title_style_ptr->sub_font       = MMI_TITLE_TEXT_FONT;
#else
    title_style_ptr->sub_font       = SONG_FONT_14;//SONG_FONT_12;
#endif
#endif
...
PUBLIC MMI_IMAGE_ID_T MMITHEME_GetWinTitleBar(void)
{
    ...
    {
     ///   return IMAGE_NULL;
         return IMAGE_TITLE_BAR;   ////ZDT_PRODUCT_Z685S fangsm
    }
}
