...
//richtext
#define RICHTEXT_BORDER_SPACE               5
#define RICHTEXT_IMG_TXT_SPACE              7
...
#else
#define RICHTEXT_ITEM_SPACE                 7
#define RICHTEXT_TEXT_LINE_SPACE            4
#endif
#define RICHTEXT_TEXT_CHAR_SPACE            0
#define RICHETXT_TEXT_MARGIN                2
...
//@for light function modify
    ...
    richtext_style_ptr->text_line_space = 1;
