    ...
    )
{
    ...
    theme_ptr->bg.color = MMITHEME_GetCurThemeFontColor(MMI_THEME_PUBWIN_BG);
    ...
    theme_ptr->mask_bg.color = 0xFAC0;    // 暂时用固定颜色，到时通过配置走//MMITHEME_GetCurThemeFontColor(MMI_THEME_SELECT);
