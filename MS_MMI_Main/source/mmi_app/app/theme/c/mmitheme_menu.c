...
#define MMITHEME_POPUPMENU_BORDER_WIDTH         5
#else
#define MMITHEME_POPUPMENU_BORDER_WIDTH         2
#endif

#define MMITHEME_POPUPMENU_MIN_LEFT             10

#define MMITHEME_POPUPMENU_TEXT_LINE_HEIGHT     26

// OPTIONS MENU
#define MMITHEME_OPTIONSMENU_BORDER_WIDTH       2
...
//boda,
#define MMIMENU_POPUP_ITEM_MAX_NUM          6 //最多显示的菜单项，显示不下则显示滚动条
#define CTRLMENU_TOGGLE_TEXT_WIDTH    85          // Toggle text rect's width
#define CTRLMENU_RADIO_TEXT_WIDTH    102          // Radio text rect's width
...
#define MMITHEME_SECMENU_GAP_WIDTH          6
...
#define MMIMENU_POPUP_ITEM_MAX_NUM          6 //最多显示的菜单项，显示不下则显示滚动条
#define CTRLMENU_TOGGLE_TEXT_WIDTH    190          // Toggle text rect's width
#define CTRLMENU_RADIO_TEXT_WIDTH    204          // Radio text rect's width
...
#define MMIMENU_POPUP_ITEM_HEIGHT           MMIMENU_SELECTED_BAR_HEIGHT //popup menu height
#else
#define MMIMENU_POPUP_ITEM_HEIGHT           50 //popup menu height
#endif
...
#define MMITHEME_POPUP_GRAY_MASK_ALPHA      166 //gray状态菜单项蒙版透明度65%
...
LOCAL const MMI_IMAGE_ID_T LIST_TOGGLE_ON_FOCUS_IMG [MMITHEME_ACCENT_COLOR_MAX] =
{
    IMAGE_TOGGLE_ON_VIOLET_MINUS_3,
    IMAGE_TOGGLE_ON_RED_MINUS_3,
    IMAGE_TOGGLE_ON_YELLOW_MINUS_3,
    IMAGE_TOGGLE_ON_GREEN_MINUS_3,
    IMAGE_TOGGLE_ON_COPPER_MINUS_3,
    IMAGE_TOGGLE_ON_BLUE_MINUS_3,
};

LOCAL const MMI_IMAGE_ID_T LIST_TOGGLE_ON_NORMAL_IMG [MMITHEME_ACCENT_COLOR_MAX] =
{
    IMAGE_TOGGLE_ON_VIOLET,
    IMAGE_TOGGLE_ON_RED,
    IMAGE_TOGGLE_ON_YELLOW,
    IMAGE_TOGGLE_ON_GREEN,
    IMAGE_TOGGLE_ON_COPPER,
    IMAGE_TOGGLE_ON_BLUE,
};

LOCAL const MMI_IMAGE_ID_T LIST_TOGGLE_OFF_FOCUS_IMG [MMITHEME_ACCENT_COLOR_MAX] =
{
    IMAGE_TOGGLE_OFF_VIOLET_MINUS_3,
    IMAGE_TOGGLE_OFF_RED_MINUS_3,
    IMAGE_TOGGLE_OFF_YELLOW_MINUS_3,
    IMAGE_TOGGLE_OFF_GREEN_MINUS_3,
    IMAGE_TOGGLE_OFF_COPPER_MINUS_3,
    IMAGE_TOGGLE_OFF_BLUE_MINUS_3,
};

LOCAL const MMI_IMAGE_ID_T LIST_TOGGLE_OFF_NORMAL_IMG [MMITHEME_ACCENT_COLOR_MAX] =
{
    IMAGE_TOGGLE_OFF_VIOLET,
    IMAGE_TOGGLE_OFF_RED,
    IMAGE_TOGGLE_OFF_YELLOW,
    IMAGE_TOGGLE_OFF_GREEN,
    IMAGE_TOGGLE_OFF_COPPER,
    IMAGE_TOGGLE_OFF_BLUE,
};
                                 ...
                                 )
{
    ...
    theme_ptr->item_font = SONG_FONT_40;
    theme_ptr->cur_item_font = SONG_FONT_40;
                              ...
                              )
{
...
#endif
    theme_ptr->radio_sel_img   = IMAGE_RADIOBUTTON_ON;
    theme_ptr->radio_unsel_img = IMAGE_RADIOBUTTON_OFF;    
    theme_ptr->check_sel_img   = IMAGE_CHECKBOX_ON;  
    theme_ptr->check_unsel_img = IMAGE_CHECKBOX_OFF;
    ...
    theme_ptr->right_gray_img  = IMAGE_COMMON_POP_MENU_RIGHT_GRAY;

    theme_ptr->is_centered     = FALSE;
    theme_ptr->item_max_num    = MMIMENU_POPUP_ITEM_MAX_NUM;
    theme_ptr->gray_mask_alpha = MMITHEME_POPUP_GRAY_MASK_ALPHA;
    theme_ptr->accent_color    = MMITHEME_GetAccentColorByOffset(MMITHEME_OFFSET_COLOR_DEFAULT);
    theme_ptr->focus_color     = MMITHEME_GetAccentColorByOffset(MMITHEME_OFFSET_COLOR_NEG_3);
    
    theme_ptr->toggle_on_focus_img[MMITHEME_ACCENT_COLOR_VIOLENT] = IMAGE_TOGGLE_ON_VIOLET_MINUS_3;
    theme_ptr->toggle_on_focus_img[MMITHEME_ACCENT_COLOR_RED] = IMAGE_TOGGLE_ON_RED_MINUS_3;
    theme_ptr->toggle_on_focus_img[MMITHEME_ACCENT_COLOR_YELLOW] = IMAGE_TOGGLE_ON_YELLOW_MINUS_3;
    theme_ptr->toggle_on_focus_img[MMITHEME_ACCENT_COLOR_GREEN] = IMAGE_TOGGLE_ON_GREEN_MINUS_3;
    theme_ptr->toggle_on_focus_img[MMITHEME_ACCENT_COLOR_COPPER] = IMAGE_TOGGLE_ON_COPPER_MINUS_3;
    theme_ptr->toggle_on_focus_img[MMITHEME_ACCENT_COLOR_BLUE] = IMAGE_TOGGLE_ON_BLUE_MINUS_3;

    theme_ptr->toggle_on_normal_img[MMITHEME_ACCENT_COLOR_VIOLENT] = IMAGE_TOGGLE_ON_VIOLET;
    theme_ptr->toggle_on_normal_img[MMITHEME_ACCENT_COLOR_RED] = IMAGE_TOGGLE_ON_RED;
    theme_ptr->toggle_on_normal_img[MMITHEME_ACCENT_COLOR_YELLOW] = IMAGE_TOGGLE_ON_YELLOW;
    theme_ptr->toggle_on_normal_img[MMITHEME_ACCENT_COLOR_GREEN] = IMAGE_TOGGLE_ON_GREEN;
    theme_ptr->toggle_on_normal_img[MMITHEME_ACCENT_COLOR_COPPER] = IMAGE_TOGGLE_ON_COPPER;
    theme_ptr->toggle_on_normal_img[MMITHEME_ACCENT_COLOR_BLUE] = IMAGE_TOGGLE_ON_BLUE;

    theme_ptr->toggle_off_focus_img[MMITHEME_ACCENT_COLOR_VIOLENT] = IMAGE_TOGGLE_OFF_VIOLET_MINUS_3;
    theme_ptr->toggle_off_focus_img[MMITHEME_ACCENT_COLOR_RED] = IMAGE_TOGGLE_OFF_RED_MINUS_3;
    theme_ptr->toggle_off_focus_img[MMITHEME_ACCENT_COLOR_YELLOW] = IMAGE_TOGGLE_OFF_YELLOW_MINUS_3;
    theme_ptr->toggle_off_focus_img[MMITHEME_ACCENT_COLOR_GREEN] = IMAGE_TOGGLE_OFF_GREEN_MINUS_3;
    theme_ptr->toggle_off_focus_img[MMITHEME_ACCENT_COLOR_COPPER] = IMAGE_TOGGLE_OFF_COPPER_MINUS_3;
    theme_ptr->toggle_off_focus_img[MMITHEME_ACCENT_COLOR_BLUE] = IMAGE_TOGGLE_OFF_BLUE_MINUS_3;

    theme_ptr->toggle_off_normal_img[MMITHEME_ACCENT_COLOR_VIOLENT] = IMAGE_TOGGLE_OFF_VIOLET;
    theme_ptr->toggle_off_normal_img[MMITHEME_ACCENT_COLOR_RED] = IMAGE_TOGGLE_OFF_RED;
    theme_ptr->toggle_off_normal_img[MMITHEME_ACCENT_COLOR_YELLOW] = IMAGE_TOGGLE_OFF_YELLOW;
    theme_ptr->toggle_off_normal_img[MMITHEME_ACCENT_COLOR_GREEN] = IMAGE_TOGGLE_OFF_GREEN;
    theme_ptr->toggle_off_normal_img[MMITHEME_ACCENT_COLOR_COPPER] = IMAGE_TOGGLE_OFF_COPPER;
    theme_ptr->toggle_off_normal_img[MMITHEME_ACCENT_COLOR_BLUE] = IMAGE_TOGGLE_OFF_BLUE;       
   
    theme_ptr->toggle_text_width = CTRLMENU_TOGGLE_TEXT_WIDTH;
    theme_ptr->radio_text_width = CTRLMENU_RADIO_TEXT_WIDTH;

    theme_ptr->sk_type[LEFT_BUTTON] = GUISK_DATA_TEXT_ID;
    theme_ptr->sk_id[LEFT_BUTTON] = TXT_NULL;

    theme_ptr->sk_type[MIDDLE_BUTTON] = GUISK_DATA_TEXT_ID;
    theme_ptr->sk_id[MIDDLE_BUTTON] = STXT_SOFTKEY_SELECT_MK;

    theme_ptr->sk_type[RIGHT_BUTTON] = GUISK_DATA_TEXT_ID;
    theme_ptr->sk_id[RIGHT_BUTTON] = TXT_COMMON_COMMON_BACK;

    theme_ptr->toggle_msk_id = STXT_SOFTKEY_CHANGE;

    theme_ptr->text_line_height = MMITHEME_POPUPMENU_TEXT_LINE_HEIGHT;
...
/*****************************************************************************/
//  Description : get toggle icon
//  Global resource dependence : 
//  Author: Cheney.Wu
//  Note:
/*****************************************************************************/
MMI_IMAGE_ID_T MMITHEME_GetThemeToggleIcon(BOOLEAN is_selected, BOOLEAN is_focused)
{
    MMITHEME_ACCENT_COLOR_E     accent_id = MMITHEME_ACCENT_COLOR_MAX;
    accent_id = MMITHEME_GetAccentId();

    if(TRUE == is_focused)
    {
        if(TRUE == is_selected)
        {
            return LIST_TOGGLE_ON_FOCUS_IMG[accent_id];
        }
        else
        {
            return LIST_TOGGLE_OFF_FOCUS_IMG[accent_id];
        }
    }
    else
    {
        if(TRUE == is_selected)
        {
            return LIST_TOGGLE_ON_NORMAL_IMG[accent_id];
        }
        else
        {
            return LIST_TOGGLE_OFF_NORMAL_IMG[accent_id];
        }
    }
