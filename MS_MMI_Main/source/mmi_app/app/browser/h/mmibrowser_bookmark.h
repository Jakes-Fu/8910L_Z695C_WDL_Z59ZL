...
#define MMIBROWSER_BOOKMARK_NDT_MAXNUM   10
#else
#define MMIBROWSER_BOOKMARK_NDT_MAXNUM   0
#endif

#ifdef MMIDORADO_BOOKMARK_BY_NV
#if defined(LOW_MEMORY_SUPPORT)  || !defined(NANDBOOT_SUPPORT)
#ifdef LOW_MEMORY_SUPPORT_32X16
#define MMIBRW_BOOKMARK_MAX_ITEM			(5+MMIBROWSER_BOOKMARK_NDT_MAXNUM)
#else
#define MMIBRW_BOOKMARK_MAX_ITEM			(20+MMIBROWSER_BOOKMARK_NDT_MAXNUM)
#endif
#else
#define MMIBRW_BOOKMARK_MAX_ITEM			(50+MMIBROWSER_BOOKMARK_NDT_MAXNUM)
#endif
...
PUBLIC BOOLEAN MMIBROWSER_CanAddNewBookmark(uint16 count);
