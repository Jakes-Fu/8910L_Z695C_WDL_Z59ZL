...
#define BRW_DEFAULT_HTTP_ACCEPT_CHARSET "UTF-8,ISO-8859-1,US-ASCII,windows-1252,windows-1251"
...
//#ifdef IM_PORTUGUESE_SUPPORT
    ...
    ,{MMISET_LANGUAGE_PORTUGUESE_BR, "pt"}
...
//#ifdef IM_SPANISH_SUPPORT
    ...
    ,{MMISET_LANGUAGE_SPANISH_AM, "es"}
    ,{MMISET_LANGUAGE_SERBIAN, "rs"}
    ,{MMISET_LANGUAGE_SWAHILI, "ke"}
//#endif
...
PUBLIC BOOLEAN BrwInitHttpSession(BRW_INFO_T* brw_info_ptr)
{
    ...
    if (BRW_PROTOCOL_HTTP == profile_ptr->protocol)
    {
		...
		BRWDebug_Printf("[cookie]BrwInitHttpSession,is_cookie_enable=%d",profile_ptr->is_cookie_enable);
        ...
        // Delete by zhigang.peng 2018/09/20 , does not define the field time_zone
   ...
   else if (BRW_PROTOCOL_WAP == profile_ptr->protocol)
   {
		...
		BRWDebug_Printf("[cookie]BrwInitHttpSession,wsp_init_param.is_cookie_enable=%d",profile_ptr->is_cookie_enable);
