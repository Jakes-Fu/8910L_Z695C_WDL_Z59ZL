...
//  Description : 
//  Author: sam.Hua
//InitNdtBookmarkSettings	Init ndt count
//SetNDTBookmarkDisable   disable all ndt bookmarks in marking operation
//SetNDTBookmarkEnable    enable all ndt bookmarks in marking operation
//IsNDTBookmark			check current item is ndt or not
//  Note: 
/*****************************************************************************/
#ifdef MULIT_VARIANT_SUPPORT
LOCAL uint16 cur_ndt_num;
#endif
LOCAL void InitNdtBookmarkSettings(void);
LOCAL BOOLEAN IsNDTBookmark(uint16 array_index);
LOCAL void SetNDTBookmarkDisable(MMI_CTRL_ID_T    list_ctrl_id);
LOCAL void SetNDTBookmarkEnable(MMI_CTRL_ID_T    list_ctrl_id);
/**--------------------------------------------------------------------------*
 **                         GLOBAL DEFINITION                                *
 **--------------------------------------------------------------------------*/
...
//  Note: 
/*****************************************************************************/
LOCAL void BrwSetBookmarkEditWindow(MMI_HANDLE_T win_handle, MMIBRW_BM_CHANGE_TYPE_E change_type);
...
WINDOW_TABLE(MMIBROWSER_BOOKMARK_EDIT_WIN_TAB) = 
{
    ...
    CREATE_FORM_CTRL(GUIFORM_LAYOUT_ORDER,MMIBROWSER_BOOKMARK_EDIT_CTRL_ID),
            CHILD_EDIT_TEXT_CTRL(TRUE, MMIBRW_BOOKMARK_MAX_TITLE_LENGTH,MMIBROWSER_BOOKMARK_EDIT_TITLE_CTRL_ID, MMIBROWSER_BOOKMARK_EDIT_CTRL_ID),
            CHILD_EDIT_TEXT_CTRL(TRUE, MMIBROWSER_MAX_URL_LEN,MMIBROWSER_BOOKMARK_EDIT_URL_CTRL_ID, MMIBROWSER_BOOKMARK_EDIT_CTRL_ID),
...
#ifdef MMI_PDA_SUPPORT
    CHILD_SOFTKEY_CTRL(STXT_SOFTKEY_SAVE_MK, TXT_NULL, STXT_RETURN,MMICOMMON_SOFTKEY_CTRL_ID,MMIBROWSER_BOOKMARK_EDIT_CTRL_ID),
#endif
...
WINDOW_TABLE( MMIBROWSER_BOOKMARK_POPMENU_WIN_TAB ) = 
{
    ...
    WIN_SOFTKEY(TXT_NULL,STXT_SOFTKEY_OK_MK,TXT_COMMON_COMMON_BACK),
    END_WIN
};
...
WINDOW_TABLE(BRW_BOOKMARK_DETAIL_WIN_TAB) = 
{
    ...
    WIN_SOFTKEY(STXT_OPTION, TXT_COMM_OPEN, TXT_COMMON_COMMON_BACK),
...
PUBLIC void MMIBROWSER_OpenBookmarkWin(void)
{
    ...
    {
        MMIPUB_OpenAlertWinByTextId(&waiting_time_out, STR_NOTE_WAITING, TXT_NULL,
    ...
    {
        BrwOpenAlertWinByTextId(PNULL,TXT_NO_SD_CARD_ALERT, PNULL, IMAGE_PUBWIN_WARNING, PNULL, MMIPUB_SOFTKEY_ONE, PNULL);
                                           ...
                                           )
{
    ...
    case MSG_CTL_LIST_NEED_ITEM_DATA:
    {
        ...
        {                
            ...
            text1_id = STXT_SOFTKEY_SELECT_MK;
            text2_id = TXT_NULL;
...
PUBLIC void MMIBROWSER_BookmarkSetOptMenu(MMI_WIN_ID_T win_id, MMI_CTRL_ID_T ctrl_id,MMI_CTRL_ID_T list_ctrl_id)
{
...
#ifdef MULIT_VARIANT_SUPPORT
    //ndt bookmark,should be disable
    if (IsNDTBookmark(cur_index) &&(0 == mark_num))
    {
        GUIMENU_SetItemGrayed(ctrl_id,group_id,ID_POPUP_MENU_BOOKMARK_EDIT,TRUE);
        GUIMENU_SetItemGrayed(ctrl_id,group_id,ID_POPUP_MENU_BOOKMARK_DELETE,TRUE);
        GUIMENU_SetItemGrayed(ctrl_id,group_id,ID_POPUP_MENU_BOOKMARK_MARK,TRUE);
    ...
    //If reach custom bookmark max num,
    GUIMENU_SetItemGrayed(ctrl_id,group_id,ID_POPUP_MENU_BOOKMARK_ADD,
    		!MMIBROWSER_CanAddNewBookmark(cur_total_num));
#endif
    ...
    GUIMENU_SetPopMenuSoftkeyType( ctrl_id  ,GUILIST_SK_TYPE_IMAGE_ID,GUILIST_SK_TYPE_TEXT_ID,GUILIST_SK_TYPE_IMAGE_ID);
#endif
}
                                   ...
                                   )
{
    ...
    case MSG_OPEN_WINDOW:
    {
        ...
        MMI_CTRL_ID_T   current_ctrl_id = MMIBROWSER_BOOKMARK_EDIT_CTRL_ID;
        GUIFORM_PermitChildFont(current_ctrl_id,FALSE);

        // GUIFORM_IsSlide(MMIBROWSER_BK_EDIT_FORM2_CTRL_ID, FALSE);
        ...
        BrwSetBookmarkEditWindow(win_id, change_type);
        GUIEDIT_SetStyle(MMIBROWSER_BOOKMARK_EDIT_TITLE_CTRL_ID,GUIEDIT_STYLE_MULTI_DYN_DOWN);
        GUIEDIT_SetStyle(MMIBROWSER_BOOKMARK_EDIT_URL_CTRL_ID,GUIEDIT_STYLE_MULTI_DYN_DOWN);
...
//    case MSG_APP_WEB:
//    case MSG_CTL_MIDSK:       //Disable OK key
#ifndef MMI_PDA_SUPPORT
#ifdef TOUCH_PANEL_SUPPORT //IGNORE9527
    case MSG_CTL_PENOK: 
#endif //TOUCH_PANEL_SUPPORT //IGNORE9527    
    ...
    case MSG_APP_OK:
        //BrowserHanldeSaveInEditWin(win_id, change_type);
        {
...
#else
            {
                ...
                {
                    BrwOpenAlertWinByTextId(PNULL,STR_URL_SAVE_EMPTY,TXT_NULL,IMAGE_PUBWIN_WARNING,PNULL,MMIPUB_SOFTKEY_ONE,PNULL);
                    break;
                }
                else
                {
...
LOCAL void BrwSetBookmarkEditWindow(MMI_HANDLE_T win_handle, MMIBRW_BM_CHANGE_TYPE_E change_type)
{
    ...
    if ((MMIBRW_BM_CHANGE_ADD_DIR == change_type) ||(MMIBRW_BM_CHANGE_EDIT_DIR == change_type))//folder 
    {
        ...
        CTRLBASEEDIT_SetLabelId(win_handle,edit_title_ctrl_id,TXT_COMMON_NAME,FALSE);
        GUIFORM_SetChildDisplay(MMIBROWSER_BOOKMARK_EDIT_CTRL_ID,MMIBROWSER_BOOKMARK_EDIT_URL_CTRL_ID,GUIFORM_CHILD_DISP_HIDE);
...
#endif        
    {
        ...
        CTRLBASEEDIT_SetLabelId(win_handle,edit_title_ctrl_id,STR_BROWSER_BOOKMARK,FALSE);
        CTRLBASEEDIT_SetLabelId(win_handle,edit_url_ctrl_id,TXT_URL_ADRESS,FALSE);
#ifndef MMIDORADO_BOOKMARK_BY_NV
...
//        GUIWIN_SeSoftkeytButtonIconId(win_id, IMAGE_COMMON_BACK, RIGHT_BUTTON, FALSE);
...
#endif            
            {
                MMI_GetLabelTextByLang(STR_BROWSER_DELETE_BOOKMARK, &dst_temp1);
            }
                               ...
                               )
{
    ...
    SetNDTBookmarkDisable(list_ctrl_id);
...
LOCAL void BrwSetBookmarkDetailWindow(MMI_CTRL_ID_T ctrl_id,uint16 list_index)
{
    ...
    item_data.text_data.res.id = TXT_BROWSER_TITLE;
...
#endif       
	    if (IsNDTBookmark(array_index))	//ndt bookmark couldn't be edit
		{
			GUIMENU_SetItemGrayed(ctrl_id, group_id, ID_POPUP_MENU_BOOKMARK_EDIT, TRUE);
		}
        MMK_SetAtvCtrl(win_id, ctrl_id);						
...
PUBLIC void MMIBRW_ChangeBookmarkWin(MMIBRW_BM_CHANGE_TYPE_E change_type)
{
    ...
    {
        BrwOpenAlertWinByTextId(PNULL, TXT_NO_SD_CARD_ALERT, TXT_NULL, IMAGE_PUBWIN_WARNING,  PNULL, MMIPUB_SOFTKEY_ONE, PNULL);
        MMIBROWSER_SetBookmarkLoaded(FALSE);//set bookmark is not loaded
        return;
    }
    //限制目录数量
...
#endif                
                STR_BROWSER_SEND_LINK, 
#ifdef SNS_SUPPORT
                TXT_SHARE_TO_SNS,
#endif
#ifndef CMCC_UI_STYLE
                STR_BROWSER_SAVE_HOMEPAGE,
#endif
#ifdef MMIDORADO_MY_NAV_SUPPORT
...
LOCAL void InitNdtBookmarkSettings(void)
{
	cur_ndt_num = MMIBROWSER_GetNDTBookmarkCount();
	return;
}
LOCAL BOOLEAN IsNDTBookmark(uint16 array_index)
{
	if (array_index <cur_ndt_num)
		return TRUE;
	return FALSE;
}
LOCAL void SetNDTBookmarkDisable(MMI_CTRL_ID_T    list_ctrl_id)
{
	uint16 i = 0;
	for (i=0;i<cur_ndt_num;i++)
		{
		    CTRLLIST_SetItemGray(list_ctrl_id,i,TRUE);
		}
	return;
}
LOCAL void SetNDTBookmarkEnable(MMI_CTRL_ID_T    list_ctrl_id)
{
	...
	for (i=0;i<cur_ndt_num;i++)
		{
		    CTRLLIST_SetItemGray(list_ctrl_id,i,FALSE);
		}
	return;
}
...
LOCAL void SetNDTBookmark_(MMI_CTRL_ID_T    list_ctrl_id)
{
	return;
}
LOCAL void SetNDTBookmarkDisable(MMI_CTRL_ID_T    list_ctrl_id)
