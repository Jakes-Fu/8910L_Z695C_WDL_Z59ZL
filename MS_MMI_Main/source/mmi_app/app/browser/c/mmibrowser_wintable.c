...
const uint32 s_menu_brw_popupmenu_table[][MMIBROWSER_POP_MENU_ITEM_DIMEN] = 
{
...
#endif
    {ID_POPUP_MENU_HAS_SAVE_FILE,STR_BROWSER_OFFLINE_PAGE, 0},
#ifdef DYNAMIC_MAINMENU_SUPPORT
    {ID_POPUP_MENU_ADD_TO_MAINMENU,TXT_BROWSER_ADD_TO_MAINMENU, 0},
#endif    
    {ID_POPUP_MENU_SAVE,STXT_SOFTKEY_SAVE_MK, 0},
#ifdef SNS_SUPPORT
...
#endif    
#endif    
    {ID_POPUP_MENU_SUB_FILEINFO,STR_BROWSER_PROPERTY, 0},
    {ID_POPUP_MENU_SEND_URL,STR_BROWSER_SEND_LINK, 0},
    ...
    {ID_POPUP_MENU_NAV,STR_BROWSER_PILOT},
#ifdef DYNAMIC_MAINMENU_SUPPORT
//    {ID_POPUP_MENU_ADD_TO_MAINMENU,TXT_BROWSER_ADD_TO_MAINMENU},
#endif
    {ID_POPUP_MENU_SAVE,STXT_SOFTKEY_SAVE_MK},
#ifdef DL_SUPPORT
    ...
    {ID_POPUP_MENU_SEND_URL,STR_BROWSER_SEND_LINK},
    {ID_POPUP_MENU_SUB_FILEINFO,STR_BROWSER_PROPERTY},
...
const uint32 s_menu_brw_open_popupmenu_table[][MMIBROWSER_POP_MENU_ITEM_DIMEN] = 
{
    ...
    {ID_POPUP_MENU_INPUTADD,TXT_WWW_INPUT_URL, IMAGE_NULL},
#ifdef BROWSER_SEARCH_SUPPORT
    ...
    {ID_POPUP_MENU_HAS_SAVE_FILE,STR_BROWSER_OFFLINE_PAGE, IMAGE_NULL},
#else
    {ID_POPUP_MENU_OPEN_HOMEPAGE,TXT_COMMON_HOMEPAGE},
    {ID_POPUP_MENU_INPUTADD,TXT_WWW_INPUT_URL},
#ifdef BROWSER_SEARCH_SUPPORT
    {ID_POPUP_MENU_SEARCH,STXT_SEARCH},
#endif
    {ID_POPUP_MENU_BOOKMARK_LIST,TXT_COMMON_BOOKMARKS},
    {ID_POPUP_MENU_HISTORY,TXT_BROWSER_HISTORY},
    {ID_POPUP_MENU_HAS_SAVE_FILE,STR_BROWSER_OFFLINE_PAGE},
#endif
};
...
const uint32 s_menu_brw_save_popupmenu_table[][MMIBROWSER_POP_MENU_ITEM_DIMEN] = 
{
    ...
    {ID_POPUP_MENU_SET_MAIN,STR_BROWSER_SAVE_HOMEPAGE, IMAGE_NULL},
#endif
    {ID_POPUP_MENU_SAVE_INTERNET_FILE,STR_BROWSER_SAVE, IMAGE_NULL},
    {ID_POPUP_MENU_SAVE_IMG, TXT_COMMON_PIC, IMAGE_NULL},
#else
#ifndef CMCC_UI_STYLE
    {ID_POPUP_MENU_SET_MAIN,STR_BROWSER_AS_HOMEPAGE},
#endif
...
WINDOW_TABLE(MMIBROWSER_MAIN_WIN_TAB) = 
{
    ...
    WIN_TITLE(STR_ILIST_INTERNET_EXT01),
...
// #ifndef MMI_BROWSER_MINI_SUPPORT
    ...
    WIN_STATUSBAR,
        ...
        WIN_SOFTKEY(STXT_OPTION, STXT_SOFTKEY_SELECT_MK, TXT_COMMON_CLOSE),
#endif
    //address bar
...
WINDOW_TABLE(MMIBROWSER_INPUT_URL_WIN_TAB) = 
{
    WIN_TITLE(TXT_WWW_INPUT_URL),
    WIN_FUNC((uint32)BrwHandleEditUrlWinMsg),    
    WIN_ID(MMIBROWSER_ADDRESS_WIN_ID),
    WIN_SOFTKEY(STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_SOFTKEY_CANCEL_MK),
...
{
    WIN_TITLE(STR_BROWSER_AUTHENTICATION),
    ...
    WIN_SOFTKEY(STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN),
#else
    WIN_SOFTKEY(STXT_SOFTKEY_OK_MK, STR_BROWSER_SOFTKEY_CHANGE, STXT_RETURN),
#endif /* MMI_PDA_SUPPORT */
...
{
    WIN_TITLE(STR_BROWSER_PROPERTY),
...
{ 
    ...
    WIN_TITLE(STR_BROWSER_DOWNLOAD_FILE),
...
#ifdef MMI_PDA_SUPPORT
        CHILD_SOFTKEY_CTRL(STXT_SOFTKEY_SAVE_MK, TXT_NULL, STXT_RETURN,MMICOMMON_SOFTKEY_CTRL_ID,MMIBROWSER_MY_NAV_EDIT_CTRL_ID),
#endif
...
#ifdef MMI_PDA_SUPPORT
    CHILD_SOFTKEY_CTRL(STXT_SOFTKEY_SAVE_MK, TXT_NULL, STXT_RETURN,MMICOMMON_SOFTKEY_CTRL_ID,MMIBROWSER_ADD2MAIN_EDIT_CTRL_ID),
#endif
...
LOCAL BOOLEAN HandleControlDisplayReadyInd(void *param)
{
    ...
    if (title_wstr_ptr != PNULL)
    {
        ...
        if (!BRW_GetPageTitle(MMIBROWSER_GetInstance(), title_wstr_ptr, &title_len, MMIBROWSER_MAX_TITLE_LEN))
        {
            title_len = 0;
        }        
...
//        GUIWIN_SetSoftkeyTextId(MMIBROWSER_MAIN_WIN_ID, STXT_OPTION, TXT_NULL, rightsoft_id, is_update);
        ...
        {
            GUIWIN_SetSoftkeyTextId(MMIBROWSER_MAIN_WIN_ID, STXT_SOFTKEY_MENU_MK, TXT_NULL, STXT_SOFTKEY_STOP_MK, is_update);
        }
        else
        {
            GUIWIN_SetSoftkeyTextId(MMIBROWSER_MAIN_WIN_ID, STXT_SOFTKEY_MENU_MK, TXT_NULL, rightsoft_id, is_update);
        }
#endif
    }
    return ret;
...
LOCAL BOOLEAN HandleControlSslCertInd(void *param)
{
    ...
    if(PNULL != param)
    {
        ...
        if (nv_setting_ptr->is_ssl_warning_enable)
        {
            ...
            MMIBROWSER_OpenQueryWinByTextId(STR_BROWSER_TRUSTED_WEB,IMAGE_PUBWIN_QUERY,&sll_query_win_id,BrwSSLCertQueryCallback);
        }
    }
    else
    {
...
LOCAL BOOLEAN HandleControlDownloadErrInd(void *param)
{
    ...
    if (PNULL != err_ind)
    {
        ...
        {
            alert_text_id = STR_BROWSER_DATA_DISCONNECT;
        }
...
LOCAL void BrwHandleMainOpenWinMsg(MMI_WIN_ID_T	win_id)
{
    ...
    if (0 == brw_instance)
    {
        MMIPUB_OpenAlertFailWin(STR_BROWSER_FAIL);
        MMK_CloseWin(win_id);
...
#endif
    GUIEDIT_SetSoftkey(edit_ctrl_id,0,1,TXT_NULL,STXT_SOFTKEY_OK_MK,PNULL);
                                   ...
                                   )
{
    ...
    case MSG_OPEN_WINDOW:
    {
        ...
        GUIEDIT_SetIm(edit_ctrl_id,GUIIM_TYPE_ENGLISH | GUIIM_TYPE_ABC | GUIIM_TYPE_DIGITAL, GUIIM_TYPE_ABC); /*lint !e655*/ //MS00220112
        GUIEDIT_SetSoftkey(edit_ctrl_id,0,1,TXT_NULL,STXT_SOFTKEY_OK_MK,PNULL);
		GUIEDIT_SetSoftkey(edit_ctrl_id, 2, 1, STXT_SOFTKEY_CANCEL_MK, STXT_SOFTKEY_DELETE_MK, PNULL);
        GUIEDIT_ConfigDisableChar(edit_ctrl_id, forbid_char_value, sizeof(forbid_char_value)/sizeof(wchar));
        ...
        GUIEDIT_SetString(edit_ctrl_id,wchar_url_arr,(uint16)url_len);
        GUIEDIT_SetStyle(edit_ctrl_id,GUIEDIT_STYLE_MULTI_UP);
        MMK_SetAtvCtrl(win_id,edit_ctrl_id);
    }
        break;
...
MMI_WIN_ID_T    query_exit_web_win_id = MMIBROWSER_QUERY_EXIT_WEB_WIN_ID;
        ...
        MMIBROWSER_OpenQueryWinByTextId(STR_BROWSER_CLOSE/*TXT_EXIT_QUERY*/,
            IMAGE_PUBWIN_QUERY,
            &query_exit_web_win_id,
            HandleQueryExitWebWin);
#else  

	MMIBROWSER_BROWSER_TYPE_E bl_browser_type = MMIBROWSER_TYPE_MAX;
	MMI_WIN_ID_T    query_exit_win_id = MMIBROWSER_QUERY_EXIT_WIN_ID;
	bl_browser_type = MMIBM_GetDefaultBrowser();

	#ifdef BROWSER_SUPPORT_DORADO    	
	if(bl_browser_type == MMIBROWSER_TYPE_DORADO)
	{
	//Dorado
		MMIBROWSER_OpenQueryWinByTextId(STR_BROWSER_CLOSE,
			IMAGE_PUBWIN_QUERY,
			&query_exit_win_id,
	...
	if(bl_browser_type == MMIBROWSER_TYPE_OPERA_MINI)
	{
		MMIBROWSER_OpenQueryWinByTextId(STR_BROWSER_CLOSE,
			IMAGE_PUBWIN_QUERY,
			&query_exit_win_id,
...
LOCAL void BrwShowErrMsg(BRW_ERROR_E error)
{
    ...
    case BRW_ERR_GPRS_LINK_DISCONNECT:
        text_id=STR_BROWSER_DATA_DISCONNECT;
        break;
    case BRW_ERR_HTTP_RTN:
        text_id = STR_BROWSER_WEBPAGE_FAIL;
        break;
    case BRW_ERR_PAGE_ERR:
        text_id = STR_BROWSER_PARSE_ERROR;
        break;
    case BRW_ERR_PAGE_TOO_BIG:
        text_id=STR_BROWSER_TOO_LARGE;
        break;
    ...
    case BRW_ERR_UNKNOWN:
        text_id = STR_BROWSER_WEBPAGE_FAIL;//Unknown error(文本相同,共用ID)
        break;
    //////////////////////////////////////////////////////////////////////////
    // added by feng.xiao
                                   ...
                                   )
{
    ...
    case MSG_APP_OK:
    {
        ...
        {
            MMIPUB_OpenAlertWarningWin(STR_BROWSER_INPUT_USERNAME);
        }
    }
        break;
...
#endif //TOUCH_PANEL_SUPPORT //IGNORE9527
    {
        ...
        if (2==index)
        {
            MMK_CreateWin((uint32*)MMIBROWSER_INPUT_USERNAME_WIN_TAB,PNULL);
        ...
        {
            MMK_CreateWin((uint32*)MMIBROWSER_INPUT_PWD_WIN_TAB,PNULL);
...
LOCAL void BrwSetAuthWindow(MMI_CTRL_ID_T ctrl_id)
{
    ...
    SCI_MEMSET(&item_data, 0x00, sizeof(GUIRICHTEXT_ITEM_T));
    item_data.text_type = GUIRICHTEXT_TEXT_RES;
    item_data.text_data.res.id = STR_BROWSER_USERNAME;    
    GUIRICHTEXT_AddItem(ctrl_id, &item_data, &index);
...
LOCAL void BrwSetFileDetailWindow(MMI_CTRL_ID_T ctrl_id)
{
    ...
    item_data.text_type = GUIRICHTEXT_TEXT_RES;
    item_data.text_data.res.id = TXT_BROWSER_TITLE_EX01;
    GUIRICHTEXT_AddItem(ctrl_id, &item_data, &index);
    ...
    SCI_MEMSET(&item_data, 0x00, sizeof(GUIRICHTEXT_ITEM_T));
    item_data.text_type = GUIRICHTEXT_TEXT_RES;
    item_data.text_data.res.id = TXT_COMMON_URL;
    GUIRICHTEXT_AddItem(ctrl_id, &item_data, &index);
...
LOCAL BOOLEAN BrwAppendSelectListItem(MMI_CTRL_ID_T ctrl_id)
{
    ...
    MMIAPISET_AppendMultiSimName(ctrl_id, STXT_SOFTKEY_OK_MK, MMI_DUAL_SYS_MAX, MMISET_APPEND_SYS_OK);
                                          ...
                                          )
{
    ...
    case MSG_OPEN_WINDOW:
        ...
        if (PNULL != file_name_req_ptr && 0 != MMIAPICOM_Wstrlen(file_name_req_ptr->res_name_arr))
        {
            ...
            if(file_name_len >MMIBROWSER_DL_FILE_FULL_PATH_MAX_LEN)
            {
                SCI_TRACE_LOW("[BRW] BrwHandleInputFileNameWinMsg file_name_len too long");
                file_name_len = MMIBROWSER_DL_FILE_FULL_PATH_MAX_LEN;
            }
        ...
        GUIEDIT_SetStyle(MMIBROWSER_INPUT_FILE_NAME_CTRL_ID,GUIEDIT_STYLE_MULTI_UP);
        //set left softkey
        GUIEDIT_SetSoftkey(ctrl_id,0,1,TXT_NULL,STXT_SOFTKEY_OK_MK,PNULL);//MS00246150
        MMK_SetAtvCtrl(win_id,ctrl_id);
        break;
        ...
        case ID_POPUP_MENU_OPEN_HOMEPAGE:
			{
				...
				{
					MMIPUB_OpenAlertWarningWin(STR_URL_SAVE_EMPTY);
				}
				else
                {
        ...
        case ID_POPUP_MENU_SAVE_INTERNET_FILE:
            {
                ...
                {
                    MMIPUB_OpenAlertWarningWin(STR_BROWSER_NO_INFO);
                }
...
//     uint16              username_len=0;
    ...
    case MSG_OPEN_WINDOW:
        GUIWIN_SeSoftkeytButtonTextId(win_id, STXT_SOFTKEY_MENU_MK, LEFT_BUTTON, FALSE);
        GUIWIN_SeSoftkeytButtonTextId(win_id, TXT_COMMON_COMMON_BACK, RIGHT_BUTTON, FALSE);        
        GUIEDIT_SetStyle(MMIBROWSER_EDIT_USERNAME_CTRL_ID,GUIEDIT_STYLE_MULTI_UP);
        MMK_SetAtvCtrl(win_id,ctrl_id);
        break;
    ...
    case MSG_CTL_OK:
        {
            ...
            {
                //invalid user name
                MMIPUB_OpenAlertWarningWin(STR_BROWSER_INVALID_USERNAME);
                break;
            }
...
//     uint16              pwd_len=0;
    ...
    case MSG_OPEN_WINDOW:
        ...
        GUIEDIT_SetStyle(ctrl_id,GUIEDIT_STYLE_MULTI_UP);
        MMK_SetAtvCtrl(win_id,ctrl_id);
        break;
...
LOCAL BOOLEAN CreatePopWinMenu(void)
{
    ...
    for(i = 0; i < item_num; i++)
    {
        ...
        if (((ID_POPUP_MENU_SAVE_INTERNET_FILE == node_id) 
            && (MMIBROWSER_GetLoading() || BRW_IsPageBlank(MMIBROWSER_GetInstance())))
...
//     uint16 font_height = GUIFONT_GetHeight(MMIBROWSER_ADDR_LABEL_FONT);
	...
	s_brw_show_info.connect_anim.v_rect.top = s_brw_show_info.addr_bar.v_rect.bottom - connect_anim_height;
                                         ...
                                         )
{
  ...
  //      MMIPUB_OpenTextDialogByTextPtr(PNULL,text1_ptr,text2_ptr,image_id,win_id_ptr,PNULL,MMIPUB_SOFTKEY_DIALOG_OK_CLOSE,handle_func);
    }
    else
    {
        MMIPUB_OpenQueryWinByTextPtr(text1_ptr, text2_ptr, image_id, &query_win_id,handle_func);
    //    MMIPUB_OpenTextDialogByTextPtr(PNULL,text1_ptr,text2_ptr,image_id,&query_win_id,PNULL,MMIPUB_SOFTKEY_DIALOG_OK_CLOSE,handle_func);
    }
}
                                        ...
                                        )
{
    ...
    if (win_id_ptr != PNULL)
    {
        MMIPUB_OpenConfirmationDialogByTextId(PNULL,text_id,TXT_NULL, image_id,win_id_ptr,PNULL,MMIPUB_SOFTKEY_DIALOG_OK_CLOSE,handle_func);
    }
    else
    {
        MMIPUB_OpenConfirmationDialogByTextId(PNULL, text_id,TXT_NULL,image_id,&query_win_id,PNULL,MMIPUB_SOFTKEY_DIALOG_OK_CLOSE, handle_func);
    }
...
LOCAL void BrwSetProgressForDL(void)
{
   ...
   // wchar progress_temp_wchar[MMIBROWSER_PROGRESS_BUF_LEN] = {0};
    ...
    if(wstr_len  < (MMIBROWSER_PROGRESS_BUF_LEN << 1))
    {
        if (0 == total_data_len)
        {
            MMI_GetLabelTextByLang(STR_BROWSER_UNKNOWN_SIZE, &unknown_str);
                                                 ...
                                                 )
{
...
#endif /* MMI_PDA_SUPPORT */
    {
        ...
        case MMIBROWSER_SAVE_MEDIAFILE_EDITBOX_CTRL_ID:
            MMK_CreateWin((uint32*)MMIBROWSER_INPUT_FILE_NAME_WIN_TAB,PNULL);
            break;
    ...
    case MSG_APP_OK:
    {
        ...
        case PREPARE_DL_ERR_EXSIT:
            MMIPUB_OpenAlertWarningWin(TXT_DC_NAMEREPEAT);//MS00191252
            break;
                                                 ...
                                                 )
{
    ...
    case MSG_NOTIFY_FORM_SWITCH_ACTIVE:
    {
        ...
        {
        case MMIBROWSER_SAVE_MEDIAFILE_EDITBOX_CTRL_ID:
            GUIWIN_SetSoftkeyTextId(win_id, STXT_SOFTKEY_OK_MK, STR_BROWSER_SOFTKEY_CHANGE, STXT_RETURN, TRUE);
            break;
            
        case MMIBROWSER_SAVE_MEDIAFILE_PATH_DROPDOWNLIST_CTRL_ID:
            GUIWIN_SetSoftkeyTextId(win_id, STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN, TRUE);
            break;
...
#ifdef DL_SUPPORT
/*****************************************************************************/
//  Description : get download type by mime type
//  Global resource dependence : 
//param: mime_type: mime type at brw.
//  Author: jun.song
//  Note:  
/*****************************************************************************/
LOCAL MMIDL_DOWNLOAD_TYPE GetDLTypeByMimeType(BRW_MIME_TYPE_E mime_type)
{
    MMIDL_DOWNLOAD_TYPE type = MMIDL_DOWNLOAD_TYPE_MAX;

    if (mime_type >= BRW_MIME_IMG_BMP && mime_type<= BRW_MIME_IMG_UNKNOWN)
    {
        type = MMIDL_DOWNLOAD_PICTURE_TYPE;
    }
    else if (mime_type >= BRW_MIME_AUDIO_AMR && mime_type<= BRW_MIME_AUDIO_UNKNOWN)
    {
        type = MMIDL_DOWNLOAD_AUDIO_TYPE;
    }
    else if (mime_type >= BRW_MIME_VIDEO_3GP && mime_type<= BRW_MIME_VIDEO_3GP)
    {
        type = MMIDL_DOWNLOAD_VIDEO_TYPE;
    }
    else
    {
        type = MMIDL_DOWNLOAD_OTHER_TYPE;
    }
...
LOCAL void SetDownloadFileNamePathWindow(MMI_WIN_ID_T win_id)
{
    ...
    GUILABEL_SetTextById(file_name_ctrl_id, TXT_DL_DOWNLOAD_INPUT_FILENAME, FALSE);
    GUILABEL_SetTextById(path_ctrl_id, STR_SETT_LIST_STORAGE_EXT01, FALSE);
    ...
    if (file_name_req_ptr != PNULL) 
    {
        ...
        else
        {
            ...
            //set save path
            SCI_MEMSET(fmm_path, 0x00, sizeof(fmm_path));
            fmm_path_len = MMIFILE_FULL_PATH_MAX_LEN;
            MMIDL_GetDownloadPath(GetDLTypeByMimeType(mime_type), fmm_path, &fmm_path_len);
...
LOCAL void InitBrwStartPageWin(MMI_WIN_ID_T win_id)
{
    ...
    GUIFORM_SetChildHeight(MMIBROWSER_START_PAGE_FORM1_CTRL_ID, MMIBROWSER_START_PAGE_LABEL11_CTRL_ID, &child_height);
    ...
    GUILABEL_SetMarginEx(MMIBROWSER_START_PAGE_LABEL11_CTRL_ID, MMI_LIST_ITEM_LEFT_MARGIN, 0);
...
#else
    //bookmark
    MMIRES_GetText(TXT_COMMON_BOOKMARKS, PNULL, &item_text_1);
#ifdef MMIBROWSER_DISPLAY_BK_HISTORY_INFO
    ...
    //Page Memo
    MMIRES_GetText(STR_BROWSER_OFFLINE_PAGE, PNULL, &item_text_1);
...
{
    MMI_RESULT_E    ret=MMI_RESULT_TRUE;    
    MMI_CTRL_ID_T   current_ctrl_id = MMIBROWSER_START_PAGE_FORM_CTRL_ID;
    GUI_BG_T        bg_info = {0};
    ...
    case MSG_OPEN_WINDOW:
        {
            ...
            MMIPUB_SetWinSoftkey(win_id, TXT_NULL, STXT_SOFTKEY_OK_MK, FALSE);
...
{                                                               
    ...
    if (result && (file_name_ptr != PNULL) && (file_name_len > 0))
    {
        ...
        {
            MMI_GetLabelTextByLang(STR_NOTE_WAITING, &wait_str); 
...
#ifndef MMI_PDA_SUPPORT
            icon_list.softkey_id[LEFT_BUTTON] = TXT_NULL;
            icon_list.softkey_id[MIDDLE_BUTTON] = STXT_SOFTKEY_ADD_MK;
            icon_list.softkey_id[RIGHT_BUTTON] = STXT_RETURN;
#endif
                                   ...
                                   )
{
    ...
    case MSG_OPEN_WINDOW:
    {
        ...
        {
            title_text_id = STXT_SOFTKEY_ADD_MK;
        }
        else
        {
        ...
        GUILABEL_SetTextById(MMIBROWSER_MY_NAV_EDIT_LABEL1_CTRL_ID, STR_BROWSER_BOOKMARK, FALSE);
...
PUBLIC BRW_PUBLIC_PROFILE_T MMIBROWSER_SetPublicProfile(void)
{
    ...
    if (PNULL == device_name_ptr)
    {
        profile.is_cache_enable = FALSE;
        profile.is_cookie_enable = FALSE;
		SCI_TRACE_LOW("[cookie] MMIBROWSER_SetPublicProfile profile.is_cookie_enable = FALSE; \n");
    }
    else
    {
        profile.is_cache_enable=nv_setting_ptr->is_cache_enable;
        profile.is_cookie_enable=nv_setting_ptr->is_cookie_enable;
		SCI_TRACE_LOW("[cookie] MMIBROWSER_SetPublicProfile is_cookie_enable = %d, nv_setting_ptr->is_cookie_enable  \n");
    }
    profile.is_image_download=nv_setting_ptr->is_image_loaded;
                                   ...
                                   )
{
    ...
    case MSG_FULL_PAINT:
    {
        ...
        {
            //please waiting
            GUILABEL_SetTextById(MMIBROWSER_FIX_HTML_LABEL_CTRL_ID,  STR_NOTE_WAITING, FALSE);
        ...
        else
        {
            ...
            if (!is_display_success) //error
            {
                ...
                GUILABEL_SetTextById(MMIBROWSER_FIX_HTML_LABEL_CTRL_ID,  STR_BROWSER_WEBPAGE_FAIL, FALSE);
                GUILABEL_SetVisible(MMIBROWSER_FIX_HTML_LABEL_CTRL_ID,  TRUE, TRUE);
            }
        }
    }
                                   ...
                                   )
{
    ...
    case MSG_OPEN_WINDOW:
    {
        ...
        GUILABEL_SetTextById(MMIBROWSER_ADD2MAIN_EDIT_LABEL1_CTRL_ID, STR_BROWSER_BOOKMARK, FALSE);
    ...
    case MSG_APP_OK:
    {
        ...
        if (url_ptr != PNULL)
        {
            ...
            ret = MMIMENU_DyAppendItem(dynamic_item_ptr, store_idx, TRUE);
        }
        else
        {
...
uint32 hero_tts_get_browser_urltab_ctrl_id(void)
{
	return MMIBROWSER_START_PAGE_LABEL11_CTRL_ID;
}
#endif
/**--------------------------------------------------------------------------*
 **                         Compiler Flag                                    *
