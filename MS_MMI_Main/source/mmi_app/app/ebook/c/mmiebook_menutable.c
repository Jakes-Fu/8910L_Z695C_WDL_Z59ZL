...
{   
    ...
    {ID_EBOOK_LIST_MAKEABLE, TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, STXT_SOFTKEY_MARK_MK,  0, 0, 0, MENU_EBOOK_LIST_MARK_OPT},
...
{   
    {ID_EBOOK_LIST_MARK,  TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, STXT_SOFTKEY_MARK_MK,  0, 0, 0, MENU_NULL},//TXT需修改
