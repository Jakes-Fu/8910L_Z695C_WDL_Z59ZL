...
#define LEBAO_SOFTKEY_BAR_HEIGHT lebao_get_softkey_bar_height()
...
typedef enum
{
	...
	RES_TEXT_LEBAO_INVALID_NUM,
	RES_TEXT_LEBAO_INVALID_CAPTCHA,
	RES_TEXT_LEBAO_SONG_NEED_BUY,
	RES_TEXT_LEBAO_MENU_LOGOUT,
	RES_TEXT_LEBAO_MENU_CLOSE_ACCOUNT,
	RES_TEXT_LEBAO_TIPS_NEEDMOBILE,
	RES_TEXT_LEBAO_TIPS_LOGOUT,
	RES_TEXT_LEBAO_CAPTCHA_INCORRECT,
	RES_TEXT_LEBAO_SOFTKEY_OK,
	RES_TEXT_LEBAO_SOFTKEY_OPTION,
	RES_TEXT_LEBAO_TIPS_MUSIC_USING,
	RES_TEXT_LEBAO_TIPS_INCALL,
	RES_TEXT_LEBAO_TIPS_EXIT_APP,
	RES_TEXT_LEBAO_NOT_DOWNLOAD_RING,
	RES_TEXT_LEBAO_LICENSE_PREFIX,
	RES_TEXT_LEBAO_GIFT_SUCCESSED,
	RES_TEXT_LEBAO_OPT_RING_CANCEL,
	RES_TEXT_LEBAO_TIPS_QRCODE_LOGIN,
	RES_TEXT_LEBAO_OPT_CONTACT,
    RES_TEXT_LEBAO_MENU_HISTORY,
    RES_TEXT_LEBAO_GUEST_LOGIN,
    RES_TEXT_LEBAO_OPT_ALARM,
    RES_TEXT_LEBAO_OPT_ALARM_CANCEL,
    RES_TEXT_LEBAO_FAV_INFO,
	RES_TEXT_LEBAO_OPT_LOOP_BOOKS,
	RES_TEXT_LEBAO_NOT_DOWNLOAD_ALARM,
	RES_TEXT_LEBAO_ALARM_OK,
	RES_TEXT_LEBAO_ALARM_FAILED,

	RES_TEXT_LEBAO_END_TEXT_ID,		/* 必须在此位置前添加的字符串定义 */
	RES_TEXT_LEBAO_END
} lebao_text_id_t;
...
typedef enum
{
	...
	RES_MMI_LEBAO_CTRL_ID_LIST_BOOKLIST,
...
MMI_RESULT_E lebao_set_chart_list_data(link_list_t *_lebaoCharts, MMI_WIN_ID_T win_id, MMI_MESSAGE_ID_E msg_id, DPARAM param);
MMI_RESULT_E lebao_set_chart_list_content(link_list_t *_lebaoCharts, MMI_WIN_ID_T win_id, MMI_MESSAGE_ID_E msg_id, DPARAM param);
...
MMI_RESULT_E lebao_set_musiclist_list_content(link_list_t *_lebaoSongs, MMI_WIN_ID_T win_id, MMI_MESSAGE_ID_E msg_id, DPARAM param);
