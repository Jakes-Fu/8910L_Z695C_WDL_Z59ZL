	...
	#define  LEBAO_LIST_ITEM_RIGHT			(234)
...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_1_icon_80x80_text_fixed_height_90 =
{
	58, 58,  //(LCD_HEIGHT - MMI_TITLE_THEME_HEIGHT - MMI_FULLSCREEN_SOFTKEY_BAR_HEIGHT) / lebao_menu_max
	{
		...
		{
			0,
			{ 58 + 2 + MMI_LIST_TEXT_LEFT_SPACE,  0,  MMI_LIST_ITEM_RIGHT - MMI_LIST_TEXT_LEFT_SPACE * 2, 58 - 1 },
			{ 58 + 2 + MMI_LIST_TEXT_LEFT_SPACE,  0,  MMI_LIST_ITEM_RIGHT - MMI_LIST_TEXT_LEFT_SPACE * 2, 58 - 1 },
...
LOCAL THEMELIST_ITEM_STYLE_T const s_item_style_1_icon_20x72_2_text_text_fixed_height_90 =
{
	80, 80,
	{
		...
		{
			0,
			{ 25 + MMI_LIST_TEXT_LEFT_SPACE,  MMI_LIST_ITEM_TOP_MARGIN,  MMI_LIST_ITEM_RIGHT, 80 / 2 - 1},
			{ 25 + MMI_LIST_TEXT_LEFT_SPACE,  MMI_LIST_ITEM_TOP_MARGIN,  MMI_LIST_ITEM_RIGHT, 80 / 2 - 1},
		...
		{
			0,
			{ 25 + MMI_LIST_TEXT_LEFT_SPACE,  80 / 2, MMI_LIST_ITEM_RIGHT, 80 - MMI_LIST_ITEM_BOTTOM_MARGIN - 1},
			{ 25 + MMI_LIST_TEXT_LEFT_SPACE,  80 / 2, MMI_LIST_ITEM_RIGHT, 80 - MMI_LIST_ITEM_BOTTOM_MARGIN - 1},
			MMI_DEFAULT_NORMAL_FONT-2, MMI_DEFAULT_NORMAL_FONT-2, //SONG_FONT_16
			0, 1
		},
		{
			0,
			{ 25, 78,  25 + 210, 79}, //split line
			{ 25, 78,  25 + 210, 79},
			0, 0,
			0, 1
		},
