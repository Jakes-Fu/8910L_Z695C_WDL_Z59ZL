 ...
 */
void lebao_api_aes_expand_key(uint8_t *key, uint8_t *expkey);
 ...
 * out		Output data
 */
void lebao_api_aes_encrypt(uint8_t *in, uint8_t *expkey, uint8_t *out);
 ...
 * out		Output data
 */
void lebao_api_aes_decrypt(uint8_t *in, uint8_t *expkey, uint8_t *out);
