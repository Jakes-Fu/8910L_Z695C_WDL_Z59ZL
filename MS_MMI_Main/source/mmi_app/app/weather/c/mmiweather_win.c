...
WINDOW_TABLE(MMIWEATHER_ADD_CITY_WIN_TAB) = 
{
    ...
    CHILD_SOFTKEY_CTRL(TXT_NULL, STXT_SOFTKEY_ADD_MK, TXT_NULL,MMICOMMON_SOFTKEY_CTRL_ID,MMIWEATHER_ADD_CITY_FORM_CTRL_ID),
#else
    ...
    case MSG_OPEN_WINDOW:
        {
            ...
            //set left softkey
            GUIEDIT_SetSoftkey(edit_ctrl_id, 0, 1, TXT_NULL, STXT_SOFTKEY_ADD_MK, PNULL);
