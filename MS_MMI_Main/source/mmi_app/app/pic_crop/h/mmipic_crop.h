...
#define MMIPICCROP_SAVE_FILE_TYPE           "jpg"  //"bmp"  //lijinghua modify it
...
//zhuyongjing add 240*320
#if defined MAINLCD_SIZE_640X480
#define MMIPICCROP_MAX_WIDTH                       480
#define MMIPICCROP_MAX_HEIGHT                      640 
#else
#define MMIPICCROP_MAX_WIDTH                       240
#define MMIPICCROP_MAX_HEIGHT                      320 
#endif
//add end
...
**                         TYPE AND CONSTANT                                *
**--------------------------------------------------------------------------*/
//typedef GUIANIM_FILE_INFO_T PICCROP_EDIT_FILE_INFO_T;           //lijinghua modify it
...
//lijinghua delete li for pic crop
//typedef struct 
//{
    //uint32              crop_file_id;
