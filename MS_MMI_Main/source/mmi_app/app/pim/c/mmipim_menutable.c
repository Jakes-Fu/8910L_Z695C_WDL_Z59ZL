...
{   
    ...
    {MMIPIM_MENU_ID_SYNC_SETTING,  TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN}, STXT_MAIN_SETTING, 0, 0, 0, MENU_NULL},
};
...
const GUIMENU_ITEM_T mmi_pim_setting_menu[] =
{
    ...
    //{MMIPIM_MENU_ID_DEBUG_SETTING,  TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN}, TXT_PIM_DEBUG_SETTING,  0, 0, 0, MENU_NULL},
...
{   
    {MMIPIM_MENU_ID_GATEWAY_IP,  TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN}, TXT_PIM_IP,  0, 0, 0, MENU_NULL},
    {MMIPIM_MENU_ID_GATEWAY_PORT,  TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN}, TXT_COMM_PORT, 0, 0, 0, MENU_NULL},
...
{   
    {MMIPIM_MENU_ID_SYNCML_SETTING_SERVER,  TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN}, TXT_PIM_SERVER_ADDR,  0, 0, 0, MENU_NULL},
    {MMIPIM_MENU_ID_SYNCML_SETTING_PORT,  TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN}, TXT_COMM_PORT, 0, 0, 0, MENU_NULL}, // chenxiang 20080506 deleted port 
...
{   
    {MMIPIM_MENU_ID_SYNCML_SETTING_CODE,  TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN}, TXT_CODING_TYPE,  0, 0, 0, MENU_NULL},
    {MMIPIM_MENU_ID_SYNCML_SETTING_AUTH,  TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN}, TXT_PIM_SYNC_AUTH,  0, 0, 0, MENU_NULL},
