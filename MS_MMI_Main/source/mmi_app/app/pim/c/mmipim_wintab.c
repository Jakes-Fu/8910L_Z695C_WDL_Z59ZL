										...
										)
{
    ...
    case MSG_OPEN_WINDOW:
		...
		MMIAPISET_AppendListItemByTextId(TXT_PROXY_ON,STXT_SOFTKEY_OK_MK,ctrl_id,GUIITEM_STYLE_ONE_LINE_RADIO);
		MMIAPISET_AppendListItemByTextId(TXT_COMM_PROXY_OFF,STXT_SOFTKEY_OK_MK,ctrl_id,GUIITEM_STYLE_ONE_LINE_RADIO);
										...
										)
{
    ...
    case MSG_OPEN_WINDOW:
        ...
        //MS00216980 cheney
        //MMIAPISET_AppendListItemByTextId(TXT_PIM_UA_OTHER,STXT_SOFTKEY_OK_MK,ctrl_id,GUIITEM_STYLE_ONE_LINE_RADIO);
        MMIAPISET_AppendListItemByTextId(TXT_PIM_UA_CUSTOM,TXT_COMMON_OK,ctrl_id,GUIITEM_STYLE_ONE_LINE_RADIO);
		//MMIAPISET_AppendListItemByTextId(TXT_PIM_UA_HS_N71,STXT_SOFTKEY_OK_MK,ctrl_id,GUIITEM_STYLE_ONE_LINE_RADIO);
    ...
    case PIM_MSG_STOP:
	{
     ...
     case PIM_MSG_SELECT_TIMER:
     {
       ...
       if(socket_select_result==-1)
       {
        ...
        MMI_STRING_T	dis_str = {0};
        MMI_GetLabelTextByLang(TXT_PSTIME_OUT, &dis_str);
