...
PUBLIC void MMIAPITTS_InitModule(void)
{
...
PUBLIC void MMIAPITTS_StopASynchTextByTask(void)
{
    ...
    SCI_TraceLow("[MMITTS] MMIAPITTS_SynthTextByTask");
...
#ifdef HERO_ENGINE_TTS_SUPPORT
extern void hero_tts_incall_playing_stop(BOOLEAN parameters);
#endif
/*****************************************************************************/
//  Description : 停止 play text 接口
//  Global resource dependence : none
...
PUBLIC void MMIAPITTS_StopPlayTextByType(TTS_ALL_RING_TYPE_E ring_type)
{
	...
	#ifdef HERO_ENGINE_TTS_SUPPORT
	hero_tts_incall_playing_stop(FALSE);
	#endif
}
                                      ...
                                      )
{
	 ...
	 SCI_TraceLow("[MMITTS] MMIAPITTS_PlayTextForControl");
