...
#define HERO_ENGINE_MANUFACTORY 			"tyis89s"  
#define HERO_ENGINE_MANUFACTORY_EX 		"20240116"  
// 手机盘空间设置(单位:字节)
...
#define __HR_SMART_AUTH_ID__         HERO_ENGINE_MANUFACTORY"_"HERO_ENGINE_HANDSET"_smartid_8910_phone"
