...
*/
	...
	{
		MMIPUB_OpenAlertWinByTextId(PNULL,STR_SIM_NOT_SIM_EXT01,TXT_NULL,IMAGE_PUBWIN_WARNING,PNULL,PNULL,MMIPUB_SOFTKEY_ONE,PNULL);
	}
	}
...
void APPLE_StartEx(unsigned int appid, char * arg)
{
    ...
    {
        MMIPUB_OpenAlertWinByTextId(PNULL, STR_JAVA_BACKGROUND_RUNNING, TXT_NULL, IMAGE_PUBWIN_WARNING, PNULL, PNULL, MMIPUB_SOFTKEY_ONE, PNULL);
        return ;
    }
#endif
...
BOOLEAN AppleAppendSelectListItem(MMI_CTRL_ID_T ctrl_id)
{
    ...
    APPLE_AppendMultiSimNameExt(ctrl_id, STXT_SOFTKEY_OK_MK,TXT_NULL,STXT_RETURN, MMI_DUAL_SYS_MAX, MMISET_APPEND_SYS_OK);
#else
                                         ...
                                         )
{
    ...
    case MSG_OPEN_WINDOW:
        ...
        //MMIAPISET_AppendDualSimName(MMIAPPLE_SELECT_SIM_CTRL_ID, STXT_SOFTKEY_OK_MK, MN_DUAL_SYS_MAX);
