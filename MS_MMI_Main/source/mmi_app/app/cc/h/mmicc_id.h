...
//speed dial	
    MMISPEEDDIAL_SETTINGS_LIST_CTRL_ID,
    ...
    MMISPEEDDIAL_VIEW_RICHTEXT_CTRL_ID,
  	...
  	MMISPEEDDIAL_DIRECTIONS_CTRL_ID,
  #endif
...
#endif
    MMICC_SMS_REJECT_CALL_TITLE_CTRL_ID,
    MMICC_SMS_REJECT_CALL_LIST_CTRL_ID,
    //[fu.ruilin, add for CALL UI]
    MMICC_MO_CALL_BOTTOM_MENU_CTRL_ID,
    MMICC_MO_CALL_BOTTOM_BT_CTRL_ID,
    MMICC_MO_CALL_BOTTOM_SPEAKER_CTRL_ID,
    MMICC_MO_CALL_BOTTOM_MUTE_CTRL_ID,
    MMICC_MO_CALL_BOTTOM_BACK_CTRL_ID,
    MMICC_MO_CALL_DTMF_CTRL_ID,
    MMICC_MULTI_CALL_ANIMATION_LIST_ID,
    //[fu.ruilin, end]
    //[implement custom call log list UI]
    MMICL_CUSTOM_LOG_LIST_CTRL_ID,
    MMICL_BLOCK_NUMBER_CTRL_ID,
    MMICL_SIM_SEL_MENU_CTRL_ID,
    MMICL_ADD_TO_PB_MENU_CTRL_ID,
    //[end]
    //added by du.yuxuan
    MMICL_LOG_LIST_DETAIL_FORM_CTRL_ID,
    MMICL_LOG_LIST_DETAIL_CONTACT_LIST_CTRL_ID,
    MMICL_LOG_LIST_DETAIL_LIST_CTRL_ID,
    MMICL_LOG_LIST_DETAIL_MENU_CTRL_ID,
    //end
#if defined(HERO_ENGINE_SUPPORT )&&defined(HERO_ENGINE_HMGS_SUPPORT)&&defined(HERO_ENGINE_HMGS_SUPPORT_ON_OTHER_LINE) 
     MMICC_CONNECTED_HMGS_LABEL_CTRL_ID,	
#endif
    MMICC_MAX_CTRL_ID
}CC_CONTROL_ID_E;
