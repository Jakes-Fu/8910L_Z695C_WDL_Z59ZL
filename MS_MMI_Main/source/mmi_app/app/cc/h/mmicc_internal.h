 ...
 **                         TYPE AND CONSTANT                                *
 **--------------------------------------------------------------------------*/
#define CC_CALL_AUTO_RETRIEVE_HOLD_CALL
#define CC_CALL_MS_CUSTOM_STYLE
typedef enum
{
    AVATAR_TYPE_CUSTOMER,
    AVATAR_TYPE_RECORDING,
    AVATAR_TYPE_CONFERENCE,
    AVATAR_TYPE_EMERGENCY,
    AVATAR_TYPE_DEFAULT,
    AVATAR_TYPE_MAX
}CUSTOM_AVATAR_TYPE_E;

typedef struct 
{
    BOOLEAN bottom_bt_pressed;
    BOOLEAN bottom_speaker_pressed;
    BOOLEAN bottom_mute_pressed;
}CC_BOTTOM_BUTTONS_STATUS_INFO_T;
...
typedef enum
{
    ...
    CC_HOLDMENU_NODE_ADD_CALL,
    CC_HOLDMENU_NODE_COMBINE_CALLS,
    CC_HOLDMENU_NODE_VIEW_MULTICALL,
    CC_HOLDMENU_NODE_HOLD_CALL
...
//#endif    
    ...
    uint8 busy_tone_timer;
    BOOLEAN is_play_busy_tone;
#endif
}MMICC_INSTANCE_T;
...
PUBLIC BOOLEAN MMICC_AppendIdleMsg();
