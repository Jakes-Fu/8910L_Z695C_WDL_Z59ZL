...
typedef enum
{
    NOT_ECC, //normal call, else emergency call
    NDT_ECC,
#ifdef CSC_XML_SUPPORT
    CSC_ECC,
#endif
...
//	Note:
/*****************************************************************************/
PUBLIC BOOLEAN MMIAPICC_IsFakeEmergencyNumByNdt(uint8 *tele_num,uint8 tele_len,MN_DUAL_SYS_E dual_sys);
