...
#endif
//#include "mmimms_attalistoptwin.h"
/**---------------------------------------------------------------------------*
 **                         Compiler Flag                                     *
 **---------------------------------------------------------------------------*/
#ifdef __cplusplus
 ...
 **                         Macro Declaration    							  *
 **---------------------------------------------------------------------------*/
 //macro for arvin debugging
// #define ARVIN_DEBUG_MESSAGING_UNISOC
...
#define MMIMMS_PIC_FIXED_WIDTH                 100          //for low memory usage
#define MMIMMS_PIC_FIXED_HEIGHT                80
#else
#define MMIMMS_PIC_FIXED_WIDTH                 200
#define MMIMMS_PIC_FIXED_HEIGHT                150
#endif
...
#define MMISMS_SMS_FIXED_TEXT_BG_WIDTH   100//100//200
#define MMISMS_SMS_FIXED_IMAGE_HEIGTH   90//113//150
#define MMISMS_SMS_FIXED_TEXT_BG_HEIGHT   24//28
#define MMISMS_CHAT_TEXT_MARGIN_LEFT  1//6
#define MMISMS_CHAT_TEXT_MARGIN_RIGHT 1//6
#define MMISMS_CHAT_TEXT_MARGIN_TOP  1//3
#define MMISMS_CHAT_TEXT_MARGIN_BOTTOM  1
#define MMISMS_CHAT_TEXT_LINE_SPACE    1
#define MMISMS_CHAT_FORM_VER_SPACE    1
#define MMISMS_SENDFAIL_DATE_TEXT_WIDTH   80
#define MMISMS_TEXT_LAYOUT_MARGIN_WIDTH   10
#define MMISMS_SMS_FIXED_SIM_RECT_WIDTH   18
#define MMISMS_SMS_EDIT_VER_MARGIN 2
#else
#define MMISMS_SMS_FIXED_TEXT_BG_WIDTH   200
#define MMISMS_SMS_FIXED_IMAGE_HEIGTH   150
#define MMISMS_SMS_FIXED_TEXT_BG_HEIGHT   28
#define MMISMS_CHAT_TEXT_MARGIN_LEFT  6
#define MMISMS_CHAT_TEXT_MARGIN_RIGHT 6
#define MMISMS_CHAT_TEXT_MARGIN_TOP  3
#define MMISMS_CHAT_TEXT_MARGIN_BOTTOM  2
#define MMISMS_CHAT_TEXT_LINE_SPACE    3
#define MMISMS_CHAT_FORM_VER_SPACE    6
#define MMISMS_SENDFAIL_DATE_TEXT_WIDTH   192
#define MMISMS_TEXT_LAYOUT_MARGIN_WIDTH   20
#define MMISMS_SMS_FIXED_SIM_RECT_WIDTH   34
#define MMISMS_SMS_EDIT_VER_MARGIN 6
#endif
...
typedef enum
{
    MMIMMS_ATTACHMENT_LIST_OPT_TYPE_VIEW,  //MMS View
    MMIMMS_ATTACHMENT_LIST_OPT_TYPE_REMOVE,//MMS Edit
    MMIMMS_ATTACHMENT_LIST_OPT_TYPE_MAX
} MMIMMS_ATTACHMENT_LIST_OPT_TYPE_E;

typedef void   (* ATTALISTINIT_CALLBACKFUNC)(MMI_CTRL_ID_T list_ctrl_id);
typedef void   (* ATTALISTOPT_CALLBACKFUNC)(MMIMMS_WINDOW_ID_E win_id, MMI_CTRL_ID_T list_ctrl_id, BOOLEAN is_all_items);

typedef struct
{
     MMIMMS_ATTACHMENT_LIST_OPT_TYPE_E    opt_type;
	ATTALISTINIT_CALLBACKFUNC init_callback_fun_ptr;
	ATTALISTOPT_CALLBACKFUNC opt_callback_fun_ptr;
    BOOLEAN is_allitems;
}MMIMMS_INIT_ATTA_LIST_DATA_T;
...
/*****************************************************************************/
//  Description :set is_share_pic_flag
//  Global resource dependence : 
//  Author:Yongli Tong
//  Note: 
/*****************************************************************************/
PUBLIC void MMIMMS_SetIsSharePicFlag(BOOLEAN flag);
...
/*****************************************************************************/
//  Description : show banner info ,using banner info instead of alert win
//  Global resource dependence : 
//  Author:rong.gu
//  Note:
/*****************************************************************************/
PUBLIC void MMIMMS_ShowBannerInfo(MMI_WIN_ID_T win_id,MMI_TEXT_ID_T text_id);
