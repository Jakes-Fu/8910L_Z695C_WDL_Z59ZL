...
typedef enum
{
    ...
    MMIMMS_EDIT_CONTACT_GROUPS_OPT_CTRL_ID,           
    //FOR MMS PREVIEW
    ...
    MMIMMS_MMS_ATTACHMENT_LIST_CTRL_ID,//atta list opt window --list ctrl id
    ...
    //arvin add begin
    MMIMMS_SMS_EDIT_CONTAINER_FORM_ID,//edit_container
    MMIMMS_SMS_EDIT_BODY_FORM_ID,//editor_main_body(text_form + shortcut_form)
    MMIMMS_SMS_EDIT_FOOTER_FORM_ID,//editor_footer(bg_img + leftnumber + IME_icon)
    MMIMMS_SMS_EDIT_UNDER_BACKGROUND_LABEL_CTL_ID,//editor_bgimg
    MMIMMS_SMS_EDIT_IME_OWNDRAW_CTL_ID,
    MMIMMS_SMS_EDIT_INPUT_LENGTH_OWNDRAW_CTL_ID,//

    MMIMMS_SMS_EDIT_SHORTCUT_INDICATOR_FORM_ID,//shortcut_indicator_form
    MMIMMS_SMS_EDIT_SHORTCUT_INDICATOR_CTL_ID,//shortcut_indicator_owndraw

	MMIMMS_SMS_EDIT_TEXT_PADDING_CTRL_ID,//temp pending for text 8px

    MMIMMS_SMS_EDIT_TEXT_FORM_ID,//create_new_sms_view_text_form
    MMIMMS_SMS_EDIT_SIM_AREA_FORM_ID,//sim_area_form
    MMIMMS_SMS_EDIT_MARGIN_FORM_ID,//margin_between_editor_and_simicon
    MMIMMS_SMS_EDIT_SIM_ICON_AREA_FORM_ID,//sim_icon_area_form
    MMIMMS_SMS_EDIT_SIM_GAP_FORM_ID,//sim_gap_form
    MMIMMS_SMS_EDIT_SIM_ICON_FORM_ID,//sim_icon_form
    MMIMMS_SMS_EDIT_SIM_ICON_BUTTON_ID,//sim_icon_button
    MMIMMS_SMS_EDIT_SIM_ICON_LABEL_ID, //sim_icon_label
    MMIMMS_SMS_EDIT_SIM_OWNDRAW_CTL_ID,//sim_icon_owndraw
    //arvin add end

    MMIMMS_SMS_EDIT_ELEMENT_AREA_FORM_ID,    
    MMIMMS_SMS_EDIT_ANIM_CTRL_ID, // anim input
    MMIMMS_SMS_EDIT_NONIMAGE_LABEL_ID,
    MMIMMS_SMS_EDIT_MORE_ATTA_LABEL_ID,
