...
RES_ADD_STRING(TXT_MMS_SETTING_RECV_OPT,"MMS Setting Receive Option!")
...
RES_ADD_STRING(STR_NOTIF_MMS,"New MMS")
RES_ADD_STRING(TXT_MMS_MAX_SLIDE,"Max. number of slides is 20")
RES_ADD_STRING(TXT_MMS_ONLY_TEXT,"No attachment")
...
RES_ADD_STRING(TXT_MMS_MULTIFILE_TOO_BIG_1K,"The file is big than 100k,cann't insert!")
...
RES_ADD_STRING(TXT_MMS_STXT_POS,"Text Position")
RES_ADD_STRING(TXT_MMS_STXT_POS_UP,"Text Up")
RES_ADD_STRING(TXT_MMS_STXT_POS_DOWN,"Text Down")

RES_ADD_STRING(TXT_MMS_NEW_MMS_PUSH,"new MMS notification")
RES_ADD_STRING(TXT_MMS_NEW_MMS_PUSHES,"new MMS notifications")

RES_ADD_STRING(TXT_MMS_STXT_SERVICE_DENIED,"User Is Not Exist")
//RES_ADD_STRING(TXT_MMS_STXT_NETLINK_FAILED,"Link Failed")        //replaced by common ID TXT_COMMON_LINK_FAILED
RES_ADD_STRING(TXT_MMS_STXT_FORMAT_CORRUPT,"Format Corrupt")
RES_ADD_STRING(TXT_MMS_STXT_ADDRESS_UNRESOLVED,"Address Unresolved")
RES_ADD_STRING(TXT_MMS_STXT_MESSAGE_NOT_FOUND,"Message Not Found")
//RES_ADD_STRING(TXT_MMS_STXT_SERVER_BUSY,"Server Busy")                      //replaced by common ID TXT_COMMON_STXT_SERVER_BUSY
RES_ADD_STRING(TXT_MMS_STXT_NOT_ACCEPTED,"Unaccepted")
RES_ADD_STRING(TXT_MMS_STXT_UNSUPORTED_MESSAGE,"Unsuported Message")

//RES_ADD_STRING(TXT_MMS_STXT_BOX_DETAIL,"Detail")    //replaced by common ID STXT_DETAIL
//RES_ADD_STRING(TXT_MMS_STXT_SIZE_BIG_FIFTY,"More Than 50k")//case 3:defined but not used
RES_ADD_STRING(TXT_MMS_STXT_PREPARE_DOWNLOAD,"Prepare Download")
//RES_ADD_STRING(TXT_MMS_STXT_LINK_LIST,"Link List")//case 3:defined but not used
...
RES_ADD_STRING(TXT_MMS_IF_ADJUST_PIC,"if adjust pic size")
RES_ADD_STRING(STR_MSG_MMS_ONE_RECIPIENT,"Only one recipient allowed for MMS")
...
RES_ADD_STRING(STR_MMS_HDR_MMS_SETTINGS, "MMS")
RES_ADD_STRING(STR_SIM1_MMS_APN_EXT01, "SIM1 access point")
RES_ADD_STRING(STR_SIM2_MMS_APN_EXT01, "SIM2 access point")
#ifdef MMI_MULTI_SIM_SYS_SINGLE
RES_ADD_STRING(STR_SIM_MMS_APN_EXT01, "SIM access point")
#endif
RES_ADD_STRING(STR_LIST_MMS_RECEPTION, "MMS reception")
RES_ADD_STRING(STR_MMS_SETT_RECEIVE_ADS, "Allow adverts")
RES_ADD_STRING(STR_HDR_MMS_RECEPTION, "MMS reception")
RES_ADD_STRING(STR_HDR_SIM1_MMS_APN_EX01, "SIM1 APN")
RES_ADD_STRING(STR_HDR_SIM2_MMS_APN_EX01, "SIM2 APN")
RES_ADD_STRING(STR_MSG_LIST_MMS_LOCAL_EXT01, "Local mode")
RES_ADD_STRING(STR_MSG_LIST_MMS_ROAMING_EXT01, "Roaming mode")
RES_ADD_STRING(STR_NOTE_REMOVE_ATTACHMENT_EXT01, "Remove this attachment?")
RES_ADD_STRING(STR_NOTE_REMOVE_ATTACHMENTS_EXT01, "Remove all attachments?")
RES_ADD_STRING(STR_MSG_LIST_MMS_ADS_EXT01, "Advertisement")
RES_ADD_STRING(STR_MSG_HDR_MMS_LOCAL_EXT01, "Local mode")
RES_ADD_STRING(STR_MSG_HDR_MMS_ROAMING_EXT01, "Roaming mode")
RES_ADD_STRING(STR_MSG_MMS_RECEIV_IMME_EXT01, "Receive immediately")
RES_ADD_STRING(STR_MSG_MMS_RECEIV_MANUAL_EXT01, "Receive manually")
RES_ADD_STRING(STR_MSG_MMS_RECEIV_DENY_EXT01, "Block reception")
RES_ADD_STRING(STR_DTAIL_TYPE_MMS,"MMS")
