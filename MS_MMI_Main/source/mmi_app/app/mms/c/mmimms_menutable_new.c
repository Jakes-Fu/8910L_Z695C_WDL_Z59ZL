...
const GUIMENU_ITEM_T menu_mms_inbox_mmsoption[] =
{
    ...
    STR_LOG_LIST_SAVE,  IMAGE_COMMON_OPTMENU_SAVE_CONTENT, 0, 0, MENU_MMS_EXTRACT_ADDTOPB_OPT},
#endif
...
#endif
    {ID_MMS_ADD2PB,  TIP_NULL, {TXT_NULL, TXT_NULL, TXT_NULL},
    STR_LOG_LIST_SAVE,  0, 0, 0, MENU_MMS_EXTRACT_ADDTOPB_OPT},
    {ID_MMS_SAVE_MEDIA_FILE,  TIP_NULL, {TXT_NULL, TXT_NULL, TXT_NULL},
...
const GUIMENU_ITEM_T menu_mms_extract[] =
{
    ...
    STR_POC_ILIST_OFF,  0, 0, 0, MENU_NULL},
};
...
{
    {ID_MMS_MENU_EXTRACT_ADDTOPB_NEW_ITEM_ID,TIP_NULL,{TXT_COMMON_OK, TXT_NULL, STXT_RETURN},STR_LOG_LIST_SAVE, 0, 0, 0, MENU_NULL},
#ifdef MMIPB_ADD_EXIST_CONTACT_SUPPORT
    {ID_MMS_MENU_EXTRACT_ADDTOPB_EXIST_ITEM_ID,TIP_NULL,{TXT_COMMON_OK, TXT_NULL, STXT_RETURN},STR_LIST_SAVE_CONTACT_EXT01, 0, 0, 0, MENU_NULL},
#endif
};
...
const GUIMENU_ITEM_T menu_mms_attach_subopt[] =
{
    ...
    {ID_MMS_INSERT_ATTACH_VCARD, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_COMMON_VCARD, 0, 0, 0, MENU_NULL},  
#endif
...
{
    {ID_MMS_SAVE_MMS_FILE, TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},STXT_SOFTKEY_SAVE_MK, 0, 0, 0, MENU_NULL},   
#ifdef SNS_SUPPORT
