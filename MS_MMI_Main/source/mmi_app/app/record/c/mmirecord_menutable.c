...
const GUIMENU_ITEM_T menu_record_start_option[] =
{
    ...
    {ID_RECORD_DELETE,			 TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},   TXT_DELETE,  0, 0, 0,  MENU_NULL},	//delete
#if defined (MMS_SUPPORT) || defined (BLUETOOTH_SUPPORT)
    {ID_RECORD_SEND,			 TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},   TXT_SEND,  0, 0, 0,  MENU_MULTIM_SEND_FILE},	  //send
#endif
    {ID_RECORD_INSERT,  TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},   TXT_RECORD_INSERT,  0, 0, 0,  MENU_NULL},//±‡º≠≤Â»Îrecordwork
    {ID_RECORD_LIST,		 TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},   TXT_COMMON_RECORD_FILE_LIST,  0, 0, 0,	MENU_NULL},    //œÍ«È
...
const GUIMENU_ITEM_T menu_record_start_option[] =
{
    ...
    {ID_RECORD_DELETE,			 TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},   TXT_DELETE,  IMAGE_COMMON_OPTMENU_DELETE, 0, 0,  MENU_NULL},	//delete
#if defined (MMS_SUPPORT) || defined (BLUETOOTH_SUPPORT)
    {ID_RECORD_SEND,			 TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},   TXT_SEND,  IMAGE_COMMON_OPTMENU_SEND, 0, 0,  MENU_MULTIM_SEND_FILE},	  //send
#endif
...
{
    {ID_RECORD_UDISK,			 TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},   STR_CAM_ILIST_MEMORY_PHN_MEMORY,  0, 0, 0, MENU_NULL},
#ifndef	 DUAL_TCARD_SUPPORT
	{ID_RECORD_UDISK +1,	 TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},   STR_ILIST_MEMORY_CARD_EXT01,  0, 0, 0,  MENU_NULL},
#else
	{ID_RECORD_UDISK +1,	 TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},   TXT_COMMON_SD_CARD0,  0, 0, 0,  MENU_NULL},
...
{
#ifdef MMS_SUPPORT
    {ID_RECORD_SEND_BY_MMS, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN}, TXT_MMS, 0, 0, 0, MENU_NULL},
#endif
#ifdef BLUETOOTH_SUPPORT
