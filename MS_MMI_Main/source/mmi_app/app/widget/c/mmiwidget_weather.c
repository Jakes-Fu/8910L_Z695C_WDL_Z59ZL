...
LOCAL MMIWIDGET_WEATHER_HOT_RECT_ITEM_T s_func_list_table[] = {
    ...
    {MMIWIDGET_WEATHER_HANDLE_BROWSER, OpenBrowserMainWin, STR_ILIST_INTERNET_EXT01},
#ifdef QQ_SUPPORT
...
LOCAL void WeatherSetWin_SetCtrlParam(MMIWIDGET_WEATHER_SET_WIN_TYPE_E win_type)
{
    ...
    case MMIWIDGET_WEATHER_SET_WIN_TYPE_BG_TEXTCOLOUR:
        {
            MMI_TEXT_ID_T          bg_type_text_id[] = {STR_POC_ILIST_OFF, TXT_OPEN};
            MMI_TEXT_ID_T          text_colour_text_id[] = {TXT_WIDGET_WEATHER_STXT_COLOUR_WHITE, TXT_WIDGET_WEATHER_STXT_COLOUR_BLACK};
#ifdef MMI_PDA_SUPPORT
...
LOCAL void BarPhoneWeather_DisplaySoftkey(MMI_WIN_ID_T    win_id, BOOLEAN is_update)
{
    ...
    {
        case NEED_ADD_CITY:
            MMIWIDGET_SoftkeySetTextId(win_id, STXT_SOFTKEY_ADD_MK, is_update);
            break;
        case NEED_UPDATE_WEATHER:
