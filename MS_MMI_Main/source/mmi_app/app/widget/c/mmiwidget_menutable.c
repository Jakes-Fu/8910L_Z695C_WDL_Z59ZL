...
{
	    {ID_WIDGET_SEND_SMS, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_SMS, 0, 0, 0, NULL},
#ifdef MMS_SUPPORT
	    {ID_CWIDGET_SEND_MMS, TIP_NULL, {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN},TXT_MMS, 0, 0, 0, NULL},
#endif
};
