...
typedef enum
{
    ...
    MMIENG_NV_TEST_MODE_SETTING,
    MMIENG_NV_FORBID_ALL_GPRS_DATA,
    MMIENG_NV_USB_TEST_SET_SETTING,
    MMIENG_NV_ESD_TEST_SET_SETTING,
#ifdef ENG_SECONDEDAC_SUPPORT
    MMIENG_NV_SECONDDAC_ID,
#endif    
#if defined ENG_NETWORK_SET //zhouqin
    MMIENG_NV_NETWORK_SIM1,
    MMIENG_NV_NETWORK_SIM2,
#endif
