...
LOCAL const uint16 mmieng_nv_len_tab[] =
{
    ...
    sizeof(BOOLEAN),//MMIENG_NV_TEST_MODE_SETTING
    sizeof(BOOLEAN),//MMIENG_NV_FORBID_ALL_GPRS_DATA
    sizeof(USB_SERVICE_E),//MMIENG_NV_USB_TEST_SET_SETTING
    sizeof(BOOLEAN),//MMIENG_NV_ESD_TEST_SET_SETTING
#ifdef ENG_SECONDEDAC_SUPPORT
    sizeof(BOOLEAN),  //MMIENG_NV_SECONDDAC_ID 
#endif
#ifdef ENG_NETWORK_SET //zhouqin 
    sizeof(MMIENG_NETWORK_T),
    sizeof(MMIENG_NETWORK_T),
#endif
