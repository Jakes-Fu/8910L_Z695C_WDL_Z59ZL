...
{
    {ID_VP_OPEN,     TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_COMM_OPEN,     		0, 0, 0, MENU_VP_OPEN_OPT},
    {ID_VP_VIEW,     TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_VIEW,           0, 0, 0, MENU_VP_VIEW_OPT},
   // {ID_VP_SETTING,  TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_VP_SETTING,        0, 0, 0, NULL},
    {ID_VP_FILEATTR, TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_VP_FILEATTR,      0, 0, 0, NULL},
    //{ID_VP_FLOWRATE, TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_VP_FLOWRATE,      0, 0, 0, NULL}
};

const GUIMENU_ITEM_T menu_vp_setting_as_opt[] = 
{
#ifdef SCREENSAVER_SUPPORT
    {ID_VP_SCEENSAVE,   TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},    TXT_COMMON_SCREENSAVE,0, 0, 0, NULL},
#endif
    {ID_VP_POWER_ON_SET,  TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},  TXT_COMMON_POWER_ON_ANIMATION,   0, 0, 0, NULL},
    {ID_VP_POWER_OFF_SET, TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN},  TXT_COMMON_POWER_OFF_ANIMATION,  0, 0, 0, NULL},
...
const GUIMENU_ITEM_T menu_vp_set_opt[]=
{
  //  {ID_VP_SET_REPEATE_MODE,     TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_COMMON_REPEAT,         0, 0, 0, NULL},
   // {ID_VP_SET_PLAY_MODE,      TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_PLAY_MODE_SETTING,           0, 0, 0, NULL},
     ...
     {ID_VP_SET_NET1,              TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_COMMON_SET_NET_SIM1,           0, 0, 0, NULL},
     {ID_VP_SET_NET2,              TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_COMMON_SET_NET_SIM2,           0, 0, 0, NULL},
#if defined(MMI_MULTI_SIM_SYS_TRI)||defined(MMI_MULTI_SIM_SYS_QUAD)
    {ID_VP_SET_NET3,              TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_COMMON_SET_NET_SIM3,           0, 0, 0, NULL},
#endif
#if defined(MMI_MULTI_SIM_SYS_QUAD)
    {ID_VP_SET_NET4,              TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_COMMON_SET_NET_SIM4,           0, 0, 0, NULL},
#endif
#else
    {ID_VP_SET_NET,              TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_NETWORK_CONNECT_SET,           0, 0, 0, NULL},
#endif
	{ID_VP_SET_PLAYBACK_MODE,    TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_VP_SET_PLAY_METHOD,           0, 0, 0, NULL},
    {ID_VP_SET_RTCP_RTP,         TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_VP_SET_RTCP,           0, 0, 0, NULL},
    {ID_VP_SET_AGENT,            TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_COMM_PROXY,           0, 0, 0, NULL},
#ifdef BROWSER_SUPPORT  
     {ID_VP_FLOWRATE, TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_COMMON_FLOW_STATISTICS,      0, 0, 0, NULL},
#endif
#endif 
     {ID_VP_SET_RESET,            TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_COMMON_SET_RESET,           0, 0, 0, NULL},
...
const GUIMENU_ITEM_T menu_vp_bookmark_opt[] =
{
    ...
    {ID_VP_DELETE_ALL,          TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_DELALL,           0, 0, 0, NULL},
 //   {ID_VP_DELETE,     TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_DELETE,     		0, 0, 0, MENU_VP_DELETE_OPT},
    {ID_VP_OPERATER,     TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_OPERATE,     		0, 0, 0, MENU_VP_OPERATER_OPT},
    {ID_VP_OPEN,     TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_COMM_OPEN,     		0, 0, 0, MENU_VP_OPEN_OPT},
    {ID_VP_VIEW,     TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_VIEW,           0, 0, 0, MENU_VP_VIEW_OPT},
 //   {ID_VP_SETTING,  TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_VP_SETTING,        0, 0, 0, NULL},
 //   {ID_VP_FLOWRATE, TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_VP_FLOWRATE,      0, 0, 0, NULL},
...
{  
    {ID_VP_OPEN,     TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_COMM_OPEN,     		0, 0, 0, MENU_VP_OPEN_OPT},
   // {ID_VP_ADD, TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_VP_ADD_VIDEO,        0, 0, 0, NULL},
  ...
  //  {ID_VP_DELETE, TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_VP_DEL_LOCALLIST,        0, 0, 0, NULL},
    {ID_VP_SETTING_AS, TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_COMMON_SETTING_AS,        0, 0, 0, MENU_VP_SETTING_AS_OPT},
 //   {ID_VP_MARK_OPT, TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, STXT_MARK,        0, 0, 0, MENU_VP_MARK_OPT},
  //  {ID_VP_SETTING,  TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_VP_SETTING,        0, 0, 0, NULL},    
...
{
    {ID_VP_SUB_MARK,           TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, STXT_MARK,           0, 0, 0, NULL},
    {ID_VP_CANCEL_MARK,    TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_CANCEL_MARK,    0, 0, 0, NULL},
    {ID_VP_MARK_ALL,       TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_MARK_ALL,       0, 0, 0, NULL},
    {ID_VP_CANCEL_ALL_MARK,TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_CANCEL_MARK_ALL,0, 0, 0, NULL}
};
//#endif
#else //PDA style menu
...
const GUIMENU_ITEM_T menu_vp_net_url_opt[] =
{
    {ID_VP_OPEN,     TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_COMM_OPEN,   IMAGE_NULL, 0, 0, MENU_VP_OPEN_OPT},
    {ID_VP_VIEW,     TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_VIEW,   IMAGE_NULL, 0, 0, MENU_VP_VIEW_OPT},
    {ID_VP_FILEATTR, TIP_NULL, {TXT_COMMON_OK, TXT_NULL, STXT_RETURN}, TXT_VP_FILEATTR, IMAGE_NULL, 0, 0, NULL}
};
