...
extern  uint8 g_videoplayer_mode ;
#endif
/*---------------------------------------------------------------------------*/
                                   ...
                                   )
{
	...
	if( 1 == g_videoplayer_mode )
	{
		dir_ptr = VP_KING_01_DIR;
		dir_len = VP_KING_01_DIR_LEN;	
	}
	else if( 2 == g_videoplayer_mode )
	{
		dir_ptr = VP_KING_02_DIR;
		dir_len = VP_KING_02_DIR_LEN;	
	}
	else if( 3 == g_videoplayer_mode )
	{
		dir_ptr = VP_KING_03_DIR;
		dir_len = VP_KING_03_DIR_LEN;	
	}
	else if( 4 == g_videoplayer_mode )
	{
		dir_ptr = VP_KING_04_DIR;
		dir_len = VP_KING_04_DIR_LEN;	
	}
	else if( 5 == g_videoplayer_mode )
	{
		dir_ptr = VP_KING_05_DIR;
		dir_len = VP_KING_05_DIR_LEN;	
	}
	else if( 6 == g_videoplayer_mode )
	{
		dir_ptr = VP_KING_06_DIR;
		dir_len = VP_KING_06_DIR_LEN;	
	}
	else
#endif
	{
