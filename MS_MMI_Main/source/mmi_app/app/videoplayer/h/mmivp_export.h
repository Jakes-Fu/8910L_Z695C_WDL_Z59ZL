...
#define VP_KING_01_DIR              MMIMULTIM_DIR_VIDEO_KING_01
#define VP_KING_01_DIR_LEN          MMIAPICOM_Wstrlen(MMIMULTIM_DIR_VIDEO_KING_01) 
#define VP_KING_02_DIR              MMIMULTIM_DIR_VIDEO_KING_02 
#define VP_KING_02_DIR_LEN          MMIAPICOM_Wstrlen(MMIMULTIM_DIR_VIDEO_KING_02) 
#define VP_KING_03_DIR              MMIMULTIM_DIR_VIDEO_KING_03
#define VP_KING_03_DIR_LEN          MMIAPICOM_Wstrlen(MMIMULTIM_DIR_VIDEO_KING_03) 
#define VP_KING_04_DIR              MMIMULTIM_DIR_VIDEO_KING_04  
#define VP_KING_04_DIR_LEN          MMIAPICOM_Wstrlen(MMIMULTIM_DIR_VIDEO_KING_04) 
#define VP_KING_05_DIR              MMIMULTIM_DIR_VIDEO_KING_05
#define VP_KING_05_DIR_LEN          MMIAPICOM_Wstrlen(MMIMULTIM_DIR_VIDEO_KING_05)
#define VP_KING_06_DIR              MMIMULTIM_DIR_VIDEO_KING_06
#define VP_KING_06_DIR_LEN          MMIAPICOM_Wstrlen(MMIMULTIM_DIR_VIDEO_KING_06) 
#endif
////文件的后处理操作 
...
/*****************************************************************************/
PUBLIC BOOLEAN MMIAPIVP_FSMCompulsivePause(VP_HANDLE  vp_handle);
...
/*****************************************************************************/
//  Description : 用于判断视频播放器对该视频文件的支持程度通过文件buffer
//  Global resource dependence :  none
//  Author: apple.zhang
//  Note: 
/*****************************************************************************/
PUBLIC VP_SUPPORTED_STATUS_TYPE_E MMIAPIVP_GetSupportedStatusByBuf(
                        uint8                   *video_buf,
                     uint32                  video_length,
                     MMICOM_VIDEO_TYPE_E         video_type
                );
