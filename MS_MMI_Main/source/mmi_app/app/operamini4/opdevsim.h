...
typedef OD_MMI_TASK OD_STATUS (*OD_GetNativeString_func_t)(OD_NativeStringID nativeStringID, char* buffer, int bufferSize);
...
struct OpDevFunc
{
	...
	OD_GetNativeString_func_t  __OD_GetNativeString;
...
#define OD_GetNativeString  getOpDevFuncs()->__OD_GetNativeString
