...
#ifndef OD_7701_SUPPORT
	WIN_TITLE(TXT_EDIT),
#else
	WIN_TITLE(STR_OPERA_BROWSER_EXT01),
...
#else
	WIN_SOFTKEY(STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_SOFTKEY_DELETE_MK),
#endif /* OD_7701_SUPPORT */
#ifdef PLATFORM_SC6600L
...
static WINDOW_TABLE(OPERA_PASSWD_EDIT_WINDOW_TABLE) =
{
	...
	CHILD_SOFTKEY_CTRL(STXT_OK, TXT_NULL, STXT_RETURN, MMICOMMON_SOFTKEY_CTRL_ID, OPERA_PASSWD_EDITOR_FORM_ID),
#else /* MMI_PDA_SUPPORT */
#ifndef OD_7701_SUPPORT
