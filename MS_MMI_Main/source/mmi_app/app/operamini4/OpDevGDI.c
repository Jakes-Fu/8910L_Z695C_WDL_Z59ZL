...
OD_ScreenMode OD_GetScreenMode(OD_Context *context)
{
    ...
    ang = OD_GetRotationAngle(context);
...
OD_STATUS OD_ToggleFullScreen(OD_Context *context, int bFullScreen, OD_BOOL force)
{
	...
	if(bFullScreen == context->data.gdi.fullScreen && !force)
	{
