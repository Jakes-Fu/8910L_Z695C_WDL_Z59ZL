 ...
 * @param[in] force reset fu.ll screen despite current settings.
 * @return OD_SUCCESS if the operation is successful, or the appropriate
 *         error code from the OD_Error enumeration.
 */
OD_MMI_TASK OD_STATUS OD_ToggleFullScreen(OD_Context *context, OD_BOOL bFullScreen, OD_BOOL force);
