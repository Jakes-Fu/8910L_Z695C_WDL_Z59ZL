...
#define MMIPB_FIXED_RING_FLAG          (uint8)0x80 //wang.qinggang 0x20 -> 0x80
#define MMIPB_FIXED_RING_FLAG_CLEAN    (uint8)0x7F //wang.qinggang 0xdf -> 0x7f

#define MMIPB_FIXED_RING_ID_MASK       (uint8)0x3F //wang.qinggang 0x0f -> 0x3f
#define MMIPB_FIXED_RING_ID_CLEAN      (uint8)0xC0 //wang.qinggang 0xf0 -> 0xc0
...
typedef struct
{
    ...
    uint32  o365_modifiedTime;//Office365 联系人的修改时间(新增)------"2015-06-16T02:20:23Z"
    uint32  phone_modifiedTime;// 联系人的手机修改时间 (新增)------"2015-06-16T02:20:23Z"
#endif
...
typedef struct _MMIPB_NAME_LETTERS_T
{
    ...
    wchar   full_letters[(MMIPB_NAME_MAX_LEN*6 + 1)*2];   // 全拼串
    uint16  head_letters_len;                   // 首字符串长度
    wchar   head_letters[(MMIPB_NAME_MAX_LEN +1)*2];   //首字符串 
