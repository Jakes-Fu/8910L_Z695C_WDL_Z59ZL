...
//#define PB_UI_UNISOC_DEBUG

#ifdef PB_UI_UNISOC_DEBUG
#define PB_UNISOC_DEBUG SCI_TRACE_LOW
#else /*PB_UI_UNISOC_DEBUG*/
#ifdef WIN32
#define PB_UNISOC_DEBUG MMIPB_DebugEmpty
#else
#define PB_UNISOC_DEBUG(...)
#endif
...
typedef enum
{
    MMIPB_LOAD_SIM_CONTACT_READY=0x0, 
    MMIPB_RELEASE_SIM_CONTACT = 0x1,
    MMIPB_LOADING_SIM_CONTACT = 0x2,
    MMIPB_LOAD_SIM_CONTACT_INIT = 0x3,
}MMIPB_LOAD_SIM_CONTACT_STATUS_E;
...
typedef struct 
{
    ...
    uint16      split_num;//
    wchar       search_str[MMIPB_NAME_MAX_LEN+2];
   ...
   // BOOLEAN     is_not_need_open_pb;
    ...
    uint16 operate_type; //MMIPB_OPERATE_TYPE_E
    uint16 all_count;
    uint16 finish_count;
    BOOLEAN  is_set_preferred_sim;
    #ifdef MMIPB_SYNC_WITH_O365
    uint16 del_entry_id;
    uint16 del_storage_id;
