...
#define PB_UI_GENERATE_STR_MAX_LEN 200
/**--------------------------------------------------------------------------*
 **                         TYPE AND CONSTANT                                *
 **--------------------------------------------------------------------------*/
...
}MMIPB_SETTINGS_SORT_BY_LIST_INDEX;
...
}MMIPB_SETTINGS_MEMORY_LIST_INDEX;
#endif
...
typedef struct _MMIPB_SYNC_UPDATE_T
{
	MMIPB_OPC_E opc;
	uint16 entry_id;
	uint16 storage_id;
