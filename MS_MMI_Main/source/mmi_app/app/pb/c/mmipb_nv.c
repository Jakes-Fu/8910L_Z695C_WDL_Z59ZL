...
const uint16 pb_nv_len[] =
{
	4,	//dummy, no use MMINV_PHONEBOOK_DISPLAY_MODE
        ...
        sizeof(BOOLEAN), //MMINV_PHONEBOOK_SORT_BY_SURNAME,
        sizeof(BOOLEAN), //MMINV_PHONEBOOK_NEED_CREATE_GROUP,
        sizeof(BOOLEAN), //MMINV_PHONEBOOK_FIRST_ENTER,
        sizeof(BOOLEAN), //MMINV_PHONEBOOK_DISPLAY_DEBUG_MENU,
        //PB_Sync start
#ifdef MMIPB_SYNC_WITH_O365	
	sizeof(BOOLEAN), //MMINV_PHONEBOOK_FIRST_SYNC
	sizeof(BOOLEAN), //MMINV_PHONEBOOK_MSA_SIGN_IN
	sizeof(BOOLEAN), //MMINV_PHONEBOOK_HEARTBEAT
	sizeof(uint32), //MMINV_PHONEBOOK_HEAVY_SYNCEDTIME
	sizeof(uint32), //MMINV_PHONEBOOK_LIGHT_SYNCEDTIME
	sizeof(uint32), //MMINV_PHONEBOOK_HEAVY_LASTCOUNT
#endif
	//PB_Sync end
#ifdef MMIPB_SIMCONTACT_SUPPORT //SETTINGS_NV_PHONEBOOK_MEMSTATUS
	sizeof(uint32)
#endif
};
