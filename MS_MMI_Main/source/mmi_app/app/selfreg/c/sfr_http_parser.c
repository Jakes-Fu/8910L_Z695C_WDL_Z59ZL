...
#ifdef ENABLE_HTTPC
#define HTTP_SIG_INIT_CNF HTTPC_SIG_INIT_CNF
#define HTTP_SIG_REQUEST_ID_IND HTTPC_SIG_REQUEST_ID_IND
#define HTTP_SIG_ERROR_IND HTTPC_SIG_ERROR_IND
#define HTTP_SIG_HEADER_IND HTTPC_SIG_HEADER_IND
#define HTTP_SIG_DATA_IND HTTPC_SIG_DATA_IND
#define HTTP_SIG_POST_CNF HTTPC_SIG_POST_CNF
#define HTTP_SIG_CLOSE_CNF HTTPC_SIG_CLOSE_CNF

#define HTTP_APP_PARAM_T HTTPC_APP_PARAM_T
#define HTTP_SUCCESS HTTPC_SUCCESS
#define HTTP_RESPONSE_CODE_OK HTTPC_RESPONSE_CODE_OK
#define HTTP_RESPONSE_CODE_PARTIAL_CONTENT HTTPC_RESPONSE_CODE_PARTIAL_CONTENT
#define HTTP_DATA_TRANS_STYLE_BUFFER HTTPC_DATA_TRANS_STYLE_BUFFER

#define HTTP_INIT_CNF_SIG_T HTTPC_INIT_CNF_SIG_T
#define HTTP_REQUEST_ID_IND_SIG_T HTTPC_REQUEST_ID_IND_SIG_T
#define HTTP_HEADER_IND_SIG_T HTTPC_HEADER_IND_SIG_T
#define HTTP_DATA_IND_SIG_T HTTPC_DATA_IND_SIG_T
#define HTTP_POST_CNF_SIG_T HTTPC_POST_CNF_SIG_T
#define HTTP_CLOSE_CNF_SIG_T HTTPC_CLOSE_CNF_SIG_T
#define HTTP_ERROR_IND_SIG_T HTTPC_ERROR_IND_SIG_T
#endif
...
#ifdef ENABLE_HTTPC
    if (http_context_ptr->context_id != signal.context_id || signal.app_instance != MMI_MODULE_SFR)
#else
