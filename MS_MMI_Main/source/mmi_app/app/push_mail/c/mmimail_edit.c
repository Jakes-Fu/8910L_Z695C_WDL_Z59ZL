...
//    	GUIEDIT_SetSoftkey(ctrl_id, 0, 1, STXT_MAIN_PB, STXT_SOFTKEY_OK_MK, PNULL);//set left softkey
...
LOCAL BOOLEAN SetEditAccList(MMI_CTRL_ID_T ctrl_id, MAIL_MESSAGE_T *editbody_ptr)
{
    ...
    {
        MMIMAIL_AppendEmptyStr2List(ctrl_id, TXT_BLANK, STXT_SOFTKEY_ADD_MK);
    }
