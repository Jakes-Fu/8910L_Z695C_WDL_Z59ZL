                                               ...
                                               )
{
    ...
    case MSG_OPEN_WINDOW:
        ...
        GUIWIN_SetSoftkeyTextId(win_id, STXT_SOFTKEY_SAVE_MK, TXT_EDIT, STXT_RETURN, TRUE);
        MMK_SetAtvCtrl(win_id, ctrl_id); 
        break;
    ...
    case MSG_NOTIFY_RICHTEXT_SWITCHFOCUS_BY_KEY:
        ...
        {
            GUIWIN_SetSoftkeyTextId(win_id, STXT_SOFTKEY_SAVE_MK, TXT_NULL, STXT_RETURN, TRUE);
        }
        break;
                                      ...
                                      )
{
    ...
    case MSG_OPEN_WINDOW:
        ...
        MMIAPISET_AppendListItemByTextId( TXT_YES, STXT_SOFTKEY_OK_MK, ctrl_id, GUIITEM_STYLE_ONE_LINE_RADIO );
        MMIAPISET_AppendListItemByTextId( TXT_COMM_NO, STXT_SOFTKEY_OK_MK, ctrl_id, GUIITEM_STYLE_ONE_LINE_RADIO );
                                  ...
                                  )
{
    ...
    //MMIFMM_SOFTKEY_TEXT_T sk_text_id = {STXT_SOFTKEY_OK_MK, TXT_NULL, STXT_RETURN};
    ...
    openwin_info.sk_text_id.leftsoft_id = STXT_SOFTKEY_SAVE_MK;
...
PUBLIC BOOLEAN MMIMAILPDP_Active(uint32 account_id, MMIPDP_MSG_CALLBACK callback_func)
{
    ...
    app_info.ip_type   = setting_detail_ptr.ip_type;
#endif
