...
#define CREATE_HEADER_AND_DIVIDER_CTRL(_CTRL_ID_)\
	    MMK_CREATE_HEADER_AND_DIVIDER, _CTRL_ID_ 

#define CREATE_SPINNER_CTRL(_CTRL_ID_)\
	    MMK_CREATE_SPINNER, _CTRL_ID_ 
...
// create the prgbox control
#define CHILD_PRGBOX_CTRL(_IS_GET_ACTIVE_, _PRGBOX_TYPE_, _CTRL_ID_, _PARENT_CTRL_ID_) \
        CREATE_CHILD_PRGBOX, _IS_GET_ACTIVE_, _PRGBOX_TYPE_, _CTRL_ID_, _PARENT_CTRL_ID_

//#define CHILD_HEADER_AND_DIVIDER_CTRL(_IS_GET_ACTIVE_, _CTRL_ID_, _PARENT_CTRL_ID_)\
//	    CREATE_CHILD_HEADER_AND_DIVIDER,_IS_GET_ACTIVE_, _CTRL_ID_, _PARENT_CTRL_ID_ 

//#define CHILD_SPINNER_CTRL(_IS_GET_ACTIVE_, _CTRL_ID_, _PARENT_CTRL_ID_)\
//	    CREATE_CHILD_SPINNER, _IS_GET_ACTIVE_, _CTRL_ID_, _PARENT_CTRL_ID_ 
...
typedef enum parse_child_ctrl_tag
{
    ...
    CREATE_CHILD_COMBOX,
	CREATE_CHILD_PRGBOX,
//    CREATE_CHILD_HEADER_AND_DIVIDER,
//    CREATE_CHILD_SPINNER,
    LAST_CHILD
