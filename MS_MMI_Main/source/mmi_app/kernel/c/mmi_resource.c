...
#define BOOKMARK_ITEM_MCC_OFFSET 0x0
#define BOOKMARK_ITEM_MNC_OFFSET 0x2
#define BOOKMARK_ITEM_NAME_LEN_OFFSET 0x04
#else
...
#endif
#ifndef MULTI_VARIANT_SUPPORT
/*lint -save -e785 */
const BOOLEAN s_lang_status_info[MMISET_MAX_LANGUAGE + 1][2] =
{
...
MMISET_LANG_SET_T s_lang_set[MMISET_MAX_LANGUAGE + 1] =
{
    ...
    /*English*/
    {{0x0045,0x006E,0x0067,0x006C,0x0069,0x0073,0x0068}, TRUE},
    ...
    /*Arabic*/
#ifdef IM_ARABIC_SUPPORT
    {{0x0627,0xFEDF,0xFECC,0xFEAD,0xFE91,0xFEF4,0xFE94}, TRUE},
#else
    {{0x0627,0xFEDF,0xFECC,0xFEAD,0xFE91,0xFEF4,0xFE94}, FALSE},
#endif
    ...
    /*Indonesian*/
#ifdef IM_INDONESIAN_SUPPORT
    {{0x0049,0x006E,0x0064,0x006F,0x006E,0x0065,0x0073,0x0069,0x0061}, TRUE},
#else
    {{0x0049,0x006E,0x0064,0x006F,0x006E,0x0065,0x0073,0x0069,0x0061}, FALSE},
#endif

    /*Malaysian*/
#ifdef IM_MALAY_SUPPORT
    {{0x004D,0x0065,0x006C,0x0061,0x0079,0x0075}, TRUE},
#else
    {{0x004D,0x0065,0x006C,0x0061,0x0079,0x0075}, FALSE},
#endif
    ...
    /*IM_PERSIAN_SUPPORT*/
#ifdef IM_PERSIAN_SUPPORT
    {{0x0641,0x0627,0x0631,0x0633,0x06cc}, TRUE}, 
#else
    {{0x0641,0x0627,0x0631,0x0633,0x06cc}, FALSE}, 
#endif
    ...
    /*Telugu*/
#ifdef IM_TELUGU_SUPPORT
    {{0x0C24,0x0C46,0x0C32,0x0C41,0x0C17,0x0C41}, TRUE},
#else
    {{0x0C24,0x0C46,0x0C32,0x0C41,0x0C17,0x0C41}, FALSE},
#endif

    /*Marathi*/
#ifdef IM_MARATHI_SUPPORT
    {{0x092E,0x0930,0x093E,0x0920,0x0940}, TRUE},
#else
    {{0x092E,0x0930,0x093E,0x0920,0x0940}, FALSE},
#endif

    /*Tamil*/
#ifdef IM_TAMIL_SUPPORT
    {{0x0BA4,0x0BAE,0x0BBF,0x0BB4,0x0BCD}, TRUE},
#else
    {{0x0BA4,0x0BAE,0x0BBF,0x0BB4,0x0BCD}, FALSE},
#endif

    /*Gujarati*/
#ifdef IM_GUJARATI_SUPPORT
    {{0x0A97,0x0AC1,0x0A9C,0x0AB0,0x0ABE,0x0AA4,0x0AC0}, TRUE},
#else
    {{0x0A97,0x0AC1,0x0A9C,0x0AB0,0x0ABE,0x0AA4,0x0AC0}, FALSE},
#endif

    /*Kannada*/
#ifdef IM_KANNADA_SUPPORT
    {{0x0C95,0x0CA8,0x0CCD,0x0CA8,0x0CA1}, TRUE},
#else
    {{0x0C95,0x0CA8,0x0CCD,0x0CA8,0x0CA1}, FALSE},
#endif

    /*Malayalam*/
#ifdef IM_MALAYALAM_SUPPORT
    {{0x0D2E,0x0D32,0x0D2F,0x0D3E,0x0D33,0x0D02}, TRUE},
#else
    {{0x0D2E,0x0D32,0x0D2F,0x0D3E,0x0D33,0x0D02}, FALSE},
#endif

    /*Oriya*/
#ifdef IM_ORIYA_SUPPORT
    {{0x0B13,0x0B21,0x0B3F,0x0B06}, TRUE},
#else
    {{0x0B13,0x0B21,0x0B3F,0x0B06}, FALSE},
#endif

    /*Punjabi*/
#ifdef IM_PUNJABI_SUPPORT
    {{0x0A2A,0x0A70,0x0A1C,0x0A3E,0x0A2C,0x0A40}, TRUE},
#else
    {{0x0A2A,0x0A70,0x0A1C,0x0A3E,0x0A2C,0x0A40}, FALSE},
#endif

    /*Afrikaans*/
#ifdef IM_AFRIKAANS_SUPPORT
    {{0x0041,0x0066,0x0072,0x0069,0x006B,0x0061,0x0061,0x006E,0x0073}, TRUE},
#else
    {{0x0041,0x0066,0x0072,0x0069,0x006B,0x0061,0x0061,0x006E,0x0073}, FALSE},
#endif

    /*Albanian*/
#ifdef IM_ALBANIAN_SUPPORT
    {{0x0053,0x0068,0x0071,0x0069,0x0070}, TRUE},
#else
    {{0x0053,0x0068,0x0071,0x0069,0x0070}, FALSE},
#endif

    /*Armenian*/
#ifdef IM_ARMENIAN_SUPPORT
    {{0x0540,0x0561,0x0575,0x0565,0x0580,0x0565,0x0576}, TRUE},
#else
    {{0x0540,0x0561,0x0575,0x0565,0x0580,0x0565,0x0576}, FALSE},
#endif

    /*Azerbaijani*/
#ifdef IM_AZERBAIJANI_SUPPORT
    {{0x0041,0x007A,0x0259,0x0072,0x0069}, TRUE},
#else
    {{0x0041,0x007A,0x0259,0x0072,0x0069}, FALSE},
#endif
    ...
    /*Bulgarian*/
#ifdef IM_BULGARIAN_SUPPORT
    {{0x0411,0x044A,0x043B,0x0433,0x0430,0x0440,0x0441,0x043A,0x0438}, TRUE},
#else
    {{0x0411,0x044A,0x043B,0x0433,0x0430,0x0440,0x0441,0x043A,0x0438}, FALSE},
#endif
    ...
    /*Croatian*/
#ifdef IM_CROATIAN_SUPPORT
    {{0x0048,0x0072,0x0076,0x0061,0x0074,0x0073,0x006B,0x0069}, TRUE},
#else
    {{0x0048,0x0072,0x0076,0x0061,0x0074,0x0073,0x006B,0x0069}, FALSE},
#endif

    /*Danish*/
#ifdef IM_DANISH_SUPPORT
    {{0x0044,0x0061,0x006E,0x0073,0x006B}, TRUE},
#else
    {{0x0044,0x0061,0x006E,0x0073,0x006B}, FALSE},
#endif

    /*Dutch*/
#ifdef IM_DUTCH_SUPPORT
    {{0x004E,0x0065,0x0064,0x0065,0x0072,0x006C,0x0061,0x006E,0x0064,0x0073}, TRUE},
#else
    {{0x004E,0x0065,0x0064,0x0065,0x0072,0x006C,0x0061,0x006E,0x0064,0x0073}, FALSE},
#endif

    /*Estonian*/
#ifdef IM_ESTONIAN_SUPPORT
    {{0x0045,0x0065,0x0073,0x0074,0x0069}, TRUE},
#else
    {{0x0045,0x0065,0x0073,0x0074,0x0069}, FALSE},
#endif
    ...
    /*Finnish*/
#ifdef IM_FINNISH_SUPPORT
    {{0x0053,0x0075,0x006F,0x006D,0x0069}, TRUE},
#else
    {{0x0053,0x0075,0x006F,0x006D,0x0069}, FALSE},
#endif
    ...
    /*Georgian*/
#ifdef IM_GEORGIAN_SUPPORT
    {{0x10E5,0x10D0,0x10E0,0x10D7,0x10E3,0x10DA,0x10D8}, TRUE},
#else
    {{0x10E5,0x10D0,0x10E0,0x10D7,0x10E3,0x10DA,0x10D8}, FALSE},
#endif

    /*Hausa*/
#ifdef IM_HAUSA_SUPPORT
    {{0x0048,0x0061,0x0075,0x0073,0x0061}, TRUE},/*Hausa*/
#else
    {{0x0048,0x0061,0x0075,0x0073,0x0061}, FALSE},/*Hausa*/
#endif

    /*Icelandic*/
#ifdef IM_ICELANDIC_SUPPORT
    {{0x00CD,0x0073,0x006C,0x0065,0x006E,0x0073,0x006B,0x0061}, TRUE},
#else
    {{0x00CD,0x0073,0x006C,0x0065,0x006E,0x0073,0x006B,0x0061}, FALSE},
#endif

    /*Igbo*/
#ifdef IM_IGBO_SUPPORT
    {{0x0049,0x0067,0x0062,0x006F}, TRUE},
#else
    {{0x0049,0x0067,0x0062,0x006F}, FALSE},
#endif
    ...
    /*Kazakh*/
#ifdef IM_KAZAKH_SUPPORT
    {{0x049a,0x0430,0x0437,0x0430,0x049b,0x0448,0x0430}, TRUE},
#else
    {{0x049a,0x0430,0x0437,0x0430,0x049b,0x0448,0x0430}, FALSE},
#endif

    /*Latvian*/
#ifdef IM_LATVIAN_SUPPORT
    {{0x004C,0x0061,0x0074,0x0076,0x0069,0x0065,0x0161,0x0075}, TRUE},
#else
    {{0x004C,0x0061,0x0074,0x0076,0x0069,0x0065,0x0161,0x0075}, FALSE},
#endif

    /*Lithuanian*/
#ifdef IM_LITHUANIAN_SUPPORT
    {{0x004C,0x0069,0x0065,0x0074,0x0075,0x0076,0x0069,0x0173}, TRUE},
#else
    {{0x004C,0x0069,0x0065,0x0074,0x0075,0x0076,0x0069,0x0173}, FALSE},
#endif

    /*Macedonian*/
#ifdef IM_MACEDONIAN_SUPPORT
    {{0x041C,0x0430,0x043A,0x0435,0x0434,0x043E,0x043D,0x0441,0x043A,0x0438}, TRUE},
#else
    {{0x041C,0x0430,0x043A,0x0435,0x0434,0x043E,0x043D,0x0441,0x043A,0x0438}, FALSE},
#endif
    ...
    /*Norwegian*/
#ifdef IM_NORWEGIAN_SUPPORT
    {{0x004E,0x006F,0x0072,0x0073,0x006B}, TRUE},
#else
    {{0x004E,0x006F,0x0072,0x0073,0x006B}, FALSE},
#endif

    /*Polish*/
#ifdef IM_POLISH_SUPPORT
    {{0x0050,0x006F,0x006C,0x0073,0x006B,0x0069}, TRUE},
#else
    {{0x0050,0x006F,0x006C,0x0073,0x006B,0x0069}, FALSE},
#endif

    /*Serbian*/
#ifdef IM_SERBIAN_SUPPORT
    {{0x0053,0x0072,0x0070,0x0073,0x006B,0x0069}, TRUE},
#else
    {{0x0053,0x0072,0x0070,0x0073,0x006B,0x0069}, FALSE},
#endif

    /*Sotho*/
#ifdef IM_SESOTHO_SUPPORT
    {{0x0053,0x0065,0x0073,0x006F,0x0074,0x0068,0x006F}, TRUE},
#else
    {{0x0053,0x0065,0x0073,0x006F,0x0074,0x0068,0x006F}, FALSE},
#endif

    /*Slovak*/
#ifdef IM_SLOVAK_SUPPORT
    {{0x0053,0x006C,0x006F,0x0076,0x0065,0x006E,0x010D,0x0069,0x006E,0x0061}, TRUE},
#else
    {{0x0053,0x006C,0x006F,0x0076,0x0065,0x006E,0x010D,0x0069,0x006E,0x0061}, FALSE},
#endif

    /*Swedish*/
#ifdef IM_SWEDISH_SUPPORT
    {{0x0053,0x0076,0x0065,0x006E,0x0073,0x006B,0x0061}, TRUE},
#else
    {{0x0053,0x0076,0x0065,0x006E,0x0073,0x006B,0x0061}, FALSE},
#endif

    /*Ukrainian*/
#ifdef IM_UKRAINIAN_SUPPORT
    {{0x0423,0x043A,0x0440,0x0430,0x0457,0x043D,0x0441,0x044C,0x043A,0x0430}, TRUE},
#else
    {{0x0423,0x043A,0x0440,0x0430,0x0457,0x043D,0x0441,0x044C,0x043A,0x0430}, FALSE},
#endif

    /*Yoruba*/
#ifdef IM_YORUBA_SUPPORT
    {{0x0059,0x006F,0x0072,0x00F9,0x0062,0x00E1}, TRUE},
#else
    {{0x0059,0x006F,0x0072,0x00F9,0x0062,0x00E1}, FALSE},
#endif

    /*Xhosa*/
#ifdef IM_XHOSA_SUPPORT
    {{0x0049,0x0073,0x0069,0x0058,0x0068,0x006F,0x0073,0x0061}, TRUE},
#else
    {{0x0049,0x0073,0x0069,0x0058,0x0068,0x006F,0x0073,0x0061}, FALSE},
#endif

    /*Zulu*/
#ifdef IM_ZULU_SUPPORT
    {{0x0049,0x0073,0x0069,0x005A,0x0075,0x006C,0x0075}, TRUE},
#else
    {{0x0049,0x0073,0x0069,0x005A,0x0075,0x006C,0x0075}, FALSE},
#endif

    /*Assamese*/
#ifdef IM_ASSAMESE_SUPPORT
    {{0x0985,0x09B8,0x09AE,0x09C0,0x09DF,0x09BE}, TRUE},
#else
    {{0x0985,0x09B8,0x09AE,0x09C0,0x09DF,0x09BE}, FALSE},
#endif

    /*Swahili*/
#ifdef IM_SWAHILI_SUPPORT
    {{0x004B,0x0069,0x0073,0x0077,0x0061,0x0068,0x0069,0x006C,0x0069}, TRUE},
#else
    {{0x004B,0x0069,0x0073,0x0077,0x0061,0x0068,0x0069,0x006C,0x0069}, FALSE},
#endif
    ...
    /*Khmer*/
#ifdef IM_KHMER_SUPPORT
    {{0x1797,0x17B6,0x179F,0x17B6,0x1781,0x17D2,0x1798,0x17C2,0x179A}, TRUE},
#else
    {{0x1797,0x17B6,0x179F,0x17B6,0x1781,0x17D2,0x1798,0x17C2,0x179A}, FALSE},
#endif

    /*Laos*/
#ifdef IM_LAO_SUPPORT
    {{0x0EC0,0x0EA1,0x0EB7,0x0EAD,0x0E87,0x0EA5,0x0EB2,0x0EA7}, TRUE},
#else
    {{0x0EC0,0x0EA1,0x0EB7,0x0EAD,0x0E87,0x0EA5,0x0EB2,0x0EA7}, FALSE},
#endif
    ...
    /*Sinhala*/
#ifdef IM_SINHALESE_SUPPORT
    {{0x0DC3,0x0DD2,0x0D82,0x0DC4,0x0DBD}, TRUE},
#else
    {{0x0DC3,0x0DD2,0x0D82,0x0DC4,0x0DBD}, FALSE},
#endif

    /*Bosnian*/
#ifdef IM_BOSNIAN_SUPPORT
    {{0x0042,0x006F,0x0073,0x0061,0x006E,0x0073,0x006B,0x0069}, TRUE},
#else
    {{0x0042,0x006F,0x0073,0x0061,0x006E,0x0073,0x006B,0x0069}, FALSE},
#endif

    /*Chinese Traditional(HK)*/
#ifdef IM_TRAD_CHINESE_HK_SUPPORT
    {{0x7E41,0x9AD4,0x4E2D,0x6587 ,0x0028,0x9999,0x6E2F,0x0029}, TRUE},
#else
    {{0x7E41,0x9AD4,0x4E2D,0x6587 ,0x0028,0x9999,0x6E2F,0x0029}, FALSE},
#endif

    /*English-US*/
#ifdef IM_ENGLISH_US_SUPPORT
    {{0x0055,0x0053,0x0020,0x0045,0x006E,0x0067,0x006C,0x0069,0x0073,0x0068}, TRUE},
#else
    {{0x0055,0x0053,0x0020,0x0045,0x006E,0x0067,0x006C,0x0069,0x0073,0x0068}, FALSE},
#endif

    /*Portuguese-BR*/
#ifdef IM_PORTUGUESE_BR_SUPPORT
    {{0x0042,0x0052,0x0020,0x0050,0x006F,0x0072,0x0074,0x0075,0x0067,0x0075,0x00EA,0x0073}, TRUE},
#else
    {{0x0042,0x0052,0x0020,0x0050,0x006F,0x0072,0x0074,0x0075,0x0067,0x0075,0x00EA,0x0073}, FALSE},
#endif

    /*Portuguese*/
#ifdef IM_TURKMEN_LATIN_SUPPORT
    {{L"Turkmen-latin"}, TRUE},
#else
    {{L"Turkmen-latin"}, FALSE},
#endif

    /*Spanish-AM*/
#ifdef IM_SPANISH_AM_SUPPORT
    {{0x004C,0x0041,0x0020,0x0045,0x0073,0x0070,0x0061,0x00F1,0x006F,0x006C}, TRUE},
#else
    {{0x004C,0x0041,0x0020,0x0045,0x0073,0x0070,0x0061,0x00F1,0x006F,0x006C}, FALSE},
#endif

    /* Belarus */
#ifdef IM_BELARUS_SUPPORT
    {{0x0431,0x0435,0x043B,0x0430,0x0440,0x0443,0x0441,0x043A,0x0430,0x044F}, TRUE},
#else
    {{0x0431,0x0435,0x043B,0x0430,0x0440,0x0443,0x0441,0x043A,0x0430,0x044F}, FALSE},
#endif
    ...
    {{0x067E,0x069A,0x062A,0x0648}, TRUE},//pashto和pushto均为普什图语
#else
    {{0x067E,0x069A,0x062A,0x0648}, FALSE},//pashto和pushto均为普什图语
#endif
...
/*lint -restore */
#else
BOOLEAN s_lang_status_info[MMISET_MAX_LANGUAGE + 1][2] = 
{
#ifdef MMI_SIM_LANGUAGE_SUPPORT
    {MMISET_LANGUAGE_AUTO,FALSE},// is different with "MMISET_LANG_SET_T" define!!
#endif
    ...
    {MMISET_LANGUAGE_TIBETAN, FALSE},
    {MMISET_LANGUAGE_SINHALESE, FALSE},
    {MMISET_LANGUAGE_BOSNIAN, FALSE},
    {MMISET_LANGUAGE_TRAD_CHINESE_HK, FALSE},
    {MMISET_LANGUAGE_AMERICAN, FALSE},
    {MMISET_LANGUAGE_PORTUGUESE_BR, FALSE},
    {MMISET_LANGUAGE_TURKMEN_LATIN, FALSE},
    {MMISET_LANGUAGE_SPANISH_AM, FALSE},
    {MMISET_LANGUAGE_BELARUS, FALSE},
    {MMISET_LANGUAGE_LINGALA, FALSE},
    {MMISET_LANGUAGE_MALAGASY, FALSE},
    {MMISET_LANGUAGE_PASHTO, FALSE},
    {MMISET_LANGUAGE_UZBEK, FALSE},
    {MMISET_LANGUAGE_BENGALI_BD, FALSE},
    {MMISET_LANGUAGE_TEST, FALSE},    
    {0 , 0}
};
...
MMISET_LANG_SET_T s_lang_set[MMISET_MAX_LANGUAGE + 1] =
{
    ...
    {{0x0045,0x006E,0x0067,0x006C,0x0069,0x0073,0x0068}, TRUE},
#else
	{{0x0045,0x006E,0x0067,0x006C,0x0069,0x0073,0x0068}, FALSE},
#endif
...
BOOLEAN s_lang_T9_status_info[MMISET_MAX_LANGUAGE+1][2]=
{
#ifdef MMI_SIM_LANGUAGE_SUPPORT
    {MMISET_LANGUAGE_AUTO,FALSE},// is different with "MMISET_LANG_SET_T" 
#endif
    ...
    {MMISET_LANGUAGE_TIBETAN, FALSE},	
    {MMISET_LANGUAGE_SINHALESE, TRUE},
    {MMISET_LANGUAGE_BOSNIAN, TRUE},
    {MMISET_LANGUAGE_TRAD_CHINESE_HK, TRUE},
    {MMISET_LANGUAGE_AMERICAN, TRUE},
    {MMISET_LANGUAGE_PORTUGUESE_BR, TRUE},
    {MMISET_LANGUAGE_TURKMEN_LATIN, FALSE},
    {MMISET_LANGUAGE_SPANISH_AM, TRUE},
    {MMISET_LANGUAGE_BELARUS, FALSE},
    {MMISET_LANGUAGE_LINGALA, FALSE},
    {MMISET_LANGUAGE_MALAGASY, FALSE},
    {MMISET_LANGUAGE_PASHTO, TRUE},
    {MMISET_LANGUAGE_UZBEK, TRUE},
    {MMISET_LANGUAGE_BENGALI_BD, TRUE},
    {0 , 0}
};
...
#ifndef VECTOR_FONT_SUPPORT_ETRUMP
//显示缓冲区
#define VECTOR_BUFFER_SIZE (48*1024)//16800
...
LOCAL void TextDestructCallback(MMI_LINK_NODE_T const * node_ptr)
{
    ...
    RES_FREE((uint8*)module_ptr->unit_offset_arry); /*lint !e63*/
    RES_FREE((uint8*)module_ptr); /*lint !e63*/
}
/*****************************************************************************/
//  Description : print res table info
//  Global resource dependence : none
...
LOCAL void NodeDestructCallback(MMI_LINK_NODE_T const * node_ptr)
{
    ...
    RES_FREE((uint8*)res_node_ptr);  /*lint !e63*/
}
...
LOCAL void FreeDynResNodeByHandle(CAF_HANDLE_T handle_id)
{
    ...
    RES_NODE_DATA_T * res_node_ptr = PNULL;
    uint32 i = 0; 
    uint32 nodes_num = MMILINK_GetListNodesNum(GetDLinkHeadPtr());

    SCI_TRACE_LOW("[RES]: FreeDynResNodeByHandle: handle_id=%d, nodes_num=%d", handle_id, nodes_num);
    ...
    do
    {
        ...
        else
        {
            ...
            SCI_TRACE_LOW("[RES]: FreeDynResNodeByHandle, free end, free_node_ptr=0x%x", free_node_ptr);
        }
        i++;
    }
    while((PNULL != free_node_ptr) && (i < nodes_num));
    SCI_TRACE_LOW("[RES]: FreeDynResNodeByHandle: i=%d, free_node_ptr=0x%x", i, free_node_ptr);
    ...
    if(PNULL != res_info_ptr)
    {
        if(res_info_ptr->is_caf_resource) //caf application resource
        {
            for(i = 0; i < res_info_ptr->res_module_total; i ++)
            {
                ...
                {
                    RES_FREE((uint8*)res_info_ptr->caf_image_module_arry[i].common_info_arry);  /*lint !e63*/
                ...
                {
                    RES_FREE((uint8*)res_info_ptr->caf_anim_module_arry[i].common_info_arry);  /*lint !e63*/
                ...
                {
                    RES_FREE((uint8*)res_info_ptr->caf_ring_module_arry[i].common_info_arry);  /*lint !e63*/
        ...
        else
        {
            if(RES_STORE_FLASH_NOR != res_info_ptr->res_location.store_type)
            {
                for(i = 0; i < res_info_ptr->res_module_total; i ++)
                {
                    RES_FREE((uint8*)res_info_ptr->anim_module_arry[i].unit_info_arry); /*lint !e63*/
                    RES_FREE((uint8*)res_info_ptr->image_module_arry[i].unit_info_arry);  /*lint !e63*/
                    RES_FREE((uint8*)res_info_ptr->ring_module_arry[i].unit_info_arry);  /*lint !e63*/
                    RES_FREE((uint8*)res_info_ptr->data_module_arry[i].unit_info_arry);   /*lint !e63*/
                }

                RES_FREE((uint8*)res_info_ptr->res_brief_ptr); /*lint !e63*/
                RES_FREE((uint8*)res_info_ptr->res_module_arry); /*lint !e63*/
                RES_FREE((uint8*)res_info_ptr->anim_module_arry); /*lint !e63*/
                RES_FREE((uint8*)res_info_ptr->image_module_arry); /*lint !e63*/
                RES_FREE((uint8*)res_info_ptr->ring_module_arry); /*lint !e63*/
                RES_FREE((uint8*)res_info_ptr->data_module_arry); /*lint !e63*/
                if(PNULL != res_info_ptr->text_prj_module_link_ptr)
                {
                    MMILINK_DestroyLink((MMI_LINK_NODE_T*)res_info_ptr->text_prj_module_link_ptr, TextDestructCallback);
                }
...
//        count = color_module_info.color_number;
        ...
        {
            RES_FREE((uint8*)module_data_ptr); /*lint !e63*/
        }
    }
}
...
LOCAL void LoadTextRes(CAF_RES_T *pRes )
{
    ...
    //if ( PNULL != ksp_text_ptr)
    {
        RES_FREE((uint8*)ksp_text_ptr); /*lint !e63*/
        ksp_text_ptr = PNULL;
    }
}
                      ...
                      )
{
    ...
    {
#if defined (MMI_RES_OUTSIDE_SUPPORT) || defined (QBTHEME_SUPPORT)
...
//  Note:
/*****************************************************************************/
PUBLIC const wchar* MMIRES_GetEnglishText(
                                   MMI_TEXT_ID_T      text_id,     //[in] the text id
                                   CAF_HANDLE_T       handle_id,
                                   MMI_STRING_T       *str_ptr
                                   )    //[out] the data of text
{
    ...
    else
    {
        ...
        {
            caf_res_ptr = s_appoint_res_ptr;
            re_str_ptr = GetText(caf_res_ptr, convert_text_id, GetCurLangIndex(MMISET_LANGUAGE_ENGLISH));
        }
...
//  Note:
/*****************************************************************************/
LOCAL BOOLEAN MMIRES_GetMulNVConfigInfo(MMI_MULCONFIG_INFO_T * config_info)
{
    ...
    {
        config_info->flag[i] = 0xFF;
    }
#else

#define LP_CODE "QA"
    if(0 == strncmp(LP_CODE,"AW", 2))
    {
        // LANGUAGE_AW_SUPPORT
        config_info->flag[MMISET_LANGUAGE_DUTCH] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_GERMAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_ROMANIAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_RUSSIAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_TURKISH] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_POLISH] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_BULGARIAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_HUNGARIAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_GREEK] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_CZECH] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_SLOVAK] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_CROATIAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_SLOVENIAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_BOSNIAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_SERBIAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_ALBANIAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_MACEDONIAN] = 0xFF;
    }
    else if(0 == strncmp(LP_CODE,"AX", 2))
    {
        // LANGUAGE_AX_SUPPORT
        config_info->flag[MMISET_LANGUAGE_FINNISH] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_SWEDISH] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_DANISH] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_NORWEGIAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_ICELANDIC] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_LITHUANIAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_RUSSIAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_LATVIAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_ESTONIAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_GERMAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_FRENCH] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_TURKISH] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_DUTCH] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_ITALIAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_PORTUGUESE] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_SPANISH] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_ROMANIAN] = 0xFF;
        
    }
    else if(0 == strncmp(LP_CODE,"AY", 2))
    {
        // LANGUAGE_AY_SUPPORT
        config_info->flag[MMISET_LANGUAGE_RUSSIAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_ROMANIAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_UKRAINIAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_KAZAKH] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_AZERBAIJANI] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_HEBREW] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_ARABIC] = 0xFF;
        
    }
    else if(0 == strncmp(LP_CODE,"ID", 2))
    {
        // LANGUAGE_ID_SUPPORT
        config_info->flag[MMISET_LANGUAGE_XHOSA] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_ZULU] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_AFRIKAANS] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_PORTUGUESE] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_FRENCH] = 0xFF;
    }
    else if(0 == strncmp(LP_CODE,"IJ", 2))
    {
        // LANGUAGE_IJ_SUPPORT
        config_info->flag[MMISET_LANGUAGE_URDU] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_PERSIAN] = 0xFF;
    }
    else if(0 == strncmp(LP_CODE,"IX", 2))
    {
        // LANGUAGE_IX_SUPPORT
        config_info->flag[MMISET_LANGUAGE_AMHARIC] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_ARABIC] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_FRENCH] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_GERMAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_HINDI] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_URDU] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_SPANISH] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_HAUSA] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_IGBO] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_PORTUGUESE] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_SWAHILI] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_YORUBA] = 0xFF;
    }
    else if(0 == strncmp(LP_CODE,"MH", 2))
    {
        // LANGUAGE_MH_SUPPORT
        config_info->flag[MMISET_LANGUAGE_HINDI] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_PUNJABI] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_MARATHI] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_GUJARATI] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_TAMIL] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_TELUGU] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_KANNADA] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_MALAYALAM] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_URDU] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_ASSAMESE] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_ORIYA] = 0xFF;
    }
    else if(0 == strncmp(LP_CODE,"MV", 2))
    {
        // LANGUAGE_MV_SUPPORT
        config_info->flag[MMISET_LANGUAGE_HINDI] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_TAMIL] = 0xFF;
    }
    else if(0 == strncmp(LP_CODE,"MX", 2))
    {
        // LANGUAGE_MX_SUPPORT
    config_info->flag[MMISET_LANGUAGE_SIMP_CHINESE] = 0xFF;
    config_info->flag[MMISET_LANGUAGE_TRAD_CHINESE] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_TAGALOG] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_THAI] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_MALAY] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_INDONESIAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_TAMIL] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_VIETNAMESE] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_KHMER] = 0xFF;
    }
    else if(0 == strncmp(LP_CODE,"OG", 2))
    {
        // LANGUAGE_OG_SUPPORT
        config_info->flag[MMISET_LANGUAGE_DUTCH] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_FRENCH] = 0xFF;
    ...
    else if(0 == strncmp(LP_CODE,"UA", 2))
    {
        // LANGUAGE_UA_SUPPORT
        config_info->flag[MMISET_LANGUAGE_AMERICAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_FRENCH] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_DUTCH] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_SPANISH_AM] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_PORTUGUESE_BR] = 0xFF;
    }
    else if(0 == strncmp(LP_CODE,"QA", 2))
    {
        // LANGUAGE_QA_SUPPORT
        config_info->flag[MMISET_LANGUAGE_SIMP_CHINESE] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_TRAD_CHINESE_HK] = 0x0;
    }
    else if(0 == strncmp(LP_CODE,"QB", 2))
    {
        // LANGUAGE_QB_SUPPORT
        config_info->flag[MMISET_LANGUAGE_SIMP_CHINESE] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_TRAD_CHINESE_HK] = 0xFF;
    }
    else if(0 == strncmp(LP_CODE,"IO", 2))
    {
        // RUSSIAN UZBEK FRENCH HAUSA IGBO YORUBA HINDI 
        config_info->flag[MMISET_LANGUAGE_RUSSIAN] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_UZBEK] = 0xFF;
	 config_info->flag[MMISET_LANGUAGE_FRENCH] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_HAUSA] = 0xFF;
	 config_info->flag[MMISET_LANGUAGE_IGBO] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_YORUBA] = 0xFF;	
	...
	else if(0 == strncmp(LP_CODE,"ZZZZ", 4))
    {
        // LANGUAGE_QC_SUPPORT
        config_info->flag[MMISET_LANGUAGE_ENGLISH] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_SIMP_CHINESE] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_TRAD_CHINESE] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_TEST] = 0xFF;
    }
	else if(0 == strncmp(LP_CODE,"EI", 4))
    {
        // LANGUAGE_QC_SUPPORT
        config_info->flag[MMISET_LANGUAGE_BELARUS] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_YORUBA] = 0xFF;
        config_info->flag[MMISET_LANGUAGE_ENGLISH] = 0xFF;
    }
...
{
    //如果将来支持希伯来文, 需要加上或判断
    return ( s_lang_status_info[MMISET_LANGUAGE_ARABIC][1]
        || s_lang_status_info[MMISET_LANGUAGE_PERSIAN][1]
        || s_lang_status_info[MMISET_LANGUAGE_URDU][1]
        || s_lang_status_info[MMISET_LANGUAGE_HEBREW][1]);
}
...
PUBLIC BOOLEAN MMIRES_LoadBookmarkFromRes(MMIRES_BOOKMARK_INFO_T *res_info_ptr)
{
	...
	//SCI_TRACE_LOW("baokun MMIRES_LoadBookmarkFromRes enter");
#ifdef CMCC_UI_STYLE
        ...
        else if (PNULL != res_info_ptr)
        {
            ...
            else
            {
                ...
                for (i = 0; i < bookmark_num; i++)
                {
                    ...
                    //get MCC
					mcc = *(uint16 *)(file_info.data_ptr + offset_addr + BOOKMARK_ITEM_MCC_OFFSET);
				//get MNC
                       mnc = *(uint16 *)(file_info.data_ptr + offset_addr + BOOKMARK_ITEM_MNC_OFFSET);

			if(cur_plmn.mcc != mcc || cur_plmn.mnc != mnc)
			{
				SCI_TRACE_LOW("MMIRES_LoadBookmarkFromRes not find ! cur_plmn.mcc %d cur_plmn.mnc %dmcc %d mnc %d", cur_plmn.mcc, cur_plmn.mnc, mcc, mnc);
				continue;
			}
#else
					index = i;
                    ...
                    res_info_ptr->res_item_ptr[index].name_len = MIN(MMIBROWSER_BOOKMARK_MAX_TITLE_LENGTH, len);
                    if(res_info_ptr->res_item_ptr[index].name_len > 0)
                    {                        

                        res_info_ptr->res_item_ptr[index].name = SCI_ALLOC_APPZ((res_info_ptr->res_item_ptr[index].name_len + 1) * sizeof(wchar));
                     }

#if defined(__BIG_ENDIAN) || defined(__BigEndian)
                    for (j = 0; j < res_info_ptr->res_item_ptr[index].name_len; j++)
                    {
                        res_info_ptr->res_item_ptr[index].name[j] = ((name_ptr[j]<< 8)&0xFF00) + ((name_ptr[j]>>8)&0x00FF);
                    }
#else
                    MMI_WSTRNCPY(res_info_ptr->res_item_ptr[index].name, res_info_ptr->res_item_ptr[index].name_len, name_ptr, res_info_ptr->res_item_ptr[index].name_len, res_info_ptr->res_item_ptr[index].name_len);
#endif
                    ...
                    //get url
                    res_info_ptr->res_item_ptr[index].url = (const char *)(file_info.data_ptr + offset_addr + data_offset + BOOKMARK_ITEM_URL_LENGTH);
                   len = strlen(res_info_ptr->res_item_ptr[index].url);
                    res_info_ptr->res_item_ptr[index].url_len = MIN(MMIBROWSER_BOOKMARK_MAX_URL_LENGTH, len);
...
#ifdef MULIT_VARIANT_SUPPORT
                   if(res_info_ptr->res_item_ptr[index].url_len > 0 ||res_info_ptr->res_item_ptr[index].name_len > 0) 
                    {
			    index++;
                    }
#endif
...
#ifdef MULIT_VARIANT_SUPPORT
				//mimatch from multi-variant, read from NDT
				SCI_TRACE_LOW("MMIRES_LoadBookmarkFromRes index %d", index);
				if(index ==0)
				{				          
					    MMIRES_UnloadBookmarkInfo(res_info_ptr);
						MMI_DNT_ReadBookMark(res_info_ptr);
				}
#endif
            }
        }
    ...
    else
    {
       // is_res_data_exist = FALSE;
         MMIRES_UnloadBookmarkInfo(res_info_ptr);
	  is_res_data_exist = MMI_DNT_ReadBookMark(res_info_ptr);
    }
...
#endif
/*****************************************************************************/
//  Description : Init multi-language Info
//  Global resource dependence : none
//  Author:
//  Note:
/*****************************************************************************/
PUBLIC void MMIRES_InitMultilanguageInfo(void)
{
#ifdef MULTI_VARIANT_SUPPORT
    uint32 i = 0;
//#ifndef WIN32
    MMI_MULCONFIG_INFO_T    config_info = {0};

    MMIRES_GetMulNVConfigInfo(&config_info);
    for(i = 0;i < MMISET_MAX_LANGUAGE;i++)
    {
        if((config_info.flag[i]>>2)&1)
        {
#if 0//def MMI_SIM_LANGUAGE_SUPPORT
            s_lang_status_info[i + 1][1] = TRUE;
            s_lang_set[i + 1].lang_status = TRUE;
#else
            s_lang_status_info[i][1] = TRUE;
            s_lang_set[i].lang_status = TRUE;
#endif
        }
    }
//#endif
