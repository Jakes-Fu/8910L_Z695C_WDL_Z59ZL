...
/*****************************************************************************/
// Description : create header and divider
// Global resource dependence : 
// Author:
// Note:
/*****************************************************************************/
LOCAL BOOLEAN CreateHeaderAndDividerCtrl(
    MMI_HANDLE_T win_handle,
    uint32**      value_pptr
    );
...
// Note:
/*****************************************************************************/
LOCAL BOOLEAN CreateSpinnerCtrl(
    MMI_HANDLE_T win_handle,
    uint32**      value_pptr
    );
...
LOCAL const MMK_WIN_KEYWORD_INFO_T MMKParseInfo[] =
{
    ...
    { MAKE_WIN_KEYWORD(MMK_CREATE_HEADER_AND_DIVIDER, CreateHeaderAndDividerCtrl, DummyParse1,  1) },   
    { MAKE_WIN_KEYWORD(MMK_CREATE_SPINNER,       CreateSpinnerCtrl,      DummyParse1,           1) },   
                         ...
                         )
{
    ...
    *value_pptr = value_ptr;
    ...
    // check the priority
    if ( win_priority > WIN_THREE_LEVEL)/*lint !e685 */
    {
...
/*****************************************************************************/
// Description : create header and divider ctrl
// Global resource dependence : 
// Author: eason huang
// Note:
/*****************************************************************************/
                                ...
                                )
{
    ...
    MMI_CTRL_ID_T               ctrl_id = 0;
    MMI_CONTROL_CREATE_T        ctrl_create = {0};
    GUIHEADERANDDIVIDER_INIT_DATA_T      init_data = {0};
...
//    init_data.both_rect = MMITHEME_GetWinClientBothRect(win_handle);
    ...
    //set control param
    ctrl_create.ctrl_id           = ctrl_id;
    ctrl_create.guid              = SPRD_GUI_HEADERANDDIVIDER_ID;
    ctrl_create.parent_win_handle = win_handle;
    ctrl_create.init_data_ptr     = &init_data;
...
/*****************************************************************************/
// Description : create spinner control
// Global resource dependence : 
// Author: sherry huang
// Note:
/*****************************************************************************/
                                ...
                                )
{
    ...
    init_data.both_rect = MMITHEME_GetWinClientBothRect(win_handle);
    init_data.is_spinner = TRUE;

    //set control param
    ctrl_create.ctrl_id           = ctrl_id;
    ctrl_create.guid              = SPRD_GUI_ANIM_ID;
    ctrl_create.parent_win_handle = win_handle;
    ctrl_create.init_data_ptr     = &init_data;
