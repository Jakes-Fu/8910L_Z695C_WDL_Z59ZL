...
#ifndef WIN32
void MNPHONE_GetCEMode(uint8* pMode, uint8 dual_sys)
{
	return;
}
void MNPHONE_SetCEMode(uint8 nMode, uint8 dual_sys)
{
	return;
}
void MNPHONE_GetVoicePrefer(uint8* pVoicePrefer, uint8 dual_sys)
{
	return;
}
void MNPHONE_SetVoicePrefer(uint8 nVoicePrefer, uint8 dual_sys)
{
	return;
}
void MNPHONE_SetLteLockFreq(uint8 number, uint32 * freq, uint8  dual_sys)
{
	return;
}
void MNPHONE_GetLteLockFreq(uint8 * number, uint32 * freq, uint8  dual_sys)
{
	return;
}
void MNPHONE_SetLteLockBand(uint8 number, uint16 * band, uint8  dual_sys)
{
	return;
}
void MNPHONE_GetLteLockBand(uint8 * number, uint16 * band, uint8  dual_sys)
{
	return;
}
void MNPHONE_SetGsmBand(uint8 nBand, uint8 dual_sys)
{
	return;
}
void MNPHONE_GetGsmBand(uint8* pBand, uint8 dual_sys)
{
	return;
}
void MNPHONE_SetRat(uint8 nRat, uint8 dual_sys)
{
	return;
}
uint8 MNPHONE_GetRat(uint8 dual_sys)
{
	return 0;
}
#endif
