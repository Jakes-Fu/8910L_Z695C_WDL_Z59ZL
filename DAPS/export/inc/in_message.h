 ...
 ** 01/09/2008     li.li            Create.                                   *
 ** 02/01/2008	   shulin.chang		Add wchar fucntion                        *
 ******************************************************************************/
...
#define DAPS_MEESAGE_GROUP DAPS_GROUP1
...
typedef enum _DAPS_SIGNAL
{
    ...
    HTTPC_SIG_GET_CNF,
    HTTPC_SIG_ERROR_IND,
    HTTPC_SIG_NEED_AUTH_IND,
    HTTPC_SIG_NEED_AUTH_RSP,
    HTTPC_SIG_HEADER_IND,
    HTTPC_SIG_HEADER_RSP,
    HTTPC_SIG_DATA_IND,
    HTTPC_SIG_REQUEST_ID_IND,
    HTTPC_SIG_SSL_CERT_UNTRUST_IND,
    HTTPC_SIG_SSL_CERT_UNTRUST_RSP,
    HTTPC_SIG_SSL_GET_CERT_REQ,
    HTTPC_SIG_SSL_GET_CERT_CNF,
    HTTPC_SIG_TIMEOUT_IND,
    HTTPC_SIG_RECV_PROGRESS_TIMEOUT_IND,
    HTTPC_SIG_HANDSHAKE_TIMEOUT_IND,
    HTTPC_SIG_DELETE_REQ,
    HTTPC_SIG_DELETE_CNF,
    HTTPC_SIG_POST_REQ,
    HTTPC_SIG_POST_CNF,
    HTTPC_SIG_END,
#endif
    ...
    OAUTH_SIG_TOKEN_IND,
    OAUTH_SIG_WK_302,
    OAUTH_SIG_REFRESH_TOKEN_IND,
    OAUTH_SIG_SIGNOFF_IND,
    OAUTH_SIG_END,         
#endif
    //poc
    POC_SIG_BEGIN,
...
//For wsp
	...
	WSP_SIG_CACHE_CLEAR_REQ,
	WSP_SIG_CACHE_CLEAR_CNF,
    WSP_SIGNAL_END,
//for wsp end
	NETMGR_SIGNAL_START,
...
//rtp test signal end
    ...
    DRM_SIG_IO_GET_FILE_RIGHTS,      //encrpt read sd file
    ...
    DRM_SIG_CANCEL_INSTALL_FILE_REQ,       // DRM CANCEL INSTALL FILE
    DRM_SIG_CANCEL_INSTALL_FILE_CNF,       // DRM CANCEL INSTALL FILE
    DRM_SIG_DH_DELETE_RIGHTS_FILE_REQ,  //delete rights file request
    DRM_SIG_DH_DELETE_RIGHTS_FILE_CNF,  //delete rights file cnf
    DRM_SIG_END,
    SNTP_SIG_BEGIN,
    SNTP_SIG_GET_TIME_REQ,
    SNTP_SIG_GET_TIME_CNF,
    SNTP_SIG_UDP_SOCKET_TIMER_IND,
    SNTP_SIG_END
    
#ifdef HERO_ENGINE_SUPPORT
	,HERO_ENGINE_SIGNAL_BEG,
	HERO_SIGNAL_ASYN_HOSTNAME,
	HERO_ENGINE_SIGNAL_END
#endif
#ifdef HERO_QR_DECODE_SUPPORT
	,HERO_QRDECODE_MOUDLE_SIGNAL_BEG,
	HERO_QRDECODE_MOUDLE_SIGNAL_EVENT,
	HERO_QRDECODE_MOUDLE_SIGNAL_END
#endif
