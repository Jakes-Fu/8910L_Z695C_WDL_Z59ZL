...
#define TCP_PEERACKED       0x2005  /* peer acked bytes in current TCP connection */
...
/* The macro IP_V6 can not be deleted.
 *  It is useful for application.
 *  They only include fie "socket_types.h"
 *  
 */
#define IP_V6 1
