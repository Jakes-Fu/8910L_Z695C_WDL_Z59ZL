...
typedef struct tagSt_SecRsaPrivateKey
{
    ...
    WE_UCHAR        ucReserved; /* four bytes align */
...
typedef enum tagE_WeRsaSigType
{
    ...
    E_WE_RSA_PKCS1_MD5,
    E_WE_RSA_PKCS1_SHA1,
    E_WE_RSA_PKCS1_DEFAULT = 0xFFFFFFFF /* four bytes align */
}E_WeRsaSigType;
...
typedef enum tagE_PadKeyType
{
    ...
    E_PAD_PRIVATE, 
    E_PAD_PUBLIC,
    E_PAD_DEFAULT = 0xFFFFFFFF /* four bytes align */
} E_PadKeyType;
...
typedef enum tagE_RsaPadMethod
{
    ...
    E_RSA_PAD_OAEPPKCS1,
    E_RSA_PAD_OAEPSET1,
    E_RSA_PAD_DEFAULT = 0xFFFFFFFF /* four bytes align */
} E_RsaPadMethod;
...
typedef enum tagE_Result
{
    E_FALSE, 
    E_TRUE ,
    E_RESULT_DEFAULT = 0xFFFFFFFF /* four bytes align */
} E_Result;
...
typedef enum tagE_RsaKTag
{
    ...
    E_RSA_KTAG_CRT_KEY,
    E_RSA_KTAG_DEFAULT = 0xFFFFFFFF /* four bytes align */
} E_RsaKTag;
...
typedef enum tagE_KsetDataType
{
    ...
    E_DATA_TYPE_DATA, 
    E_DATA_TYPE_HASH,
    E_DATA_TYPE_DEFAULT2 = 0xFFFFFFFF /* four bytes align */
} E_KsetDataType;
...
typedef enum tagE_WeBsapiModeOp
{
    ...
    E_WE_RSA_SIGN, 
    E_WE_RSA_VERIFY,
    E_WE_RSA_DEFAULT = 0xFFFFFFFF /* four bytes align */
} E_WeRsaModeOp; 
...
typedef enum tagE_WeRsaModeCBC
{
    E_WE_RSA_MODE_ECB, 
    E_WE_RSA_MODE_CBC,
    E_WE_RSA_MODE_DEFAULT = 0xFFFFFFFF /* four bytes align */
} E_WeRsaModeCBC;
...
typedef enum tagE_WeKSetKeyType
{
    ...
    E_RSA_KEY_TYPE_DEFAULT2 = 0xFFFFFFFF /* four bytes align */
} E_RsaKSetKeyType;
...
typedef enum tagE_WeHashType
{
    E_HASH_NUMERIC,
    E_HASH_BITS,
    E_HASH_DEFAULT = 0xFFFFFFFF /* four bytes align */
}E_RsaHashType;
