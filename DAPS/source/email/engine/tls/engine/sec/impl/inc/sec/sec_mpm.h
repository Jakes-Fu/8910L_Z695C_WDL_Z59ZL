...
{
    E_MPM_D = 0x00000000, E_MPM_DIV_ZERO = E_MPM_D,     
...
typedef enum tagE_MpmSign
{
    E_MPM_NEG, 
    E_MPM_POS,
    E_MPMSIGN_DEFAULT = 0xFFFFFFFF /* four bytes align */
} E_MpmSign;
...
WE_VOID We_MpmTransfer(WE_VOID * pvDestMid, E_MpmReg eDestRid, WE_VOID * pvSrcMid,
                      E_MpmReg eSrcRid, E_Result ePreserve) ;
