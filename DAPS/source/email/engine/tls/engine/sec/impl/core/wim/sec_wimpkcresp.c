...
====================================================================================================
    ...
    ----------   --------------   ---------   --------------------------------------
    2006-07-11            Sam                                      create sec_wimpkcresp.c
...
static void Sec_WimHandlePubKeyRSAEncryptResp( WE_HANDLE  hSecHandle,St_SecCrptEncryptPkcResp  *pstParam );
static void Sec_WimHandleVerifyRSASignatureResp( WE_HANDLE hSecHandle, St_SecCrptVerifySignatureResp   *pstParam );
#if (defined ( M_SEC_CFG_WTLS_CLASS_3 ) || defined (M_SEC_CFG_TLS))
static void Sec_WimHandleComputeRSADigSignResp( WE_HANDLE hSecHandle, St_SecCrptComputeSignatureResp *pstParam ) ;
#endif
/*==================================================================================================
FUNCTION: 
    Sec_WimInit
...
)
{
    ...
    (void)WE_MEMSET( pstElement,0,sizeof(St_SecWimElement) );
    /* evaluate */
...
#endif
#ifdef M_SEC_CFG_TLS
    if(M_SEC_WIM_TLS_KEYEXCHANGE_RSA==pstElement->iState)
    {
