/*==================================================================================================
    ...
    GENERAL DESCRIPTION
        This File will gather functions that support encrypt or decrypt operation.
...
====================================================================================================
    ...
    ----------   ------------    ---------   -------------------------------------------------------
    2006-07-07     steven ding                                          create sec_lib.c
...
#define M_SEC_BREW_ISHELL_HANDLE    NULL
#define M_SEC_LIB_HANDLE            (((St_SecGlobalData *)(((ISec*)hSecHandle)->hPrivateData))->pvAlgHandle)
