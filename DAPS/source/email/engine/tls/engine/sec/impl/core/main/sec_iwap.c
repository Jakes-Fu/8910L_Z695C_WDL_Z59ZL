/*=====================================================================================
    ...
    GENERAL DESCRIPTION:
        This file provides a set of functions, which is used for WAP application.
...
=======================================================================================
    ...
    ---------- -------------- --------- --------------------------------------
    2006-07-04          Kevin                                        create sec_iwap.c
                                 ...
                                 WE_INT32 iOutputLen)
{
    ...
    (void)WE_MEMSET(pstWtlsPrf,0,sizeof(St_SecGetPrfResult));
                                   ...
                                   const WE_VOID *pvBuf, WE_INT32 iBufLen)
{
    ...
    WE_MEMSET(pstVerCertChain, 0, sizeof(St_SecWtlsVerifySvrCert));
...
WE_INT32 Sec_MsgWtlsGetCipherSuite (WE_HANDLE hSecHandle, WE_INT32 iTargetID ,WE_HANDLE hTrustKeyIds)
{
    ...
    (void)WE_MEMSET(pstGetMethods,0,sizeof(St_SecWtlsGetCipherSuite));
    pstGetMethods->iTargetID = iTargetID;
    pstGetMethods->hTrustKeyIds = hTrustKeyIds;
                                 ...
                                 const WE_UCHAR * pucRandval)
{
    ...
    WE_LOG_MSG((WE_LOG_DETAIL_MEDIUM, 0,
               "Sec_iwap.c:.....into Sec_MsgWtlsKeyExchange\n"));
...
/*post the message*/
    ...
    (void)WE_MEMSET(pstKeyExch,0,sizeof(St_SecWtlsKeyExchange));
    ...
    WE_LOG_MSG((WE_LOG_DETAIL_MEDIUM, 0,
               "Sec_iwap.c:.....exit Sec_MsgWtlsKeyExchange\n"));
                                   ...
                                   const WE_VOID *pvBuf, WE_INT32 iBufLen)
{
    ...
    (void)WE_MEMSET(pstVerCertChain, 0, sizeof(St_SecTlsVerifySvrCert));
    pstVerCertChain->iTargetID = iTargetID;
                             ...
                             WE_INT32 iAlg)
{
    ...
    (void)WE_MEMSET(pstCompSig,0,sizeof(St_SecTlsComputeSign));
    ...
    iRes =Sec_PostMsg(hSecHandle, (WE_INT32)E_SEC_MSG_COMPSIG, (void*)pstCompSig);
    if(iRes !=M_SEC_ERR_OK)
    {
        WE_FREE(pstCompSig);
        pstCompSig =NULL;
                                ...
                                const WE_UCHAR * pucRandval)
{
    ...
    (void)WE_MEMSET(pstParamMem,0,sizeof(St_SecTlsKeyExchangeParams));
    ...
    case E_SEC_TLS_KEYEXCH_DHE_RSA_EXPORT:
       ...
       (void)WE_MEMSET(pstKeyExch,0,sizeof(St_SecTlsKeyExchange));
       /*post message data*/
       pstKeyExch->iTargetID = iTargetID;
       pstKeyExch->pstParam = pstParamMem;
       pstKeyExch->pucRandval = pucRandValMem;
                         ...
                         St_SecSessionInfo stSessionInfo)
{
    ...
    (void)WE_MEMSET(pstConEst,0,sizeof(St_SecSetupConnection));
                         ...
                         WE_UINT8 ucConnectionType)
{
    ...
    (void)WE_MEMSET(pstConTm,0,sizeof(St_SecStopConnection));
...
WE_INT32 Sec_MsgEnableSession (WE_HANDLE hSecHandle, WE_INT32 iMasterSecretId, WE_UINT8 ucIsActive)
{
    ...
    (void)WE_MEMSET(pstSessActive,0,sizeof(St_SecEnableSession));
...
WE_INT32 Sec_MsgDisableSession (WE_HANDLE hSecHandle, WE_INT32 iMasterSecretId)
{
    ...
    (void)WE_MEMSET(pstSesInval,0,sizeof(St_SecDisableSession));
...
WE_INT32 Sec_MsgRemovePeer (WE_HANDLE hSecHandle, WE_INT32 iTargetID, WE_INT32 iMasterSecretId)
{
    ...
    (void)WE_MEMSET( pstPeerDelLink,0,sizeof(St_SecRemovePeer) );
                                     ...
                                     WE_INT32 iMasterSecretId)
{
    ...
    (void)WE_MEMSET(pstPeerLinkSes,0,sizeof(St_SecAttachPeer));
                            ...
                            const WE_CHAR * pcDomain, WE_UINT16 usPortnum)
{
    ...
    (void)WE_MEMSET( pstPeerLU,0,sizeof(St_SecSearchPeer) );
...
WE_INT32 Sec_MsgGetSessionInfo (WE_HANDLE hSecHandle, WE_INT32 iTargetID, WE_INT32 iMasterSecretId)
{
    ...
    (void)WE_MEMSET(pstSesFetch,0,sizeof(St_SecFetchSessionInfo));
                              ...
                              WE_UINT32 uiCreationTime)
{
    ...
    (void)WE_MEMSET(pstSesUpd,0,sizeof(St_SecUpdateSession));
