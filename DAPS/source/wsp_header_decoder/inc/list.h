...
/*
 * Create a list object,you must alloc List object you self.
*/
void list_create_real(List *list);
#define list_create(list) list_create_real(list)
 ...
 */
BOOLEAN list_append(List *list, void *item);
 ...
 */
int list_search_all(List *list, List* searchList, void *pattern, list_item_matches_t *cmp);

void list_duplicate(List *d, List*s);
