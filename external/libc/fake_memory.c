...
#define	 SPLIBC_POOL_SIZE		(300*1024)
#define  SPLIBC_POOL_REGION		(120*1024)
#define  SPLIBC_MEM_MAX_SIZE	(512)
...
/*******************************************************************/
//  Interface:		SPRD__alloca
//  Description : 	SPRD__alloca
//  Global resource dependence : 
//  Author: Cheng.luo
//  Note:
/*******************************************************************/
