...
//
extern void FDL_PacketDoIdle (void);

// send the packet.
extern void FDL_SendPacket (PACKET_T *packet_ptr);

extern void FDL_SendAckPacket (cmd_pkt_type pkt_type);

extern void FDL_SendErrLog(const char *x_format, ...);

extern void FDL_SendTrace(const char *x_format, ...);
