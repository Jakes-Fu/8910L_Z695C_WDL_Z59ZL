 ...
 ******************************************************************************/
#define NBL_SIZE					1                    /* 1 block,     16KB */
#define OSB_SIZE					25                   /* 192 blocks,  3MB */
#define OSA_SIZE					145                  /* 184 blocks,     18MB */
#define DL_NV_SIZE					1                    /* 1 block,     16KB */
#define CALIPARAM_SIZE				1                    /* 3 blocks,    48KB */
#define MMI_RESOURCE_SIZE			401                  /* 400 blocks,  50MB */
#ifdef POWER_OFF_PROTECT_SUPPORT
...
#endif
#ifdef USB_VCOM_AUTORUN_SUPPORT
#define ROMDISK_FS_SIZE			15			/* 5MB   */
#else
#define ROMDISK_FS_SIZE			0			/* 5MB   */
#endif
#define RUNNING_NV_SIZE			24                   /* 192 blocks,  2M */
#define HIDDEN_FS_SIZE				40                   /* 320 blocks,   5MB */
