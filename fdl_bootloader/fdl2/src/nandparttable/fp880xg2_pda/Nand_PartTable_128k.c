 ...
 ******************************************************************************/
#define NBL_SIZE					1           /* 1 block,     128KB */
#ifdef MODEM_PLATFORM
#define OSB_SIZE                64          /* 64 blocks,   8MB  */
#else
#define OSB_SIZE                44          /* 32 blocks,   4MB  */
#endif

#ifdef VM_SUPPORT
#define OSC_SIZE					16          /* 16 blocks,   2MB  */
#else
#define OSC_SIZE					0           /* 0 blocks,    0MB  */
#endif

#define OSA_SIZE					180         /* 160 blocks,  20MB */
#define DL_NV_SIZE					1           /* 1 block,     128KB */
#define CALIPARAM_SIZE				1           /* 1 blocks,    128KB */

#ifdef DEV_MANAGE_SUPPORT
#define UA_SIZE						2           /* 2 block,     256KB*/
#define UBB_SIZE					10          /* 10 block,    1280KB*/
#define DU_SIZE						20          /* 20 block,    1280KB*/
#define UAEB_SIZE					20          /* 20 block,    1280KB*/
#define UF_SIZE						1           /* 1 block      128KB*/
#else
...
#endif
#define MMI_RESOURCE_SIZE			248           /* 1 blocks,    128KB */
#define RUNNING_NV_SIZE			48          /* 48 blocks,   6M */
#define HIDDEN_FS_SIZE				320         /* 40 blocks,   5MB */
#define DSP_CODE_SIZE				31          /* 32 blocks,   4MB */
...
#endif
#ifdef USB_VCOM_AUTORUN_SUPPORT
#define ROMDISK_FS_SIZE			120         /* 120 blocks,  5MB */
#else
...
const NAND_PARTITION PartI_128k =
{
    {PART_NUM},
    {
