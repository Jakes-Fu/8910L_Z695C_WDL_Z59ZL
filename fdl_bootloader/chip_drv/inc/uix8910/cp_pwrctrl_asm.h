...
#ifndef _CP_PWRCTRL_ASM_H_
#define _CP_PWRCTRL_ASM_H_

//THIS FILE HAS BEEN GENERATED WITH COOLWATCHER. PLEASE EDIT WITH CARE !

#ifndef CT_ASM
#error "You are trying to use in a normal C code the assembly H description of 'cp_pwrctrl'."
#endif
...
#define REG_PWRCTRL_BASE_HI        BASE_HI(REG_PWRCTRL_BASE)
#define REG_PWRCTRL_BASE_LO        BASE_LO(REG_PWRCTRL_BASE)

#define REG_PWRCTRL_PWR_HWEN       REG_PWRCTRL_BASE_LO + 0x00000000
#define REG_PWRCTRL_AP_PWR_CTRL    REG_PWRCTRL_BASE_LO + 0x00000004
#define REG_PWRCTRL_ZSP_PWR_CTRL   REG_PWRCTRL_BASE_LO + 0x00000008
#define REG_PWRCTRL_LTE_PWR_CTRL   REG_PWRCTRL_BASE_LO + 0x0000000C
#define REG_PWRCTRL_GGE_PWR_CTRL   REG_PWRCTRL_BASE_LO + 0x00000010
#define REG_PWRCTRL_RF_PWR_CTRL    REG_PWRCTRL_BASE_LO + 0x00000014
#define REG_PWRCTRL_BTFM_PWR_CTRL  REG_PWRCTRL_BASE_LO + 0x00000018
#define REG_PWRCTRL_AON_LP_PWR_CTRL REG_PWRCTRL_BASE_LO + 0x0000001C
#define REG_PWRCTRL_AP_PWR_STAT    REG_PWRCTRL_BASE_LO + 0x00000020
#define REG_PWRCTRL_ZSP_PWR_STAT   REG_PWRCTRL_BASE_LO + 0x00000024
#define REG_PWRCTRL_LTE_PWR_STAT   REG_PWRCTRL_BASE_LO + 0x00000028
#define REG_PWRCTRL_GGE_PWR_STAT   REG_PWRCTRL_BASE_LO + 0x0000002C
#define REG_PWRCTRL_RF_PWR_STAT    REG_PWRCTRL_BASE_LO + 0x00000030
#define REG_PWRCTRL_BTFM_PWR_STAT  REG_PWRCTRL_BASE_LO + 0x00000034
#define REG_PWRCTRL_AON_LP_PWR_STAT REG_PWRCTRL_BASE_LO + 0x00000038
#define REG_PWRCTRL_STATE_DELAY    REG_PWRCTRL_BASE_LO + 0x0000003C
#define REG_PWRCTRL_PREPGC_DELAY   REG_PWRCTRL_BASE_LO + 0x00000040
#define REG_PWRCTRL_ALLPGC_DELAY   REG_PWRCTRL_BASE_LO + 0x00000044
#define REG_PWRCTRL_DDR_HOLD_CTRL  REG_PWRCTRL_BASE_LO + 0x00000048
#define REG_PWRCTRL_ZSP_PD_POLL    REG_PWRCTRL_BASE_LO + 0x0000004C
#define REG_PWRCTRL_ZSP_PD_POLL_SET REG_PWRCTRL_BASE_LO + 0x00000050
#define REG_PWRCTRL_ZSP_PD_POLL_CLR REG_PWRCTRL_BASE_LO + 0x00000054
#define REG_PWRCTRL_WCN_LPS        REG_PWRCTRL_BASE_LO + 0x00000090
#define REG_PWRCTRL_ARM_SLP_REQ_SW REG_PWRCTRL_BASE_LO + 0x00000094
#define REG_PWRCTRL_ARM_SLP_ACK    REG_PWRCTRL_BASE_LO + 0x00000098
#define REG_PWRCTRL_ARM_SLP_REQ_HWEN REG_PWRCTRL_BASE_LO + 0x0000009C
#define REG_PWRCTRL_ZSP_SLP_REQ_SW REG_PWRCTRL_BASE_LO + 0x000000A0
#define REG_PWRCTRL_ZSP_SLP_ACK    REG_PWRCTRL_BASE_LO + 0x000000A4
#define REG_PWRCTRL_ZSP_SLP_REQ_HWEN REG_PWRCTRL_BASE_LO + 0x000000A8
#define REG_PWRCTRL_DDR_SLP_REQ_SW REG_PWRCTRL_BASE_LO + 0x000000AC
#define REG_PWRCTRL_DDR_SLP_ACK    REG_PWRCTRL_BASE_LO + 0x000000B0
#define REG_PWRCTRL_DDR_SLP_REQ_HWEN REG_PWRCTRL_BASE_LO + 0x000000B4
#define REG_PWRCTRL_TIMEOUT_FLAG   REG_PWRCTRL_BASE_LO + 0x000000B8
#define REG_PWRCTRL_POWER_STATE    REG_PWRCTRL_BASE_LO + 0x000000BC
#define REG_PWRCTRL_PWRCTRL_MODE   REG_PWRCTRL_BASE_LO + 0x000000C0
#define REG_PWRCTRL_PWRCTRL_SW     REG_PWRCTRL_BASE_LO + 0x000000C4
#define REG_PWRCTRL_PWRCTRL_SW_SET REG_PWRCTRL_BASE_LO + 0x000000C8
#define REG_PWRCTRL_PWRCTRL_SW_CLR REG_PWRCTRL_BASE_LO + 0x000000CC
#define REG_PWRCTRL_PWRCTRL_SW1    REG_PWRCTRL_BASE_LO + 0x000000D0
#define REG_PWRCTRL_PWRCTRL_SW1_SET REG_PWRCTRL_BASE_LO + 0x000000D4
#define REG_PWRCTRL_PWRCTRL_SW1_CLR REG_PWRCTRL_BASE_LO + 0x000000D8
