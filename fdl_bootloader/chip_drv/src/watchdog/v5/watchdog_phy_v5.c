...
PUBLIC  void CHIP_SOFT_Reset(void)
{
	...
	value = ADI_Analogdie_reg_read(ANA_MODULE_EN0);
	value |= ANA_WDG_EN;
    ADI_Analogdie_reg_write (ANA_MODULE_EN0,  value);

	value = ADI_Analogdie_reg_read(ANA_RTC_CLK_EN0);
	value |= ANA_RTC_WDG_EN;
    ADI_Analogdie_reg_write (ANA_RTC_CLK_EN0,  value);
#else
