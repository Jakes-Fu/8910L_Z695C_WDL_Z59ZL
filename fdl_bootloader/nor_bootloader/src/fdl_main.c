...
#define hwp_keypad      ((HWP_KEYPAD_T*) (0x50106000))
...
#define SRAM_BASE_ADDR          (0x04000000)
...
int main(void)
{
    ...
    {
#if defined(CHIP_VER_UIS8910FF)
#define SYS_PROGRAM_START_ADDR (0x60020000)
#else
#define SYS_PROGRAM_START_ADDR (0x60010000)
#endif
#ifdef SECURE_BOOT_SUPPORT
	memcpy(signature_data, (uint8 *)(SYS_PROGRAM_START_ADDR + VLR_INFO_SIZ), VLR_INFO_SIZ);
        if (0 == secure_boot_check((uint8 *)(SYS_PROGRAM_START_ADDR + SECURE_CODE_OFF),
	...
	else
	{
      ...
      JumpToTarget(SYS_PROGRAM_START_ADDR);
#endif
    }
#else //#if defined PLATFORM_UIX8910
